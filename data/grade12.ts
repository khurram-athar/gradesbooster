...
{day:1, label:"Day 1 — Mon", subjects:[
  {subject:"English", title:"Literary Analysis: University-Level Essay Writing", summary:"Students develop the analytical writing skills required for first-year university — constructing complex arguments, integrating sources, and writing with precision and intellectual authority.",
   ...
   quiz:[
     ...
     {q:"A counterargument in an academic essay ___.", options:["proves you are unsure of your argument","should always be avoided","weakens your position","strengthens your argument when addressed and refuted — demonstrating that you have considered alternative interpretations and can explain why your reading is more persuasive"], answer:3},
     {q:"Integrating literary criticism responsibly means ___.", options:["engaging critically with secondary sources — using them to inform, enrich, or challenge your reading, while maintaining your own analytical voice and making your own contribution","avoiding critics who disagree with you","only agreeing with critics","copying the critic's argument as your own"], answer:0},
  ...
  {subject:"AdvancedFunctions", title:"Polynomial Functions: Deep Dive into Graphs and Equations", summary:"Students investigate polynomial functions of all degrees — connecting multiplicity of zeros, end behaviour, turning points, and algebraic form to graphical behaviour.",
   ...
   quiz:[
     ...
     {q:"A zero of multiplicity 3 means the graph ___.", options:["touches and bounces","creates a sharp corner","has no x-intercept there","crosses with an S-curve (point of inflection) at that zero — flattening as it crosses"], answer:3},
     {q:"For P(x) = −2(x+1)²(x−3)(x−5), the end behaviour is ___.", options:["rises left, rises right","rises left, falls right","falls both directions — leading term is −2x⁴ (even degree, negative coefficient)","falls left, rises right"], answer:2},
     {q:"The Intermediate Value Theorem guarantees ___.", options:["a polynomial is always continuous","a polynomial has exactly n roots","a zero exists between a and b if P(a) and P(b) have opposite signs — at least one zero must exist where the graph crosses zero","the maximum value of a polynomial"], answer:2}
   ]},
  {subject:"Calculus", title:"Introduction to Limits and Continuity", summary:"Students develop an intuitive and rigorous understanding of limits — what they mean, how to evaluate them, and their role as the foundation of calculus.",
   ...
   quiz:[
     ...
     {q:"A removable discontinuity (hole) occurs when ___.", options:["the function is not defined anywhere","the limit exists at x = a but either f(a) is undefined or f(a) ≠ the limit — the discontinuity can be 'fixed' by redefining f(a)","the function goes to infinity","the limit does not exist at the point"], answer:1}
   ]},
...
{day:2, label:"Day 2 — Tue", subjects:[
  {subject:"English", title:"Independent Study: The Novel — Form and Meaning", summary:"Students read a major novel independently, analysing how formal choices (narration, structure, style) create meaning rather than just content.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"The distinction between story (fabula) and discourse (sjuzhet) means ___.", options:["only the plot matters","discourse is less important than story","story is the raw chronological events; discourse is how those events are arranged and told — great novelists manipulate discourse to shape meaning, pace, and perspective","they are the same in all novels"], answer:2},
     {q:"Free indirect discourse (FID) in a novel allows ___.", options:["only third-person narrators to speak","only interior monologue in first person","a third-person narrator to render a character's thoughts and speech without explicit tags — blurring the boundary between narrator and character, creating empathy and irony simultaneously","only direct quotation of characters"], answer:2},
  ...
  {subject:"Calculus", title:"Derivatives: Definition and Basic Rules", summary:"Students develop the concept of the derivative as a limit of difference quotients, and apply the basic differentiation rules (power, constant, sum, difference).",
   ...
   quiz:[
     {q:"The derivative f'(a) is defined as ___.", options:["f(a+1) − f(a)","lim(h→0)[f(a+h) − f(a)]/h — the slope of the tangent line at x = a","f(a+h) − f(a)","f(a)/h"], answer:1},
     ...
     {q:"The derivative f'(x) represents ___.", options:["the area under f(x)","the antiderivative of f(x)","the instantaneous rate of change of f(x) — the slope of the tangent line to the graph of f at any point x","f(x) squared"], answer:2}
   ]},
  {subject:"Physics", title:"Forces: Newton's Laws in 2D", summary:"Students apply Newton's three laws to two-dimensional force problems, including inclined planes, connected masses, and friction.",
   ...
   quiz:[
     ...
     {q:"Newton's Third Law states that for every action force there is ___.", options:["an equal and opposite reaction force — acting on a DIFFERENT object than the action force","a smaller reaction force in the same direction","no corresponding reaction","a larger reaction force"], answer:0}
   ]},
]},
{day:3, label:"Day 3 — Wed", subjects:[
  {subject:"English", title:"Literature: The Tragic Form Across Cultures", summary:"Students compare the tragic form in different cultural traditions — Greek tragedy, Shakespearean tragedy, and contemporary tragic narratives — examining what 'tragedy' means across time and culture.",
   ...
   quiz:[
     ...
     {q:"Anagnorisis (recognition) in Greek tragedy is ___.", options:["the protagonist's moment of terrible recognition — realising the truth of their situation, often connected to hamartia — which may precede but cannot prevent their downfall","a minor plot device","only relevant in comedy","the moment of physical death"], answer:0},
     ...
     {q:"Comparing tragic forms across cultures illuminates ___.", options:["only literary technique","how different cultures understand fate, justice, individual agency, and what makes human suffering meaningful — tragedy is a cross-cultural form, but its specific expression reflects distinct world views","that tragedy is purely a Western form","only historical differences"], answer:1}
   ]},
  {subject:"AdvancedFunctions", title:"Exponential and Logarithmic Functions: Advanced Applications", summary:"Students solve complex exponential and logarithmic equations, apply change of base, and model real phenomena including logistic growth.",
   ...
   quiz:[
     ...
     {q:"Logistic growth f(t) = L/(1 + ae^(−kt)) models populations because ___.", options:["it allows unlimited growth","it only models exponential growth","it shows rapid initial growth that slows as the population approaches the carrying capacity L — more realistic than pure exponential growth","it always decreases"], answer:2},
     {q:"The natural logarithm ln(x) = log_e(x) is especially important because ___.", options:["the number e ≈ 2.718 arises naturally in calculus (as the base of the derivative of exponential functions) — ln is the inverse of e^x, the most important exponential function","e is a round number","ln has simpler graphs","ln is easier to calculate"], answer:0},
  ...
  {subject:"Calculus", title:"Derivatives: Product, Quotient, and Chain Rules", summary:"Students master the three composite differentiation rules and apply them to increasingly complex functions.",
   ...
   quiz:[
     {q:"The product rule for d/dx[f(x)g(x)] is ___.", options:["f'(x)g(x) + f(x)g'(x) — differentiate each factor and apply","f(x)g'(x)","f'(x) × g'(x)","f'(x)g(x)"], answer:0},
     ...
     {q:"The chain rule for d/dx[f(g(x))] is ___.", options:["f'(g(x)) × g'(x) — differentiate the outer function at the inner, times the derivative of the inner","f'(x) × g'(x)","f(g'(x))","f'(g(x))"], answer:0},
  ...
  {subject:"Physics", title:"Work, Energy, and Power: Advanced Applications", summary:"Students apply the work-energy theorem, conservation of mechanical energy, and power calculations to complex problems.",
   ...
   quiz:[
     ...
     {q:"Conservative forces are those for which ___.", options:["no energy is stored","friction is the best example","work done is path-independent — only the endpoints matter; mechanical energy is conserved in systems with only conservative forces","work depends on the path taken"], answer:2},
...
{day:4, label:"Day 4 — Thu", subjects:[
  {subject:"English", title:"Writing: Extended Critical Analysis Essay", summary:"Students plan and write a 1000+ word critical essay on a literary text, meeting university standards for argument, evidence, and analysis.",
   ...
   quiz:[
     ...
     {q:"Evidence in a university essay should be ___.", options:["precisely chosen — the smallest portion of text that demonstrates the specific point you are making, embedded grammatically, and always followed by analysis that earns the quotation","replaced by paraphrase always","always a minimum of 5 lines","as long as possible"], answer:0},
     {q:"The difference between analysis and description in an extended essay is ___.", options:["they are the same at university level","description reports what the text does; analysis explains how and why specific choices create specific effects — every paragraph must be driven by analysis, not description","analysis only appears in conclusions","description is more academic"], answer:1},
     {q:"Concluding a long essay effectively requires ___.", options:["synthesising the essay's argument, extending the thesis to its larger implications, and leaving the reader with a new perspective or unresolved question — not just restating what has been said","adding new evidence at the end","summarising all body paragraphs in order","repeating the thesis word for word"], answer:0}
   ]},
  {subject:"AdvancedFunctions", title:"Trigonometric Functions: Identities and Equations (Advanced)", summary:"Students prove and apply advanced trigonometric identities including compound angle, double angle, and sum-to-product formulas, and solve complex trigonometric equations.",
   ...
   quiz:[
     {q:"To prove a trigonometric identity, you must ___.", options:["start from both sides simultaneously","cross-multiply to eliminate fractions","substitute specific values","work on one side only, transforming it to equal the other, using only known identities and algebraic operations — never treating it like an equation to solve"], answer:3},
     ...
     {q:"Sum-to-product: sinA + sinB = ___.", options:["2sin(A+B)cos(A−B)","2cos((A+B)/2)sin((A−B)/2)","sin(A+B)","2sin((A+B)/2)cos((A−B)/2) — a useful formula for adding sine functions"], answer:3},
  ...
  {subject:"Physics", title:"Circular Motion and Gravitation", summary:"Students analyse uniform circular motion — centripetal acceleration and force — and apply Newton's law of universal gravitation.",
   ...
   quiz:[
     {q:"Centripetal acceleration for uniform circular motion is ___.", options:["v²/r directed toward the centre — it is the acceleration required to continually change the direction of velocity","rω","v/r","tangential acceleration"], answer:0},
     {q:"The centripetal force is ___.", options:["the outward 'centrifugal force'","a new type of force","the force of rotation","the net inward force that causes circular motion: F_c = mv²/r — it is provided by real forces such as gravity, tension, or normal force"], answer:3},
...
{day:5, label:"Day 5 — Fri", subjects:[
  {subject:"English", title:"Media Analysis: Digital Media and Political Communication", summary:"Students analyse how digital platforms — social media, podcasts, algorithmic news — have transformed political communication and citizenship.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"Political communication via social media differs from broadcast media in ___.", options:["its interactive, many-to-many architecture — anyone can broadcast to thousands; algorithms determine reach; misinformation can spread as fast as truth; echo chambers form algorithmically","it has no political influence","it reaches fewer people","it is always more accurate"], answer:0},
  ...
  {subject:"AdvancedFunctions", title:"Combining Functions: Operations and Compositions", summary:"Students perform operations on functions (sum, difference, product, quotient) and compositions, including finding domains of combined functions.",
   ...
   quiz:[
     {q:"The domain of (f + g)(x) is ___.", options:["the intersection of the domains of f and g — both must be defined","the domain of f only","the domain of g only","the domain of f union domain of g"], answer:0},
     {q:"The domain of f(x) = √x and g(x) = 1/(x−2): find domain of f(g(x)).", options:["g(x) must be ≥ 0 for √g(x) to exist, so 1/(x−2) ≥ 0, meaning x > 2 (and x ≠ 2) — domain is x > 2","x > 0","x ≥ 2","x < 0"], answer:0},
  ...
  {subject:"Physics", title:"Waves: Transverse, Longitudinal, and Sound", summary:"Students examine wave properties (wavelength, frequency, amplitude, speed), the wave equation, and properties of sound.",
   ...
   quiz:[
     {q:"The wave equation v = fλ relates ___.", options:["wave speed to frequency and wavelength — doubling the frequency halves the wavelength for the same medium","velocity to force and length","amplitude to frequency","wavelength to period only"], answer:0},
     ...
     {q:"The Doppler effect explains why ___.", options:["sound cannot travel through air","light always appears red-shifted","waves cannot be reflected","the pitch of a police siren seems to change as it approaches and recedes — the source moves relative to the observer, compressing or stretching the wavelengths"], answer:3},
     {q:"Resonance occurs when ___.", options:["the driving frequency matches the object's natural frequency — producing maximum amplitude oscillations that can be very large (e.g., a singer breaking a glass, a bridge vibrating in wind)","all frequencies are absorbed equally","the amplitude becomes zero","only destructive interference is possible"], answer:0},
...
{day:6, label:"Day 6 — Mon", subjects:[
  {subject:"English", title:"Literature: Poetry — The Lyric Tradition", summary:"Students study the development of the lyric poem from the Romantics through Modernism to contemporary practice, examining how lyric poetry constructs a speaking self and addresses fundamental human questions.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"The lyric poem is distinguished by ___.", options:["its expression of personal feeling or thought through a speaking 'I' — the lyric creates a sense of intimacy and presence, as if a thinking, feeling consciousness is directly addressed to us","always being short","always rhyming","always being about nature"], answer:0},
     ...
     {q:"Modernist lyric poetry (Eliot, Yeats, Stevens) often uses ___.", options:["only traditional forms","fragmentation, allusion, difficulty, and impersonality — the 'persona' of the poem is often distanced or deliberately constructed, rejecting Romantic expressivism for a more ironic, cerebral stance","only simple language","straightforward emotional expression"], answer:1},
     {q:"Contemporary lyric poetry engages with ___.", options:["only traditional subjects like love and death","only nature as a subject","a vast range of subjects and forms — from personal trauma and identity politics to ecological crisis and digital culture — often in hybrid forms mixing prose and verse","only formal experimentation"], answer:2},
     {q:"Close reading a lyric poem involves ___.", options:["only identifying the rhyme scheme","only summarising what the poem is about","attending to every word, sound, line break, and formal choice — lyric poetry is maximally compressed, so nothing is accidental","only determining whether the speaker is happy or sad"], answer:2}
   ]},
  ...
  {subject:"Physics", title:"Electricity: Electric Fields and Potential", summary:"Students analyse electric fields and electric potential produced by point charges and uniform fields, and relate electric potential to potential energy.",
   ...
   quiz:[
     ...
     {q:"The relationship between electric field and electric potential is ___.", options:["E = −dV/dx (in 1D) — the field is the negative gradient of the potential; field points from high to low potential","E = V + r","E = V/r only in uniform fields","E = V × r"], answer:0},
     ...
     {q:"Electric field lines and equipotential surfaces are ___.", options:["parallel to each other","the same thing drawn differently","always perpendicular — field lines show the direction of force on a positive charge; equipotential surfaces connect points of equal potential","only drawn around conductors"], answer:2}
   ]},
]},
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"English", title:"Drama and Theatre: Contemporary Playwriting", summary:"Students read and analyse a contemporary Canadian play, examining how playwrights structure dramatic conflict, develop character through dialogue, and use theatrical space.",
   ...
   quiz:[
     ...
     {q:"Non-realistic staging in contemporary theatre (abstract sets, stylised movement) ___.", options:["requires no interpretation","creates meaning by refusing the illusion of realism — drawing attention to theatricality itself and inviting audiences to engage imaginatively rather than passively accept an illusion","is used to avoid the cost of realistic sets","is always unsuccessful with audiences"], answer:1},
  ...
  {subject:"AdvancedFunctions", title:"Rates of Change: Introduction to Calculus Concepts", summary:"Students explore the concept of instantaneous rate of change as a limit, preparing the foundation for Grade 12 Calculus and making explicit the connection between Advanced Functions and Calculus.",
   ...
   quiz:[
     {q:"Average rate of change of f(x) over [a, b] is ___.", options:["[f(b) − f(a)]/(b − a) — the slope of the secant line through (a, f(a)) and (b, f(b))","f'(a)","[f(b) − f(a)] × (b − a)","f(a)/f(b)"], answer:0},
     {q:"Instantaneous rate of change at x = a is ___.", options:["lim(h→0)[f(a+h) − f(a)]/h — the slope of the tangent line at a, i.e., the derivative f'(a)","f(a)/a","[f(b)−f(a)]/(b−a) for any b","f(a+1) − f(a)"], answer:0},
  ...
  {subject:"Calculus", title:"Optimisation: Maximum and Minimum Problems", summary:"Students apply derivatives to find maximum and minimum values in applied context problems — geometry, economics, and physics.",
   ...
   quiz:[
     ...
     {q:"The second derivative test confirms a maximum when ___.", options:["f''(c) is undefined","f''(c) = 0","f''(c) < 0 (concave down at the critical point — local maximum)","f''(c) > 0 (concave up — local minimum)"], answer:2},
     ...
     {q:"Optimisation in real life includes ___.", options:["only geometric problems","only mathematical problems","no economic applications","minimising cost, maximising revenue, finding the most efficient shape for a container, minimising material use, maximising the strength of a structure — calculus is the tool of choice"], answer:3}
   ]},
  {subject:"Physics", title:"Electric Circuits: Current, Resistance, and Ohm's Law", summary:"Students analyse DC electric circuits — current, voltage, resistance, Ohm's Law, series and parallel circuits, and power dissipation.",
   ...
   quiz:[
     ...
     {q:"Power dissipated in a resistor is ___.", options:["P = IR²","P = V/I","P = IV = I²R = V²/R — three equivalent expressions, all valid for any resistor obeying Ohm's Law","P = I/R"], answer:2},
     {q:"Adding a resistor in parallel to a circuit ___.", options:["only changes the voltage","doesn't affect total resistance","decreases total resistance — 1/R_total = 1/R₁ + 1/R₂ means R_total is always less than either individual resistance","increases total resistance"], answer:2}
   ]},
]},
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"English", title:"Writing: The University Application Process and Personal Writing", summary:"Students write personal statements and supplementary essays for university applications, applying their Grade 12 writing skills to genuine high-stakes contexts.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"A university personal statement is most effective when ___.", options:["it lists every achievement in your life","it sounds like every other applicant","it reveals how you think — through a specific story or question that shows your intellectual curiosity, growth, and genuine engagement with ideas","it focuses only on grades"], answer:2},
     {q:"Showing rather than telling in a personal statement means ___.", options:["only using achievements","instead of saying 'I am passionate about biology,' describing the specific moment, question, or observation that sparked that passion — concrete specificity is more persuasive than self-description","never making claims about yourself","avoiding personal stories"], answer:1},
     {q:"Tailoring a supplementary essay to a specific university or program requires ___.", options:["copying your main personal statement","generic statements about the school","genuine research — knowing specific programs, professors, courses, or approaches at that institution and explaining how they connect to your specific intellectual interests","avoiding mention of specific courses"], answer:2},
     ...
     {q:"Your personal statement is most valuable to you personally because ___.", options:["it impresses admission officers","only the grade matters","it guarantees admission","it requires you to reflect seriously on who you are, what you care about, and where you want to go — the act of writing it is itself valuable, not just the finished product"], answer:3}
   ]},
  {subject:"AdvancedFunctions", title:"Discrete Functions: Advanced Sequences, Series, and Financial Math", summary:"Students apply geometric series formulas to financial mathematics — annuities, mortgages, and investment growth — with university-preparatory rigour.",
   ...
   quiz:[
     {q:"The future value of an annuity (regular payment R, interest rate i per period, n periods) is ___.", options:["FV = R × i × n","FV = R(1+i)ⁿ","FV = R[(1+i)ⁿ − 1]/i — a geometric series: each payment earns compound interest for a different number of periods","FV = R × n"], answer:2},
     {q:"If you invest $200/month at 6%/year (0.5%/month) for 30 years, the future value is ___.", options:["$200 × (1.005)^360","200[(1.005)^360 − 1]/0.005 ≈ $200,903 — compound interest dramatically amplifies regular saving","200 × 360 = $72,000","200 × 0.005 × 360"], answer:1},
     {q:"The present value of an annuity formula is ___.", options:["PV = R/i","PV = R(1+i)ⁿ/i","PV = R[1 − (1+i)^(−n)]/i — how much a series of future payments is worth today","PV = R × n"], answer:2},
     {q:"A mortgage is a ___.", options:["future value of an annuity problem","perpetuity","present value of an annuity problem — the loan amount is the PV; monthly payments are R; solving for R gives the payment size","growing annuity"], answer:2},
  ...
  {subject:"Calculus", title:"Integration: The Antiderivative and Indefinite Integrals", summary:"Students are introduced to integration as the reverse of differentiation, applying the power rule for integration and the constant of integration.",
   ...
   quiz:[
     ...
     {q:"∫(3x² − 4x + 5) dx = ___.", options:["x³ − 2x² + 5x + C — integrate term by term using the power rule","3x³ − 4x² + 5x","6x − 4","x³ − 2x² + 5x + C"], answer:0},
     {q:"The constant of integration C appears because ___.", options:["any constant differentiates to zero, so infinitely many functions have the same derivative — C represents the 'lost' information about the original function's vertical shift","C equals zero always","integration is imprecise","every integral is different"], answer:0},
  ...
  {subject:"Physics", title:"Magnetic Fields and Forces", summary:"Students examine magnetic fields produced by current-carrying conductors, and the force on a current or moving charge in a magnetic field.",
   ...
   quiz:[
     {q:"The force on a charge q moving with velocity v in a magnetic field B is ___.", options:["F = qv × B (vector cross product) — magnitude F = qvB sinθ, direction given by the right-hand rule","F = mv/qB","F = qvB (this is the magnitude when v ⊥ B)","F = qB/v"], answer:0},
     {q:"A charged particle moving perpendicular to a uniform magnetic field follows ___.", options:["a spiral path along B","a circular path — the magnetic force is always perpendicular to velocity, providing centripetal force without doing work","a parabolic path","a straight line"], answer:1},
     ...
     {q:"Two parallel wires carrying current in the same direction ___.", options:["do not exert forces on each other","repel each other","rotate around each other","attract each other — the magnetic field of each wire exerts an attractive force on the current in the other"], answer:3},
     {q:"The right-hand rule for a solenoid: point fingers in the direction of current wrap, thumb points ___.", options:["at 90° to field","toward the south pole","toward the north pole — the solenoid's magnetic field inside points in the direction of the thumb","in the direction of current flow"], answer:2}
   ]},
]},
{day:9, label:"Day 9 — Thu", subjects:[
  {subject:"English", title:"Independent Reading: Postmodern Literature", summary:"Students read a postmodern novel or short fiction collection, examining metafiction, fragmentation, unreliable narration, and postmodern challenges to stable meaning.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"Postmodern literature challenges ___.", options:["all previous narrative techniques without exception","the concepts of stable, knowable truth and coherent identity — postmodern texts often question the authority of the narrator, the reliability of language, and the very possibility of authentic selfhood","only the use of irony","the idea that literature can accurately represent reality"], answer:1},
     {q:"Metafiction is ___.", options:["only experimental prose poetry","fiction about real events presented as fiction","only found in postmodern novels","fiction that self-consciously draws attention to its own artifice — reminding readers they are reading a constructed text, often by having narrators comment on the act of storytelling"], answer:3},
     {q:"Intertextuality in postmodern fiction means ___.", options:["plagiarism from other works","the way a text is built from and in dialogue with other texts — quotations, allusions, parody, pastiche — blurring the boundaries between 'original' and 'borrowed' material","only references to classical literature","only quoting other texts directly"], answer:1},
     {q:"Pastiche differs from parody in that ___.", options:["pastiche is always comic","they are identical","pastiche has no relationship to prior works","pastiche imitates a style without the critical distance of parody — it celebrates or mourns a style rather than mocking it; Fredric Jameson saw pastiche as the dominant mode of postmodern culture"], answer:3},
     {q:"Reading postmodern fiction productively requires ___.", options:["abandoning all interpretive frameworks","accepting that meaning is completely arbitrary","tolerating and enjoying ambiguity — learning to read with pleasure the way meaning is deferred, multiplied, and complicated rather than seeking a definitive single meaning","only reading plot summaries"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"Introduction to Vectors", summary:"Students are introduced to vectors — geometric and component representations, operations, dot product, and applications to displacement and work.",
   ...
   quiz:[
     ...
     {q:"Two vectors a = (a₁, a₂) and b = (b₁, b₂) are added by ___.", options:["adding corresponding components: a + b = (a₁+b₁, a₂+b₂) — equivalent to the geometric tip-to-tail rule","multiplying components","subtracting components","taking the average of each component"], answer:0},
     {q:"The dot product a · b = ___.", options:["a × b (vector cross product)","|a| × |b| (this is only the magnitude part)","a₁b₁ + a₂b₂ = |a||b|cosθ — a scalar that captures the 'same-direction' component of two vectors","a₁b₂ + a₂b₁"], answer:2},
     {q:"Two vectors are perpendicular if and only if ___.", options:["their magnitudes are equal","one has zero magnitude","their dot product equals zero — cosθ = 0 when θ = 90°","they are in the same direction"], answer:2},
     {q:"The work done by force F over displacement d is ___.", options:["F × d (scalar)","W = F · d = |F||d|cosθ — work is the dot product; only the component of force in the direction of displacement does work","F + d","|F| × |d|"], answer:1}
   ]},
  {subject:"Calculus", title:"Definite Integrals and the Fundamental Theorem of Calculus", summary:"Students compute definite integrals, apply the Fundamental Theorem of Calculus, and interpret definite integrals as areas.",
   ...
   quiz:[
     {q:"The Fundamental Theorem of Calculus Part 1 states ___.", options:["∫f(x)dx from a to a equals 1","integration and differentiation are unrelated","∫f(x)dx can only be approximated","if F'(x) = f(x), then ∫[a to b]f(x)dx = F(b) − F(a) — connecting the antiderivative to the area under the curve"], answer:3},
  ...
  {subject:"Physics", title:"Electromagnetic Induction", summary:"Students examine Faraday's Law of electromagnetic induction, Lenz's Law, and applications including transformers and generators.",
   ...
   quiz:[
     {q:"Faraday's Law states that an EMF is induced in a conductor when ___.", options:["current flows through it","the magnetic flux through it changes — the induced EMF equals the rate of change of flux: EMF = −dΦ/dt","it is placed in a constant magnetic field","it is heated"], answer:1},
     {q:"Lenz's Law states that the induced current flows in a direction that ___.", options:["is always clockwise","has no relation to the cause","opposes the change in magnetic flux — a consequence of energy conservation: the induced current always acts to maintain the existing flux","amplifies the change causing it"], answer:2},
     {q:"An electric generator works by ___.", options:["using a battery to create magnetic flux","rotating a coil in a magnetic field — changing magnetic flux induces an EMF, converting mechanical energy to electrical energy","converting electrical energy to mechanical energy (that is a motor)","using nuclear fusion"], answer:1},
     {q:"A transformer steps up voltage by ___.", options:["having fewer primary turns","having more secondary turns than primary turns — V_s/V_p = N_s/N_p; stepping up voltage steps down current (power conservation: V_p I_p = V_s I_s)","using DC current (transformers require AC)","using stronger magnets"], answer:1},
     {q:"The reason high-voltage transmission lines are used to send electricity across long distances is ___.", options:["at high voltage, the current is lower (P = IV), so power loss (P_loss = I²R) in the wires is minimised — transformers make this practical with AC","high voltage is safer","high voltage doesn't need towers","only historical convention"], answer:0}
   ]},
]},
{day:10, label:"Day 10 — Fri", subjects:[
  {subject:"English", title:"Literature: Comparative Canadian and World Literature", summary:"Students compare Canadian literature with a world text, analysing how place, history, and culture shape literary form and theme.",
   ...
   quiz:[
     ...
     {q:"Canadian literature is shaped by ___.", options:["only the landscape","only Quebec-English tensions","a unique combination of colonial history, vast geography, proximity to the US, two official languages, Indigenous presence, and ongoing waves of immigration — producing a literature of settlement, survival, and identity","only multiculturalism"], answer:2},
     {q:"The concept of 'writing back' (from post-colonial theory) means ___.", options:["only about rejecting Western literature","only Indigenous writing","texts from formerly colonised cultures engaging with, subverting, or transforming the literary traditions of the colonising culture — rewriting familiar narratives from marginalised perspectives","answering letters"], answer:2},
     {q:"A sophisticated comparison of two texts examines ___.", options:["only whether one is better than the other","only their plots","only their dates of publication","how each text's formal choices, cultural context, and thematic concerns illuminate the other — finding meaningful connections and tensions that reveal something about both"], answer:3},
     {q:"The value of global and comparative literature for Canadian students is ___.", options:["no connection to Canadian identity","only preparation for international travel","it places Canada in a global conversation — students discover both what is distinctive about Canadian literature and what connects it to the broader human story","only useful for English majors"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"Proof and Mathematical Reasoning", summary:"Students examine mathematical proof — direct proof, proof by contradiction, and mathematical induction — developing the formal reasoning skills required for university mathematics.",
   ...
   quiz:[
     ...
     {q:"Proof by contradiction assumes ___.", options:["only that algebra is valid","the theorem is sometimes false","the opposite of the theorem, then derives a logical impossibility — proving the original theorem must be true","the theorem is trivially true"], answer:2},
     {q:"Mathematical induction proves a statement P(n) for all n ≥ 1 by ___.", options:["only checking P(1)","proving P(n) is true for some large n","checking P(n) for n = 1 to 100","proving P(1) (base case) and proving that if P(k) is true, then P(k+1) is also true (inductive step) — together, these imply P(n) is true for all n"], answer:3},
     {q:"Use induction to prove 1 + 2 + ... + n = n(n+1)/2. The inductive step shows: if 1+...+k = k(k+1)/2, then 1+...+k+(k+1) = ___.", options:["(k+1)(k+1)/2","k(k+1)","k(k+1)/2 + (k+1) = (k+1)(k+2)/2 — which is the formula for n = k+1 ✓","k²+k/2"], answer:2},
     {q:"A single counterexample ___.", options:["strengthens a theorem by eliminating one case","has no significance in mathematics","disproves a universal statement ('for all n, P(n)') — you only need one example where the statement fails to prove it is not universally true","proves a theorem in all other cases"], answer:2}
   ]},
  {subject:"Calculus", title:"Applications of Integration: Area and Volume", summary:"Students calculate areas under curves, between curves, and volumes of solids of revolution.",
   ...
   quiz:[
     ...
     {q:"The disc method for volume of revolution around the x-axis gives ___.", options:["V = 2π∫x f(x)dx","V = π∫[f(x)]² dx from a to b — summing circular cross-sections of radius f(x)","V = π∫f(x)dx","V = ∫f(x)dx"], answer:1},
     {q:"The shell method for volume rotated around the y-axis gives ___.", options:["V = π∫f(x)²dx","V = 2∫f(x)dx","V = ∫f(x)dx","V = 2π∫x f(x)dx from a to b — summing cylindrical shell volumes"], answer:3},
  ...
  {subject:"Physics", title:"Modern Physics: Special Relativity", summary:"Students examine Einstein's special relativity — postulates, time dilation, length contraction, mass-energy equivalence, and experimental evidence.",
   ...
   quiz:[
     ...
     {q:"Time dilation means ___.", options:["a clock in motion relative to an observer runs slower than one at rest — the moving clock measures less elapsed time: Δt' = γΔt₀ where γ = 1/√(1 − v²/c²)","time passes at the same rate for all observers","clocks in motion run faster","only GPS satellites are affected"], answer:0},
     {q:"Length contraction means ___.", options:["all lengths change equally","objects appear smaller due to perspective","only length perpendicular to motion contracts","objects moving at speed v appear shorter along the direction of motion: L = L₀/γ — at relativistic speeds objects are compressed in the direction of travel"], answer:3},
     {q:"E = mc² means ___.", options:["only radioactive materials have rest energy","mass is a form of energy — a tiny mass corresponds to enormous energy (c² ≈ 9 × 10¹⁶ J/kg); this equivalence explains nuclear energy and pair production","nuclear energy is impossible to harness","mass and energy are always the same"], answer:1},
...
{day:11, label:"Day 11 — Mon", subjects:[
  {subject:"English", title:"Writing: The Argumentative Essay on a Social Issue", summary:"Students write a well-researched argumentative essay on a contemporary social or political issue, integrating sources, acknowledging counterarguments, and making an original contribution.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"A strong argumentative essay on a social issue must ___.", options:["only present one side","engage with the strongest version of the opposing view (steelmanning), not a weak caricature — and explain why your position is more defensible despite the counterargument","include emotional appeals only","avoid all statistics"], answer:1},
  ...
  {subject:"AdvancedFunctions", title:"Functions Review: Connecting All Function Families", summary:"Students synthesise the entire Advanced Functions course, connecting all function families and preparing for final assessment.",
   ...
   quiz:[
     ...
     {q:"Exponential and logarithmic functions are most important because ___.", options:["they are aesthetically pleasing","they model phenomena where a constant percentage change occurs per unit time — population growth, radioactive decay, compound interest, pH, the Richter scale","they model phenomena that are only approximately linear","they are easy to calculate"], answer:1},
     {q:"Trigonometric functions are unique among function families in that ___.", options:["they have no algebraic properties","they are periodic — they repeat their values at regular intervals, making them essential for modelling oscillatory and cyclical phenomena throughout physics and engineering","they only model sound","they are only defined for angles"], answer:1},
     {q:"Vector operations extend functions by ___.", options:["eliminating scalar quantities","allowing mathematical description of quantities that have both magnitude and direction — force, displacement, velocity — enabling 2D and 3D physics and geometry","adding direction to algebra","replacing all other functions"], answer:1},
     {q:"A student who has mastered Advanced Functions can ___.", options:["not extend to calculus","only work in pure mathematics","see a mathematical relationship and immediately identify: what type of function? What are its key features? What algebraic technique applies? What does its graph look like? — fluent pattern recognition across all function families","only solve the types of problems they've seen before"], answer:2}
   ]},
  {subject:"Calculus", title:"Calculus of Exponential and Logarithmic Functions", summary:"Students differentiate and integrate e^(ax), ln(x), and related functions, and apply these to growth/decay problems.",
   ...
   quiz:[
     ...
     {q:"A population grows at a rate proportional to its size: dP/dt = kP. The solution is ___.", options:["P(t) = P₀ + kt","P(t) = P₀(kt)","P(t) = P₀e^(kt) — solving the separable differential equation dP/P = k dt → ln P = kt + C → P = P₀e^(kt)","P(t) = ke^(P₀t)"], answer:2}
   ]},
  {subject:"Physics", title:"Nuclear Physics and Elementary Particles", summary:"Students examine nuclear reactions (fission and fusion), binding energy, and an introduction to the Standard Model of particle physics.",
   ...
   quiz:[
     {q:"Nuclear fission involves ___.", options:["radioactive beta decay","splitting a heavy nucleus (e.g., U-235) into two smaller nuclei, releasing neutrons and a large amount of energy — exploited in nuclear reactors and weapons","combining light nuclei to form heavier ones","only gamma emission"], answer:1},
     {q:"Nuclear fusion involves ___.", options:["combining light nuclei (e.g., hydrogen isotopes) to form a heavier nucleus, releasing enormous energy — the process powering stars and pursued for clean energy on Earth","splitting heavy nuclei","no energy release","only proton-electron collisions"], answer:0},
     {q:"Mass defect and binding energy: the mass of a nucleus is ___.", options:["greater than the sum of its parts","equal to the sum of its parts","slightly less than the sum of its constituent protons and neutrons — the 'missing' mass is the binding energy (E = mc²): this is the energy released when the nucleus forms","impossible to measure"], answer:2},
     {q:"The Standard Model of particle physics describes ___.", options:["the fundamental particles (quarks, leptons) and forces (electromagnetic, strong nuclear, weak nuclear) that make up all matter — gravity is not yet unified in the Standard Model","only electromagnetic forces","only the structure of atoms","only gravity and electromagnetism"], answer:0},
     {q:"The Higgs boson, discovered in 2012, is significant because ___.", options:["it is the force carrier of gravity","it was already predicted by general relativity","it creates all mass in the universe","it is the field particle associated with the Higgs field, which gives fundamental particles their mass — confirming the Standard Model's prediction after 50 years of searching"], answer:3}
   ]},
]},
{day:12, label:"Day 12 — Tue", subjects:[
  {subject:"English", title:"Media: Creating a Digital Portfolio", summary:"Students curate, design, and reflect on a digital portfolio of their best work across Grade 12, developing skills in curation, self-presentation, and digital literacy.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"A digital portfolio differs from a print portfolio in that ___.", options:["it can include only digital work","it can be hyperlinked, multimedia, and publicly accessible — connecting written work to visual, audio, and video media in ways a print portfolio cannot","it is always better","it never includes reflection"], answer:1},
     {q:"Curating a portfolio requires ___.", options:["including everything you've produced","only including the most recent work","only including error-free work","deliberate selection based on criteria: which pieces best demonstrate your range, growth, and strongest capabilities — curation is itself a creative and analytical act"], answer:3},
     {q:"The reflective statement in a portfolio item ___.", options:["only explains what the piece is about","is optional and minor","describes what grade you received","explains why you selected this piece, what it demonstrates about your thinking and skills, and what you would do differently — metacognition applied to writing"], answer:3},
     ...
     {q:"The most important quality in a digital portfolio for university or career purposes is ___.", options:["only the most technical work","as many pieces as possible","authentic evidence of your thinking — not just correct answers but genuine intellectual engagement, growth, and the distinctive qualities of your mind","the most elaborate visual design"], answer:2}
   ]},
  ...
  {subject:"Calculus", title:"Differential Equations: Separable and Initial Value Problems", summary:"Students solve separable differential equations and apply them to growth, decay, and Newton's Law of Cooling.",
   ...
   quiz:[
     {q:"A separable differential equation has the form ___.", options:["dy/dx = f(x)/g(x)","dy/dx = f(x)g(y) — the variables can be separated: dy/g(y) = f(x)dx","dy/dx = f(x) + g(y)","d²y/dx² = f(y)"], answer:1},
     ...
     {q:"An initial condition (e.g., y(0) = 5) determines ___.", options:["the form of the differential equation","only the domain of the solution","whether the equation is separable","only the constant of integration C in the general solution — giving a particular solution"], answer:3},
  ...
  {subject:"Physics", title:"Physics Year-End: Connections and Applications", summary:"Students synthesise all Grade 12 Physics — mechanics, fields, waves, modern physics — and examine how physical principles interconnect.",
   ...
   quiz:[
     {q:"The four fundamental forces of nature are ___.", options:["gravity, electromagnetism, the strong nuclear force, and the weak nuclear force — all other forces are manifestations of these four","gravity, electricity, magnetism, nuclear","friction, normal force, gravity, tension","gravity, magnetism, heat, and nuclear"], answer:0},
     {q:"Conservation laws in physics (energy, momentum, angular momentum, charge) are ___.", options:["less fundamental than Newton's Laws","only valid in isolated systems (no external forces/energy inputs) — and are among the most powerful and far-reaching principles in all of physics","only valid in classical physics","approximate — they can be violated in extreme conditions"], answer:1},
     ...
     {q:"Special relativity modifies classical mechanics at ___.", options:["only for massless particles","only in gravitational fields","speeds approaching the speed of light — at everyday speeds, relativistic corrections are negligible, and classical mechanics is an excellent approximation","all speeds"], answer:2},
     {q:"The most profound insight from Grade 12 Physics is ___.", options:["physics applies only to extreme conditions","the universe operates through mathematically precise laws — and that our human-scale intuitions, while useful approximations, break down at extreme speeds, scales, and energies in ways that reveal deeper truths about reality","only Newtonian mechanics matters","physics is only about equations"], answer:1}
   ]},
]},
{day:13, label:"Day 13 — Wed", subjects:[
  {subject:"English", title:"Independent Reading Synthesis: Personal Reading List", summary:"Students develop a personal reading list beyond the curriculum, demonstrating wide reading, independent literary judgment, and lifelong reading habits.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"Building a personal reading list involves ___.", options:["following only the curriculum","only choosing bestsellers","reading only within one genre","deliberate exploration across genres, periods, cultures, and forms — allowing recommendations, curiosity, and connections between books to guide you into territory you would not otherwise encounter"], answer:3},
     {q:"Keeping a reading journal develops ___.", options:["only for readers who become English teachers","no transferable skills","only a record of books completed","the habit of attending carefully to what you read — noting questions, images, passages, and ideas that matter to you, building a personal archive of reading that enriches all future reading and writing"], answer:3},
     {q:"A recommendation to a peer about a book should include ___.", options:["only the genre","only the plot summary","a specific reason this book is worth reading: what is distinctive about its prose, its ideas, its emotional impact, or its formal innovation — not just what it's about, but why it matters","only the theme"], answer:2},
     {q:"Reading widely beyond the curriculum benefits you by ___.", options:["replacing academic literary study","only improving your exam marks","building vocabulary, background knowledge, cultural awareness, empathy, narrative intelligence, and the capacity for sustained attention — all of which transfer to academic and professional life","only for entertainment"], answer:2},
     {q:"The lifelong reader develops ___.", options:["a distinctive relationship to language and narrative — a richer inner life, a wider frame of reference, and a deeper capacity for understanding perspectives and experiences beyond their own","only factual knowledge from books","a disinterest in other media","only literary knowledge from fiction"], answer:0}
   ]},
  {subject:"AdvancedFunctions", title:"Mathematical Modelling: Choosing the Right Function", summary:"Students apply all function families to real-world data — choosing, fitting, and interpreting mathematical models.",
   ...
   quiz:[
     {q:"When data shows exponential growth that eventually levels off, the best model is ___.", options:["a trigonometric function","a pure exponential function","a polynomial function","a logistic function — capturing rapid initial growth that slows as the population approaches carrying capacity"], answer:3},
     {q:"Data showing a repeating seasonal pattern with constant amplitude is best modelled by ___.", options:["an exponential function","a sinusoidal (trigonometric) function — periodic data requires a periodic model","a linear function","a polynomial"], answer:1},
     {q:"Data about the cooling of an object over time is best modelled by ___.", options:["a polynomial of degree 2","a linear function","a sinusoidal function","an exponential decay function — Newton's Law of Cooling produces exponential temperature change"], answer:3},
     ...
     {q:"The most important limitation of any mathematical model is ___.", options:["models are always perfect representations","it is a simplification of reality — it captures some aspects of the phenomenon and misses others; the skill is knowing which simplifications are acceptable for the purpose at hand","they require too much computation","they can never be made by students"], answer:1}
   ]},
  {subject:"Calculus", title:"Applications: Calculus in Science and Engineering", summary:"Students apply differentiation and integration to physics (motion, work, fluid pressure) and examine the role of calculus in modern science.",
   ...
   quiz:[
     ...
     {q:"Work done by a variable force F(x) over displacement from a to b is ___.", options:["F × (b − a)","∫[a to b] F(x) dx — summing infinitesimal work elements, which requires integration when F varies","F(a) × (b − a)","F(b) − F(a)"], answer:1},
     {q:"The average value of a continuous function f on [a, b] is ___.", options:["[f(b)−f(a)]/(b−a)","f(a) + f(b))/2 (only for linear functions)","∫[a to b]f(x)dx","[1/(b−a)] × ∫[a to b]f(x)dx — the integral divided by the interval length"], answer:3},
     {q:"Calculus is fundamental to ___.", options:["only physics","physics (motion, fields, thermodynamics), engineering (design, control systems), economics (marginal analysis), biology (population models), and statistics (probability distributions) — it is the mathematical language of change","only pure mathematics","only engineering"], answer:1},
     {q:"The most important insight calculus provides is ___.", options:["that mathematics can only describe simple systems","only how to find slopes","how to calculate derivatives and integrals","that continuous change can be understood by examining it at an infinitesimal scale — and that the process of accumulation (integration) and the process of change (differentiation) are inverse operations"], answer:3}
   ]},
  {subject:"Physics", title:"Astrophysics: Stars, Galaxies, and Cosmology", summary:"Students examine stellar evolution, galaxy structure, and the Big Bang model of the universe, connecting nuclear physics and gravity to astrophysics.",
   ...
   quiz:[
     {q:"A star generates energy through ___.", options:["chemical combustion","nuclear fusion — hydrogen nuclei fuse to form helium in the stellar core, releasing energy from the mass defect","only gravitational contraction","nuclear fission of heavy elements"], answer:1},
     {q:"The Hertzsprung-Russell (H-R) diagram plots ___.", options:["speed vs. mass","distance vs. age","luminosity vs. surface temperature — revealing that most stars (on the 'main sequence') have a predictable relationship between these quantities","temperature vs. position"], answer:2},
     {q:"A neutron star forms when ___.", options:["a massive star undergoes a supernova and its core collapses — protons and electrons combine to form neutrons, producing an incredibly dense object roughly the size of a city","a star explodes without collapse","a star runs out of hydrogen only","any star dies"], answer:0},
     {q:"The observed redshift of distant galaxies demonstrates ___.", options:["the universe is expanding — light from distant galaxies is shifted toward longer (red) wavelengths, consistent with recessional velocity increasing with distance (Hubble's Law)","the universe is contracting","the speed of light is increasing","only that galaxies are old"], answer:0},
     {q:"The Cosmic Microwave Background (CMB) is ___.", options:["radiation from the first stars","noise in early radio equipment","only visible with optical telescopes","thermal radiation left over from when the universe cooled enough for atoms to form (~380,000 years after the Big Bang) — the strongest evidence for the Big Bang model"], answer:3}
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  {subject:"English", title:"Grade 12 English: Culminating Preparation", summary:"Students prepare for their culminating essay and exam, reviewing the year's literary works and refining their analytical approaches.",
   ...
   quiz:[
     ...
     {q:"Preparing for a literary exam involves ___.", options:["only re-reading all the texts","only memorising quotations","understanding each text's formal choices, key thematic concerns, and the arguments you could make about it — having 2-3 developed analytical positions for each major text","only reviewing the plot of each text"], answer:2},
     {q:"The most effective use of quotations in a timed essay is ___.", options:["using as many as possible","always using long quotations","only using quotations in the introduction","shorter, precisely targeted quotations that require and reward analysis — a brief, telling phrase you can unpack analytically is better than a long passage you merely describe"], answer:3},
     {q:"Engaging with literary criticism in a culminating essay shows ___.", options:["that critics are always right","that you can position your own reading in relation to existing scholarly perspectives — agreeing, disagreeing, extending, or qualifying a critical position with textual evidence","that you have no original ideas","only that you have read critics"], answer:1},
  ...
  {subject:"AdvancedFunctions", title:"Advanced Functions Final Assessment Review", summary:"Students review all major course concepts and practise exam-level problems.",
   ...
   quiz:[
     {q:"The graph of f(x) = x(x−2)²(x+1)³ has x-intercepts at ___.", options:["x = 0, 2, −1 with multiplicities 1, 2, 3 respectively — crosses at 0 and −1, touches at 2","x = 0, 4, 3","x = 0 and x = 1 only","x = 0, 2, 1"], answer:0},
  ...
  {subject:"Calculus", title:"Calculus Final Assessment Review", summary:"Students review all major Calculus content and practise exam-level problems.",
   ...
   quiz:[
     {q:"Evaluate: lim(x→0) of (sin x)/x.", options:["lim(x→0) sin(x)/x = 1 (a fundamental limit in calculus — proved by the squeeze theorem or L'Hôpital's Rule)","−1","∞","0"], answer:0},
...
{day:15, label:"Day 15 — Fri", subjects:[
  {subject:"English", title:"Grade 12 English: Exam and Celebration", summary:"A final celebration of Grade 12 English — reflecting on the year's literary journey and looking ahead to university and lifelong reading.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/c/TEDEd",
   quiz:[
     {q:"Grade 12 English culminates in ___.", options:["the end of reading and writing as serious pursuits","only exam preparation","completed study of English","a genuine transformation — students who engage deeply emerge as fundamentally different readers and thinkers, with analytical skills, literary knowledge, and communicative power that will serve them throughout their lives"], answer:3},
     {q:"The connection between literature and university study is ___.", options:["the analytical, argumentative, and communicative skills developed in literary study are fundamental to success in virtually any university discipline — history, law, political science, philosophy, psychology, and increasingly science communication","literature is only relevant in humanities programs","literature is not studied at university","no connection"], answer:0},
     ...
     {q:"The writers you have studied in Grade 12 ___.", options:["have given you intellectual companions — voices you can return to throughout your life, finding new meaning as your own experience grows","are only relevant in academic contexts","have taught you only literary technique","are now no longer relevant"], answer:0},
     {q:"English, as a discipline and a practice, is ___.", options:["only about grammar and spelling","a set of skills you've now mastered and completed","only about fiction and poetry","a lifelong pursuit — language and literature are not finished, not mastered, not set aside after graduation but lived with, returned to, and deepened throughout a human life"], answer:3}
   ]},
  {subject:"AdvancedFunctions", title:"Looking Back, Looking Forward", summary:"Students reflect on their mathematical development across MHF4U and its connection to university mathematics.",
   ...
   quiz:[
     {q:"Advanced Functions has prepared you for university mathematics by ___.", options:["only for students in STEM programs","teaching you all the mathematics you will ever need","developing fluency in function analysis — the foundation for calculus, linear algebra, statistics, and all quantitative reasoning at university level","being equivalent to first-year university calculus"], answer:2},
     ...
     {q:"Finishing Advanced Functions means ___.", options:["you have the mathematical tools to pursue virtually any university program — and more importantly, you have experienced mathematical thinking at a level that trains the mind for rigorous reasoning in any field","you are done with mathematics","you need no further mathematical study","only that you passed the course"], answer:0}
   ]},
  {subject:"Calculus", title:"Calculus: Looking Back and Forward", summary:"Students reflect on the year's learning in calculus and its connections to the mathematical sciences.",
   ...
   quiz:[
     {q:"The Fundamental Theorem of Calculus is profound because ___.", options:["it is the most complex theorem in mathematics","it reveals that differentiation and integration — apparently unrelated operations — are inverse operations, unifying two major streams of mathematical thinking into a single theory","it makes integration easier to compute","only because it involves two operations"], answer:1},
     {q:"Calculus was developed independently by ___.", options:["Descartes and Fermat","Gauss and Euler","Newton and Leibniz in the 17th century — a famous priority dispute, but their discoveries were genuinely independent and used different notation (we use Leibniz's)","Euclid and Archimedes"], answer:2},
     {q:"The most important application of calculus in the 21st century is ___.", options:["only in physics","only bridge design","arguably machine learning — the training of neural networks relies on gradient descent (an application of multivariable calculus) to optimise complex functions with millions of parameters","only in engineering"], answer:2},
     {q:"Differential equations (which you've begun) are ___.", options:["the language in which most of science is written — from Newton's laws to quantum mechanics to epidemiology to population ecology, the universe is described by equations relating rates of change","a minor extension of introductory calculus","only for engineers","less important than algebra"], answer:0},
     {q:"Completing Grade 12 Calculus means ___.", options:["you have mastered all of calculus","you have the foundation to study multivariable calculus, differential equations, and real analysis at university — the door to the mathematical sciences is open","university calculus will be completely familiar","calculus is now closed to you"], answer:1}
   ]},
  {subject:"Physics", title:"Physics: A Final Reflection", summary:"Students reflect on their learning in Grade 12 Physics and the role of physics in understanding the universe.",
   ...
   quiz:[
     {q:"Physics is the most fundamental science because ___.", options:["its principles underlie chemistry, biology, and engineering — chemistry is physics applied to electrons, biology applies chemical and physical principles to living systems, and all technology exploits physical laws","it is the oldest science","it is the most difficult","only physicists understand it"], answer:0},
     {q:"The history of physics shows ___.", options:["a series of revolutionary conceptual shifts — from Aristotle to Newton, from Newton to Einstein, from classical to quantum — each overturning apparently solid knowledge and revealing something deeper","major changes in understanding are no longer possible","only a gradual accumulation of facts","physics is a complete and finished discipline"], answer:0},
     {q:"Quantum mechanics and general relativity, the two great theories of 20th century physics, ___.", options:["are in perfect agreement","have been completely unified","are both spectacularly confirmed but mutually inconsistent — their reconciliation (quantum gravity) is one of the greatest unsolved problems in all of science","have no experimental support"], answer:2},
     {q:"Physics shapes your daily life through ___.", options:["only large-scale technologies","only electrical devices","everything: the transistors in your phone, the GPS that locates you, the medical imaging that diagnoses disease, the lasers that read discs, the superconductors in MRI machines — all rest on 20th century physics","no practical applications in everyday life"], answer:2},
     {q:"The greatest gift of physics education is ___.", options:["the habit of asking 'why does this happen?' and having confidence that patient, systematic inquiry can reveal the answer — the physicist's mindset: curiosity, rigour, and belief in the comprehensibility of nature","passing the exam","knowing all the formulas","only useful if you study physics at university"], answer:0}
   ]},
]},
{day:16, label:"Day 16 — Mon", subjects:[
  {subject:"English", title:"Postcolonial Literature: Writing Back to Empire", summary:"Students examine postcolonial theory and its application to literary texts — how writers from formerly colonised nations rewrite colonial narratives.",
   ...
   quiz:[
     {q:"The term 'writing back' (Ashcroft et al.) refers to ___.", options:["only protest poetry","authors responding to publisher rejections","postcolonial writers engaging with, subverting, and rewriting the canonical texts of the colonising culture — reclaiming language and narrative for suppressed perspectives","only African literature"], answer:2},
     {q:"Chinua Achebe's critique of Conrad's Heart of Darkness argues ___.", options:["Conrad dehumanises Africans by making Africa merely a backdrop for a European psychological journey — denying African people interiority, agency, and humanity","the novel is flawless","the novel is primarily about navigation","Conrad was not a racist"], answer:0},
     {q:"The use of the coloniser's language by postcolonial writers is ___.", options:["a complex negotiation — some see it as accommodation, others as strategic subversion; many writers (Achebe, Ngugi, Rushdie) have debated this directly in essays and in their fiction","a sign of cultural defeat","unproblematic and straightforward","never chosen freely"], answer:0},
     {q:"Hybridity (Homi Bhabha) in postcolonial literature refers to ___.", options:["mixing languages only","the complex cultural mixing produced by colonialism — neither purely coloniser nor colonised, but a 'third space' of negotiated identity","cultural purity in new nations","a purely biological concept"], answer:1},
     {q:"Applying postcolonial theory to a Canadian text requires ___.", options:["acknowledging Canada's specific colonial history — both as a British colony and as a settler-colonial state with ongoing impacts on Indigenous peoples — a complex dual position","recognising Canada has no colonial history","treating all colonial experiences as identical","only examining French-English relations"], answer:0}
   ]},
  {subject:"AdvancedFunctions", title:"Vectors in Three Dimensions", summary:"Students extend 2D vector concepts to 3D — Cartesian coordinates, vector operations, magnitude, dot product, and angle between vectors.",
   ...
   quiz:[
     {q:"A vector in 3D is written as ___.", options:["a = (a₁, a₂, a₃) or a₁i + a₂j + a₃k — three components corresponding to x, y, z directions","x + y + z","[x:y:z]","(x, y)"], answer:0},
     ...
     {q:"The angle θ between vectors a and b satisfies ___.", options:["cosθ = |a|/|b|","tanθ = a·b","sinθ = a·b/(|a||b|)","cosθ = a·b/(|a||b|) — rearranging the dot product formula: a·b = |a||b|cosθ"], answer:3},
  ...
  {subject:"Physics", title:"Momentum and Impulse", summary:"Students analyse linear momentum, impulse, and the impulse-momentum theorem in collision contexts.",
   ...
   quiz:[
     ...
     {q:"Conservation of linear momentum applies when ___.", options:["friction is absent","all forces are equal","no net external force acts on the system — the total momentum before equals total momentum after, regardless of what happens internally","the system is in free fall"], answer:2},
     {q:"In a perfectly inelastic collision ___.", options:["kinetic energy is conserved","both objects pass through each other","the objects bounce elastically","the objects stick together — momentum is conserved but kinetic energy is not; some KE converts to heat, sound, or deformation"], answer:3},
...
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"English", title:"Comparative Essay: World Literature", summary:"Students write a formal comparative essay on two world literature texts, applying university-level analytical standards.",
   ...
   quiz:[
     {q:"A comparative essay thesis must ___.", options:["describe similarities only","only list the works to be compared","treat works as entirely separate","make a claim about what the comparison reveals — not just 'A and B are similar/different' but 'this specific similarity/difference illuminates X about both texts'"], answer:3},
     {q:"Integrating two texts in a comparative essay is best done by ___.", options:["never mixing the texts","only using plot summaries","using a point-by-point structure for analytical comparison — each paragraph focuses on a specific comparative point, weaving both texts together to support the analytical claim","discussing one text fully, then the other (block method always)"], answer:2},
     {q:"When comparing texts from different cultural contexts, a student must ___.", options:["treat one culture as the norm and the other as exotic","acknowledge the cultural and historical specificity of each text — avoid imposing one cultural framework on the other, and use both contexts to enrich the comparison","assume all cultures value the same things","only focus on form, not context"], answer:1},
     {q:"The most sophisticated comparative essays ___.", options:["only describe similarities","find a productive tension — a similarity that conceals difference, or a difference that reveals a shared concern — and use this to generate genuine analytical insight","treat texts independently and in parallel only","only note obvious differences"], answer:1},
     {q:"Works from different languages in translation present ___.", options:["opportunities to compare style directly","a specific interpretive challenge — you are reading the translator's choices as well as the author's, and you should acknowledge this while still engaging meaningfully with the available text","no issues since translation is neutral","no analytical interest"], answer:1}
   ]},
  {subject:"AdvancedFunctions", title:"Lines and Planes in Three Dimensions", summary:"Students write vector and parametric equations of lines in 3D, and scalar and vector equations of planes.",
   ...
   quiz:[
     {q:"The vector equation of a line through point P₀=(x₀,y₀,z₀) with direction d=(a,b,c) is ___.", options:["r = (x₀,y₀,z₀) + t(a,b,c) — a point plus a scalar multiple of the direction vector","r = d × P₀","r = P₀ + t (the direction is missing)","r = (x₀+a, y₀+b, z₀+c)"], answer:0},
     {q:"The parametric equations of the same line are ___.", options:["x=x₀+at, y=y₀+bt, z=z₀+ct — one equation per dimension, each parameterised by t","only x = x₀ + at","x=at, y=bt, z=ct only","x=x₀t, y=y₀t, z=z₀t"], answer:0},
     {q:"The scalar (Cartesian) equation of a plane with normal n=(A,B,C) through (x₀,y₀,z₀) is ___.", options:["A(x+x₀)+B(y+y₀)+C(z+z₀)=0","A(x−x₀)+B(y−y₀)+C(z−z₀)=0 — or equivalently Ax+By+Cz=D where D=Ax₀+By₀+Cz₀","A+B+C=D","Ax + By + Cz = 0 (only if through origin)"], answer:1},
     ...
     {q:"A line is perpendicular to a plane when ___.", options:["the line passes through the origin","the line's direction vector is parallel to the plane's normal vector — the line points in the same direction as the normal","the line has slope 1","the line's direction vector is horizontal"], answer:1}
   ]},
  {subject:"Calculus", title:"L'Hôpital's Rule and Indeterminate Forms", summary:"Students apply L'Hôpital's Rule to evaluate limits of indeterminate forms (0/0, ∞/∞, ∞−∞, 0·∞).",
   ...
   quiz:[
     {q:"L'Hôpital's Rule states that if lim f/g = 0/0 or ∞/∞, then ___.", options:["lim f(x)/g(x) = lim f'(x)/g'(x) — provided the latter limit exists; differentiate numerator and denominator separately (not the quotient rule)","lim f/g = f/g evaluated at the limit point","lim f/g = lim (f+g)","lim f/g = lim (f−g)/(g)"], answer:0},
     ...
     {q:"Evaluate lim(x→∞) x/eˣ.", options:["The limit is ∞","L'Hôpital (∞/∞): lim 1/eˣ = 0 — exponentials grow faster than polynomials","The limit is 1","L'Hôpital: lim 1/xeˣ"], answer:1},
  ...
  {subject:"Physics", title:"Conservation of Momentum: Collisions in 2D", summary:"Students apply conservation of momentum to two-dimensional collisions, resolving vectors into components.",
   ...
   quiz:[
     {q:"For a 2D collision, conservation of momentum applies ___.", options:["independently to both x and y components simultaneously — momentum is a vector, so each component is separately conserved","only in the horizontal direction","only for elastic collisions","only if no friction acts"], answer:0},
     {q:"In a 2D elastic collision, both ___ and ___ are conserved.", options:["force and time","momentum (vector) and kinetic energy (scalar) — both are conserved simultaneously","mass and velocity","mass and charge"], answer:1},
     {q:"A 2 kg ball moving at 5 m/s east hits a 2 kg ball at rest. After collision ball 1 moves north. By symmetry (equal masses, elastic):", options:["ball 2 moves east at 5 m/s, ball 1 stops — total KE and momentum conserved (for equal mass elastic head-on collision)... but this is 2D so ball 1 moves north — ball 2 moves east at 5 m/s","ball 1 bounces back west","both stop","both balls move east at 2.5 m/s"], answer:0},
     {q:"The coefficient of restitution e = ___.", options:["e = v₁_initial/v₂_final","e = m₁/m₂","e = final momentum/initial momentum","e = relative speed after/relative speed before — 0 for perfectly inelastic, 1 for perfectly elastic"], answer:3},
...
{day:18, label:"Day 18 — Wed", subjects:[
  {subject:"English", title:"Literary Theory: Reading Through a Lens", summary:"Students apply feminist, Marxist, and psychoanalytic critical lenses to literary texts, understanding how theory shapes interpretation.",
   ...
   quiz:[
     {q:"Applying a critical lens to a text means ___.", options:["finding the one correct interpretation","using a theoretical framework to ask specific questions of the text — the lens determines what you notice, what questions you ask, and how you interpret what you find","proving the author had specific intentions","only citing theory in a bibliography"], answer:1},
     {q:"Feminist literary criticism examines ___.", options:["how texts construct, reinforce, challenge, or subvert gender roles and the social, political, and economic structures that subordinate women — applied to texts by any author","only gender in isolation from other factors","only texts with female protagonists","only texts by women"], answer:0},
     {q:"Marxist literary criticism examines ___.", options:["only communist literature","how texts reflect, reinforce, or critique the economic base and ideological superstructure of society — including class, labour, power, and commodity relations","only class conflict in plot","only economic statistics in fiction"], answer:1},
     {q:"Psychoanalytic literary criticism (Freud, Lacan) examines ___.", options:["the unconscious dimensions of texts — repression, desire, the uncanny, dream logic, the dynamics of id/ego/superego or Lacanian registers (Symbolic, Imaginary, Real)","only mentally ill characters","only the author's biography","only obvious symbolism"], answer:0},
     {q:"The danger of applying theory mechanically is ___.", options:["the theory becomes irrelevant","theory always improves a reading","the text is reduced to an illustration of the theory — sophisticated critical work uses theory as a lens to illuminate specific textual details, not as a formula that produces predetermined readings","no danger exists in using theory"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"The Cross Product in 3D", summary:"Students compute cross products of 3D vectors and apply them to find normals to planes, areas of parallelograms, and equations of planes.",
   ...
   quiz:[
     {q:"The cross product a × b produces ___.", options:["a vector perpendicular to both a and b — with magnitude |a||b|sinθ","a scalar equal to |a||b|cosθ","the component-wise product of two vectors","the dot product of two vectors"], answer:0},
     ...
     {q:"a × b = −(b × a) means ___.", options:["cross product is commutative","cross product is anti-commutative — reversing the order reverses the direction of the resulting vector; the magnitude is the same","cross product always gives zero","a × b and b × a are equal"], answer:1}
   ]},
  {subject:"Calculus", title:"Implicit Differentiation and Inverse Functions", summary:"Students apply implicit differentiation to curves defined implicitly, and differentiate inverse trigonometric and general inverse functions.",
   ...
   quiz:[
     {q:"Implicit differentiation is needed when ___.", options:["y cannot easily be isolated — you differentiate both sides with respect to x, treating y as a function of x and applying the chain rule whenever y appears","the function is a polynomial","the function has no y variable","y is explicitly solved in terms of x"], answer:0},
  ...
  {subject:"Physics", title:"Simple Harmonic Motion", summary:"Students analyse SHM — period, frequency, amplitude, restoring force — and apply to springs and pendulums.",
   ...
   quiz:[
     {q:"Simple harmonic motion occurs when ___.", options:["speed is constant","the restoring force is proportional to and opposite to the displacement: F = −kx — this produces sinusoidal oscillation","the amplitude increases over time","the restoring force is constant"], answer:1},
     ...
     {q:"The total mechanical energy in SHM is ___.", options:["constant: E = ½kA² (where A is amplitude) — KE and PE convert to each other, but their sum is always ½kA²","only potential energy","only kinetic energy","zero at the equilibrium position"], answer:0},
     {q:"At maximum displacement (amplitude) in SHM, the velocity is ___ and acceleration is ___.  ", options:["maximum and zero","zero and zero","maximum and maximum","zero and maximum — at the endpoints, the object momentarily stops (v=0) and the restoring force (and thus acceleration) is greatest"], answer:3}
   ]},
]},
{day:19, label:"Day 19 — Thu", subjects:[
  {subject:"English", title:"Satire: Social Critique Through Comedy", summary:"Students analyse satire as a literary mode — examining targets, techniques (irony, parody, exaggeration), and the ethics and limits of satirical writing.",
   ...
   quiz:[
     {q:"Satire differs from simple comedy in that ___.", options:["satire is never funny","satire is always gentler than direct critique","satire uses humour to expose, criticise, and potentially reform human folly, vice, or social institutions — comedy is an end in itself; satirical comedy is a means to a critical end","satire has no political dimension"], answer:2},
     ...
     {q:"Juvenalian satire (after Juvenal) is characterised by ___.", options:["bitter, contemptuous indignation — the satirist condemns and attacks; the tone is harsh, the critique unsparing","praise of the satirical target","gentle humour","no exaggeration"], answer:0},
     {q:"Jonathan Swift's 'A Modest Proposal' uses ___.", options:["sustained irony — the narrator's reasonable tone and logical precision make the monstrous proposal (eating Irish babies) more horrifying, not less; the gap between manner and content is the satirical engine","straightforward rhetorical argument","pure comedy without bite","direct emotional appeal"], answer:0},
     {q:"The ethics of satire involve ___.", options:["no ethical considerations","that any target is fair game","difficult questions about power: satire that 'punches down' (mocks the vulnerable) is ethically different from satire that challenges power — and the line is not always clear","only attacking powerful institutions"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"Equations of Lines and Planes: Intersections and Distances", summary:"Students find intersections of lines and planes in 3D and calculate distances from points to lines and planes.",
   ...
   quiz:[
     ...
     {q:"The distance from point P=(x₁,y₁,z₁) to plane Ax+By+Cz=D is ___.", options:["|Ax₁+By₁+Cz₁|","√(A²+B²+C²)","|AP₁|","|Ax₁+By₁+Cz₁−D|/√(A²+B²+C²) — a formula analogous to the 2D point-to-line distance"], answer:3},
  ...
  {subject:"Calculus", title:"Mean Value Theorem and Monotonicity", summary:"Students state and apply the Mean Value Theorem, Rolle's Theorem, and use them to analyse function behaviour.",
   ...
   quiz:[
     {q:"Rolle's Theorem states: if f is continuous on [a,b], differentiable on (a,b), and f(a)=f(b), then ___.", options:["there exists c in (a,b) such that f'(c) = 1","f is constant on [a,b]","f has no local extrema","there exists c in (a,b) such that f'(c) = 0 — at least one point where the tangent is horizontal"], answer:3},
     {q:"The Mean Value Theorem states: if f is continuous on [a,b] and differentiable on (a,b), then ___.", options:["there exists c in (a,b) such that f'(c) = [f(b)−f(a)]/(b−a) — the instantaneous rate equals the average rate at some interior point","f(a) = f(b) always","f achieves its maximum at a or b","f'(x) = 0 for some x"], answer:0},
     ...
     {q:"If f'(x) > 0 for all x in (a,b), then the MVT implies ___.", options:["f(a) = f(b)","f has no extrema only","f is strictly increasing on (a,b) — a corollary: a positive derivative implies increasing function","f is constant"], answer:2},
     {q:"If f'(x) = g'(x) for all x, then ___.", options:["f(x) = g(x)","f(x) = g(x) + C for some constant C — their derivatives being equal means they can only differ by a constant (a direct corollary of the MVT)","f and g are both zero","no relationship can be inferred"], answer:1}
   ]},
  {subject:"Physics", title:"Wave Superposition and Interference", summary:"Students analyse the superposition of waves — constructive and destructive interference, standing waves, and resonance in strings and air columns.",
   ...
   quiz:[
     {q:"The principle of superposition states ___.", options:["only two waves can interfere","louder waves always dominate","waves cannot occupy the same space","when two or more waves overlap, the resultant displacement is the algebraic sum of the individual displacements — waves pass through each other unchanged"], answer:3},
     ...
     {q:"Destructive interference occurs when ___.", options:["waves have equal amplitudes only","waves arrive out of phase (path difference = (n+½)λ) — crest meets trough, producing minimum or zero amplitude","waves travel in opposite directions","path difference = nλ"], answer:1},
     {q:"A standing wave on a string fixed at both ends has nodes at ___.", options:["antinodes only","only at the centre","the fixed endpoints — and additional nodes at intervals of λ/2; antinodes are halfway between nodes","random positions along the string"], answer:2},
...
{day:20, label:"Day 20 — Fri", subjects:[
  {subject:"English", title:"The Research Essay: Argument and Evidence at University Level", summary:"Students write and revise a fully documented research essay integrating primary texts, secondary criticism, and their own analysis.",
   ...
   quiz:[
     {q:"A literary research essay differs from a personal response in that ___.", options:["it is longer only","personal response is always better","it situates your argument within the existing critical conversation — using secondary sources to identify what critics have argued and positioning your own reading in relation to that conversation","it does not use primary texts"], answer:2},
     {q:"Selecting secondary sources for a literary research essay requires ___.", options:["only using Wikipedia and study guides","only the most recent criticism","peer-reviewed scholarly articles and books — sources that have been evaluated by experts in the field and make rigorous, evidence-based arguments about the text","any online source about the author"], answer:2},
     {q:"Synthesising sources in a research essay means ___.", options:["never agreeing with any source","weaving together multiple perspectives to illuminate your own argument — sources speak to each other and to your thesis, not just in sequence","quoting each source in order","only summarising each source separately"], answer:1},
     {q:"MLA citation requires ___.", options:["only in-text page numbers for everything","in-text citations (author page#) and a corresponding Works Cited page — for online sources, include URL or DOI and access date as applicable","only footnotes, no bibliography","only a bibliography, no in-text citation"], answer:1},
     {q:"Academic integrity in a research essay means ___.", options:["only quoting correctly","citing every source of ideas, information, and argument (whether quoted, paraphrased, or summarised) and presenting your own original synthesis and argument — not reproducing others' analysis as your own","only avoiding copy-paste","only citing sources you agree with"], answer:1}
   ]},
  {subject:"AdvancedFunctions", title:"Geometric Vectors: Applications to Physics and Engineering", summary:"Students apply 3D vector concepts to displacement, velocity, force equilibrium, and work problems.",
   ...
   quiz:[
     {q:"Resolving a force into components in 3D uses ___.", options:["trigonometry only","F = Fₓi + F_yj + F_zk — decomposing the force vector into x, y, z components using direction cosines or given angles","only the magnitude of the force","the dot product alone"], answer:1},
     {q:"For three forces to be in equilibrium, their vector sum must be ___.", options:["zero: F₁ + F₂ + F₃ = 0 — equilibrium means no net force, so all components sum to zero","equal to the largest force","non-zero","pointing downward"], answer:0},
     {q:"The scalar projection of a onto b is ___.", options:["a×b","|a||b|","a·b (the full dot product)","a·b̂ = a·b/|b| — the signed magnitude of a's component in the direction of b"], answer:3},
     {q:"The vector projection of a onto b is ___.", options:["a × b","(a·b̂)b̂ = (a·b/|b|²)b — the component of a in the direction of b, as a vector","a·b/|b|²","|a|cosθ"], answer:1},
     {q:"Work done by a force F over displacement d is ___.", options:["F + d","|F||d|","W = F · d = |F||d|cosθ — only the component of force in the direction of displacement does work","F × d (cross product — this gives a vector, not work)"], answer:2}
   ]},
  {subject:"Calculus", title:"Integration by Substitution", summary:"Students apply the substitution rule (u-substitution) to evaluate indefinite and definite integrals of composite functions.",
   ...
   quiz:[
     {q:"The substitution rule reverses ___.", options:["the quotient rule","the chain rule — if the integrand is of the form f(g(x))g'(x), let u = g(x), du = g'(x)dx, and integrate f(u)du","the power rule","the product rule"], answer:1},
  ...
  {subject:"Physics", title:"Optics: Reflection and Refraction", summary:"Students apply the law of reflection and Snell's Law to mirrors, lenses, and fibre optics; analyse total internal reflection.",
   ...
   quiz:[
     ...
     {q:"Snell's Law of refraction is ___.", options:["n₁sinθ₁ = n₂sinθ₂ — where n is the index of refraction; light bends toward the normal when entering a denser medium","n₁θ₁ = n₂θ₂","n₁cosθ₁ = n₂cosθ₂","n₁/sinθ₁ = n₂/sinθ₂"], answer:0},
     {q:"Total internal reflection occurs when ___.", options:["any light passes from air to glass","light passes from glass to air at any angle","n₁ < n₂","the angle of refraction reaches 90° (critical angle sinθ_c = n₂/n₁) and beyond — light is entirely reflected back into the denser medium"], answer:3},
     ...
     {q:"Optical fibre works by ___.", options:["total internal reflection — light is repeatedly totally internally reflected along the fibre, allowing lossless transmission of data over long distances","total reflection from metal coatings","only working in vacuum","absorption of light"], answer:0}
   ]},
]},
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"English", title:"The Novel as Social Document: Realism and Its Discontents", summary:"Students examine realist novels and their sociological dimension — how fiction can document social reality while remaining art.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/watch?v=qGHBcRcPQeI",
   quiz:[
     {q:"Nineteenth-century realism in the novel aimed to ___.", options:["represent society as it actually is — with documentary precision, attention to social class, economic conditions, and the quotidian lives of ordinary people, not just heroes and aristocrats","create pure fantasy worlds","avoid representing working-class life","focus only on aristocratic characters"], answer:0},
     {q:"The sociological reading of a novel examines ___.", options:["only the author's biography","only plot and character","how the novel reflects and critiques the social structures, ideologies, and class relations of its historical moment — what it can tell us about the world that produced it","only style and form"], answer:2},
     {q:"A 'condition of England' novel (like those by Dickens or Gaskell) characteristically ___.", options:["only follows middle-class characters","dramatises a contemporary social problem — poverty, industrialisation, factory conditions, child labour — as a way of drawing public attention to injustice","avoids contemporary social problems","romanticises the past"], answer:1},
     ...
     {q:"Contemporary fiction as social document includes ___.", options:["only 'issues novels' without literary merit","no claim to documentary accuracy","only literary fiction set in the past","novels that address climate change, algorithmic culture, economic precarity, migration, and racial justice — fiction as a mode of social imagination that can reveal what statistics and journalism cannot"], answer:3}
   ]},
  {subject:"AdvancedFunctions", title:"Vectors: Applications to Navigation and Problem Solving", summary:"Students apply 3D vector techniques to navigation, structural problems, and multi-step applied problems.",
   ...
   quiz:[
     {q:"A boat travels at 20 km/h in a river with current 5 km/h perpendicular. Its actual speed is ___.", options:["15 km/h","√(20² + 5²) = √425 ≈ 20.6 km/h — vector addition of boat velocity and current velocity","25 km/h","10 km/h"], answer:1},
     ...
     {q:"Forces of 30 N north and 40 N east act on an object. The resultant force is ___.", options:["50 N due northeast","50 N at arctan(40/30) N of E — √(30²+40²) = 50 N; direction = arctan(E/N) from north","70 N","10 N"], answer:1},
     ...
     {q:"A force of (3, 4, 0) N acts over displacement (1, 1, 5) m. Work done = ___.", options:["3+4+1+1+5 = 14 J","(3+4+0)(1+1+5) = 49 J","√(3²+4²+0²) J","3·1 + 4·1 + 0·5 = 7 J — dot product gives scalar work"], answer:3}
   ]},
  {subject:"Calculus", title:"Integration by Parts", summary:"Students apply the integration by parts formula to products of functions, including repeated application and tabular method.",
   ...
   quiz:[
     ...
     {q:"∫x²·sin(x) dx requires ___.", options:["no special technique","two applications of integration by parts (or the tabular method) — the power of x reduces each time until only sin(x) remains","one application of parts","u-substitution only"], answer:1},
     {q:"The mnemonic LIATE suggests choosing u as ___.", options:["the function that comes first in: Logarithm, Inverse trig, Algebraic, Trig, Exponential — generally the 'earlier' choice makes du simpler","the last function in the product","the exponential always","the function that differentiates to zero"], answer:0}
   ]},
  {subject:"Physics", title:"The Photoelectric Effect and Wave-Particle Duality", summary:"Students examine the photoelectric effect, photon model of light, and the evidence for wave-particle duality.",
   ...
   quiz:[
     ...
     {q:"Classical wave theory failed to explain the photoelectric effect because ___.", options:["it correctly predicted everything","it predicted that any frequency of light would eject electrons given enough intensity — but experiment showed frequency, not intensity, determines if electrons are ejected","it predicted no electrons would be emitted","it predicted only red light would work"], answer:1},
     {q:"Einstein's explanation of the photoelectric effect (1905) proposed ___.", options:["light is purely a particle with no wave properties","the metal surface is the key factor","light energy comes in discrete packets (photons) of energy E = hf — below the threshold frequency, no single photon has enough energy to eject an electron regardless of intensity","the current from the battery ejects electrons"], answer:2},
...
{day:22, label:"Day 22 — Tue", subjects:[
  {subject:"English", title:"Short Fiction Masterworks: Structure, Voice, and Compression", summary:"Students study canonical short stories, examining how compressed form demands particular mastery of voice, structure, epiphany, and economy of language.",
   ...
   quiz:[
     {q:"The short story differs from the novel in that ___.", options:["it demands absolute economy — every word must work; there is no space for subplots, extended development, or leisurely description — the form itself creates pressure","it is always easier to write","it can never achieve the depth of a novel","it has no character development"], answer:0},
     {q:"The 'epiphany' in Joyce's short fiction (from 'Dubliners') refers to ___.", options:["a moment of sudden insight or revelation — often quiet and internal — when a character perceives something essential about themselves or their situation","a surprise plot twist","a religious experience only","the story's happy ending"], answer:0},
     {q:"Point of view in a short story is especially important because ___.", options:["point of view has no relation to meaning","third person is always better","first person is always best","the limited space means the narrative voice is almost everything — the angle from which the story is told determines what is knowable, what is visible, and what the reader can understand"], answer:3},
     {q:"Chekhov's famous 'gun' principle states ___.", options:["every story needs violence","stories should be realistic only","if a gun is shown in the first act, it must be fired by the third — dramatic economy requires that every element introduced must be relevant; details are significant precisely because they are selected","guns are important in Russian fiction"], answer:2},
     {q:"Compression in short fiction achieves ___.", options:["only brevity without depth","less than the novel in all respects","nothing that a longer story could not do better","a different kind of intensity — the reader carries more weight; implication, suggestion, and what is left unsaid become as important as what is stated, creating resonant ambiguity"], answer:3}
   ]},
  {subject:"AdvancedFunctions", title:"Counting Principles and Permutations", summary:"Students apply the fundamental counting principle, permutations (with and without repetition), and circular permutations to combinatorics problems.",
   ...
   quiz:[
     ...
     {q:"In how many ways can 5 people sit at a round table?", options:["5! = 120","5","(5−1)! = 4! = 24 — circular permutations fix one position to account for rotational equivalence","5!/5 = 24"], answer:2},
  ...
  {subject:"Calculus", title:"Volumes of Solids of Revolution: Advanced", summary:"Students compute volumes using disc/washer and shell methods, and apply the methods to multi-region problems.",
   ...
   quiz:[
     {q:"The washer method for a solid between y=f(x) and y=g(x) (f≥g) rotated about x-axis gives ___.", options:["V = π∫{[f(x)]² − [g(x)]²} dx — subtract the inner circle (g) from the outer circle (f)","V = 2π∫x[f(x)−g(x)] dx","V = π∫[f(x)+g(x)] dx","V = π∫[f(x)−g(x)]² dx"], answer:0},
     ...
     {q:"The shell method integrates ___ when rotating about the y-axis.", options:["horizontal strips of width dy","circular discs perpendicular to y","the radius squared","vertical shells: V = 2π∫x·f(x) dx from a to b — shell radius = x, shell height = f(x)"], answer:3},
     {q:"Choosing between disc/washer and shell methods: prefer shells when ___.", options:["solving for x in terms of y would be difficult — shells allow integration in x even when rotating about y","only for linear functions","always preferring shells","the function has no closed form"], answer:0},
  ...
  {subject:"Physics", title:"Atomic Structure and Quantum Numbers", summary:"Students examine the Bohr model, quantum mechanical model, and electron configurations using quantum numbers.",
   ...
   quiz:[
     {q:"The Bohr model of the hydrogen atom correctly predicted ___.", options:["the Zeeman effect","the spectra of all elements","the 3D shape of orbitals","the discrete emission spectrum of hydrogen — electrons occupy fixed energy levels, and photon emission corresponds to electron transitions between levels: ΔE = hf"], answer:3},
     {q:"The principal quantum number n determines ___.", options:["the energy level and size of the orbital — n = 1, 2, 3, ... with higher n meaning higher energy and larger radius","the shape of the orbital","the magnetic orientation of the orbital","the spin of the electron"], answer:0},
     {q:"The four quantum numbers (n, l, mₗ, mₛ) together specify ___.", options:["a unique quantum state for each electron in an atom — the Pauli Exclusion Principle states no two electrons can share the same set of four quantum numbers","only the energy of the electron","only the spin orientation","only the orbital shape"], answer:0},
...
{day:23, label:"Day 23 — Wed", subjects:[
  {subject:"English", title:"Documentary and Non-Fiction: Truth, Form, and Ethics", summary:"Students examine documentary film and literary non-fiction (creative non-fiction, journalism) — exploring how non-fiction makes arguments and ethical obligations to truth.",
   ...
   quiz:[
     {q:"Documentary film differs from fiction film in that ___.", options:["documentary has no narrative structure","documentary is always objective","documentary claims a relationship to actual events and people — but this claim does not mean documentary is neutral or unmediated; every documentary makes choices that shape the audience's understanding","documentary uses no cinematic technique"], answer:2},
     {q:"Rhetorical strategies in documentary include ___.", options:["only verbal argument","interview selection, ordering of footage, music and sound, narration, juxtaposition — all of which guide the viewer toward a particular interpretation while appearing merely to present facts","only factual presentation","no rhetorical strategies"], answer:1},
     {q:"Creative non-fiction (e.g., literary journalism, memoir, personal essay) ___.", options:["should avoid literary techniques","has no responsibility to truth","is always more subjective than journalism","uses the techniques of fiction (scene, character, voice, imagery, structure) in the service of factual content — but maintains an ethical obligation to truth that fiction does not"], answer:3},
     ...
     {q:"Analysing a documentary as a text means ___.", options:["only checking factual accuracy","only watching without analysis","examining its rhetorical strategies, cinematic choices, ideological assumptions, and the relationship between its claims and the evidence it presents — treating it as an argument, not just a record","accepting it as a neutral truth document"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"Combinations and the Binomial Theorem", summary:"Students calculate combinations, apply Pascal's triangle, and expand binomials using the Binomial Theorem.",
   ...
   quiz:[
     {q:"The number of combinations of n objects taken r at a time is ___.", options:["n!/(n−r)!","n!/r!","n!","C(n,r) = n!/(r!(n−r)!) — order does not matter in combinations; fewer than permutations by a factor of r!"], answer:3},
     ...
     {q:"The Binomial Theorem states (a+b)ⁿ = ___.", options:["∑[k=0 to n] C(n,k) aⁿ⁻ᵏ bᵏ — a sum of n+1 terms with binomial coefficients from Pascal's triangle","aⁿ + bⁿ only","∑ C(n,k) aᵏbⁿ⁻ᵏ","n·aⁿ⁻¹b + aⁿ"], answer:0},
     {q:"The term with b³ in (2x + 3)⁵ is ___.", options:["C(5,3)(2x)²(3)³ = 1080x²","C(5,3)(2x)³(3)²","C(5,3)(2x)²(3)³ = 10 × 4x² × 27 = 1080x²","C(5,2)(2x)³(3)²"], answer:2},
     {q:"Pascal's triangle has the property that ___.", options:["C(n,r) = C(n−1,r)","C(n,r) = C(n,r−1) + C(n,r+1)","each entry is the sum of all entries above","C(n,r) = C(n−1,r−1) + C(n−1,r) — each entry is the sum of the two entries above it"], answer:3}
   ]},
  {subject:"Calculus", title:"Numerical Integration: Riemann Sums and the Trapezoid Rule", summary:"Students approximate definite integrals using Riemann sums, the Trapezoid Rule, and Simpson's Rule.",
   ...
   quiz:[
     ...
     {q:"Simpson's Rule (n even) is ___.", options:["the same as the trapezoid rule","only used for linear functions","(h/3)[f(x₀)+4f(x₁)+2f(x₂)+4f(x₃)+...+4f(xₙ₋₁)+f(xₙ)] — alternating coefficients 4 and 2; generally more accurate than trapezoid","only the midpoint rule"], answer:2},
     {q:"Numerical integration is necessary when ___.", options:["the antiderivative cannot be expressed in closed form — many real-world functions (e.g., e^(−x²), √(1+x³)) have no elementary antiderivative","only for physics problems","the function is always integrable","you cannot use the FTC"], answer:0},
     {q:"As the number of subintervals n → ∞, all Riemann sum approximations ___.", options:["converge to the exact value of the definite integral — this is precisely the definition of the Riemann integral","approach different limits","remain the same","diverge"], answer:0}
   ]},
  {subject:"Physics", title:"Nuclear Reactions: Fission, Fusion, and Radioactive Decay", summary:"Students analyse nuclear reactions, calculate binding energy per nucleon, and apply decay equations.",
   ...
   quiz:[
     ...
     {q:"Half-life T½ is related to decay constant λ by ___.", options:["T½ = λ","T½ = ln2/λ = 0.693/λ — solving N₀/2 = N₀e^(−λT½)","T½ = 1/λ","T½ = e^λ"], answer:1},
...
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"English", title:"Contemporary Drama: Stagecraft and Text", summary:"Students examine a contemporary play, analysing the relationship between the written text and its realisation in performance.",
   ...
   quiz:[
     {q:"A play script is ___.", options:["always the same in any production","less important than the director's vision","the complete work of art in itself","a blueprint for performance — the text is indeterminate until realised; staging choices, casting, design, and acting all complete the work the playwright began"], answer:3},
     {q:"Stage directions in a contemporary play ___.", options:["are always followed literally","may be poetic, ambiguous, or minimal — some playwrights (Beckett, Pinter) make stage directions part of the artistic text; others leave maximum freedom to the director and designer","tell audiences what to think","are always ignored by directors"], answer:1},
     ...
     {q:"The most important question when analysing a scene in a contemporary play is ___.", options:["what happens in the plot","what does each character want in this scene, and what theatrical means are used to create or frustrate that desire — dramatic action is always about want and obstacle","how many characters appear","what time period is the play set in"], answer:1}
   ]},
  {subject:"AdvancedFunctions", title:"Probability Distributions: Binomial and Geometric", summary:"Students work with discrete probability distributions — binomial and geometric — applying formulas and interpreting results.",
   ...
   quiz:[
     {q:"The binomial distribution applies when ___.", options:["only one trial is performed","probability changes each trial","there are n independent identical trials, each with two outcomes (success/failure), and probability of success p is constant — counting the number of successes X","trials have more than two outcomes"], answer:2},
     {q:"P(X=k) for a binomial distribution is ___.", options:["C(n,k) × pᵏ × (1−p)^n","C(n,k) × pᵏ × (1−p)^(n−k) — choosing which k trials succeed times the probability of that pattern","p^k × (1-p)^(n-k)","n × p × k"], answer:1},
  ...
  {subject:"Calculus", title:"Differential Equations: Growth, Decay, and Newton's Law", summary:"Students solve separable ODEs applied to exponential growth, radioactive decay, and Newton's Law of Cooling.",
   ...
   quiz:[
     {q:"The general solution of dP/dt = kP is ___.", options:["P(t) = ke^(P₀t)","P(t) = P₀ + kt","P(t) = P₀e^(kt) — separate, integrate both sides: ∫dP/P = ∫k dt → ln P = kt + C → P = Ae^(kt)","P(t) = P₀kt"], answer:2},
     ...
     {q:"A differential equation is separable if ___.", options:["its solution is always exponential","it can be written as dy/g(y) = f(x) dx — the variables can be completely separated to opposite sides before integrating","it has constant coefficients","it involves only one variable"], answer:1}
   ]},
  {subject:"Physics", title:"Modern Physics: Quantum Mechanics and the Standard Model", summary:"Students examine the probabilistic nature of quantum mechanics, wave functions, and an overview of the Standard Model.",
   ...
   quiz:[
     {q:"The wave function ψ(x,t) in quantum mechanics gives ___.", options:["the exact position of the particle","the energy of the particle directly","the probability amplitude — |ψ|² gives the probability density of finding the particle at position x at time t","the actual path of the particle"], answer:2},
     {q:"The Schrödinger equation is ___.", options:["the fundamental equation of quantum mechanics — describing how the wave function evolves in time; solving it gives the allowed quantum states and their energies","only applicable to classical waves","a statement of conservation of energy","only for relativistic particles"], answer:0},
     {q:"Quantum tunnelling allows ___.", options:["particles to pass through potential barriers that classical mechanics would prohibit — explained by the non-zero probability amplitude on the far side of the barrier; crucial in nuclear fusion and semiconductor devices","only photons to pass through barriers","energy conservation to be violated","particles to exceed the speed of light"], answer:0},
     {q:"The Standard Model classifies matter as composed of ___.", options:["photons and electrons only","protons and neutrons only","atoms and molecules only","quarks (making up protons, neutrons) and leptons (electrons, neutrinos) — interacting via bosons: photons (EM), W/Z bosons (weak), gluons (strong)"], answer:3},
...
{day:25, label:"Day 25 — Fri", subjects:[
  {subject:"English", title:"Research Essay Workshop: Drafting and Peer Review", summary:"Students workshop research essay drafts in a peer-review setting, applying structured feedback protocols and revising for argument, evidence, and style.",
   ...
   quiz:[
     {q:"Peer review is most valuable when ___.", options:["reviewers respond as genuine readers — identifying where the argument is unclear, where evidence is unconvincing, where the analysis is superficial — providing the response a real academic reader would give","reviewers focus only on grammar","reviewers are lenient to encourage the writer","reviewers only praise the essay"], answer:0},
     ...
     {q:"Revising an essay is different from editing in that ___.", options:["editing is more important","revising is only fixing grammar","they are the same process","revising involves reconsidering the argument, structure, and evidence — making major changes to content and organisation; editing addresses sentence-level clarity and correctness"], answer:3},
     {q:"When evidence does not support your claim, the correct response is ___.", options:["ignore the problem","delete the evidence","misrepresent the evidence to fit","revise either the claim to match the evidence, or find better evidence for the existing claim — intellectual honesty requires alignment between claim and evidence"], answer:3},
  ...
  {subject:"AdvancedFunctions", title:"Probability: Conditional Probability and Independence", summary:"Students apply conditional probability, Bayes' Theorem, and independence to complex probability problems.",
   ...
   quiz:[
     ...
     {q:"Events A and B are independent if and only if ___.", options:["P(A|B) = P(A), equivalently P(A∩B) = P(A)P(B) — knowing B occurred gives no information about A","P(A∩B) = 0","P(A) = P(B)","P(A) + P(B) = 1"], answer:0},
     {q:"Bayes' Theorem: P(A|B) = ___.", options:["P(B|A)×P(A)×P(B)","P(B|A)/P(A)","P(A|B) = P(A)P(B)","P(B|A)×P(A) / P(B) — allows updating probability of A given new evidence B"], answer:3},
     ...
     {q:"The multiplication rule for conditional probability: P(A∩B) = ___.", options:["P(A)×P(B) always","P(A)×P(B|A) = P(B)×P(A|B) — either form works; the second factor is the conditional probability of the second event given the first","P(A|B) − P(B)","P(A) + P(B) − P(A∪B)"], answer:1}
   ]},
  {subject:"Calculus", title:"Arc Length and Surface Area", summary:"Students calculate arc lengths of curves and surface areas of solids of revolution using integration.",
   ...
   quiz:[
     {q:"The arc length of y = f(x) from a to b is ___.", options:["∫[a to b]√(1+[f(x)]²) dx","∫[a to b]f(x) dx","∫[a to b]√(1+[f'(x)]²) dx — derived from approximating the curve by infinitesimal line segments ds = √(dx²+dy²)","∫[a to b](1+f(x)) dx"], answer:2},
     {q:"Find the arc length of y = x³/² from x=0 to x=4.", options:["∫√(1+x³) dx","4³/² = 8","∫[0 to 4]√(1+(3x^(1/2)/2)²) dx = ∫√(1+9x/4) dx — solved by substitution; ≈ 9.07","4 × √(1+9) = 4√10"], answer:2},
     {q:"Surface area of y=f(x) rotated about x-axis from a to b is ___.", options:["π∫[f(x)]² dx (this is volume by discs)","2π∫f(x)√(1+[f'(x)]²) dx — sum of infinitesimal bands of circumference 2πf(x) and slant height ds","2π∫f(x) dx","π∫f(x)√(1+[f'(x)]²) dx"], answer:1},
     {q:"These formulas require that f(x) is ___.", options:["continuously differentiable (f' continuous) on [a,b] — so that ds = √(1+[f'(x)]²)dx is well-defined","only continuous","only integrable","always positive"], answer:0},
  ...
  {subject:"Physics", title:"Medical and Applied Physics", summary:"Students see how physics principles apply to medicine — X-rays, MRI, PET scans, ultrasound, and radiation therapy.",
   ...
   quiz:[
     {q:"X-rays penetrate soft tissue but are absorbed by bone because ___.", options:["X-rays cannot travel through any material","X-rays are repelled by calcium","bone is harder than soft tissue","bone is denser and contains calcium which absorbs X-rays more strongly — the differential absorption creates the radiographic image"], answer:3},
     {q:"MRI (Magnetic Resonance Imaging) uses ___.", options:["radioactive tracers","X-rays with computer processing","the magnetic properties of hydrogen nuclei (protons) — a strong magnetic field aligns them, then radiofrequency pulses disturb the alignment; detecting the return to equilibrium creates images of soft tissue","ultrasound at very high frequencies"], answer:2},
     {q:"PET (Positron Emission Tomography) works by ___.", options:["measuring sound waves inside the body","using a magnetic field to image organs","detecting gamma rays from positron-electron annihilation — a positron-emitting tracer is injected, and annihilation events (producing paired gamma rays) reveal metabolic activity","using external X-ray sources"], answer:2},
     {q:"Ultrasound imaging uses ___.", options:["gamma radiation","visible light","high-frequency sound waves (1–20 MHz) — reflected differently by tissues of different density; safe for foetal imaging because it uses no ionising radiation","infrared radiation"], answer:2},
     {q:"Radiation therapy targets cancer because ___.", options:["normal cells cannot be harmed by radiation","radiation has no side effects","ionising radiation damages DNA, killing rapidly dividing cells (cancer cells divide faster than most normal cells) — but normal tissue damage is a significant side effect requiring careful dosing and targeting","only cancer cells absorb radiation"], answer:2}
   ]},
]},
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"English", title:"Oral Communication: Seminar and Academic Discussion", summary:"Students prepare for and participate in a formal Socratic seminar, developing skills in academic discussion, active listening, and building on others' ideas.",
   ...
   quiz:[
     ...
     {q:"Effective academic discussion requires ___.", options:["never asking questions during someone's turn","active listening — being able to summarise what the previous speaker said before responding, engaging with their actual argument rather than changing the subject","talking as much as possible","always agreeing with the previous speaker"], answer:1},
     ...
     {q:"The purpose of requiring textual evidence in a seminar is ___.", options:["to penalise students who didn't prepare","to ground claims in specific textual detail — preventing discussion from floating into vague assertion, and ensuring claims about texts are based on what texts actually say and do","to fill time in the discussion","to show you did the reading"], answer:1},
     {q:"The highest level of seminar participation involves ___.", options:["asking a question that genuinely opens up new thinking for the group — the best seminar contributions change the direction of the discussion productively","speaking longest","making the most points","never asking questions"], answer:0}
   ]},
  {subject:"AdvancedFunctions", title:"Advanced Functions: Comprehensive Review", summary:"Students review the full MHF4U course with examination-level practice problems spanning all strands.",
   ...
   quiz:[
     ...
     {q:"The general term of the expansion (3x−2)⁶ containing x⁴ is ___.", options:["C(6,4)(3x)⁴(−2)² — note: term with x⁴ has k=4 in (3x)^(6−k)(−2)^k: k=2 → C(6,2)(3x)⁴(−2)² = 15×81×4 x⁴ = 4860x⁴","C(6,2)(3x)⁴(−2)² = 15 × 81x⁴ × 4 = 4860x⁴","C(6,4)(3x)⁴(−2)² = 15 × 81x⁴ × 4 = 4860x⁴","C(6,2)(3x)⁴(2)² = 4860x⁴"], answer:0},
...
{day:27, label:"Day 27 — Tue", subjects:[
  {subject:"English", title:"Writing Workshop: Style, Voice, and the Sentence", summary:"Students examine prose style at the level of the sentence — rhythm, syntax, diction — and revise their own writing for greater clarity, precision, and voice.",
   ...
   quiz:[
     {q:"Prose style at the sentence level includes ___.", options:["only grammar and spelling","only sentence length","only vocabulary choice","rhythm (patterns of stress, sentence length variation), syntax (clause structure, subordination), and diction (word choice, register, tone) — all working together to create a distinctive voice"], answer:3},
     {q:"Varying sentence length in academic prose ___.", options:["shows inconsistent style","has no effect on the reader","should be avoided in formal writing","creates rhythm and emphasis — a short sentence after several long ones lands with particular force; uniform sentence length produces monotony regardless of the quality of the ideas"], answer:3},
     {q:"Nominalisations (turning verbs/adjectives into nouns) in academic writing ___.", options:["always improve clarity","are mandatory in formal academic style","should be avoided always","can obscure agency and make prose unnecessarily dense — 'the improvement of student performance' is weaker than 'students improved'; nominalisation is sometimes appropriate but often inflates and obscures"], answer:3},
     {q:"The difference between a precise word and an approximate one is ___.", options:["only important in poetry","only a matter of style","enormous in academic writing — 'the passage suggests ambivalence' is analytically precise; 'the passage shows something complicated' is not; precision in diction is precision in thinking","unimportant if the meaning is roughly correct"], answer:2},
     {q:"Revision at the sentence level should happen ___.", options:["never — first drafts are always good enough","after the larger revision (argument, structure, evidence) is complete — it is inefficient to perfect sentences in a paragraph that may be restructured or deleted","before revising the argument structure","only for the introduction"], answer:1}
   ]},
...
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"English", title:"Culminating Essay: Writing Under Examination Conditions", summary:"Students practise writing a full analytical essay under timed conditions, applying all skills developed throughout the year.",
   resourceLabel:"TED-Ed: Literature", resourceUrl:"https://www.youtube.com/watch?v=kLJE8IYIQEM",
   quiz:[
     {q:"The most important 5 minutes of a timed literary essay are ___.", options:["the first 5 minutes of planning — a clear, specific thesis and a logical outline before writing saves time and produces a more coherent essay than beginning immediately","the conclusion","the middle of the essay","the last 5 minutes of writing"], answer:0},
     {q:"In a timed essay, the most common weakness is ___.", options:["insufficient analytical development — students describe textual events or state themes without explaining how specific textual choices create meaning; analysis takes time and cannot be rushed","writing too slowly","knowing the text too well","writing in too formal a register"], answer:0},
     {q:"Choosing a quotation under time pressure: prefer ___.", options:["only quotations you've memorised exactly","the longest quotation you can recall","a short, specific phrase that is analytically productive — better to have two precise words you can analyse fully than two sentences you can only describe","any passage you remember"], answer:2},
     {q:"Ending a timed essay effectively: the conclusion should ___.", options:["repeat the introduction word for word","introduce new evidence","only name the texts again","synthesise the essay's argument in 3-5 sentences — showing how the evidence collectively demonstrates the thesis, and opening one genuinely new perspective or question without introducing new evidence"], answer:3},
     {q:"A student who has genuinely mastered Grade 12 English will find timed writing ___.", options:["only useful for English exams","impossible without notes","irrelevant to real university skill","challenging but empowering — demonstrating that analytical thinking and articulate expression under pressure are real intellectual capacities, not just performances"], answer:3}
   ]},
...
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"English", title:"Grade 12 English: Oral Culminating and Reflection", summary:"Students deliver oral culminating presentations and reflect on their growth as readers, writers, and thinkers across Grade 12.",
   ...
   quiz:[
     ...
     {q:"Reflecting on your development as a reader across Grade 12 means ___.", options:["only counting books read","articulating what has changed in how you read — what you now notice, ask, and value that you did not before — making your intellectual growth conscious and available for further development","only recognising what you found difficult","only identifying your favourite text"], answer:1},
     {q:"The skills developed in Grade 12 English that transfer most directly to university are ___.", options:["only knowledge of canonical literature","critical reading, analytical argument, evidence-based reasoning, and clear written communication — the core intellectual skills of university education in any discipline","only reading speed","only essay formatting"], answer:1},
     {q:"The most significant intellectual growth in Grade 12 English occurs when ___.", options:["you finish all the assessments","you get the highest mark","you move from seeking the 'right answer' to generating your own well-supported, genuinely original interpretive arguments — from passive consumer to active maker of meaning","you have memorised the most quotations"], answer:2},
     {q:"Grade 12 English is fundamentally about ___.", options:["preparing for English at university","memorising literary terms","developing your capacity to think carefully, feel deeply, and communicate precisely — using literature as the site and language as the tool of that development","learning to write five-paragraph essays"], answer:2}
   ]},
  {subject:"AdvancedFunctions", title:"Advanced Functions: Final Reflection and Looking Forward", summary:"Students reflect on the year's learning in Advanced Functions and its significance for future study.",
   ...
   quiz:[
     ...
     {q:"The proof and reasoning strand in Advanced Functions ___.", options:["is unrelated to the function content","introduces the formal mathematical reasoning that is the foundation of university mathematics — learning to construct and verify proofs, not just apply algorithms","is only for future mathematics students","is only about mathematical induction"], answer:1},
     {q:"Looking back on Grade 12 mathematics, the most valuable habit of mind developed is ___.", options:["test-taking strategy","speed at calculation","mathematical curiosity — the willingness to ask 'why does this work?' and 'what would happen if...?' and to pursue those questions rigorously to a satisfying answer","memorisation of formulas"], answer:2}
   ]},
  {subject:"Calculus", title:"Calculus: Final Reflection and University Preparation", summary:"Students reflect on Calculus learning and prepare for university calculus courses.",
   ...
   quiz:[
     {q:"The two most important ideas in Calculus are ___.", options:["the product rule and chain rule","derivatives and integrals as separate topics","the derivative (instantaneous rate of change as a limit) and the integral (accumulated change); and that they are inverse operations — the Fundamental Theorem connecting them","limits and power rule"], answer:2},
     {q:"University calculus (Calculus I, II) will build on your Grade 12 learning by ___.", options:["not requiring any Grade 12 preparation","being much easier","introducing multivariable calculus, series, improper integrals, and applications in physics, engineering, and economics — Grade 12 calculus is the essential foundation","starting completely from scratch"], answer:2},
     {q:"The most important skill for university calculus is ___.", options:["memorising all derivative rules","algebraic fluency — limits and derivatives require confident algebra; students who struggle with algebra in Grade 12 will find university calculus very difficult","only understanding limits","only understanding integration"], answer:1},
  ...
  {subject:"Physics", title:"Physics: Final Reflection and Looking to University", summary:"Students reflect on their Grade 12 Physics learning and its connections to university physics and modern life.",
   resourceLabel:"Crash Course Physics", resourceUrl:"https://www.youtube.com/watch?v=aY8z2qO44WA",
   quiz:[
     {q:"The most important conceptual development in Grade 12 Physics is ___.", options:["understanding the SI unit system","moving from the intuitive Newtonian world to the deeply counter-intuitive worlds of quantum mechanics and relativity — where human intuition, while useful at everyday scales, fundamentally misleads","learning to use complex formulas","knowing all fundamental constants"], answer:1},
     {q:"University physics (mechanics, E&M, waves/optics, modern physics) builds on Grade 12 by ___.", options:["deepening and mathematising every concept — using multivariable calculus, differential equations, and linear algebra as the primary tools; Grade 12 physics is the conceptual foundation","repeating the same material","being completely different in content","being much easier"], answer:0},
     ...
     {q:"The most significant open problems in physics today are ___.", options:["quantum gravity, dark matter, dark energy, matter-antimatter asymmetry, and a unified theory of all forces — each of which may require conceptual revolutions as profound as Einstein's or Planck's","already solved in principle","only relevant to theorists","only mathematical"], answer:0},
     {q:"Grade 12 Physics has shown you that ___.", options:["physics is a closed discipline with all answers known","the universe operates according to mathematical laws of astonishing elegance and power — and that patient, systematic, mathematically guided inquiry is the most reliable path to understanding it","equations are more important than concepts","physics is only for those who plan to study it at university"], answer:1}
   ]},
]},
{day:30, label:"Day 30 — Fri", subjects:[
  {subject:"English", title:"Grade 12 Celebration: A Year of Growth", summary:"A final day celebrating the intellectual journey of Grade 12 — reflecting on growth, looking ahead to university and life, and recognising what has been accomplished.",
   ...
   quiz:[
     {q:"The most important thing accomplished in Grade 12 is ___.", options:["only university preparation","only skill development","genuine intellectual growth — deeper, more independent thinking; the ability to sustain a complex argument; wider reading and a more developed aesthetic and critical sensibility","a high grade average"], answer:2},
     {q:"University marks a transition from ___.", options:["high school content to harder content","guided learning to independent intellectual life — you choose your own questions, pursue your own research, and take responsibility for your own intellectual development to a degree impossible in high school","being assessed to never being assessed again","one set of rules to another set of rules"], answer:1},
     {q:"The reading and writing skills developed in Grade 12 ___.", options:["are only for English programs","will be forgotten quickly after exams","are fundamental to success in any field requiring communication, analysis, or sustained thinking — virtually every university program and professional career","have no relevance outside school"], answer:2},
     {q:"Looking back on all of Grade 12, the subject that will most surprise you at university is ___.", options:["the one that opens up into a vast new world — where high school content was the surface of an ocean; at university you begin to dive","the one that gave you the worst grade","the one you studied least","the one that was easiest in high school"], answer:0},
     {q:"The best preparation for university and adult life that Grade 12 has provided is ___.", options:["achieving the highest possible marks","only having specific skills","knowing all the curriculum content","the experience of sustained intellectual effort — wrestling with difficulty, revising your thinking, producing work you genuinely stand behind, and discovering what you are actually capable of"], answer:3}
   ]},
  {subject:"AdvancedFunctions", title:"Grade 12 Mathematics: Final Day Celebration", summary:"Students celebrate completing two of Ontario's most rigorous mathematics courses and look ahead with confidence.",
   ...
   quiz:[
     {q:"Completing both Advanced Functions and Calculus in Grade 12 demonstrates ___.", options:["nothing about future capabilities","genuine mathematical maturity — you have engaged with the deepest mathematical ideas taught in Ontario secondary school, and you have the foundation for any quantitatively demanding university program","only good test-taking strategy","only that you like mathematics"], answer:1},
     {q:"The discipline of solving a difficult mathematics problem translates to ___.", options:["nothing outside mathematics","only to science and engineering","any domain requiring persistence, systematic analysis, and comfort with complexity — the problem-solving mindset is not subject-specific","only future mathematics problems"], answer:2},
     {q:"The most important mathematical truth you have encountered in Grade 12 is ___.", options:["the quadratic formula","the formula for the area of a circle","that calculus connects the two most fundamental mathematical operations — differentiation and integration — in a single elegant theorem; and that this connection, discovered 350 years ago, underlies virtually all of modern science and technology","only the power rule"], answer:2},
     {q:"A student who has done well in Grade 12 mathematics should feel ___.", options:["that they have developed genuine mathematical power — the ability to reason precisely, handle abstraction, and apply formal thinking to real problems — a portable, durable, and extremely valuable intellectual asset","that they have exhausted mathematics","that mathematics is now fully mastered","that mathematics is only useful for specialists"], answer:0},
     {q:"Looking ahead, Grade 12 mathematics graduates who pursue further study will discover ___.", options:["that all mathematics has now been discovered","that first-year university mathematics is the same as Grade 12","that mathematics is a vast, living field of inquiry — Grade 12 covered two centuries of mathematical development; several more centuries (and open research problems) await","that mathematics becomes less interesting at university"], answer:2}
   ]},
  {subject:"Physics", title:"Grade 12 Physics: Final Day", summary:"Students celebrate completing Grade 12 Physics and look ahead to university and the world of physics.",
   ...
   quiz:[
     {q:"Grade 12 Physics has given you ___.", options:["only a foundation for university physics","a way of seeing the world — every natural phenomenon from the motion of planets to the behaviour of electrons is in principle understandable through the application of a small number of elegant physical laws","only laboratory skills","only a set of formulas to memorise"], answer:1},
     {q:"The greatest physicists (Newton, Faraday, Maxwell, Einstein, Bohr, Feynman) were unified by ___.", options:["only mathematical genius","deep curiosity about how the world works — combined with the discipline to pursue that curiosity systematically, the mathematical tools to express what they found, and the imagination to conceive what had never been conceived before","only experimental skill","only theoretical creativity"], answer:1},
     {q:"Climate change, renewable energy, quantum computing, and medical imaging are all ___.", options:["direct applications of physical principles — Grade 12 Physics is not abstract knowledge but the foundation of the most pressing technological challenges facing humanity","only political issues","unrelated to physics","only engineering problems"], answer:0},
     {q:"The challenges that await the next generation of physicists and engineers include ___.", options:["problems that have already been solved","only problems in pure mathematics","fusion energy, quantum computers, materials science for sustainability, space exploration, and the ultimate questions of quantum gravity and the nature of dark matter — genuinely open, important, and difficult","only incremental improvements to existing technology"], answer:2},
     {q:"The final lesson of Grade 12 Physics is ___.", options:["only specialists need to understand physics","physics content is fully memorised and complete","curiosity is the essential scientific virtue — the questions 'why?' and 'what if?' and 'how do we know?' asked persistently, rigorously, and with mathematical precision, are what the entire edifice of physics is built on","physics is too difficult for most people"], answer:2}
   ]},
]},
];
