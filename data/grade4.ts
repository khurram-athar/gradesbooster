...
{day:40, label:"Day 40 — Fri", subjects:[
  {subject:"Language", title:"Reading: Determining Importance", summary:"Ontario Grade 4 Reading strand: determining importance means identifying which details in a text are essential to understanding it, separating key information from interesting but less important details.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   videoUrl:"https://www.youtube.com/watch?v=NPsCEDQ3MUs",
   quiz:[
  ...
  {subject:"Math", title:"Coordinate Grids: Plotting Points", summary:"Ontario Grade 4 Geometry strand: a coordinate grid uses a horizontal x-axis and vertical y-axis to locate points using ordered pairs, such as (3, 2), which means 3 units across and 2 units up.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   videoUrl:"https://www.youtube.com/watch?v=bZQkSjEzIEo",
   quiz:[
...
{day:53, label:"Day 53 — Wed", subjects:[
  ...
  {subject:"Math", title:"Measuring and Classifying Angles with a Protractor", summary:"Grade 4 Math strand: a protractor is a tool used to measure the size of an angle in degrees, and angles can be classified as acute, right, obtuse, or straight.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   videoUrl:"https://www.youtube.com/watch?v=_erF7VM5-zI",
   quiz:[
  ...
  {subject:"Science", title:"Waves and Vibrations: How Sound is Produced", summary:"Grade 4 Science strand: sound is produced when an object vibrates, creating waves of energy that travel through air or another medium to our ears.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   videoUrl:"https://www.youtube.com/watch?v=y3uSZeDPBGo",
   quiz:[
  ...
  {subject:"SocialStudies", title:"Canada’s Industries and Economic Regions", summary:"Grade 4 Social Studies strand: different regions of Canada rely on different industries, such as fishing on the coasts, farming on the Prairies, and manufacturing in central Canada.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   videoUrl:"https://www.youtube.com/watch?v=R7PZwYNb8Ao",
   quiz:[
...
{day:61, label:"Day 61 — Mon", subjects:[
  {subject:"Language", title:"Vocabulary: Analogies", summary:"Grade 4 Language strand: an analogy compares two pairs of words that share the same kind of relationship, such as hot is to cold as up is to down.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"An analogy compares two pairs of words that share the same ___.", options:["Type of relationship","X unrelated to analogies","Number of letters","Spelling pattern"], answer:0},
     {q:"Which word completes the analogy: Bird is to nest as bee is to ___?", options:["Hive","X unrelated to the analogy","Web","Burrow"], answer:0},
     {q:"Which word completes the analogy: Puppy is to dog as kitten is to ___?", options:["Cow","Foal","X unrelated to the analogy","Cat"], answer:3},
     {q:"Hot is to cold as up is to ___?", options:["Sideways","Down","X unrelated to the analogy","Around"], answer:1},
     {q:"Why are analogies useful for building vocabulary?", options:["Analogies have no connection to word meaning","They help readers see how word meanings and relationships connect","Analogies only test spelling, not meaning","X unrelated to vocabulary building"], answer:1}
   ]},
  {subject:"Math", title:"Place Value to 10,000", summary:"Grade 4 Math strand: place value to 10,000 describes the value of each digit in a number based on its position -- ones, tens, hundreds, and thousands.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"In the number 6,482, the digit 4 represents ___.", options:["X unrelated to place value","4 tens","4 thousands","4 hundreds"], answer:3},
     {q:"What is the value of the 7 in 7,315?", options:["70","X unrelated to place value","700","7,000"], answer:3},
     {q:"Which number has a 5 in the thousands place?", options:["5,214","2,514","X unrelated to place value","1,254"], answer:0},
     {q:"What is 3,000 + 400 + 20 + 6 written as a standard number?", options:["X unrelated to place value","3,246","3,426","3,624"], answer:2},
     {q:"Why is it useful to understand place value in large numbers?", options:["It helps read, write, and compare numbers accurately","Every digit in a number always has the same value","Place value has no effect on the meaning of a number","X unrelated to place value"], answer:0}
   ]},
  {subject:"Science", title:"Canadian Biomes: Forests, Wetlands, and Tundra", summary:"Grade 4 Science strand: Canada contains several distinct biomes, including forests, wetlands, and tundra, each with its own climate, plants, and animals.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"A biome is best described as a large region with a distinct ___.", options:["Type of rock only","X unrelated to biomes","Style of building","Climate, plants, and animals"], answer:3},
     {q:"Which biome is found in Canada’s far north, with very cold temperatures and few trees?", options:["Rainforest","Wetland","Tundra","X unrelated to biomes"], answer:2},
     {q:"A wetland is an area that is ___.", options:["Located only underground","X unrelated to biomes","Covered by water for at least part of the year","Always completely dry"], answer:2},
     {q:"Which biome covers much of central and northern Ontario, with many coniferous and deciduous trees?", options:["Desert","Forest","Tundra","X unrelated to biomes"], answer:1},
     {q:"Why do scientists study different biomes?", options:["To understand how climate shapes the plants and animals living there","Every biome on Earth is exactly the same","X unrelated to biomes","Biomes provide no useful scientific information"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Ancient Maya Civilization", summary:"Grade 4 Social Studies strand: the ancient Maya built cities in Central America between about 2000 BCE and 1500 CE, known for their pyramids, writing system, and knowledge of astronomy.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"The ancient Maya civilization was located in ___.", options:["Southern Africa","Central America","Northern Europe","X unrelated to the Maya"], answer:1},
     {q:"The Maya built large stone structures known as ___.", options:["Log cabins","X unrelated to Maya architecture","Pyramids","Igloos"], answer:2},
     {q:"The Maya developed a system of ___ to record dates and events.", options:["Modern printing presses","Writing (hieroglyphs)","Money made only of paper","X unrelated to Maya achievements"], answer:1},
     {q:"The Maya were skilled observers of ___.", options:["X unrelated to Maya knowledge","The stars and sky (astronomy)","Only underwater life","Modern machinery"], answer:1},
     {q:"Why do historians study the ruins of Maya cities today?", options:["Maya ruins provide no historical information","The Maya left behind no evidence of their civilization","They reveal how the Maya lived, built, and organized their society","X unrelated to studying history"], answer:2}
   ]},
]},
{day:62, label:"Day 62 — Tue", subjects:[
  {subject:"Language", title:"Figurative Language: Alliteration", summary:"Grade 4 Language strand: alliteration is the repetition of the same beginning consonant sound in a series of nearby words, such as slippery snakes slither silently.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Alliteration is the repetition of the same ___ in nearby words.", options:["Ending vowel sound","Beginning consonant sound","Number of syllables","X unrelated to alliteration"], answer:1},
     {q:"Which phrase is an example of alliteration?", options:["The dog ran quickly","X unrelated to alliteration","Busy bees buzzed by","The sun was very hot"], answer:2},
     {q:"Which phrase is an example of alliteration?", options:["Peter Piper picked peppers","The cat sat on the mat","She walked to the store","X unrelated to alliteration"], answer:0},
     {q:"Why might a poet use alliteration?", options:["Alliteration has no effect on how a poem sounds","X unrelated to figurative language","To create rhythm and make language more memorable","To make a poem harder to read aloud"], answer:2},
     {q:"Which word best continues this alliteration pattern: Silly snakes slid ___?", options:["Away","Loudly","Slowly","X unrelated to alliteration"], answer:2}
   ]},
  {subject:"Math", title:"Multiplying 2-Digit by 2-Digit Numbers", summary:"Grade 4 Math strand: multiplying a 2-digit number by another 2-digit number involves breaking each factor into tens and ones, then adding the partial products together.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"When multiplying 2-digit numbers, each factor can be broken into ___.", options:["Only hundreds","X unrelated to multiplication","Only fractions","Tens and ones"], answer:3},
     {q:"What is 12 × 13?", options:["X unrelated to the calculation","156","146","136"], answer:1},
     {q:"What is 21 × 14?", options:["294","X unrelated to the calculation","304","284"], answer:0},
     {q:"What is 15 × 15?", options:["225","X unrelated to the calculation","215","235"], answer:0},
     {q:"Why is it helpful to break numbers into tens and ones before multiplying?", options:["It makes multiplying large numbers more manageable in smaller steps","It changes the value of the original numbers","Breaking numbers apart makes multiplication impossible","X unrelated to multiplication strategies"], answer:0}
   ]},
  {subject:"Science", title:"Animal Camouflage and Mimicry", summary:"Grade 4 Science strand: camouflage helps an animal blend into its surroundings, while mimicry occurs when one species evolves to resemble another species, both as strategies for survival.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Camouflage helps an animal ___.", options:["X unrelated to camouflage","Grow larger than other animals","Blend into its surroundings to avoid predators","Attract as much attention as possible"], answer:2},
     {q:"Mimicry occurs when one species ___.", options:["Has no connection to any other species","Changes location every single day","X unrelated to mimicry","Resembles another species for protection or advantage"], answer:3},
     {q:"Which is an example of camouflage?", options:["X unrelated to camouflage","A polar bear’s white fur blending into snow","A lion’s loud roar","A peacock’s bright, colourful tail feathers"], answer:1},
     {q:"Why might a harmless insect evolve to look like a stinging wasp?", options:["To trick predators into avoiding it, an example of mimicry","X unrelated to mimicry","Looking similar to another species provides no benefit","Insects never resemble other species"], answer:0},
     {q:"How do camouflage and mimicry both help animals survive?", options:["They make animals more visible to predators","X unrelated to animal survival strategies","They have no effect on an animal’s chances of survival","They help animals avoid predators or better catch prey"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Ancient Nubia (Kingdom of Kush)", summary:"Grade 4 Social Studies strand: ancient Nubia, home to the Kingdom of Kush, was located along the Nile River south of Egypt and became known for its skilled ironworkers, pyramids, and trade in gold.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"The ancient Kingdom of Kush was located ___.", options:["In Northern Europe","X unrelated to Nubia","In Central America","Along the Nile River, south of Egypt"], answer:3},
     {q:"Nubia became especially well known for its skill in working with ___.", options:["Iron","Plastic","X unrelated to Nubian achievements","Rubber"], answer:0},
     {q:"Like ancient Egypt, the Kingdom of Kush built ___.", options:["Pyramids","Log cabins","Skyscrapers","X unrelated to Nubian architecture"], answer:0},
     {q:"Nubia traded valuable resources such as ___ with neighbouring regions.", options:["Plastic goods","Modern currency","X unrelated to Nubian trade","Gold"], answer:3},
     {q:"Why is it important to learn about ancient Nubia alongside ancient Egypt?", options:["Only Egypt existed in ancient Africa","X unrelated to ancient African civilizations","It shows another powerful African civilization with its own rich history","Nubia had no history worth studying"], answer:2}
   ]},
]},
{day:63, label:"Day 63 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Interjections", summary:"Grade 4 Language strand: an interjection is a word or phrase that expresses strong emotion, such as Wow! or Ouch!, and is often followed by an exclamation mark.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"An interjection is a word that expresses ___.", options:["A location in a sentence","X unrelated to interjections","A complete action","Strong emotion"], answer:3},
     {q:"Which word is an interjection?", options:["X unrelated to interjections","Wow","Table","Jump"], answer:1},
     {q:"An interjection is often followed by ___.", options:["Quotation marks only","A semicolon","An exclamation mark","X unrelated to punctuation"], answer:2},
     {q:"Which sentence contains an interjection?", options:["Ouch! That really hurt.","She read the book quietly.","X unrelated to interjections","The dog ran across the yard."], answer:0},
     {q:"Why might a writer use an interjection in dialogue?", options:["To replace the need for any punctuation","Interjections never appear in dialogue","X unrelated to interjections","To show a character’s strong feeling or reaction"], answer:3}
   ]},
  {subject:"Math", title:"Rounding Decimals", summary:"Grade 4 Math strand: rounding decimals means adjusting a decimal number to a nearby, simpler value, such as rounding to the nearest whole number or nearest tenth.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"Rounding a decimal means adjusting it to a nearby, simpler ___.", options:["Value","Colour","Shape","X unrelated to rounding"], answer:0},
     {q:"What is 4.7 rounded to the nearest whole number?", options:["4","6","X unrelated to the calculation","5"], answer:3},
     {q:"What is 2.3 rounded to the nearest whole number?", options:["1","3","2","X unrelated to the calculation"], answer:2},
     {q:"What is 6.85 rounded to the nearest tenth?", options:["7.0","X unrelated to the calculation","6.9","6.8"], answer:2},
     {q:"Why might someone round a decimal number in everyday life?", options:["Rounding decimals serves no practical purpose","To make an estimate or simplify a number quickly","Rounding always makes a number less accurate for every purpose","X unrelated to rounding"], answer:1}
   ]},
  {subject:"Science", title:"Space: Earth’s Rotation and the Day/Night Cycle", summary:"Grade 4 Science strand: Earth rotates on its axis once approximately every 24 hours, and this rotation causes the cycle of day and night.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Earth’s rotation on its axis takes approximately ___.", options:["One year","X unrelated to Earth’s rotation","24 minutes","24 hours"], answer:3},
     {q:"Day and night occur because Earth ___.", options:["Stops moving completely","X unrelated to day and night","Rotates on its axis","Changes shape every day"], answer:2},
     {q:"When your part of Earth is facing the Sun, it is ___.", options:["Always winter","Nighttime","Daytime","X unrelated to Earth’s rotation"], answer:2},
     {q:"Which term describes Earth spinning on its axis?", options:["Revolution around the Sun","Reflection","X unrelated to Earth’s movement","Rotation"], answer:3},
     {q:"Why do different places on Earth experience day and night at different times?", options:["X unrelated to Earth’s rotation","The entire Earth always faces the Sun at once","The Sun turns on and off each day","Only half of the rotating Earth faces the Sun at any moment"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Early Societies: Tools and Technology", summary:"Grade 4 Social Studies strand: early societies developed tools and technology, such as farming implements, pottery, and metalworking, to meet their daily needs and improve their way of life.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Early societies developed tools mainly to ___.", options:["X unrelated to early technology","Meet daily needs, such as farming and building","Compete in modern sporting events","Avoid doing any work at all"], answer:1},
     {q:"Which material did many early societies learn to shape into tools and weapons?", options:["X unrelated to early tools","Metal, such as bronze or iron","Glass fibre","Plastic"], answer:1},
     {q:"Pottery was an important early technology used mainly for ___.", options:["Building modern skyscrapers","X unrelated to pottery","Powering machines","Storing and carrying food and water"], answer:3},
     {q:"How did farming tools, such as the plow, change early societies?", options:["They made growing food impossible","X unrelated to early technology","They allowed people to grow more food and support larger communities","Farming tools had no effect on early societies"], answer:2},
     {q:"Why do historians study the tools used by early societies?", options:["X unrelated to studying history","Studying tools provides no historical information","Early societies never used any tools","Tools reveal how people lived, worked, and solved problems"], answer:3}
   ]},
]},
{day:64, label:"Day 64 — Thu", subjects:[
  {subject:"Language", title:"Reading: Identifying Theme", summary:"Grade 4 Language strand: the theme of a story is its central message or lesson about life, which is different from the plot, or the events that happen.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"The theme of a story is its ___.", options:["Central message or lesson about life","List of characters only","X unrelated to theme","Number of chapters"], answer:0},
     {q:"How is theme different from plot?", options:["Theme is the underlying message, while plot is the sequence of events","Plot is the message and theme is the setting","Theme and plot always mean exactly the same thing","X unrelated to theme"], answer:0},
     {q:"A story about a character who learns to be honest after telling a lie likely has a theme about ___.", options:["Cooking","X unrelated to the story’s theme","Honesty","Travel"], answer:2},
     {q:"Why might two different stories share the same theme, such as courage?", options:["X unrelated to identifying theme","Different plots and characters can still teach a similar life lesson","Every story must have a completely unique theme","Themes can never repeat across different stories"], answer:1},
     {q:"Which question would best help a reader identify a story’s theme?", options:["What colour is the book’s cover?","X unrelated to identifying theme","What lesson does this story teach about life?","How many pages does this story have?"], answer:2}
   ]},
  {subject:"Math", title:"Estimating Products and Quotients", summary:"Grade 4 Math strand: estimating products and quotients involves rounding numbers before multiplying or dividing to quickly predict a reasonable answer.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"Estimating a product or quotient means ___.", options:["Rounding numbers first to quickly predict a reasonable answer","Ignoring the numbers completely","X unrelated to estimation","Calculating the exact answer with no rounding"], answer:0},
     {q:"Which is the best estimate for 29 × 4?", options:["120","X unrelated to the estimate","200","90"], answer:0},
     {q:"Which is the best estimate for 58 ÷ 6?", options:["10","5","20","X unrelated to the estimate"], answer:0},
     {q:"To estimate 19 × 21, you might round to ___.", options:["X unrelated to estimating this product","20 × 20","19 × 30","10 × 10"], answer:1},
     {q:"Why is estimating useful before solving a multiplication or division problem?", options:["Estimating never helps with checking an answer","It helps check whether the exact answer is reasonable","Estimating always gives the exact same result as calculating","X unrelated to estimation"], answer:1}
   ]},
  {subject:"Science", title:"Matter: Why Objects Float or Sink (Buoyancy Basics)", summary:"Grade 4 Science strand: whether an object floats or sinks in water depends on its buoyancy, which compares the object’s weight to the weight of the water it displaces.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Buoyancy refers to the ability of an object to ___.", options:["Change colour underwater","X unrelated to buoyancy","Dissolve completely in water","Float in a liquid such as water"], answer:3},
     {q:"An object generally sinks in water when it is ___.", options:["Denser (heavier for its size) than water","Lighter for its size than water","Exactly the same temperature as water","X unrelated to sinking"], answer:0},
     {q:"Which of these would most likely float in water?", options:["X unrelated to floating","A solid metal ball","A small wooden block","A heavy rock"], answer:2},
     {q:"Why can a large steel ship float, even though steel is denser than water?", options:["Its hollow shape displaces enough water to support its weight","X unrelated to buoyancy","Steel always sinks with no exceptions","Ships are not actually made of steel"], answer:0},
     {q:"Why is understanding buoyancy useful in everyday life?", options:["X unrelated to buoyancy","Buoyancy has no real-world application","All objects behave identically in water","It helps explain how boats, life jackets, and other objects behave in water"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Early Societies: Leadership and Government Structures", summary:"Grade 4 Social Studies strand: early societies organized leadership in different ways, from kings and pharaohs to councils of elders, to make decisions and maintain order.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Many early societies were led by a single powerful ruler, such as a ___.", options:["Modern prime minister","King or pharaoh","Elected mayor","X unrelated to early leadership"], answer:1},
     {q:"Some early societies made decisions through a ___.", options:["Coin toss with no discussion at all","Group of strangers chosen at random","X unrelated to early government","Council of elders or respected leaders"], answer:3},
     {q:"Why did early societies need some form of leadership or government?", options:["X unrelated to early government structures","Early societies never needed any organization","To make decisions, resolve conflicts, and maintain order","Leadership served no purpose in early societies"], answer:2},
     {q:"In ancient Egypt, the pharaoh was believed to be ___.", options:["A god-like ruler with great authority","Chosen by a public vote every year","X unrelated to Egyptian leadership","An ordinary citizen with no power"], answer:0},
     {q:"How did leadership structures in early societies differ from one another?", options:["Early societies had no leaders at all","Every early society used the exact same system of leadership","X unrelated to comparing early societies","Some had a single ruler, while others relied on councils or shared leadership"], answer:3}
   ]},
]},
{day:65, label:"Day 65 — Fri", subjects:[
  {subject:"Language", title:"Writing: Newspaper Report Writing", summary:"Grade 4 Language strand: a newspaper report presents factual information about a recent event, answering the questions who, what, where, when, why, and how in a clear headline and opening paragraph.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"A newspaper report is mainly meant to ___.", options:["Share a completely fictional made-up story","Present factual information about a recent event","Persuade readers to buy a product","X unrelated to newspaper reports"], answer:1},
     {q:"A strong newspaper report usually answers ___.", options:["X unrelated to newspaper reports","A single random question","Who, what, where, when, why, and how","Only the writer’s personal opinion"], answer:2},
     {q:"The headline of a newspaper report should ___.", options:["X unrelated to headlines","Summarize the story in a short, attention-grabbing way","Be longer than the entire article","Never relate to the story’s content"], answer:1},
     {q:"Where is the most important information usually placed in a newspaper report?", options:["X unrelated to newspaper structure","Near the beginning, in the opening paragraph","Only at the very end of the article","Hidden within the middle paragraphs"], answer:1},
     {q:"Why should a newspaper report stick to facts rather than opinions?", options:["Opinions are always more important than facts","Facts are never important in a newspaper report","So readers can trust the information as accurate and unbiased","X unrelated to newspaper writing"], answer:2}
   ]},
  {subject:"Math", title:"Classifying Polygons by Sides and Angles", summary:"Grade 4 Math strand: polygons are classified by their number of sides and angles, and can be described as regular (equal sides and angles) or irregular (unequal sides and angles).",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"A polygon is classified based on its number of ___.", options:["Sides and angles","X unrelated to classifying polygons","Curved edges","Colours"], answer:0},
     {q:"A polygon with five sides is called a ___.", options:["X unrelated to polygon names","Octagon","Hexagon","Pentagon"], answer:3},
     {q:"A polygon with six sides is called a ___.", options:["Pentagon","Heptagon","Hexagon","X unrelated to polygon names"], answer:2},
     {q:"A regular polygon has ___.", options:["X unrelated to regular polygons","A different number of sides each time","All sides and angles equal","No straight sides at all"], answer:2},
     {q:"Which best describes an irregular polygon?", options:["X unrelated to irregular polygons","It must always be a circle","It has no sides or angles at all","Its sides and angles are not all equal"], answer:3}
   ]},
  {subject:"Science", title:"Weather: Cloud Types and What They Predict", summary:"Grade 4 Science strand: clouds form in different shapes and heights, and identifying cloud types, such as cumulus, stratus, and cirrus, can help predict upcoming weather.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Clouds form when water vapour in the air ___.", options:["Instantly disappears","Cools and condenses into tiny droplets","Freezes into solid rock","X unrelated to cloud formation"], answer:1},
     {q:"Fluffy, puffy clouds with flat bottoms are called ___ clouds.", options:["Nimbus only","Cumulus","X unrelated to cloud types","Cirrus"], answer:1},
     {q:"Thin, wispy clouds high in the sky are called ___ clouds.", options:["X unrelated to cloud types","Stratus only","Cumulus","Cirrus"], answer:3},
     {q:"Flat, grey clouds that cover the sky like a blanket are called ___ clouds.", options:["Stratus","Cumulus only","X unrelated to cloud types","Cirrus"], answer:0},
     {q:"Why might meteorologists study cloud types?", options:["Cloud shapes and heights can help predict upcoming weather","Cloud types provide no useful weather information","All clouds always predict the exact same weather","X unrelated to studying weather"], answer:0}
   ]},
  {subject:"SocialStudies", title:"The Canadian Shield: Formation and Landscape", summary:"Grade 4 Social Studies strand: the Canadian Shield is a vast region of ancient rock covering much of central and northern Canada, shaped by glaciers and known for its lakes, forests, and mineral deposits.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"The Canadian Shield is best described as a vast region of ___.", options:["Flat farmland found only in southern Ontario","Ancient rock covering much of central and northern Canada","Desert sand dunes","X unrelated to the Canadian Shield"], answer:1},
     {q:"The landscape of the Canadian Shield was heavily shaped by ___.", options:["Ocean waves along a tropical coastline","Volcanic eruptions happening every year","Glaciers moving across the land long ago","X unrelated to the Canadian Shield’s formation"], answer:2},
     {q:"The Canadian Shield is known for having many ___.", options:["Sandy beaches only","X unrelated to the Canadian Shield","Lakes and forests","Skyscrapers"], answer:2},
     {q:"Why is the rock of the Canadian Shield considered especially old?", options:["It formed billions of years ago, making it some of the oldest rock on Earth","X unrelated to the Canadian Shield","The rock is not actually old at all","It formed only a few years ago"], answer:0},
     {q:"Which of these regions of Canada would you find part of the Canadian Shield?", options:["Much of Ontario and Quebec","X unrelated to the Canadian Shield’s location","Only Vancouver Island","Only Prince Edward Island"], answer:0}
   ]},
]},
{day:66, label:"Day 66 — Mon", subjects:[
  {subject:"Language", title:"Spelling: Silent Letters", summary:"Grade 4 Language strand: some English words contain silent letters that are written but not pronounced, such as the k in knee or the b in comb.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"A silent letter is a letter that is ___.", options:["Written but not pronounced","Never written in a word","Always pronounced loudly","X unrelated to silent letters"], answer:0},
     {q:"Which letter is silent in the word knee?", options:["K","E","N","X unrelated to silent letters"], answer:0},
     {q:"Which letter is silent in the word comb?", options:["B","M","C","X unrelated to silent letters"], answer:0},
     {q:"Which letter is silent in the word write?", options:["T","X unrelated to silent letters","R","W"], answer:3},
     {q:"Why can silent letters make spelling tricky for readers?", options:["Silent letters are always pronounced exactly as written","A letter appears in the word but is not heard when the word is spoken","X unrelated to spelling challenges","Silent letters never appear in the English language"], answer:1}
   ]},
  {subject:"Math", title:"Measuring Capacity: Litres and Millilitres", summary:"Grade 4 Math strand: capacity describes how much liquid a container can hold, and is measured in millilitres (mL) for small amounts and litres (L) for larger amounts.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"Capacity describes how much ___ a container can hold.", options:["Liquid","Weight","X unrelated to capacity","Length"], answer:0},
     {q:"Which unit would best measure the capacity of a large water bottle?", options:["X unrelated to measuring capacity","Grams","Kilometres","Litres"], answer:3},
     {q:"Which unit would best measure a small spoonful of liquid medicine?", options:["Litres","Millilitres","X unrelated to measuring capacity","Metres"], answer:1},
     {q:"How many millilitres are in 1 litre?", options:["X unrelated to this conversion","100 millilitres","1,000 millilitres","10 millilitres"], answer:2},
     {q:"Why is it useful to know both litres and millilitres?", options:["X unrelated to measuring capacity","Litres and millilitres always measure the exact same amount","Litres suit larger amounts, while millilitres suit smaller, more precise amounts","Only one of these units is ever used in real life"], answer:2}
   ]},
  {subject:"Science", title:"Forces: Air Resistance and Motion", summary:"Grade 4 Science strand: air resistance is a force that pushes against objects as they move through the air, slowing them down depending on their shape and speed.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Air resistance is a force that ___.", options:["Pushes against an object moving through the air","Pulls every object straight down to the ground","X unrelated to air resistance","Only affects objects underwater"], answer:0},
     {q:"Which object would experience more air resistance while falling?", options:["X unrelated to air resistance","A small pebble","An open parachute","A tightly folded piece of paper"], answer:2},
     {q:"Why does a flat sheet of paper fall more slowly than a crumpled ball of the same paper?", options:["Flat paper weighs much more than crumpled paper","Air resistance has no effect on falling paper","Its larger surface area creates more air resistance","X unrelated to air resistance"], answer:2},
     {q:"How does air resistance affect a moving bicycle?", options:["It has no effect on how a bicycle moves","It always speeds up the bicycle","X unrelated to air resistance","It pushes against the rider, making it harder to pedal quickly"], answer:3},
     {q:"Why might race car designers shape cars to reduce air resistance?", options:["X unrelated to air resistance","Race cars are designed to increase air resistance as much as possible","A streamlined shape lets the car move faster with less resistance","Reducing air resistance has no benefit for a moving car"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Canada’s National Parks and Protected Areas", summary:"Grade 4 Social Studies strand: Canada has established national parks and other protected areas to preserve natural landscapes, wildlife, and ecosystems for future generations.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"A national park is an area of land that is ___.", options:["Protected to preserve its natural landscape and wildlife","Used only for large-scale farming","X unrelated to national parks","Open for unlimited building and development"], answer:0},
     {q:"Why does Canada create protected areas such as national parks?", options:["X unrelated to conservation","To ensure land is developed as quickly as possible","To conserve natural environments and wildlife for future generations","Protected areas serve no environmental purpose"], answer:2},
     {q:"Which of these activities is commonly allowed in many Canadian national parks?", options:["Building shopping malls","Hiking and camping","Large-scale industrial mining","X unrelated to national park activities"], answer:1},
     {q:"Banff National Park, one of Canada’s oldest national parks, is located in ___.", options:["Prince Edward Island","Nova Scotia","X unrelated to Banff’s location","Alberta"], answer:3},
     {q:"How do national parks help protect biodiversity?", options:["National parks have no connection to biodiversity","They preserve habitats where many plants and animals can continue to live","National parks remove all wildlife from an area","X unrelated to protecting the environment"], answer:1}
   ]},
]},
{day:67, label:"Day 67 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Direct Objects", summary:"Grade 4 Language strand: a direct object is the noun or pronoun that receives the action of a verb in a sentence, answering the question what or whom.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"A direct object is the part of a sentence that ___.", options:["Performs the action of the verb","Describes the setting of a sentence","Receives the action of the verb","X unrelated to direct objects"], answer:2},
     {q:"In the sentence Maya kicked the ball, what is the direct object?", options:["X unrelated to the direct object","Maya","Ball","Kicked"], answer:2},
     {q:"In the sentence The chef baked a cake, what is the direct object?", options:["Baked","X unrelated to the direct object","Chef","Cake"], answer:3},
     {q:"A direct object answers which question about the verb?", options:["Where or when","What or whom","X unrelated to direct objects","How often"], answer:1},
     {q:"In the sentence The dog chased the squirrel, what is the direct object?", options:["Dog","Chased","Squirrel","X unrelated to the direct object"], answer:2}
   ]},
  {subject:"Math", title:"Comparing Prices: Unit Rate and Best Value", summary:"Grade 4 Math strand: comparing prices using unit rate means finding the cost of a single item or unit, which helps shoppers decide which option offers the best value.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"A unit rate compares the cost of ___.", options:["A single item or unit","X unrelated to unit rate","Only the tax on a purchase","An entire store’s total sales"], answer:0},
     {q:"If 4 apples cost 2 dollars, what is the unit rate per apple?", options:["2 dollars per apple","4 dollars per apple","X unrelated to this unit rate","0.50 dollars per apple"], answer:3},
     {q:"A pack of 5 pencils costs 5 dollars, and a pack of 10 pencils costs 8 dollars. Which has the better unit rate?", options:["The pack of 5 pencils","X unrelated to comparing unit rates","Both packs have the exact same unit rate","The pack of 10 pencils"], answer:3},
     {q:"Why is finding the unit rate helpful when shopping?", options:["Unit rate makes it impossible to compare prices","It helps shoppers compare prices fairly to find the best value","X unrelated to comparing prices","The total price is always more useful than the unit rate"], answer:1},
     {q:"If 3 juice boxes cost 6 dollars, what is the cost per juice box?", options:["3 dollars","6 dollars","2 dollars","X unrelated to this unit rate"], answer:2}
   ]},
  {subject:"Science", title:"Structures: Why Shape Affects Strength (Triangles vs Squares)", summary:"Grade 4 Science strand: the shape of a structure affects its strength, and triangles are especially strong because their fixed angles resist bending and twisting better than squares.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Triangles are considered a strong shape in structures because their angles ___.", options:["Change shape very easily under pressure","X unrelated to triangle strength","Have no effect on a structure’s strength","Resist bending and twisting under pressure"], answer:3},
     {q:"Compared to a triangle, a square shape is more likely to ___.", options:["Collapse or change shape under pressure","Support far more weight than a triangle","Remain perfectly rigid under any pressure","X unrelated to comparing shapes"], answer:0},
     {q:"Why do builders often use triangular supports in bridges and towers?", options:["Triangular supports have no effect on strength","Triangles make a structure weaker and less stable","X unrelated to structural design","Triangles distribute force evenly and resist bending"], answer:3},
     {q:"If you push on one corner of a square frame, what is likely to happen?", options:["The square remains rigid and never changes shape","The square becomes a triangle automatically","X unrelated to testing shape strength","The square can shift into a different shape, such as a parallelogram"], answer:3},
     {q:"Why might engineers test different shapes before building a structure?", options:["Testing shapes provides no useful information for engineers","All shapes provide exactly the same strength","X unrelated to engineering design","To find the shape that provides the most strength and stability"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Time Zones Across Canada", summary:"Grade 4 Social Studies strand: because Canada spans such a wide area from east to west, it is divided into six time zones, meaning it can be a different time of day in different parts of the country at once.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Canada is divided into time zones because it ___.", options:["Has only one region with people living in it","Is a very small country","Spans a very wide area from east to west","X unrelated to Canada’s time zones"], answer:2},
     {q:"How many time zones does Canada have?", options:["X unrelated to Canada’s time zones","Twelve","Six","One"], answer:2},
     {q:"If it is 3:00 p.m. in Ontario (Eastern time), it is generally earlier in the day in ___.", options:["A place in exactly the same time zone","X unrelated to comparing time zones","Newfoundland (Newfoundland time)","British Columbia (Pacific time)"], answer:3},
     {q:"Why might someone need to consider time zones when calling a friend in another province?", options:["Every province in Canada shares the exact same time","Time zones only matter for international travel","X unrelated to time zones","The time of day may be different in each province"], answer:3},
     {q:"Time zones are generally organized based on a location’s ___.", options:["Population size","Longitude (east-west position)","X unrelated to time zones","Latitude (north-south position) only"], answer:1}
   ]},
]},
{day:68, label:"Day 68 — Wed", subjects:[
  {subject:"Language", title:"Reading: Skimming and Scanning for Information", summary:"Grade 4 Language strand: skimming means quickly reading a text to get its general idea, while scanning means searching a text quickly for specific facts, such as a date or name.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Skimming a text means reading quickly to ___.", options:["Memorize every single word","Get the general idea of the text","X unrelated to skimming","Find one exact fact only"], answer:1},
     {q:"Scanning a text means searching quickly for ___.", options:["The author’s complete biography","A specific piece of information","The entire meaning of the text","X unrelated to scanning"], answer:1},
     {q:"Which strategy would be best for quickly finding a specific date in a long article?", options:["X unrelated to finding a specific fact","Reading every single word carefully","Scanning","Skimming"], answer:2},
     {q:"Which strategy would be best for getting a quick overview of what a chapter is about?", options:["Memorizing the chapter word for word","Skimming","Scanning","X unrelated to getting an overview"], answer:1},
     {q:"Why are skimming and scanning useful reading strategies?", options:["X unrelated to reading strategies","They help readers find information efficiently without reading every word","These strategies always take longer than reading word for word","They prevent readers from understanding a text at all"], answer:1}
   ]},
  {subject:"Math", title:"Tally Charts and Frequency Tables", summary:"Grade 4 Math strand: a tally chart uses marks to record how often something occurs, and this data can be organized into a frequency table showing the total count for each category.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"A tally chart uses marks to record ___.", options:["How often something occurs","X unrelated to tally charts","The colour of an object","The exact size of an object"], answer:0},
     {q:"In tally marks, a group of five is usually shown as ___.", options:["Four vertical lines with a line crossed through them","X unrelated to tally marks","Five separate dots","A single curved line"], answer:0},
     {q:"A frequency table organizes data by showing the ___ for each category.", options:["Colour","Total count","Alphabetical order only","X unrelated to frequency tables"], answer:1},
     {q:"If a tally chart shows a group of 5, then a group of 5, then 2 more marks for a category, how many are recorded?", options:["X unrelated to this tally count","10","14","12"], answer:3},
     {q:"Why might a survey use a tally chart while collecting data?", options:["Tally charts make it impossible to count responses","Tally charts can only be used for numbers larger than 100","X unrelated to collecting data","It makes it quick and easy to record and count responses"], answer:3}
   ]},
  {subject:"Science", title:"Electricity: Reading Simple Circuit Diagrams", summary:"Grade 4 Science strand: a circuit diagram uses standard symbols to represent parts of an electric circuit, such as a battery, switch, and light bulb, showing how they are connected.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"A circuit diagram uses symbols to represent ___.", options:["The colours of the wires only","X unrelated to circuit diagrams","The parts of an electric circuit and how they connect","The weather conditions outside"], answer:2},
     {q:"Which symbol typically represents a battery in a circuit diagram?", options:["A perfect circle with no lines","A wavy line","A pair of parallel lines, one longer than the other","X unrelated to circuit diagrams"], answer:2},
     {q:"In a circuit diagram, a switch symbol shows where the circuit can be ___.", options:["Opened or closed to control the flow of electricity","Filled with water","X unrelated to switches","Permanently broken with no way to reconnect it"], answer:0},
     {q:"Why are standard symbols used in circuit diagrams instead of drawings of real objects?", options:["X unrelated to circuit diagrams","Standard symbols make circuits impossible to understand","Every country uses completely different, unrelated symbols","They allow anyone to read and understand a circuit clearly and quickly"], answer:3},
     {q:"If a circuit diagram shows a break in the line connecting the parts, what does this likely mean?", options:["The circuit is complete and functioning normally","X unrelated to reading circuit diagrams","The circuit is open and electricity cannot flow","The diagram contains no useful information"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Natural Hazards in Canada (Floods, Forest Fires, Earthquakes)", summary:"Grade 4 Social Studies strand: different regions of Canada face different natural hazards, such as floods near rivers, forest fires in dry forested areas, and earthquakes along the west coast.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"A natural hazard is an event caused by nature that can ___.", options:["Only occur in outer space","Never affect people in any way","Threaten people, property, or the environment","X unrelated to natural hazards"], answer:2},
     {q:"Areas near rivers are especially at risk of ___.", options:["Volcanic eruptions","Earthquakes only","X unrelated to river hazards","Flooding"], answer:3},
     {q:"Dry, forested regions of Canada are especially at risk of ___.", options:["Forest fires","X unrelated to forest hazards","Blizzards only","Flooding from the ocean"], answer:0},
     {q:"Which region of Canada is more likely to experience earthquakes?", options:["The flat Prairies","The west coast, such as British Columbia","The Atlantic coast only","X unrelated to earthquake risk"], answer:1},
     {q:"Why is it useful for communities to understand the natural hazards in their region?", options:["Natural hazards never affect any Canadian community","X unrelated to natural hazards","Understanding natural hazards provides no benefit to a community","It helps them prepare and respond safely to potential emergencies"], answer:3}
   ]},
]},
{day:69, label:"Day 69 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Connotation and Denotation", summary:"Grade 4 Language strand: denotation is the exact dictionary meaning of a word, while connotation is the feeling or association a word carries beyond its literal meaning.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Denotation refers to a word’s ___.", options:["Emotional feeling only","Number of syllables","X unrelated to denotation","Exact dictionary meaning"], answer:3},
     {q:"Connotation refers to the ___ a word carries beyond its literal meaning.", options:["Exact spelling","Feeling or association","Number of letters","X unrelated to connotation"], answer:1},
     {q:"The words skinny and slim have similar denotations but different ___.", options:["Connotations","Spellings","X unrelated to comparing these words","Pronunciations"], answer:0},
     {q:"Which word has a more positive connotation than stubborn?", options:["Careless","X unrelated to comparing connotations","Messy","Determined"], answer:3},
     {q:"Why might a writer carefully choose words based on their connotation?", options:["To create a specific feeling or impression for the reader","X unrelated to word choice","Connotation has no effect on how a reader feels","Every word carries exactly the same feeling"], answer:0}
   ]},
  {subject:"Math", title:"Number Lines: Plotting Fractions and Decimals", summary:"Grade 4 Math strand: fractions and decimals can be plotted on a number line to compare their values and see how they relate to whole numbers.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"A number line can be used to ___.", options:["Only show whole numbers greater than 100","Measure the weight of an object","Compare the values of fractions and decimals","X unrelated to number lines"], answer:2},
     {q:"On a number line from 0 to 1, where would 1/2 be plotted?", options:["Right next to 0","X unrelated to plotting fractions","Exactly halfway between 0 and 1","Right next to 1"], answer:2},
     {q:"On a number line, which is closer to 1: 0.75 or 0.25?", options:["0.25","X unrelated to comparing these decimals","They are equally close to 1","0.75"], answer:3},
     {q:"Where would the fraction 3/4 be plotted on a number line between 0 and 1?", options:["Exactly at 0","Closer to 0 than to 1","Closer to 1 than to 0","X unrelated to plotting this fraction"], answer:2},
     {q:"Why is it useful to plot fractions and decimals on the same number line?", options:["It helps show how fractions and decimals relate to and compare with each other","X unrelated to number lines","Fractions and decimals can never be compared to one another","A number line can only show whole numbers"], answer:0}
   ]},
  {subject:"Science", title:"Compound Machines: Combining Simple Machines", summary:"Grade 4 Science strand: a compound machine is made by combining two or more simple machines, such as a wheelbarrow (lever and wheel and axle) or scissors (two levers), to make work easier.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"A compound machine is made by combining ___.", options:["A single simple machine used alone","Two or more simple machines","X unrelated to compound machines","Only electrical parts"], answer:1},
     {q:"A wheelbarrow is an example of a compound machine because it combines a ___.", options:["X unrelated to how a wheelbarrow works","Wedge and an inclined plane only","Lever and a wheel and axle","Pulley and a screw"], answer:2},
     {q:"Scissors are considered a compound machine because they are made of ___.", options:["X unrelated to how scissors work","Two levers joined together","A wheel and axle only","A single pulley"], answer:1},
     {q:"Why might combining simple machines create a more useful tool?", options:["Combined machines can make certain tasks even easier than a single simple machine","Combining simple machines always makes tasks harder to complete","Simple machines cannot be combined with one another","X unrelated to compound machines"], answer:0},
     {q:"Which of these is an example of a compound machine?", options:["A single ramp with nothing else attached","A bicycle, which combines wheels, levers, and gears","X unrelated to compound machines","A single lever with no other parts"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Canada’s Population Distribution: Where People Live", summary:"Grade 4 Social Studies strand: most of Canada’s population lives in a narrow band near the southern border, close to resources, transportation, and warmer climates, while northern regions remain sparsely populated.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Most of Canada’s population lives ___.", options:["Spread evenly across the entire country","X unrelated to Canada’s population","In a narrow band near the southern border","Mostly in the far north"], answer:2},
     {q:"Why do fewer people live in Canada’s northern regions?", options:["The climate is harsher and there are fewer transportation routes and services","X unrelated to population distribution","Everyone in Canada is required to live in the south","The north has no land at all"], answer:0},
     {q:"Which factor most influences where Canadians choose to settle?", options:["Access to resources, jobs, and transportation","The colour of the provincial flag","The number of letters in a city’s name","X unrelated to population distribution"], answer:0},
     {q:"Which of these Canadian cities would likely have one of the largest populations?", options:["Toronto","A remote research station","X unrelated to comparing population size","A small hamlet in Nunavut"], answer:0},
     {q:"Why do geographers study population distribution?", options:["Every region of Canada has an identical population","Population distribution provides no useful information","It helps explain how and why people are spread across a country","X unrelated to studying geography"], answer:2}
   ]},
]},
{day:70, label:"Day 70 — Fri", subjects:[
  {subject:"Language", title:"Review: Vocabulary, Grammar, and Reading Skills (Days 61-69)", summary:"Grade 4 Language strand: this review lesson revisits key ideas from Days 61-69, including analogies, alliteration, interjections, theme, and skimming and scanning.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"An analogy compares two pairs of words that share the same ___.", options:["Spelling pattern","Type of relationship","Number of letters","X unrelated to analogies"], answer:1},
     {q:"Alliteration is the repetition of the same ___ in nearby words.", options:["Beginning consonant sound","Ending vowel sound","X unrelated to alliteration","Number of syllables"], answer:0},
     {q:"An interjection is a word that expresses ___.", options:["A location in a sentence","Strong emotion","A complete action","X unrelated to interjections"], answer:1},
     {q:"The theme of a story is its ___.", options:["Number of chapters","Central message or lesson about life","X unrelated to theme","List of characters only"], answer:1},
     {q:"Why is it useful to review vocabulary, grammar, and reading strategies together?", options:["Reviewing past learning never helps strengthen understanding","It reinforces how these language skills support clear reading and writing","X unrelated to reviewing language arts","These skills have no connection to each other"], answer:1}
   ]},
  {subject:"Math", title:"Review: Number Sense, Geometry, and Data (Days 61-69)", summary:"Grade 4 Math strand: this review lesson revisits key ideas from Days 61-69, including place value, multiplying 2-digit numbers, rounding decimals, classifying polygons, and tally charts.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"In the number 6,482, the digit 4 represents ___.", options:["X unrelated to place value","4 hundreds","4 thousands","4 tens"], answer:1},
     {q:"What is 12 × 13?", options:["X unrelated to the calculation","136","146","156"], answer:3},
     {q:"What is 4.7 rounded to the nearest whole number?", options:["5","6","4","X unrelated to the calculation"], answer:0},
     {q:"A polygon with five sides is called a ___.", options:["X unrelated to polygon names","Octagon","Hexagon","Pentagon"], answer:3},
     {q:"Why is it useful to review place value, multiplication, and geometry together?", options:["These topics have no connection to each other","X unrelated to reviewing math","Review never helps strengthen understanding of a subject","It reinforces how these math concepts connect and build on one another"], answer:3}
   ]},
  {subject:"Science", title:"Review: Ecosystems, Earth and Space, and Structures (Days 61-69)", summary:"Grade 4 Science strand: this review lesson revisits key ideas from Days 61-69, including Canadian biomes, camouflage, Earth’s rotation, buoyancy, air resistance, and structural strength.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"A biome is best described as a large region with a distinct ___.", options:["Type of rock only","Climate, plants, and animals","Style of building","X unrelated to biomes"], answer:1},
     {q:"Camouflage helps an animal ___.", options:["Grow larger than other animals","Blend into its surroundings to avoid predators","X unrelated to camouflage","Attract as much attention as possible"], answer:1},
     {q:"Day and night occur because Earth ___.", options:["Rotates on its axis","X unrelated to day and night","Changes shape every day","Stops moving completely"], answer:0},
     {q:"Triangles are considered a strong shape in structures because their angles ___.", options:["Have no effect on a structure’s strength","Change shape very easily under pressure","X unrelated to triangle strength","Resist bending and twisting under pressure"], answer:3},
     {q:"Why is it useful to review ecosystems, space, and structures together?", options:["Each topic must be studied with no connection to the others","It reinforces how these science concepts each explain different parts of the natural world","These topics have no connection to each other","Review is never useful in science"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Review: Early Societies and Canadian Geography (Days 61-69)", summary:"Grade 4 Social Studies strand: this review lesson revisits key ideas from Days 61-69, including the Maya, Nubia, early leadership, the Canadian Shield, time zones, and population distribution.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"The ancient Maya civilization was located in ___.", options:["Northern Europe","Central America","Southern Africa","X unrelated to the Maya"], answer:1},
     {q:"Nubia became especially well known for its skill in working with ___.", options:["Rubber","Iron","X unrelated to Nubian achievements","Plastic"], answer:1},
     {q:"The Canadian Shield is best described as a vast region of ___.", options:["Desert sand dunes","Flat farmland found only in southern Ontario","X unrelated to the Canadian Shield","Ancient rock covering much of central and northern Canada"], answer:3},
     {q:"How many time zones does Canada have?", options:["Six","One","Twelve","X unrelated to Canada’s time zones"], answer:0},
...
{day:81, label:"Day 81 — Mon", subjects:[
  {subject:"Language", title:"Vocabulary: Portmanteau Words and Blends", summary:"Grade 4 Language strand: a portmanteau word blends the sounds and meanings of two words into one new word, such as combining breakfast and lunch to make brunch.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"A portmanteau word blends the sounds and meanings of how many words?", options:["Two","A concept unrelated to vocabulary","Zero","Three"], answer:0},
     {q:"Which word is a portmanteau made from breakfast and lunch?", options:["Meal","Brunch","Snack","Dinner"], answer:1},
     {q:"Which word is a portmanteau made from smoke and fog?", options:["Fogsmoke","Mist","Smog","Cloud"], answer:2},
     {q:"Why might people create portmanteau words instead of using two separate words?", options:["Portmanteau words are always longer than using two words","This concept has no connection to vocabulary","They can quickly describe something new by combining familiar ideas","Portmanteau words never have any real meaning"], answer:2},
     {q:"Which of these is an example of a portmanteau word?", options:["Rewrite, a word with a prefix","Motel, from motor and hotel","Sunlight, a compound word","Happiness, a word with a suffix"], answer:1}
   ]},
  {subject:"Math", title:"Multiplying Decimals by Whole Numbers", summary:"Grade 4 Math strand: students learn to multiply a decimal number by a whole number, such as finding 0.4 times 3, by thinking of the decimal as tenths or hundredths.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is 0.4 times 3?", options:["12","0.7","1.4","1.2"], answer:3},
     {q:"What is 0.2 times 5?", options:["1.0","0.7","2.5","10"], answer:0},
     {q:"What is 1.5 times 2?", options:["3.0","1.7","15","2.5"], answer:0},
     {q:"When multiplying a decimal by a whole number, why is it helpful to think of the decimal as tenths?", options:["This concept has no connection to multiplication","Tenths always make multiplication impossible","It helps keep track of the correct place value in the answer","Decimals have no connection to place value"], answer:2},
     {q:"What is 0.6 times 4?", options:["0.24","24","2.0","2.4"], answer:3}
   ]},
  {subject:"Science", title:"Science: Ecosystems: Food Webs vs Food Chains", summary:"Grade 4 Science strand: a food chain shows a single path of energy from one living thing to the next, while a food web shows many connected food chains, illustrating an ecosystem’s more complex feeding relationships.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Does a food chain show a single path of energy, or many connected paths?", options:["A single path","Many connected paths","A concept unrelated to ecosystems","No path at all"], answer:0},
     {q:"Does a food web show a single path of energy, or many connected food chains?", options:["A single path only","Many connected food chains","A concept unrelated to ecosystems","No connections at all"], answer:1},
     {q:"Which shows a more complete picture of an ecosystem’s feeding relationships, a food chain or a food web?", options:["A food chain","They are exactly the same thing","A food web","Neither shows any feeding relationships"], answer:2},
     {q:"Why might scientists prefer using a food web instead of a single food chain to study an ecosystem?", options:["A single food chain always shows more information than a food web","A food web shows how many different species are connected through feeding relationships","Food webs have no connection to ecosystems","This concept has no relevance to science"], answer:1},
     {q:"What might happen to a food web if one species disappeared from the ecosystem?", options:["Removing one species would never affect any other species","Food webs never change no matter what happens","This concept has no connection to ecosystems","Other species connected to it could also be affected"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Ancient Aztec Civilization", summary:"Grade 4 Social Studies strand: the Aztec civilization built a powerful empire in what is now Mexico, known for its capital city Tenochtitlan, advanced farming methods, and detailed calendar system.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"In what area did the Aztec civilization build its empire?", options:["What is now Canada","What is now Mexico","A concept unrelated to ancient civilizations","What is now Australia"], answer:1},
     {q:"What was the name of the Aztec capital city?", options:["Rome","Tenochtitlan","A concept unrelated to the Aztecs","Athens"], answer:1},
     {q:"Were the Aztecs known for advanced farming methods?", options:["A concept unrelated to the Aztecs","They never grew any food","Yes","No, they had no farming methods at all"], answer:2},
     {q:"Why might the Aztecs’ detailed calendar system have been important to their society?", options:["Calendars have no connection to ancient societies","This concept has no relevance to social studies","It likely helped them plan farming, festivals, and other important events","The Aztecs never used any kind of calendar"], answer:2},
     {q:"Why do historians study ancient civilizations like the Aztecs?", options:["This concept has no relevance to social studies","Ancient civilizations have no connection to history","Studying past societies has no value at all","To understand how past societies lived, built cities, and organized their communities"], answer:3}
   ]},
]},
{day:82, label:"Day 82 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Active and Passive Voice", summary:"Grade 4 Language strand: in the active voice, the subject performs the action, such as The dog chased the ball, while in the passive voice, the subject receives the action, such as The ball was chased by the dog.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"In the active voice, does the subject perform the action or receive it?", options:["A concept unrelated to grammar","Neither perform nor receive it","Receive it","Perform it"], answer:3},
     {q:"In the passive voice, does the subject perform the action or receive it?", options:["Receive it","Perform it","Neither perform nor receive it","A concept unrelated to grammar"], answer:0},
     {q:"Which sentence is written in the active voice?", options:["A concept unrelated to grammar","The ball chased itself.","The ball was chased by the dog.","The dog chased the ball."], answer:3},
     {q:"Which sentence is written in the passive voice?", options:["A concept unrelated to grammar","The ball was chased by the dog.","The dog is fast.","The dog chased the ball."], answer:1},
     {q:"Why might a writer choose the active voice over the passive voice?", options:["This concept has no connection to writing style","Active voice often sounds clearer and more direct","Passive voice always sounds clearer than active voice","The active voice is never used by writers"], answer:1}
   ]},
  {subject:"Math", title:"Dividing Decimals by Whole Numbers", summary:"Grade 4 Math strand: students learn to divide a decimal number by a whole number, such as finding 6.4 divided by 2, keeping careful track of the decimal point in the answer.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is 6.4 divided by 2?", options:["2.2","3.2","32","3.4"], answer:1},
     {q:"What is 8.4 divided by 4?", options:["4.2","2.1","84","2.4"], answer:1},
     {q:"What is 9.0 divided by 3?", options:["90","3.0","2.7","3.9"], answer:1},
     {q:"When dividing a decimal by a whole number, what should you carefully keep track of?", options:["The position of the decimal point","Only the colour of the numbers","Only the size of the whole number","A concept unrelated to division"], answer:0},
     {q:"What is 5.5 divided by 5?", options:["1.1","5.5","1.5","11"], answer:0}
   ]},
  {subject:"Science", title:"Science: Comets and Asteroids", summary:"Grade 4 Science strand: a comet is a ball of ice and dust that develops a glowing tail as it nears the Sun, while an asteroid is a rocky object that orbits the Sun, often found in a belt between Mars and Jupiter.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is a comet mostly made of?", options:["A concept unrelated to space","Only solid rock","Ice and dust","Only metal"], answer:2},
     {q:"What is an asteroid mostly made of?", options:["Rock","A concept unrelated to space","Only gas","Only ice"], answer:0},
     {q:"Does a comet develop a glowing tail as it nears the Sun?", options:["No, comets never develop a tail","Only asteroids develop tails","A concept unrelated to comets","Yes"], answer:3},
     {q:"Where is a well-known belt of asteroids located in our solar system?", options:["A concept unrelated to the solar system","Beyond Pluto only","Between Mars and Jupiter","Between Earth and the Moon"], answer:2},
     {q:"Why might scientists study comets and asteroids?", options:["They can teach us about the early materials that formed our solar system","This concept has no relevance to space science","Comets and asteroids have no connection to the solar system","Studying comets and asteroids has no scientific value"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of Museums in Preserving History", summary:"Grade 4 Social Studies strand: museums collect, preserve, and display historical artifacts and stories, helping communities learn about and remember important parts of their past.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do museums do with historical artifacts, besides displaying them?", options:["Collect and preserve them","Ignore them completely","Throw them away","A concept unrelated to museums"], answer:0},
     {q:"Do museums help communities learn about and remember their past?", options:["No, museums have no connection to the past","A concept unrelated to history","Yes","Museums only display modern objects"], answer:2},
     {q:"Name one thing you might find preserved in a museum, such as an old artifact.", options:["A brand new smartphone","An old artifact","A concept unrelated to museums","A fresh loaf of bread"], answer:1},
     {q:"Why is it important for museums to carefully preserve historical artifacts?", options:["Historical artifacts never need any care at all","Preserving artifacts has no value to a community","So future generations can learn about and understand the past","This concept has no relevance to social studies"], answer:2},
     {q:"How might visiting a museum help a student understand a historical event better than just reading about it?", options:["Museums never help anyone understand history","Reading and visiting a museum are always exactly the same experience","Seeing real artifacts and exhibits can make history feel more real and memorable","This concept has no connection to learning about the past"], answer:2}
   ]},
]},
{day:83, label:"Day 83 — Wed", subjects:[
  {subject:"Language", title:"Reading: Analyzing Symbolism in Stories", summary:"Grade 4 Language strand: symbolism is when an author uses an object, colour, or image to represent a deeper idea, such as a dove often symbolizing peace.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What do we call it when an author uses an object to represent a deeper idea?", options:["A grammar rule","A math pattern","A concept unrelated to reading","Symbolism"], answer:3},
     {q:"What does a dove often symbolize in stories?", options:["Anger","War","A concept unrelated to symbolism","Peace"], answer:3},
     {q:"Can a colour, like the colour black, be used as a symbol in a story?", options:["Only objects can be symbols, never colours","No, colours are never used as symbols","Yes","A concept unrelated to reading"], answer:2},
     {q:"Why might an author use symbolism instead of directly stating an idea?", options:["Authors should always state ideas directly and never use symbols","It can add deeper meaning and invite readers to think more carefully","Symbolism never adds meaning to a story","This concept has no connection to storytelling"], answer:1},
     {q:"If a story repeatedly shows a wilting flower as a character grows sadder, what might the flower symbolize?", options:["The flower has no symbolic meaning","A concept unrelated to the character’s feelings","Nothing at all connected to the story","The character’s fading hope or happiness"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Classifying Quadrilaterals by Properties", summary:"Grade 4 Math strand: quadrilaterals can be classified by their properties, such as a parallelogram having two pairs of parallel sides, and a rhombus having four equal sides.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"How many pairs of parallel sides does a parallelogram have?", options:["Four","Two","Zero","One"], answer:1},
     {q:"How many equal sides does a rhombus have?", options:["Three","Four","Two","Zero"], answer:1},
     {q:"Is a square a special type of rhombus with four right angles?", options:["A concept unrelated to quadrilaterals","A square has no right angles","No, a square is never a rhombus","Yes"], answer:3},
     {q:"What property must a shape have to be classified as a quadrilateral?", options:["No sides at all","Five sides","Three sides","Four sides"], answer:3},
     {q:"Which of these shapes always has four equal sides?", options:["A rectangle that is not a square","A trapezoid","A rhombus","A triangle"], answer:2}
   ]},
  {subject:"Science", title:"Science: Weather Fronts and Air Masses", summary:"Grade 4 Science strand: an air mass is a large body of air with a similar temperature and moisture, and a front is where two different air masses meet, often causing changes in the weather.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What do we call a large body of air with a similar temperature and moisture?", options:["A rock formation","A type of soil","An air mass","A concept unrelated to weather"], answer:2},
     {q:"What do we call the place where two different air masses meet?", options:["A rock cycle","A tide","A front","A concept unrelated to weather"], answer:2},
     {q:"Can a front cause changes in the weather?", options:["Yes","No, fronts never affect the weather","A concept unrelated to weather","Fronts only occur in the ocean"], answer:0},
     {q:"Why might meteorologists track air masses and fronts to predict weather?", options:["Weather never actually changes because of fronts","This concept has no relevance to science","Air masses and fronts have no connection to weather prediction","Where air masses meet can signal upcoming changes, like rain or temperature shifts"], answer:3},
     {q:"What might happen when a cold air mass meets a warm air mass?", options:["This concept has no connection to weather patterns","Weather changes can occur, such as clouds or precipitation forming","Nothing at all happens when air masses meet","The two air masses always instantly become identical"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canada’s Peacekeeping Role Internationally", summary:"Grade 4 Social Studies strand: Canada has a history of contributing peacekeepers, often through the United Nations, to help maintain peace and stability in regions experiencing conflict.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do we call soldiers sent to help maintain peace in a conflict region?", options:["A concept unrelated to international relations","Firefighters","Postal workers","Peacekeepers"], answer:3},
     {q:"Has Canada historically contributed peacekeepers to international efforts?", options:["Only other countries send peacekeepers","A concept unrelated to Canada","Yes","No, Canada has never contributed peacekeepers"], answer:2},
     {q:"Through what international organization has Canada often sent peacekeepers?", options:["A local town council","A single private company","The United Nations","A concept unrelated to peacekeeping"], answer:2},
     {q:"Why might a country choose to send peacekeepers to a conflict region?", options:["This concept has no connection to international relations","Peacekeepers never help with maintaining peace","Sending peacekeepers always increases conflict","To help maintain peace and stability where conflict is occurring"], answer:3},
     {q:"Why might Canada’s peacekeeping role be an important part of its national identity?", options:["Peacekeeping has no connection to national identity","This concept has no relevance to Canadian history","It reflects Canada’s values of cooperation and supporting global peace","Canada has no international role at all"], answer:2}
   ]},
]},
{day:84, label:"Day 84 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Speech", summary:"Grade 4 Language strand: a speech is a piece of writing meant to be spoken aloud to an audience, often including a strong opening, clear main points, and a memorable closing.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What kind of writing is meant to be spoken aloud to an audience?", options:["A weather report","A grocery list","A concept unrelated to writing","A speech"], answer:3},
     {q:"Should a speech include a strong opening to capture the audience’s attention?", options:["Yes","Only the closing matters in a speech","A concept unrelated to writing","No, openings are never important in a speech"], answer:0},
     {q:"Should a speech include clear main points for the audience to follow?", options:["Main points are only needed in essays, never speeches","Yes","A concept unrelated to writing","No, speeches should never have any main points"], answer:1},
     {q:"Why might a speech benefit from a memorable closing?", options:["A speech should never have any kind of ending","This concept has no connection to writing a speech","It helps the message stick with the audience after the speech ends","Closings never affect how an audience remembers a speech"], answer:2},
     {q:"Which of these is most likely the opening line of a speech about kindness?", options:["Have you ever wondered how one small act of kindness can change someone’s whole day?","Add 3 and 4 to get 7.","The chemical symbol for water is H2O.","A triangle has three sides."], answer:0}
   ]},
  {subject:"Math", title:"Data: Stem-and-Leaf Plots", summary:"Grade 4 Math strand: a stem-and-leaf plot organizes numerical data by splitting each number into a stem, its leading digit or digits, and a leaf, its final digit, making patterns in the data easier to see.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"In a stem-and-leaf plot, what does the stem usually represent?", options:["The leading digit or digits of a number","A concept unrelated to data","The colour of the data","The final digit of a number"], answer:0},
     {q:"In a stem-and-leaf plot, what does the leaf usually represent?", options:["A concept unrelated to data","The leading digit of a number","The average of the data","The final digit of a number"], answer:3},
     {q:"In the number 42, if 4 is the stem, what is the leaf?", options:["24","4","42","2"], answer:3},
     {q:"Why might a stem-and-leaf plot be useful for organizing a set of test scores?", options:["It can show patterns in the data, like where most scores cluster","This concept has no connection to organizing data","Stem-and-leaf plots never show any patterns","Test scores can never be organized in a plot"], answer:0},
     {q:"What is a key benefit of a stem-and-leaf plot compared to just a list of numbers?", options:["Lists of numbers are always clearer than a stem-and-leaf plot","A stem-and-leaf plot always hides the exact values","It keeps the exact values while also showing the data’s overall shape","This concept has no benefit at all"], answer:2}
   ]},
  {subject:"Science", title:"Science: Air Pollution and Clean Air Initiatives", summary:"Grade 4 Science strand: air pollution happens when harmful substances, such as smoke or chemicals, enter the air, and clean air initiatives, like reducing car emissions, help protect air quality.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What happens when harmful substances like smoke enter the air?", options:["Photosynthesis","A concept unrelated to air quality","Air pollution","Clean air"], answer:2},
     {q:"Name one example of a clean air initiative, such as reducing car emissions.", options:["A concept unrelated to air quality","Ignoring air quality completely","Increasing pollution on purpose","Reducing car emissions"], answer:3},
     {q:"Can air pollution be harmful to people and the environment?", options:["No, air pollution is never harmful","Air pollution only affects plants, never people","A concept unrelated to air quality","Yes"], answer:3},
     {q:"Why might a city encourage people to use public transportation instead of cars?", options:["It can help reduce air pollution from car emissions","Using cars always improves air quality","Public transportation has no connection to air quality","This concept has no relevance to science"], answer:0},
     {q:"Why is monitoring air quality important for a community’s health?", options:["This concept has no relevance to science","Poor air quality can affect breathing and overall health","Air pollution never actually affects anyone’s health","Air quality has no connection to health"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Comparing Monarchy, Democracy, and Dictatorship", summary:"Grade 4 Social Studies strand: countries can be governed in different ways, including a monarchy led by a king or queen, a democracy where citizens vote for leaders, and a dictatorship led by one person with total control.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"In a monarchy, who typically leads the country?", options:["Citizens who vote","No one leads at all","A king or queen","A concept unrelated to government"], answer:2},
     {q:"In a democracy, how are leaders typically chosen?", options:["Citizens vote for them","A concept unrelated to government","A single king or queen decides","Leaders are chosen at random"], answer:0},
     {q:"In a dictatorship, how much control does typically one single leader have?", options:["A concept unrelated to government","No control at all","Total control","Equal control shared among all citizens"], answer:2},
     {q:"Why might citizens in a democracy have more say in their government compared to a dictatorship?", options:["This concept has no relevance to government systems","Democracies and dictatorships work in exactly the same way","Citizens in a democracy can vote for their leaders and influence decisions","Citizens never have any say in a democracy"], answer:2},
     {q:"Why is it useful to compare different systems of government, like monarchy, democracy, and dictatorship?", options:["Comparing government systems has no educational value","It helps us understand how power and decisions are organized differently around the world","All systems of government are always identical","This concept has no relevance to social studies"], answer:1}
   ]},
]},
{day:85, label:"Day 85 — Fri", subjects:[
  {subject:"Language", title:"Figurative Language: Oxymorons", summary:"Grade 4 Language strand: an oxymoron combines two contradictory words for effect, such as jumbo shrimp or deafening silence, creating an interesting or thought-provoking phrase.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What do we call a phrase that combines two contradictory words, like jumbo shrimp?", options:["A homophone","An oxymoron","A synonym","A concept unrelated to figurative language"], answer:1},
     {q:"Which of these is an example of an oxymoron?", options:["A quiet library","A loud concert","A silent night","Deafening silence"], answer:3},
     {q:"Why do the two words in an oxymoron seem to contradict each other?", options:["This concept has no connection to figurative language","They have opposite or conflicting meanings","The two words always mean the exact same thing","Oxymorons never actually combine two words"], answer:1},
     {q:"Why might a writer use an oxymoron like bittersweet in their writing?", options:["Oxymorons never add any meaning to writing","It can capture a complex feeling that a single word cannot fully express","A bittersweet feeling can always be described with just one simple word","This concept has no connection to figurative language"], answer:1},
     {q:"Which of these phrases is an oxymoron?", options:["Bright sunshine","Fast car","Original copy","Tall building"], answer:2}
   ]},
  {subject:"Math", title:"Fractions: Adding Mixed Numbers", summary:"Grade 4 Math strand: students learn to add two mixed numbers, such as 2 and 1 fourth plus 1 and 2 fourths, by adding the whole numbers and the fractions separately, then combining the results.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is 2 and 1 fourth plus 1 and 2 fourths?", options:["3 and 2 fourths","4 and 3 fourths","3 and 1 fourth","3 and 3 fourths"], answer:3},
     {q:"What is 1 and 1 third plus 1 and 1 third?", options:["1 and 2 thirds","3 and 2 thirds","2 and 1 third","2 and 2 thirds"], answer:3},
     {q:"What is 3 and 1 fifth plus 2 and 2 fifths?", options:["5 and 1 fifth","5 and 2 fifths","5 and 3 fifths","6 and 3 fifths"], answer:2},
     {q:"When adding mixed numbers, what should you add first?", options:["Only the fractions, ignoring the whole numbers completely","Only the whole numbers, ignoring the fractions completely","Neither part should ever be added","The whole numbers and the fractions can each be added separately"], answer:3},
     {q:"What is 4 and 2 sixths plus 1 and 3 sixths?", options:["5 and 6 sixths","6 and 5 sixths","5 and 2 sixths","5 and 5 sixths"], answer:3}
   ]},
  {subject:"Science", title:"Science: Desert Survival Strategies", summary:"Grade 4 Science strand: desert plants and animals have special adaptations for survival, such as storing water, being active at night to avoid heat, and having features that reduce water loss.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Name one adaptation of a desert plant, such as storing water.", options:["Storing water","A concept unrelated to desert survival","Growing in deep snow","Living underwater"], answer:0},
     {q:"Do some desert animals stay active at night to avoid daytime heat?", options:["No, all desert animals are active only during the hottest part of the day","Desert animals are never affected by heat","A concept unrelated to adaptations","Yes"], answer:3},
     {q:"Why might a desert animal have features that reduce water loss?", options:["Water is scarce in the desert, so conserving it helps the animal survive","This concept has no relevance to adaptations","Water loss has no connection to desert survival","Deserts always have plenty of available water"], answer:0},
     {q:"Why do many desert animals rest during the hottest part of the day?", options:["Desert animals never need to avoid the heat","To avoid losing too much water and overheating","Resting has no connection to surviving desert heat","This concept has no relevance to science"], answer:1},
     {q:"Why might a cactus’s thick, waxy skin help it survive in the desert?", options:["Cacti never need to store any water","Thick skin has no connection to water loss","It helps the plant hold onto its stored water longer","This concept has no relevance to desert adaptations"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of the United Nations", summary:"Grade 4 Social Studies strand: the United Nations is an international organization where countries work together on issues like peace, human rights, and humanitarian aid.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do we call the international organization where countries work together on global issues?", options:["A concept unrelated to international relations","A single country’s government","A local town council","The United Nations"], answer:3},
     {q:"Name one issue the United Nations works on, such as peace or human rights.", options:["Peace","A backyard garden","A local school rule","A concept unrelated to the United Nations"], answer:0},
     {q:"Do many different countries work together as part of the United Nations?", options:["No, only one single country is involved","Yes","A concept unrelated to the United Nations","The United Nations has no members at all"], answer:1},
     {q:"Why might countries choose to work together through an organization like the United Nations?", options:["Countries never benefit from working together","This concept has no connection to international relations","Global issues never require cooperation between countries","Cooperating can help solve problems that affect many countries at once"], answer:3},
     {q:"Why might humanitarian aid be an important part of the United Nations’ work?", options:["People affected by disasters never need any help","Humanitarian aid has no connection to the United Nations","It can help people affected by disasters or conflict around the world","This concept has no relevance to social studies"], answer:2}
   ]},
]},
{day:86, label:"Day 86 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Correlative Conjunctions", summary:"Grade 4 Language strand: correlative conjunctions are pairs of words that work together to join related ideas, such as either/or, neither/nor, and both/and.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Correlative conjunctions are pairs of words that work together to do what?", options:["End every sentence","Join related ideas","A concept unrelated to grammar","Replace all nouns in a sentence"], answer:1},
     {q:"Which of these is a pair of correlative conjunctions?", options:["Cat/dog","Run/jump","Blue/red","Either/or"], answer:3},
     {q:"Which of these is a pair of correlative conjunctions?", options:["Neither/nor","Fast/slow","Up/down","Happy/sad"], answer:0},
     {q:"Which sentence correctly uses correlative conjunctions?", options:["Either you can walk, or you can bike.","Bike or you can either walk you can.","Either walk you can, bike or you can.","You either can walk bike or you can."], answer:0},
     {q:"Why might a writer use both/and to join two ideas?", options:["This concept has no connection to grammar","Both/and can never be used to join ideas","To show that both ideas are true or included together","Both/and always shows a choice between two ideas"], answer:2}
   ]},
  {subject:"Math", title:"Measurement: Converting Between Metric Units of Mass", summary:"Grade 4 Math strand: students learn to convert between metric units of mass, knowing that 1 kilogram equals 1000 grams, to solve problems involving weight.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"How many grams are in 1 kilogram?", options:["10000","100","10","1000"], answer:3},
     {q:"How many grams are in 2 kilograms?", options:["2000","20000","20","200"], answer:0},
     {q:"If an object has a mass of 500 grams, is that more or less than half a kilogram?", options:["Cannot tell","Less than half a kilogram","More than half a kilogram","Exactly half a kilogram"], answer:3},
     {q:"Converting 3000 grams into kilograms gives you how many kilograms?", options:["3000","3","300","30"], answer:1},
     {q:"Why is it useful to convert between grams and kilograms?", options:["This concept has no connection to measurement","It helps compare or combine measurements given in different units","Converting units never has any real use","Grams and kilograms can never be compared"], answer:1}
   ]},
  {subject:"Science", title:"Science: Chemical Reactions: Signs That a New Substance Formed", summary:"Grade 4 Science strand: signs that a chemical reaction has occurred include a colour change, bubbles forming, a new smell, or heat being given off, showing that a new substance was created.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Name one sign that a chemical reaction may have occurred, such as bubbles forming.", options:["The object staying exactly the same","A concept unrelated to chemical reactions","Nothing happening at all","Bubbles forming"], answer:3},
     {q:"Can a colour change be a sign that a chemical reaction has occurred?", options:["No, colour changes never indicate a reaction","Yes","Colour changes only happen during physical changes","A concept unrelated to chemistry"], answer:1},
     {q:"Can heat being given off be a sign of a chemical reaction?", options:["No, heat is never connected to chemical reactions","Yes","A concept unrelated to chemistry","Heat only occurs during freezing"], answer:1},
     {q:"Why do scientists look for signs like bubbles or colour changes when studying a reaction?", options:["This concept has no relevance to science","These signs can indicate that a new substance has formed","A new substance never actually forms during a reaction","These signs have no connection to chemical reactions"], answer:1},
     {q:"Why might baking a cake be considered an example of a chemical reaction?", options:["This concept has no connection to chemical reactions","The ingredients combine and change to form a completely new substance","A cake is exactly the same as its raw ingredients","Baking a cake never actually changes the ingredients at all"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canada’s Immigration Policies Today", summary:"Grade 4 Social Studies strand: Canada has immigration policies today that determine how people from other countries can come to live, work, or study in Canada, contributing to the country’s diversity.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do we call the rules that determine how people can come to live in Canada?", options:["School rules","A concept unrelated to government","Traffic laws","Immigration policies"], answer:3},
     {q:"Can people come to Canada to work or study through immigration policies?", options:["Yes","A concept unrelated to immigration","No one is ever allowed to come to Canada","No, immigration policies only apply to tourists"], answer:0},
     {q:"Do immigrants contribute to Canada’s diversity?", options:["No, immigrants have no effect on Canada’s diversity","Diversity has no connection to immigration","A concept unrelated to immigration","Yes"], answer:3},
     {q:"Why might Canada have specific policies for immigration rather than no rules at all?", options:["This concept has no connection to government","Policies help organize and manage how people come to live, work, or study in the country","Countries never need any immigration policies","Immigration policies serve no real purpose"], answer:1},
     {q:"How might immigration contribute to Canada’s economy and culture?", options:["Immigrants never contribute anything to a country","This concept has no relevance to social studies","Immigrants can bring new skills, ideas, and traditions that enrich communities","Immigration never affects a country’s economy or culture"], answer:2}
   ]},
]},
{day:87, label:"Day 87 — Tue", subjects:[
  {subject:"Language", title:"Reading: Evaluating an Author’s Credibility", summary:"Grade 4 Language strand: evaluating an author’s credibility means considering whether the author is a trustworthy source, such as checking their expertise or whether their information can be verified.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What does it mean to evaluate an author’s credibility?", options:["Assuming every author is always correct with no evidence","Considering whether the author is a trustworthy source","Ignoring the author completely","A concept unrelated to reading"], answer:1},
     {q:"Name one way to check an author’s credibility, such as checking their expertise.", options:["Checking their expertise","Ignoring the topic entirely","Guessing without any evidence","A concept unrelated to credibility"], answer:0},
     {q:"Should readers consider whether information can be verified when evaluating credibility?", options:["No, verification is never important","Yes","A concept unrelated to reading","Only the length of a text matters for credibility"], answer:1},
     {q:"Why is it important to evaluate an author’s credibility before trusting their claims?", options:["Credibility never affects how reliable information is","It helps readers judge whether information is accurate and reliable","All authors are always completely trustworthy no matter what","This concept has no connection to reading comprehension"], answer:1},
     {q:"Which of these might suggest an author is credible on a science topic?", options:["The author has never studied the topic at all","The author’s book has a colourful cover","The author has expertise or training in that scientific field","The author wrote the book very quickly"], answer:2}
   ]},
  {subject:"Math", title:"Probability: Calculating Simple Probability as a Fraction", summary:"Grade 4 Math strand: students learn to express the probability of an event as a fraction, such as the chance of rolling a 4 on a 6-sided die being 1 out of 6.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is the probability, as a fraction, of rolling a 4 on a 6-sided die?", options:["1 sixth","1 half","4 sixths","1 fourth"], answer:0},
     {q:"What is the probability, as a fraction, of flipping heads on a coin?", options:["1 third","1 fourth","1 half","1 sixth"], answer:2},
     {q:"If a bag has 3 red marbles and 2 blue marbles, what is the probability of picking a red marble?", options:["3 halves","3 fifths","1 fifth","2 fifths"], answer:1},
     {q:"To express probability as a fraction, what goes in the denominator?", options:["The number of favourable outcomes only","A concept unrelated to probability","Always the number 100","The total number of possible outcomes"], answer:3},
     {q:"If a spinner has 4 equal sections and only 1 is red, what is the probability of landing on red?", options:["1 half","1 third","1 fourth","4 fourths"], answer:2}
   ]},
  {subject:"Science", title:"Science: Eclipses — Solar and Lunar", summary:"Grade 4 Science strand: a solar eclipse happens when the Moon passes between the Sun and Earth, blocking sunlight, while a lunar eclipse happens when Earth passes between the Sun and Moon.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What happens during a solar eclipse?", options:["The Moon passes between the Sun and Earth","A concept unrelated to eclipses","Earth passes between the Sun and Moon","Nothing happens in the sky at all"], answer:0},
     {q:"What happens during a lunar eclipse?", options:["A concept unrelated to eclipses","The Sun disappears completely","The Moon passes between the Sun and Earth","Earth passes between the Sun and Moon"], answer:3},
     {q:"During a solar eclipse, what does the Moon block?", options:["Sunlight","Nothing at all","A concept unrelated to eclipses","Moonlight"], answer:0},
     {q:"Why do solar and lunar eclipses not happen every single month?", options:["This concept has no connection to the Sun, Earth, and Moon","The Moon never moves in any predictable pattern","The Sun, Earth, and Moon must align in a very specific way, which does not happen every month","Eclipses actually happen every single day"], answer:2},
     {q:"Why should people avoid looking directly at a solar eclipse without proper eye protection?", options:["Solar eclipses are never harmful to look at directly","Eclipses always make the Sun completely safe to view directly","Looking directly at the Sun, even during an eclipse, can damage the eyes","This concept has no connection to eye safety"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Indigenous Land Acknowledgements: Why They Matter", summary:"Grade 4 Social Studies strand: a land acknowledgement recognizes the Indigenous Peoples who have traditionally lived on and cared for the land, showing respect for their history and ongoing connection to it.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do we call a statement recognizing the Indigenous Peoples connected to a piece of land?", options:["A land acknowledgement","A concept unrelated to Indigenous history","A grocery list","A weather report"], answer:0},
     {q:"Does a land acknowledgement show respect for Indigenous history and connection to the land?", options:["No, it shows no respect at all","Yes","A concept unrelated to Indigenous Peoples","It has no connection to history"], answer:1},
     {q:"Might a land acknowledgement be shared at the start of a school event or meeting?", options:["They are only shared in private","A concept unrelated to Indigenous Peoples","Yes","No, land acknowledgements are never shared publicly"], answer:2},
     {q:"Why might communities choose to share a land acknowledgement?", options:["To honour and recognize Indigenous Peoples’ long history and connection to the land","This concept has no connection to Indigenous history","Communities never need to recognize any history at all","Land acknowledgements have no real purpose"], answer:0},
     {q:"Why is understanding the meaning behind a land acknowledgement more valuable than simply reading it aloud?", options:["Understanding its meaning helps build genuine respect and awareness, not just repetition","The meaning behind a land acknowledgement never matters at all","Reading it aloud without understanding has the exact same value as understanding it","This concept has no relevance to social studies"], answer:0}
   ]},
]},
{day:88, label:"Day 88 — Wed", subjects:[
  {subject:"Language", title:"Vocabulary: Etymology — Where Words Come From", summary:"Grade 4 Language strand: etymology is the study of where words come from and how their meanings have changed over time, often tracing English words back to Latin, Greek, or other languages.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What do we call the study of where words come from?", options:["Geography","A concept unrelated to vocabulary","Geometry","Etymology"], answer:3},
     {q:"Do word meanings sometimes change over time?", options:["No, word meanings never change","Yes","Words are never studied by anyone","A concept unrelated to etymology"], answer:1},
     {q:"Name one language that many English words can be traced back to, such as Latin.", options:["Latin","A computer programming language","A made-up language with no real speakers","A concept unrelated to etymology"], answer:0},
     {q:"Why might learning about a word’s etymology help with understanding its meaning?", options:["A word’s origin always has the opposite meaning of the word itself","This concept has no connection to vocabulary","Etymology never provides any useful information about words","Knowing a word’s origin can reveal clues about its meaning"], answer:3},
     {q:"Why might studying etymology help someone learn new vocabulary more easily?", options:["Every word has a completely unrelated, random origin","This concept has no relevance to vocabulary study","Etymology never helps with learning new words","Recognizing common word origins can help predict the meaning of unfamiliar words"], answer:3}
   ]},
  {subject:"Math", title:"Patterning: Algebraic Expressions with a Variable", summary:"Grade 4 Math strand: students learn to write simple algebraic expressions using a variable, such as letting n represent an unknown number in the expression n plus 5.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"In the expression n plus 5, what does the letter n represent?", options:["Always the number 5","An unknown number","A concept unrelated to algebra","The answer to the expression"], answer:1},
     {q:"If n equals 3, what is the value of n plus 5?", options:["5","15","3","8"], answer:3},
     {q:"If n equals 10, what is the value of n minus 4?", options:["14","6","10","4"], answer:1},
     {q:"What do we call a letter used to represent an unknown number in an expression?", options:["A constant","A concept unrelated to algebra","A variable","An operation"], answer:2},
     {q:"If a expression is written as 2 times n, and n equals 4, what is the value?", options:["8","4","6","2"], answer:0}
   ]},
  {subject:"Science", title:"Science: Invasive Species and Their Effects", summary:"Grade 4 Science strand: an invasive species is a plant or animal introduced to a new environment where it can spread quickly and harm native species by competing for food or space.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What do we call a plant or animal that spreads quickly in a new environment and can cause harm?", options:["A concept unrelated to ecosystems","A domesticated species","A native species","An invasive species"], answer:3},
     {q:"Can an invasive species compete with native species for food or space?", options:["Yes","Invasive species always help native species","No, invasive species never affect native species","A concept unrelated to ecosystems"], answer:0},
     {q:"Is an invasive species originally from the environment it is found in, or introduced from elsewhere?", options:["Neither, it appears from nowhere","Introduced from elsewhere","A concept unrelated to invasive species","Originally from that environment"], answer:1},
     {q:"Why can invasive species be harmful to an ecosystem?", options:["Invasive species always help balance an ecosystem perfectly","They can outcompete native species for resources, disrupting the balance of the ecosystem","This concept has no connection to ecosystems","Invasive species never have any effect on an ecosystem"], answer:1},
     {q:"Why might people be asked not to release aquarium fish into local lakes or rivers?", options:["The fish could become an invasive species and harm the local ecosystem","This concept has no relevance to science","Aquarium fish can never survive outside a tank","Releasing aquarium fish never has any effect on an ecosystem"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The History of Canadian Currency", summary:"Grade 4 Social Studies strand: Canadian currency has changed over time, from early trade using items like fur pelts, to coins and paper bills, to today’s polymer bank notes.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Name one early form of trade used before coins existed, such as fur pelts.", options:["A concept unrelated to currency","Fur pelts","Modern credit cards","Digital currency"], answer:1},
     {q:"Has Canadian currency changed over time?", options:["A concept unrelated to Canadian history","Currency never changes in any country","Yes","No, currency has always been exactly the same"], answer:2},
     {q:"What material are today’s Canadian bank notes often made from?", options:["A concept unrelated to currency","Polymer","Only cotton","Only paper"], answer:1},
     {q:"Why might a country update its currency over time, such as moving to polymer bank notes?", options:["This concept has no connection to Canadian history","New materials or designs can improve durability and security","Currency changes have no real purpose","Countries never update their currency for any reason"], answer:1},
     {q:"Why is understanding the history of currency helpful for understanding a country’s economy?", options:["This concept has no relevance to social studies","The history of currency has no connection to the economy","Currency has never changed in any meaningful way","It shows how trade and money have evolved to meet the needs of a growing society"], answer:3}
   ]},
]},
{day:89, label:"Day 89 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Persuasive Letter to a Local Leader", summary:"Grade 4 Language strand: a persuasive letter to a local leader states a clear opinion about a community issue, supported by reasons and evidence, aiming to convince the leader to take action.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What kind of writing states a clear opinion to convince a local leader to take action?", options:["A grocery list","A concept unrelated to writing","A persuasive letter","A weather report"], answer:2},
     {q:"Should a persuasive letter include reasons and evidence to support its opinion?", options:["Only the opinion matters, with no support at all","No, reasons and evidence are never needed","Yes","A concept unrelated to writing"], answer:2},
     {q:"What is the goal of a persuasive letter to a local leader?", options:["To convince the leader to take action on an issue","To simply describe a random unrelated topic","A concept unrelated to persuasive writing","To confuse the reader with no clear point"], answer:0},
     {q:"Why might a student write a persuasive letter about adding a crosswalk near their school?", options:["This concept has no connection to writing","A crosswalk has no connection to community safety","To convince a local leader that the crosswalk would improve safety","Persuasive letters are never used for community issues"], answer:2},
     {q:"Which of these would strengthen a persuasive letter about protecting a local park?", options:["Evidence showing how the park benefits the community","A drawing with no connection to the topic","A random fact about a different country entirely","A completely unrelated math equation"], answer:0}
   ]},
  {subject:"Math", title:"Financial Literacy: Simple Interest Basics", summary:"Grade 4 Math strand: simple interest is extra money earned or owed based on a percentage of an original amount, such as earning interest on money kept in a savings account.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What do we call extra money earned based on a percentage of an original amount?", options:["A concept unrelated to money","Simple interest","A discount","A tax"], answer:1},
     {q:"Might a savings account earn simple interest over time?", options:["Interest is only ever owed, never earned","No, savings accounts never earn any interest","Yes","A concept unrelated to finance"], answer:2},
     {q:"If you have 100 dollars in an account earning 5 dollars in interest, how much money do you have in total?", options:["100 dollars","95 dollars","105 dollars","5 dollars"], answer:2},
     {q:"Why might someone want to save money in an account that earns interest?", options:["Interest never actually adds any money to an account","This concept has no connection to saving money","Savings accounts always lose money over time","Their money can grow over time without any extra effort"], answer:3},
     {q:"Simple interest is usually calculated as a percentage of the ___.", options:["Original amount","Weather forecast","Number of coins in a piggy bank","Time of day"], answer:0}
   ]},
  {subject:"Science", title:"Science: How a Generator Makes Electricity", summary:"Grade 4 Science strand: a generator produces electricity by using motion, such as spinning magnets near coils of wire, to convert mechanical energy into electrical energy.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What does a generator produce?", options:["Sunlight","A concept unrelated to energy","Electricity","Fresh water"], answer:2},
     {q:"Does a generator use motion, such as spinning magnets, to produce electricity?", options:["Yes","A concept unrelated to generators","No, generators never use any motion","Generators only use sunlight"], answer:0},
     {q:"What type of energy does a generator convert into electrical energy?", options:["Only light energy","Mechanical energy","Only sound energy","A concept unrelated to energy"], answer:1},
     {q:"Why might a generator be useful during a power outage?", options:["Generators can only be used when regular power is already working","Generators are never useful during a power outage","This concept has no connection to electricity","It can produce electricity when the regular power supply is unavailable"], answer:3},
     {q:"Why is understanding how a generator works helpful for understanding renewable energy, like wind power?", options:["Many renewable energy sources, like wind turbines, also use motion to generate electricity","Wind power never actually produces any electricity","This concept has no relevance to science","Generators have no connection to renewable energy"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Global Trade Organizations and Agreements", summary:"Grade 4 Social Studies strand: countries often join trade organizations or sign agreements to set shared rules for buying and selling goods internationally, helping trade run smoothly.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do countries often join to set shared rules for international trade?", options:["A single school club","A local sports league","A concept unrelated to global trade","Trade organizations or agreements"], answer:3},
     {q:"Do trade agreements help set rules for buying and selling goods between countries?", options:["Trade agreements only apply within one single country","A concept unrelated to trade","No, trade agreements have no connection to buying and selling goods","Yes"], answer:3},
     {q:"Can trade organizations help trade run more smoothly between countries?", options:["Trade organizations have no connection to trade at all","Yes","A concept unrelated to international relations","No, trade organizations always make trade more difficult"], answer:1},
     {q:"Why might countries want shared rules for international trade instead of each having completely different rules?", options:["Shared rules can make trading goods more predictable and fair for everyone involved","This concept has no connection to global trade","Countries never actually trade goods with each other","Shared trade rules never actually help anyone"], answer:0},
     {q:"Why might joining a trade organization benefit a country’s economy?", options:["This concept has no relevance to social studies","Trade organizations only exist to limit a country’s economy","Joining a trade organization never benefits a country’s economy","It can open up new markets and opportunities to sell and buy goods"], answer:3}
   ]},
]},
{day:90, label:"Day 90 — Fri", subjects:[
  {subject:"Language", title:"Review: Vocabulary, Grammar, and Reading Skills (Days 81-89)", summary:"Grade 4 Language strand review: students revisit portmanteau words, active and passive voice, symbolism, speech writing, oxymorons, correlative conjunctions, author credibility, etymology, and persuasive letters.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"A portmanteau word blends the sounds and meanings of how many words?", options:["A concept unrelated to vocabulary","Two","Zero","Three"], answer:1},
     {q:"In the active voice, does the subject perform the action or receive it?", options:["Neither perform nor receive it","Receive it","A concept unrelated to grammar","Perform it"], answer:3},
     {q:"What do we call it when an author uses an object to represent a deeper idea?", options:["Symbolism","A grammar rule","A concept unrelated to reading","A math pattern"], answer:0},
     {q:"What do we call a phrase that combines two contradictory words, like jumbo shrimp?", options:["An oxymoron","A homophone","A synonym","A concept unrelated to figurative language"], answer:0},
     {q:"What do we call the study of where words come from?", options:["A concept unrelated to vocabulary","Geography","Etymology","Geometry"], answer:2}
   ]},
  {subject:"Math", title:"Review: Decimals, Fractions, and Data (Days 81-89)", summary:"Grade 4 Math strand review: students revisit multiplying and dividing decimals, classifying quadrilaterals, stem-and-leaf plots, adding mixed numbers, converting mass, probability as a fraction, algebraic expressions, and simple interest.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is 0.4 times 3?", options:["1.2","0.7","12","1.4"], answer:0},
     {q:"What is 6.4 divided by 2?", options:["3.2","3.4","2.2","32"], answer:0},
     {q:"How many equal sides does a rhombus have?", options:["Zero","Four","Two","Three"], answer:1},
     {q:"What is 2 and 1 fourth plus 1 and 2 fourths?", options:["3 and 3 fourths","4 and 3 fourths","3 and 1 fourth","3 and 2 fourths"], answer:0},
     {q:"What is the probability, as a fraction, of flipping heads on a coin?", options:["1 half","1 sixth","1 fourth","1 third"], answer:0}
   ]},
  {subject:"Science", title:"Review: Ecosystems, Earth and Space, and Physical Science (Days 81-89)", summary:"Grade 4 Science strand review: students revisit food webs, comets and asteroids, weather fronts, air pollution, desert adaptations, chemical reactions, eclipses, invasive species, and generators.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Does a food web show a single path of energy, or many connected food chains?", options:["Many connected food chains","A single path only","No connections at all","A concept unrelated to ecosystems"], answer:0},
     {q:"What is a comet mostly made of?", options:["A concept unrelated to space","Only solid rock","Ice and dust","Only metal"], answer:2},
     {q:"What do we call the place where two different air masses meet?", options:["A front","A tide","A rock cycle","A concept unrelated to weather"], answer:0},
     {q:"What happens during a solar eclipse?", options:["Nothing happens in the sky at all","Earth passes between the Sun and Moon","The Moon passes between the Sun and Earth","A concept unrelated to eclipses"], answer:2},
     {q:"What does a generator produce?", options:["Sunlight","A concept unrelated to energy","Fresh water","Electricity"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Review: Ancient Societies, Government, and Global Connections (Days 81-89)", summary:"Grade 4 Social Studies strand review: students revisit the Aztec civilization, museums, Canadian peacekeeping, comparing government systems, the United Nations, immigration policy, land acknowledgements, currency history, and global trade.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What was the name of the Aztec capital city?", options:["Athens","A concept unrelated to the Aztecs","Tenochtitlan","Rome"], answer:2},
     {q:"What do we call soldiers sent to help maintain peace in a conflict region?", options:["Postal workers","A concept unrelated to international relations","Peacekeepers","Firefighters"], answer:2},
     {q:"In a democracy, how are leaders typically chosen?", options:["A single king or queen decides","A concept unrelated to government","Citizens vote for them","Leaders are chosen at random"], answer:2},
     {q:"What do we call a statement recognizing the Indigenous Peoples connected to a piece of land?", options:["A concept unrelated to Indigenous history","A grocery list","A weather report","A land acknowledgement"], answer:3},
...
{day:111, label:"Day 111 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Coordinating and Subordinating Conjunctions", summary:"Grade 4 Language strand: coordinating conjunctions (and, but, or) join equal ideas, while subordinating conjunctions (because, although, since) join a main idea to a dependent one.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which is a coordinating conjunction?", options:["And","Because","Although","Since"], answer:0},
     {q:"Which is a subordinating conjunction?", options:["Or","Because","And","But"], answer:1},
     {q:"What do coordinating conjunctions join?", options:["Only questions","Two equal ideas","Only single words","Nothing at all"], answer:1},
     {q:"In the sentence I stayed home because it rained, which word is the subordinating conjunction?", options:["It","Because","Stayed","Home"], answer:1},
     {q:"Which sentence uses a coordinating conjunction correctly?", options:["I like tea because coffee.","I like tea since coffee.","I like tea although coffee.","I like tea and coffee."], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Introduction to Percent", summary:"Grade 4 Math strand: percent means out of one hundred, and students learn to represent simple percentages such as 50% (half) and 25% (a quarter) using models and fractions.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does percent mean?", options:["Out of ten","Out of one","Out of one thousand","Out of one hundred"], answer:3},
     {q:"What fraction is equal to 50%?", options:["1/10","1/2","1/4","1/5"], answer:1},
     {q:"What fraction is equal to 25%?", options:["1/4","1/2","3/4","1/5"], answer:0},
     {q:"If a shape is 100% shaded, how much of it is shaded?", options:["All of it","A quarter of it","None of it","Half of it"], answer:0},
     {q:"The percent symbol is written as ___.", options:["@","#","%","&"], answer:2}
   ]},
  {subject:"Science", title:"Science: Volcanoes and Earthquakes — Forces Beneath Earths Surface", summary:"Grade 4 Science strand: volcanoes and earthquakes are caused by movement and pressure within the Earth, releasing molten rock or causing the ground to shake.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What can cause a volcano to erupt?", options:["Wind blowing across land","Ocean tides","Pressure and molten rock beneath the surface","Rain falling from clouds"], answer:2},
     {q:"What is an earthquake?", options:["A kind of flood","A type of storm","A slow-moving glacier","A shaking of the ground caused by movement beneath the surface"], answer:3},
     {q:"What is the molten rock that comes out of a volcano called?", options:["Sand","Lava","Ice","Steam only"], answer:1},
     {q:"Where do many earthquakes and volcanoes occur?", options:["Nowhere on Earth","Only in the ocean","Only in deserts","Near the edges of tectonic plates"], answer:3},
     {q:"Why do scientists study volcanoes and earthquakes?", options:["To cause more of them","To ignore the risks","To understand and help predict these natural events","They have no scientific value"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The RCMP — Canadas National Police Force", summary:"Grade 4 Social Studies strand: the Royal Canadian Mounted Police, or RCMP, is Canadas national police force, responsible for enforcing federal laws across the country.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     ...
     {q:"What is the RCMP known for wearing?", options:["A blue business suit","A firefighter helmet","A red serge uniform","A chefs apron"], answer:2},
     {q:"Why does Canada need both local police and a national police force?", options:["It replaces all city police","Only cities need police","Different levels of law enforcement handle different responsibilities","National police are unnecessary"], answer:2},
...
{day:112, label:"Day 112 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Gerunds and Infinitives", summary:"Grade 4 Language strand: a gerund is a verb form ending in -ing used as a noun (Swimming is fun), and an infinitive is to plus the base verb used as a noun (To swim is fun).",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a gerund?", options:["A punctuation mark","A prefix","A verb form ending in -ing used as a noun","A type of adjective"], answer:2},
     {q:"Which word is a gerund in the sentence Running is great exercise?", options:["Exercise","Is","Running","Great"], answer:2},
     {q:"What is an infinitive?", options:["A comma rule","To plus the base verb used as a noun","A verb ending in -ed","A type of pronoun"], answer:1},
     {q:"Which phrase is an infinitive?", options:["Swimming","To swim","Swam","Swims"], answer:1},
     {q:"Which sentence uses a gerund correctly as the subject?", options:["Read is my favourite hobby.","To reads is my favourite hobby.","Reads is my favourite hobby.","Reading is my favourite hobby."], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Order of Operations", summary:"Grade 4 Math strand: the order of operations tells us the sequence to solve a math expression -- brackets, exponents, multiplication and division, then addition and subtraction.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What do we solve first in the order of operations?", options:["Brackets","Addition","Whatever comes first left to right, always","Subtraction"], answer:0},
     {q:"In the order of operations, which comes before addition and subtraction?", options:["Nothing, addition is always first","Multiplication and division","Exponents are ignored","Brackets are solved last"], answer:1},
     {q:"What is 3 + 4 x 2 using the order of operations?", options:["9","14","11","10"], answer:2},
     {q:"What is (3 + 4) x 2 using the order of operations?", options:["10","14","9","11"], answer:1},
     {q:"Why do we follow a consistent order of operations?", options:["To make math harder on purpose","Order never affects the answer","It does not matter what order we use","So everyone gets the same answer to the same expression"], answer:3}
   ]},
  {subject:"Science", title:"Science: The Human Skeletal and Muscular Systems", summary:"Grade 4 Science strand: the skeletal system gives our body structure and protection using bones, while the muscular system works with bones to allow movement.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What does the skeletal system give our body?", options:["Only taste","Only smell","Structure and protection","Only colour"], answer:2},
     {q:"What do muscles work with to allow movement?", options:["Skin colour","Blood cells only","Hair","Bones"], answer:3},
     {q:"Why are bones important for protection?", options:["They only help us taste food","They shield organs like the brain and heart","They stop us from breathing","They have no protective role"], answer:1},
     {q:"What happens when a muscle contracts?", options:["It shortens and can move a bone","It stops working permanently","It turns into bone","It disappears"], answer:0},
     {q:"The skeletal and muscular systems work together to allow the body to ___.", options:["See colours","Hear sounds","Move and stay supported","Taste food"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Canadian Senate — The Other House of Parliament", summary:"Grade 4 Social Studies strand: the Senate is the second chamber of Canadas Parliament, where appointed senators review and can suggest changes to proposed laws.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the Senate?", options:["The second chamber of Canadas Parliament","A city government","A type of court","A sports league"], answer:0},
     {q:"How do people typically become senators in Canada?", options:["They are chosen by lottery","They inherit the position","They are appointed","They are elected by the public"], answer:2},
     {q:"What is one role of the Senate?", options:["Running local schools","Reviewing and suggesting changes to proposed laws","Managing hospitals","Selling products"], answer:1},
     {q:"Parliament in Canada is made up of the House of Commons and the ___.", options:["City Council","Cabinet only","Supreme Court","Senate"], answer:3},
     {q:"Why might a country have two chambers reviewing proposed laws?", options:["To slow down all government forever","Two chambers serve no purpose","Only one chamber is ever needed","To provide additional review and balance"], answer:3}
   ]},
]},
{day:113, label:"Day 113 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Appositives — Adding Extra Information", summary:"Grade 4 Language strand: an appositive is a noun or phrase placed next to another noun to rename or explain it, often set off by commas, such as my dog, a golden retriever, loves to run.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is an appositive?", options:["A type of verb","A noun or phrase that renames or explains another noun","A prefix","A punctuation mark"], answer:1},
     {q:"In my dog, a golden retriever, loves to run, what is the appositive?", options:["To run","My dog","Loves to run","A golden retriever"], answer:3},
     {q:"How are appositives usually set off in a sentence?", options:["With exclamation marks","With no punctuation at all","With commas","With question marks"], answer:2},
     {q:"Why do writers use appositives?", options:["To remove information from a sentence","To add extra detail or explanation about a noun","To make sentences shorter","To avoid using nouns"], answer:1},
     {q:"Which sentence contains an appositive?", options:["Is my teacher kind?","My teacher, Mrs. Lee, is kind.","My teacher is kind.","My kind teacher."], answer:1}
   ]},
  {subject:"Math", title:"Number Sense: Least Common Multiple and Greatest Common Factor", summary:"Grade 4 Math strand: the least common multiple (LCM) is the smallest number that is a multiple of two numbers, while the greatest common factor (GCF) is the largest number that divides evenly into both.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does LCM stand for?", options:["Longest common multiple","Least counted multiple","Largest common measure","Least common multiple"], answer:3},
     {q:"What is the LCM of 4 and 6?", options:["10","12","24","6"], answer:1},
     {q:"What does GCF stand for?", options:["Grouped common factor","General common fraction","Greatest common factor","Greatest counted fraction"], answer:2},
     {q:"What is the GCF of 8 and 12?", options:["2","8","4","24"], answer:2},
     {q:"Finding the GCF can help when ___.", options:["Measuring angles","Multiplying decimals","Reading a clock","Simplifying fractions"], answer:3}
   ]},
  {subject:"Science", title:"Science: The Circulatory System — How Blood Moves Through Our Body", summary:"Grade 4 Science strand: the circulatory system uses the heart to pump blood through blood vessels, delivering oxygen and nutrients throughout the body.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What organ pumps blood through the body?", options:["The heart","The stomach","The brain","The lungs"], answer:0},
     {q:"What does blood deliver to the body?", options:["Only water","Oxygen and nutrients","Only sound","Only light"], answer:1},
     {q:"What are the tubes that carry blood through the body called?", options:["Bones","Blood vessels","Muscles","Nerves"], answer:1},
     {q:"Why is the circulatory system important?", options:["It only affects the fingers","It has no important function","It carries oxygen and nutrients to every part of the body","It stops blood from moving"], answer:2},
     {q:"The circulatory system works closely with which other system to deliver oxygen?", options:["The respiratory system","The skeletal system only","The digestive system only","No other system"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: How a Bill Becomes a Law in Canada", summary:"Grade 4 Social Studies strand: a proposed law, called a bill, must be debated and approved by the House of Commons and the Senate before receiving royal assent to become law.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is a bill?", options:["A type of tax","A type of currency","A court decision","A proposed law"], answer:3},
     {q:"Which groups must approve a bill before it becomes law?", options:["No one needs to approve it","Only the mayor","Only the public directly","The House of Commons and the Senate"], answer:3},
     {q:"What is the final step for a bill to become law?", options:["Receiving royal assent","Being renamed","Being ignored","Being erased"], answer:0},
     {q:"Why does a bill go through multiple steps of review?", options:["To skip debate entirely","Review is not necessary","To ensure it is carefully considered before becoming law","To make the process instant"], answer:2},
     {q:"A bill is debated in Parliament to ___.", options:["Immediately reject all bills","Ignore public interest","Discuss its strengths and weaknesses","Avoid making decisions"], answer:2}
   ]},
]},
{day:114, label:"Day 114 — Thu", subjects:[
  {subject:"Language", title:"Reading: Distinguishing Primary and Secondary Sources", summary:"Grade 4 Language strand: a primary source is a firsthand account or original document, like a diary or photograph, while a secondary source, like a textbook, interprets or describes primary sources.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
  ...
  {subject:"Math", title:"Number Sense: Prime Factorization", summary:"Grade 4 Math strand: prime factorization means breaking a number down into the prime numbers that multiply together to make it, such as 12 = 2 x 2 x 3.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is prime factorization?", options:["Dividing by zero","Rounding a number","Breaking a number into the prime numbers that multiply to make it","Adding all factors together"], answer:2},
     {q:"What is the prime factorization of 12?", options:["1 x 12","3 x 4","2 x 6","2 x 2 x 3"], answer:3},
     {q:"What is the prime factorization of 20?", options:["2 x 10","4 x 5","2 x 2 x 5","1 x 20"], answer:2},
     {q:"A prime number has exactly ___ factors.", options:["Two (1 and itself)","Ten","Zero","Three"], answer:0},
     {q:"Why might prime factorization be useful?", options:["It has no mathematical use","It rounds numbers automatically","It helps find LCM and GCF of numbers","It changes a number into a fraction"], answer:2}
   ]},
  {subject:"Science", title:"Science: The Respiratory System — How We Breathe", summary:"Grade 4 Science strand: the respiratory system, including the lungs, allows us to breathe in oxygen and breathe out carbon dioxide.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What organs are central to the respiratory system?", options:["The skin","The bones","The lungs","The stomach"], answer:2},
     {q:"What gas do we breathe in?", options:["Oxygen","Carbon dioxide only","Helium","Nitrogen only"], answer:0},
     {q:"What gas do we breathe out?", options:["Only water","Carbon dioxide","Only oxygen","Only helium"], answer:1},
     {q:"Why do our bodies need oxygen?", options:["To help cells produce energy","To help us taste food","Oxygen has no use in the body","To make bones stronger only"], answer:0},
     {q:"The respiratory system works with the ___ system to deliver oxygen throughout the body.", options:["Digestive","Skeletal","Muscular","Circulatory"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Role in NATO", summary:"Grade 4 Social Studies strand: NATO is an international alliance of countries, including Canada, that agree to support and defend one another for collective security.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What does NATO stand for?", options:["North Atlantic Treaty Organization","National Association of Trade Organizations","National Alliance for Territorial Order","North American Trade Office"], answer:0},
     {q:"Is Canada a member of NATO?", options:["Yes","Canada has never joined","No","Canada withdrew long ago"], answer:0},
     {q:"What is the main purpose of NATO?", options:["Collective security and mutual defence among member countries","Organizing sports competitions","Managing world weather","Selling goods internationally"], answer:0},
     {q:"What does collective security mean in the context of NATO?", options:["Only one country makes decisions","Members agree to support each other if one is threatened","Each country defends only itself","No countries cooperate at all"], answer:1},
     {q:"Being part of an international alliance like NATO helps Canada ___.", options:["Lose its own identity","Isolate itself from the world","Avoid all international relationships","Build cooperative relationships with other countries"], answer:3}
   ]},
]},
{day:115, label:"Day 115 — Fri", subjects:[
  {subject:"Language", title:"Reading: Understanding Satire", summary:"Grade 4 Language strand: satire uses humour, irony, or exaggeration to criticize or poke fun at ideas, people, or society, often to make a point.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is satire?", options:["A type of punctuation","A grammar rule","Using humour or exaggeration to criticize something","A math term"], answer:2},
     {q:"What might a satirical story use to make its point?", options:["Humour, irony, or exaggeration","Only serious facts","Complete silence","Only numbers"], answer:0},
     {q:"Why do writers use satire?", options:["To remove all humour from writing","To criticize or comment on society in an entertaining way","To confuse readers with no purpose","To avoid making any point"], answer:1},
     {q:"Which is an example of a satirical idea?", options:["A grocery list","A textbook definition","A weather report","A story exaggerating a rule to show how silly it is"], answer:3},
     {q:"Satire is closely related to which other literary technique?", options:["Alliteration","Onomatopoeia","Rhyme","Irony"], answer:3}
   ]},
  {subject:"Math", title:"Data Management: Identifying Outliers in a Data Set", summary:"Grade 4 Math strand: an outlier is a data value that is much higher or lower than the rest of the data, and it can affect measures like the mean.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     ...
     {q:"In the data set 4, 5, 6, 5, 40, which value is the outlier?", options:["40","6","5","4"], answer:0},
     ...
     {q:"Which of these data sets has an obvious outlier?", options:["2, 3, 3, 4, 50","2, 3, 4, 5, 6","10, 11, 12, 13, 14","5, 5, 5, 5, 5"], answer:0}
   ]},
  {subject:"Science", title:"Science: The Nervous System — How Our Brain Sends Messages", summary:"Grade 4 Science strand: the nervous system, controlled by the brain, sends and receives messages throughout the body using nerves, allowing us to think, feel, and react.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What organ controls the nervous system?", options:["The skin","The stomach","The lungs","The brain"], answer:3},
     {q:"What do nerves do?", options:["Pump blood","Send and receive messages throughout the body","Filter air","Digest food"], answer:1},
     {q:"What allows us to react quickly to touching something hot?", options:["The skeletal system alone","The nervous system sending fast signals","The digestive system","Nothing, reactions are random"], answer:1},
     {q:"The nervous system helps us to ___.", options:["Think, feel, and react","Only grow taller","Only see colours","Only taste food"], answer:0},
     {q:"Nerves carry messages between the brain and ___.", options:["Only the stomach","The rest of the body","Nowhere else","Only the eyes"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadian Inventions and Inventors", summary:"Grade 4 Social Studies strand: Canadians have contributed many important inventions, including basketball, insulin therapy, and the telephone, shaping science and daily life around the world.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Which sport was invented by a Canadian?", options:["Basketball","Cricket","Rugby","Soccer"], answer:0},
     {q:"What is one area where Canadian inventors have made important contributions?", options:["Only cooking","Nothing significant","Medicine, sports, and technology","Only fashion"], answer:2},
     {q:"Why is it valuable to learn about Canadian inventions?", options:["Inventions do not matter","It has no educational value","It highlights Canadian contributions to the world","Only foreign inventions count"], answer:2},
     {q:"Canadian inventors have contributed to fields including ___.", options:["Medicine and technology","Nothing at all","Only weather forecasting","Only farming"], answer:0},
     {q:"Learning about inventors can inspire students to ___.", options:["Dislike innovation","Value creativity and problem-solving","Avoid trying new ideas","Ignore science and technology"], answer:1}
   ]},
]},
{day:116, label:"Day 116 — Mon", subjects:[
  {subject:"Language", title:"Vocabulary: Words with Greek and Latin Roots", summary:"Grade 4 Language strand: many English words come from Greek and Latin roots, such as tele- (far) in telephone, or aqua (water) in aquarium, helping readers decode unfamiliar words.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What does the root tele- mean?", options:["Far","Sound","Light","Water"], answer:0},
     {q:"What does the root aqua mean?", options:["Air","Water","Fire","Earth"], answer:1},
     {q:"Which word contains the root tele- meaning far?", options:["Ten","Table","Tent","Telephone"], answer:3},
     {q:"Which word contains the root aqua meaning water?", options:["Airplane","Aquarium","Aardvark","Apple"], answer:1},
     {q:"Why is learning Greek and Latin roots helpful?", options:["It only applies to math","It helps decode the meaning of unfamiliar words","It has no effect on vocabulary","It makes words impossible to understand"], answer:1}
   ]},
  {subject:"Math", title:"Geometry: Area of Composite Shapes", summary:"Grade 4 Math strand: a composite shape is made of two or more simple shapes, and its area is found by breaking it into parts, finding each area, then adding them together.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a composite shape?", options:["A shape made of two or more simple shapes","A shape with no sides","A single triangle only","A single circle"], answer:0},
     {q:"How do you find the area of a composite shape?", options:["Multiply all the side lengths together","Guess the area","Measure only one side","Break it into simple shapes, find each area, and add them"], answer:3},
     {q:"A composite shape made of a rectangle (area 20) and a triangle (area 6) has a total area of ___.", options:["20","6","26","14"], answer:2},
     {q:"Why might builders and designers need to calculate composite areas?", options:["It only applies to circles","Real objects are often made of combined shapes","Composite areas are never needed","All shapes are simple in real life"], answer:1},
     {q:"The first step in solving a composite area problem is to ___.", options:["Guess the final answer","Skip measuring anything","Divide the shape into simpler parts","Ignore the shape entirely"], answer:2}
   ]},
  {subject:"Science", title:"Science: Density — Why Some Objects Sink While Others Float", summary:"Grade 4 Science strand: density describes how much mass is packed into a given volume, and objects denser than water sink while less dense objects float.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is density?", options:["The colour of an object","The shape of an object","The temperature of an object","How much mass is packed into a given volume"], answer:3},
     {q:"What happens to an object that is denser than water?", options:["It floats","It disappears","It changes colour","It sinks"], answer:3},
     {q:"What happens to an object that is less dense than water?", options:["It sinks","It explodes","It disappears","It floats"], answer:3},
     {q:"Why does a large ship made of metal float, even though metal is dense?", options:["Water has no effect on ships","Ships are not made of dense materials","Metal always sinks with no exceptions","Its overall shape displaces enough water to float"], answer:3},
     {q:"Density compares an objects mass to its ___.", options:["Volume","Age","Colour","Temperature"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Official Languages Act — Bilingualism in Canada", summary:"Grade 4 Social Studies strand: the Official Languages Act recognizes English and French as Canadas two official languages, guaranteeing services in both languages at the federal level.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What are Canadas two official languages?", options:["English and French","French and German","English and Spanish","English only"], answer:0},
     {q:"What does the Official Languages Act guarantee?", options:["No language rights at all","Services in only one language","Services only in provinces","Federal services in both English and French"], answer:3},
     {q:"Why might a country recognize more than one official language?", options:["To confuse citizens on purpose","Only one language should ever be used","To reflect the diverse linguistic heritage of its population","Languages do not matter to government"], answer:2},
     {q:"Which province in Canada has a large French-speaking population historically tied to this policy?", options:["Quebec","British Columbia","Alberta","Manitoba only"], answer:0},
     {q:"Bilingualism in Canada reflects the countrys ___.", options:["English and French heritage","Rejection of French language rights","Lack of cultural diversity","Single-language history"], answer:0}
   ]},
]},
{day:117, label:"Day 117 — Tue", subjects:[
  {subject:"Language", title:"Media Literacy: Evaluating Website Credibility", summary:"Grade 4 Language strand: evaluating a websites credibility means checking who wrote it, when it was published, and whether the information is supported by evidence before trusting it.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What should you check to evaluate a websites credibility?", options:["Who wrote it and when it was published","Only the font style","Nothing, all websites are equally reliable","Only the background colour"], answer:0},
     {q:"Why is it important to check who wrote a website?", options:["Authors are always experts","The author never matters","It has no effect on trust","To judge whether the author is a reliable source"], answer:3},
     {q:"What is a sign that a website might be less credible?", options:["It provides no evidence or sources for its claims","It is written by an expert","It has a recent publish date","It cites clear sources"], answer:0},
     {q:"Why might the publish date of a website matter?", options:["Older websites are always more accurate","Information can become outdated over time","Dates never matter online","Publish dates are always fake"], answer:1},
     {q:"Which is a good habit when researching online?", options:["Ignoring all sources","Trusting the very first result blindly","Believing everything without checking","Comparing information across multiple credible sources"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Scale Drawings and Scale Factor", summary:"Grade 4 Math strand: a scale drawing represents a real object at a different size using a scale factor, such as 1 cm representing 1 metre in real life.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a scale drawing?", options:["A random sketch","A drawing without shapes","A drawing with no measurements","A drawing that represents a real object at a different size"], answer:3},
     {q:"What does a scale factor tell you?", options:["The colour of the drawing","The artists name","The relationship between the drawing size and the real size","The type of paper used"], answer:2},
     {q:"If a scale is 1 cm = 1 m, what does 5 cm on the drawing represent in real life?", options:["5 m","1 m","5 cm","50 m"], answer:0},
     {q:"Why do architects use scale drawings?", options:["Scale drawings are never used in real life","To make buildings smaller in real life","To accurately represent large structures on paper","To avoid using any measurements"], answer:2},
     {q:"A map is an example of a ___.", options:["Scale drawing","Composite shape","Data table","Prime number"], answer:0}
   ]},
  {subject:"Science", title:"Science: Groundwater and Aquifers", summary:"Grade 4 Science strand: groundwater is water that soaks into the ground and collects in layers of rock and soil called aquifers, an important source of fresh water.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is groundwater?", options:["Water in a swimming pool","Water that soaks into the ground and collects underground","Water in the ocean only","Water in the clouds"], answer:1},
     {q:"What is an aquifer?", options:["A kind of river","A weather instrument","An underground layer of rock or soil that holds water","A type of cloud"], answer:2},
     {q:"Why is groundwater important?", options:["It is a major source of fresh water for people","It only exists in oceans","It has no importance","It cannot be used by people"], answer:0},
     {q:"How does water typically get into an aquifer?", options:["It is pumped in by machines only","It soaks down through soil and rock","It never enters an aquifer","It falls directly from space"], answer:1},
     {q:"Protecting groundwater from pollution is important because ___.", options:["Pollution never affects groundwater","Groundwater is never used by people","Many communities rely on it for drinking water","Aquifers cannot be polluted"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Franklin Expedition — Arctic Exploration History", summary:"Grade 4 Social Studies strand: the Franklin Expedition was a 19th-century voyage that attempted to navigate the Arctic and became a famous mystery when the ships were lost.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What was the Franklin Expedition trying to do?", options:["Explore the desert","Navigate a route through the Arctic","Climb a mountain range","Sail across the Pacific"], answer:1},
     {q:"What happened to the Franklin Expeditions ships?", options:["They became lost, creating a historical mystery","They were never real ships","They never left port","They arrived successfully with no issues"], answer:0},
     {q:"When did the Franklin Expedition take place?", options:["Last year","In the 1800s","In ancient times","It has not happened yet"], answer:1},
     {q:"Why do historians and scientists remain interested in the Franklin Expedition?", options:["No evidence of it has ever been found","It reveals details about Arctic exploration and history","It is a modern event","It has no historical significance"], answer:1},
     {q:"The Franklin Expedition is an example of ___.", options:["A modern space mission","A type of Canadian currency","Historical Arctic exploration","A sport played in Canada"], answer:2}
   ]},
]},
{day:118, label:"Day 118 — Wed", subjects:[
  {subject:"Language", title:"Oral Communication: Debate Basics — Presenting and Countering Arguments", summary:"Grade 4 Language strand: a debate involves presenting a clear argument with supporting reasons, then respectfully listening and responding to the other sides points.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a key part of presenting an argument in a debate?", options:["Ignoring the topic","Yelling louder than the other side","Supporting it with clear reasons","Refusing to speak"], answer:2},
     {q:"Why is listening important during a debate?", options:["It helps you understand and respond to the other sides points","It has no effect on the debate","You should never consider other viewpoints","Listening is not necessary"], answer:0},
     {q:"What does it mean to counter an argument?", options:["To agree immediately with no thought","To repeat it exactly","To respond to it with your own reasoning or evidence","To ignore it completely"], answer:2},
     {q:"A respectful debate involves ___.", options:["Refusing to speak at all","Listening and responding calmly","Interrupting constantly","Insulting the other side"], answer:1},
     {q:"Why do students practice debating in school?", options:["To build skills in reasoning, listening, and public speaking","Debating has no educational value","It only teaches memorization","To avoid learning to communicate"], answer:0}
   ]},
  {subject:"Math", title:"Fractions: Dividing a Whole Number by a Unit Fraction", summary:"Grade 4 Math strand: dividing a whole number by a unit fraction, like 3 divided by 1/2, tells us how many of that fraction fit into the whole number.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does 3 divided by 1/2 ask?", options:["How many halves fit into 3","How many wholes fit into a half","The sum of 3 and 1/2","How many thirds fit into a half"], answer:0},
     {q:"What is 3 divided by 1/2?", options:["1.5","3","2","6"], answer:3},
     {q:"What is 4 divided by 1/4?", options:["1","8","16","4"], answer:2},
     {q:"Dividing a whole number by a unit fraction usually gives an answer ___ the original whole number.", options:["Equal to","Larger than","Negative compared to","Smaller than"], answer:1},
     {q:"Why does dividing by a fraction less than 1 make the number larger?", options:["Division always makes numbers smaller","Fractions cannot be divided","Because you are finding how many smaller pieces fit into the whole","It is a coincidence with no reason"], answer:2}
   ]},
  {subject:"Science", title:"Science: Owls and Other Birds of Prey — Adaptations for Hunting", summary:"Grade 4 Science strand: birds of prey like owls, hawks, and eagles have adaptations such as sharp talons, hooked beaks, and keen eyesight that help them hunt effectively.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What are birds of prey adapted to do?", options:["Live only in water","Avoid all movement","Hunt effectively","Swim underwater only"], answer:2},
     {q:"What body part helps birds of prey grab their food?", options:["Soft fur","Sharp talons","Webbed feet","Long tails only"], answer:1},
     {q:"What kind of beak do birds of prey typically have?", options:["A flat beak for filtering water","A hooked beak for tearing food","A beak made of fur","No beak at all"], answer:1},
     {q:"Which sense is especially sharp in birds of prey like owls?", options:["Eyesight or hearing","Smell","Touch","Taste"], answer:0},
     {q:"Adaptations in birds of prey help them ___.", options:["Lose their ability to fly","Avoid eating altogether","Live only underwater","Survive by hunting successfully"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Terry Fox — A Canadian Hero and His Marathon of Hope", summary:"Grade 4 Social Studies strand: Terry Fox was a young Canadian who ran partway across Canada to raise money for cancer research, inspiring an annual tradition that continues today.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What did Terry Fox do to raise money for cancer research?", options:["He wrote a book","He ran across much of Canada","He built a hospital himself","He painted a mural"], answer:1},
     {q:"What is the name of Terry Foxs journey called?", options:["The Marathon of Hope","The Race for Life","The Great Run","The Cross-Canada Walk"], answer:0},
     {q:"What continues today in honour of Terry Fox?", options:["A yearly parade with no cause","A national holiday with no purpose","Nothing continues","An annual run raising money for cancer research"], answer:3},
     {q:"Why is Terry Fox considered a Canadian hero?", options:["He was a prime minister","He showed great courage and inspired others to help a cause","He was a hockey champion","He was a famous actor"], answer:1},
     {q:"The Terry Fox Run happening in schools across Canada shows ___.", options:["A random unrelated tradition","Canadians coming together to support a cause","A one-time-only event","A rule with no meaning"], answer:1}
   ]},
]},
{day:119, label:"Day 119 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing Song Lyrics or a Rap", summary:"Grade 4 Language strand: writing song lyrics or a rap involves choosing a topic, using rhythm and rhyme, and organizing ideas into verses and a repeating chorus.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What are the two repeating structural parts often found in songs?", options:["Verses and a chorus","Only a title","A table of contents","Only a footnote"], answer:0},
     {q:"What poetic elements are commonly used in song lyrics?", options:["Only numbers","Rhythm and rhyme","Only silence","Only punctuation marks"], answer:1},
     {q:"What usually stays the same each time it repeats in a song?", options:["The title only","The authors name","The chorus","The verse"], answer:2},
     {q:"Why might a songwriter choose words carefully for rhythm?", options:["Rhythm does not matter in songwriting","To avoid using any rhyme","To match the beat and flow of the music","Words are chosen randomly"], answer:2},
     {q:"Which is a first step in writing song lyrics?", options:["Choosing a clear topic or feeling to express","Avoiding any structure","Copying another song exactly","Skipping all planning"], answer:0}
   ]},
  {subject:"Math", title:"Measurement: Volume of Composite Rectangular Prisms", summary:"Grade 4 Math strand: the volume of a composite shape made of rectangular prisms is found by breaking it into simple prisms, finding each volume, then adding them together.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"How do you find the volume of a composite shape made of rectangular prisms?", options:["Multiply all side lengths of the whole shape at once","Break it into prisms, find each volume, and add them","Guess the volume","Measure only the height"], answer:1},
     {q:"If two rectangular prisms have volumes of 24 and 10, what is the total composite volume?", options:["14","10","34","24"], answer:2},
     {q:"What formula finds the volume of a single rectangular prism?", options:["Length x width x height","Length x width only","Height only","Length + width + height"], answer:0},
     {q:"Why might real objects require composite volume calculations?", options:["Real objects are always simple cubes","Many real objects are combinations of simple 3D shapes","Composite volume is never used practically","Volume only applies to 2D shapes"], answer:1},
     {q:"The units for volume are typically expressed in ___.", options:["No units at all","Linear units only","Cubic units","Square units"], answer:2}
   ]},
  {subject:"Science", title:"Science: Bats and Echolocation", summary:"Grade 4 Science strand: bats are the only flying mammals, and many species use echolocation, bouncing sound waves off objects, to navigate and find food in the dark.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What makes bats unique among mammals?", options:["They lay eggs","They have no fur","They live underwater","They are the only mammals that truly fly"], answer:3},
     ...
     {q:"How do bats use echolocation to find food?", options:["They see insects glow in the dark","They taste the air","They listen for sound bouncing back off insects","They smell insects from far away"], answer:2},
     {q:"Bats are classified as ___.", options:["Mammals","Reptiles","Birds","Insects"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Census — Counting Everyone in Canada", summary:"Grade 4 Social Studies strand: a census is an official count of everyone living in Canada, helping the government plan services like schools, hospitals, and roads.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is a census?", options:["A type of holiday","A sports event","A kind of map","An official count of everyone in a country"], answer:3},
     {q:"Why does the government conduct a census?", options:["To have no reason","To confuse citizens","To sell products","To help plan services like schools and hospitals"], answer:3},
     {q:"How often is a census usually taken in Canada?", options:["At regular intervals, such as every few years","Only once ever","Never","Every single day"], answer:0},
     {q:"Which service might benefit from census information?", options:["Playing a game","Painting a fence","Planning new schools","Selling candy"], answer:2},
...
{day:120, label:"Day 120 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Grammar, Sources, and Media Literacy", summary:"Grade 4 Language strand review: students revisit coordinating and subordinating conjunctions, gerunds and infinitives, appositives, primary and secondary sources, satire, and evaluating website credibility.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which is a coordinating conjunction?", options:["Because","Since","Although","And"], answer:3},
     {q:"What is a gerund?", options:["A verb form ending in -ing used as a noun","A punctuation mark","A prefix","A type of adjective"], answer:0},
     {q:"What is an appositive?", options:["A noun or phrase that renames or explains another noun","A type of verb","A punctuation mark","A prefix"], answer:0},
     ...
     {q:"What is satire?", options:["Using humour or exaggeration to criticize something","A grammar rule","A type of punctuation","A math term"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Number Sense, Geometry, and Measurement", summary:"Grade 4 Math strand review: students revisit percent, order of operations, LCM/GCF, prime factorization, outliers, composite area, scale drawings, and composite volume.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does percent mean?", options:["Out of one","Out of one thousand","Out of one hundred","Out of ten"], answer:2},
     {q:"What is 3 + 4 x 2 using the order of operations?", options:["14","11","9","10"], answer:1},
     {q:"What is the LCM of 4 and 6?", options:["10","6","24","12"], answer:3},
     {q:"What is the prime factorization of 12?", options:["2 x 6","1 x 12","3 x 4","2 x 2 x 3"], answer:3},
     {q:"What is an outlier?", options:["The total of all values","The most common value","The middle value","A data value much higher or lower than the rest"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Human Body Systems and Earth Science", summary:"Grade 4 Science strand review: students revisit volcanoes and earthquakes, the skeletal and muscular systems, the circulatory system, the respiratory system, the nervous system, and density.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What organ pumps blood through the body?", options:["The brain","The stomach","The heart","The lungs"], answer:2},
     {q:"What organs are central to the respiratory system?", options:["The lungs","The skin","The stomach","The bones"], answer:0},
     {q:"What organ controls the nervous system?", options:["The lungs","The stomach","The skin","The brain"], answer:3},
     {q:"What is density?", options:["How much mass is packed into a given volume","The temperature of an object","The colour of an object","The shape of an object"], answer:0},
     {q:"What is an earthquake?", options:["A slow-moving glacier","A type of storm","A kind of flood","A shaking of the ground caused by movement beneath the surface"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Government, History, and Canadian Identity", summary:"Grade 4 Social Studies strand review: students revisit the RCMP, the Senate, how a bill becomes a law, NATO, Canadian inventions, bilingualism, the Franklin Expedition, Terry Fox, and the census.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     ...
     {q:"What is the Senate?", options:["A sports league","The second chamber of Canadas Parliament","A type of court","A city government"], answer:1},
     {q:"What does NATO stand for?", options:["North Atlantic Treaty Organization","North American Trade Office","National Alliance for Territorial Order","National Association of Trade Organizations"], answer:0},
     {q:"What are Canadas two official languages?", options:["French and German","English and French","English only","English and Spanish"], answer:1},
     {q:"What is a census?", options:["A type of holiday","A kind of map","A sports event","An official count of everyone in a country"], answer:3}
   ]},
]},
{day:121, label:"Day 121 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Comma Rules — Series, Introductory Phrases, and Compound Sentences", summary:"Grade 4 Language strand: commas separate items in a series, follow introductory phrases at the start of a sentence, and join two independent clauses before a coordinating conjunction in a compound sentence.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which sentence uses commas correctly in a series?", options:["I packed apples, oranges, and grapes.","I packed apples oranges, and grapes.","I packed, apples oranges and grapes.","I packed apples, oranges and, grapes."], answer:0},
     {q:"Where does a comma usually go after an introductory phrase?", options:["Commas are never used with introductory phrases","Right after the introductory phrase","At the very end of the sentence","Before the subject only"], answer:1},
     {q:"Which sentence correctly uses a comma in a compound sentence?", options:["I finished, my homework and I watched a movie.","I finished my homework, and I watched a movie.","I finished my homework and, I watched a movie.","I finished my homework and I, watched a movie."], answer:1},
     {q:"What does a comma do when separating items in a list?", options:["Replaces a period","Shows where one item ends and the next begins","Ends the sentence","Joins two full sentences without a conjunction"], answer:1},
     {q:"In the sentence After the storm passed, we went outside, what is being set off by the comma?", options:["A list of items","A title","A quotation","An introductory phrase"], answer:3}
   ]},
  {subject:"Math", title:"Fractions: Adding Fractions with Unlike Denominators", summary:"Grade 4 Math strand: to add fractions with unlike denominators, students find a common denominator, rewrite each fraction as an equivalent fraction, then add the numerators.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What must fractions have before they can be added directly?", options:["The same numerator","The same sign","Different denominators","A common denominator"], answer:3},
     {q:"What is 1/2 + 1/4?", options:["1/6","3/4","2/6","2/4"], answer:1},
     {q:"What is 1/3 + 1/6?", options:["1/2","2/9","7/6","1/9"], answer:0},
     {q:"What is the first step in adding fractions with unlike denominators?", options:["Find a common denominator","Subtract the fractions","Add the denominators","Multiply the numerators"], answer:0},
     {q:"Why cant we add fraction numerators directly when denominators differ?", options:["Denominators do not matter","Numerators are always equal","Because the pieces are different sizes until denominators match","Fractions can never be added"], answer:2}
   ]},
  {subject:"Science", title:"Science: The Human Digestive System — Breaking Down Food for Energy", summary:"Grade 4 Science strand: the digestive system breaks down food into nutrients the body can absorb and use for energy, involving organs such as the stomach, small intestine, and large intestine.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the main job of the digestive system?", options:["Sending nerve signals","Filtering air","Breaking down food into nutrients the body can use","Pumping blood"], answer:2},
     {q:"Which organ mixes food with acid to help break it down?", options:["The heart","The brain","The lungs","The stomach"], answer:3},
     {q:"Where are nutrients mostly absorbed into the blood?", options:["The lungs","The small intestine","The mouth","The skin"], answer:1},
     {q:"What happens to food waste after nutrients are absorbed?", options:["It is stored in the brain","It turns into oxygen","It becomes bone","It passes through the large intestine to be removed from the body"], answer:3},
     {q:"Why does the body need to digest food?", options:["To make food heavier","To stop the body from growing","To break it into nutrients that provide energy and building blocks for the body","Digestion has no purpose"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Ancient Japan — Early Society and Culture", summary:"Grade 4 Social Studies strand: ancient Japan developed a unique early society influenced by its island geography, featuring farming communities, emperors, and rich traditions in art and religion.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What type of geography influenced ancient Japans development?", options:["A landlocked plain","A vast desert","A mountain range with no coast","Its island location"], answer:3},
     {q:"What role did an emperor typically hold in ancient Japan?", options:["No role at all","A foreign visitor","A random villager","A central figure of authority and tradition"], answer:3},
     {q:"What was a common economic activity in early Japanese society?", options:["Only fishing","Only mining","Farming, especially rice cultivation","Only trading with no farming"], answer:2},
     {q:"Why is Japans island geography significant to its early history?", options:["It caused constant flooding with no benefits","It prevented any culture from forming","It shaped trade, culture, and how the society developed somewhat separately","It made no difference to society"], answer:2},
     {q:"What aspect of ancient Japanese culture became influential in art and religion?", options:["Modern technology only","A complete absence of art","European traditions only","Traditions passed down and refined over centuries"], answer:3}
   ]},
]},
{day:122, label:"Day 122 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Plural Noun Rules — Regular and Irregular Forms", summary:"Grade 4 Language strand: most nouns form plurals by adding -s or -es, but irregular nouns change form in other ways, such as child to children or mouse to mice.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is the plural of dog?", options:["Doges","Dogen","Dogs","Dogies"], answer:2},
     {q:"What is the plural of box?", options:["Boxies","Boxs","Boxes","Box"], answer:2},
     {q:"What is the irregular plural of child?", options:["Childrens","Children","Childs","Childes"], answer:1},
     {q:"What is the irregular plural of mouse?", options:["Mouses","Mice","Mices","Meese"], answer:1},
     {q:"Which rule usually applies to nouns ending in a consonant plus y, like baby?", options:["Just add s","Add es only","The word never changes","Change the y to i and add es"], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Square Numbers and Square Roots", summary:"Grade 4 Math strand: a square number is the product of a whole number multiplied by itself, such as 4 x 4 = 16, and the square root is the number that produces it, such as the square root of 16 is 4.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a square number?", options:["A number multiplied by itself","Any even number","A number added to itself","A number divided by itself"], answer:0},
     {q:"What is 5 squared (5 x 5)?", options:["10","25","15","20"], answer:1},
     {q:"What is the square root of 16?", options:["16","8","4","2"], answer:2},
     {q:"What is the square root of 9?", options:["18","3","6","9"], answer:1},
     {q:"Square numbers can be shown as ___.", options:["Only prime numbers","Numbers divided by zero","Only odd numbers","Arrays forming a perfect square shape"], answer:3}
   ]},
  {subject:"Science", title:"Science: The Skin — Our Bodys Protective Organ", summary:"Grade 4 Science strand: the skin is the bodys largest organ, protecting against germs and injury, helping regulate temperature, and containing nerve endings that sense touch.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the skin often described as?", options:["A type of bone","A type of muscle only","The bodys largest organ","The smallest organ"], answer:2},
     {q:"What is one job of the skin?", options:["Sending only sound signals","Pumping blood","Digesting food","Protecting the body from germs and injury"], answer:3},
     {q:"How does skin help regulate body temperature?", options:["By changing colour permanently","Through sweating and changes in blood flow near the surface","Skin does not affect temperature","By growing hair only"], answer:1},
     {q:"What allows skin to sense touch?", options:["Nerve endings in the skin","Blood vessels only","Muscles only","Bones beneath the skin"], answer:0},
     {q:"Why is it important to protect skin from cuts and injuries?", options:["Cuts never affect health","Skin cannot be injured","Skin acts as a barrier against germs entering the body","Skin has no protective function"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of the Prime Minister in Canada", summary:"Grade 4 Social Studies strand: the Prime Minister is the head of the Canadian federal government, leading the Cabinet and overseeing the passage of laws and national policy.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the Prime Minister the head of?", options:["The Canadian federal government","A city council","A single province","A private company"], answer:0},
     {q:"What group does the Prime Minister lead?", options:["The Senate only","The RCMP only","The Cabinet","The Supreme Court"], answer:2},
     {q:"How does someone usually become Prime Minister of Canada?", options:["They are born into the role","Their political party wins the most seats in a federal election","They are appointed by another country","They win a local election only"], answer:1},
     {q:"What is one responsibility of the Prime Minister?", options:["Running a single business","Teaching in schools","Coaching sports teams","Overseeing national policy and the passage of laws"], answer:3},
     {q:"Where does the Prime Minister typically work while serving?", options:["In a province chosen at random","In a different country","Nowhere in particular","In Ottawa, the national capital"], answer:3}
   ]},
]},
{day:123, label:"Day 123 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Prepositional Phrases", summary:"Grade 4 Language strand: a prepositional phrase begins with a preposition and ends with a noun or pronoun, showing relationships such as location, time, or direction, as in under the table or before dinner.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What does a prepositional phrase begin with?", options:["A verb","A preposition","An adjective","A conjunction"], answer:1},
     {q:"Which is a prepositional phrase?", options:["And then","Ran quickly","Happy dog","Under the table"], answer:3},
     {q:"In the sentence The cat slept on the couch, what is the prepositional phrase?", options:["The cat","Slept","On the couch","The cat slept"], answer:2},
     {q:"What can a prepositional phrase show?", options:["Only colour","Location, time, or direction","Only size","Only sound"], answer:1},
     {q:"Which word could begin a prepositional phrase?", options:["Happy","Before","Quickly","Run"], answer:1}
   ]},
  {subject:"Math", title:"Number Sense: Divisibility Rules for 3, 6, and 9", summary:"Grade 4 Math strand: a number is divisible by 3 if the sum of its digits is divisible by 3, by 9 if the digit sum is divisible by 9, and by 6 if it is divisible by both 2 and 3.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"A number is divisible by 3 if ___.", options:["It is a prime number","It ends in an even digit","It ends in 0","The sum of its digits is divisible by 3"], answer:3},
     {q:"Is 123 divisible by 3?", options:["No, because it is an odd number","Yes, because 1+2+3=6 is divisible by 3","No, because it ends in 3","Yes, because it has three digits"], answer:1},
     {q:"A number is divisible by 9 if ___.", options:["It is divisible by 3 only","It is an odd number","The sum of its digits is divisible by 9","It ends in 9"], answer:2},
     {q:"For a number to be divisible by 6, it must be divisible by ___.", options:["Only 2","Only 3","Both 2 and 3","Neither 2 nor 3"], answer:2},
     {q:"Is 42 divisible by 6?", options:["No, because its digit sum is not divisible by 3","No, because it is odd","Yes, but only by 2","Yes, because it is divisible by both 2 and 3"], answer:3}
   ]},
  {subject:"Science", title:"Science: The Immune System — How Our Body Fights Germs", summary:"Grade 4 Science strand: the immune system defends the body against harmful germs using white blood cells and other defenses that identify and destroy invaders.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the main job of the immune system?", options:["Defending the body against harmful germs","Breaking down food","Sending messages to muscles","Pumping blood through the body"], answer:0},
     {q:"What blood cells help fight germs?", options:["Red blood cells only","White blood cells","Bone cells","Skin cells only"], answer:1},
     {q:"What is a germ?", options:["A type of bone","A tiny organism that can cause illness","A large animal","A kind of rock"], answer:1},
     {q:"Why might a fever occur when the body is fighting an infection?", options:["Fevers always mean the body is healthy","Fevers have no connection to illness","It can help the immune system fight germs more effectively","Fevers stop the immune system from working"], answer:2},
     {q:"How do vaccines help the immune system?", options:["They help the body learn to recognize and fight specific germs","They remove the immune system entirely","They have no effect on immunity","They only affect the skin"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Canadian Coast Guard", summary:"Grade 4 Social Studies strand: the Canadian Coast Guard is a federal service that ensures safe navigation, responds to search and rescue emergencies, and protects Canadas waters.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What does the Canadian Coast Guard help ensure?", options:["Safe travel through forests","Safe travel on highways only","Safe air travel only","Safe navigation on Canadas waters"], answer:3},
     {q:"What is one major responsibility of the Coast Guard?", options:["Building houses","Teaching in schools","Growing crops","Responding to search and rescue emergencies at sea"], answer:3},
     {q:"What level of government operates the Canadian Coast Guard?", options:["Federal","No government involvement","Municipal","Provincial only"], answer:0},
     {q:"Why is protecting Canadas waters important?", options:["Only oceans exist, no coastlines to protect","Canada has no coastline","Canada has extensive coastlines and waterways vital to trade and safety","Water protection is unnecessary"], answer:2},
     {q:"The Coast Guard is an example of a service that ___.", options:["Has no purpose","Focuses solely on farming","Keeps people and shipping safe on the water","Only exists in other countries"], answer:2}
   ]},
]},
{day:124, label:"Day 124 — Thu", subjects:[
  {subject:"Language", title:"Reading: Analyzing Poetry — Stanzas, Rhyme Scheme, and Meter", summary:"Grade 4 Language strand: poems are organized into stanzas, may follow a rhyme scheme such as ABAB, and use meter, a pattern of rhythm, to create musicality.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a stanza?", options:["The title of a poem","A type of punctuation","A group of lines in a poem, like a paragraph","A single word"], answer:2},
     {q:"What does rhyme scheme describe?", options:["The number of stanzas","The poems length","The pattern of rhyming sounds at the ends of lines","The authors name"], answer:2},
     {q:"In an ABAB rhyme scheme, which lines rhyme with each other?", options:["Only lines 1 and 2","No lines rhyme","Lines 1 and 3, and lines 2 and 4","All four lines rhyme"], answer:2},
     {q:"What is meter in poetry?", options:["A type of comma rule","A pattern of rhythm created by stressed and unstressed syllables","A measurement of length","A kind of prefix"], answer:1},
     {q:"Why might a poet use a strong rhyme scheme and meter?", options:["To make the poem confusing","To avoid using any words","To create a musical, memorable feeling","To remove all structure"], answer:2}
   ]},
  {subject:"Math", title:"Geometry: Tessellations — Tiling a Plane with Transformations", summary:"Grade 4 Math strand: a tessellation is a repeating pattern of shapes that covers a flat surface with no gaps or overlaps, often created using translations, reflections, and rotations.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a tessellation?", options:["A 3D solid figure","A shape with curved sides only","A repeating pattern of shapes covering a surface with no gaps or overlaps","A single isolated shape"], answer:2},
     {q:"Which shape is well known for tessellating easily?", options:["A cone","An oval","A circle","A regular hexagon"], answer:3},
     {q:"Which transformations are often used to create tessellations?", options:["Only colouring shapes","Only enlarging shapes","Translations, reflections, and rotations","Only measuring angles"], answer:2},
     {q:"Why can circles not tessellate on their own?", options:["They leave gaps between them when repeated","They are always the same colour","They have too many sides","They are too small"], answer:0},
     {q:"Where can tessellations be found in real life?", options:["Nowhere in real life","Only in liquids","Floor tiles and honeycomb patterns","Only in outer space"], answer:2}
   ]},
  {subject:"Science", title:"Science: The Five Senses and Sensory Organs", summary:"Grade 4 Science strand: humans perceive the world through five senses -- sight, hearing, smell, taste, and touch -- each detected by a specialized sensory organ.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"How many main senses do humans have?", options:["Two","Seven","Five","Three"], answer:2},
     {q:"Which organ is responsible for the sense of sight?", options:["The eyes","The ears","The tongue","The nose"], answer:0},
     {q:"Which organ is responsible for the sense of hearing?", options:["The nose","The ears","The eyes","The skin"], answer:1},
     {q:"Which organ is mainly responsible for the sense of taste?", options:["The tongue","The nose","The ears","The eyes"], answer:0},
     {q:"Why are the five senses important?", options:["Only sight matters for survival","They have no useful purpose","Senses only work in the dark","They help us gather information about our environment"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Remembrance Day and Canadas Military History", summary:"Grade 4 Social Studies strand: Remembrance Day, observed on November 11, honours Canadians who served and sacrificed in military conflicts, marked by moments of silence and wearing poppies.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"On what date is Remembrance Day observed in Canada?", options:["November 11","July 1","October 31","December 25"], answer:0},
     {q:"What does Remembrance Day honour?", options:["Canadians who served and sacrificed in military conflicts","A new years celebration","A sports championship","A harvest festival"], answer:0},
     {q:"What symbol is commonly worn on Remembrance Day?", options:["A poppy","A red ribbon","A small flag pin","A maple leaf pin"], answer:0},
     {q:"What tradition is observed at 11 a.m. on Remembrance Day?", options:["A public holiday with no observance","A moment of silence","A parade with loud music","A fireworks display"], answer:1},
     {q:"Why is it important for students to learn about Remembrance Day?", options:["It celebrates a sports victory","It has no historical importance","It is only about modern events","It helps them understand and honour sacrifices made in Canadas history"], answer:3}
   ]},
]},
{day:125, label:"Day 125 — Fri", subjects:[
  {subject:"Language", title:"Reading: Identifying Tone in a Text", summary:"Grade 4 Language strand: tone is the authors attitude toward a subject, revealed through word choice and details, such as a humorous, serious, or sorrowful tone.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is tone in a piece of writing?", options:["The setting of the story","The main character","The authors attitude toward the subject","The title of the text"], answer:2},
     {q:"How can readers identify an authors tone?", options:["By examining word choice and details","By counting the pages","Tone cannot be identified","By looking at the cover only"], answer:0},
     {q:"Which words might signal a humorous tone?", options:["Only angry words","Playful and silly language","Only sad words","Formal legal terms"], answer:1},
     {q:"Which words might signal a serious tone?", options:["Bright, playful exclamations","Silly jokes","Random nonsense words","Formal, weighty language about an important topic"], answer:3},
     {q:"Why is understanding tone important for readers?", options:["Tone only matters in poetry","Tone is the same as plot","It has no effect on understanding a text","It helps readers understand how the author feels about the topic"], answer:3}
   ]},
  {subject:"Math", title:"Measurement: Exploring Shapes with the Same Perimeter but Different Area", summary:"Grade 4 Math strand: two shapes can share the same perimeter yet enclose different areas, showing that perimeter and area measure different properties of a shape.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does perimeter measure?", options:["The weight of a shape","The space inside a shape","The number of sides only","The distance around a shape"], answer:3},
     {q:"What does area measure?", options:["The space inside a shape","The number of corners","The height only","The distance around a shape"], answer:0},
     {q:"A 2 by 8 rectangle and a 5 by 5 square both have a perimeter of 20 -- which shape has a greater area?", options:["They always have equal area","Area cannot be compared this way","The square (25) has a greater area than the rectangle (16)","The rectangle always has more area"], answer:2},
     {q:"Why is it useful to know that shapes can share a perimeter but differ in area?", options:["It means perimeter is not useful","It means area never changes","It proves perimeter and area are the same thing","It shows perimeter and area are independent measurements"], answer:3},
     {q:"Which shape generally maximizes area for a given perimeter?", options:["A shape closer to a square or circle","A very long, thin rectangle","A shape with many sharp points","Any triangle"], answer:0}
   ]},
  {subject:"Science", title:"Science: Insect Life Cycles — Complete and Incomplete Metamorphosis", summary:"Grade 4 Science strand: insects such as butterflies undergo complete metamorphosis with four distinct stages, while insects such as grasshoppers undergo incomplete metamorphosis with fewer, more gradual stages.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What are the four stages of complete metamorphosis?", options:["Adult, egg, and larva only","Egg, adult, larva, and nymph","Larva, egg, nymph, and pupa","Egg, larva, pupa, and adult"], answer:3},
     {q:"Which insect is a well-known example of complete metamorphosis?", options:["Grasshopper","Butterfly","Dragonfly nymph only","Cockroach"], answer:1},
     {q:"What stage in complete metamorphosis involves a protective casing?", options:["Larva","Pupa","Egg","Adult"], answer:1},
     {q:"What is different about incomplete metamorphosis?", options:["It has fewer stages and the young resemble smaller versions of adults","The larva looks nothing like the adult","It always has five stages","There is no egg stage"], answer:0},
     {q:"Which insect is an example of incomplete metamorphosis?", options:["Moth","Grasshopper","Ladybug","Butterfly"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Boreal Forest — Geography and Importance", summary:"Grade 4 Social Studies strand: the boreal forest is a vast forest region stretching across much of northern Canada, providing habitat for wildlife, storing carbon, and supporting industries such as forestry.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the boreal forest?", options:["A vast forest region across much of northern Canada","A desert region","An underwater ecosystem","A small forest in southern Canada"], answer:0},
     {q:"What kind of trees are common in the boreal forest?", options:["Only cactus plants","Only palm trees","Coniferous trees such as spruce and pine","No trees grow there"], answer:2},
     {q:"What role does the boreal forest play for wildlife?", options:["It has no wildlife","It destroys animal habitats","It provides important habitat for many animal species","It only supports fish"], answer:2},
     {q:"Why is the boreal forest important for storing carbon?", options:["Its trees and soil absorb and store large amounts of carbon","It only exists to be cut down","It has no effect on carbon levels","It releases carbon with no absorption"], answer:0},
     {q:"Which industry commonly operates in the boreal forest?", options:["Underwater mining","Forestry","Fishing exclusively","Desert tourism"], answer:1}
   ]},
]},
{day:126, label:"Day 126 — Mon", subjects:[
  {subject:"Language", title:"Vocabulary: Loanwords — Words Borrowed from Other Languages", summary:"Grade 4 Language strand: a loanword is a word English has borrowed from another language, such as ballet from French or spaghetti from Italian, enriching English vocabulary.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a loanword?", options:["A word borrowed from another language","A word that is always spelled wrong","A type of punctuation mark","A word with no meaning"], answer:0},
     {q:"Which word is a loanword borrowed from French?", options:["Happy","Ballet","Table","Run"], answer:1},
     {q:"Which word is a loanword borrowed from Italian?", options:["Tree","House","Book","Spaghetti"], answer:3},
     {q:"Why does English contain so many loanwords?", options:["English has no connection to other languages","English has borrowed words through trade, travel, and cultural contact over time","English never changes","Loanwords are recent inventions with no history"], answer:1},
     {q:"Learning about loanwords can help readers understand ___.", options:["Nothing useful","How languages influence each other","Only science vocabulary","Only math vocabulary"], answer:1}
   ]},
  {subject:"Math", title:"Data Management: Using a Venn Diagram to Sort and Compare Data", summary:"Grade 4 Math strand: a Venn diagram uses overlapping circles to sort data into categories, showing items that belong to one group, another group, or both.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a Venn diagram used for?", options:["Sorting and comparing data using overlapping circles","Measuring angles","Recording elapsed time","Finding the area of a shape"], answer:0},
     {q:"What does the overlapping section of a Venn diagram show?", options:["Items that belong to neither category","The total number of items only","Items outside both circles","Items that belong to both categories"], answer:3},
     {q:"If an item belongs to only one circle in a Venn diagram, what does that mean?", options:["It fits both categories","It fits no category","It fits only that one category","It is an error"], answer:2},
     {q:"Why are Venn diagrams useful for organizing data?", options:["They replace the need for any data at all","They visually show relationships and overlaps between groups","They only work with numbers","They cannot show overlapping information"], answer:1},
     {q:"A Venn diagram comparing students who like apples and students who like oranges would place students who like both ___.", options:["In neither circle","Outside both circles","In the overlapping section","In a separate diagram"], answer:2}
   ]},
  {subject:"Science", title:"Science: Fossil Fuels — Formation, Use, and Environmental Impact", summary:"Grade 4 Science strand: fossil fuels such as coal, oil, and natural gas formed over millions of years from ancient organisms and are burned for energy, though their use releases pollution and greenhouse gases.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What are fossil fuels?", options:["Sources of energy made from sunlight instantly","A renewable energy source","A type of rock with no energy use","Energy sources formed over millions of years from ancient organisms"], answer:3},
     {q:"Which of these is an example of a fossil fuel?", options:["Wind","Sunlight","Water","Coal"], answer:3},
     {q:"How long does it take for fossil fuels to form?", options:["A few days","A few hours","One year","Millions of years"], answer:3},
     {q:"What is one environmental concern with burning fossil fuels?", options:["It creates more fossil fuels instantly","It cools the planet permanently","It has no environmental effects","It releases pollution and greenhouse gases"], answer:3},
     {q:"Why are fossil fuels considered non-renewable?", options:["They take far too long to reform once used up","They never run out","They can be remade in seconds","They are unlimited in supply"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Mining Industry", summary:"Grade 4 Social Studies strand: Canadas mining industry extracts valuable resources such as nickel, gold, and potash from the ground, contributing significantly to the national economy and employment.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What does the mining industry extract from the ground?", options:["Valuable resources such as minerals and metals","Only trees","Only water","Only soil"], answer:0},
     {q:"Name one resource commonly mined in Canada.", options:["Cotton","Bananas","Rice","Nickel"], answer:3},
     {q:"How does mining contribute to Canadas economy?", options:["It only costs money with no benefit","It replaces all other industries","It creates jobs and generates income through resource sales","It has no economic impact"], answer:2},
     {q:"Why might mining be an important industry in certain Canadian regions?", options:["Those regions have rich mineral deposits underground","Mining only occurs in cities","Mining requires no natural resources","All regions have identical resources"], answer:0},
     {q:"What is one environmental consideration related to mining?", options:["Balancing resource extraction with protecting the environment","Environmental impact is never considered","Mining always improves the environment","Mining has no environmental effects"], answer:0}
   ]},
]},
{day:127, label:"Day 127 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing an Autobiography", summary:"Grade 4 Language strand: an autobiography is a true account of a persons own life written by that person, often organized in chronological order and including important events and reflections.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is an autobiography?", options:["A true account of a persons life written by that person","A biography written by another author","A type of poem","A fictional story about someone else"], answer:0},
     {q:"How are autobiographies usually organized?", options:["Backwards from the end to beginning always","Randomly with no order","Alphabetically by topic","In chronological order"], answer:3},
     {q:"What point of view is typically used in an autobiography?", options:["First person (I, me, my)","No point of view is used","Second person only","Third person only"], answer:0},
     {q:"What might an autobiography include besides events?", options:["Only pictures with no words","The writers reflections and feelings","Only dates and numbers","Nothing personal at all"], answer:1},
     {q:"How is an autobiography different from a biography?", options:["A biography is always fictional","There is no difference","An autobiography is always about someone else","An autobiography is written by the subject about themselves, while a biography is written by someone else"], answer:3}
   ]},
  {subject:"Math", title:"Data Management: Expressing Probability as a Percent", summary:"Grade 4 Math strand: probability can be expressed as a fraction, decimal, or percent, showing the likelihood of an event, such as a 1/2 chance being expressed as 50%.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"Probability can be expressed as a fraction, decimal, or ___.", options:["Whole number only","Negative number","Ratio only","Percent"], answer:3},
     {q:"What percent represents a probability of 1/2?", options:["25%","100%","50%","10%"], answer:2},
     {q:"What percent represents a probability of 1/4?", options:["25%","100%","50%","75%"], answer:0},
     {q:"If an event is certain to happen, what is its probability as a percent?", options:["0%","50%","100%","25%"], answer:2},
     {q:"If an event is impossible, what is its probability as a percent?", options:["0%","100%","25%","50%"], answer:0}
   ]},
  {subject:"Science", title:"Science: The Carbon Cycle — How Carbon Moves Through Earths Systems", summary:"Grade 4 Science strand: the carbon cycle describes how carbon moves between the air, plants, animals, oceans, and soil, such as plants absorbing carbon dioxide and animals releasing it through breathing.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What does the carbon cycle describe?", options:["How electricity flows through circuits","How carbon moves between air, plants, animals, and soil","How water moves through clouds only","How rocks form over time"], answer:1},
     {q:"What gas do plants absorb from the air as part of the carbon cycle?", options:["Nitrogen only","Helium","Carbon dioxide","Oxygen only"], answer:2},
     {q:"How do animals release carbon back into the environment?", options:["Through breathing out carbon dioxide","Through walking","Through drinking water","Through sleeping"], answer:0},
     {q:"Where can carbon be stored for long periods of time?", options:["Only in animals","In oceans, soil, and fossil fuels","Nowhere, it disappears","Only in the air"], answer:1},
     {q:"Why is the carbon cycle important for life on Earth?", options:["It only affects rocks","It has no importance to living things","It helps regulate the balance of gases that support living things","It stops all plant growth"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canada-United States Trade Relationship", summary:"Grade 4 Social Studies strand: Canada and the United States share one of the largest trading relationships in the world, exchanging goods such as vehicles, energy, and agricultural products across the border.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Canada shares one of the largest trading relationships in the world with which country?", options:["Australia","The United States","Brazil","Japan"], answer:1},
     {q:"What might Canada and the United States exchange through trade?", options:["Vehicles, energy, and agricultural products","Only historical documents","Nothing at all","Only artwork"], answer:0},
     {q:"Why is trade between neighbouring countries often significant?", options:["Neighbouring countries never trade","Shared borders make transporting goods easier and more efficient","Distance has no effect on trade","Trade only happens between distant countries"], answer:1},
     {q:"What is one benefit of strong trade relationships between countries?", options:["No goods are exchanged","Access to a wider variety of goods and economic growth","Trade always harms both countries","Countries lose all their resources"], answer:1},
     {q:"Trade agreements between countries like Canada and the United States help ___.", options:["Prevent any trade from happening","Eliminate all industries","Set clear rules for how goods are exchanged","Stop economic growth"], answer:2}
   ]},
]},
{day:128, label:"Day 128 — Wed", subjects:[
  {subject:"Language", title:"Writing: Writing a Mystery Story", summary:"Grade 4 Language strand: a mystery story presents a puzzling problem, such as a crime or disappearance, and follows characters as they gather clues to solve it before a satisfying resolution.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a key feature of a mystery story?", options:["A list of vocabulary words","A recipe for a meal","A puzzling problem that needs to be solved","A weather report"], answer:2},
     {q:"What do characters in a mystery often gather to solve the problem?", options:["Clues","Nothing at all","Random objects with no purpose","Money only"], answer:0},
     {q:"Who is often the main character trying to solve the mystery?", options:["The weather","A random stranger never mentioned again","A detective or curious character","A narrator with no role"], answer:2},
     {q:"What usually happens at the end of a mystery story?", options:["All characters disappear","The mystery is solved and explained","Nothing is ever resolved","The story restarts from the beginning"], answer:1},
     {q:"Why do writers include red herrings, or misleading clues, in mysteries?", options:["To create suspense and mislead readers temporarily","To confuse readers with no purpose","To end the story early","Red herrings are never used in mysteries"], answer:0}
   ]},
  {subject:"Math", title:"Financial Literacy: Calculating Discounts and Sale Prices", summary:"Grade 4 Math strand: a discount reduces the original price of an item by a percent, and the sale price is found by subtracting the discount amount from the original price.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does a discount do to the original price of an item?", options:["Reduces it","Keeps it the same","Doubles it","Increases it"], answer:0},
     {q:"If a $20 item has a 10% discount, how much is the discount?", options:["$18","$10","$20","$2"], answer:3},
     {q:"If a $20 item has a 10% discount, what is the sale price?", options:["$22","$10","$18","$2"], answer:2},
     {q:"To find the sale price, you should ___.", options:["Multiply the original price by 100","Subtract the discount amount from the original price","Ignore the discount","Add the discount to the original price"], answer:1},
     {q:"Why might stores offer discounts?", options:["To make prices permanently higher","To confuse shoppers","To encourage customers to buy items","Discounts are never offered"], answer:2}
   ]},
  {subject:"Science", title:"Science: Alternative Energy — Geothermal and Biomass Power", summary:"Grade 4 Science strand: geothermal energy harnesses heat from deep within the Earth, while biomass energy comes from burning organic material such as wood or plant waste, offering renewable alternatives to fossil fuels.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is geothermal energy?", options:["Energy from the sun only","Energy from wind only","Energy harnessed from heat within the Earth","Energy from ocean waves"], answer:2},
     {q:"What is biomass energy made from?", options:["Only water","Organic material such as wood or plant waste","Only sunlight","Only metal"], answer:1},
     {q:"Why are geothermal and biomass energy considered renewable?", options:["They come from fossil fuels","Their sources can be naturally replenished over time","They only work for a single day","They cannot be replenished at all"], answer:1},
     {q:"Where does geothermal energy typically come from underground?", options:["Heat from deep within the Earth","Frozen ice layers","Empty caves with no heat","Cold air pockets"], answer:0},
     {q:"What is one benefit of using alternative energy sources like geothermal and biomass?", options:["They are identical to fossil fuels","They always pollute more than fossil fuels","They cannot produce electricity","They can reduce reliance on fossil fuels"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The History of O Canada — Canadas National Anthem", summary:"Grade 4 Social Studies strand: O Canada, written in the 19th century, became Canadas official national anthem in 1980 and is sung at ceremonies and events across the country.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the title of Canadas national anthem?", options:["The Maple Leaf Forever","O Canada","God Save the King","True North Strong"], answer:1},
     {q:"In what century was O Canada originally written?", options:["The 19th century","The 21st century","The 10th century","The 15th century"], answer:0},
     {q:"In what year did O Canada officially become Canadas national anthem?", options:["1920","1867","2000","1980"], answer:3},
     {q:"When is O Canada commonly sung?", options:["Never in public settings","At ceremonies, events, and the start of school days","Only in courtrooms","Only during elections"], answer:1},
     {q:"Why do countries have national anthems?", options:["To confuse citizens","To express national pride and unity","Only for private use","They serve no purpose"], answer:1}
   ]},
]},
{day:129, label:"Day 129 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Fable with a Moral", summary:"Grade 4 Language strand: a fable is a short story, often featuring animal characters, that teaches a lesson called a moral, such as honesty is the best policy.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a fable?", options:["A short story that teaches a lesson","A type of poem with no message","A grammar rule","A factual news report"], answer:0},
     {q:"What are fable characters often depicted as?", options:["Robots","Animals that act like people","Only humans","Inanimate objects with no personality"], answer:1},
     {q:"What is a moral in a fable?", options:["The setting","The main characters name","The lesson the story teaches","The title of the story"], answer:2},
     {q:"Which is an example of a common fable moral?", options:["Numbers can be added together","Nouns name people, places, or things","Honesty is the best policy","Water boils at 100 degrees"], answer:2},
     {q:"Why do writers use animal characters in fables?", options:["To represent human behaviours and teach lessons in an engaging way","Animals only appear in nonfiction","To avoid teaching any lesson","Animals cannot be characters in stories"], answer:0}
   ]},
  {subject:"Math", title:"Data Management: Interpreting Double Line Graphs", summary:"Grade 4 Math strand: a double line graph displays two related sets of data over the same time period using two separate lines, making it easy to compare trends.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does a double line graph show?", options:["Only one set of data","Two related sets of data over the same time period","Data with no time period","A single point of data"], answer:1},
     {q:"Why might someone use a double line graph instead of a single line graph?", options:["Double line graphs cannot be compared","To show only categories with no numbers","To compare two trends at once","To hide information"], answer:2},
     {q:"What do the two lines in a double line graph usually represent?", options:["Two different data sets being compared","Random unrelated numbers","Nothing meaningful","The same data twice"], answer:0},
     {q:"If two lines on a graph cross, what does that suggest?", options:["The graph is incorrect","The two data sets were equal at that point","Data cannot cross","The lines will never move again"], answer:1},
     {q:"Double line graphs are especially useful for comparing ___.", options:["The area of a rectangle","Angles in a shape","Trends over time between two groups","Only one number"], answer:2}
   ]},
  {subject:"Science", title:"Science: Coral Reefs — Diverse Underwater Ecosystems", summary:"Grade 4 Science strand: coral reefs are diverse underwater ecosystems built by tiny animals called coral polyps, providing habitat for a huge variety of ocean life.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What builds a coral reef?", options:["Underwater volcanoes only","Ocean currents alone","Large fish","Tiny animals called coral polyps"], answer:3},
     {q:"Why are coral reefs important ecosystems?", options:["They destroy ocean life","They have no living things","They only exist on land","They provide habitat for a huge variety of ocean life"], answer:3},
     {q:"What conditions do coral reefs typically need to grow?", options:["Fresh water only","Warm, shallow, clear water","Cold, deep, dark water","No water at all"], answer:1},
     {q:"What is one threat to coral reefs today?", options:["Too many fish protecting them","Nothing threatens coral reefs","Rising ocean temperatures causing coral bleaching","Too much cold water"], answer:2},
     {q:"Coral reefs are sometimes called the ___ of the sea because of their rich biodiversity.", options:["Rainforests","Volcanoes","Deserts","Glaciers"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of Volunteers and Charities in Canadian Communities", summary:"Grade 4 Social Studies strand: volunteers and charities support Canadian communities by providing services such as food banks, shelters, and fundraising for causes that governments may not fully cover.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do volunteers offer to their communities?", options:["Only money with no time given","Only government services","Nothing of value","Their time and effort to help others without pay"], answer:3},
     {q:"What is a charity?", options:["A type of school","A branch of the military","A government department","An organization that raises money or resources to help a cause"], answer:3},
     {q:"Name one service a charity might provide.", options:["Operating a food bank","Collecting taxes","Running elections","Building highways"], answer:0},
     {q:"Why are volunteers and charities important in a community?", options:["They only exist in large cities","They have no effect on communities","They provide support that governments may not fully cover","They replace all government services"], answer:2},
     {q:"How can students contribute to their community as volunteers?", options:["By ignoring community needs","Only by paying taxes","Students cannot volunteer","By helping with local events or fundraising efforts"], answer:3}
   ]},
]},
{day:130, label:"Day 130 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Grammar, Poetry, and Writing Forms", summary:"Grade 4 Language strand review: students revisit comma rules, plural noun rules, prepositional phrases, analyzing poetry, and identifying tone.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which sentence uses commas correctly in a series?", options:["I packed apples oranges, and grapes.","I packed apples, oranges and, grapes.","I packed, apples oranges and grapes.","I packed apples, oranges, and grapes."], answer:3},
     {q:"What is the plural of dog?", options:["Dogs","Doges","Dogen","Dogies"], answer:0},
     {q:"What does a prepositional phrase begin with?", options:["A preposition","A verb","A conjunction","An adjective"], answer:0},
     {q:"What is a stanza?", options:["A type of punctuation","A group of lines in a poem, like a paragraph","A single word","The title of a poem"], answer:1},
     {q:"What is tone in a piece of writing?", options:["The authors attitude toward the subject","The main character","The setting of the story","The title of the text"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Fractions, Number Sense, and Data", summary:"Grade 4 Math strand review: students revisit adding fractions with unlike denominators, square numbers and square roots, divisibility rules, tessellations, and same-perimeter-different-area shapes.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What must fractions have before they can be added directly?", options:["The same sign","Different denominators","A common denominator","The same numerator"], answer:2},
     {q:"What is a square number?", options:["Any even number","A number multiplied by itself","A number added to itself","A number divided by itself"], answer:1},
     {q:"A number is divisible by 3 if ___.", options:["It ends in 0","It is a prime number","It ends in an even digit","The sum of its digits is divisible by 3"], answer:3},
     {q:"What is a tessellation?", options:["A single isolated shape","A 3D solid figure","A shape with curved sides only","A repeating pattern of shapes covering a surface with no gaps or overlaps"], answer:3},
     {q:"What does perimeter measure?", options:["The weight of a shape","The space inside a shape","The number of sides only","The distance around a shape"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Body Systems, Energy, and Ecosystems", summary:"Grade 4 Science strand review: students revisit the digestive system, the skin, the immune system, the five senses, and insect life cycles.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the main job of the digestive system?", options:["Filtering air","Sending nerve signals","Breaking down food into nutrients the body can use","Pumping blood"], answer:2},
     {q:"What is the skin often described as?", options:["The bodys largest organ","A type of muscle only","The smallest organ","A type of bone"], answer:0},
     {q:"What is the main job of the immune system?", options:["Breaking down food","Pumping blood through the body","Sending messages to muscles","Defending the body against harmful germs"], answer:3},
     {q:"How many main senses do humans have?", options:["Five","Seven","Three","Two"], answer:0},
     {q:"What are the four stages of complete metamorphosis?", options:["Adult, egg, and larva only","Egg, adult, larva, and nymph","Larva, egg, nymph, and pupa","Egg, larva, pupa, and adult"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Ancient Societies, Government, and Canadian Geography", summary:"Grade 4 Social Studies strand review: students revisit ancient Japan, the role of the Prime Minister, the Canadian Coast Guard, Remembrance Day, and the boreal forest.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What type of geography influenced ancient Japans development?", options:["Its island location","A landlocked plain","A mountain range with no coast","A vast desert"], answer:0},
     {q:"What is the Prime Minister the head of?", options:["A private company","The Canadian federal government","A single province","A city council"], answer:1},
     {q:"What does the Canadian Coast Guard help ensure?", options:["Safe navigation on Canadas waters","Safe air travel only","Safe travel through forests","Safe travel on highways only"], answer:0},
     {q:"On what date is Remembrance Day observed in Canada?", options:["December 25","November 11","October 31","July 1"], answer:1},
...
{day:141, label:"Day 141 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Parallel Structure in Sentences", summary:"Grade 4 Language strand: parallel structure means using the same grammatical pattern for items in a list or series, such as making sure all items are the same part of speech or verb form.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is parallel structure in a sentence?", options:["Using a different verb tense for each item","Using the same grammatical pattern for items in a series","Never using lists in a sentence","Using only nouns and no verbs"], answer:1},
     {q:"Which sentence uses parallel structure correctly?", options:["She likes running, swimming, and biking.","She likes to run, swimming, and bike.","She likes running, to swim, and biking.","She likes runs, swims, and biking."], answer:0},
     {q:"Why is parallel structure important in writing?", options:["It makes sentences clearer and easier to read","It has no effect on writing","It removes all verbs from a sentence","It makes sentences confusing on purpose"], answer:0},
     {q:"What is wrong with the sentence He enjoys hiking, to fish, and camping?", options:["It is already correct","It mixes a gerund and an infinitive instead of using the same form","It has too many commas","It uses no verbs at all"], answer:1},
     {q:"What should all items in a parallel list share?", options:["No connection to each other","Completely different meanings","The same grammatical form","Different punctuation each time"], answer:2}
   ]},
  {subject:"Math", title:"Fractions: Dividing a Fraction by a Whole Number", summary:"Grade 4 Math strand: to divide a fraction by a whole number, students can think of splitting the fraction into that many equal groups, which multiplies the denominator by the whole number.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What happens to the denominator when dividing a fraction by a whole number?", options:["The denominator stays exactly the same","The denominator is divided by the whole number","The denominator is multiplied by the whole number","The numerator disappears"], answer:2},
     {q:"What is 1/2 divided by 2?", options:["1","1/4","1/2","2/2"], answer:1},
     {q:"What is 1/3 divided by 2?", options:["1/3","2/3","1/2","1/6"], answer:3},
     {q:"What is 2/5 divided by 2?", options:["1/10","4/5","1/5","2/5"], answer:2},
     {q:"Why does dividing a fraction by a whole number usually make it smaller?", options:["Because the fraction is being split into more equal parts","Division always makes numbers larger","Fractions cannot be divided","The numerator always becomes zero"], answer:0}
   ]},
  {subject:"Science", title:"Science: Photosynthesis — How Plants Make Their Own Food", summary:"Grade 4 Science strand: photosynthesis is the process by which plants use sunlight, water, and carbon dioxide to make their own food and release oxygen as a byproduct.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is photosynthesis?", options:["The process by which plants make their own food using sunlight","A process where plants produce no oxygen","A process that only happens at night","A process where plants absorb food from soil only"], answer:0},
     {q:"What three things do plants need for photosynthesis?", options:["Sunlight, water, and carbon dioxide","Only darkness and water","Only oxygen and sugar","Only soil and rocks"], answer:0},
     {q:"What gas do plants release during photosynthesis?", options:["Oxygen","Hydrogen","Nitrogen","Carbon dioxide only"], answer:0},
     {q:"Where in a plant does most photosynthesis take place?", options:["In the bark only","In the leaves","In the roots only","In the flowers only"], answer:1},
     {q:"Why is photosynthesis important for other living things?", options:["It has no effect on other living things","It produces oxygen and food that many organisms depend on","It removes all oxygen from the air","It only matters to plants and no one else"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Hudson Bay Company and the Fur Trade Economy", summary:"Grade 4 Social Studies strand: the Hudson Bay Company was a major fur trading company that played a significant role in the exploration, economy, and early history of what is now Canada.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What kind of company was the Hudson Bay Company?", options:["A major fur trading company","A film production company","An airline company","A modern technology company"], answer:0},
     {q:"What role did the Hudson Bay Company play in early Canadian history?", options:["It played a major role in exploration and the fur trade economy","It focused only on farming","It had no role in Canadian history","It only operated outside of North America"], answer:0},
     {q:"What resource was central to the Hudson Bay Companys trade?", options:["Animal furs, such as beaver pelts","Gold and silver only","Oil and gas","Grain and wheat"], answer:0},
     {q:"How did the fur trade affect relationships between European traders and Indigenous peoples?", options:["It had no effect on either group","It only involved European traders","It caused no interaction between the two groups","It led to trading partnerships and exchanges of goods"], answer:3},
     {q:"Why is the Hudson Bay Company still studied in Canadian history today?", options:["It has no lasting historical importance","It was active for only one single day","It significantly shaped early exploration, trade, and settlement patterns","It only affected countries outside North America"], answer:2}
   ]},
]},
{day:142, label:"Day 142 — Tue", subjects:[
  {subject:"Language", title:"Reading: Analyzing Character Foils", summary:"Grade 4 Language strand: a character foil is a character whose traits contrast with another character, highlighting specific qualities of the main character through the difference.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a character foil?", options:["A character who looks exactly like the main character","A character whose traits contrast with another character to highlight qualities","A type of punctuation mark","A character who never appears in the story"], answer:1},
     {q:"What does a foil help readers notice about the main character?", options:["The authors name","Nothing useful about the story","Only the setting of the story","Specific traits or qualities through contrast"], answer:3},
     {q:"If a brave character is paired with a timid character, what literary device might this show?", options:["A character foil emphasizing bravery through contrast","A simile comparing two objects","A type of onomatopoeia","An example of alliteration"], answer:0},
     {q:"Where might a character foil appear in a story?", options:["As a friend, sibling, or rival with opposite traits","Only in the table of contents","Never in fiction","Only in the title of the book"], answer:0},
     {q:"Why do authors use character foils?", options:["To avoid describing any characters","To make certain traits of a character stand out more clearly","To remove conflict from a story","To confuse readers with no purpose"], answer:1}
   ]},
  {subject:"Math", title:"Geometry: Volume of Triangular Prisms", summary:"Grade 4 Math strand: the volume of a triangular prism is found by multiplying the area of its triangular base by the length of the prism.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What shape is the base of a triangular prism?", options:["A pentagon","A circle","A square","A triangle"], answer:3},
     {q:"How do you find the volume of a triangular prism?", options:["Multiply only the two shortest sides","Add all the edges together","Multiply the area of the triangular base by the length of the prism","Multiply the perimeter by the height"], answer:2},
     {q:"If a triangular base has an area of 6 square units and the prism is 5 units long, what is the volume?", options:["25 cubic units","11 cubic units","30 cubic units","6 cubic units"], answer:2},
     {q:"What units are used to measure the volume of a prism?", options:["Linear units","Cubic units","Square units","No units are needed"], answer:1},
     {q:"Why is finding the area of the triangular base an important first step?", options:["The base has no effect on volume","Volume can be found without knowing the base","Because volume depends on the area of the base multiplied by length","Triangular prisms never have a measurable base"], answer:2}
   ]},
  {subject:"Science", title:"Science: Vertebrates and Invertebrates — Classifying Animals", summary:"Grade 4 Science strand: animals can be classified as vertebrates, which have a backbone, or invertebrates, which do not, helping scientists organize and study the animal kingdom.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is a vertebrate?", options:["A type of plant","An animal that has a backbone","An animal that has no backbone","A type of rock"], answer:1},
     {q:"What is an invertebrate?", options:["An animal that always has a backbone","A type of weather pattern","An animal that does not have a backbone","A type of mineral"], answer:2},
     {q:"Which of these is an example of a vertebrate?", options:["A jellyfish","A fish","An insect","A worm"], answer:1},
     {q:"Which of these is an example of an invertebrate?", options:["A reptile","A mammal","A bird","A snail"], answer:3},
     {q:"Why do scientists classify animals into groups like vertebrates and invertebrates?", options:["Classification only applies to plants","All animals are exactly the same","Classification has no scientific purpose","It helps organize and study the wide variety of animals"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: How Taxes Support Canadian Communities", summary:"Grade 4 Social Studies strand: taxes are money collected by governments from individuals and businesses, used to fund public services such as schools, roads, hospitals, and emergency services in Canadian communities.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What are taxes?", options:["A type of currency used only in stores","Money given only to private businesses","A voluntary gift with no purpose","Money collected by governments to fund public services"], answer:3},
     {q:"Which of these is commonly funded by tax money?", options:["Public schools and hospitals","Only foreign purchases","Only individual savings accounts","Only private vacations"], answer:0},
     {q:"Who is generally responsible for paying taxes?", options:["No one is responsible for taxes","Only children","Only visitors from other countries","Individuals and businesses"], answer:3},
     {q:"Why are taxes important for a community?", options:["They have no benefit to the community","Taxes only benefit the government itself","They help pay for shared services everyone can use","Taxes remove all public services"], answer:2},
     {q:"Which level of government might collect taxes in Canada?", options:["Only private companies","Only foreign governments","No government collects taxes","Federal, provincial, and municipal governments"], answer:3}
   ]},
]},
{day:143, label:"Day 143 — Wed", subjects:[
  {subject:"Language", title:"Writing: Writing a Public Service Announcement", summary:"Grade 4 Language strand: a public service announcement is a short persuasive message that informs the public about an important issue and encourages a specific action, often used on radio, television, or posters.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is the purpose of a public service announcement?", options:["To share a private diary entry","To inform the public about an issue and encourage action","To tell a made-up bedtime story","To sell a specific brand of toy"], answer:1},
     {q:"Where might a public service announcement be shared?", options:["On radio, television, or posters","Only in a math textbook","Only in a private letter","Nowhere at all"], answer:0},
     {q:"What should a strong public service announcement include?", options:["Only decorative pictures","Random unrelated facts","A clear message and a call to action","No message at all"], answer:2},
     {q:"Which topic would be appropriate for a public service announcement?", options:["Encouraging people to recycle","Describing a fictional dragon","Listing random numbers","Sharing a private joke"], answer:0},
     {q:"Why do public service announcements use short, clear language?", options:["Short language has no benefit","To make the message harder to understand","So the audience quickly understands and remembers the message","Because rules require no words at all"], answer:2}
   ]},
  {subject:"Math", title:"Number Sense: Introduction to Integers (Positive and Negative Numbers)", summary:"Grade 4 Math strand: integers include positive numbers, negative numbers, and zero, and can be used to represent values such as temperatures below zero or money owed.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What are integers?", options:["Only positive numbers","Positive numbers, negative numbers, and zero","Only fractions","Only decimals"], answer:1},
     {q:"What might a negative integer represent in real life?", options:["A temperature below zero","The number of sides on a square","A number of apples in a basket","The number of days in a week"], answer:0},
     {q:"Which of these is a negative integer?", options:["5","1/2","0.5","-5"], answer:3},
     {q:"On a number line, where are negative integers located compared to zero?", options:["Exactly at zero","To the right of zero","Negative integers do not exist on a number line","To the left of zero"], answer:3},
     {q:"Which integer is greater, -3 or -8?", options:["Neither can be compared","-8","They are equal","-3"], answer:3}
   ]},
  {subject:"Science", title:"Science: Plant Parts and Their Functions — Roots, Stems, Leaves, and Flowers", summary:"Grade 4 Science strand: each part of a plant has a specific function, with roots absorbing water and nutrients, stems supporting the plant and transporting materials, leaves capturing sunlight, and flowers producing seeds.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the main job of a plants roots?", options:["Releasing pollen only","Absorbing water and nutrients from the soil","Capturing sunlight for energy","Producing seeds"], answer:1},
     {q:"What is the main job of a plants stem?", options:["Absorbing sunlight directly","Producing fruit only","Anchoring the plant underground","Supporting the plant and transporting water and nutrients"], answer:3},
     {q:"What is the main job of a plants leaves?", options:["Producing seeds for reproduction","Absorbing water from the soil","Capturing sunlight to make food through photosynthesis","Anchoring the plant in place"], answer:2},
     {q:"What is the main job of a plants flowers?", options:["Releasing oxygen only at night","Absorbing water and nutrients","Producing seeds for reproduction","Supporting the entire plant structure"], answer:2},
     {q:"Why does a plant need all of these parts working together?", options:["Each part performs a different function needed for the plant to survive and grow","Only one part is ever needed for survival","Plants do not need roots or stems","Plant parts have no connection to each other"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas National Symbols — The Beaver and the Maple Leaf", summary:"Grade 4 Social Studies strand: Canada has several national symbols, including the beaver, recognized for its role in the fur trade and industriousness, and the maple leaf, featured on the national flag and representing Canadian identity.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Which animal is a well-known national symbol of Canada?", options:["The kangaroo","The eagle","The lion","The beaver"], answer:3},
     {q:"What historical industry is the beaver closely associated with in Canada?", options:["The fishing industry","The film industry","The fur trade","The mining industry"], answer:2},
     {q:"What plant symbol appears on the Canadian flag?", options:["The oak leaf","The rose","The palm leaf","The maple leaf"], answer:3},
     {q:"Why are national symbols like the beaver and maple leaf important to Canadian identity?", options:["They are only used outside of Canada","They have no connection to Canadian history","They represent a completely different country","They represent shared history and help people feel connected to their country"], answer:3},
     {q:"Where might you see the maple leaf symbol displayed?", options:["Only in other countries","On the Canadian flag and various official items","Only on private property","Nowhere in Canada"], answer:1}
   ]},
]},
{day:144, label:"Day 144 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Understanding Jargon and Technical Vocabulary", summary:"Grade 4 Language strand: jargon is special vocabulary used by people in a particular field or group, such as doctors or athletes, that may be unfamiliar to general readers.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is jargon?", options:["A word with no meaning at all","A type of punctuation mark","A grammar rule for verbs","Special vocabulary used by people in a particular field or group"], answer:3},
     {q:"Who might use medical jargon?", options:["Only fictional characters","No one uses jargon","Doctors and nurses","Only young children"], answer:2},
     {q:"Why might jargon be confusing to general readers?", options:["It always uses the simplest words possible","It uses specialized terms unfamiliar outside that field","Jargon is identical in every field","Jargon never appears in real language"], answer:1},
     {q:"What should a writer do when using jargon for a general audience?", options:["Avoid all vocabulary completely","Use only jargon with no explanation","Explain or define the specialized terms","Assume everyone already knows it"], answer:2},
     {q:"Which is an example of sports jargon?", options:["A term like slam dunk used among basketball players","A punctuation mark","A common word like table","A silent letter"], answer:0}
   ]},
  {subject:"Math", title:"Data Management: Interpreting Stacked Bar Graphs", summary:"Grade 4 Math strand: a stacked bar graph shows multiple categories within a single bar, with each section representing a different part of the total for that bar.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does a stacked bar graph show within a single bar?", options:["Nothing measurable","Multiple categories stacked to show parts of a total","Only one category with no divisions","A single number with no comparison"], answer:1},
     {q:"How can you find the total value represented by a stacked bar?", options:["Add up all the sections stacked within that bar","Only look at the top section","Multiply the number of sections","Subtract each section from the others"], answer:0},
     {q:"Why might a stacked bar graph be useful for comparing data?", options:["It hides all the data","It shows both individual parts and the overall total at once","It cannot be used to compare anything","It only shows a single value with no detail"], answer:1},
     {q:"What might different colours within a stacked bar represent?", options:["Only decoration","Nothing at all","The title of the graph","Different categories or subgroups of data"], answer:3},
     {q:"If one bar shows red for 3 units and blue for 2 units stacked together, what is the total height of that bar?", options:["3 units","2 units","6 units","5 units"], answer:3}
   ]},
  {subject:"Science", title:"Science: Magnetic Fields and Compasses", summary:"Grade 4 Science strand: a magnet creates an invisible magnetic field around it, and a compass uses a small magnetized needle that aligns with Earths magnetic field to point toward magnetic north.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is a magnetic field?", options:["An invisible area of force surrounding a magnet","A type of electrical current","A type of sound wave","A visible line drawn around a magnet"], answer:0},
     {q:"What does a compass needle align with?", options:["Earths magnetic field","The nearest light source","The direction of the wind","The temperature of the air"], answer:0},
     {q:"Which direction does a compass needle typically point?", options:["Toward the ground","Toward magnetic north","In a random direction each time","Toward the nearest building"], answer:1},
     {q:"Why is a compass a useful navigation tool?", options:["It helps travellers determine direction using Earths magnetic field","It only works underwater","It has no practical use for navigation","It measures temperature instead of direction"], answer:0},
     {q:"What happens to a compass needle near a strong magnet?", options:["It has no reaction at all","It always points south instead","It can be pulled away from pointing to magnetic north","It stops working permanently"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of the Supreme Court of Canada", summary:"Grade 4 Social Studies strand: the Supreme Court of Canada is the highest court in the country, making final decisions on important legal cases and ensuring laws follow the Canadian Constitution.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the Supreme Court of Canada?", options:["A private business court","A local municipal office","A branch of the police force","The highest court in the country"], answer:3},
     {q:"What kind of decisions does the Supreme Court of Canada make?", options:["Decisions about sports team rules","Final decisions on important legal cases","Decisions about school lunch menus","Decisions about weather forecasts"], answer:1},
     {q:"What document must Canadian laws align with, according to the Supreme Court?", options:["A local city bylaw only","A foreign countrys constitution","The Canadian Constitution","A private companys rules"], answer:2},
     {q:"Why is having a highest court important for a country?", options:["It only handles minor disputes","It replaces the need for any other courts","It provides a final, consistent decision on major legal questions","It has no real purpose in government"], answer:2},
     {q:"Who might bring a case to the Supreme Court of Canada?", options:["Only young children","Only foreign governments","People or groups involved in significant legal disputes","No one is allowed to bring cases"], answer:2}
   ]},
]},
{day:145, label:"Day 145 — Fri", subjects:[
  {subject:"Language", title:"Reading: Comparing Two Texts on the Same Topic", summary:"Grade 4 Language strand: comparing two texts on the same topic involves identifying similarities and differences in the information, perspective, or purpose each author presents.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What does comparing two texts on the same topic involve?", options:["Identifying similarities and differences between the texts","Ignoring the topic entirely","Copying one text exactly","Reading only one of the texts"], answer:0},
     {q:"Why might two texts about the same topic present different information?", options:["Topics never have more than one source","Texts about the same topic are not allowed to differ","Authors can have different purposes, perspectives, or sources","All texts on a topic are always identical"], answer:2},
     {q:"What is one way authors perspectives might differ on the same topic?", options:["All authors always agree completely","Perspective has no effect on writing","Only fictional texts can differ","One author might focus on benefits while another focuses on risks"], answer:3},
     {q:"Why is it useful to read multiple texts about the same topic?", options:["It always causes more confusion","It gives a fuller and more balanced understanding","One text is always enough","Comparing texts is never useful"], answer:1},
     {q:"What might readers look for when comparing texts?", options:["Only the font used","Only the length of each text","Only the page numbers","Facts, opinions, and evidence presented differently"], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Rounding to the Nearest Ten Thousand", summary:"Grade 4 Math strand: to round a number to the nearest ten thousand, students look at the thousands digit to decide whether to round up or keep the ten thousands digit the same.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What digit do you check when rounding to the nearest ten thousand?", options:["The tenths digit","The hundred thousands digit","The ones digit","The thousands digit"], answer:3},
     {q:"What is 43,700 rounded to the nearest ten thousand?", options:["44,000","40,000","43,000","50,000"], answer:1},
     {q:"What is 76,200 rounded to the nearest ten thousand?", options:["77,000","80,000","70,000","76,000"], answer:1},
     {q:"If the thousands digit is 5 or greater, what should you do when rounding to the nearest ten thousand?", options:["Ignore the digit completely","Round down to zero","Keep the ten thousands digit the same","Round the ten thousands digit up by one"], answer:3},
     {q:"Why might someone round a large number to the nearest ten thousand?", options:["Rounding removes the need for all math","To make the number easier to work with or estimate","Rounding only works with small numbers","To make the number less accurate for no reason"], answer:1}
   ]},
  {subject:"Science", title:"Science: The Life Cycle of a Frog — Amphibian Metamorphosis", summary:"Grade 4 Science strand: a frog undergoes complete metamorphosis, changing from an egg to a tadpole living in water, then developing legs and lungs to become an adult frog that can live on land and in water.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the first stage of a frogs life cycle?", options:["Froglet","Adult frog","Egg","Tadpole"], answer:2},
     {q:"Where do tadpoles typically live and breathe?", options:["Underground, using no breathing organs","In trees, using skin only","On dry land, using lungs","In water, using gills"], answer:3},
     {q:"What major changes happen as a tadpole becomes a frog?", options:["It loses all its organs","It stops growing entirely","It grows legs and develops lungs for breathing air","It turns into a completely different animal species"], answer:2},
     {q:"What term describes the frogs dramatic change in body form?", options:["Hibernation","Metamorphosis","Migration","Photosynthesis"], answer:1},
     {q:"Where can adult frogs typically live?", options:["Only high in the mountains","Both in water and on land","Only deep underground","Only in the desert"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Ancient Israel and the Fertile Crescent", summary:"Grade 4 Social Studies strand: ancient Israel developed within the Fertile Crescent, a region with rich soil and access to water that supported early farming, trade, and the growth of significant historical societies.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the Fertile Crescent known for?", options:["Being a completely dry desert with no water","Being located entirely underwater","Having no history of early civilizations","Rich soil and water access that supported early farming"], answer:3},
     {q:"Why did early societies often settle near rivers in the Fertile Crescent?", options:["Rivers had no value to ancient peoples","Early societies avoided rivers completely","Rivers made travel and farming impossible","Rivers provided water for farming and daily life"], answer:3},
     {q:"What activity was strongly supported by the fertile land in this region?", options:["Mountain climbing","Farming","Deep sea fishing only","Ice fishing"], answer:1},
     {q:"What is ancient Israel an example of in this region?", options:["A society with no connection to farming","A significant historical society that developed in the Fertile Crescent","A civilization located in Antarctica","A modern country with no ancient history"], answer:1},
     {q:"Why do historians study the Fertile Crescent today?", options:["It helps explain the origins of early farming and civilization","It was never inhabited by ancient peoples","It is important only for its modern buildings","It has no historical significance"], answer:0}
   ]},
]},
{day:146, label:"Day 146 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Understanding Verb Moods — Indicative, Imperative, and Interrogative", summary:"Grade 4 Language strand: verb mood shows the purpose of a sentence, with the indicative mood stating facts, the imperative mood giving commands, and the interrogative mood asking questions.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What does the indicative mood do?", options:["Expresses a wish","Gives a command","States a fact or opinion","Asks a question"], answer:2},
     {q:"What does the imperative mood do?", options:["Asks a question","Describes a feeling only","Gives a command or request","States a fact"], answer:2},
     {q:"Which sentence is in the interrogative mood?", options:["Close the door.","The sky is blue.","Did you finish your homework?","Please sit down."], answer:2},
     {q:"Which sentence is in the imperative mood?", options:["The window is open.","Is the window open?","The window was closed yesterday.","Please close the window."], answer:3},
     {q:"Why is it useful to recognize verb mood?", options:["Verb mood has no real use","It helps understand the purpose of a sentence","It only matters in poetry","It replaces the need for punctuation"], answer:1}
   ]},
  {subject:"Math", title:"Financial Literacy: Calculating Change with Multiple Bills and Coins", summary:"Grade 4 Math strand: calculating change involves subtracting the cost of an item from the amount paid, then determining which combination of bills and coins makes up that amount.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"How do you calculate the change owed after a purchase?", options:["Subtract the cost of the item from the amount paid","Multiply the cost by the amount paid","Divide the amount paid by the cost","Add the cost of the item to the amount paid"], answer:0},
     {q:"If an item costs 6 dollars and 25 cents and you pay with a 10 dollar bill, how much change should you receive?", options:["3 dollars and 25 cents","4 dollars and 25 cents","3 dollars and 75 cents","4 dollars and 75 cents"], answer:2},
     {q:"Why might a cashier give change using the fewest bills and coins possible?", options:["Fewer bills and coins is against store rules","It has no effect on the transaction","It always uses more coins than necessary","It is a simpler and more efficient way to make change"], answer:3},
     {q:"Which combination of coins equals exactly 2 dollars?", options:["Three quarters","Two 1 dollar coins","Five dimes","One 1 dollar coin and one quarter"], answer:1},
     {q:"Why is it useful to practice calculating change?", options:["Change is never given in stores","It has no real-life application","Calculating change is only used in math class","It helps ensure you receive the correct amount of money back"], answer:3}
   ]},
  {subject:"Science", title:"Science: Static Electricity and Lightning", summary:"Grade 4 Science strand: static electricity builds up when electric charges collect on the surface of an object, and lightning is a dramatic natural example of static electricity discharging between clouds or between a cloud and the ground.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is static electricity?", options:["A type of sound wave","A buildup of electric charge on the surface of an object","A steady flow of electricity through a wire","A type of magnetic field"], answer:1},
     {q:"What natural event is a large-scale example of static electricity discharging?", options:["Wind","Lightning","Fog","Rainfall"], answer:1},
     {q:"What can cause static electricity to build up between two objects?", options:["Rubbing two objects together","Placing objects in water","Heating an object slowly","Freezing an object"], answer:0},
     {q:"Why might your hair stand up after rubbing a balloon on it?", options:["Static charge causes strands of hair to repel each other","Rubbing an object has no electrical effect","Hair always stands up in cold weather","The balloon removes all electricity from your hair"], answer:0},
     {q:"Why is it dangerous to be outside during a lightning storm?", options:["Lightning carries a powerful electric discharge that can strike people","Lightning never travels toward the ground","Lightning only strikes underwater","Lightning has no real danger"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Royal Canadian Mint and How Coins Are Made", summary:"Grade 4 Social Studies strand: the Royal Canadian Mint is the government organization responsible for designing and producing Canadas coins, using metal, precise measurements, and detailed designs.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is the Royal Canadian Mint responsible for?", options:["Printing paper money only","Running Canadas schools","Managing Canadas highways","Designing and producing Canadas coins"], answer:3},
     {q:"What material is commonly used to produce coins?", options:["Metal","Glass","Paper","Wood"], answer:0},
     {q:"Why must coins be made with precise measurements?", options:["So they are consistent in size, weight, and value","Precision has no importance for coins","Every coin is meant to be a different size","Coins are never measured during production"], answer:0},
     {q:"What might appear on the design of a Canadian coin?", options:["Foreign national symbols only","Random unrelated images with no meaning","Nothing at all","Important symbols or figures representing Canada"], answer:3},
     {q:"Why is it useful to learn how coins are made?", options:["Coins appear naturally with no production process","It helps us understand the process behind everyday currency","Learning about currency has no value","Coins are not used in Canada"], answer:1}
   ]},
]},
{day:147, label:"Day 147 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing a Persuasive Advertisement Script", summary:"Grade 4 Language strand: a persuasive advertisement script uses catchy language, strong reasons, and a clear call to action to convince an audience to buy a product or support an idea.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is the goal of a persuasive advertisement script?", options:["To share a private diary entry","To describe a historical event only","To list random facts with no purpose","To convince an audience to buy a product or support an idea"], answer:3},
     {q:"What is a call to action in an advertisement?", options:["A clear statement telling the audience what to do next","A type of punctuation mark","A random unrelated sentence","The title of the product only"], answer:0},
     {q:"Why might an advertisement use catchy language?", options:["To grab attention and make the message memorable","To confuse the audience on purpose","To make the ad longer with no purpose","Catchy language has no effect on advertising"], answer:0},
     {q:"What might a persuasive advertisement include to support its claims?", options:["Unrelated jokes only","Strong reasons or benefits of the product","Only random numbers","No reasons at all"], answer:1},
     {q:"Where might an advertisement script be performed?", options:["Only in a private notebook","Nowhere at all","On television, radio, or in a video","Only inside a math class"], answer:2}
   ]},
  {subject:"Math", title:"Geometry: Finding Missing Angles in a Triangle", summary:"Grade 4 Math strand: the three interior angles of a triangle always add up to 180 degrees, so a missing angle can be found by subtracting the sum of the two known angles from 180.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What do the three interior angles of a triangle always add up to?", options:["90 degrees","270 degrees","180 degrees","360 degrees"], answer:2},
     {q:"If two angles in a triangle are 50 degrees and 60 degrees, what is the third angle?", options:["70 degrees","110 degrees","80 degrees","60 degrees"], answer:0},
     {q:"If two angles in a triangle are both 45 degrees, what is the third angle?", options:["90 degrees","60 degrees","180 degrees","45 degrees"], answer:0},
     {q:"How do you find a missing angle when you know the other two angles of a triangle?", options:["Multiply the two known angles","Subtract the sum of the two known angles from 180 degrees","Add the two known angles together for the answer","Divide 180 by the two known angles"], answer:1},
     {q:"What is the missing angle if a triangle has angles of 90 degrees and 30 degrees?", options:["90 degrees","30 degrees","120 degrees","60 degrees"], answer:3}
   ]},
  {subject:"Science", title:"Science: Space — An Introduction to Galaxies and the Milky Way", summary:"Grade 4 Science strand: a galaxy is a massive collection of stars, planets, gas, and dust held together by gravity, and our solar system is located within a galaxy called the Milky Way.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is a galaxy?", options:["A type of moon","A single star with no planets","A small cloud found only on Earth","A massive collection of stars, planets, gas, and dust held together by gravity"], answer:3},
     {q:"What is the name of the galaxy that contains our solar system?", options:["The Orion Galaxy","The Solar Galaxy","The Milky Way","The Andromeda Galaxy"], answer:2},
     {q:"What force holds a galaxy together?", options:["Wind","Magnetism only","Gravity","Heat alone"], answer:2},
     {q:"What might a galaxy contain besides stars?", options:["Only empty space with nothing else","Planets, gas, and dust","Only water","Only oxygen"], answer:1},
     {q:"Why can we see a band of light in the night sky called the Milky Way?", options:["It is an illusion with no real explanation","It is caused by clouds on Earth","We are viewing part of our own galaxy from within it","It is a reflection from the Moon"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Canadian Armed Forces — Serving at Home and Abroad", summary:"Grade 4 Social Studies strand: the Canadian Armed Forces protect Canada and its citizens, respond to emergencies at home, and take part in international missions such as peacekeeping alongside other countries.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is a key responsibility of the Canadian Armed Forces?", options:["Running provincial elections","Protecting Canada and its citizens","Building highways only","Managing local libraries"], answer:1},
     {q:"What might the Canadian Armed Forces do during a natural disaster at home?", options:["Ignore the emergency completely","Help respond to emergencies and assist affected communities","Cancel all emergency services","Only respond to disasters in other countries"], answer:1},
     {q:"What international role do Canadian Armed Forces members sometimes take part in?", options:["Coaching sports teams abroad","Running foreign businesses","Peacekeeping missions","Teaching foreign languages only"], answer:2},
     {q:"Why might Canada take part in international peacekeeping missions?", options:["To help maintain peace and stability alongside other countries","To avoid working with other countries","Peacekeeping has no connection to the military","Canada never takes part in international missions"], answer:0},
     {q:"Why is the Canadian Armed Forces an important part of Canadian society?", options:["It helps protect citizens and supports missions both at home and abroad","It focuses solely on foreign trade","It has no connection to protecting Canadians","It only exists during wartime"], answer:0}
   ]},
]},
{day:148, label:"Day 148 — Wed", subjects:[
  {subject:"Language", title:"Reading: Identifying Bias in Historical Accounts", summary:"Grade 4 Language strand: bias in a historical account occurs when a writer presents information in a way that favours one perspective, often leaving out other viewpoints or important facts.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is bias in a historical account?", options:["Presenting every perspective completely equally","A summary with no opinions at all","A type of punctuation mark","Presenting information in a way that favours one perspective"], answer:3},
     {q:"Why might a biased historical account leave out certain facts?", options:["Bias never affects which facts are included","All historical accounts are automatically unbiased","To support one particular viewpoint over others","To always present a fully balanced view"], answer:2},
     {q:"How can readers identify possible bias in a text?", options:["By ignoring the source of the text","By trusting every single text completely","By checking whether other viewpoints or facts are missing","Bias cannot ever be identified"], answer:2},
     {q:"Why is it useful to compare multiple historical sources?", options:["Multiple sources always say the exact same thing","Comparing sources is never useful","One source is always enough","It helps reveal different perspectives and possible bias"], answer:3},
     {q:"What might indicate a source has strong bias?", options:["Including dates and verified facts","Citing multiple credible sources","Presenting balanced evidence from multiple sides","Only describing one groups viewpoint as entirely correct"], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Comparing Fractions Decimals and Percents", summary:"Grade 4 Math strand: fractions, decimals, and percents are different ways of representing the same value, and converting between them helps students compare and order numbers.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What do fractions, decimals, and percents all represent?", options:["Only negative numbers","Completely unrelated concepts","Only whole numbers","Different ways of showing the same value"], answer:3},
     {q:"What is 1/2 written as a decimal?", options:["0.5","0.2","1.5","0.25"], answer:0},
     {q:"What is 0.5 written as a percent?", options:["0.5%","500%","50%","5%"], answer:2},
     {q:"Which is greater, 1/4 or 0.4?", options:["1/4","0.4","They are equal","They cannot be compared"], answer:1},
     {q:"Why is it useful to convert between fractions, decimals, and percents?", options:["Fractions and decimals can never be compared","It makes it easier to compare and order different values","Conversion is never useful in math","Percents cannot represent fractions"], answer:1}
   ]},
  {subject:"Science", title:"Science: Nocturnal Animals and Their Adaptations", summary:"Grade 4 Science strand: nocturnal animals are active mainly at night and have special adaptations, such as large eyes, strong hearing, or a keen sense of smell, that help them survive in the dark.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What does it mean for an animal to be nocturnal?", options:["It never sleeps at all","It lives only underwater","It is mainly active during the day","It is mainly active at night"], answer:3},
     {q:"What adaptation helps many nocturnal animals see in low light?", options:["Extremely small eyes","Large eyes that gather more light","No eyes at all","Bright colouring"], answer:1},
     {q:"Which of these is an example of a nocturnal animal?", options:["A squirrel","An owl","A butterfly","A robin"], answer:1},
     {q:"Why might being active at night help some animals avoid predators?", options:["Darkness has no effect on predator activity","Nighttime has no predators anywhere","Fewer daytime predators are hunting during the night","Predators are more active exclusively at night"], answer:2},
     {q:"Besides eyesight, what other sense might help nocturnal animals navigate in the dark?", options:["Only their sense of sight","A sense of taste only","No senses are needed at night","A strong sense of hearing or smell"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Public Libraries and Their Role in Canadian Communities", summary:"Grade 4 Social Studies strand: public libraries are community institutions that provide free access to books, information, and programs, supporting learning and connection for people of all ages.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What do public libraries provide free access to?", options:["Books, information, and community programs","Nothing of value","Only private business services","Only expensive rare items"], answer:0},
     {q:"Who can typically use a public library?", options:["People of all ages in the community","Only government officials","Only students in university","Only wealthy citizens"], answer:0},
     {q:"What is one benefit public libraries offer to a community?", options:["Restricting access to information","Charging high fees for every book","Providing no community services","Supporting learning and access to information for everyone"], answer:3},
     {q:"What kind of programs might a public library offer besides lending books?", options:["Reading clubs and educational workshops","No programs at all","Only paid entertainment events","Only private business meetings"], answer:0},
     {q:"Why are public libraries considered an important public institution?", options:["They serve no real purpose in society","They only benefit one small group of people","They charge for every service they offer","They provide equal access to knowledge and resources for the community"], answer:3}
   ]},
]},
{day:149, label:"Day 149 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Understanding Euphemisms", summary:"Grade 4 Language strand: a euphemism is a mild or indirect word or phrase used in place of one that might be considered harsh, unpleasant, or too direct.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a euphemism?", options:["A word that means the exact same as its opposite","A grammar rule for verbs","A mild or indirect word used in place of a harsher one","A type of punctuation mark"], answer:2},
     {q:"Why might a writer use a euphemism?", options:["To soften language about a sensitive or unpleasant topic","To make language more harsh and direct","To confuse the reader on purpose","Euphemisms are never used in writing"], answer:0},
     {q:"Which is an example of a euphemism for passed away?", options:["Died suddenly","Stopped breathing forever","Was killed instantly","Passed on"], answer:3},
     {q:"What might using a euphemism accomplish in conversation?", options:["Removing all meaning from a sentence","Confusing the listener with random words","Making a topic feel more harsh","Making a difficult topic feel gentler to discuss"], answer:3},
     {q:"In which situation might someone use a euphemism?", options:["When discussing a sensitive topic politely","When writing a shopping list","When labelling a diagram","When stating a simple math fact"], answer:0}
   ]},
  {subject:"Math", title:"Measurement: Perimeter of Composite Shapes", summary:"Grade 4 Math strand: the perimeter of a composite shape, made up of two or more simple shapes joined together, is found by adding the lengths of all the outer sides.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a composite shape?", options:["A shape that has no area","A shape with only one side","A shape made up of two or more simple shapes joined together","A shape found only in circles"], answer:2},
     {q:"How do you find the perimeter of a composite shape?", options:["Multiply the length by the width only","Add only two of the sides","Add the lengths of all the outer sides","Find the area instead of the perimeter"], answer:2},
     {q:"If a composite shape has outer sides of 4, 3, 4, 2, 2, and 1 units, what is its perimeter?", options:["16 units","12 units","14 units","18 units"], answer:0},
     {q:"Why might you need to find a missing side length before calculating perimeter?", options:["Perimeter never requires knowing every side","Missing sides do not affect perimeter","Some outer side lengths might not be labelled directly on the shape","All side lengths are always labelled"], answer:2},
     {q:"What is the difference between area and perimeter?", options:["Perimeter measures the distance around a shape while area measures the space inside it","They both measure the exact same thing","Perimeter measures the space inside a shape","Area measures only around a shape"], answer:0}
   ]},
  {subject:"Science", title:"Science: Weather — Air Pressure and Wind", summary:"Grade 4 Science strand: differences in air pressure between areas cause wind, as air moves from areas of higher pressure to areas of lower pressure, and this movement plays a major role in weather patterns.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What causes wind to form?", options:["Air moving from areas of higher pressure to lower pressure","Water evaporating instantly","The Moon pulling air directly","Air staying perfectly still at all times"], answer:0},
     {q:"What is air pressure?", options:["The weight of air pressing down on the Earths surface","The colour of the sky","The temperature of the air only","The speed of falling rain"], answer:0},
     {q:"What tool is commonly used to measure air pressure?", options:["A compass","A rain gauge","A thermometer","A barometer"], answer:3},
     {q:"How are wind and air pressure related to weather patterns?", options:["They have no connection to weather at all","Wind only occurs in outer space","Changes in air pressure and wind often signal changing weather","Air pressure never changes on Earth"], answer:2},
     {q:"What generally happens to air as it moves from high pressure to low pressure areas?", options:["It stops moving immediately","It creates wind as it flows toward the lower pressure area","It always creates snow","It disappears completely"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: World Heritage Sites in Canada", summary:"Grade 4 Social Studies strand: World Heritage Sites are locations recognized by UNESCO for their cultural or natural significance, and Canada is home to several such sites, including national parks and historic landmarks.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What organization designates World Heritage Sites?", options:["The World Trade Organization","UNESCO","The Canadian Senate","The United Nations Security Council"], answer:1},
     {q:"Why are World Heritage Sites recognized?", options:["For being the newest buildings in a country","For their outstanding cultural or natural significance","For being entirely man-made shopping centres","For having no significance at all"], answer:1},
     {q:"What type of location in Canada might be designated a World Heritage Site?", options:["A random empty field","A private shopping mall","A national park or historic landmark","A brand new parking lot"], answer:2},
     {q:"Why is it valuable for a country to have World Heritage Sites?", options:["It has no value to a country","It means the site must be destroyed","It highlights important natural or cultural treasures worth protecting","It only benefits foreign visitors"], answer:2},
     {q:"What might visitors learn from exploring a World Heritage Site?", options:["Nothing of educational value","Only about modern technology","About important natural or cultural history","Only about unrelated topics"], answer:2}
   ]},
]},
{day:150, label:"Day 150 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Sentence Craft, Character, and Media Texts", summary:"Grade 4 Language strand review: students revisit parallel structure, character foils, public service announcements, jargon, and comparing texts on the same topic.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is parallel structure in a sentence?", options:["A title and a subtitle","Using the same grammatical pattern for items in a series","Using a different verb tense for each item","Two unrelated topics"], answer:1},
     {q:"What is a character foil?", options:["A type of punctuation mark","A character who looks exactly like the main character","A character who never appears in the story","A character whose traits contrast with another character to highlight qualities"], answer:3},
     {q:"What is the purpose of a public service announcement?", options:["To sell a specific brand of toy","To inform the public about an issue and encourage action","To share a private diary entry","To tell a made-up bedtime story"], answer:1},
     {q:"What is jargon?", options:["A type of punctuation mark","A word with no meaning at all","Special vocabulary used by people in a particular field or group","A grammar rule for verbs"], answer:2},
     {q:"What does comparing two texts on the same topic involve?", options:["Reading only one of the texts","Ignoring the topic entirely","Copying one text exactly","Identifying similarities and differences between the texts"], answer:3}
   ]},
  {subject:"Math", title:"Math Review: Operations, Measurement, and Data", summary:"Grade 4 Math strand review: students revisit dividing a fraction by a whole number, volume of triangular prisms, integers, stacked bar graphs, and rounding to the nearest ten thousand.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What happens to the denominator when dividing a fraction by a whole number?", options:["The denominator is divided by the whole number","The denominator is multiplied by the whole number","The denominator stays exactly the same","The numerator disappears"], answer:1},
     {q:"What shape is the base of a triangular prism?", options:["A square","A circle","A triangle","A pentagon"], answer:2},
     {q:"What are integers?", options:["Positive numbers, negative numbers, and zero","Only positive numbers","Only decimals","Only fractions"], answer:0},
     {q:"What does a stacked bar graph show within a single bar?", options:["A single number with no comparison","Only one category with no divisions","Multiple categories stacked to show parts of a total","Nothing measurable"], answer:2},
     {q:"What digit do you check when rounding to the nearest ten thousand?", options:["The thousands digit","The tenths digit","The hundred thousands digit","The ones digit"], answer:0}
   ]},
  {subject:"Science", title:"Science Review: Life Science, Earth and Space, and Physical Science", summary:"Grade 4 Science strand review: students revisit photosynthesis, vertebrates and invertebrates, plant parts, magnetic fields, and the life cycle of a frog.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is photosynthesis?", options:["The process by which plants make their own food using sunlight","A process where plants produce no oxygen","A process that only happens at night","A process where plants absorb food from soil only"], answer:0},
     {q:"What is a vertebrate?", options:["A type of rock","An animal that has no backbone","A type of plant","An animal that has a backbone"], answer:3},
     {q:"What is the main job of a plants roots?", options:["Absorbing water and nutrients from the soil","Capturing sunlight for energy","Producing seeds","Releasing pollen only"], answer:0},
     {q:"What is a magnetic field?", options:["A type of sound wave","A visible line drawn around a magnet","A type of electrical current","An invisible area of force surrounding a magnet"], answer:3},
     {q:"What is the first stage of a frogs life cycle?", options:["Adult frog","Egg","Tadpole","Froglet"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Canadian History, Government, and World Geography", summary:"Grade 4 Social Studies strand review: students revisit the Hudson Bay Company, taxes, Canadas national symbols, the Supreme Court of Canada, and the Fertile Crescent.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What kind of company was the Hudson Bay Company?", options:["An airline company","A major fur trading company","A film production company","A modern technology company"], answer:1},
     {q:"What are taxes?", options:["A type of currency used only in stores","Money collected by governments to fund public services","Money given only to private businesses","A voluntary gift with no purpose"], answer:1},
     {q:"Which animal is a well-known national symbol of Canada?", options:["The kangaroo","The eagle","The beaver","The lion"], answer:2},
     {q:"What is the Supreme Court of Canada?", options:["The highest court in the country","A private business court","A local municipal office","A branch of the police force"], answer:0},
...
{day:161, label:"Day 161 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Interrogative Pronouns — Who, Whom, Whose, Which, and What", summary:"Grade 4 Language strand: interrogative pronouns, including who, whom, whose, which, and what, are used to ask questions and stand in for the noun being asked about.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which interrogative pronoun asks about a person acting as the subject?", options:["Whom","Whose","Who","Which"], answer:2},
     {q:"Which interrogative pronoun asks about a person as the object of a verb or preposition?", options:["What","Whom","Who","Which"], answer:1},
     {q:"Which interrogative pronoun asks about ownership?", options:["Who","Which","Whose","What"], answer:2},
     {q:"Which interrogative pronoun asks someone to choose among specific options?", options:["Which","Whose","What","Who"], answer:0},
     {q:"Why do writers use interrogative pronouns?", options:["To ask questions and identify unknown information","To state a fact with certainty","To give a command","To join two independent sentences"], answer:0}
   ]},
  {subject:"Math", title:"Geometry: Points, Lines, Line Segments, and Rays", summary:"Grade 4 Math strand: a point marks an exact location in space, a line extends infinitely in both directions, a line segment has two fixed endpoints, and a ray starts at one point and extends infinitely in a single direction.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a point in geometry?", options:["A line that never ends","A shape with four sides","An exact location in space with no size","A measurement of an angle"], answer:2},
     {q:"How far does a line extend?", options:["Only between two endpoints","Only in one direction","It does not extend at all","Infinitely in both directions"], answer:3},
     {q:"What makes a line segment different from a line?", options:["A line segment has no length","A line segment has two fixed endpoints","A line segment is always curved","A line segment extends forever"], answer:1},
     {q:"What is a ray?", options:["A shape with three sides","A line with two endpoints","A single point with no direction","A part of a line that starts at one point and extends infinitely in one direction"], answer:3},
     {q:"Why do mathematicians distinguish between lines, line segments, and rays?", options:["Distinguishing between them has no mathematical use","Each has a different length and direction that affects how it is used","They are all exactly identical","Only rays are ever used in geometry"], answer:1}
   ]},
  {subject:"Science", title:"Science: Introduction to Cells — The Basic Building Blocks of Living Things", summary:"Grade 4 Science strand: all living things are made up of cells, the basic units of life, and cells can be so small that a microscope is needed to see them clearly.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What are cells?", options:["A type of rock","A type of weather pattern","A form of energy","The basic building blocks of living things"], answer:3},
     {q:"What tool is often needed to see individual cells?", options:["A thermometer","A telescope","A compass","A microscope"], answer:3},
     {q:"Do all living things have cells?", options:["Only humans have cells","Yes, all living things are made of one or more cells","No, only animals have cells","No, only plants have cells"], answer:1},
     {q:"What might a single-celled organism have compared to a human?", options:["No connection to being a living thing","Just one cell instead of trillions of cells","No cells at all","The exact same number of cells as a human"], answer:1},
     {q:"Why do scientists study cells?", options:["To understand how living things grow, function, and stay alive","Cells have no connection to how living things work","Studying cells has no scientific value","Cells are not related to life at all"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Mongol Empire — Conquest and Trade Across Asia", summary:"Grade 4 Social Studies strand: the Mongol Empire, led by Genghis Khan, became one of the largest empires in history, connecting distant regions of Asia and Europe through conquest and extensive trade routes.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Who founded the Mongol Empire?", options:["Julius Caesar","Alexander the Great","Hammurabi","Genghis Khan"], answer:3},
     {q:"What made the Mongol Empire notable in size?", options:["It became one of the largest empires in history","It only existed for a single day","It had no connection to trade","It never expanded beyond one small village"], answer:0},
     {q:"How did the Mongol Empire affect trade between distant regions?", options:["It only allowed trade within one city","It had no effect on trade at all","It completely blocked all trade","It helped connect trade routes across Asia and Europe"], answer:3},
     {q:"What skill were Mongol warriors especially known for?", options:["Building pyramids","Deep sea navigation","Farming rice paddies","Skilled horseback riding and archery"], answer:3},
     {q:"Why do historians still study the Mongol Empire today?", options:["It only affected a small unimportant area","It never interacted with other civilizations","It reshaped trade, culture, and borders across a huge part of the world","It has no historical importance"], answer:2}
   ]},
]},
{day:162, label:"Day 162 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Reflexive Pronouns", summary:"Grade 4 Language strand: reflexive pronouns, such as myself, yourself, himself, herself, itself, ourselves, yourselves, and themselves, are used when the subject and object of a sentence refer to the same person or thing.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a reflexive pronoun?", options:["A pronoun used when the subject and object of a sentence are the same","A word that joins two sentences","A type of punctuation mark","A pronoun that only names an object"], answer:0},
     {q:"Which reflexive pronoun matches the subject I?", options:["Yourself","Themselves","Myself","Himself"], answer:2},
     {q:"Which sentence correctly uses a reflexive pronoun?", options:["She hurt their while running.","She hurt hers while running.","She hurt she while running.","She hurt herself while running."], answer:3},
     {q:"Which reflexive pronoun matches the subject they?", options:["Itself","Myself","Himself","Themselves"], answer:3},
     {q:"Why are reflexive pronouns useful in writing?", options:["They are never used in complete sentences","They remove the need for a verb","They always change the subject of a sentence","They show the subject and object of a sentence are the same person or thing"], answer:3}
   ]},
  {subject:"Math", title:"Number Sense: Multiplying a 3-Digit Number by a 2-Digit Number", summary:"Grade 4 Math strand: multiplying a 3-digit number by a 2-digit number involves breaking the 2-digit number into tens and ones, multiplying each part separately, and adding the partial products together.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a common first step to multiply a 3-digit number by a 2-digit number?", options:["Add the two numbers together","Round both numbers to zero","Break the 2-digit number into tens and ones","Divide the numbers first"], answer:2},
     {q:"What is 213 multiplied by 12?", options:["2,356","2,600","2,486","2,556"], answer:3},
     {q:"What is 145 multiplied by 21?", options:["3,145","2,945","3,245","3,045"], answer:3},
     {q:"After multiplying by the tens digit and the ones digit separately, what should you do next?", options:["Divide both products by 10","Add the two partial products together","Subtract the smaller product from the larger one","Multiply the two partial products together"], answer:1},
     {q:"Why is breaking numbers into tens and ones helpful when multiplying larger numbers?", options:["It only works with 1-digit numbers","It removes the need for any calculation","It makes the multiplication easier to manage in smaller steps","It always produces an incorrect answer"], answer:2}
   ]},
  {subject:"Science", title:"Science: Elements, Compounds, and Mixtures — Classifying Matter", summary:"Grade 4 Science strand: matter can be classified as an element, a pure substance made of only one type of atom, a compound, made of two or more elements chemically joined, or a mixture, made of substances that are combined but not chemically joined.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is an element?", options:["A type of rock only","A mixture of many substances","A liquid that cannot be separated","A pure substance made of only one type of atom"], answer:3},
     {q:"What is a compound?", options:["A single element with no other substances","Two or more elements chemically joined together","A form of energy","A type of light wave"], answer:1},
     {q:"What is a mixture?", options:["A type of rock","A compound with exactly two elements","A substance made of only one type of atom","A combination of substances that are not chemically joined"], answer:3},
     {q:"Which of these is an example of a mixture?", options:["Pure carbon","A salad with many separate ingredients","A single gold atom","Pure oxygen gas"], answer:1},
     {q:"Why is it useful to classify matter as elements, compounds, or mixtures?", options:["It helps scientists understand what a substance is made of and how it behaves","Matter cannot be classified in any way","Classifying matter has no scientific value","All matter is exactly identical"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Bay of Fundy — Home to the Worlds Highest Tides", summary:"Grade 4 Social Studies strand: the Bay of Fundy, located between Nova Scotia and New Brunswick, is famous for having the highest tides in the world, caused by the unique shape of the bay funnelling huge volumes of water.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"In which two provinces is the Bay of Fundy located?", options:["Manitoba and Saskatchewan","Nova Scotia and New Brunswick","British Columbia and Alberta","Ontario and Quebec"], answer:1},
     {q:"What is the Bay of Fundy famous for?", options:["Having no tides at all","Being the largest lake in Canada","Having the highest tides in the world","Being located in the Arctic"], answer:2},
     {q:"What causes the Bay of Fundy to have such extreme tides?", options:["The bay never experiences changing water levels","The unique shape of the bay funnels large volumes of water","The tides are caused by wind alone","The bay has no connection to the ocean"], answer:1},
     {q:"How much can water levels change during a tide cycle in the Bay of Fundy?", options:["By less than one centimetre","Only during the winter season","By many metres between high and low tide","Water levels never change there"], answer:2},
     {q:"Why might scientists and tourists be interested in the Bay of Fundy?", options:["It has no scientific or tourism value","It is identical to every other bay in Canada","Its dramatic tides make it a unique natural and scientific attraction","It is located far from any coastline"], answer:2}
   ]},
]},
{day:163, label:"Day 163 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Possessive Pronouns", summary:"Grade 4 Language strand: possessive pronouns, such as mine, yours, his, hers, its, ours, and theirs, show ownership and replace a noun instead of coming before one.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What do possessive pronouns show?", options:["A question being asked","A location in a sentence","Ownership of something","An action taking place"], answer:2},
     {q:"Which is an example of a possessive pronoun?", options:["These","Them","Theirs","They"], answer:2},
     {q:"Which sentence correctly uses a possessive pronoun?", options:["That book is I.","That book is me.","That book is my.","That book is mine."], answer:3},
     {q:"How is a possessive pronoun different from a possessive noun like Sarahs?", options:["A possessive pronoun is always spelled with an apostrophe","A possessive pronoun is only used in questions","A possessive pronoun never shows ownership","A possessive pronoun replaces the noun entirely instead of attaching to it"], answer:3},
     {q:"Why are possessive pronouns useful in writing?", options:["They show ownership without repeating the noun","They replace verbs in a sentence","They remove all meaning from a sentence","They can only be used with plural nouns"], answer:0}
   ]},
  {subject:"Math", title:"Data Management: Constructing and Interpreting Line Plots", summary:"Grade 4 Math strand: a line plot displays data along a number line using symbols such as Xs or dots to show how many times each value occurs, making it easy to see the shape and spread of a data set.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What does a line plot use to show how many times a value occurs?", options:["Slices of a circle","Bars of different colours","Symbols such as Xs or dots stacked above a number line","Multiple separate graphs"], answer:2},
     {q:"What does a line plot help you quickly see about a data set?", options:["Nothing useful about the data","The shape and spread of the data","Only the largest value in the set","The exact title of the survey"], answer:1},
     {q:"If three Xs are stacked above the number 5 on a line plot, what does that mean?", options:["The value 5 occurred only once","The data set has no values at all","The value 5 occurred three times in the data","The number 3 occurred five times"], answer:2},
     {q:"What is one advantage of a line plot for a small data set?", options:["It hides all individual data points","It only works with very large data sets","It shows every individual data point clearly","It cannot show repeated values"], answer:2},
     {q:"Why might a class use a line plot to record data like favourite pet or shoe size?", options:["It removes the need to collect any data","It gives a simple visual way to compare how often each value appears","Line plots cannot be used for that kind of data","It only works with negative numbers"], answer:1}
   ]},
  {subject:"Science", title:"Science: Spiders and Other Arachnids — Unique Adaptations", summary:"Grade 4 Science strand: spiders and other arachnids, such as scorpions and ticks, have eight legs and two main body parts, and many spiders have special adaptations like silk-spinning glands used to build webs for catching prey.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"How many legs do spiders and other arachnids typically have?", options:["Ten","Six","Four","Eight"], answer:3},
     {q:"How many main body parts does a typical spider have?", options:["Four","Two","Three","One"], answer:1},
     {q:"What is one adaptation many spiders use to catch prey?", options:["Growing wings","Producing bright flowers","Spinning silk webs","Breathing underwater only"], answer:2},
     {q:"Which of these is an example of an arachnid other than a spider?", options:["A bee","A scorpion","A ladybug","A butterfly"], answer:1},
     {q:"How are arachnids different from insects?", options:["Arachnids have eight legs while insects have six","Insects always have more body parts than arachnids","Arachnids have wings while insects never do","Arachnids have no legs at all"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: David Thompson — Mapping Western Canada", summary:"Grade 4 Social Studies strand: David Thompson was an explorer and surveyor who mapped vast areas of western Canada in the early 1800s, creating detailed maps that helped guide later settlement and trade.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What was David Thompson known for?", options:["Mapping vast areas of western Canada","Founding the city of Toronto","Leading a naval fleet","Building the CN Tower"], answer:0},
     {q:"What job did David Thompson do to create his maps?", options:["He worked only as a farmer","He never travelled anywhere","He worked only as a baker","He worked as an explorer and surveyor"], answer:3},
     {q:"When did David Thompson complete much of his mapping work?", options:["In the early 1800s","In the twenty-first century","In ancient times","During the Ice Age"], answer:0},
     {q:"How did David Thompsons maps help later Canadians?", options:["They only showed oceans with no land","They guided later settlement and trade routes","They were immediately lost and never used","They had no use to anyone"], answer:1},
     {q:"Why is David Thompson remembered as an important figure in Canadian history?", options:["He never explored any part of Canada","His work was never recorded","His detailed maps greatly expanded knowledge of western Canadas geography","He has no connection to Canadian history"], answer:2}
   ]},
]},
{day:164, label:"Day 164 — Thu", subjects:[
  {subject:"Language", title:"Reading: Understanding Motifs in Literature", summary:"Grade 4 Language strand: a motif is a recurring image, symbol, or idea that appears throughout a text and helps reinforce its theme or deeper meaning.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a motif in literature?", options:["The title of a book","A type of punctuation mark","A single event that happens only once","A recurring image, symbol, or idea throughout a text"], answer:3},
     {q:"What does a motif help reinforce in a story?", options:["The font used in printing","The authors name","The theme or deeper meaning of the text","The page numbers of the book"], answer:2},
     {q:"If the colour red appears repeatedly around moments of danger in a story, what might this be an example of?", options:["A grammar rule","A motif connected to danger or warning","A random unrelated detail","A type of punctuation"], answer:1},
     {q:"How is a motif different from a symbol used only once?", options:["A motif has no connection to meaning","A motif repeats throughout the text while a single symbol may appear only once","A motif never repeats","A motif and a single symbol are exactly the same thing"], answer:1},
     {q:"Why might authors use motifs in their writing?", options:["To subtly reinforce important ideas throughout a story","Motifs are never used in literature","To remove meaning from a text","To confuse readers with no purpose"], answer:0}
   ]},
  {subject:"Math", title:"Probability: Using Tree Diagrams to List Possible Outcomes", summary:"Grade 4 Math strand: a tree diagram is a branching diagram used to list all possible outcomes of an event or combination of events, making it easier to count outcomes and calculate probability.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a tree diagram used for?", options:["Listing all possible outcomes of an event","Comparing prices at a store","Measuring the length of an object","Showing the temperature over time"], answer:0},
     {q:"If you flip a coin and then roll a die, how would a tree diagram help?", options:["It would show every possible combination of coin and die results","It would only show the coin results","It would show no useful information","It would only show the die results"], answer:0},
     {q:"How many outcomes are shown by a tree diagram for flipping two coins?", options:["Two","Four","Six","Eight"], answer:1},
     {q:"What does each branch of a tree diagram usually represent?", options:["One possible choice or outcome at that stage","A type of punctuation mark","A fixed number that never changes","An unrelated topic"], answer:0},
     {q:"Why are tree diagrams useful in probability?", options:["They only work with one outcome at a time","They have no connection to probability","They help organize and count all possible outcomes clearly","They make outcomes impossible to count"], answer:2}
   ]},
  {subject:"Science", title:"Science: The Layers of a Rainforest — Canopy, Understory, and Forest Floor", summary:"Grade 4 Science strand: a tropical rainforest has distinct layers, including the emergent layer of tallest trees, the canopy that forms a dense leafy roof, the understory of smaller plants, and the forest floor, each supporting different plants and animals.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is the canopy of a rainforest?", options:["A type of river found only in rainforests","A dense leafy layer formed by the crowns of tall trees","The layer of soil beneath the forest","The tallest single tree in the forest"], answer:1},
     {q:"What is found at the very top of a rainforest, above the canopy?", options:["The root layer","The emergent layer of the tallest trees","The forest floor","The understory"], answer:1},
     {q:"What is the understory of a rainforest?", options:["A layer found only underwater","A layer of smaller plants growing beneath the canopy","The tallest layer of trees","A layer made entirely of rock"], answer:1},
     {q:"Why does very little sunlight reach the forest floor of a rainforest?", options:["The canopy has no effect on sunlight","Rainforests receive no sunlight at all","The dense canopy blocks most sunlight from passing through","The forest floor is located underground"], answer:2},
     {q:"Why do rainforest layers support different types of plants and animals?", options:["Only the forest floor supports any life","Each layer offers different amounts of light, temperature, and space","All layers are exactly identical","Rainforest layers have no effect on living things"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Bluenose — A Famous Canadian Sailing Ship", summary:"Grade 4 Social Studies strand: the Bluenose was a famous Canadian racing schooner built in Nova Scotia in the 1920s, celebrated for its speed and skill, and its image now appears on the Canadian dime.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What type of ship was the Bluenose?", options:["A submarine","A cruise ship","A racing schooner","A cargo tanker"], answer:2},
     {q:"In which province was the Bluenose built?", options:["Nova Scotia","Manitoba","British Columbia","Alberta"], answer:0},
     {q:"What was the Bluenose especially celebrated for?", options:["Being the largest ship ever built","Being used only for fishing trips","Never winning any races","Its speed and sailing skill"], answer:3},
     {q:"Where does the image of the Bluenose appear today?", options:["On the Canadian dime","On the Canadian flag","On the back of the twenty dollar bill","On provincial licence plates"], answer:0},
     {q:"Why is the Bluenose considered an important Canadian symbol?", options:["It represents Canadian maritime skill and pride from the early twentieth century","It never achieved any recognition","It was built in a different country","It has no connection to Canadian history"], answer:0}
   ]},
]},
{day:165, label:"Day 165 — Fri", subjects:[
  {subject:"Language", title:"Reading: Identifying an Unreliable Narrator", summary:"Grade 4 Language strand: an unreliable narrator is a storyteller whose account of events may be inaccurate, biased, or incomplete, requiring readers to question and look beyond what is being told.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is an unreliable narrator?", options:["A character who never speaks in the story","The author of the book","A storyteller whose account may be inaccurate or biased","A narrator who always tells the complete truth"], answer:2},
     {q:"Why might readers need to question an unreliable narrators account?", options:["Because unreliable narrators are always completely accurate","Because unreliable narrators cannot tell a story","Because the narrator never appears in the story","Because the narrators version of events may be incomplete or biased"], answer:3},
     {q:"What might cause a narrator to be unreliable?", options:["Speaking in the first person","Describing the setting","Being the main character of the story","Limited knowledge, strong bias, or a reason to hide the truth"], answer:3},
     {q:"How can readers detect that a narrator might be unreliable?", options:["Unreliable narrators cannot be detected","By ignoring the narrator entirely","By noticing contradictions or gaps between the narrators claims and other details","By trusting every statement completely"], answer:2},
     {q:"Why might an author choose to use an unreliable narrator?", options:["Unreliable narrators are never used in literature","To remove all meaning from a story","To create suspense or challenge readers to think critically about the story","To make the story impossible to understand"], answer:2}
   ]},
  {subject:"Math", title:"Financial Literacy: Calculating Simple Profit and Loss", summary:"Grade 4 Math strand: profit occurs when the money earned from selling something is greater than the cost to make or buy it, while a loss occurs when the cost is greater than the money earned.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is profit?", options:["The amount lost after a sale","The price customers pay before tax","The amount earned that is greater than the cost","The total cost of making an item"], answer:2},
     {q:"What is a loss?", options:["When an item is sold for exactly its cost","When the cost of an item is greater than the money earned from selling it","When profit is very high","When no money is spent at all"], answer:1},
     {q:"If a lemonade stand spends 5 dollars on supplies and earns 12 dollars in sales, what is the profit?", options:["12 dollars","5 dollars","7 dollars","17 dollars"], answer:2},
     {q:"If a stand spends 10 dollars on supplies and only earns 6 dollars in sales, what happened?", options:["The stand broke even exactly","The stand earned exactly 10 dollars","The stand had a loss of 4 dollars","The stand had a profit of 4 dollars"], answer:2},
     {q:"Why is it useful for a business to track profit and loss?", options:["It helps determine whether the business is making or losing money","Tracking profit and loss has no real purpose","Loss has no effect on a business","All businesses always make the same amount of profit"], answer:0}
   ]},
  {subject:"Science", title:"Science: Tsunamis — Powerful Waves Triggered Beneath the Ocean", summary:"Grade 4 Science strand: a tsunami is a series of powerful ocean waves usually triggered by an underwater earthquake, volcanic eruption, or landslide, capable of causing major flooding when it reaches the shore.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What most commonly triggers a tsunami?", options:["A sunny day","A change in air temperature","A full moon","An underwater earthquake"], answer:3},
     {q:"What is a tsunami?", options:["A type of cloud formation","A type of underground cave","A gentle ripple in a pond","A series of powerful ocean waves"], answer:3},
     {q:"Besides earthquakes, what else can trigger a tsunami?", options:["A light breeze","An underwater volcanic eruption or landslide","A sunny afternoon","A change in the tide alone"], answer:1},
     {q:"What can happen when a tsunami reaches the shore?", options:["It has no effect on coastal areas","It only affects deep ocean water","It always disappears before reaching land","It can cause major flooding and damage"], answer:3},
     {q:"Why do scientists monitor the ocean floor for tsunami warning signs?", options:["To warn coastal communities early and help keep people safe","Warning systems have no effect on safety","Tsunamis cannot be detected in any way","Monitoring the ocean floor has no benefit"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Point Pelee National Park and Bird Migration", summary:"Grade 4 Social Studies strand: Point Pelee National Park, located at the southern tip of mainland Canada, is an important resting point for millions of migrating birds each spring and fall due to its location along a major migration route.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Where is Point Pelee National Park located?", options:["In northern Quebec","On the west coast of British Columbia","In the Canadian Arctic","At the southern tip of mainland Canada"], answer:3},
     {q:"Why is Point Pelee important for birds?", options:["It serves as a resting point along a major migration route","Birds never travel through this area","It has no connection to bird migration","It is located far from any migration paths"], answer:0},
     {q:"During which seasons do large numbers of birds pass through Point Pelee?", options:["Only in summer","Spring and fall","Birds never pass through in any season","Only in winter"], answer:1},
     {q:"Why might birds need resting points like Point Pelee during migration?", options:["Migration routes never include stops","Birds never need to rest during migration","Resting points make migration impossible","Long migrations require stops to rest and find food"], answer:3},
     {q:"Why do many visitors travel to Point Pelee each year?", options:["It is closed to the public","It has no attractions for visitors","To observe the large variety of migrating birds","It has no connection to nature"], answer:2}
   ]},
]},
{day:166, label:"Day 166 — Mon", subjects:[
  {subject:"Language", title:"Writing: Writing an Acrostic Poem", summary:"Grade 4 Language strand: an acrostic poem uses the letters of a word, spelled vertically down the page, as the starting letter for each line, often describing or relating to that word.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is an acrostic poem?", options:["A poem that must rhyme every line","A poem where each line starts with a letter from a word spelled vertically","A poem written only about animals","A poem with no structure at all"], answer:1},
     {q:"How are the letters of the key word arranged in an acrostic poem?", options:["Scattered randomly","Vertically down the page","Hidden inside other words","Written backwards only"], answer:1},
     {q:"What might each line of an acrostic poem describe?", options:["Only punctuation marks","Only numbers","A completely unrelated topic","Something related to the meaning of the key word"], answer:3},
     {q:"If the key word is DOG, how many lines would a basic acrostic poem about DOG likely have?", options:["Five","Three","Ten","One"], answer:1},
     {q:"Why might a writer choose to write an acrostic poem?", options:["It offers a fun, structured way to explore a word or topic creatively","It only works for very long words","Acrostic poems have no creative value","It removes the need for any words"], answer:0}
   ]},
  {subject:"Math", title:"Number Sense: Divisibility Rules for 4 and 8", summary:"Grade 4 Math strand: a number is divisible by 4 if its last two digits form a number divisible by 4, and a number is divisible by 8 if its last three digits form a number divisible by 8.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"How can you tell if a number is divisible by 4?", options:["Check only the first digit","Check if the number is even","Check if the digits add up to 4","Check if the last two digits form a number divisible by 4"], answer:3},
     {q:"Is the number 316 divisible by 4?", options:["No, 316 cannot be tested","Yes, because 16 is divisible by 4","Yes, because 3 is divisible by 4","No, because 16 is not divisible by 4"], answer:1},
     {q:"How can you tell if a number is divisible by 8?", options:["Check if the number is odd","Check if the digits add up to 8","Check if the first digit is 8","Check if the last three digits form a number divisible by 8"], answer:3},
     {q:"Is the number 1,240 divisible by 8?", options:["No, because 240 is not divisible by 8","No, only even numbers can be divisible by 8","Yes, because 1 is divisible by 8","Yes, because 240 is divisible by 8"], answer:3},
     {q:"Why are divisibility rules useful in math?", options:["They have no practical use","They make division impossible","They only work for the number 10","They help quickly check if a number can be divided evenly without doing long division"], answer:3}
   ]},
  {subject:"Science", title:"Science: Hurricanes and Tropical Storms", summary:"Grade 4 Science strand: a hurricane is a powerful rotating storm that forms over warm ocean water, bringing strong winds, heavy rain, and dangerous storm surges when it reaches land.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"Where do hurricanes typically form?", options:["Over warm ocean water","Over frozen tundra","Underground","Over mountain peaks"], answer:0},
     {q:"What is a key feature of a hurricane?", options:["A complete lack of rain","Freezing temperatures","No wind at all","Strong rotating winds"], answer:3},
     {q:"What can a hurricane bring when it reaches land?", options:["Only cold temperatures","Only light breezes","Strong winds, heavy rain, and storm surges","Only clear skies"], answer:2},
     {q:"What is a storm surge?", options:["A gentle wave with no danger","A rise in sea level pushed toward the coast by a storm","A type of desert wind","A calm ocean current"], answer:1},
     {q:"Why do meteorologists closely track hurricanes?", options:["Hurricanes never affect people on land","To warn coastal communities and help people prepare for safety","Hurricanes cannot be tracked in any way","Tracking hurricanes has no benefit"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Automotive Industry", summary:"Grade 4 Social Studies strand: Canadas automotive industry, centred largely in Ontario, manufactures vehicles and parts, providing many jobs and playing a significant role in the countrys economy and trade with other nations.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Which province is most closely associated with Canadas automotive industry?", options:["Ontario","Nova Scotia","Manitoba","British Columbia"], answer:0},
     {q:"What does Canadas automotive industry primarily manufacture?", options:["Only farming equipment","Only clothing","Only furniture","Vehicles and vehicle parts"], answer:3},
     {q:"What does the automotive industry provide for many Canadians?", options:["Free land","Unlimited fuel","Free vehicles for everyone","Jobs"], answer:3},
     {q:"How does the automotive industry connect to Canadas trade with other countries?", options:["Vehicles and parts are often exported and imported between countries","All vehicles are only used within one factory","The industry has no connection to trade","Canada never trades vehicles with other countries"], answer:0},
     {q:"Why is the automotive industry considered important to Canadas economy?", options:["It only affects a single small town","It creates jobs and generates significant economic activity","It has no impact on the economy","It provides no products or services"], answer:1}
   ]},
]},
{day:167, label:"Day 167 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing a Fairy Tale", summary:"Grade 4 Language strand: a fairy tale is a traditional story that often includes magical elements, a clear conflict between good and evil, and a lesson or happy ending, such as tales featuring castles, enchanted creatures, or brave heroes.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is a common feature of a fairy tale?", options:["Only factual scientific information","Magical elements and a conflict between good and evil","A list of unrelated statistics","A formal business letter"], answer:1},
     {q:"What kind of ending do many fairy tales have?", options:["An ending that is never written","An ending with no resolution at all","A happy ending or resolved lesson","A completely random ending with no connection to the story"], answer:2},
     {q:"Which of these might commonly appear as a setting in a fairy tale?", options:["An enchanted forest or castle","A subway station","A modern office building","A shopping mall"], answer:0},
     {q:"What role might a fairy tale hero often play in the story?", options:["Overcoming a challenge or defeating an evil force","Ending the story without any actions","Causing all the problems in the story","Never appearing in the story"], answer:0},
     {q:"Why do many fairy tales include a clear lesson or moral?", options:["Morals have no place in fairy tales","Lessons are only found in nonfiction texts","Fairy tales never include lessons","To teach readers something meaningful through the story"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Classifying Triangles by Angle Type — Acute, Right, and Obtuse", summary:"Grade 4 Math strand: triangles can be classified by their angles as acute, where all angles are less than 90 degrees, right, with one angle equal to exactly 90 degrees, or obtuse, with one angle greater than 90 degrees.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What defines an acute triangle?", options:["One angle is greater than 90 degrees","All three angles are less than 90 degrees","All three angles are equal to 180 degrees","One angle is exactly 90 degrees"], answer:1},
     {q:"What defines a right triangle?", options:["One angle is exactly 90 degrees","All angles are less than 45 degrees","No angles are equal","All angles are greater than 90 degrees"], answer:0},
     {q:"What defines an obtuse triangle?", options:["All angles are less than 90 degrees","One angle is exactly 90 degrees","One angle is greater than 90 degrees","All angles are exactly equal"], answer:2},
     {q:"Can a triangle have two right angles?", options:["No, because the three angles must add up to 180 degrees total","No triangle can ever have a right angle","Yes, but only in obtuse triangles","Yes, every triangle has two right angles"], answer:0},
     {q:"Why is it useful to classify triangles by their angles?", options:["Angles have no connection to triangle shape","Classifying triangles has no mathematical value","It helps identify and describe the properties of different triangle shapes","All triangles have identical angles"], answer:2}
   ]},
  {subject:"Science", title:"Science: How Batteries Store and Release Energy", summary:"Grade 4 Science strand: a battery stores chemical energy and converts it into electrical energy through a chemical reaction inside the battery, allowing it to power devices when connected in a circuit.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What type of energy does a battery store?", options:["Chemical energy","Wind energy","Sound energy","Light energy"], answer:0},
     {q:"What does a battery convert its stored energy into?", options:["Electrical energy","Heat energy only","Sound energy only","Nuclear energy"], answer:0},
     {q:"How does a battery release its stored energy?", options:["By freezing","Through a chemical reaction inside the battery","By spinning rapidly","By absorbing sunlight"], answer:1},
     {q:"What is needed for a battery to power a device?", options:["The device must have no wires","The battery must be left disconnected","The battery must be connected in a complete circuit","The battery must be exposed to sunlight"], answer:2},
     {q:"Why do batteries eventually stop working and need to be replaced or recharged?", options:["Their stored chemical energy runs out over time","Batteries create energy from nothing","Batteries never run out of energy","Batteries only work for one second"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Credit Unions and Cooperative Banking in Canada", summary:"Grade 4 Social Studies strand: a credit union is a cooperative financial institution owned by its members, offering banking services such as savings accounts and loans, with profits often returned to members rather than outside shareholders.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What is a credit union?", options:["A national park","A type of grocery store","A cooperative financial institution owned by its members","A government tax office"], answer:2},
     {q:"Who owns a credit union?", options:["A foreign government","Its members","No one owns a credit union","A single wealthy owner"], answer:1},
     {q:"What services might a credit union offer?", options:["Only construction services","Only grocery delivery","Only postal services","Savings accounts and loans"], answer:3},
     {q:"How are credit union profits often used?", options:["They are often returned to members instead of outside shareholders","They disappear completely","They are never distributed to anyone","They are always given to a foreign government"], answer:0},
     {q:"Why might someone choose to bank with a credit union?", options:["Credit unions are not allowed to offer banking services","Because it is member-owned and may offer benefits back to its community of members","Credit unions only serve large businesses","Credit unions offer no benefits at all"], answer:1}
   ]},
]},
{day:168, label:"Day 168 — Wed", subjects:[
  {subject:"Language", title:"Writing: Writing a Product Review", summary:"Grade 4 Language strand: a product review is a piece of writing that describes a product, evaluates its strengths and weaknesses, and offers an opinion to help other readers decide whether to use it.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"What is the purpose of a product review?", options:["To tell an imaginary story","To list unrelated facts","To evaluate a product and help readers decide whether to use it","To describe a historical event"], answer:2},
     {q:"What might a product review include?", options:["The products strengths and weaknesses","Only the products price with no opinion","A completely unrelated topic","A private diary entry"], answer:0},
     {q:"Why might a reviewer include specific examples in a product review?", options:["Examples always confuse the reader","Reviews are not allowed to include examples","To support their opinion with clear evidence","Examples have no value in a review"], answer:2},
     {q:"What tone might a balanced product review use?", options:["A tone that only criticizes the product","A fair tone that considers both positives and negatives","A tone with no opinion expressed at all","A tone that only praises the product"], answer:1},
     {q:"Why do many readers look for product reviews before making a purchase?", options:["Reviews help them understand a products quality before buying it","Product reviews are never read by anyone","Reviews have no influence on purchases","Reviews only describe unrelated products"], answer:0}
   ]},
  {subject:"Math", title:"Number Sense: Multiplying Decimals by 10, 100, and 1,000", summary:"Grade 4 Math strand: multiplying a decimal by 10, 100, or 1,000 moves the decimal point to the right by one, two, or three places, making the number larger.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What happens to a decimal number when it is multiplied by 10?", options:["The decimal point moves one place to the right","The decimal point moves one place to the left","The number stays exactly the same","The number becomes smaller"], answer:0},
     {q:"What is 3.45 multiplied by 10?", options:["3.45","0.345","345","34.5"], answer:3},
     {q:"What is 2.6 multiplied by 100?", options:["26","260","2.6","0.26"], answer:1},
     {q:"What is 0.7 multiplied by 1,000?", options:["7","70","700","0.7"], answer:2},
     {q:"Why is it useful to understand how multiplying by 10, 100, and 1,000 affects decimals?", options:["It helps with mental math and understanding place value shifts","Multiplying decimals always produces a smaller number","Decimals cannot be multiplied by whole numbers","It has no effect on any calculation"], answer:0}
   ]},
  {subject:"Science", title:"Science: Bioluminescence — Living Things That Glow", summary:"Grade 4 Science strand: bioluminescence is the ability of certain living things, such as fireflies, jellyfish, and deep-sea fish, to produce their own light through a chemical reaction inside their bodies.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is bioluminescence?", options:["The ability of living things to produce their own light","The ability of living things to change colour","The ability of living things to fly","The ability of living things to breathe underwater"], answer:0},
     {q:"Which of these is a well-known example of a bioluminescent animal?", options:["A robin","A firefly","A squirrel","A deer"], answer:1},
     {q:"How do bioluminescent organisms produce light?", options:["By using electricity from wires","By absorbing sunlight during the day","By reflecting moonlight only","Through a chemical reaction inside their bodies"], answer:3},
     {q:"Where might many bioluminescent creatures be found besides on land?", options:["In outer space","On mountain peaks","In the desert","In the deep ocean"], answer:3},
     {q:"Why might bioluminescence be useful to an animal?", options:["It has no useful purpose for animals","It always harms the animal that produces it","It can help attract mates, lure prey, or ward off predators","It prevents animals from being seen at all"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Role of the Ombudsman in Protecting Citizens Rights", summary:"Grade 4 Social Studies strand: an ombudsman is an independent official who investigates complaints from citizens about unfair treatment by government services, helping ensure fairness and accountability.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What does an ombudsman do?", options:["Builds highways across the country","Investigates complaints from citizens about unfair treatment","Runs a private business","Manages a countrys military"], answer:1},
     {q:"Why is an ombudsman considered independent?", options:["They are controlled entirely by a single business","They have no connection to government services","They investigate fairly without taking sides between citizens and government","They always side with the government"], answer:2},
     {q:"Who might contact an ombudsman for help?", options:["Only large corporations","No one is allowed to contact an ombudsman","A citizen who feels they were treated unfairly by a government service","Only foreign governments"], answer:2},
     {q:"What is one goal of having an ombudsman in government?", options:["Preventing citizens from ever complaining","Ensuring fairness and accountability in public services","Removing all rules from government","Making government services less accountable"], answer:1},
     {q:"Why is the role of an ombudsman valuable to a community?", options:["It has no value to citizens","It removes all citizen rights","It gives citizens a way to seek fair treatment and hold services accountable","It only benefits government workers"], answer:2}
   ]},
]},
{day:169, label:"Day 169 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Commonly Confused Words — Their, There, and Theyre", summary:"Grade 4 Language strand: their, there, and theyre are commonly confused homophones, where their shows possession, there refers to a location, and theyre is a short form of they are.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which word shows possession, meaning something belongs to a group?", options:["Theyre","Their","There","None of these"], answer:1},
     {q:"Which word refers to a location or place?", options:["Theyre","Their","There","None of these"], answer:2},
     {q:"Which word is a short form combining they and are?", options:["Theyre","Their","There","None of these"], answer:0},
     {q:"Which sentence uses their correctly?", options:["The students brought theyre books to class.","The students brought their books to class.","The students brought there books to class.","The students brought books their to class."], answer:1},
     {q:"Why is it important to use their, there, and theyre correctly in writing?", options:["These words all mean exactly the same thing","Spelling never affects meaning","Using the correct word helps the sentence make clear sense to readers","These words are never confused by writers"], answer:2}
   ]},
  {subject:"Math", title:"Number Sense: Ordering Integers on a Number Line", summary:"Grade 4 Math strand: integers can be ordered from least to greatest by plotting them on a number line, remembering that numbers further to the left are smaller and numbers further to the right are larger, even with negative numbers.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"On a number line, which direction do numbers increase in value?", options:["To the right","To the left","Upward only","Downward only"], answer:0},
     {q:"Which integer is greater, -2 or 3?", options:["-2","They are equal","3","Cannot be determined"], answer:2},
     {q:"Which integer is smaller, -7 or -1?", options:["Cannot be determined","-1","-7","They are equal"], answer:2},
     {q:"How would you order -4, 2, and -1 from least to greatest?", options:["-4, -1, 2","-1, -4, 2","2, -1, -4","2, -4, -1"], answer:0},
     {q:"Why is it useful to plot integers on a number line before ordering them?", options:["It makes ordering integers impossible","It has no effect on comparing values","It gives a clear visual way to compare their positions and values","Number lines cannot include negative numbers"], answer:2}
   ]},
  {subject:"Science", title:"Science: Types of Volcanoes — Shield, Cinder Cone, and Composite", summary:"Grade 4 Science strand: volcanoes can be classified by shape and eruption style, including shield volcanoes with gently sloping sides, cinder cone volcanoes with steep sides built from erupted debris, and composite volcanoes formed from alternating layers of lava and ash.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What is a shield volcano known for?", options:["Having extremely steep sides","Never erupting at all","Being made entirely of ice","Having gently sloping sides formed by runny lava"], answer:3},
     {q:"What is a cinder cone volcano built from?", options:["Only flowing water","Erupted debris that piles up into steep sides","Only solid rock with no eruptions","Only sand from a desert"], answer:1},
     {q:"What forms a composite volcano?", options:["A single layer of sand","A layer of only water","A single layer of ice","Alternating layers of lava and ash"], answer:3},
     {q:"Which type of volcano tends to have the steepest, most cone-shaped profile?", options:["Shield volcanoes only","Composite or cinder cone volcanoes","Volcanoes have no shape","All volcanoes look identical"], answer:1},
     {q:"Why do scientists classify volcanoes into different types?", options:["All volcanoes behave in exactly the same way","Volcanoes cannot be studied or classified","It helps predict eruption style and potential hazards","Classifying volcanoes has no scientific use"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Igloos, Longhouses, and Tipis — Traditional Indigenous Housing Across Canada", summary:"Grade 4 Social Studies strand: Indigenous peoples across Canada developed different types of traditional housing suited to their environment and way of life, including igloos built from snow in the Arctic, longhouses built by Iroquoian peoples, and tipis used by Plains peoples.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"What material were traditional igloos built from?", options:["Blocks of snow and ice","Stone bricks","Wood logs","Woven grass"], answer:0},
     {q:"Which group of Indigenous peoples traditionally built longhouses?", options:["Only peoples living on the Pacific coast","Iroquoian peoples","No Indigenous peoples used longhouses","Only peoples living in the Arctic"], answer:1},
     {q:"What were tipis traditionally used for?", options:["Storage buildings for grain","Structures used only for fishing","Permanent housing used only in cities","Portable housing used by Plains peoples"], answer:3},
     {q:"Why did traditional Indigenous housing styles vary across Canada?", options:["Different environments and ways of life called for different housing designs","Housing style had no connection to environment","Indigenous peoples never built any housing","All Indigenous housing was built exactly the same way"], answer:0},
     {q:"Why is it valuable to learn about traditional Indigenous housing?", options:["It has no educational value","It shows how Indigenous peoples adapted skillfully to their environments","Traditional housing has no connection to Indigenous cultures","These housing styles were never actually used"], answer:1}
   ]},
]},
{day:170, label:"Day 170 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Pronouns, Motifs, and Narrators", summary:"Grade 4 Language strand review: students revisit interrogative pronouns, reflexive pronouns, possessive pronouns, motifs in literature, and unreliable narrators.",
   resourceLabel:"TVO Learn: Grade 4 Language", resourceUrl:"https://tvolearn.com/pages/grade-4-language",
   quiz:[
     {q:"Which interrogative pronoun asks about a person acting as the subject?", options:["Whom","Which","Whose","Who"], answer:3},
     {q:"What is a reflexive pronoun?", options:["A pronoun used when the subject and object of a sentence are the same","A type of punctuation mark","A pronoun that only names an object","A word that joins two sentences"], answer:0},
     {q:"What do possessive pronouns show?", options:["A location in a sentence","An action taking place","Ownership of something","A question being asked"], answer:2},
     {q:"What is a motif in literature?", options:["A single event that happens only once","A type of punctuation mark","The title of a book","A recurring image, symbol, or idea throughout a text"], answer:3},
     {q:"What is an unreliable narrator?", options:["A storyteller whose account may be inaccurate or biased","A narrator who always tells the complete truth","A character who never speaks in the story","The author of the book"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Geometry, Multiplication, and Data", summary:"Grade 4 Math strand review: students revisit points lines and rays, multiplying a 3-digit number by a 2-digit number, line plots, tree diagrams, and profit and loss.",
   resourceLabel:"TVO Learn: Grade 4 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-4-mathematics",
   quiz:[
     {q:"What is a point in geometry?", options:["A measurement of an angle","A shape with four sides","A line that never ends","An exact location in space with no size"], answer:3},
     {q:"What is a common first step to multiply a 3-digit number by a 2-digit number?", options:["Divide the numbers first","Add the two numbers together","Break the 2-digit number into tens and ones","Round both numbers to zero"], answer:2},
     {q:"What does a line plot use to show how many times a value occurs?", options:["Symbols such as Xs or dots stacked above a number line","Slices of a circle","Bars of different colours","Multiple separate graphs"], answer:0},
     {q:"What is a tree diagram used for?", options:["Listing all possible outcomes of an event","Measuring the length of an object","Comparing prices at a store","Showing the temperature over time"], answer:0},
     {q:"What is profit?", options:["The total cost of making an item","The price customers pay before tax","The amount lost after a sale","The amount earned that is greater than the cost"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Cells, Ecosystems, and Natural Forces", summary:"Grade 4 Science strand review: students revisit cells, elements compounds and mixtures, spiders and arachnids, rainforest layers, and tsunamis.",
   resourceLabel:"TVO Learn: Grade 4 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-4-science-and-technology",
   quiz:[
     {q:"What are cells?", options:["A form of energy","A type of weather pattern","A type of rock","The basic building blocks of living things"], answer:3},
     {q:"What is an element?", options:["A mixture of many substances","A liquid that cannot be separated","A type of rock only","A pure substance made of only one type of atom"], answer:3},
     {q:"How many legs do spiders and other arachnids typically have?", options:["Eight","Six","Ten","Four"], answer:0},
     {q:"What is the canopy of a rainforest?", options:["The tallest single tree in the forest","A type of river found only in rainforests","The layer of soil beneath the forest","A dense leafy layer formed by the crowns of tall trees"], answer:3},
     {q:"What most commonly triggers a tsunami?", options:["An underwater earthquake","A change in air temperature","A sunny day","A full moon"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: World Empires, Canadian Landmarks, and Explorers", summary:"Grade 4 Social Studies strand review: students revisit the Mongol Empire, the Bay of Fundy, David Thompson, the Bluenose, and Point Pelee National Park.",
   resourceLabel:"TVO Learn: Grade 4 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-4-social-studies",
   quiz:[
     {q:"Who founded the Mongol Empire?", options:["Alexander the Great","Genghis Khan","Hammurabi","Julius Caesar"], answer:1},
     {q:"In which two provinces is the Bay of Fundy located?", options:["Nova Scotia and New Brunswick","Manitoba and Saskatchewan","British Columbia and Alberta","Ontario and Quebec"], answer:0},
     {q:"What was David Thompson known for?", options:["Founding the city of Toronto","Leading a naval fleet","Mapping vast areas of western Canada","Building the CN Tower"], answer:2},
     {q:"What type of ship was the Bluenose?", options:["A cruise ship","A racing schooner","A cargo tanker","A submarine"], answer:1},
