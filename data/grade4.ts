...
{day:5, label:"Day 5 — Fri", subjects:[
  {subject:"Language", title:"Reading: Main Idea and Supporting Details", summary:"Grade 4 Reading strand: the main idea is what a text is mostly about. Supporting details give more information and evidence for the main idea.",
   ...
   quiz:[
     ...
     {q:"Where is the main idea often found?", options:["In a caption","Only in the middle","Often in the first or last paragraph as the topic sentence","Only at the end"], answer:2},
     ...
     {q:"Which is a main idea sentence?", options:["She walked to the store.","The cat was orange.","He ate lunch at noon.","Recycling has many benefits for the environment."], answer:3}
   ]},
  ...
  {subject:"Science", title:"Human Impact on Ecosystems", summary:"Grade 4 Science Life Systems: human activities such as deforestation, pollution, and urbanization negatively affect ecosystems; conservation actions help protect them.",
   ...
   quiz:[
     ...
     {q:"Which action helps PROTECT ecosystems?", options:["Littering","Building factories near rivers","Polluting water","Creating national parks and reducing emissions"], answer:3},
     ...
     {q:"What can individuals do to reduce environmental impact?", options:["Drive more cars","Cut down more trees","Use more plastic","Reduce, reuse, recycle and conserve energy"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Indigenous Peoples of North America", summary:"Grade 4 Social Studies: Indigenous peoples of North America include many diverse nations, each with unique cultures, languages, and governance systems.",
   ...
   quiz:[
     ...
     {q:"Traditional Indigenous knowledge includes ___.", options:["only dance","ecological knowledge, governance, and cultural practices","only language","only crafts"], answer:1},
     {q:"Why is it important to learn about Indigenous cultures?", options:["It is not important","They are part of Canada's history, heritage, and identity","Only for adults","Only in Ontario"], answer:1},
     {q:"The Indian Act (1876) was ___.", options:["a law that restricted the rights of Indigenous peoples in Canada","a celebration of Indigenous cultures","a trade agreement","A school curriculum"], answer:0}
   ]},
]},
{day:6, label:"Day 6 — Mon", subjects:[
  {subject:"Language", title:"Reading: Inference", summary:"Grade 4 Reading strand: inference means using evidence from the text plus your own knowledge to understand something not directly stated.",
   ...
   quiz:[
     {q:"An inference is ___.", options:["the main idea","a conclusion drawn from evidence in the text plus prior knowledge","directly stated in the text","a guess with no evidence"], answer:1},
     ...
     {q:"Maria grabbed her umbrella before leaving. You can infer ___.", options:["She forgot her coat","She likes umbrellas","She is going swimming","It was probably raining or she expected rain"], answer:3},
     ...
     {q:"After making an inference, a good reader ___.", options:["Reads on to confirm or revise the inference","Ignores it","Stops reading","Tells others"], answer:0}
   ]},
  ...
  {subject:"Science", title:"Rocks and Minerals", summary:"Grade 4 Science Earth strand: rocks are made of minerals. The three rock types are igneous, sedimentary, and metamorphic, each formed by different processes.",
   ...
   quiz:[
     ...
     {q:"Metamorphic rock forms when ___.", options:["lava cools","sediment is compressed","glaciers melt","existing rock is changed by heat and pressure"], answer:3},
  ...
  {subject:"SocialStudies", title:"Early Canadian History", summary:"Grade 4 Social Studies: Canada's early history includes Indigenous peoples, European exploration, New France, and British colonization.",
   ...
   quiz:[
     ...
     {q:"Jacques Cartier was significant because ___.", options:["He was the first European to sail the St. Lawrence River","He built the first railway","He discovered gold","He founded Toronto"], answer:0},
     ...
     {q:"The Battle of the Plains of Abraham (1759) resulted in ___.", options:["French victory","Indigenous victory","A draw","British victory and control of New France"], answer:3}
   ]},
]},
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Writing: Paragraphs", summary:"Grade 4 Writing strand: a well-organized paragraph has a topic sentence, supporting details, and a concluding sentence. All sentences relate to one main idea.",
   ...
   quiz:[
     ...
     {q:"Supporting sentences in a paragraph ___.", options:["end the paragraph","are optional","give details, reasons, or examples that support the topic sentence","introduce new topics"], answer:2},
     {q:"A concluding sentence ___.", options:["asks a question","introduces the topic","adds a new idea","wraps up the paragraph and restates the main idea"], answer:3},
     {q:"How many main ideas should one paragraph have?", options:["One","Two or three","None","As many as possible"], answer:0},
     {q:"Which would make a good topic sentence for a paragraph about dogs?", options:["Dogs can run.","My dog is named Rex.","Dogs make excellent pets for many reasons.","Dogs are brown."], answer:2}
   ]},
  ...
  {subject:"Science", title:"Rock Cycle", summary:"Grade 4 Science Earth strand: rocks cycle continuously between igneous, sedimentary, and metamorphic forms through geological processes.",
   ...
   quiz:[
     {q:"What drives the rock cycle?", options:["Heat and pressure from Earth's interior, and weathering at the surface","The moon's gravity","Only volcanic eruptions","Wind and rain only"], answer:0},
     ...
     {q:"The rock cycle shows that rocks ___.", options:["are always igneous","only come from volcanoes","can be transformed from one type to another over time","never change"], answer:2}
   ]},
  {subject:"SocialStudies", title:"European Explorers", summary:"Grade 4 Social Studies: European explorers from the 1400s–1600s sailed to North America, changing the world and affecting Indigenous peoples significantly.",
   ...
   quiz:[
     ...
     {q:"The arrival of Europeans had a ___ impact on Indigenous peoples.", options:["no impact","devastating — disease, displacement, and loss of culture","mostly positive","completely neutral"], answer:1},
...
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"Language", title:"Writing: Descriptive Writing", summary:"Grade 4 Writing strand: descriptive writing uses sensory details (sight, sound, smell, touch, taste) and vivid language to create a clear picture for the reader.",
   ...
   quiz:[
     ...
     {q:"Which is a more descriptive sentence?", options:["I saw a flower.","The velvety crimson rose filled the air with a sweet perfume.","The flower was nice.","The flower was red."], answer:1},
  ...
  {subject:"Science", title:"Soil Formation", summary:"Grade 4 Science Earth strand: soil forms over thousands of years by weathering of rock and addition of organic matter. It has layers called horizons.",
   ...
   quiz:[
     ...
     {q:"Topsoil is important because ___.", options:["it contains no water","it is the hardest layer","it is richest in nutrients for plant growth","it is made of solid rock"], answer:2},
  ...
  {subject:"SocialStudies", title:"Government: Democracy and Monarchy", summary:"Grade 4 Social Studies: governments organize society and make laws. A democracy gives citizens a voice; a monarchy is led by a king or queen.",
   ...
   quiz:[
     ...
     {q:"Canada is a ___.", options:["dictatorship","republic","absolute monarchy","constitutional monarchy and parliamentary democracy"], answer:3},
     {q:"Parliament makes ___.", options:["food","laws","buildings","schools"], answer:1},
     {q:"A constitutional monarchy means ___.", options:["the monarch has unlimited power","there is no elected government","only the monarch rules","the monarch's power is limited by a constitution and elected government"], answer:3},
...
{day:9, label:"Day 9 — Thu", subjects:[
  {subject:"Language", title:"Writing: Persuasive Writing", summary:"Grade 4 Writing strand: persuasive writing argues for a position using reasons, evidence, and a call to action. It has a clear opinion statement.",
   ...
   quiz:[
     ...
     {q:"Counter-arguments in persuasive writing ___.", options:["are unrelated to the topic","should always be avoided","weaken your argument","acknowledge opposing views and then refute them, strengthening your argument"], answer:3},
  ...
  {subject:"Science", title:"Properties of Light: Reflection", summary:"Grade 4 Science Energy strand: light travels in straight lines and reflects off surfaces. The angle of incidence equals the angle of reflection.",
   ...
   quiz:[
     ...
     {q:"Why does a mirror show your reflection?", options:["It is transparent","It glows","It absorbs light","Its smooth surface reflects light at the same angle it hits"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Trade and Commerce in History", summary:"Grade 4 Social Studies: trade is the exchange of goods and services. Ancient and early modern civilizations developed trade routes that spread culture and ideas.",
   ...
   quiz:[
     ...
     {q:"Why did civilizations trade with each other?", options:["To access goods they could not produce themselves","Only for art","For entertainment","Only for war"], answer:0},
     {q:"Trade often led to ___.", options:["isolation of cultures","spreading of ideas, technology, and culture between civilizations","conflict only","only economic profit"], answer:1},
     {q:"The fur trade in early Canada involved ___.", options:["only Indigenous peoples","only French traders","only European settlers","both Indigenous peoples and European settlers"], answer:3}
   ]},
]},
{day:10, label:"Day 10 — Fri", subjects:[
  ...
  {subject:"SocialStudies", title:"Human Rights", summary:"Grade 4 Social Studies: human rights are basic rights all people deserve. The Universal Declaration of Human Rights (UDHR, 1948) protects these rights globally.",
   ...
   quiz:[
     {q:"Human rights are rights that ___.", options:["all people have equally, regardless of background","only adults have","only citizens have","only wealthy people have"], answer:0},
     {q:"The Universal Declaration of Human Rights was adopted in ___.", options:["1867","2000","1948","1776"], answer:2},
     {q:"Which is a basic human right?", options:["Unlimited money","Never going to school","Owning luxury goods","Freedom of speech and freedom from torture"], answer:3},
     {q:"Who is responsible for upholding human rights?", options:["Governments, organizations, and individuals","Only wealthy nations","Only the United Nations","No one"], answer:0},
     {q:"Why are human rights important?", options:["They only apply in certain countries","They protect the dignity and equality of every person","They are not","Only politicians care about them"], answer:1}
   ]},
]},
{day:11, label:"Day 11 — Mon", subjects:[
  ...
  {subject:"Science", title:"Sound: Vibration and Frequency", summary:"Grade 4 Science Energy strand: sounds are made by vibrations. Frequency determines pitch — higher frequency = higher pitch. Amplitude determines volume.",
   ...
   quiz:[
     ...
     {q:"Frequency refers to ___.", options:["how loud a sound is","how many vibrations per second (determines pitch)","the speed of light","how far sound travels"], answer:1},
...
{day:12, label:"Day 12 — Tue", subjects:[
  {subject:"Language", title:"Vocabulary: Context Clues", summary:"Grade 4 Language strand: context clues are words and phrases near an unknown word that help you determine its meaning without a dictionary.",
   ...
   quiz:[
     {q:"Context clues are ___.", options:["words and ideas near an unknown word that suggest its meaning","only antonyms","only synonyms","definitions found in the glossary"], answer:0},
     ...
     {q:"Using context clues helps readers ___.", options:["figure out word meanings while reading continuously","look up every word in a dictionary","memorize vocabulary lists","skip unknown words"], answer:0},
...
{day:13, label:"Day 13 — Wed", subjects:[
  ...
  {subject:"Science", title:"Electricity: Static and Current", summary:"Grade 4 Science Energy strand: static electricity is a build-up of charge; current electricity is a flow of electrons through a conductor.",
   ...
   quiz:[
     {q:"Static electricity is caused by ___.", options:["burning fuel","magnetism","a build-up of electric charge on a surface","a flow of electrons in a circuit"], answer:2},
     ...
     {q:"Which is an example of static electricity?", options:["Turning on a light bulb","Charging a phone","A lightning bolt and rubbing a balloon on hair","Using a toaster"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Maps: Physical Features", summary:"Grade 4 Social Studies: physical maps show natural features like mountains, rivers, lakes, and plains. They use colour and symbols to represent terrain.",
   ...
   quiz:[
     {q:"A physical map shows ___.", options:["natural features like mountains and rivers","population density","roads and cities","political boundaries"], answer:0},
     {q:"On most physical maps, blue represents ___.", options:["water (rivers, lakes, oceans)","land","grasslands","mountains"], answer:0},
     {q:"What is a legend (key) on a map?", options:["A table that explains the symbols used on the map","Scale bar","North arrow","The title"], answer:0},
...
{day:14, label:"Day 14 — Thu", subjects:[
  ...
  {subject:"SocialStudies", title:"Canada's Natural Resources", summary:"Grade 4 Social Studies: Canada is rich in natural resources including forests, minerals, freshwater, oil, and agricultural land. These support the economy but must be managed sustainably.",
   ...
   quiz:[
     ...
     {q:"Why are Canada's forests valuable?", options:["They provide lumber, paper, habitat, and help regulate climate","They are not valuable","Only for tourism","Only for scenery"], answer:0},
     ...
     {q:"Sustainable use of resources means ___.", options:["only using what you can carry","using them as fast as possible","never using them","using them in a way that does not deplete them for future generations"], answer:3},
...
{day:15, label:"Day 15 — Fri", subjects:[
  {subject:"Language", title:"Figurative Language: Metaphors", summary:"Grade 4 Language strand: a metaphor directly states that one thing IS another unlike thing, without using 'like' or 'as'. Example: 'Life is a journey.'",
   ...
   quiz:[
     ...
     {q:"What does 'Time is money' mean?", options:["Clocks cost money","Time is free","Time is currency","Time is valuable and should not be wasted"], answer:3},
  ...
  {subject:"Science", title:"Forces: Gravity and Friction", summary:"Grade 4 Science Energy strand: gravity is the force that pulls objects toward Earth. Friction is the force that resists movement between surfaces in contact.",
   ...
   quiz:[
     {q:"Gravity is a force that ___.", options:["stops all motion","only exists in space","pulls objects toward each other (especially toward Earth)","pushes objects upward"], answer:2},
  ...
  {subject:"SocialStudies", title:"Environment: Conservation", summary:"Grade 4 Social Studies: conservation means protecting and managing natural resources wisely to prevent their depletion and preserve environments for future generations.",
   ...
   quiz:[
     {q:"Conservation means ___.", options:["only saving money","using all resources immediately","protecting and wisely managing natural resources","never using resources"], answer:2},
     ...
     {q:"Why should we conserve freshwater?", options:["Only 3% of Earth's water is fresh and accessible for drinking","Freshwater is dirty","Water is unlimited","Only fish need freshwater"], answer:0},
...
{day:16, label:"Day 16 — Mon", subjects:[
  {subject:"Language", title:"Reading: Sequencing", summary:"Grade 4 Reading strand: sequence is the order in which events happen. Signal words: first, then, next, after, finally, before.",
   ...
   quiz:[
     ...
     {q:"Why is sequence important in a how-to text?", options:["Only the first step matters","All steps can be done in any order","It is not","Steps must be in order to be followed correctly"], answer:3},
  ...
  {subject:"Science", title:"Properties of Liquids and Solids", summary:"Grade 4 Science Materials strand: solids have definite shape and volume; liquids have definite volume but take the shape of their container.",
   ...
   quiz:[
     ...
     {q:"A liquid has ___.", options:["definite shape and volume","definite volume but takes the shape of its container","no mass","no volume"], answer:1},
     {q:"Which is a solid at room temperature?", options:["Air","Water","Wood","Mercury"], answer:2},
     {q:"The property of viscosity describes ___.", options:["the colour of a liquid","how thick or resistant to flow a liquid is","how hot a liquid is","how heavy a liquid is"], answer:1},
  ...
  {subject:"SocialStudies", title:"Canadian Culture and Arts", summary:"Grade 4 Social Studies: Canadian culture reflects Indigenous traditions and the contributions of people from many nations, expressed through music, art, literature, and celebrations.",
   ...
   quiz:[
     {q:"Canada's culture is ___.", options:["only British and French","uniform and the same everywhere","only Indigenous","shaped by Indigenous peoples and immigrants from around the world"], answer:3},
     ...
     {q:"The Group of Seven were known for ___.", options:["painting Canadian landscapes in a distinct style","composing music","writing novels","playing hockey"], answer:0},
     {q:"Indigenous art often features ___.", options:["only landscapes","cultural symbols, animals, and stories of the artist's nation","only abstract shapes","only portraits"], answer:1},
...
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"Language", title:"Writing: Narrative Writing", summary:"Grade 4 Writing strand: narrative writing tells a story with a clear beginning (characters/setting), middle (problem/rising action), and end (resolution).",
   ...
   quiz:[
     ...
     {q:"The climax of a story is ___.", options:["the introduction of characters","the most exciting moment or turning point","the beginning","the setting"], answer:1},
  ...
  {subject:"SocialStudies", title:"Citizenship: Rights and Responsibilities", summary:"Grade 4 Social Studies: in a democratic society, citizens have rights (freedoms) and responsibilities (duties). Being an active citizen benefits everyone.",
   ...
   quiz:[
     ...
     {q:"Responsibilities require citizens to ___.", options:["only benefit themselves","do nothing","fulfill duties such as obeying laws and respecting others","ignore rules"], answer:2},
     {q:"Voting is both a right and a ___.", options:["responsibility","privilege only for adults","reward","punishment"], answer:0},
     {q:"Why is community involvement important?", options:["It costs too much","Only politicians should be involved","Active citizenship makes communities stronger and more just","It is not"], answer:2},
...
{day:18, label:"Day 18 — Wed", subjects:[
  ...
  {subject:"Science", title:"Physical and Chemical Changes", summary:"Grade 4 Science Materials strand: a physical change alters the form but not the substance (e.g., cutting). A chemical change produces a new substance (e.g., burning).",
   ...
   quiz:[
     ...
     {q:"A chemical change ___.", options:["is always reversible","only changes shape","produces a new substance with different properties","is the same as melting"], answer:2},
     ...
     {q:"Which observation suggests a CHEMICAL change has occurred?", options:["Change in location","Colour change, gas produced, or heat released","Change in size","Change in shape"], answer:1}
   ]},
  {subject:"SocialStudies", title:"First Nations Treaties in Canada", summary:"Grade 4 Social Studies: treaties are agreements between the Crown and First Nations peoples. They were meant to share land but were often not honoured by the government.",
   ...
   quiz:[
     {q:"A treaty is ___.", options:["a type of building","a style of artwork","a formal agreement between two or more parties","a type of land"], answer:2},
     {q:"Treaties between First Nations and the Crown involved ___.", options:["sharing land and defining rights and responsibilities","only religion","only money","only sharing food"], answer:0},
     {q:"Many treaties were NOT honoured by the government, which led to ___.", options:["displacement and loss of land and rights for First Nations peoples","more treaties being made quickly","stronger First Nations communities","peace and prosperity"], answer:0},
     {q:"Today, treaties are ___.", options:["only museum pieces","still legally binding and relevant to land and resource rights","only used in schools","forgotten documents"], answer:1},
     {q:"Learning about treaties helps Canadians ___.", options:["understand shared history and work toward reconciliation","ignore Indigenous history","focus only on recent history","avoid the topic"], answer:0}
   ]},
]},
{day:19, label:"Day 19 — Thu", subjects:[
  ...
  {subject:"SocialStudies", title:"Colonial Canada", summary:"Grade 4 Social Studies: colonial Canada (1600s–1867) was shaped by French and British settlers, the fur trade, and conflicts with and among Indigenous peoples.",
   ...
   quiz:[
     {q:"New France was the name for ___.", options:["Modern Quebec only","British settlements in Canada","Indigenous territories","French colonial territory in North America"], answer:3},
     {q:"The fur trade was important because ___.", options:["It was only about clothing","It was the main economic activity connecting Indigenous peoples and Europeans","Only Europeans benefited","Only Indigenous peoples benefited"], answer:1},
     {q:"The Acadian people were ___.", options:["American colonists","Indigenous peoples","British settlers in Nova Scotia","French-speaking settlers in Atlantic Canada"], answer:3},
...
{day:20, label:"Day 20 — Fri", subjects:[
  {subject:"Language", title:"Reading: Text Features in Non-Fiction", summary:"Grade 4 Reading strand: non-fiction text features include headings, subheadings, captions, text boxes, bold words, table of contents, index, and glossary.",
   ...
   quiz:[
     {q:"A subheading in a text ___.", options:["is unrelated to the text","is the author's name","organizes information by labelling a sub-section","introduces the whole article"], answer:2},
     {q:"A glossary provides ___.", options:["definitions of key words used in the text","the author's biography","an index of pages","pictures"], answer:0},
     {q:"An index helps readers ___.", options:["read captions","understand definitions","see the table of contents","find where specific topics are discussed (page numbers)"], answer:3},
     ...
     {q:"Text boxes in non-fiction ___.", options:["replace the main text","are errors","provide extra or supplementary information related to the topic","are always statistics"], answer:2}
   ]},
  ...
  {subject:"SocialStudies", title:"Confederation and Canadian Identity", summary:"Grade 4 Social Studies: Confederation (1867) united four provinces into the Dominion of Canada. Canadian identity includes bilingualism, multiculturalism, and respect for Indigenous peoples.",
   ...
   quiz:[
     ...
     {q:"Canadian identity is shaped by ___.", options:["only British traditions","only geography","only one cultural group","English and French heritage, Indigenous cultures, and immigration from around the world"], answer:3},
     {q:"What does 'bilingual' mean in Canada's context?", options:["Canada has two official languages: English and French","Only Quebec speaks French","Everyone speaks English","Speaking three languages"], answer:0},
     {q:"Canada became officially multicultural by law in ___.", options:["1931","2000","1867","1971 (Multiculturalism Policy) / 1988 (Act)"], answer:3},
     {q:"Canadian identity includes ___.", options:["only British traditions","only French culture","only hockey and maple syrup","kindness, diversity, democracy, rule of law, and Indigenous heritage"], answer:3}
   ]},
]},
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"Language", title:"Writing: Summary Writing", summary:"Grade 4 Writing strand: a summary is a brief restatement of the most important ideas in a text, using your own words. It does not include personal opinions.",
   ...
   quiz:[
     {q:"A summary ___.", options:["is longer than the original","briefly restates the most important ideas in your own words","includes your personal opinions","retells every detail of a text"], answer:1},
  ...
  {subject:"Science", title:"Space: Moon Phases", summary:"Grade 4 Science Earth strand: the Moon has no light of its own; it reflects sunlight. As it orbits Earth, we see different amounts of its lit side — the phases.",
   ...
   quiz:[
     ...
     {q:"The Moon phases are caused by ___.", options:["The Moon moving in and out of shadow","Earth blocking sunlight (eclipse)","The Moon changing shape","Different portions of the Moon's sunlit side being visible from Earth"], answer:3},
     ...
     {q:"A 'new moon' is when ___.", options:["It is a new month","The Moon is invisible (lit side faces away from Earth)","The Moon is smallest","We see the entire lit face"], answer:1},
  ...
  {subject:"SocialStudies", title:"Economics: Needs, Wants, Supply, and Demand", summary:"Grade 4 Social Studies: needs are essentials (food, shelter); wants are desires. Supply is how much is available; demand is how much people want.",
   ...
   quiz:[
     ...
     {q:"A 'want' is ___.", options:["the same as a need","only food and water","essential for survival","something desirable but not necessary for survival"], answer:3},
...
{day:22, label:"Day 22 — Tue", subjects:[
  {subject:"Language", title:"Writing: Procedural Texts", summary:"Grade 4 Writing strand: a procedural text (how-to) explains how to do something in step-by-step order. It uses numbered steps, imperative verbs, and clear language.",
   ...
   quiz:[
     ...
     {q:"What is essential in a procedural text?", options:["Opinions and feelings","Descriptive language only","Characters and a plot","Steps in chronological (sequential) order"], answer:3},
  ...
  {subject:"Science", title:"Conservation of Energy", summary:"Grade 4 Science Energy strand: energy cannot be created or destroyed; it can only change form. Examples: electrical → light, chemical (food) → kinetic.",
   ...
   quiz:[
     {q:"The law of conservation of energy states that energy ___.", options:["is always used up","cannot be created or destroyed, only changed in form","can be created from nothing","disappears when used"], answer:1},
     ...
     {q:"Which is an example of energy transformation?", options:["A windmill converting wind (kinetic) to electrical energy","Using a non-electric candle","Turning off all lights","Doing nothing"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Heritage Celebrations", summary:"Grade 4 Social Studies: cultural celebrations reflect the heritage and identity of communities. Understanding different celebrations builds respect and inclusion.",
   ...
   quiz:[
     {q:"A heritage celebration reflects ___.", options:["only modern pop culture","only sports","only government events","the traditions and history of a cultural community"], answer:3},
     ...
     {q:"Chinese New Year is celebrated with ___.", options:["Summer solstice","Building snowmen","parades and fireworks to mark the lunar new year","Thanksgiving food"], answer:2},
     {q:"Why is it important to acknowledge multiple cultural celebrations?", options:["Only tourists need to know","It causes confusion","It promotes understanding, respect, and inclusion in a multicultural society","It is not important"], answer:2},
     {q:"What is Remembrance Day (November 11)?", options:["A cultural celebration","A harvest festival","A day to honour veterans who served in wars","Canada's birthday"], answer:2}
   ]},
]},
{day:23, label:"Day 23 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Prepositions", summary:"Grade 4 Language strand: prepositions show the relationship between a noun and another word. Common prepositions: in, on, at, by, under, over, between, through.",
   ...
   quiz:[
     {q:"A preposition shows the ___ between words.", options:["relationship (especially location or time)","sound","colour","size"], answer:0},
     ...
     {q:"A preposition is usually followed by a ___.", options:["adjective","verb","adverb","noun or pronoun (the object of the preposition)"], answer:3}
   ]},
  {subject:"Math", title:"Division: 2-Digit Divisor Introduction", summary:"Grade 4 Number strand: students divide larger dividends by 1-digit divisors and are introduced to estimation with division.",
   ...
   quiz:[
     ...
     {q:"To check your division, you can ___.", options:["subtract the divisor","add the divisor and quotient","multiply the quotient by the divisor to get the dividend","guess again"], answer:2},
  ...
  {subject:"Science", title:"Sustainable Practices", summary:"Grade 4 Science Life Systems/Materials strand: sustainable practices reduce waste and protect the environment. The 3 Rs: Reduce, Reuse, Recycle.",
   ...
   quiz:[
     {q:"Sustainable means ___.", options:["never using resources","using as much as possible","meeting present needs without compromising future generations' ability to meet theirs","spending less money"], answer:2},
  ...
  {subject:"SocialStudies", title:"Immigration: Building Canada", summary:"Grade 4 Social Studies: immigrants have come to Canada from all over the world, contributing to its economy, culture, and identity. Immigration continues today.",
   ...
   quiz:[
     {q:"Why have people immigrated to Canada?", options:["Looking for safety, better opportunities, family reunification, or adventure","Canada is not a destination","Canada forced them","Only recently has anyone come to Canada"], answer:0},
     {q:"What is a refugee?", options:["A student studying abroad","A tourist who stays","Someone fleeing persecution, war, or disaster","A wealthy immigrant"], answer:2},
     {q:"Immigrants have contributed to Canada by ___.", options:["only speaking one language","only working in farms","causing problems","building communities, founding businesses, enriching culture, and serving in the military"], answer:3},
     ...
     {q:"Why is Canada's multicultural heritage considered a strength?", options:["It is a weakness","Diverse perspectives, skills, and ideas make Canada more innovative and resilient","Only in cities","Only some Canadians benefit"], answer:1}
   ]},
]},
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Reading Comprehension Strategies Review", summary:"Grade 4 Reading strand: skilled readers use multiple strategies: predicting, visualising, asking questions, making connections, summarising, and synthesising.",
   ...
   quiz:[
     ...
     {q:"Synthesising information means ___.", options:["only summarising","copying text exactly","creating a new understanding by combining information from multiple sources","restating information unchanged"], answer:2},
     {q:"Which strategy is best for an unfamiliar word?", options:["Ask someone immediately without trying","Stop reading","Use context clues and prior knowledge to figure out the meaning","Skip it"], answer:2}
   ]},
  ...
  {subject:"Science", title:"Year Review: Science Concepts", summary:"Grade 4 Science strand review: habitats, rocks, energy (light, sound, electricity), weather, and space.",
   ...
   quiz:[
     {q:"A food web shows ___.", options:["the structure of rock layers","how energy flows through interconnected food chains","the rock cycle","the water cycle"], answer:1},
  ...
  {subject:"SocialStudies", title:"Social Studies Year Review", summary:"Grade 4 Social Studies review: ancient civilizations, Canadian history, geography, government, economics, and citizenship.",
   ...
   quiz:[
     ...
     {q:"What is the main purpose of a government?", options:["Entertain citizens","Only fight wars","Organize society, make laws, and provide services","Only collect taxes"], answer:2},
...
{day:25, label:"Day 25 — Fri", subjects:[
  ...
  {subject:"Science", title:"Review: Ecosystems and Life Systems", summary:"Grade 4 Science review: habitats, communities, adaptations, biodiversity, human impact, and conservation.",
   ...
   quiz:[
     ...
     {q:"Biodiversity is important because ___.", options:["only scientists care","diverse ecosystems are more stable and resilient","it wastes resources","it is not"], answer:1},
     {q:"Which action BEST protects biodiversity?", options:["Creating wildlife corridors and protected areas","Draining wetlands","Introducing invasive species","Building highways through forests"], answer:0},
  ...
  {subject:"SocialStudies", title:"Review: Government and Citizenship", summary:"Grade 4 Social Studies review: types of government, rights, responsibilities, Canadian law, and civic participation.",
   ...
   quiz:[
     {q:"A democracy is a government where ___.", options:["the military runs everything","leaders are chosen by citizens through elections","the monarch holds all power","religious leaders rule"], answer:1},
     {q:"The Canadian Charter of Rights and Freedoms protects ___.", options:["fundamental rights and freedoms of all people in Canada","only English Canadians","only the rights of the government","only French Canadians"], answer:0},
     ...
     {q:"Why is an independent judiciary important?", options:["It makes laws more expensive","Only lawyers care","It is not","It ensures laws are applied fairly and governments cannot abuse power"], answer:3},
...
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Reading: Author's Purpose", summary:"Grade 4 Reading strand: the author's purpose is the reason for writing — to persuade, inform, or entertain (PIE). Identifying it helps comprehension.",
   ...
   quiz:[
     ...
     {q:"Identifying author's purpose helps readers ___.", options:["read faster","skip reading strategies","evaluate information and understand why it was written","find the plot"], answer:2}
   ]},
...
{day:27, label:"Day 27 — Tue", subjects:[
  {subject:"Language", title:"Writing: Editing and Proofreading", summary:"Grade 4 Writing strand: editing focuses on content and organization; proofreading focuses on spelling, grammar, and punctuation. Both improve the final piece.",
   ...
   quiz:[
     {q:"Editing involves ___.", options:["improving the content, structure, and clarity of writing","only punctuation","fixing spelling mistakes","copying neatly"], answer:0},
     ...
     {q:"Why is revising and editing important?", options:["Writing is always perfect first time","It is not","Only teachers need to edit","It improves the quality and clarity of writing for the reader"], answer:3},
     {q:"Which should you do first: edit content or proofread?", options:["Edit content first (big picture before details)","Do both at exactly the same time","Proofread first","Do neither"], answer:0}
   ]},
  ...
  {subject:"Science", title:"Review: Materials and Earth", summary:"Grade 4 Science review: rocks, minerals, soil, mixtures, solutions, physical/chemical changes, and the rock cycle.",
   ...
   quiz:[
     ...
     {q:"A solution differs from a mixture because ___.", options:["in a solution the solute dissolves completely and cannot be seen","mixtures are permanent","solutions always involve water","they are the same"], answer:0},
     {q:"Which is a physical change?", options:["Baking bread","Tearing paper into smaller pieces","Burning paper","Rusting iron"], answer:1},
     {q:"Soil is made of ___.", options:["only compost","only sand","rock particles, organic matter, air, and water","only clay"], answer:2},
     {q:"The rock cycle is driven by ___.", options:["only volcanoes","the water cycle","heat and pressure from Earth's interior plus weathering at the surface","only wind and rain"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Review: Canada's History and Geography", summary:"Grade 4 Social Studies review: Canadian geography, exploration, Indigenous peoples, Confederation, and citizenship.",
   ...
   quiz:[
     ...
     {q:"What is the Canadian Charter of Rights and Freedoms?", options:["A trading document","A municipal bylaw","A children's story","A document protecting fundamental rights of all people in Canada"], answer:3}
   ]},
]},
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Grammar Review", summary:"Grade 4 Language strand comprehensive grammar review: parts of speech, sentence types, punctuation, and sentence construction.",
   ...
   quiz:[
     ...
     {q:"A complex sentence contains ___.", options:["only a dependent clause","two independent clauses","no verbs","one independent clause and one dependent clause"], answer:3},
  ...
  {subject:"Science", title:"Science Review: All Strands", summary:"Grade 4 Science comprehensive review across life, earth, materials, and energy strands.",
   ...
   quiz:[
     {q:"What is biodiversity?", options:["A food chain","A weather pattern","A type of rock","The variety of living organisms in an ecosystem"], answer:3},
     ...
     {q:"The Moon's phases are caused by ___.", options:["the Moon changing shape","The Sun moving","Different portions of the Moon's sunlit side being visible from Earth","Earth's shadow"], answer:2},
     {q:"Conservation of energy means energy ___.", options:["cannot be created or destroyed, only transformed","increases when heated","is created by machines","disappears when used"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: All Topics", summary:"Grade 4 Social Studies comprehensive review across heritage, identity, government, and geography strands.",
   ...
   quiz:[
     ...
     {q:"Why are treaties important today?", options:["Only in Quebec","Only in the 1800s","They are not","They define rights to land and resources and are legally binding"], answer:3},
     ...
     {q:"Canada's multicultural heritage is ___.", options:["irrelevant today","a strength that enriches society with diverse ideas and cultures","only for big cities","a weakness"], answer:1}
   ]},
]},
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Language Arts: Oral Communication", summary:"Grade 4 Language strand: oral communication includes speaking clearly, listening actively, presenting ideas, and participating respectfully in discussions.",
   ...
   quiz:[
     {q:"Active listening means ___.", options:["looking away","waiting for your turn to talk only","interrupting to add ideas","paying attention, making eye contact, and showing you understand the speaker"], answer:3},
     ...
     {q:"Constructive feedback is ___.", options:["ignoring what someone said","only positive comments","only negative comments","specific, kind, and helpful suggestions for improvement"], answer:3},
     {q:"A debate involves ___.", options:["one person speaking alone","sharing feelings only","choosing sides and presenting arguments and counter-arguments","only asking questions"], answer:2},
     {q:"Why is oral communication important?", options:["Strong speaking and listening skills help in school, work, and daily life","Only for presentations","Computers do all communication now","Only writing matters"], answer:0}
   ]},
  {subject:"Math", title:"Math: Problem Solving Strategies", summary:"Grade 4 Mathematics: students apply strategies like drawing diagrams, making tables, working backwards, and looking for patterns to solve multi-step problems.",
   ...
   quiz:[
     {q:"Working backwards is a useful strategy when you know ___.", options:["a middle step","nothing about the problem","the starting conditions","the final result and need to find the beginning"], answer:3},
     {q:"Making a table helps to ___.", options:["organize data to find a pattern or answer","draw a picture","multiply numbers","avoid solving a problem"], answer:0},
     ...
     {q:"Drawing a diagram helps to ___.", options:["only geometry problems","skip the calculation","visualize the problem and make it easier to solve","decorate your work"], answer:2},
     {q:"Looking for a pattern helps you ___.", options:["only in number sense","predict what will come next based on what has happened so far","skip the work","guess randomly"], answer:1}
   ]},
  {subject:"Science", title:"Science: Inquiry and STEM Connections", summary:"Grade 4 Science: scientific inquiry involves asking questions, making hypotheses, testing, recording, and forming conclusions. STEM connects science, technology, engineering, and math.",
   ...
   quiz:[
     {q:"A hypothesis is ___.", options:["a proven fact","a conclusion","a best guess/prediction about the answer to a question, based on prior knowledge","a question"], answer:2},
     ...
     {q:"A conclusion should ___.", options:["list materials","be written before the experiment","introduce a new idea","state whether the hypothesis was supported and what was learned"], answer:3},
  ...
  {subject:"SocialStudies", title:"Culminating Task: Community Action Plan", summary:"Grade 4 Social Studies: students apply knowledge of communities, environment, rights, and citizenship to develop a local action plan addressing a community issue.",
   ...
   quiz:[
     {q:"A community action plan addresses ___.", options:["a local issue by identifying problems and proposing realistic solutions","only school issues","only global issues","only government problems"], answer:0},
     {q:"When presenting a community plan, you should include ___.", options:["only historical information","only pictures","only problems with no solutions","the problem, proposed solutions, and who is responsible for each action"], answer:3},
     {q:"Effective community action involves ___.", options:["only money","ignoring different viewpoints","collaboration and input from community members","only one person deciding"], answer:2},
     {q:"Which is a real example of community action?", options:["Ignoring local pollution","A petition to create a new park in a neighbourhood","Only complaining","Waiting for others to fix issues"], answer:1},
     {q:"Why do citizens need to be active in their community?", options:["Active citizens make their communities safer, healthier, and more equitable","Change is impossible","Only politicians should act","They do not"], answer:0}
   ]},
]},
{day:30, label:"Day 30 — Fri", subjects:[
  {subject:"Language", title:"Year Review: Language Arts", summary:"Grade 4 Language Arts comprehensive review covering reading, writing, oral communication, grammar, and media literacy.",
   ...
   quiz:[
     ...
     {q:"An inferring reader ___.", options:["guesses randomly","uses text evidence plus prior knowledge to understand unstated ideas","only reads the words on the page","reads very slowly"], answer:1},
     {q:"The purpose of a summary is to ___.", options:["make the text longer","include opinions","briefly restate the main ideas in your own words","retell every detail"], answer:2},
     {q:"Editing focuses on ___, while proofreading focuses on ___ .", options:["spelling, content","length, style","grammar, length","content/ideas, mechanics (spelling/grammar/punctuation)"], answer:3}
   ]},
  ...
  {subject:"Science", title:"Year Review: Science", summary:"Grade 4 Science comprehensive review across all strands.",
   ...
   quiz:[
     ...
     {q:"The Moon's phases are caused by ___.", options:["the Moon glowing itself","different amounts of the Moon's sunlit side visible from Earth","clouds","seasons"], answer:1},
  ...
  {subject:"SocialStudies", title:"Year Review: Social Studies", summary:"Grade 4 Social Studies comprehensive review.",
   ...
   quiz:[
     ...
     {q:"Rights and responsibilities in a democracy ___.", options:["go together: rights give freedom; responsibilities ensure respect for others","are opposite","only adults have them","are unrelated"], answer:0},
     {q:"Conservation means ___.", options:["only saving money","never using natural resources","wasting resources","using resources wisely for future generations"], answer:3}
   ]},
]},
];
