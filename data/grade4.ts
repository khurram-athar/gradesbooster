...
{day:1, label:"Day 1 — Mon", subjects:[
  {subject:"Language", title:"Parts of Speech", summary:"Grade 4 Language strand: nouns name people/places/things, verbs show actions, adjectives describe nouns, adverbs describe verbs.",
   ...
   quiz:[
     ...
     {q:"Which is an adjective?", options:["run","slowly","happy","eat"], answer:2},
     {q:"Adverbs often tell ___ about a verb.", options:["colour","size","how/when/where","what kind"], answer:2},
  ...
  {subject:"Math", title:"Multiplication Facts to 10×10", summary:"Grade 4 Number strand: students recall multiplication facts to 10×10 fluently and use them to solve problems.",
   ...
   quiz:[
     ...
     {q:"4 × 7 = ?", options:["24","28","32","21"], answer:1},
     {q:"9 × 9 = ?", options:["72","81","80","90"], answer:1},
  ...
  {subject:"Science", title:"Habitats and Communities", summary:"Grade 4 Science Life Systems strand: a habitat is where organisms live; a community is all the organisms sharing a habitat and interacting.",
   ...
   quiz:[
     ...
     {q:"Which is a freshwater habitat?", options:["Ocean","Desert","Pond","Tundra"], answer:2},
     {q:"Organisms in a community ___.", options:["never interact","depend on and interact with each other","live separately","eat only plants"], answer:1},
  ...
  {subject:"SocialStudies", title:"Ancient Civilizations Overview", summary:"Grade 4 Social Studies Heritage strand: ancient civilizations developed organized societies with government, art, writing, and technology.",
   ...
   quiz:[
     ...
     {q:"Ancient civilizations contributed ___.", options:["nothing to modern life","writing, government, and architecture still used today","only myths and legends","only farming"], answer:1},
     {q:"What is archaeology?", options:["The study of stars","The study of rocks","The study of human history through artifacts","A type of government"], answer:2},
     {q:"Why do we study ancient civilizations?", options:["We do not","To understand how human societies developed","Only for fun","Only for geography"], answer:1}
   ]},
]},
{day:2, label:"Day 2 — Tue", subjects:[
  ...
  {subject:"Math", title:"Division Basics", summary:"Grade 4 Number strand: division is sharing equally or grouping. Students divide with dividends to 100 using multiplication facts.",
   ...
   quiz:[
     ...
     {q:"Division is the inverse (opposite) of ___.", options:["addition","subtraction","multiplication","fractions"], answer:2},
     {q:"63 ÷ 9 = ?", options:["6","7","8","9"], answer:1},
  ...
  {subject:"Science", title:"Food Chains and Webs", summary:"Grade 4 Science Life Systems: a food chain shows energy flow from producer to consumer. A food web shows interconnected food chains.",
   ...
   quiz:[
     ...
     {q:"In a food web, arrows show ___.", options:["friendship","the direction energy flows","movement","habitat"], answer:1},
     {q:"What happens if one species in a food web disappears?", options:["Nothing changes","Other species are affected because they are connected","Only predators notice","Only prey notice"], answer:1},
  ...
  {subject:"SocialStudies", title:"Ancient Egypt", summary:"Grade 4 Social Studies: Ancient Egypt flourished along the Nile River, developing writing (hieroglyphics), monumental architecture, and complex government.",
   ...
   quiz:[
     ...
     {q:"Egyptian hieroglyphics were ___.", options:["a form of mathematics","a type of building","a writing system using pictures","a religious ceremony"], answer:2},
     {q:"The pyramids were built as ___.", options:["palaces for living pharaohs","tombs for pharaohs","temples for worship only","storage facilities"], answer:1},
     {q:"Who ruled Ancient Egypt?", options:["A president","An elected prime minister","A pharaoh (king/queen)","A group of priests"], answer:2}
   ]},
]},
{day:3, label:"Day 3 — Wed", subjects:[
  ...
  {subject:"Math", title:"2-Digit × 1-Digit Multiplication", summary:"Grade 4 Number strand: multiply 2-digit numbers by 1-digit numbers using the distributive property and place value.",
   ...
   quiz:[
     ...
     {q:"67 × 2 = ?", options:["124","134","114","144"], answer:1},
     {q:"To solve 34 × 5, you can think 30×5 + 4×5 = ?", options:["160","170","180","150"], answer:1},
  ...
  {subject:"Science", title:"Adaptations", summary:"Grade 4 Science Life Systems: adaptations are physical or behavioural features that help organisms survive in their habitat.",
   ...
   quiz:[
     ...
     {q:"A cactus stores water in its thick stem as an adaptation to ___.", options:["rainy environments","cold climates","desert environments with little rain","forest life"], answer:2},
     {q:"Which is a behavioural adaptation?", options:["Duck's webbed feet","Bird's hollow bones","Birds migrating south in winter","Fish gills"], answer:2},
  ...
  {subject:"SocialStudies", title:"Ancient Greece", summary:"Grade 4 Social Studies: Ancient Greece developed democracy, philosophy, the Olympics, and architecture that influenced the Western world.",
   ...
   quiz:[
     ...
     {q:"The Olympic Games began in ___.", options:["Rome","Greece","Egypt","China"], answer:1},
     {q:"Greek philosophers like Socrates were known for ___.", options:["building pyramids","writing hieroglyphics","asking deep questions about life and knowledge","fighting wars only"], answer:2},
     {q:"Ancient Greek architecture featured ___.", options:["mud brick walls","igloos","columns and temples like the Parthenon","underground cities"], answer:2}
   ]},
]},
{day:4, label:"Day 4 — Thu", subjects:[
  ...
  {subject:"Math", title:"Introduction to Long Division", summary:"Grade 4 Number strand: students divide 2-digit dividends by 1-digit divisors, understanding quotient and remainder.",
   ...
   quiz:[
     ...
     {q:"27 ÷ 4 = 6 remainder ___.", options:["2","3","4","1"], answer:1},
  ...
  {subject:"Science", title:"Biodiversity", summary:"Grade 4 Science Life Systems: biodiversity means the variety of living organisms in an ecosystem. Greater biodiversity usually means a healthier ecosystem.",
   ...
   quiz:[
     ...
     {q:"Which habitat has the greatest biodiversity?", options:["A parking lot","A single-crop farm","A tropical rainforest","An empty field"], answer:2},
     {q:"How does biodiversity benefit humans?", options:["It does not","It provides food, medicine, and clean air and water","Only scientists benefit","Only animals benefit"], answer:1},
  ...
  {subject:"SocialStudies", title:"Ancient Rome", summary:"Grade 4 Social Studies: Ancient Rome built a vast empire, developing law, engineering, and governance that influenced modern Western civilization.",
   ...
   quiz:[
     ...
     {q:"Roman engineering achievements include ___.", options:["pyramids","hieroglyphics","roads, aqueducts, and the arch","the Great Wall"], answer:2},
     {q:"The Roman Empire fell in ___.", options:["100 AD","476 AD","1492 AD","1066 AD"], answer:1},
     {q:"What is one way ancient Rome influences us today?", options:["No influence","Latin words in English and legal/government systems","Egyptian architecture","Greek food"], answer:1}
   ]},
]},
{day:5, label:"Day 5 — Fri", subjects:[
  ...
  {subject:"Math", title:"Fractions: Equal Parts", summary:"Grade 4 Number strand: a fraction represents equal parts of a whole. The numerator shows how many parts are selected; the denominator shows total equal parts.",
   ...
   quiz:[
     ...
     {q:"Which fraction represents half?", options:["1/3","1/4","1/2","2/3"], answer:2},
     {q:"A pizza is cut into 8 equal slices. You eat 3. What fraction did you eat?", options:["3/8","8/3","5/8","3/5"], answer:0},
  ...
  {subject:"Science", title:"Human Impact on Ecosystems", summary:"Grade 4 Science Life Systems: human activities such as deforestation, pollution, and urbanization negatively affect ecosystems; conservation actions help protect them.",
   ...
   quiz:[
     ...
     {q:"Which action helps PROTECT ecosystems?", options:["Littering","Polluting water","Creating national parks and reducing emissions","Building factories near rivers"], answer:2},
     {q:"How does pollution affect wildlife?", options:["It helps wildlife","It destroys habitats and harms organisms","Only fish are affected","Only birds are affected"], answer:1},
  ...
  {subject:"SocialStudies", title:"Indigenous Peoples of North America", summary:"Grade 4 Social Studies: Indigenous peoples of North America include many diverse nations, each with unique cultures, languages, and governance systems.",
   ...
   quiz:[
     ...
     {q:"Traditional Indigenous knowledge includes ___.", options:["only crafts","only language","ecological knowledge, governance, and cultural practices","only dance"], answer:2},
     {q:"Why is it important to learn about Indigenous cultures?", options:["It is not important","They are part of Canada's history, heritage, and identity","Only in Ontario","Only for adults"], answer:1},
     {q:"The Indian Act (1876) was ___.", options:["a celebration of Indigenous cultures","a law that restricted the rights of Indigenous peoples in Canada","a trade agreement","A school curriculum"], answer:1}
   ]},
]},
{day:6, label:"Day 6 — Mon", subjects:[
  {subject:"Language", title:"Reading: Inference", summary:"Grade 4 Reading strand: inference means using evidence from the text plus your own knowledge to understand something not directly stated.",
   ...
   quiz:[
     ...
     {q:"Maria grabbed her umbrella before leaving. You can infer ___.", options:["She is going swimming","It was probably raining or she expected rain","She likes umbrellas","She forgot her coat"], answer:1},
     {q:"The book's cover shows a spaceship. You can infer the story is about ___.", options:["Farming","Space/science fiction","Cooking","History"], answer:1},
  ...
  {subject:"Math", title:"Comparing Fractions", summary:"Grade 4 Number strand: to compare fractions with the same denominator, compare numerators. To compare different denominators, find equivalent fractions.",
   ...
   quiz:[
     ...
     {q:"1/2 is ___ 1/4.", options:["less than","equal to","greater than","not comparable to"], answer:2},
     {q:"Order from least to greatest: 3/8, 1/8, 7/8", options:["7/8, 3/8, 1/8","1/8, 3/8, 7/8","3/8, 1/8, 7/8","1/8, 7/8, 3/8"], answer:1},
  ...
  {subject:"Science", title:"Rocks and Minerals", summary:"Grade 4 Science Earth strand: rocks are made of minerals. The three rock types are igneous, sedimentary, and metamorphic, each formed by different processes.",
   ...
   quiz:[
     ...
     {q:"Sedimentary rock forms from ___.", options:["magma","layers of sediment compressed over time","magma and pressure","only volcanic activity"], answer:1},
     {q:"Metamorphic rock forms when ___.", options:["lava cools","sediment is compressed","existing rock is changed by heat and pressure","glaciers melt"], answer:2},
  ...
  {subject:"SocialStudies", title:"Early Canadian History", summary:"Grade 4 Social Studies: Canada's early history includes Indigenous peoples, European exploration, New France, and British colonization.",
   ...
   quiz:[
     ...
     {q:"Jacques Cartier was significant because ___.", options:["He built the first railway","He was the first European to sail the St. Lawrence River","He discovered gold","He founded Toronto"], answer:1},
     {q:"British and French competition for control of Canada led to ___.", options:["immediate peace","trade agreements","conflict including the Seven Years' War","no conflict"], answer:1},
     {q:"The Battle of the Plains of Abraham (1759) resulted in ___.", options:["French victory","A draw","British victory and control of New France","Indigenous victory"], answer:2}
   ]},
]},
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Writing: Paragraphs", summary:"Grade 4 Writing strand: a well-organized paragraph has a topic sentence, supporting details, and a concluding sentence. All sentences relate to one main idea.",
   ...
   quiz:[
     ...
     {q:"A concluding sentence ___.", options:["introduces the topic","adds a new idea","wraps up the paragraph and restates the main idea","asks a question"], answer:2},
     {q:"How many main ideas should one paragraph have?", options:["As many as possible","Two or three","One","None"], answer:2},
  ...
  {subject:"Math", title:"Adding Fractions with Same Denominator", summary:"Grade 4 Number strand: to add fractions with the same denominator, add the numerators and keep the denominator the same.",
   ...
   quiz:[
     ...
     {q:"3/8 + 4/8 = ?", options:["7/16","6/8","7/8","1/8"], answer:2},
     {q:"When adding fractions with the same denominator, the denominator ___.", options:["doubles","adds too","stays the same","becomes 0"], answer:2},
  ...
  {subject:"Science", title:"Rock Cycle", summary:"Grade 4 Science Earth strand: rocks cycle continuously between igneous, sedimentary, and metamorphic forms through geological processes.",
   ...
   quiz:[
     ...
     {q:"Sediment that is compressed and cemented forms ___.", options:["igneous rock","metamorphic rock","sedimentary rock","lava"], answer:2},
     {q:"When magma cools it forms ___.", options:["sedimentary rock","metamorphic rock","igneous rock","sediment"], answer:2},
  ...
  {subject:"SocialStudies", title:"European Explorers", summary:"Grade 4 Social Studies: European explorers from the 1400s–1600s sailed to North America, changing the world and affecting Indigenous peoples significantly.",
   ...
   quiz:[
     ...
     {q:"John Cabot claimed land for ___.", options:["Spain","France","England","Portugal"], answer:2},
     {q:"The arrival of Europeans had a ___ impact on Indigenous peoples.", options:["mostly positive","completely neutral","devastating — disease, displacement, and loss of culture","no impact"], answer:2},
     {q:"Samuel de Champlain is known for ___.", options:["Discovering North America","Finding gold","Founding Quebec City in 1608","Winning the Seven Years' War"], answer:2}
   ]},
]},
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"Language", title:"Writing: Descriptive Writing", summary:"Grade 4 Writing strand: descriptive writing uses sensory details (sight, sound, smell, touch, taste) and vivid language to create a clear picture for the reader.",
   ...
   quiz:[
     ...
     {q:"Vivid adjectives make writing ___.", options:["harder to read","more boring","more specific and engaging","shorter"], answer:2},
  ...
  {subject:"Math", title:"Decimals: Tenths", summary:"Grade 4 Number strand: a decimal is another way to write a fraction. Tenths represent parts of a whole divided into 10 equal parts (e.g., 0.3 = 3/10).",
   ...
   quiz:[
     ...
     {q:"What is 6 tenths as a decimal?", options:["6.0","0.06","0.6","60.0"], answer:2},
     {q:"0.1 + 0.4 = ?", options:["0.5","0.3","0.04","5.0"], answer:0},
  ...
  {subject:"Science", title:"Soil Formation", summary:"Grade 4 Science Earth strand: soil forms over thousands of years by weathering of rock and addition of organic matter. It has layers called horizons.",
   ...
   quiz:[
     ...
     {q:"Topsoil is important because ___.", options:["it is the hardest layer","it is richest in nutrients for plant growth","it contains no water","it is made of solid rock"], answer:1},
     {q:"How long does it take to form good soil?", options:["A few days","A few years","Hundreds to thousands of years","Only in rainy seasons"], answer:2},
  ...
  {subject:"SocialStudies", title:"Government: Democracy and Monarchy", summary:"Grade 4 Social Studies: governments organize society and make laws. A democracy gives citizens a voice; a monarchy is led by a king or queen.",
   ...
   quiz:[
     ...
     {q:"A constitutional monarchy means ___.", options:["the monarch has unlimited power","the monarch's power is limited by a constitution and elected government","only the monarch rules","there is no elected government"], answer:1},
     {q:"Voting is important because ___.", options:["it is not important","only wealthy people vote","citizens have a voice in choosing their government","the government decides everything anyway"], answer:1}
   ]},
]},
{day:9, label:"Day 9 — Thu", subjects:[
  {subject:"Language", title:"Writing: Persuasive Writing", summary:"Grade 4 Writing strand: persuasive writing argues for a position using reasons, evidence, and a call to action. It has a clear opinion statement.",
   ...
   quiz:[
     ...
     {q:"Which is a good opinion statement for a persuasive text?", options:["Dogs exist.","Dogs can run.","Schools should have longer lunch breaks.","Some students eat lunch."], answer:2},
     {q:"Counter-arguments in persuasive writing ___.", options:["weaken your argument","acknowledge opposing views and then refute them, strengthening your argument","are unrelated to the topic","should always be avoided"], answer:1},
  ...
  {subject:"Math", title:"Decimals: Hundredths", summary:"Grade 4 Number strand: hundredths represent parts of a whole divided into 100 equal parts. 0.23 = 23/100 = 2 tenths + 3 hundredths.",
   ...
   quiz:[
     ...
     {q:"What is 8 hundredths as a decimal?", options:["8.0","0.8","0.08","80.0"], answer:2},
     {q:"0.25 + 0.50 = ?", options:["0.75","0.25","0.70","0.55"], answer:0},
  ...
  {subject:"Science", title:"Properties of Light: Reflection", summary:"Grade 4 Science Energy strand: light travels in straight lines and reflects off surfaces. The angle of incidence equals the angle of reflection.",
   ...
   quiz:[
     ...
     {q:"Which surface reflects light best?", options:["Black velvet","Dark wood","A mirror","A sponge"], answer:2},
     {q:"The angle of incidence is ___.", options:["always 90 degrees","equal to the angle of reflection","greater than the angle of reflection","less than the angle of reflection"], answer:1},
  ...
  {subject:"SocialStudies", title:"Trade and Commerce in History", summary:"Grade 4 Social Studies: trade is the exchange of goods and services. Ancient and early modern civilizations developed trade routes that spread culture and ideas.",
   ...
   quiz:[
     ...
     {q:"Why did civilizations trade with each other?", options:["For entertainment","To access goods they could not produce themselves","Only for war","Only for art"], answer:1},
     {q:"Trade often led to ___.", options:["isolation of cultures","conflict only","spreading of ideas, technology, and culture between civilizations","only economic profit"], answer:2},
     {q:"The fur trade in early Canada involved ___.", options:["only European settlers","only Indigenous peoples","both Indigenous peoples and European settlers","only French traders"], answer:2}
   ]},
]},
{day:10, label:"Day 10 — Fri", subjects:[
  ...
  {subject:"Math", title:"Money: Making Change", summary:"Grade 4 Number strand: students calculate change by subtracting the price from the amount paid, using coins and bills up to $20.",
   ...
   quiz:[
     ...
     {q:"To calculate change, you ___.", options:["add price and amount paid","subtract the price from the amount paid","multiply the price","divide the price"], answer:1},
     {q:"An item costs $7.89. You pay $10.00. Your change is ___.", options:["$2.11","$3.11","$2.21","$3.21"], answer:0},
  ...
  {subject:"Science", title:"Properties of Light: Refraction", summary:"Grade 4 Science Energy strand: refraction is the bending of light as it passes from one medium to another (e.g., from air to water).",
   ...
   quiz:[
     ...
     {q:"A straw in a glass of water appears to be bent because of ___.", options:["reflection","refraction","absorption","diffusion"], answer:1},
     {q:"A prism separates white light into its colours because different colours ___ at different angles.", options:["absorb","emit","refract","reflect"], answer:2},
  ...
  {subject:"SocialStudies", title:"Human Rights", summary:"Grade 4 Social Studies: human rights are basic rights all people deserve. The Universal Declaration of Human Rights (UDHR, 1948) protects these rights globally.",
   ...
   quiz:[
     ...
     {q:"Which is a basic human right?", options:["Owning luxury goods","Freedom of speech and freedom from torture","Never going to school","Unlimited money"], answer:1},
     {q:"Who is responsible for upholding human rights?", options:["No one","Governments, organizations, and individuals","Only the United Nations","Only wealthy nations"], answer:1},
     {q:"Why are human rights important?", options:["They are not","They protect the dignity and equality of every person","Only politicians care about them","They only apply in certain countries"], answer:1}
   ]},
]},
{day:11, label:"Day 11 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Adverbs", summary:"Grade 4 Language strand: adverbs modify verbs, adjectives, or other adverbs. They tell how, when, where, or to what degree something happens.",
   ...
   quiz:[
     ...
     {q:"Adverbs of manner tell ___.", options:["when","where","how","to what degree"], answer:2},
  ...
  {subject:"Math", title:"Patterns: Numeric and Geometric", summary:"Grade 4 Algebra and Patterning strand: numeric patterns follow a mathematical rule; geometric patterns involve shapes. Students identify rules and extend patterns.",
   ...
   quiz:[
     ...
     {q:"A geometric pattern uses ___.", options:["numbers only","repeating or growing shapes","only colours","only lines"], answer:1},
     {q:"What is the rule? 100, 90, 80, 70...", options:["subtract 5","subtract 10","subtract 20","add 10"], answer:1},
  ...
  {subject:"Science", title:"Sound: Vibration and Frequency", summary:"Grade 4 Science Energy strand: sounds are made by vibrations. Frequency determines pitch — higher frequency = higher pitch. Amplitude determines volume.",
   ...
   quiz:[
     ...
     {q:"A high-frequency sound has a ___ pitch.", options:["low","medium","high","no"], answer:2},
     {q:"Amplitude of a sound wave determines its ___.", options:["pitch","speed","volume (loudness)","frequency"], answer:2},
  ...
  {subject:"SocialStudies", title:"Canadian Geography: Provinces and Territories", summary:"Grade 4 Social Studies: Canada has 10 provinces and 3 territories. Each has a capital city and distinct geographic features.",
   ...
   quiz:[
     ...
     {q:"What is the largest province in Canada by area?", options:["Ontario","British Columbia","Alberta","Quebec"], answer:3},
     {q:"What is Canada's capital city?", options:["Toronto","Ottawa","Montreal","Vancouver"], answer:1},
     {q:"Which territory is the newest, created in 1999?", options:["Yukon","Northwest Territories","Nunavut","British Columbia"], answer:2}
   ]},
]},
{day:12, label:"Day 12 — Tue", subjects:[
  ...
  {subject:"Math", title:"Geometry: Angles", summary:"Grade 4 Geometry strand: an angle is formed by two rays with a common endpoint. A right angle = 90°, acute angle < 90°, obtuse angle > 90°.",
   ...
   quiz:[
     ...
     {q:"An obtuse angle measures ___.", options:["less than 90°","exactly 90°","between 90° and 180°","more than 180°"], answer:2},
     {q:"A straight angle measures ___.", options:["90°","45°","180°","270°"], answer:2},
  ...
  {subject:"Science", title:"Pulleys and Gears", summary:"Grade 4 Science Energy strand: pulleys and gears are simple machines that redirect or change force. Gears can speed up or slow down motion and change direction.",
   ...
   quiz:[
     ...
     {q:"A moveable pulley ___ the force needed.", options:["doubles","keeps the same","reduces by about half","triples"], answer:2},
     {q:"When two gears mesh, they rotate in ___ directions.", options:["the same","opposite","random","no"], answer:1},
  ...
  {subject:"SocialStudies", title:"Ontario Geography", summary:"Grade 4 Social Studies: Ontario is Canada's most populous province with diverse geography including the Great Lakes, Canadian Shield, and Great Lakes–St. Lawrence Lowlands.",
   ...
   quiz:[
     ...
     {q:"The most populous city in Ontario is ___.", options:["Ottawa","Hamilton","London","Toronto"], answer:3},
     {q:"Ontario's provincial capital is ___.", options:["Ottawa","Toronto","Hamilton","Kingston"], answer:1},
     {q:"Which region of Ontario is most suited for farming?", options:["Canadian Shield","Northern Ontario","Great Lakes–St. Lawrence Lowlands","Hudson Bay Lowlands"], answer:2}
   ]},
]},
{day:13, label:"Day 13 — Wed", subjects:[
  {subject:"Language", title:"Reading: Compare and Contrast", summary:"Grade 4 Reading strand: comparing shows how two things are alike; contrasting shows how they differ. Signal words: both, similarly, however, but, in contrast.",
   ...
   quiz:[
     ...
     {q:"Which signal word shows a contrast?", options:["Similarly","Also","Both","However"], answer:3},
     {q:"A Venn diagram helps ___.", options:["add numbers","compare and contrast two or more things","write paragraphs","draw maps"], answer:1},
  ...
  {subject:"Math", title:"Area and Perimeter", summary:"Grade 4 Measurement strand: perimeter is the distance around a shape; area is the space inside. Area of a rectangle = length × width; perimeter = 2(l + w).",
   ...
   quiz:[
     ...
     {q:"A rectangle is 5 cm long and 3 cm wide. Area = ?", options:["8 cm²","15 cm²","16 cm²","10 cm²"], answer:1},
  ...
  {subject:"Science", title:"Electricity: Static and Current", summary:"Grade 4 Science Energy strand: static electricity is a build-up of charge; current electricity is a flow of electrons through a conductor.",
   ...
   quiz:[
     ...
     {q:"Which is a good conductor of electricity?", options:["Rubber","Wood","Copper wire","Glass"], answer:2},
     {q:"An insulator ___.", options:["allows electricity to flow freely","blocks the flow of electricity","creates static electricity","has no electrical properties"], answer:1},
  ...
  {subject:"SocialStudies", title:"Maps: Physical Features", summary:"Grade 4 Social Studies: physical maps show natural features like mountains, rivers, lakes, and plains. They use colour and symbols to represent terrain.",
   ...
   quiz:[
     ...
     {q:"What is a legend (key) on a map?", options:["The title","A table that explains the symbols used on the map","North arrow","Scale bar"], answer:1},
     {q:"Which tool on a map shows distance?", options:["Legend","North arrow","Scale bar","Title"], answer:2},
     {q:"The Rocky Mountains in Canada are located in ___.", options:["Eastern Canada","Atlantic provinces","Western Canada","Central Ontario"], answer:2}
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  ...
  {subject:"Math", title:"Metric Measurement: Length", summary:"Grade 4 Measurement strand: the metric system uses kilometres (km), metres (m), centimetres (cm), and millimetres (mm). 1 m = 100 cm; 1 km = 1000 m.",
   ...
   quiz:[
     ...
     {q:"Which unit would you use to measure the length of a pencil?", options:["Kilometres","Metres","Centimetres","Grams"], answer:2},
     {q:"Which unit would you use to measure the distance between two cities?", options:["Centimetres","Millimetres","Metres","Kilometres"], answer:3},
  ...
  {subject:"Science", title:"Electric Circuits", summary:"Grade 4 Science Energy strand: a complete circuit allows electricity to flow. It needs a power source, conductors, and a load (device). Circuits can be series or parallel.",
   ...
   quiz:[
     ...
     {q:"In a series circuit, components are connected ___.", options:["in parallel paths","one after another in one loop","randomly","in a grid"], answer:1},
     {q:"In a parallel circuit, each branch has ___.", options:["the same current as all others","its own direct path to the power source","no power at all","only one component"], answer:1},
  ...
  {subject:"SocialStudies", title:"Canada's Natural Resources", summary:"Grade 4 Social Studies: Canada is rich in natural resources including forests, minerals, freshwater, oil, and agricultural land. These support the economy but must be managed sustainably.",
   ...
   quiz:[
     ...
     {q:"What energy resource does Alberta have in large quantities?", options:["Coal only","Iron ore","Oil and natural gas","Gold"], answer:2},
     {q:"Sustainable use of resources means ___.", options:["using them as fast as possible","never using them","using them in a way that does not deplete them for future generations","only using what you can carry"], answer:2},
     {q:"Which province is known for potash mining?", options:["Ontario","Nova Scotia","Saskatchewan","Newfoundland"], answer:2}
   ]},
]},
{day:15, label:"Day 15 — Fri", subjects:[
  ...
  {subject:"Math", title:"Mass and Volume Measurement", summary:"Grade 4 Measurement strand: mass is measured in grams (g) and kilograms (kg). Volume is measured in litres (L) and millilitres (mL). 1 kg = 1000 g; 1 L = 1000 mL.",
   ...
   quiz:[
     ...
     {q:"Which unit measures how heavy something is?", options:["Litre","Millilitre","Kilometre","Kilogram"], answer:3},
     {q:"Which unit measures the amount of liquid in a bottle?", options:["Kilogram","Kilometre","Millilitre/Litre","Centimetre"], answer:2},
  ...
  {subject:"Science", title:"Forces: Gravity and Friction", summary:"Grade 4 Science Energy strand: gravity is the force that pulls objects toward Earth. Friction is the force that resists movement between surfaces in contact.",
   ...
   quiz:[
     ...
     {q:"Which surface creates MORE friction?", options:["Ice","A polished marble floor","Rough sandpaper","A wet road"], answer:2},
     {q:"Friction produces ___.", options:["cold temperatures","heat and slows objects down","more gravity","electrical charge"], answer:1},
  ...
  {subject:"SocialStudies", title:"Environment: Conservation", summary:"Grade 4 Social Studies: conservation means protecting and managing natural resources wisely to prevent their depletion and preserve environments for future generations.",
   ...
   quiz:[
     ...
     {q:"Canada Day (July 1) celebrates ___.", options:["The founding of Ontario","Canada becoming a nation in 1867","Conservation week","Indigenous peoples' day"], answer:1},
     {q:"Why should we conserve freshwater?", options:["Water is unlimited","Only 3% of Earth's water is fresh and accessible for drinking","Freshwater is dirty","Only fish need freshwater"], answer:1},
     {q:"Which action MOST helps conserve forests?", options:["Cutting down all old trees","Paper recycling and sustainable forestry","Never entering forests","Using more wood products"], answer:1}
   ]},
]},
{day:16, label:"Day 16 — Mon", subjects:[
  ...
  {subject:"Science", title:"Properties of Liquids and Solids", summary:"Grade 4 Science Materials strand: solids have definite shape and volume; liquids have definite volume but take the shape of their container.",
   ...
   quiz:[
     ...
     {q:"Which is a solid at room temperature?", options:["Water","Air","Wood","Mercury"], answer:2},
     {q:"The property of viscosity describes ___.", options:["how heavy a liquid is","how thick or resistant to flow a liquid is","the colour of a liquid","how hot a liquid is"], answer:1},
  ...
  {subject:"SocialStudies", title:"Canadian Culture and Arts", summary:"Grade 4 Social Studies: Canadian culture reflects Indigenous traditions and the contributions of people from many nations, expressed through music, art, literature, and celebrations.",
   ...
   quiz:[
     ...
     {q:"The Group of Seven were known for ___.", options:["writing novels","composing music","painting Canadian landscapes in a distinct style","playing hockey"], answer:2},
     {q:"Indigenous art often features ___.", options:["only abstract shapes","cultural symbols, animals, and stories of the artist's nation","only portraits","only landscapes"], answer:1},
     {q:"Why is celebrating cultural arts important?", options:["It is not important","Arts preserve culture, identity, and history","Only professional artists need it","Only for entertainment"], answer:1}
   ]},
]},
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"Language", title:"Writing: Narrative Writing", summary:"Grade 4 Writing strand: narrative writing tells a story with a clear beginning (characters/setting), middle (problem/rising action), and end (resolution).",
   ...
   quiz:[
     ...
     {q:"The climax of a story is ___.", options:["the beginning","the most exciting moment or turning point","the setting","the introduction of characters"], answer:1},
     {q:"The resolution of a narrative is ___.", options:["the problem","how the story begins","how the problem is solved","the climax"], answer:2},
  ...
  {subject:"Math", title:"Data: Line Graphs", summary:"Grade 4 Data strand: a line graph shows how data changes over time. Points are connected by a line to show trends: increasing, decreasing, or stable.",
   ...
   quiz:[
     ...
     {q:"An upward-sloping line on a graph shows ___.", options:["data is decreasing","data is staying the same","data is increasing","data is random"], answer:2},
     {q:"Which data set is best shown in a line graph?", options:["Favourite sports of 30 students","Daily temperature over one week","Number of each type of fruit in a bowl","Animal habitats"], answer:1},
  ...
  {subject:"Science", title:"Mixtures and Solutions", summary:"Grade 4 Science Materials strand: a mixture is made of two or more substances combined physically. A solution is a mixture where one substance dissolves completely in another.",
   ...
   quiz:[
     ...
     {q:"What is a solvent?", options:["The substance that is dissolved","The substance that does the dissolving","A type of magnet","A type of acid"], answer:1},
     {q:"Which is an example of a solution?", options:["Sand and water (sand settles)","Salad (mixed vegetables)","Salt dissolved in water","Oil and water (they separate)"], answer:2},
  ...
  {subject:"SocialStudies", title:"Citizenship: Rights and Responsibilities", summary:"Grade 4 Social Studies: in a democratic society, citizens have rights (freedoms) and responsibilities (duties). Being an active citizen benefits everyone.",
   ...
   quiz:[
     ...
     {q:"Voting is both a right and a ___.", options:["punishment","reward","responsibility","privilege only for adults"], answer:2},
     {q:"Why is community involvement important?", options:["It is not","Active citizenship makes communities stronger and more just","Only politicians should be involved","It costs too much"], answer:1},
     {q:"Which is an example of civic responsibility?", options:["Littering","Ignoring elections","Paying taxes and following laws","Only caring about yourself"], answer:2}
   ]},
]},
{day:18, label:"Day 18 — Wed", subjects:[
  ...
  {subject:"Science", title:"Physical and Chemical Changes", summary:"Grade 4 Science Materials strand: a physical change alters the form but not the substance (e.g., cutting). A chemical change produces a new substance (e.g., burning).",
   ...
   quiz:[
     ...
     {q:"Which is a PHYSICAL change?", options:["Burning wood","Rusting iron","Baking a cake","Cutting paper"], answer:3},
     {q:"Which is a CHEMICAL change?", options:["Melting ice","Dissolving salt in water","Tearing paper","Burning candle wax"], answer:3},
  ...
  {subject:"SocialStudies", title:"First Nations Treaties in Canada", summary:"Grade 4 Social Studies: treaties are agreements between the Crown and First Nations peoples. They were meant to share land but were often not honoured by the government.",
   ...
   quiz:[
     ...
     {q:"Many treaties were NOT honoured by the government, which led to ___.", options:["peace and prosperity","displacement and loss of land and rights for First Nations peoples","stronger First Nations communities","more treaties being made quickly"], answer:1},
     {q:"Today, treaties are ___.", options:["forgotten documents","still legally binding and relevant to land and resource rights","only museum pieces","only used in schools"], answer:1},
     {q:"Learning about treaties helps Canadians ___.", options:["ignore Indigenous history","understand shared history and work toward reconciliation","focus only on recent history","avoid the topic"], answer:1}
   ]},
]},
{day:19, label:"Day 19 — Thu", subjects:[
  ...
  {subject:"Math", title:"3-Digit × 1-Digit Multiplication", summary:"Grade 4 Number strand: multiply 3-digit numbers by 1-digit numbers using expanded form and the standard algorithm.",
   ...
   quiz:[
     ...
     {q:"To solve 234 × 5, you can expand: (200×5) + (30×5) + (4×5) = ?", options:["1140","1170","1200","1070"], answer:1},
     {q:"326 × 3 = ?", options:["968","978","958","998"], answer:1},
  ...
  {subject:"Science", title:"Weather Patterns and Water Cycle", summary:"Grade 4 Science Earth strand: the water cycle involves evaporation, condensation, and precipitation. Weather is caused by movements of air masses.",
   ...
   quiz:[
     ...
     {q:"Precipitation includes ___.", options:["only rain","rain, snow, sleet, and hail","only snow","evaporation and condensation"], answer:1},
  ...
  {subject:"SocialStudies", title:"Colonial Canada", summary:"Grade 4 Social Studies: colonial Canada (1600s–1867) was shaped by French and British settlers, the fur trade, and conflicts with and among Indigenous peoples.",
   ...
   quiz:[
     ...
     {q:"The Acadian people were ___.", options:["British settlers in Nova Scotia","French-speaking settlers in Atlantic Canada","Indigenous peoples","American colonists"], answer:1},
     {q:"When did Canada become a country?", options:["1492","1759","1867","1914"], answer:2},
     {q:"The British North America Act (1867) created ___.", options:["New France","The Dominion of Canada (Confederation)","The Indian Act","The fur trade"], answer:1}
   ]},
]},
{day:20, label:"Day 20 — Fri", subjects:[
  {subject:"Language", title:"Reading: Text Features in Non-Fiction", summary:"Grade 4 Reading strand: non-fiction text features include headings, subheadings, captions, text boxes, bold words, table of contents, index, and glossary.",
   ...
   quiz:[
     ...
     {q:"An index helps readers ___.", options:["find where specific topics are discussed (page numbers)","understand definitions","see the table of contents","read captions"], answer:0},
     {q:"Bold words in a text usually indicate ___.", options:["errors","important vocabulary terms","the author's favourite words","unrelated information"], answer:1},
  ...
  {subject:"Math", title:"Elapsed Time", summary:"Grade 4 Measurement strand: elapsed time is the amount of time that passes between a start time and an end time.",
   ...
   quiz:[
     ...
     {q:"3:00 p.m. + 2 hours 40 minutes = ?", options:["5:00 p.m.","5:40 p.m.","6:00 p.m.","4:40 p.m."], answer:1},
     {q:"A task starts at 10:45 a.m. and takes 1 h 30 min. It ends at?", options:["11:15 a.m.","12:15 p.m.","12:45 p.m.","11:45 a.m."], answer:1},
  ...
  {subject:"Science", title:"Space: The Solar System", summary:"Grade 4 Science Earth strand: our solar system has the Sun at its centre and 8 planets, plus moons, asteroids, and comets orbiting it.",
   ...
   quiz:[
     ...
     {q:"Which is the largest planet?", options:["Saturn","Earth","Jupiter","Neptune"], answer:2},
     {q:"Planets closer to the Sun are generally ___.", options:["colder","warmer","made of gas","invisible"], answer:1},
...
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"Language", title:"Writing: Summary Writing", summary:"Grade 4 Writing strand: a summary is a brief restatement of the most important ideas in a text, using your own words. It does not include personal opinions.",
   ...
   quiz:[
     ...
     {q:"A summary should be ___.", options:["longer than the original text","the same length as the original","shorter than the original","any length"], answer:2},
     {q:"Which is NOT appropriate in a summary?", options:["The main idea","Key supporting details","The author's conclusion","Your personal opinion or new information"], answer:3},
  ...
  {subject:"Math", title:"Equivalent Fractions", summary:"Grade 4 Number strand: equivalent fractions represent the same value even though they have different numerators and denominators. Example: 1/2 = 2/4 = 4/8.",
   ...
   quiz:[
     ...
     {q:"To find an equivalent fraction, multiply or divide the numerator and denominator by the ___.", options:["0","1","same number","different numbers"], answer:2},
     {q:"Is 3/4 equivalent to 6/8?", options:["No","Yes","Cannot tell","Only sometimes"], answer:1},
...
{day:22, label:"Day 22 — Tue", subjects:[
  {subject:"Language", title:"Writing: Procedural Texts", summary:"Grade 4 Writing strand: a procedural text (how-to) explains how to do something in step-by-step order. It uses numbered steps, imperative verbs, and clear language.",
   ...
   quiz:[
     ...
     {q:"What is essential in a procedural text?", options:["Opinions and feelings","Steps in chronological (sequential) order","Descriptive language only","Characters and a plot"], answer:1},
     {q:"A materials or ingredients list in a procedural text comes ___.", options:["after all the steps","in the middle","before the steps","at the end"], answer:2},
  ...
  {subject:"Math", title:"Geometry: 3D Figures", summary:"Grade 4 Geometry strand: 3D figures have length, width, and height. Key figures: cube, rectangular prism, cylinder, cone, sphere, pyramid.",
   ...
   quiz:[
     ...
     {q:"Which 3D figure has no edges or vertices?", options:["Cube","Cylinder","Sphere","Cone"], answer:2},
     {q:"A cone has how many curved surface(s)?", options:["0","1","2","3"], answer:1},
  ...
  {subject:"Science", title:"Conservation of Energy", summary:"Grade 4 Science Energy strand: energy cannot be created or destroyed; it can only change form. Examples: electrical → light, chemical (food) → kinetic.",
   ...
   quiz:[
     ...
     {q:"A light bulb converts electrical energy into ___.", options:["chemical energy","sound energy","light and heat energy","mechanical energy"], answer:2},
     {q:"Solar panels convert ___ energy to ___ energy.", options:["chemical, electrical","sound, light","light (solar), electrical","kinetic, nuclear"], answer:2},
  ...
  {subject:"SocialStudies", title:"Heritage Celebrations", summary:"Grade 4 Social Studies: cultural celebrations reflect the heritage and identity of communities. Understanding different celebrations builds respect and inclusion.",
   ...
   quiz:[
     ...
     {q:"Chinese New Year is celebrated with ___.", options:["parades and fireworks to mark the lunar new year","Thanksgiving food","Summer solstice","Building snowmen"], answer:0},
     {q:"Why is it important to acknowledge multiple cultural celebrations?", options:["It is not important","It promotes understanding, respect, and inclusion in a multicultural society","Only tourists need to know","It causes confusion"], answer:1},
     {q:"What is Remembrance Day (November 11)?", options:["Canada's birthday","A day to honour veterans who served in wars","A harvest festival","A cultural celebration"], answer:1}
   ]},
]},
{day:23, label:"Day 23 — Wed", subjects:[
  ...
  {subject:"Math", title:"Division: 2-Digit Divisor Introduction", summary:"Grade 4 Number strand: students divide larger dividends by 1-digit divisors and are introduced to estimation with division.",
   ...
   quiz:[
     ...
     {q:"75 ÷ 5 = ?", options:["13","14","15","16"], answer:2},
     {q:"To check your division, you can ___.", options:["guess again","multiply the quotient by the divisor to get the dividend","add the divisor and quotient","subtract the divisor"], answer:1},
  ...
  {subject:"SocialStudies", title:"Immigration: Building Canada", summary:"Grade 4 Social Studies: immigrants have come to Canada from all over the world, contributing to its economy, culture, and identity. Immigration continues today.",
   ...
   quiz:[
     ...
     {q:"Immigrants have contributed to Canada by ___.", options:["causing problems","building communities, founding businesses, enriching culture, and serving in the military","only working in farms","only speaking one language"], answer:1},
     {q:"What is multiculturalism?", options:["Everyone having the same culture","A policy recognizing and valuing cultural diversity","Only two cultures existing","Ignoring different cultures"], answer:1},
     {q:"Why is Canada's multicultural heritage considered a strength?", options:["It is a weakness","Diverse perspectives, skills, and ideas make Canada more innovative and resilient","Only some Canadians benefit","Only in cities"], answer:1}
   ]},
]},
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Reading Comprehension Strategies Review", summary:"Grade 4 Reading strand: skilled readers use multiple strategies: predicting, visualising, asking questions, making connections, summarising, and synthesising.",
   ...
   quiz:[
     ...
     {q:"A text-to-world connection is ___.", options:["connecting the text to another book","connecting the text to your personal experience","connecting the text to what you know about the world","connecting to a film"], answer:2},
     {q:"Synthesising information means ___.", options:["copying text exactly","creating a new understanding by combining information from multiple sources","only summarising","restating information unchanged"], answer:1},
  ...
  {subject:"Math", title:"Review: Number Sense and Operations", summary:"Grade 4 Number strand review: students demonstrate fluency with multiplication, division, fractions, and decimals.",
   ...
   quiz:[
     ...
     {q:"1/2 + 1/2 = ?", options:["1/4","1/2","1","2"], answer:2},
     {q:"0.3 + 0.6 = ?", options:["0.8","0.9","1.0","0.7"], answer:1},
  ...
  {subject:"Science", title:"Year Review: Science Concepts", summary:"Grade 4 Science strand review: habitats, rocks, energy (light, sound, electricity), weather, and space.",
   ...
   quiz:[
     ...
     {q:"The Moon reflects ___.", options:["its own light","sunlight","starlight","earthlight"], answer:1},
  ...
  {subject:"SocialStudies", title:"Social Studies Year Review", summary:"Grade 4 Social Studies review: ancient civilizations, Canadian history, geography, government, economics, and citizenship.",
   ...
   quiz:[
     ...
     {q:"Canada has ___ provinces and ___ territories.", options:["9, 4","10, 3","8, 4","10, 4"], answer:1},
     {q:"What is the main purpose of a government?", options:["Entertain citizens","Organize society, make laws, and provide services","Only collect taxes","Only fight wars"], answer:1},
     {q:"Which is a right of Canadian citizens?", options:["Destroying property","Free speech and equality under the law","Ignoring all rules","Having unlimited money"], answer:1}
   ]},
]},
{day:25, label:"Day 25 — Fri", subjects:[
  ...
  {subject:"Math", title:"Coordinate Grid", summary:"Grade 4 Geometry strand: students locate and plot points on a coordinate grid using ordered pairs (x, y). The x-axis is horizontal; y-axis is vertical.",
   ...
   quiz:[
     ...
     {q:"To plot the point (4, 2), you move ___ right and ___ up.", options:["2 right, 4 up","4 right, 2 up","4 up, 2 right","2 up, 4 right"], answer:1},
     {q:"The origin of a coordinate grid is at ___.", options:["(1, 1)","(0, 0)","(1, 0)","(0, 1)"], answer:1},
  ...
  {subject:"Science", title:"Review: Ecosystems and Life Systems", summary:"Grade 4 Science review: habitats, communities, adaptations, biodiversity, human impact, and conservation.",
   ...
   quiz:[
     ...
     {q:"Biodiversity is important because ___.", options:["it is not","diverse ecosystems are more stable and resilient","only scientists care","it wastes resources"], answer:1},
     {q:"Which action BEST protects biodiversity?", options:["Building highways through forests","Draining wetlands","Creating wildlife corridors and protected areas","Introducing invasive species"], answer:2},
  ...
  {subject:"SocialStudies", title:"Review: Government and Citizenship", summary:"Grade 4 Social Studies review: types of government, rights, responsibilities, Canadian law, and civic participation.",
   ...
   quiz:[
     ...
     {q:"Civic responsibility includes ___.", options:["voting and following laws","ignoring local issues","never volunteering","only paying taxes when asked"], answer:0},
     {q:"Why is an independent judiciary important?", options:["It is not","It ensures laws are applied fairly and governments cannot abuse power","Only lawyers care","It makes laws more expensive"], answer:1},
     {q:"Canada's head of government is ___.", options:["The King/Queen","The Governor General","The Prime Minister","The Chief Justice"], answer:2}
   ]},
]},
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Reading: Author's Purpose", summary:"Grade 4 Reading strand: the author's purpose is the reason for writing — to persuade, inform, or entertain (PIE). Identifying it helps comprehension.",
   ...
   quiz:[
     ...
     {q:"A commercial trying to sell shoes has the purpose to ___.", options:["inform","entertain","persuade","describe"], answer:2},
     {q:"A funny picture book has the purpose to ___.", options:["inform","persuade","entertain","instruct"], answer:2},
  ...
  {subject:"Math", title:"Review: Measurement", summary:"Grade 4 Measurement review: length, mass, volume, elapsed time, area, and perimeter.",
   ...
   quiz:[
     ...
     {q:"1 kg = ___ g.", options:["10","100","1000","10000"], answer:2},
     {q:"A task from 9:20 a.m. to 11:05 a.m. takes?", options:["1 h 45 min","2 h 15 min","1 h 35 min","2 h 5 min"], answer:0},
  ...
  {subject:"Science", title:"Review: Energy Forms and Changes", summary:"Grade 4 Science Energy review: light, sound, electricity, circuits, forces, simple machines.",
   ...
   quiz:[
     ...
     {q:"A complete circuit needs a power source, ___, and a load.", options:["water","insulator","conductor/wire","vacuum"], answer:2},
     {q:"Refraction occurs when light passes from one ___ to another.", options:["colour","direction","medium","source"], answer:2},
  ...
  {subject:"SocialStudies", title:"Review: Ancient Civilizations", summary:"Grade 4 Social Studies review: Egypt, Greece, Rome, and their contributions to modern society.",
   ...
   quiz:[
     ...
     {q:"The Roman contribution of ___ influences modern law and government.", options:["hieroglyphics","the Olympic Games","legal and governmental systems","papyrus"], answer:2},
     {q:"Which civilization used the Silk Road for trade?", options:["Ancient Egypt","Ancient Greece","Ancient Rome","Ancient China and Rome both used it"], answer:3},
     {q:"Which ancient civilization was located in present-day Italy?", options:["Greece","Egypt","Rome","Mesopotamia"], answer:2}
   ]},
]},
{day:27, label:"Day 27 — Tue", subjects:[
  {subject:"Language", title:"Writing: Editing and Proofreading", summary:"Grade 4 Writing strand: editing focuses on content and organization; proofreading focuses on spelling, grammar, and punctuation. Both improve the final piece.",
   ...
   quiz:[
     ...
     {q:"The acronym COPS (Capitals, Organization, Punctuation, Spelling) is a ___.", options:["writing style","proofreading checklist","paragraph structure","story type"], answer:1},
     {q:"Why is revising and editing important?", options:["It is not","It improves the quality and clarity of writing for the reader","Only teachers need to edit","Writing is always perfect first time"], answer:1},
  ...
  {subject:"Math", title:"Review: Data and Probability", summary:"Grade 4 Data review: tally charts, bar graphs, line graphs, pictographs, and probability.",
   ...
   quiz:[
     ...
     {q:"P(rolling 6 on a fair die) = ?", options:["1/6","1/3","1/2","2/6"], answer:0},
     {q:"P(picking red from 3 red and 7 blue) = ?", options:["7/10","3/7","3/10","10/3"], answer:2},
  ...
  {subject:"Science", title:"Review: Materials and Earth", summary:"Grade 4 Science review: rocks, minerals, soil, mixtures, solutions, physical/chemical changes, and the rock cycle.",
   ...
   quiz:[
     ...
     {q:"Which is a physical change?", options:["Burning paper","Rusting iron","Baking bread","Tearing paper into smaller pieces"], answer:3},
     {q:"Soil is made of ___.", options:["only sand","rock particles, organic matter, air, and water","only clay","only compost"], answer:1},
  ...
  {subject:"SocialStudies", title:"Review: Canada's History and Geography", summary:"Grade 4 Social Studies review: Canadian geography, exploration, Indigenous peoples, Confederation, and citizenship.",
   ...
   quiz:[
     ...
     {q:"The largest province by area is ___.", options:["Ontario","British Columbia","Alberta","Quebec"], answer:3},
     {q:"Treaties between the Crown and First Nations are ___.", options:["old and irrelevant","still legally binding","fiction","only about money"], answer:1},
     {q:"What is the Canadian Charter of Rights and Freedoms?", options:["A children's story","A trading document","A document protecting fundamental rights of all people in Canada","A municipal bylaw"], answer:2}
   ]},
]},
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Grammar Review", summary:"Grade 4 Language strand comprehensive grammar review: parts of speech, sentence types, punctuation, and sentence construction.",
   ...
   quiz:[
     ...
     {q:"Which punctuation separates items in a list?", options:["Period","Comma","Exclamation mark","Question mark"], answer:1},
     {q:"What is a clause?", options:["A type of word","A word with a prefix","A group of words with a subject and verb","Only a dependent phrase"], answer:2},
  ...
  {subject:"Math", title:"Math Review: All Strands", summary:"Grade 4 Mathematics comprehensive review covering number, geometry, measurement, patterning, and data.",
   ...
   quiz:[
     ...
     {q:"What is the next number? 3, 6, 12, 24, ___", options:["30","36","48","42"], answer:2},
     {q:"Which fraction is greater: 3/4 or 5/8?", options:["5/8","3/4","Equal","Cannot tell"], answer:1},
  ...
  {subject:"Science", title:"Science Review: All Strands", summary:"Grade 4 Science comprehensive review across life, earth, materials, and energy strands.",
   ...
   quiz:[
     ...
     {q:"A complete circuit requires ___.", options:["only a battery","power source, conductor, and a load","only wires","a magnet"], answer:1},
     {q:"The Moon's phases are caused by ___.", options:["the Moon changing shape","Earth's shadow","Different portions of the Moon's sunlit side being visible from Earth","The Sun moving"], answer:2},
  ...
  {subject:"SocialStudies", title:"Social Studies Review: All Topics", summary:"Grade 4 Social Studies comprehensive review across heritage, identity, government, and geography strands.",
   ...
   quiz:[
     ...
     {q:"Why are treaties important today?", options:["They are not","They define rights to land and resources and are legally binding","Only in Quebec","Only in the 1800s"], answer:1},
     {q:"Sustainable resource use means ___.", options:["using all resources now","never using resources","using resources so future generations can also benefit","only using renewable energy"], answer:2},
     {q:"Canada's multicultural heritage is ___.", options:["a weakness","a strength that enriches society with diverse ideas and cultures","only for big cities","irrelevant today"], answer:1}
   ]},
]},
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Language Arts: Oral Communication", summary:"Grade 4 Language strand: oral communication includes speaking clearly, listening actively, presenting ideas, and participating respectfully in discussions.",
   ...
   quiz:[
     ...
     {q:"Constructive feedback is ___.", options:["only negative comments","specific, kind, and helpful suggestions for improvement","only positive comments","ignoring what someone said"], answer:1},
     {q:"A debate involves ___.", options:["one person speaking alone","choosing sides and presenting arguments and counter-arguments","only asking questions","sharing feelings only"], answer:1},
  ...
  {subject:"Math", title:"Math: Problem Solving Strategies", summary:"Grade 4 Mathematics: students apply strategies like drawing diagrams, making tables, working backwards, and looking for patterns to solve multi-step problems.",
   ...
   quiz:[
     ...
     {q:"A multi-step problem requires ___.", options:["only one operation","two or more steps to solve","a calculator always","reading once and guessing"], answer:1},
     {q:"Drawing a diagram helps to ___.", options:["decorate your work","visualize the problem and make it easier to solve","skip the calculation","only geometry problems"], answer:1},
  ...
  {subject:"Science", title:"Science: Inquiry and STEM Connections", summary:"Grade 4 Science: scientific inquiry involves asking questions, making hypotheses, testing, recording, and forming conclusions. STEM connects science, technology, engineering, and math.",
   ...
   quiz:[
     ...
     {q:"The dependent variable is ___.", options:["what you change","what you keep the same","what you measure (the result)","the materials list"], answer:2},
     {q:"A conclusion should ___.", options:["introduce a new idea","state whether the hypothesis was supported and what was learned","list materials","be written before the experiment"], answer:1},
  ...
  {subject:"SocialStudies", title:"Culminating Task: Community Action Plan", summary:"Grade 4 Social Studies: students apply knowledge of communities, environment, rights, and citizenship to develop a local action plan addressing a community issue.",
   ...
   quiz:[
     ...
     {q:"Effective community action involves ___.", options:["only one person deciding","collaboration and input from community members","ignoring different viewpoints","only money"], answer:1},
     {q:"Which is a real example of community action?", options:["Ignoring local pollution","A petition to create a new park in a neighbourhood","Waiting for others to fix issues","Only complaining"], answer:1},
     {q:"Why do citizens need to be active in their community?", options:["They do not","Active citizens make their communities safer, healthier, and more equitable","Only politicians should act","Change is impossible"], answer:1}
   ]},
]},
{day:30, label:"Day 30 — Fri", subjects:[
  {subject:"Language", title:"Year Review: Language Arts", summary:"Grade 4 Language Arts comprehensive review covering reading, writing, oral communication, grammar, and media literacy.",
   ...
   quiz:[
     ...
     {q:"An inferring reader ___.", options:["only reads the words on the page","uses text evidence plus prior knowledge to understand unstated ideas","guesses randomly","reads very slowly"], answer:1},
     {q:"The purpose of a summary is to ___.", options:["retell every detail","include opinions","briefly restate the main ideas in your own words","make the text longer"], answer:2},
  ...
  {subject:"Math", title:"Year Review: Mathematics", summary:"Grade 4 Mathematics comprehensive review: all strands.",
   ...
   quiz:[
     ...
     {q:"0.6 + 0.7 = ?", options:["1.2","1.3","1.0","0.13"], answer:1},
     {q:"Area of a 7 cm × 4 cm rectangle = ?", options:["22 cm²","28 cm²","14 cm²","11 cm²"], answer:1},
  ...
  {subject:"Science", title:"Year Review: Science", summary:"Grade 4 Science comprehensive review across all strands.",
   ...
   quiz:[
     ...
     {q:"Refraction is the ___ of light.", options:["reflection","absorption","bending (change of direction)","speeding up"], answer:2},
     {q:"The Moon's phases are caused by ___.", options:["clouds","different amounts of the Moon's sunlit side visible from Earth","the Moon glowing itself","seasons"], answer:1},
  ...
  {subject:"SocialStudies", title:"Year Review: Social Studies", summary:"Grade 4 Social Studies comprehensive review.",
   ...
   quiz:[
     ...
     {q:"Canada has ___ official languages.", options:["1","2","3","4"], answer:1},
     {q:"Rights and responsibilities in a democracy ___.", options:["are opposite","go together: rights give freedom; responsibilities ensure respect for others","are unrelated","only adults have them"], answer:1},
     {q:"Conservation means ___.", options:["wasting resources","using resources wisely for future generations","never using natural resources","only saving money"], answer:1}
   ]},
]},
];
