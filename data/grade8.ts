...
{day:1, label:"Day 1 — Mon", subjects:[
  {subject:"Language", title:"Reading Strategies: Inference and Evidence", summary:"Readers make inferences by combining text evidence with background knowledge. Students practise identifying implicit meaning and citing specific textual evidence.",
   ...
   quiz:[
     ...
     {q:"When an author implies something without stating it directly, readers must ___.", options:["skip that part","ask the teacher","make an inference using context clues and prior knowledge","only read literal statements"], answer:2},
     {q:"Which question requires an inference to answer?", options:["What year was the novel published?","How many characters are in the story?","Why does the character seem afraid even though she smiles?","What is the title of the book?"], answer:2},
  ...
  {subject:"Math", title:"Number Sense: Powers and Scientific Notation", summary:"Students work with powers (base and exponent), evaluate expressions, and write large/small numbers in scientific notation.",
   ...
   quiz:[
     ...
     {q:"Scientific notation writes numbers as ___.", options:["fractions","a number between 1 and 10 multiplied by a power of 10","a number times 100","decimals only"], answer:1},
     {q:"Write 34 000 in scientific notation.", options:["3.4 × 10³","34 × 10³","3.4 × 10⁴","0.34 × 10⁵"], answer:2},
  ...
  {subject:"Science", title:"Cells: Structure and Function", summary:"Students examine the cell as the basic unit of life. They compare plant and animal cells and identify organelles and their functions.",
   ...
   quiz:[
     ...
     {q:"Mitochondria are responsible for ___.", options:["storing water","producing proteins","photosynthesis only","producing energy (ATP) through cellular respiration"], answer:3},
     {q:"Which structure is found in plant cells but NOT in animal cells?", options:["Nucleus","Cell membrane","Mitochondria","Cell wall and chloroplasts"], answer:3},
  ...
  {subject:"History", title:"New France: Colonisation and Society", summary:"Students explore the establishment of New France, the role of the fur trade, relations with Indigenous peoples, and French colonial society.",
   ...
   quiz:[
     ...
     {q:"The Catholic Church in New France played ___.", options:["no role","a minor economic role only","a central role in education, social services, and cultural life — it was the most powerful institution","a purely political role"], answer:2},
     {q:"Relations between French colonists and Indigenous peoples were shaped by ___.", options:["complete cooperation always","competition and conflict only","a complex mix of trade alliances (especially with the Huron-Wendat), military alliances, cultural exchange, and devastating disease and displacement","total indifference on both sides"], answer:2},
     {q:"Samuel de Champlain's significance to New France includes ___.", options:["he only explored, never settled","founding Quebec City (1608), mapping New France, forging Indigenous alliances, and governing the colony","defeating the British in battle","discovering the St. Lawrence River"], answer:1}
   ]},
]},
{day:2, label:"Day 2 — Tue", subjects:[
  {subject:"Language", title:"Writing: Thesis Development", summary:"Students craft strong thesis statements for analytical and argumentative essays. A thesis must be specific, debatable, and guide the essay's argument.",
   ...
   quiz:[
     ...
     {q:"A thesis statement appears ___.", options:["only in the conclusion","throughout every paragraph","at the end of the introduction paragraph, guiding the reader into the body of the essay","at the beginning of each body paragraph"], answer:2},
     {q:"A debatable thesis means ___.", options:["it is obviously true","it cannot be argued against","it is obviously false","a reasonable person could disagree with or argue against it"], answer:3},
  ...
  {subject:"Math", title:"Proportional Reasoning: Rates and Ratios", summary:"Students solve problems involving unit rates, proportions, and percent change. They distinguish proportional from non-proportional relationships.",
   ...
   quiz:[
     ...
     {q:"A proportion states that ___.", options:["two sums are equal","two products are equal","two differences are equal","two ratios are equal"], answer:3},
     {q:"Solve the proportion: 3/4 = x/20", options:["x = 12","x = 15","x = 16","x = 5"], answer:1},
  ...
  {subject:"Science", title:"Cells: Cell Division and Specialisation", summary:"Students explore mitosis (cell division for growth and repair), meiosis (for reproduction), and how cells specialise into tissues, organs, and systems.",
   ...
   quiz:[
     ...
     {q:"Cell specialisation means ___.", options:["all cells look the same","cells change into random types","cells develop specific structures and functions suited to a particular role in the organism","only occurs in plants"], answer:2},
     {q:"The correct order of organisation from smallest to largest is ___.", options:["organ → tissue → cell → organ system","cell → tissue → organ → organ system → organism","tissue → cell → organ → organism","organism → organ → tissue → cell"], answer:1},
  ...
  {subject:"History", title:"The British Conquest and After", summary:"Students examine the Seven Years' War in North America (1756–1763), the Battle of the Plains of Abraham, and the subsequent British governance of Quebec.",
   ...
   quiz:[
     ...
     {q:"The Royal Proclamation of 1763 ___.", options:["ignored Indigenous peoples","gave Quebec to France","established British governance in Quebec and recognised Indigenous peoples' land rights west of the Appalachians","abolished the fur trade"], answer:2},
     {q:"The Quebec Act of 1774 ___.", options:["made English the only language","abolished Catholicism in Quebec","restored French civil law, protected the Catholic Church, and expanded Quebec's territory — angering American colonists","granted Quebec independence"], answer:2},
     {q:"For French Canadians after the conquest, the most pressing concern was ___.", options:["economic development only","preserving their language, religion, civil law, and cultural identity under British rule","joining the American colonies","establishing a new French empire"], answer:2}
   ]},
]},
{day:3, label:"Day 3 — Wed", subjects:[
  {subject:"Language", title:"Literary Analysis: Themes in Fiction", summary:"Students identify and analyse the major themes in fiction. They support thematic interpretations with specific textual evidence and consider how different readers may interpret the same theme.",
   ...
   quiz:[
     ...
     {q:"Which is a theme (not a topic)?", options:["Friendship","War","Love","Unchecked ambition leads to self-destruction"], answer:3},
     {q:"A text can have ___.", options:["only one theme","exactly two themes","no themes","multiple themes that may even seem to contradict each other"], answer:3},
  ...
  {subject:"Math", title:"Linear Equations: Solving Multi-Step", summary:"Students solve multi-step linear equations with variables on one or both sides. They check solutions by substitution.",
   ...
   quiz:[
     ...
     {q:"To solve an equation with variables on both sides, first ___.", options:["multiply both sides by zero","add the variables together","collect variable terms on one side and constant terms on the other","ignore one side"], answer:2},
     {q:"Check: Is x = 4 a solution to 5x − 3 = 17?", options:["No, because 5(4) − 3 = 17 ✓","Yes, because 5(4) − 3 = 17 ✓","No, because 17 ≠ 20","Yes, but the equation is wrong"], answer:1},
  ...
  {subject:"Science", title:"Reproduction: Sexual and Asexual", summary:"Students compare sexual and asexual reproduction in plants and animals. They understand the advantages of each strategy in different contexts.",
   ...
   quiz:[
     ...
     {q:"An advantage of asexual reproduction is ___.", options:["genetic diversity","slower reproduction","rapid reproduction without a mate, useful in stable environments","resistance to disease"], answer:2},
     {q:"An advantage of sexual reproduction is ___.", options:["only one parent needed","faster reproduction","no energy cost","genetic variation, which increases a population's ability to adapt to changing environments"], answer:3},
  ...
  {subject:"History", title:"Loyalists and the American Revolution", summary:"Students examine why the American Revolution occurred, who the Loyalists were, and how their migration to Canada shaped British North America.",
   ...
   quiz:[
     ...
     {q:"Why did many Loyalists migrate to what is now Canada after 1783?", options:["They were forced out of Canada","They preferred the climate","They faced persecution in the United States and sought refuge in British territories","They received no land grants"], answer:2},
     {q:"The arrival of Loyalists in British North America led to ___.", options:["the creation of New France","the founding of Upper Canada (Ontario) and New Brunswick as separate colonies","the end of British rule","the departure of all French settlers"], answer:1},
     {q:"The Constitutional Act of 1791 divided Quebec into ___.", options:["Upper and Lower Canada, with separate elected assemblies","three provinces","one united colony","independent states"], answer:0}
   ]},
]},
{day:4, label:"Day 4 — Thu", subjects:[
  {subject:"Language", title:"Grammar: Sentence Variety and Syntax", summary:"Students use a variety of sentence structures (simple, compound, complex, compound-complex) to improve writing fluency and impact. They avoid common errors like comma splices and run-ons.",
   ...
   quiz:[
     ...
     {q:"Which is a run-on sentence?", options:["She ran quickly.","Although it was late, he stayed.","She ran quickly, and he followed.","The storm arrived we had no warning."], answer:3},
     {q:"Sentence variety improves writing because ___.", options:["longer sentences are always better","shorter sentences are always better","varied sentence structures create rhythm, emphasise key points, and keep readers engaged","only grammar matters"], answer:2},
  ...
  {subject:"Math", title:"Geometry: Pythagorean Theorem", summary:"Students understand and apply the Pythagorean Theorem (a² + b² = c²) to find missing side lengths in right triangles and solve real-world problems.",
   ...
   quiz:[
     ...
     {q:"A right triangle has legs of 3 cm and 4 cm. The hypotenuse = ?", options:["5 cm","7 cm","6 cm","25 cm"], answer:0},
     {q:"A ladder 10 m long leans against a wall. The base is 6 m from the wall. How high does it reach?", options:["8 m","7 m","4 m","16 m"], answer:0},
  ...
  {subject:"Science", title:"Fluids: Properties and Pressure", summary:"Students explore the properties of fluids (liquids and gases), viscosity, density, buoyancy, and how pressure works in fluids.",
   ...
   quiz:[
     ...
     {q:"An object floats when ___.", options:["it is very large","it is made of metal","its density is less than the density of the fluid it is placed in","its density is greater than the fluid"], answer:2},
     {q:"Pressure in a fluid increases with ___.", options:["decreasing depth","increasing depth (due to the increasing weight of fluid above)","the colour of the fluid","only temperature"], answer:1},
  ...
  {subject:"History", title:"The War of 1812", summary:"Students examine the causes, key battles, and consequences of the War of 1812 for Canada, the United States, Britain, and Indigenous peoples.",
   ...
   quiz:[
     ...
     {q:"The burning of York (now Toronto) in 1813 ___.", options:["ended the war","was a British victory","was an American victory that destroyed the capital of Upper Canada","had no military significance"], answer:2},
     {q:"The Treaty of Ghent (1814) ended the war ___.", options:["with clear American victory","with clear British victory","largely restoring pre-war boundaries — neither side gained or lost significant territory","with Canadian independence"], answer:2},
     {q:"The War of 1812 contributed to Canadian identity by ___.", options:["proving Canada wanted to join the United States","having no lasting impact","creating a sense of shared defence and pride among colonists who had helped repel American invasion","leading to Confederation immediately"], answer:2}
   ]},
]},
{day:5, label:"Day 5 — Fri", subjects:[
  {subject:"Language", title:"Media Literacy: Bias and Perspective", summary:"Students identify bias in media sources. They understand how word choice, framing, omission, and visual selection can shape audience perception.",
   ...
   quiz:[
     ...
     {q:"Omission bias in media occurs when ___.", options:["everything relevant is included","only negative news is published","important information that would change the reader's interpretation is left out","only images are used"], answer:2},
     {q:"To read media critically, you should ___.", options:["trust all major outlets","trust no sources","consider the source's ownership, funding, stated purpose, and whether multiple credible sources report the same information","only read social media"], answer:2},
  ...
  {subject:"Math", title:"Analytic Geometry: Slope and y-intercept", summary:"Students calculate slope from two points, write equations in slope-intercept form (y = mx + b), and graph linear equations.",
   ...
   quiz:[
     ...
     {q:"The slope of a line through (1,2) and (3,8) is ___.", options:["2","3","4","6"], answer:1},
  ...
  {subject:"Science", title:"Fluids: Hydraulics and Pneumatics", summary:"Students explore how hydraulic and pneumatic systems use fluid pressure to transmit force and do work. They examine real-world applications.",
   ...
   quiz:[
     ...
     {q:"A hydraulic lift works because ___.", options:["the fluid is heated","Pascal's principle: pressure applied to an enclosed liquid is transmitted equally in all directions, multiplying force over a larger area","the piston is magnetic","gravity pulls the fluid"], answer:1},
     {q:"Which is a real-world application of hydraulics?", options:["Bicycle tyres","Hot-air balloons","Car brakes and construction equipment","Speakers"], answer:2},
  ...
  {subject:"History", title:"Responsible Government and Reform", summary:"Students examine the Rebellions of 1837, the Durham Report, and the achievement of Responsible Government in 1848.",
   ...
   quiz:[
     ...
     {q:"The Durham Report (1839) recommended ___.", options:["independence for Canada","keeping the existing system","uniting Upper and Lower Canada and eventually granting responsible government","separating the colonies further"], answer:2},
     {q:"Responsible government means ___.", options:["the governor has total power","only appointed officials govern","the executive (cabinet) is responsible to (must maintain the confidence of) the elected legislative assembly, not to the Crown","elected officials can be overruled by Britain at any time"], answer:2},
     {q:"Responsible government was achieved in the Province of Canada in ___.", options:["1791","1837","1867","1848, when the governor accepted that the elected majority must govern"], answer:3}
   ]},
]},
{day:6, label:"Day 6 — Mon", subjects:[
  {subject:"Language", title:"Reading: Non-Fiction Structures", summary:"Students identify and analyse different non-fiction text structures: cause/effect, compare/contrast, problem/solution, chronological order, and description.",
   ...
   quiz:[
     ...
     {q:"A problem/solution structure ___.", options:["lists events in order","describes two things side by side","compares two texts","identifies an issue and proposes one or more ways to address it"], answer:3},
     {q:"Chronological order text structure ___.", options:["always discusses causes","presents events or steps in time sequence","compares two ideas","explains why something happened"], answer:1},
  ...
  {subject:"Math", title:"Geometry: Circle Measurements", summary:"Students calculate circumference (C = πd or 2πr) and area (A = πr²) of circles and apply these formulas in real-world contexts.",
   ...
   quiz:[
     ...
     {q:"A circle has radius 5 cm. Circumference = ? (use π ≈ 3.14)", options:["15.70 cm","78.5 cm","31.4 cm","62.8 cm"], answer:2},
     {q:"A circle has diameter 10 m. Area = ? (use π ≈ 3.14)", options:["31.4 m²","78.5 m²","314 m²","15.7 m²"], answer:1},
  ...
  {subject:"Science", title:"Cells: Genetics Introduction", summary:"Students are introduced to heredity — how traits pass from parents to offspring through genes and chromosomes. They explore dominant/recessive alleles and Punnett squares.",
   ...
   quiz:[
     ...
     {q:"A dominant allele ___.", options:["is always expressed in the phenotype even if only one copy is present","only shows when two copies are present","is always harmful","is rarer than recessive alleles"], answer:0},
     {q:"A recessive allele ___.", options:["always shows in the phenotype","disappears after one generation","is expressed in the phenotype only when two copies (homozygous recessive) are present","is always beneficial"], answer:2},
  ...
  {subject:"History", title:"Confederation: Causes and Process", summary:"Students explore the political, economic, and military pressures that led to Confederation in 1867 and the roles of the Fathers of Confederation.",
   ...
   quiz:[
     ...
     {q:"The British North America Act (1867) created ___.", options:["a republic","a fully independent nation immediately","the Dominion of Canada, a federal state with Ontario, Quebec, Nova Scotia, and New Brunswick as founding provinces","a colony of France"], answer:2},
     {q:"Who was the first Prime Minister of Canada?", options:["George-Étienne Cartier","D'Arcy McGee","Thomas D'Arcy McGee","Sir John A. Macdonald"], answer:3},
     {q:"Federal division of powers means ___.", options:["only the federal government has power","only provinces have power","some powers belong to the federal government, some to provinces, and some are shared","Confederation was temporary"], answer:2}
   ]},
]},
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Writing: Analytical Paragraph (PEEL)", summary:"Students write well-structured analytical paragraphs using the PEEL structure: Point, Evidence, Explanation, Link.",
   ...
   quiz:[
     ...
     {q:"'Explanation' in PEEL means ___.", options:["another piece of evidence","the topic sentence repeated","the analysis that explains HOW the evidence supports the point","the conclusion"], answer:2},
     {q:"'Link' in PEEL means ___.", options:["the opening sentence","the evidence sentence","a sentence that connects the paragraph back to the thesis or forward to the next idea","another analysis"], answer:2},
  ...
  {subject:"Math", title:"Data Management: Probability", summary:"Students calculate theoretical and experimental probability, including compound events. They use tree diagrams and sample spaces.",
   ...
   quiz:[
     ...
     {q:"A tree diagram helps find probabilities by ___.", options:["drawing only one branch","visually showing all possible outcomes of sequential events through branching","eliminating impossible events","replacing calculations"], answer:1},
     {q:"The probability of flipping heads twice in a row is ___.", options:["1/2","1/4","1/3","2/4"], answer:1},
  ...
  {subject:"Science", title:"Systems in Action: Mechanical Systems", summary:"Students explore mechanical systems including gears, pulleys, levers, and how these are combined in machines to change force, speed, and direction.",
   ...
   quiz:[
     ...
     {q:"Mechanical advantage is ___.", options:["the number of gears in a system","the ratio of output force to input force — it tells you how much a machine multiplies force","the speed of the machine","the size of the machine"], answer:1},
     {q:"A fixed pulley changes ___.", options:["the magnitude of force","the mechanical advantage only","the direction of force (you pull down to lift up) but not the magnitude","both force and direction equally"], answer:2},
  ...
  {subject:"History", title:"Building a Nation: 1867–1900", summary:"Students examine how Canada expanded after Confederation: Manitoba (1870), BC (1871), CPR, North-West Resistance, and the numbered treaties.",
   ...
   quiz:[
     ...
     {q:"The North-West Resistance of 1885 was led by ___.", options:["John A. Macdonald","George-Étienne Cartier","Gabriel Dumont and Louis Riel, defending Métis land rights in what is now Saskatchewan","Tecumseh"], answer:2},
     {q:"Louis Riel is a controversial historical figure because ___.", options:["he was never important","history is unambiguous about him","he was executed for treason by the Canadian government, but is also seen as a defender of Métis rights and a Father of Manitoba","he was a British loyalist"], answer:2},
     {q:"Manitoba joined Confederation in 1870 as a result of ___.", options:["a Canadian military conquest","a federal election","the Red River Resistance, in which Riel negotiated Manitoba's entry as a province with protections for Métis land and language","a British proclamation"], answer:2}
   ]},
]},
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"Language", title:"Oral Communication: Formal Presentation Skills", summary:"Students plan and deliver a formal presentation. They apply skills in organisation, eye contact, voice projection, pacing, and responding to questions.",
   ...
   quiz:[
     ...
     {q:"Pacing in a presentation means ___.", options:["how many slides you use","the number of facts you include","controlling the speed of delivery — speaking slowly enough to be understood but briskly enough to hold attention","only the conclusion"], answer:2},
     {q:"When responding to an audience question, you should ___.", options:["ignore it","pretend you didn't hear","restate the question to ensure everyone heard it, then answer clearly and honestly — admitting if you don't know","argue with the questioner"], answer:2},
  ...
  {subject:"Math", title:"Integers and Rational Numbers", summary:"Students extend operations to all integers and rational numbers. They add, subtract, multiply, and divide positive and negative fractions and decimals.",
   ...
   quiz:[
     ...
     {q:"(−2/3) + (1/2) = ___.", options:["−1/6","1/6","−1/2","3/5"], answer:0},
     {q:"The product of a positive and a negative number is always ___.", options:["positive","zero","negative","undefined"], answer:2},
  ...
  {subject:"Science", title:"Optics: Light, Colour, and Vision", summary:"Students extend their understanding of light, exploring how the eye perceives colour, how additive and subtractive colour mixing works, and modern applications of optics.",
   ...
   quiz:[
     ...
     {q:"The human retina has two types of photoreceptors ___.", options:["only rods","only cones","rods (sensitive to low light/motion) and cones (sensitive to colour and fine detail)","rods and lenses"], answer:2},
     {q:"Colour blindness occurs when ___.", options:["the cornea is damaged","rods are missing","one or more types of cone cells are absent or malfunctioning, making certain colours indistinguishable","the pupil cannot dilate"], answer:2},
  ...
  {subject:"History", title:"Immigration and Social Change 1867–1914", summary:"Students examine waves of immigration to Canada, the experiences of newcomers, discriminatory policies, and cultural changes in the late 19th and early 20th century.",
   ...
   quiz:[
     ...
     {q:"The Komagata Maru incident (1914) demonstrated ___.", options:["Canada's open immigration policy","Canada's commitment to diversity","Canada's racially discriminatory immigration policies, which excluded most non-European immigrants","Canada's military strength"], answer:2},
     {q:"Clifford Sifton's immigration policy in the 1890s–1900s targeted ___.", options:["immigrants from Asia","immigrants from the Caribbean","primarily farmers from Eastern Europe (Ukrainians, Poles) and the United States to settle the Prairies","skilled urban workers from Britain only"], answer:2},
     {q:"Early immigrant experiences often included ___.", options:["immediate full acceptance","automatic citizenship and land grants","discrimination, language barriers, harsh pioneer conditions, and pressure to assimilate while trying to maintain cultural identity","only positive experiences"], answer:2}
   ]},
]},
{day:9, label:"Day 9 — Thu", subjects:[
  ...
  {subject:"Math", title:"Analytic Geometry: Systems of Equations", summary:"Students solve systems of two linear equations graphically and algebraically (substitution method).",
   ...
   quiz:[
     ...
     {q:"To solve a system by substitution: solve one equation for one variable, then ___.", options:["solve the same equation again","substitute that expression into the other equation and solve for the remaining variable","add the equations","multiply the equations"], answer:1},
     {q:"Solve: y = 2x + 1 and y = −x + 7", options:["x = 2, y = 5","x = 3, y = 7","x = 2, y = 7","x = 1, y = 3"], answer:0},
  ...
  {subject:"Science", title:"Cells: Biotechnology and Ethics", summary:"Students explore how biotechnology (genetic engineering, CRISPR, cloning, GMOs) applies cell biology, and consider ethical questions raised by these technologies.",
   ...
   quiz:[
     ...
     {q:"A GMO (genetically modified organism) is ___.", options:["only a cloned animal","any organism bred through natural selection","an organism whose genome has been altered through genetic engineering to express a desired trait","only a plant"], answer:2},
     {q:"One benefit of GM crops is ___.", options:["they are always more expensive","they never affect ecosystems","they can be engineered for higher yields, pest resistance, drought tolerance, or enhanced nutrition","they eliminate all farming"], answer:2},
  ...
  {subject:"History", title:"World War I: Canada's Experience", summary:"Students examine Canada's military contributions, the home front, the conscription crisis, and how WWI changed Canada's international standing.",
   ...
   quiz:[
     ...
     {q:"Women's contribution on the home front during WWI led to ___.", options:["no changes","stricter restrictions","women being granted the right to vote federally in 1918 (with exclusions for some women)","women being banned from public life"], answer:2},
     {q:"Trench warfare was characterised by ___.", options:["fast movement and cavalry charges","no casualties","a rapid victory for the Allies","static defensive lines, extremely high casualties, mud, disease, and the use of artillery and poison gas"], answer:3},
     {q:"The end of WWI left Canada with ___.", options:["no international recognition","the same colonial status as before","greater international status and autonomy, having signed the Treaty of Versailles separately, reflecting growing independence from Britain","a weakened military"], answer:2}
   ]},
]},
{day:10, label:"Day 10 — Fri", subjects:[
  {subject:"Language", title:"Independent Reading: Novel Study Launch", summary:"Students select a novel for in-depth study. They track character, plot, setting, theme, and author's craft through journals and analytical response tasks.",
   ...
   quiz:[
     ...
     {q:"Point of view affects a novel because ___.", options:["it only changes the narrator's name","it has no effect","the narrator's perspective shapes what information readers access, which characters they trust, and how they interpret events","it only matters in non-fiction"], answer:2},
     {q:"A motif in literature is ___.", options:["the protagonist's goal","a recurring element (image, symbol, idea) that develops and deepens the work's themes","the chapter structure only","the physical description of the setting"], answer:1},
  ...
  {subject:"Math", title:"Measurement: Surface Area and Volume of 3D Solids", summary:"Students calculate surface area and volume of prisms, cylinders, cones, and spheres using formulas.",
   ...
   quiz:[
     ...
     {q:"A cylinder has radius 3 cm and height 10 cm. Volume = ? (π ≈ 3.14)", options:["94.2 cm³","282.6 cm³","188.4 cm³","94.2 cm²"], answer:1},
  ...
  {subject:"Science", title:"Systems in Action: Fluid Systems", summary:"Students connect fluid properties to engineered systems, examining hydraulic and pneumatic applications, and designing simple fluid systems.",
   ...
   quiz:[
     ...
     {q:"A hydraulic jack multiplies force because ___.", options:["the piston is magnetic","pressure is transmitted equally in all directions, and a small force on a small piston creates high pressure that acts on a much larger piston","friction helps","it uses electricity"], answer:1},
     {q:"Pneumatic systems (e.g., air brakes on buses) have the advantage of ___.", options:["being completely noiseless","requiring no energy","using compressed air, which is readily available, clean, and safe (air leaks are not harmful like oil leaks)","producing more force than hydraulics always"], answer:2},
  ...
  {subject:"History", title:"The Great Depression and Canada", summary:"Students examine the causes and impact of the Great Depression (1929–1939) on Canadians, and the political and social responses it generated.",
   ...
   quiz:[
     ...
     {q:"The 'On to Ottawa Trek' (1935) was ___.", options:["a tourism campaign","a military march","a protest march by unemployed Canadians from western relief camps to Ottawa to demand government action, ending in the Regina Riot","a political convention"], answer:2},
     {q:"The Social Credit and CCF parties grew during the Depression because ___.", options:["traditional parties solved all problems","Canadians were satisfied with the government response","widespread suffering and failure of traditional parties to provide relief led voters to support new political movements offering alternatives","both parties had existed for decades"], answer:2}
   ]},
]},
{day:11, label:"Day 11 — Mon", subjects:[
  {subject:"Language", title:"Writing: The Research Essay — Sources and Integration", summary:"Students find, evaluate, and ethically integrate source material into a research essay. They practise paraphrasing, quoting, and citing sources.",
   ...
   quiz:[
     ...
     {q:"A direct quotation should be used when ___.", options:["you want to avoid summarising","the original wording is especially powerful, precise, or authoritative — and you always include a citation","you can't understand the source","you want to make your essay longer"], answer:1},
     {q:"Signal phrases (e.g., 'According to Smith...' or 'Historians argue...') are used to ___.", options:["hide sources","replace citations","introduce sources smoothly and attribute ideas to their authors within your text","only begin essays"], answer:2},
  ...
  {subject:"Math", title:"Patterning: Arithmetic and Geometric Sequences", summary:"Students identify, extend, and create arithmetic sequences (constant difference) and geometric sequences (constant ratio). They write general terms.",
   ...
   quiz:[
     ...
     {q:"The arithmetic sequence 5, 8, 11, 14... has a common difference of ___.", options:["5","8","3","11"], answer:2},
     {q:"The geometric sequence 2, 6, 18, 54... has a common ratio of ___.", options:["2","3","6","4"], answer:1},
  ...
  {subject:"Science", title:"Cells: The Immune System", summary:"Students explore how the body defends itself — physical barriers, innate immunity, and adaptive immunity (B cells, T cells, antibodies, vaccines).",
   ...
   quiz:[
     ...
     {q:"B cells of the adaptive immune system produce ___.", options:["red blood cells","antibodies that bind to specific antigens on pathogens, marking them for destruction","only hormones","physical barriers"], answer:1},
     {q:"Vaccines work by ___.", options:["killing all bacteria","curing active infection","introducing a harmless form of an antigen to train the adaptive immune system to respond quickly if the real pathogen is encountered","replacing antibodies"], answer:2},
  ...
  {subject:"History", title:"WWII: Canada's Role", summary:"Students examine Canada's military contributions to WWII — the Battle of Britain, Dieppe, Sicily, D-Day — and the impact on the home front.",
   ...
   quiz:[
     ...
     {q:"On D-Day (June 6, 1944), Canadian forces landed at ___.", options:["Gold Beach","Utah Beach","Sword Beach","Juno Beach, one of five Allied landing zones in the Normandy invasion"], answer:3},
     {q:"On the home front, Japanese Canadians during WWII were ___.", options:["treated equally","celebrated for contributions","protected by the government","forcibly relocated to internment camps and had their property confiscated — a serious historical injustice"], answer:3},
     {q:"By the end of WWII, Canada's military contribution had ___.", options:["diminished Canada's international standing","had no lasting effect","firmly established Canada as an independent middle power with significant international influence","resulted in colonial dependence"], answer:2}
   ]},
]},
{day:12, label:"Day 12 — Tue", subjects:[
  {subject:"Language", title:"Novel Study: Character and Conflict", summary:"Students analyse how conflict shapes character development. They distinguish types of conflict and trace how characters respond and change.",
   ...
   quiz:[
     ...
     {q:"How does conflict drive a narrative?", options:["It slows the story down","It is optional","It creates tension, forces characters to make choices, and drives the plot forward through rising action toward the climax","Only in action stories"], answer:2},
     {q:"A character foil is ___.", options:["a character who never changes","the antagonist always","a character whose contrasting traits highlight qualities of the protagonist","the narrator"], answer:2},
  ...
  {subject:"Math", title:"Financial Literacy: Simple and Compound Interest", summary:"Students calculate simple interest (I = Prt) and compound interest, and understand the difference in long-term growth.",
   ...
   quiz:[
     ...
     {q:"The 'power of compound interest' refers to ___.", options:["interest rates decreasing over time","debt disappearing faster","the exponential growth of an investment because interest earns interest, producing much larger returns over time","simple addition of interest"], answer:2},
  ...
  {subject:"Science", title:"Fluids: Environmental Applications", summary:"Students connect fluid properties to environmental contexts — ocean currents, atmospheric pressure, water treatment, and the effects of pollution on fluid systems.",
   ...
   quiz:[
     ...
     {q:"Water treatment plants use ___.", options:["only chemicals","only filters","physical filtration, chemical treatment (chlorination), and sometimes UV disinfection to remove pathogens and contaminants","boiling only"], answer:2},
     {q:"Oil spills are particularly harmful to marine ecosystems because ___.", options:["oil is naturally present in oceans","oil is easily cleaned up","oil floats on water, reducing oxygen exchange, coating marine animals, and persisting in the food chain","they only affect fish"], answer:2},
  ...
  {subject:"History", title:"The Cold War and Canada", summary:"Students examine the Cold War, Canada's role in NATO, the Korean War, the Cuban Missile Crisis, and peacekeeping.",
   ...
   quiz:[
     ...
     {q:"The Cuban Missile Crisis (1962) involved ___.", options:["Canada and Britain","France and Germany","the US and USSR in a 13-day nuclear standoff after the USSR placed missiles in Cuba — the closest the Cold War came to nuclear war","China and the US"], answer:2},
     {q:"UN peacekeeping was pioneered by ___.", options:["John A. Macdonald","Lester B. Pearson, whose proposal to end the Suez Crisis (1956) earned him the Nobel Peace Prize and established Canada's identity as a peacekeeper","Pierre Trudeau","Tommy Douglas"], answer:1},
     {q:"Canada's participation in NORAD (1958) involved ___.", options:["economic cooperation only","cultural exchange","joint Canada-US air defence of North America against the threat of Soviet nuclear attack","a military conflict with the US"], answer:2}
   ]},
]},
{day:13, label:"Day 13 — Wed", subjects:[
  {subject:"Language", title:"Writing: Persuasive Letter", summary:"Students write a formal persuasive letter to a public official or organisation. They apply knowledge of audience, purpose, formal register, and persuasive techniques.",
   ...
   quiz:[
     ...
     {q:"When writing to a public official, you should ___.", options:["use slang","write as briefly as possible regardless of content","address them by their proper title, state your position clearly, provide evidence, and suggest a specific action they can take","avoid stating your position"], answer:2},
     {q:"Which persuasive technique involves showing the reader that the letter-writer's position is backed by credible evidence?", options:["Pathos","Bandwagon","Ethos (establishing credibility and authority)","Ad hominem"], answer:2},
  ...
  {subject:"Math", title:"Geometry: Angle Relationships", summary:"Students apply angle relationships — supplementary, complementary, vertically opposite, and angles in parallel lines cut by a transversal — to find unknown angles.",
   ...
   quiz:[
     ...
     {q:"Vertically opposite angles are ___.", options:["supplementary","complementary","equal to each other","always 90°"], answer:2},
     {q:"When a transversal crosses two parallel lines, alternate interior angles are ___.", options:["supplementary","unrelated","equal","complementary"], answer:2},
  ...
  {subject:"Science", title:"Light and Optics: Mirrors and Lenses in Technology", summary:"Students explore how mirrors and lenses are used in technology — cameras, telescopes, microscopes, corrective lenses, and medical equipment.",
   ...
   quiz:[
     ...
     {q:"A compound microscope magnifies by ___.", options:["one powerful lens","a mirror and a single lens","two lens systems: the objective lens produces a magnified image and the eyepiece lens magnifies it further","electricity alone"], answer:2},
     {q:"Corrective lenses for myopia (short-sightedness) are ___.", options:["convex","flat","concave lenses that diverge light so it focuses correctly on the retina instead of in front of it","only for reading"], answer:2},
  ...
  {subject:"History", title:"Social Movements in Canada: Rights and Equality", summary:"Students examine the women's suffrage movement, Indigenous rights movements, and the Canadian civil rights movement in the 20th century.",
   ...
   quiz:[
     ...
     {q:"The Indian Act (1876) affected Indigenous peoples by ___.", options:["granting them full rights","having no lasting impact","imposing strict government control over Indigenous life, banning cultural practices, creating the reserve system, and undermining Indigenous self-governance","being repealed in 1900"], answer:2},
     {q:"The residential school system in Canada was designed to ___.", options:["celebrate Indigenous cultures","improve Indigenous education","forcibly assimilate Indigenous children by removing them from their families, banning their languages, and replacing their culture with Euro-Canadian values — causing multigenerational trauma","improve literacy in rural Canada"], answer:2},
     {q:"The Canadian Human Rights Act (1977) ___.", options:["had no effect","only applied to immigrants","prohibited discrimination in federal jurisdiction on grounds including race, sex, religion, and disability","replaced the Charter of Rights"], answer:2}
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  {subject:"Language", title:"Media Creation: Podcast Script", summary:"Students plan and write a script for a short informational podcast episode. They learn to write for the ear — using conversational language, clear structure, and engaging hooks.",
   ...
   quiz:[
     ...
     {q:"Transitions in a podcast script ___.", options:["are unimportant","only appear at the beginning","guide listeners through the episode, signalling topic shifts and maintaining flow since listeners can't see headings","should be avoided"], answer:2},
     {q:"Why is clarity especially important in audio media?", options:["It is not more important","Visual aids compensate","Listeners cannot re-read — they must understand each point as it is spoken, so language must be clear, concise, and well-organised","Only for news podcasts"], answer:2},
  ...
  {subject:"Math", title:"Probability: Compound Events and Simulations", summary:"Students calculate probabilities of independent and dependent compound events and use simulations to explore experimental probability.",
   ...
   quiz:[
     ...
     {q:"Dependent events are events where ___.", options:["the first event has no effect on the second","they are impossible","the outcome of the first event DOES affect the probability of the second event","they always have equal probability"], answer:2},
     {q:"A bag has 3 red and 2 blue marbles. You draw one without replacing it. P(red then blue) = ?", options:["3/5 × 2/5 = 6/25","3/5 × 2/4 = 6/20 = 3/10","2/5 × 3/4 = 6/20","1/2"], answer:1},
  ...
  {subject:"Science", title:"Review: Science Connections Grade 8", summary:"Students connect the four Grade 8 science strands (cells, fluids, mechanical systems, optics) and see their real-world and technological applications.",
   ...
   quiz:[
     ...
     {q:"The compound microscope is an application of ___.", options:["fluid mechanics","genetics","cellular respiration","optics (mirrors and lenses)"], answer:3},
     {q:"Genetic engineering uses knowledge from which strand?", options:["Fluids","Optics and light","Cells and genetics","Mechanical systems"], answer:2},
  ...
  {subject:"History", title:"Canada in the Modern World: 1950s–1980s", summary:"Students examine key events: Quiet Revolution, Official Languages Act, Charter of Rights, Constitution Act 1982, and Canada's evolving identity.",
   ...
   quiz:[
     ...
     {q:"The repatriation of the Constitution in 1982 was significant because ___.", options:["it changed Canada's capital","Canada had to get Britain's permission to amend its constitution before this — repatriation gave Canada full constitutional independence","it created the provinces","it ended Confederation"], answer:1},
     {q:"The Canadian Charter of Rights and Freedoms (1982) ___.", options:["only applies to criminals","has no effect on laws","guarantees fundamental rights and freedoms to all Canadians and allows courts to strike down laws that violate these rights","is not part of the Constitution"], answer:2},
     {q:"The FLQ Crisis (1970) involved ___.", options:["a peaceful independence movement","an economic crisis","a Quebec separatist terrorist group that kidnapped and murdered government officials, leading Trudeau to invoke the War Measures Act — a controversial use of emergency powers","a conflict with the United States"], answer:2}
   ]},
]},
{day:15, label:"Day 15 — Fri", subjects:[
  {subject:"Language", title:"Reading: Shakespearean Drama", summary:"Students read excerpts from a Shakespeare play (e.g., Macbeth or Romeo and Juliet). They interpret Elizabethan language, identify dramatic conventions, and analyse key scenes.",
   ...
   quiz:[
     ...
     {q:"The witches in Macbeth serve to ___.", options:["add comedy","resolve the conflict","introduce supernatural elements that tempt Macbeth, raise questions about fate vs. free will, and foreshadow his downfall","explain the historical setting"], answer:2},
     {q:"Dramatic irony occurs when ___.", options:["the audience knows less than the characters","two characters disagree","the audience knows something important that one or more characters do not, creating tension","the plot is confusing"], answer:2},
  ...
  {subject:"Math", title:"Algebra: Polynomials Introduction", summary:"Students identify monomials, binomials, and trinomials. They add and subtract polynomials by collecting like terms.",
   ...
   quiz:[
     ...
     {q:"Like terms are ___.", options:["any terms in an expression","terms with identical variable parts (same variable(s) raised to the same power)","only constant terms","only terms with coefficients"], answer:1},
     {q:"Simplify: (3x² + 2x − 1) + (x² − 4x + 5)", options:["4x² − 2x + 4","4x² + 6x + 4","2x² − 2x + 6","4x⁴ − 2x + 4"], answer:0},
  ...
  {subject:"Science", title:"Cells: Review and Synthesis", summary:"Students synthesise their learning about cells, reproduction, genetics, and body systems, connecting ideas across the strand.",
   ...
   quiz:[
     ...
     {q:"Which body system most directly interacts with the immune system?", options:["Digestive","Muscular","Circulatory (blood carries immune cells throughout the body)","Skeletal"], answer:2},
     {q:"The discovery of DNA's double helix structure by Watson and Crick (1953) was important because ___.", options:["it discovered cells","it proved evolution","it revealed how genetic information is encoded, copied, and passed on — enabling molecular biology and biotechnology","it had no practical impact"], answer:2},
  ...
  {subject:"History", title:"Contemporary Canada: Issues and Identity", summary:"Students examine contemporary Canadian issues: Indigenous reconciliation, environmental policy, Quebec and Canadian identity, and Canada's role in global affairs.",
   ...
   quiz:[
     ...
     {q:"Canada's multiculturalism policy (enshrined in the Multiculturalism Act, 1988) states ___.", options:["only two cultures are recognised","all cultures must assimilate","that cultural diversity is a fundamental Canadian value and the government will support the preservation and sharing of all cultural heritages","multicultural policies ended in 2000"], answer:2},
     {q:"Quebec's distinct society debate concerns ___.", options:["only language policy","only economics","whether Quebec should be recognised constitutionally as a distinct society within Canada, given its unique French language, civil law, and culture","whether Quebec should join France"], answer:2},
     {q:"Canada's reputation as a 'middle power' in global affairs refers to ___.", options:["being a small, unimportant country","being a military superpower","being a country of significant but not dominant power that contributes to international stability through diplomacy, multilateralism, and peacekeeping","having the world's largest military"], answer:2}
   ]},
]},
{day:16, label:"Day 16 — Mon", subjects:[
  {subject:"Language", title:"Writing: Narrative with Shifting Point of View", summary:"Students experiment with narrative point of view — first person, second person, third limited, and third omniscient — and analyse how POV shapes reader experience.",
   ...
   quiz:[
     ...
     {q:"Third-person limited POV ___.", options:["knows all characters' inner thoughts","is told from a character's perspective","follows one character's perspective closely, accessing only that character's inner world","uses first-person pronouns"], answer:1},
     {q:"How does POV affect a story?", options:["It has no effect","It only changes pronouns","It fundamentally shapes what readers know, whom they trust, what information is withheld, and how they emotionally connect to the narrative","Only the style changes"], answer:2},
  ...
  {subject:"Math", title:"Algebra: Multiplying Polynomials", summary:"Students multiply polynomials: monomial × polynomial and binomial × binomial using the distributive property and FOIL.",
   ...
   quiz:[
     ...
     {q:"(2x − 1)(3x + 2) = ___.", options:["6x² + 4x − 3x − 2 = 6x² + x − 2","5x + 1","6x² − 2","6x² + 1"], answer:0},
  ...
  {subject:"Science", title:"Mechanical Systems: Efficiency and Energy", summary:"Students examine efficiency in machines, energy input vs. output, friction losses, and renewable energy technologies.",
   ...
   quiz:[
     ...
     {q:"Why is no real machine 100% efficient?", options:["Engineers are not skilled enough","Friction always converts some energy to heat, sound, or vibration — wasted energy","Perfect machines do exist","Small machines are always 100%"], answer:1},
     {q:"Renewable energy sources include ___.", options:["coal and natural gas","oil and propane","nuclear only","solar, wind, hydroelectric, geothermal, and tidal energy"], answer:3},
  ...
  {subject:"History", title:"Post-WWII Canada: Growth and Change", summary:"Students examine the baby boom, suburbanisation, the Quiet Revolution, Expo 67, and Canada's evolving sense of identity in the 1950s–1960s.",
   ...
   quiz:[
     ...
     {q:"Expo 67 in Montreal was significant because ___.", options:["it had no impact","it was held in another country","it was Canada's centennial celebration and World's Fair, showcasing Canadian and global achievements and generating enormous national pride","it was a trade fair only"], answer:2},
     {q:"Canada's centennial year was ___.", options:["1982","1967","1997","1927"], answer:1},
     {q:"The Quiet Revolution in Quebec (1960s) resulted in ___.", options:["French Canadians losing cultural influence","Quebec separating from Canada","rapid secularisation, modernisation of education and social services, and a strong assertion of Québécois identity and eventually a separatist movement","no major changes"], answer:2}
   ]},
]},
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"Language", title:"Reading: Dystopian Fiction", summary:"Students examine dystopian fiction as a genre, exploring how authors use dystopias to critique contemporary society and raise questions about power, freedom, and identity.",
   ...
   quiz:[
     ...
     {q:"In dystopian fiction, the protagonist usually ___.", options:["perfectly fits into their society","is the government leader","becomes aware of and resists the oppressive systems controlling their society","is entirely happy"], answer:2},
     {q:"Surveillance, censorship, and propaganda are common dystopian elements because ___.", options:["they make for exciting action","they are uniquely fictional","they reflect real mechanisms used by authoritarian regimes to control populations and suppress dissent","only dystopian governments use them"], answer:2},
  ...
  {subject:"Math", title:"Geometry: 3D Solids — Nets and Surface Area", summary:"Students draw and interpret nets of 3D solids and calculate surface area of composite solids.",
   ...
   quiz:[
     ...
     {q:"To find the surface area of a composite solid ___.", options:["add the volumes","find the surface area of each part and add them, subtracting any shared faces","measure only the base","use only the perimeter"], answer:1},
     {q:"A net for a square pyramid has ___.", options:["four triangles only","one square base and four triangular faces","two squares and four triangles","only triangles"], answer:1},
  ...
  {subject:"Science", title:"Cells: Organ Systems in Detail", summary:"Students examine two body systems in depth — cardiovascular and nervous — exploring their structures, functions, and interactions.",
   ...
   quiz:[
     ...
     {q:"Neurons transmit signals using ___.", options:["mechanical pressure","sound waves","electrical signals along the axon and chemical signals (neurotransmitters) across the synapse","magnetic fields"], answer:2},
  ...
  {subject:"History", title:"Quebec Referendums and Canadian Unity", summary:"Students examine the two Quebec referendums (1980, 1995) and the complex questions of identity, language, and national unity they raised.",
   ...
   quiz:[
     ...
     {q:"The 1995 Quebec Referendum result was ___.", options:["70% No","70% Yes","50.58% No — the narrowest possible result, with the No side winning by less than 1 percentage point","exactly 50-50"], answer:0},
     {q:"The Clarity Act (2000) was passed to ___.", options:["encourage Quebec to separate","ban all future referendums","establish federal conditions for any future separation — requiring a clear question and a clear majority before negotiation could begin","grant Quebec special status"], answer:2},
     {q:"The Quebec referendums highlight tensions between ___.", options:["English Quebec and French Ontario","only economic issues","the French-Canadian identity and desire for self-determination in Quebec vs. the English-Canadian vision of a bilingual, multicultural Canada","only language policy"], answer:2}
   ]},
]},
{day:18, label:"Day 18 — Wed", subjects:[
  {subject:"Language", title:"Writing: The Short Story", summary:"Students plan and write an original short story with an engaging hook, developed plot structure, consistent point of view, vivid characterisation, and a resonant ending.",
   ...
   quiz:[
     ...
     {q:"An effective ending ___.", options:["always wraps everything up perfectly","is always surprising","follows logically from the story's events and themes — it can be resolved, ambiguous, or open, but must feel earned","is always happy"], answer:2},
     {q:"Showing vs. telling in fiction means ___.", options:["having a narrator explain everything","only using dialogue","using specific details, actions, and sensory descriptions to show emotions and events rather than simply stating them directly","writing longer descriptions"], answer:2},
  ...
  {subject:"Math", title:"Data Management: Scatter Plots and Correlations", summary:"Students create scatter plots, identify correlations (positive, negative, none), draw lines of best fit, and use them to make predictions.",
   ...
   quiz:[
     ...
     {q:"A line of best fit ___.", options:["must pass through all data points","passes through the origin","is a straight line that best represents the overall trend in scatter plot data, passing through the middle of the data","is always horizontal"], answer:2},
  ...
  {subject:"Science", title:"Optics: Telescopes and Modern Technology", summary:"Students explore how modern telescopes work, the electromagnetic spectrum beyond visible light, and how optical technology has transformed astronomy.",
   ...
   quiz:[
     ...
     {q:"The James Webb Space Telescope primarily observes in ___.", options:["visible light like Hubble","ultraviolet light","X-rays","infrared, allowing it to see the earliest galaxies and peer through dust clouds"], answer:3},
     {q:"Adaptive optics in modern ground-based telescopes ___.", options:["magnifies the image more","replaces lenses with mirrors","uses real-time adjustments to mirror shape to compensate for atmospheric turbulence, dramatically sharpening images","only works in space"], answer:2},
  ...
  {subject:"History", title:"Indigenous Issues: Land Rights and Reconciliation", summary:"Students examine specific Indigenous land claims, treaty rights, and current reconciliation efforts in Canada, connecting to historical policies.",
   ...
   quiz:[
     ...
     {q:"Section 35 of the Constitution Act, 1982 ___.", options:["removed all Indigenous rights","is irrelevant today","recognises and affirms existing Aboriginal and treaty rights of the Indigenous peoples of Canada — a landmark constitutional protection","only protects Métis rights"], answer:2},
     {q:"The 94 Calls to Action from the Truth and Reconciliation Commission address ___.", options:["only educational reform","only language revitalisation","a broad range of areas including child welfare, education, language, health, justice, and commemoration — requiring action from governments, churches, and all Canadians","only the federal government"], answer:2},
...
{day:19, label:"Day 19 — Thu", subjects:[
  {subject:"Language", title:"Grammar Review: Clauses, Phrases, and Usage", summary:"Students distinguish between phrases and clauses, identify misplaced and dangling modifiers, and apply grammar knowledge to revise writing for clarity and precision.",
   ...
   quiz:[
     ...
     {q:"Which sentence contains a dangling modifier?", options:["Having studied hard, she passed the exam.","Running quickly, John reached the bus stop.","Walking through the park, the flowers were beautiful.","After eating dinner, he went for a walk."], answer:2},
     {q:"Parallel structure means ___.", options:["using only simple sentences","using only adjectives","items in a list or series should have the same grammatical form (all nouns, all phrases, all clauses)","sentences that rhyme"], answer:2},
  ...
  {subject:"Math", title:"Algebra: Factoring", summary:"Students factor polynomials by finding the greatest common factor (GCF) and factoring simple trinomials.",
   ...
   quiz:[
     ...
     {q:"Factor: 6x² + 9x", options:["3(2x² + 3x)","3x(2x + 3)","6x(x + 9)","3x²(2 + 3)"], answer:1},
     {q:"Factor: x² + 5x + 6", options:["(x + 6)(x − 1)","(x + 2)(x + 3)","(x + 1)(x + 6)","(x − 2)(x − 3)"], answer:1},
  ...
  {subject:"Science", title:"Fluids: Technology and Society", summary:"Students evaluate how fluid technology has shaped society — from ancient aqueducts to modern medicine (syringes, IV drips, blood pressure monitors).",
   ...
   quiz:[
     ...
     {q:"Dialysis machines clean blood by ___.", options:["using electrical current","using fluid dynamics: blood is passed through a semi-permeable membrane in dialysate solution, removing waste through diffusion while retaining needed components","using lasers","compressing the blood"], answer:1},
  ...
  {subject:"History", title:"Canada and Globalisation", summary:"Students examine how globalisation affects Canada — trade, immigration, cultural exchange, and environmental interdependence.",
   ...
   quiz:[
     ...
     {q:"Canada's immigration policy is described as a 'points-based system' that ___.", options:["selects immigrants randomly","only accepts refugees","only accepts immigrants from wealthy countries","evaluates applicants on education, work experience, language skills, and adaptability to select economic immigrants"], answer:3},
     {q:"Cultural globalisation can threaten local cultures because ___.", options:["global culture always improves local culture","diversity naturally increases with globalisation","the dominance of a few global cultures (especially American media and English-language content) can displace or erode local languages, traditions, and cultural practices","there is no evidence of cultural displacement"], answer:2},
     {q:"Environmental globalisation means ___.", options:["environmental problems only occur locally","only climate change is global","pollution, species extinction, and climate change cross national borders, requiring international cooperation to address problems no single country can solve alone","only trade causes environmental problems"], answer:2}
   ]},
]},
{day:20, label:"Day 20 — Fri", subjects:[
  {subject:"Language", title:"Independent Novel Study: Theme and Author's Craft", summary:"Students write an analytical essay on their novel, examining how the author uses specific craft choices to develop a central theme.",
   ...
   quiz:[
     ...
     {q:"Imagery in a novel ___.", options:["only describes nature","is decorative only","uses sensory language to create vivid pictures that evoke emotion, deepen character, and develop themes","is only in poetry"], answer:2},
     {q:"When discussing an author's craft, you should ___.", options:["only praise the author","only identify techniques","identify the technique, provide a textual example, and explain the specific effect the technique creates in service of the theme","ignore technique"], answer:2},
  ...
  {subject:"Math", title:"Financial Literacy: Budgeting and Tax", summary:"Students create a personal budget, understand gross vs. net income, and learn the basics of taxes (income tax, HST/GST) and why they exist.",
   ...
   quiz:[
     ...
     {q:"HST (Harmonised Sales Tax) in Ontario is ___.", options:["a federal income tax","an investment return","a combined federal and provincial sales tax of 13% applied to most goods and services at the point of sale","a luxury tax only"], answer:2},
     {q:"Why do governments collect income tax?", options:["To punish workers","Taxes are unnecessary","To fund public services (health care, education, roads, defence, social programs) that benefit all citizens","Only to pay politicians"], answer:2},
  ...
  {subject:"Science", title:"Biology: Biodiversity and Ecosystems Review", summary:"Students consolidate understanding of cells, genetics, reproduction, and connect to ecosystem-level impacts of biodiversity loss.",
   ...
   quiz:[
     ...
     {q:"The primary driver of current biodiversity loss globally is ___.", options:["natural climate cycles","disease only","habitat destruction (primarily for agriculture, logging, and urban expansion)","pollution alone"], answer:2},
     {q:"Conservation biology strategies include ___.", options:["only captive breeding programs","only creating national parks","a range of approaches: protected areas, wildlife corridors, captive breeding, rewilding, invasive species control, and addressing root causes like habitat loss","only legislation"], answer:2},
  ...
  {subject:"History", title:"Canada's Environmental History and Policy", summary:"Students examine key environmental milestones — creation of national parks, environmental legislation, climate commitments, and Indigenous land stewardship.",
   ...
   quiz:[
     ...
     {q:"Canada's commitment to the Paris Agreement (2015) involves ___.", options:["withdrawing from all climate targets","ignoring carbon emissions","reducing greenhouse gas emissions to limit global temperature rise to 1.5–2°C above pre-industrial levels","only reforestation"], answer:2},
     {q:"Indigenous land stewardship is increasingly recognised as important to conservation because ___.", options:["Indigenous peoples have no connection to land stewardship","it is only a political claim","Indigenous communities have managed territories sustainably for millennia, and Indigenous-led conservation areas have proven highly effective at protecting biodiversity","only Western science understands ecology"], answer:2},
     {q:"The concept of 'seventh generation' in some Indigenous traditions relates to ___.", options:["voting every seven years","a type of government","making decisions with consideration of their impact seven generations into the future — a model of long-term environmental thinking","a religious practice"], answer:2}
   ]},
]},
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"Language", title:"Writing: Reflection and Self-Assessment", summary:"Students write a formal self-assessment of their learning and growth throughout the year, applying metacognitive skills to evaluate strengths and areas for continued development.",
   ...
   quiz:[
     ...
     {q:"Why is self-assessment a valuable skill?", options:["It replaces teacher feedback","Only teachers should assess","It develops independence, self-awareness, and the ability to set meaningful goals — essential for lifelong learning beyond school","It is only required in school"], answer:2},
     {q:"When identifying an area for improvement, you should ___.", options:["simply say 'I need to improve'","only blame external factors","be specific about what the challenge is and what concrete steps you will take to address it","avoid it in a self-assessment"], answer:2},
  ...
  {subject:"Math", title:"Review: Algebra and Analytic Geometry", summary:"Students consolidate Grade 8 algebra and geometry — equations, polynomials, graphing, systems, and geometric formulas.",
   ...
   quiz:[
     ...
     {q:"Expand: (x − 3)(x + 7)", options:["x² + 4x − 21","x² − 4x + 21","x² + 4x + 21","x² − 4x − 21"], answer:0},
     {q:"Factor: x² − x − 12", options:["(x − 4)(x + 3)","(x + 4)(x − 3)","(x − 6)(x + 2)","(x + 6)(x − 2)"], answer:0},
  ...
  {subject:"Science", title:"Review: Science Synthesis Grade 8", summary:"Students connect all four Grade 8 science strands and reflect on how scientific knowledge evolves and intersects with ethical and social questions.",
   ...
   quiz:[
     ...
     {q:"The Hubble Space Telescope's discoveries relate primarily to which strand?", options:["Cells","Mechanical advantage","Fluids","Optics"], answer:3},
     {q:"How does genetic engineering (cells strand) connect to the environment (fluids/ecosystems)?", options:["It does not connect","Only through water","Through GMO crops that may affect soil and water ecosystems, and conservation genetics that could protect endangered species","Only through climate"], answer:2},
  ...
  {subject:"History", title:"Review: Canadian History Grade 8", summary:"Students synthesise their understanding of Canadian history from New France to the present, identifying themes of identity, power, rights, and responsibility.",
   ...
   quiz:[
     ...
     {q:"The Charter of Rights and Freedoms (1982) and multiculturalism policy (1971) both reflect ___.", options:["the dominance of French culture","a preference for assimilation","the gradual development of a Canadian identity based on rights, diversity, and inclusion — though imperfectly realised","the end of Indigenous rights"], answer:2},
     {q:"The most important lesson from studying Canadian history is arguably ___.", options:["Canada has always been perfect","history is irrelevant today","history is not just the past — it actively shapes the present, and understanding it helps us recognise injustice, celebrate progress, and take responsibility for building a better future","only some Canadians need to know history"], answer:2}
   ]},
]},
{day:22, label:"Day 22 — Tue", subjects:[
  {subject:"Language", title:"Media: Analysing Propaganda", summary:"Students examine propaganda techniques and historical and contemporary examples. They develop critical tools for identifying manipulation in media.",
   ...
   quiz:[
     ...
     {q:"Scapegoating as a propaganda technique ___.", options:["is rare in modern media","fairly identifies causes of problems","blames a specific group (ethnic, religious, political) for complex societal problems to redirect public anger and justify discrimination","only occurs in history"], answer:2},
     {q:"How can you identify propaganda?", options:["Only experts can","You cannot","Examining sources, checking whether claims are supported by verifiable evidence, identifying emotional manipulation, and seeking diverse perspectives","Only by feeling what sounds wrong"], answer:2},
  ...
  {subject:"Math", title:"Review: Measurement and Data", summary:"Students consolidate measurement (surface area, volume of 3D solids) and data management (scatter plots, probability) from Grade 8.",
   ...
   quiz:[
     ...
     {q:"A scatter plot shows a strong negative correlation. As x increases, y ___.", options:["also increases","stays the same","cannot be determined","decreases"], answer:3},
     {q:"P(rolling a 3 on a die AND flipping heads) = ?", options:["1/3","1/4","1/12","1/6"], answer:2},
  ...
  {subject:"Science", title:"Science: Careers and Future Directions", summary:"Students explore STEM careers and how Grade 8 science connects to real-world professions and future study.",
   ...
   quiz:[
     ...
     {q:"Environmental engineers need knowledge of ___.", options:["only chemistry","only biology","fluid dynamics, ecology, chemistry, and engineering to design systems that protect and clean water, air, and soil","only mechanical systems"], answer:2},
     {q:"Genetic counsellors use knowledge of ___.", options:["optics","fluid mechanics","genetics, inheritance, and cell biology to advise families about hereditary conditions and reproductive options","mechanical engineering"], answer:2},
  ...
  {subject:"History", title:"Critical Thinking: Historical Perspective Taking", summary:"Students practise empathetic historical thinking — examining events from multiple perspectives to develop nuanced understanding and avoid presentism.",
   ...
   quiz:[
     ...
     {q:"Multiple accounts of the same historical event ___.", options:["always contradict each other meaninglessly","should be avoided","reveal different perspectives, priorities, and experiences — each is partial, and historians must critically evaluate them all to construct fuller understanding","are always equally reliable"], answer:2},
     {q:"Primary sources help historians because ___.", options:["they are always objective","they contain no bias","they are first-hand accounts created at the time of an event, giving direct (though always partial and perspective-specific) evidence of what happened","they are more recent than secondary sources"], answer:2},
     {q:"Why is understanding history from multiple perspectives essential for democratic citizenship?", options:["It is not","Only one perspective is valid","History with multiple perspectives reveals complexity, challenges simple narratives, and helps citizens avoid manipulation by those who oversimplify the past for political purposes","Only historians need multiple perspectives"], answer:2}
   ]},
]},
{day:23, label:"Day 23 — Wed", subjects:[
  {subject:"Language", title:"Writing: Publishing and Sharing", summary:"Students select, polish, and present a piece of writing to a real or simulated audience. They understand the writing-to-publish process.",
   ...
   quiz:[
     ...
     {q:"Formatting and presentation of published writing should ___.", options:["be ignored — content is all that matters","follow no conventions","follow conventions appropriate to the form (paragraph breaks, headings, consistent font) so that presentation enhances rather than distracts from the content","always use decorative fonts"], answer:2},
     {q:"Author's note or introduction to a published piece ___.", options:["is always required","is never appropriate","can contextualise the piece, explain the writer's process or inspiration, and help readers connect with the work","must explain every choice"], answer:2},
  ...
  {subject:"Math", title:"Algebra: Solving Quadratic Equations (Introduction)", summary:"Students are introduced to quadratic equations in standard form (ax² + bx + c = 0). They solve simple cases by factoring.",
   ...
   quiz:[
     ...
     {q:"Solve x² − 5x + 6 = 0 by factoring.", options:["x = 2 and x = 3 (from (x−2)(x−3) = 0)","x = −2 and x = −3","x = 5 and x = 6","x = 1 and x = 6"], answer:0},
     {q:"The zero product property states: if ab = 0, then ___.", options:["a = b","a + b = 0","a = 0 OR b = 0 (at least one factor must be zero)","a = 0 AND b = 0"], answer:2},
  ...
  {subject:"Science", title:"Environmental Science: Climate Change Science", summary:"Students examine the evidence for climate change, the greenhouse effect, tipping points, and current mitigation and adaptation strategies.",
   ...
   quiz:[
     ...
     {q:"Evidence for current climate change includes ___.", options:["only computer models","only rising temperatures in one region","rising global average temperatures, melting ice sheets and glaciers, rising sea levels, more frequent extreme weather events, and shifting seasons — all corroborated by multiple independent data sources","only CO₂ measurements"], answer:2},
     {q:"Mitigation refers to ___.", options:["adapting to inevitable changes","ignoring climate change","reducing greenhouse gas emissions and enhancing carbon sinks to slow or prevent future warming","measuring temperature"], answer:2},
  ...
  {subject:"History", title:"Canada's Future: Challenges and Opportunities", summary:"Students examine key challenges Canada faces in the 21st century: reconciliation, climate change, economic inequality, and democratic participation.",
   ...
   quiz:[
     ...
     {q:"Democratic participation in Canada includes ___.", options:["only voting in federal elections","only joining a political party","voting, engaging with elected officials, participating in public consultations, joining civil society organisations, and staying informed — democracy requires active citizens, not just voters every four years","only running for office"], answer:2},
     {q:"Immigration is central to Canada's future because ___.", options:["Canada has too many immigrants","immigration creates no economic benefit","Canada's aging population and low birth rate mean immigration is necessary for economic growth, filling labour shortages, and sustaining social programs like CPP and health care","immigration is purely humanitarian"], answer:2},
...
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Reading: Poetry Analysis", summary:"Students closely analyse poems from different traditions and periods. They examine structure, diction, imagery, figurative language, and theme.",
   ...
   quiz:[
     ...
     {q:"A volta in a sonnet is ___.", options:["the final couplet's rhyme","the first quatrain","a sudden shift or turn in argument, emotion, or perspective — typically at line 9 in a Petrarchan sonnet or at the couplet in a Shakespearean sonnet","the opening question"], answer:2},
     {q:"Personification in poetry ___.", options:["only describes landscapes","only occurs in prose","attributes human qualities, emotions, or actions to non-human things, creating vivid emotional connections","is a type of rhyme scheme"], answer:2},
  ...
  {subject:"Math", title:"Number Systems: Square Roots and Irrational Numbers", summary:"Students distinguish rational from irrational numbers, estimate square roots, and place them on a number line.",
   ...
   quiz:[
     ...
     {q:"√2 is ___.", options:["exactly 1.41","exactly 1.414","rational","irrational — its decimal expansion goes on forever without repeating"], answer:3},
     {q:"Estimate √50 to the nearest whole number.", options:["6","7","8","9"], answer:1},
  ...
  {subject:"Science", title:"Systems: Connecting Science Strands", summary:"Students explore how the four Grade 8 science strands connect — cells and systems, fluids and pressure, mechanical advantage, optics — within real engineering contexts.",
   ...
   quiz:[
     ...
     {q:"Medical imaging (X-rays, MRI, ultrasound) relates primarily to ___.", options:["cell division","fluid pressure","mechanical advantage","optics and the physics of waves — electromagnetic or sound waves interact with body tissues to create images"], answer:3},
     {q:"CRISPR gene editing relates to which two strands most directly?", options:["Fluids and optics","Mechanical systems and optics","Cells and genetics (understanding DNA structure and function) plus ethics (social implications)","Fluids and mechanical systems"], answer:2},
  ...
  {subject:"History", title:"Digital History: Canada's Information Age", summary:"Students examine how digital technology has transformed Canadian society, economy, and governance since the 1980s.",
   ...
   quiz:[
     ...
     {q:"The digital divide refers to ___.", options:["the difference between digital and analogue cameras","only slow internet speeds","a mathematical concept","the gap between those who have access to digital technology and internet connectivity and those who do not — affecting equality of opportunity"], answer:3},
     {q:"Canada's Digital Charter (2019) addresses ___.", options:["internet speeds only","postal service","immigration through the internet","principles for protecting Canadians' privacy, security, and rights in the digital age"], answer:3},
     {q:"Cybersecurity is important for Canada because ___.", options:["Canada has no cyber threats","only private companies are targeted","digital infrastructure is increasingly critical, and cyberattacks on government, health care, and finance systems can threaten national security and Canadians' personal data","only the US faces cyber threats"], answer:2}
   ]},
]},
{day:25, label:"Day 25 — Fri", subjects:[
  {subject:"Language", title:"Research: Ethics in Writing and Citation", summary:"Students deepen their understanding of academic integrity. They distinguish paraphrase, summary, and quotation, and practise ethical source integration.",
   ...
   quiz:[
     ...
     {q:"When should you use a direct quote?", options:["For all information from sources","Never — always paraphrase","When the original wording is especially precise, memorable, or authoritative — and it always requires quotation marks and a citation","Only for very long passages"], answer:2},
     {q:"Why is citing sources important beyond avoiding plagiarism?", options:["It is only about avoiding plagiarism","It makes essays longer","Citations allow readers to verify your sources, trace the conversation of ideas, and give proper credit to the scholars whose work you built upon — it is a mark of scholarly honesty","Only for academic papers"], answer:2},
  ...
  {subject:"Math", title:"Measurement: Optimisation Problems", summary:"Students solve problems that require optimising area, perimeter, surface area, or volume — finding maximum or minimum values given constraints.",
   ...
   quiz:[
     ...
     {q:"A farmer has 200 m of fencing for a rectangular pen. Maximum area = ?", options:["100 m × 100 m = ... wait, perimeter 400 m for a 100×100","50 m × 50 m = 2500 m² (a square uses all 200 m as perimeter)","40 m × 60 m = 2400 m²","25 m × 75 m = 1875 m²"], answer:1},
     {q:"For a fixed volume, a cylinder with minimum surface area has ___.", options:["height much greater than diameter","height much less than diameter","height equal to diameter (h = 2r)","no specific relationship"], answer:2},
  ...
  {subject:"Science", title:"Science and Society: Ethics of Technology", summary:"Students examine the ethical dimensions of emerging technologies — AI, genetic engineering, space exploration — and practise ethical reasoning.",
   ...
   quiz:[
     ...
     {q:"The precautionary principle in science and ethics states ___.", options:["always pursue all technologies","wait until all uncertainty is resolved","when an action raises potential serious harm, precautionary measures should be taken even if full scientific certainty is lacking — err on the side of safety","ignore risks that are not yet proven"], answer:2},
     {q:"Gene therapy (correcting genetic diseases) raises ethical questions about ___.", options:["whether genetics exists","whether it will work","the difference between treating disease and enhancing human traits (designer babies), consent (especially for germline changes affecting future generations), and equitable access","only cost"], answer:2},
  ...
  {subject:"History", title:"Year-End History Synthesis", summary:"Students synthesise Canadian history from New France to the present, examining recurring themes and their relevance to contemporary Canada.",
   ...
   quiz:[
     ...
     {q:"What do WWI, WWII, and peacekeeping have in common for Canadian identity?", options:["Only military spending","Only casualties","They all contributed to Canada establishing itself as a distinct middle power with a unique international identity — not simply following Britain or the United States","Only alliances"], answer:2},
     {q:"Why is reconciliation with Indigenous peoples described as 'unfinished business'?", options:["It is already complete","It was never started","It is impossible","Legal recognition (Section 35, UNDRIP) has occurred but structural inequalities, land claims, and the healing of multigenerational trauma require sustained action across generations"], answer:3},
     {q:"The most important civic responsibility for Grade 8 students as future Canadian citizens is ___.", options:["only voting when old enough","only paying taxes","ignoring politics","staying informed, thinking critically, participating actively in democracy, and working toward a more just and equitable Canada for all people"], answer:3}
   ]},
]},
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Language Arts: Consolidation and Celebration", summary:"Students reflect on their growth as readers, writers, and communicators in Grade 8. They celebrate achievements and set goals for high school.",
   ...
   quiz:[
     ...
     {q:"Setting a literacy goal for high school means ___.", options:["giving up on improving","being satisfied with current skills","identifying a specific area (analytical writing, reading challenging texts, oral communication) where you want to grow and making a concrete plan","only planning which books to read"], answer:2},
     {q:"Reading widely is important because ___.", options:["it is only about pleasure","it wastes time","it builds vocabulary, background knowledge, empathy, and critical thinking — across genres, cultures, and perspectives","only fiction counts"], answer:2},
  ...
  {subject:"Math", title:"Grade 8 Math: Comprehensive Review", summary:"Students review all major Grade 8 math strands.",
   ...
   quiz:[
     ...
     {q:"The slope of the line −3x + y = 6 is ___.", options:["−3","6","3","1/3"], answer:2},
     {q:"Expand and simplify: (2x + 3)(x − 4)", options:["2x² − 5x − 12","2x² + 5x − 12","2x² − 8x + 3x − 12","2x² − 5x + 12"], answer:0},
  ...
  {subject:"Science", title:"Science: Looking Ahead to Grade 9", summary:"Students preview the Grade 9 science curriculum (biology, chemistry, physics, earth science) and connect Grade 8 learning to what comes next.",
   ...
   quiz:[
     ...
     {q:"The concept of energy (work, mechanical efficiency) from Grade 8 connects to ___.", options:["Grade 9 biology","Grade 9 geography","Grade 9 history","Grade 9 physics, which examines electricity, circuits, and energy transfer in more depth"], answer:3},
     {q:"Studying science in high school will require ___.", options:["no mathematical reasoning","only memorisation","forgetting Grade 8 concepts","stronger mathematical reasoning, lab skills, and ability to connect evidence to theory — all skills practised in Grade 8"], answer:3},
  ...
  {subject:"History", title:"History: Becoming an Informed Citizen", summary:"Students reflect on how studying history prepares them for democratic participation and lifelong civic engagement.",
   ...
   quiz:[
     ...
     {q:"Why is it important to know Canadian history as a voter?", options:["It is not important for voting","Only political science courses teach voting","Historical knowledge helps you understand why current political issues exist, evaluate political claims, and make informed choices that consider the long-term consequences for all Canadians","Only federal election history matters"], answer:2},
     {q:"The concept of 'historical responsibility' means ___.", options:["personally feeling guilty for past wrongs","ignoring the past","blaming only one group for history","acknowledging that societies can have responsibilities to address historical injustices — even those they did not personally commit — and work toward just outcomes"], answer:3},
     {q:"The best way to honour those who built and shaped Canada is to ___.", options:["only celebrate the heroes","pretend history was perfect","criticise everything about the past","understand the full complexity of their stories — achievements and failures — and use that knowledge to build a more just and inclusive Canada for all"], answer:3}
   ]},
]},
{day:27, label:"Day 27 — Tue", subjects:[
  {subject:"Language", title:"Exam Preparation: Close Reading Practice", summary:"Students practise close reading and analytical response to unseen texts — a key skill for high school and standardised assessments.",
   ...
   quiz:[
     ...
     {q:"Timed writing differs from essay writing because ___.", options:["it requires no planning","grammar doesn't matter","you don't need evidence","you must plan quickly, write efficiently, and prioritise the most important points — strong outlining in the first 2 minutes pays off heavily"], answer:3},
     {q:"If you don't understand a word in an exam passage, you should ___.", options:["stop writing","ask for a dictionary","use context clues from surrounding sentences to infer the meaning and continue reading","skip the whole question"], answer:2},
  ...
  {subject:"Math", title:"Pre-High-School Math: Review and Extensions", summary:"Students consolidate all Grade 8 math and preview Grade 9 topics: linear equations, quadratics, and analytic geometry extensions.",
   ...
   quiz:[
     ...
     {q:"The distance formula between two points (x₁,y₁) and (x₂,y₂) is ___.", options:["(x₂ − x₁) + (y₂ − y₁)","|(x₂ − x₁)|","√((x₂−x₁)² + (y₂−y₁)²)","(x₂ + y₂) − (x₁ + y₁)"], answer:2},
     {q:"Scientific notation is used in Grade 9 science because ___.", options:["scientists prefer it for aesthetic reasons","it is optional","it doesn't apply in high school","very large and very small numbers (atoms, distances in space) are impossible to work with in standard form"], answer:3},
  ...
  {subject:"Science", title:"Science: Lab Skills and Safety Review", summary:"Students review scientific inquiry, lab safety, equipment use, and how to write effective lab reports.",
   ...
   quiz:[
     ...
     {q:"The dependent variable is ___.", options:["the variable you change","the variable that is kept constant","the variable that responds to the independent variable — what you measure as the outcome","only for science fairs"], answer:2},
     {q:"A control group in an experiment ___.", options:["is always the experimental group","is not used in good experiments","receives no treatment, providing a baseline for comparison with the experimental group","must be very large"], answer:2},
  ...
  {subject:"History", title:"History: The Power of Narrative", summary:"Students examine how the stories we tell about history shape national identity, and whose voices have historically been left out of official narratives.",
   ...
   quiz:[
     ...
     {q:"Counter-narratives are important because ___.", options:["they are always more accurate than dominant narratives","they replace all existing history","they present experiences and perspectives excluded from dominant narratives, creating a fuller, more truthful, and more inclusive account of the past","only one narrative can be true"], answer:2},
     {q:"The inclusion of diverse voices in Canadian history education ___.", options:["complicates history unnecessarily","only benefits minority students","creates a more accurate and complete history that helps all Canadians understand the full range of experiences that built this country","should be limited to specific months"], answer:2},
     {q:"Whose stories most need to be better told in Canadian history?", options:["Only political leaders","Only military heroes","History is complete","Indigenous peoples, Black Canadians, immigrants, women, and other groups whose experiences have been underrepresented or erased from the mainstream Canadian historical narrative"], answer:3}
   ]},
]},
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Writing: Letter to Future Self", summary:"Students write a formal reflective letter to their future high-school self, synthesising their growth, expressing hopes, and setting intentions.",
   ...
   quiz:[
     ...
     {q:"Including specific details from Grade 8 experiences in the letter ___.", options:["is irrelevant","makes it too long","makes it impersonal","grounds the reflection in concrete reality and will be more meaningful when your future self reads it"], answer:3},
     {q:"The tone of a letter to your future self should be ___.", options:["critical and discouraging","completely formal","entirely casual with no reflection","honest, warm, and thoughtful — like a conversation with someone you trust deeply"], answer:3},
  ...
  {subject:"Math", title:"Algebra: Inequalities", summary:"Students solve one- and two-step inequalities in one variable, graph solutions on a number line, and understand how multiplying/dividing by a negative reverses the inequality sign.",
   ...
   quiz:[
     ...
     {q:"Solve: −2x < 8", options:["x < −4","x < 4","x > −4","x > 4"], answer:2},
     {q:"Why does the inequality sign reverse when multiplying or dividing by a negative?", options:["It is a random rule","It only happens sometimes","Because the relative order of numbers flips when negated: if 2 < 5, then −2 > −5","To make problems easier"], answer:2},
  ...
  {subject:"Science", title:"Review: Environmental Science and Stewardship", summary:"Students synthesise environmental learning — climate, biodiversity, fluid systems — and develop a personal stewardship plan.",
   ...
   quiz:[
     ...
     {q:"Connecting personal choices to environmental outcomes requires ___.", options:["understanding only global policy","ignoring individual actions","systems thinking — understanding how individual choices aggregate into large-scale effects, and how economic, political, and social systems shape what choices are available","only scientific knowledge"], answer:2},
     {q:"Indigenous-led conservation models are valuable because ___.", options:["only Western science is valid","they only apply to forests","Indigenous communities have developed deep ecological knowledge and sustainable management practices over millennia that can complement and enhance modern conservation science","they are purely political"], answer:2},
  ...
  {subject:"History", title:"History Exam Preparation and Reflection", summary:"Students review key concepts, practise historical thinking skills, and reflect on the significance of Grade 8 history for their lives as citizens.",
   ...
   quiz:[
     ...
     {q:"Cause and consequence in history means ___.", options:["events have only one cause","consequences are always immediate","historical events have multiple, interconnected causes, and their consequences can be short-term and long-term, intended and unintended","causes are always economic"], answer:2},
     {q:"Continuity and change as a historical thinking concept means ___.", options:["everything always changes","nothing ever changes","examining what has changed over time AND what has remained the same — both are equally important to understand","only wars cause change"], answer:2},
     {q:"The most valuable skill from Grade 8 History for future citizenship is ___.", options:["memorising all dates","knowing every Prime Minister's name","only drawing historical maps","critical analysis of evidence — the ability to evaluate competing claims, consider multiple perspectives, and form reasoned judgements about complex issues"], answer:3}
   ]},
]},
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Culminating Activity: Oral Presentation", summary:"Students deliver a culminating oral presentation on a significant Canadian historical or contemporary issue, demonstrating research, analysis, and communication skills.",
   ...
   quiz:[
     ...
     {q:"Using visual aids (slides, maps, images) in a presentation should ___.", options:["replace your words","contain all your text","not be used in high school","supplement and support your points — visuals should enhance, not replace, your spoken argument"], answer:3},
     {q:"Answering audience questions well demonstrates ___.", options:["that you memorised everything","that you read many books","only confidence","genuine deep understanding of your topic — you can engage with what you don't know honestly and think on your feet"], answer:3},
  ...
  {subject:"Math", title:"Culminating Math: Problem Solving Challenge", summary:"Students apply all Grade 8 math concepts to multi-step real-world problems.",
   ...
   quiz:[
     ...
     {q:"A scatter plot shows height vs. shoe size with a positive correlation. What does this mean?", options:["Height causes larger feet","Taller people always have the exact same shoe size","Height and shoe size tend to increase together, though correlation does not prove causation","Shoe size determines height"], answer:2},
     {q:"Solve the system: y = 3x + 1 and 2x + y = 16", options:["x = 3, y = 10","x = 5, y = 6","x = 3, y = 7","x = 2, y = 7"], answer:0},
  ...
  {subject:"Science", title:"Science: Year Review and Looking Forward", summary:"Students review all four Grade 8 science strands and connect learning to Grade 9 and beyond.",
   ...
   quiz:[
     ...
     {q:"The study of light and optics connects to ___.", options:["only telescope use","Grade 9 physics waves unit, which explores sound and light as waves in much greater depth","Grade 9 chemistry only","no Grade 9 topic"], answer:1},
     {q:"Genetics from Grade 8 cells connects to ___.", options:["Grade 9 earth science","Grade 9 physics","Grade 9 Language","Grade 9 biology, which introduces evolution and natural selection — both depend on understanding genetic variation and inheritance"], answer:3},
  ...
  {subject:"History", title:"Grade 8 History: Final Reflection", summary:"Students write a final historical reflection, identifying the most significant idea they will carry forward from Grade 8 History.",
   ...
   quiz:[
     ...
     {q:"The history of Canada is best described as ___.", options:["a story of continuous perfect progress","a simple story of heroes and villains","irrelevant to modern Canada","a complex, ongoing story of competing visions, hard-won rights, profound injustices, remarkable achievements, and unfinished work toward a more just and inclusive nation"], answer:3},
     {q:"As a future Canadian citizen, the most important thing you can do with your knowledge of history is ___.", options:["keep it only for yourself","forget it after the test","only share it in class","use it — to vote thoughtfully, engage with public debates, support reconciliation, and work toward the Canada that history has shown us we can and must become"], answer:3},
     {q:"Grade 8 History ends, but Canadian history ___.", options:["ended in 2000","is complete","only matters to historians","is still being written — and your generation will be the authors of its next chapter"], answer:3}
   ]},
]},
{day:30, label:"Day 30 — Fri", subjects:[
  {subject:"Language", title:"Year-End Celebration: Voices and Stories", summary:"A celebration of Grade 8 Language Arts learning. Students share their best writing and reflect on their development as literate, critical thinkers.",
   ...
   quiz:[
     ...
     {q:"The texts you've read and analysed this year have ___.", options:["had no lasting impact","only been for assessment","built your capacity for empathy, critical thinking, and understanding of human experience — literature is one of humanity's most powerful tools for making sense of the world","only improved your grammar"], answer:2},
     {q:"Being a literate person in the 21st century means ___.", options:["only being able to read words","only being able to write essays","being able to critically read, analyse, and evaluate ALL types of texts — written, visual, digital, and multimodal — and respond with your own thoughtful voice","only reading books"], answer:2},
  ...
  {subject:"Math", title:"Grade 8 Math: Celebration and Forward Look", summary:"A final review celebrating mathematical growth and looking ahead to Grade 9.",
   ...
   quiz:[
     ...
     {q:"Mathematics is connected to other subjects because ___.", options:["it is not","only science uses math","math only applies to math class","logical reasoning, data analysis, proportional thinking, and spatial reasoning are used across all disciplines from science to social studies to music"], answer:3},
     {q:"Being good at math means ___.", options:["never making mistakes","only getting right answers","being fast always","being willing to struggle with challenging problems, learning from errors, making connections between ideas, and persisting until you reach understanding"], answer:3},
  ...
  {subject:"Science", title:"Science: Final Synthesis and Celebration", summary:"Students celebrate their learning across all Grade 8 science strands and look forward to the broader world of scientific inquiry.",
   ...
   quiz:[
     ...
     {q:"Science and society are interconnected because ___.", options:["science is separate from society","only scientists need to understand science","scientists work in a social and political vacuum","scientific discoveries shape society (medicines, technology, energy) and society shapes science (funding priorities, ethical constraints, public demand)"], answer:3},
  ...
  {subject:"History", title:"Farewell: You Are Canadian History", summary:"A final message connecting students to their role as participants in the ongoing story of Canada.",
   ...
   quiz:[
     ...
     {q:"Canada's greatest strength is ___.", options:["being a military power","having no challenges to overcome","economic wealth only","its ongoing commitment to becoming a more just, inclusive, and diverse nation — a project that is never finished, but always worth pursuing"], answer:3},
     {q:"Your role as a future Canadian citizen is ___.", options:["only to vote every four years","to be a passive observer of events","only to follow the news","to engage, to think critically, to care about justice, and to contribute your unique voice and skills to the communities and country you are part of"], answer:3},
     {q:"Grade 8 is complete. High school begins. Which best describes the journey ahead?", options:["A completely fresh start with nothing from Grade 8 carrying forward","Only harder versions of the same tests","An expansion of everything you've built — more complex texts, deeper history, more abstract math, and greater opportunity to develop your own voice, values, and vision for the future","Only more difficult and stressful"], answer:2}
   ]},
]},
];
