...
{day:1, label:"Day 1 — Mon", subjects:[
  {subject:"Language", title:"Letter A", summary:"Explore uppercase and lowercase A. Students identify the letter, practise its short /a/ sound, and find words beginning with A such as apple, ant, and astronaut.",
   ...
   quiz:[
     ...
     {q:"Which A word is a fruit?", options:["Ant","Apple","Arrow","Axe"], answer:1},
  ...
  {subject:"Math", title:"Counting 1 to 5", summary:"Students count objects up to 5, match numerals to quantities, and begin to understand one-to-one correspondence.",
   ...
   quiz:[
     ...
     {q:"Which numeral means three?", options:["1","2","3","4"], answer:2},
     {q:"Count the dots: ● ● ● ● How many?", options:["3","4","5","2"], answer:1},
  ...
  {subject:"Science", title:"Living and Non-Living Things", summary:"Students learn to distinguish living things (grow, breathe, need food/water) from non-living things (do not grow on their own, do not breathe).",
   ...
   quiz:[
     ...
     {q:"Which is non-living?", options:["Dog","Flower","Table","Cat"], answer:2},
     {q:"A non-living thing ___.", options:["breathes","grows on its own","does not grow, breathe, or reproduce on its own","needs food and water"], answer:2},
  ...
  {subject:"SocialStudies", title:"My Family", summary:"Students explore different family structures — large, small, single-parent, grandparent families — and appreciate that all families are special.",
   ...
   quiz:[
     ...
     {q:"Families can be ___.", options:["only large","only small","different sizes and structures","only two people"], answer:2},
     {q:"How do families show they care?", options:["By ignoring each other","By helping, listening, and spending time together","By fighting only","By living apart"], answer:1},
     {q:"Why is your family special?", options:["It is not","Every family is unique and special in its own way","Only big families are special","Only famous families are special"], answer:1}
   ]},
]},
{day:2, label:"Day 2 — Tue", subjects:[
  {subject:"Language", title:"Letter B", summary:"Explore uppercase and lowercase B. Students identify the letter, practise its /b/ sound, and name B words such as ball, bear, and butterfly.",
   ...
   quiz:[
     ...
     {q:"Which B word is an animal?", options:["Bat — yes it is a B animal","Car","Sun","Tree"], answer:0},
     {q:"Find the B: cat, ball, apple, sun", options:["cat","ball","apple","sun"], answer:1},
  ...
  {subject:"Math", title:"Counting 6 to 10", summary:"Students count objects from 6 to 10, match numerals to quantities, and practise counting on from 5.",
   ...
   quiz:[
     ...
     {q:"Which numeral means eight?", options:["6","7","8","9"], answer:2},
     {q:"What number comes before 10?", options:["7","8","9","11"], answer:2},
  ...
  {subject:"Science", title:"Plants Around Us", summary:"Students explore plants in their environment. All plants have basic needs: sunlight, water, and soil. Plant parts include roots, stem, leaves, and sometimes flowers.",
   ...
   quiz:[
     ...
     {q:"Leaves help a plant by ___.", options:["holding it up only","storing seeds","making food using sunlight","protecting the roots"], answer:2},
  ...
  {subject:"SocialStudies", title:"My Home and Community", summary:"Students explore different types of homes (house, apartment, townhouse) and the idea that home is within a neighbourhood and community.",
   ...
   quiz:[
     ...
     {q:"A community is ___.", options:["one family only","a place where people live and work together","only a school","only a park"], answer:1},
     {q:"What makes a home special?", options:["Its size","The colour of the walls","The people and love inside it","Only if it has a yard"], answer:2},
     {q:"Which building is in most communities?", options:["A spaceship","A submarine","A school or fire station","A castle"], answer:2}
   ]},
]},
{day:3, label:"Day 3 — Wed", subjects:[
  ...
  {subject:"Math", title:"2D Shapes: Circle and Square", summary:"Students identify, name, sort, and describe circles and squares. Circles have no corners; squares have 4 equal sides and 4 corners.",
   ...
   quiz:[
     ...
     {q:"Which shape is perfectly round?", options:["Square","Triangle","Circle","Rectangle"], answer:2},
     {q:"How many sides does a square have?", options:["2","3","4","6"], answer:2},
  ...
  {subject:"Science", title:"Seasons: Autumn", summary:"Students explore the characteristics of autumn in Ontario — shorter days, falling leaves, cooler temperatures, and animals preparing for winter.",
   ...
   quiz:[
     ...
     {q:"Autumn is usually ___ than summer.", options:["hotter","cooler","the same temperature","colder than winter"], answer:1},
     {q:"Animals prepare for winter in autumn by ___.", options:["playing more","storing food or preparing to migrate or hibernate","swimming more","staying exactly the same"], answer:1},
  ...
  {subject:"SocialStudies", title:"Helping at Home", summary:"Students explore household responsibilities and how children can contribute by tidying, setting the table, and caring for pets.",
   ...
   quiz:[
     ...
     {q:"Why is it important to help at home?", options:["It is not","It teaches responsibility and helps the family work together","Only parents should do chores","Only if you are asked"], answer:1},
     {q:"Which chore could a kindergartener do?", options:["Fix the roof","Pay the bills","Put shoes away neatly","Cook dinner alone"], answer:2},
     {q:"When you help at home, your family feels ___.", options:["annoyed","proud and grateful","angry","nothing"], answer:1}
   ]},
]},
{day:4, label:"Day 4 — Thu", subjects:[
  {subject:"Language", title:"Letter D", summary:"Explore uppercase and lowercase D. Students identify the letter, practise its /d/ sound, and name D words such as dog, duck, and drum.",
   ...
   quiz:[
     ...
     {q:"Which D word is an animal?", options:["Door","Drum","Duck","Den"], answer:2},
     {q:"Lowercase d looks like ___.", options:["only a straight line","a circle with a tall line on the right","two bumps","a curved line only"], answer:1},
  ...
  {subject:"Math", title:"Number Order 1-10", summary:"Students arrange numbers 1-10 in order, identify missing numbers, and understand more/fewer using a number line.",
   ...
   quiz:[
     ...
     {q:"Put in order: 5, 3, 1, 4, 2", options:["1, 2, 3, 4, 5","5, 4, 3, 2, 1","3, 1, 2, 4, 5","1, 3, 2, 5, 4"], answer:0},
     {q:"What comes between 6 and 8?", options:["5","7","9","6"], answer:1},
  ...
  {subject:"Science", title:"Water Around Us", summary:"Students explore water in their environment. Water is a liquid that flows, takes the shape of its container, and is essential for all life.",
   ...
   quiz:[
     ...
     {q:"Where can we find water in nature?", options:["Only in taps","Only in bottles","Rivers, lakes, rain, and oceans","Only in stores"], answer:2},
     {q:"What shape does water take?", options:["Always a ball","Always flat","The shape of its container","Always a cube"], answer:2},
  ...
  {subject:"SocialStudies", title:"Community Helpers: Police and Firefighters", summary:"Students learn how police officers keep communities safe and how firefighters protect people and property. Both are important community helpers.",
   ...
   quiz:[
     ...
     {q:"What number do you call in an emergency in Canada?", options:["411","511","911","211"], answer:2},
     {q:"Firefighters wear special gear to ___.", options:["look important","protect themselves from heat, smoke, and flames","run faster","only look scary"], answer:1},
     {q:"Why are community helpers important?", options:["They are not","They provide services that keep everyone safe and healthy","Only adults need them","Only in emergencies"], answer:1}
   ]},
]},
{day:5, label:"Day 5 — Fri", subjects:[
  {subject:"Language", title:"Vowels: A, E, I, O, U", summary:"Students learn to identify the five vowels and their short sounds. Vowels are special letters: a (apple), e (egg), i (igloo), o (octopus), u (umbrella).",
   ...
   quiz:[
     ...
     {q:"Which word has the short A sound?", options:["Bike","Cat","Pete","Cute"], answer:1},
     {q:"Which word has the short E sound?", options:["Cake","Mine","Egg","Boot"], answer:2},
  ...
  {subject:"Math", title:"Addition to 5", summary:"Students use objects, fingers, and drawings to add two groups and find totals up to 5.",
   ...
   quiz:[
     ...
     {q:"You have 2 apples and 2 oranges. How many fruit in all?", options:["2","3","4","5"], answer:2},
     {q:"0 + 5 = ?", options:["0","4","5","10"], answer:2},
  ...
  {subject:"Science", title:"The Sun and Moon", summary:"Students explore the Sun as Earth's main light and heat source. The Moon reflects sunlight and can be seen at night. They observe day and night.",
   ...
   quiz:[
     ...
     {q:"The Moon ___ its own light.", options:["makes plenty of","produces strongly","does not produce — it reflects sunlight","creates daily"], answer:2},
     {q:"We usually see the Sun during the ___.", options:["night","day","only at sunrise","only in winter"], answer:1},
  ...
  {subject:"SocialStudies", title:"My School Community", summary:"Students explore the school as a community. They identify key helpers: principal, teacher, custodian, librarian, and secretary.",
   ...
   quiz:[
     ...
     {q:"What does a school custodian do?", options:["Teach reading","Keep the school clean and safe","Run the office","Drive the bus"], answer:1},
     {q:"A school is a community because ___.", options:["it has one teacher","people work and learn together there","it is a building","only children are there"], answer:1},
     {q:"Which person helps students find books?", options:["Principal","Custodian","Secretary","Librarian"], answer:3}
   ]},
]},
{day:6, label:"Day 6 — Mon", subjects:[
  {subject:"Language", title:"Letter E", summary:"Explore uppercase and lowercase E. Students practise the short /e/ sound (egg, elephant) and identify E words.",
   ...
   quiz:[
     ...
     {q:"Which E word is an animal?", options:["Egg","Eagle","Empty","Each"], answer:1},
     {q:"Find the E: cat, egg, tree, and elephant", options:["cat","egg","tree","elephant (both egg and elephant)"], answer:3},
  ...
  {subject:"Math", title:"Patterns: ABAB", summary:"Students identify, copy, extend, and create simple repeating AB patterns using colours, shapes, sounds, and actions.",
   ...
   quiz:[
     ...
     {q:"What comes next? clap, stomp, clap, stomp, ___", options:["stomp","clap","jump","sit"], answer:1},
     {q:"A repeating pattern always ___.", options:["stops after 4 items","changes randomly","follows the same rule over and over","has only 2 colours"], answer:2},
  ...
  {subject:"Science", title:"Pets and Their Needs", summary:"Students explore common pets (dog, cat, fish, bird) and their needs: food, water, shelter, exercise, and love.",
   ...
   quiz:[
     ...
     {q:"A fish needs ___ to breathe.", options:["air like humans","soil","water with dissolved oxygen (and often a filter)","only food"], answer:2},
     {q:"Who is responsible for a pet's care?", options:["Only the veterinarian","Only adults","The owner/family who chose to have the pet","No one"], answer:2},
  ...
  {subject:"SocialStudies", title:"Rules and Responsibility", summary:"Students explore why communities have rules: to keep people safe and ensure fairness. They discuss school rules and why following them matters.",
   ...
   quiz:[
     ...
     {q:"What happens if no one follows rules?", options:["Everything stays the same","Communities become unsafe and unfair","Only teachers care","Rules fix themselves"], answer:1},
     {q:"A responsibility is ___.", options:["something others do for you","a job or duty that you are expected to do","only for adults","never fun"], answer:1},
     {q:"Which is an example of responsibility at school?", options:["Littering","Arriving on time with your bag packed","Ignoring a classmate's help","Only doing your favourite subjects"], answer:1}
   ]},
]},
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Letter F", summary:"Explore uppercase and lowercase F. Students practise the /f/ sound and name F words such as fish, frog, and flower.",
   ...
   quiz:[
     ...
     {q:"Which F word is an animal?", options:["Flower","Farm","Frog","Float"], answer:2},
     {q:"Find all F words: fish, cat, frog, flower", options:["cat only","fish only","fish, frog, and flower","frog only"], answer:2},
  ...
  {subject:"Math", title:"Counting to 20", summary:"Students count forward from any number to 20, identify missing numbers, and begin to recognise teen numbers as ten and some more.",
   ...
   quiz:[
     ...
     {q:"Which number is between 10 and 12?", options:["9","11","13","8"], answer:1},
     {q:"How many tens are in the number 15?", options:["0","1","2","5"], answer:1},
  ...
  {subject:"Science", title:"Wild Animals", summary:"Students explore wild animals in Ontario and beyond. Wild animals live in natural habitats, find their own food, and are not tamed.",
   ...
   quiz:[
     ...
     {q:"Where would you find a beaver in the wild?", options:["In a city apartment","In a desert","Near lakes and rivers in forests","In a shopping mall"], answer:2},
     {q:"Wild animals should ___.", options:["be taken home as pets","always be fed by humans","be observed from a safe distance and left in their habitat","be hunted for food always"], answer:2},
  ...
  {subject:"SocialStudies", title:"Being a Good Friend", summary:"Students explore qualities of friendship: kindness, sharing, taking turns, listening, and including others. Good friends treat each other with respect.",
   ...
   quiz:[
     ...
     {q:"Taking turns means ___.", options:["always going first","each person gets a chance","only one person goes","skipping others"], answer:1},
     ...
     {q:"Which is an act of friendship?", options:["Laughing at a mistake","Pushing in line","Cheering a friend on when they try something hard","Ignoring a friend who is sad"], answer:2}
   ]},
]},
{day:8, label:"Day 8 — Wed", subjects:[
  ...
  {subject:"Math", title:"Non-Standard Measurement: Length", summary:"Students measure the length of objects using non-standard units (paper clips, blocks, hands) and use the words longer, shorter, and same.",
   ...
   quiz:[
     ...
     {q:"A book is 8 paper clips long. A pencil is 5. The book is ___.", options:["shorter","the same length as the pencil","longer","impossible to compare"], answer:2},
     {q:"To compare lengths fairly, you must ___.", options:["guess","use a computer","start measuring from the same point","always use a ruler"], answer:2},
  ...
  {subject:"Science", title:"Parts of a Plant", summary:"Students name and describe the function of plant parts: roots (absorb water), stem (transport water and support), leaves (make food), flower (reproduction), seed (new plant).",
   ...
   quiz:[
     ...
     {q:"Leaves are the main part of a plant that ___.", options:["hold up the plant","make food using sunlight and air","absorb water from soil","produce seeds only"], answer:1},
     {q:"A flower helps a plant by ___.", options:["absorbing water","making food","supporting the stem","producing seeds that grow into new plants"], answer:3},
  ...
  {subject:"SocialStudies", title:"Canadian Symbols", summary:"Students learn symbols that represent Canada: the maple leaf flag, beaver, and Parliament Buildings. These symbols create a shared Canadian identity.",
   ...
   quiz:[
     ...
     {q:"The maple leaf is a symbol of ___.", options:["the United States","England","Canada","France"], answer:2},
     {q:"Where does the Canadian government meet?", options:["The CN Tower","Parliament Hill in Ottawa","Niagara Falls","The Rocky Mountains"], answer:1},
     {q:"Why do countries have symbols?", options:["Only for money","To identify the nation and give its people a shared sense of pride and belonging","Only for flags","Only for tourists"], answer:1}
   ]},
]},
{day:9, label:"Day 9 — Thu", subjects:[
  {subject:"Language", title:"Letter H", summary:"Explore uppercase and lowercase H. Students practise the /h/ sound and name H words such as house, horse, and hat.",
   ...
   quiz:[
     ...
     {q:"Which H word do you wear on your head?", options:["House","Horse","Hat","Hand"], answer:2},
     {q:"Find the H: hat, dog, horse, cat", options:["dog and cat","hat and horse","horse only","hat only"], answer:1},
  ...
  {subject:"Math", title:"Subtraction from 5", summary:"Students subtract within 5 using objects, pictures, and fingers. They understand subtraction as taking away.",
   ...
   quiz:[
     ...
     {q:"What does the - sign mean?", options:["Add","Multiply","Take away","Measure"], answer:2},
  ...
  {subject:"Science", title:"Winter Season", summary:"Students explore characteristics of winter in Ontario: cold temperatures, ice and snow, shorter days, and how animals and plants respond.",
   ...
   quiz:[
     ...
     {q:"Days are ___ in winter than in summer.", options:["longer","the same length","shorter","exactly 12 hours"], answer:2},
  ...
  {subject:"SocialStudies", title:"Our Environment: Caring for Nature", summary:"Students learn that the environment includes air, water, land, plants, and animals. Everyone can help protect it by reducing waste and not littering.",
   ...
   quiz:[
     ...
     {q:"How can you help the environment?", options:["Leave taps running","Litter in parks","Turn off lights and put waste in the bin","Use extra plastic bags"], answer:2},
     {q:"Why is clean air important?", options:["Only for birds","All living things need clean air to breathe and stay healthy","Only in cities","Only in summer"], answer:1},
     {q:"Recycling helps the environment because ___.", options:["it makes more rubbish","it reduces waste and reuses materials","it is only for adults","only paper can be recycled"], answer:1}
   ]},
]},
{day:10, label:"Day 10 — Fri", subjects:[
  {subject:"Language", title:"Short Vowel Sounds", summary:"Students review and practise identifying short vowel sounds: a (cat), e (hen), i (pig), o (dog), u (bug) in spoken words.",
   ...
   quiz:[
     ...
     {q:"Which word has the short O sound?", options:["Bean","Rain","Dog","Blue"], answer:2},
     {q:"Which word has the short U sound?", options:["Rain","Cake","Bee","Bug"], answer:3},
  ...
  {subject:"Math", title:"3D Shapes: Sphere, Cube, Cylinder", summary:"Students identify and describe 3D shapes they encounter daily. A sphere (ball), cube (dice), and cylinder (can) are explored.",
   ...
   quiz:[
     ...
     {q:"Which 3D shape is a can of soup?", options:["Sphere","Cube","Cylinder","Cone"], answer:2},
     {q:"Which 3D shape can roll in any direction?", options:["Cube","Cylinder","Cone","Sphere"], answer:3},
  ...
  {subject:"SocialStudies", title:"Family Traditions", summary:"Students learn that families celebrate traditions: special events, foods, stories, and practices that are passed down and shared. All traditions are valued.",
   ...
   quiz:[
     ...
     {q:"Why are traditions important?", options:["They are not","They connect families to their history and heritage and create special memories","Only for wealthy families","Only for certain cultures"], answer:1},
     {q:"Can different families have different traditions?", options:["No","Only if they are the same culture","Yes — each family's traditions are unique and special","Only in other countries"], answer:2},
     {q:"Sharing family traditions with classmates ___.", options:["causes problems","shows respect and helps others learn about different cultures","is embarrassing","only confuses others"], answer:1}
   ]},
]},
{day:11, label:"Day 11 — Mon", subjects:[
  {subject:"Language", title:"Letter I", summary:"Explore uppercase and lowercase I. Students practise the short /i/ sound (igloo, insect) and the long /i/ sound (ice, island).",
   ...
   quiz:[
     ...
     {q:"Find the I: ant, igloo, elephant, octopus", options:["ant","igloo","elephant","octopus"], answer:1},
  ...
  {subject:"Science", title:"Farm Animals", summary:"Students learn about common farm animals (cow, pig, chicken, sheep, horse) and how farms provide food and other products for communities.",
   ...
   quiz:[
     ...
     {q:"Eggs come from ___.", options:["cows","pigs","chickens","sheep"], answer:2},
     {q:"Why are farms important?", options:["They are not","Farms produce food that feeds communities and countries","Only animals live there","Only for rural people"], answer:1},
  ...
  {subject:"SocialStudies", title:"Kinds of Families", summary:"Students learn that families can look different — some have two parents, some one parent, some grandparents as caregivers, blended families — and all are equally valid.",
   ...
   quiz:[
     ...
     {q:"A blended family is one where ___.", options:["no children are present","only grandparents live together","two families join together (step-parents, step-siblings)","only one parent lives in the house"], answer:2},
     {q:"What makes every family special?", options:["Only its size","Only its money","The love and care the members share","Only how big the house is"], answer:2},
     {q:"Why is it important to respect different kinds of families?", options:["It is not","All families deserve respect; diversity in families is natural and normal","Only traditional families are valid","Only if they are like yours"], answer:1}
   ]},
]},
{day:12, label:"Day 12 — Tue", subjects:[
  {subject:"Language", title:"Letter J", summary:"Explore uppercase and lowercase J. Students practise the /j/ sound and name J words such as jump, jungle, and jar.",
   ...
   quiz:[
     ...
     {q:"Which J word means to leap into the air?", options:["Jar","Jam","Jump","Just"], answer:2},
     {q:"Find the J: jellyfish, cat, jar, apple", options:["cat and apple","jellyfish and jar","jar only","jellyfish only"], answer:1},
  ...
  {subject:"Science", title:"Materials: Natural and Human-Made", summary:"Students sort materials into natural (wood, cotton, water, wool) and human-made/manufactured (plastic, glass, metal, nylon). Both types have different properties and uses.",
   ...
   quiz:[
     ...
     {q:"Which is a human-made (manufactured) material?", options:["Cotton","Wool","Plastic","Wood"], answer:2},
     {q:"Why do humans make new materials?", options:["Only for decoration","To create materials with specific properties that may not exist in nature","Natural materials are bad","Only for factories"], answer:1},
  ...
  {subject:"SocialStudies", title:"Our Town/City", summary:"Students explore the features of their local community: streets, buildings, parks, services, and how the town/city helps people meet their needs.",
   ...
   quiz:[
     ...
     {q:"A park is an important community space because ___.", options:["it is only for dogs","it gives people a place to relax, play, and connect with nature","only athletes use it","it replaces schools"], answer:1},
     {q:"Which service helps when there is a fire?", options:["School","Library","Fire station","Grocery store"], answer:1},
     {q:"Why do people live in communities?", options:["To be isolated","Communities allow people to share resources, services, and support each other","Only for shopping","Only for work"], answer:1}
   ]},
]},
{day:13, label:"Day 13 — Wed", subjects:[
  {subject:"Language", title:"Letter K", summary:"Explore uppercase and lowercase K. Students practise the /k/ sound (same as hard C) and name K words such as kite, king, and kangaroo.",
   ...
   quiz:[
     ...
     {q:"Which K word is a large jumping animal?", options:["King","Kite","Kangaroo","Kind"], answer:2},
     {q:"Find the K: kite, cat, king, dog", options:["cat and dog","kite and king","king only","kite only"], answer:1},
  ...
  {subject:"Math", title:"ABC Patterns", summary:"Students identify, extend, and create ABC patterns (three repeating units) using colours, shapes, and objects.",
   ...
   quiz:[
     ...
     {q:"Identify: triangle, circle, square, triangle, circle, ___", options:["triangle","circle","square","rectangle"], answer:2},
     {q:"An ABC pattern repeats every ___ items.", options:["2","3","4","5"], answer:1},
  ...
  {subject:"Science", title:"Sound and Light", summary:"Students explore that sound travels as vibrations and light travels in straight lines. They investigate different sources of both.",
   ...
   quiz:[
     ...
     {q:"Light travels in ___.", options:["curves","zigzags","straight lines","circles"], answer:2},
     {q:"Which is a natural source of light?", options:["A torch","A lamp","The Sun","A television"], answer:2},
  ...
  {subject:"SocialStudies", title:"Rights and Responsibilities", summary:"Students learn that rights (things they are entitled to: safety, education, play) come with responsibilities (duties: respect, cooperation, looking after things).",
   ...
   quiz:[
     ...
     {q:"Which is a right of children in Canada?", options:["Working long hours","Education, safety, and play","No protection under law","Only food"], answer:1},
     {q:"Which is a responsibility at school?", options:["Littering in the hallway","Arriving late every day","Treating classmates with respect","Ignoring classroom rules"], answer:2},
     {q:"Rights and responsibilities ___.", options:["are unrelated","go together — having rights means respecting others' rights too","only adults have","only governments have"], answer:1}
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  {subject:"Language", title:"Letter L", summary:"Explore uppercase and lowercase L. Students practise the /l/ sound and name L words such as leaf, lion, and lemon.",
   ...
   quiz:[
     ...
     {q:"Which L word is an animal?", options:["Leaf","Lemon","Lion","Light"], answer:2},
     {q:"Find all L words: leaf, dog, lemon, lion", options:["dog only","leaf, lemon, and lion","lion only","lemon only"], answer:1},
  ...
  {subject:"Math", title:"Number Words 1 to 10", summary:"Students match numerals to number words: one, two, three, four, five, six, seven, eight, nine, ten.",
   ...
   quiz:[
     ...
     {q:"Which number word means 10?", options:["Nine","Ten","Seven","Eight"], answer:1},
     {q:"Match: 3 = ?", options:["One","Two","Three","Four"], answer:2},
  ...
  {subject:"Science", title:"Spring Season", summary:"Students explore characteristics of spring in Ontario: warming temperatures, returning birds, blossoming plants, and rain showers.",
   ...
   quiz:[
     ...
     {q:"Many birds ___ in spring after being away in warmer places.", options:["hibernate","return (migrate back north)","disappear","stay underground"], answer:1},
     {q:"Spring weather in Ontario is often ___.", options:["hot and dry like summer","cold and snowy like winter","warming, with rain showers","always perfect"], answer:2},
  ...
  {subject:"SocialStudies", title:"Special People in My Life", summary:"Students identify and appreciate special people in their lives: family members, friends, teachers, and community helpers who contribute to their wellbeing.",
   ...
   quiz:[
     ...
     {q:"Which person at school helps you feel safe and learn every day?", options:["A stranger","Your teacher","Someone on TV","No one"], answer:1},
     {q:"Why is it important to appreciate the people who help you?", options:["It is not","It shows respect and encourages positive relationships","Only for birthdays","Only if they give you things"], answer:1},
     {q:"A community helper who is special to the community is ___.", options:["anyone who contributes positively to others' wellbeing","only a policeman","only a teacher","only a family member"], answer:0}
   ]},
]},
{day:15, label:"Day 15 — Fri", subjects:[
  {subject:"Language", title:"Letter M", summary:"Explore uppercase and lowercase M. Students practise the /m/ sound and name M words such as moon, monkey, and mango.",
   ...
   quiz:[
     ...
     {q:"Which M word is an animal?", options:["Moon","Mango","Monkey","Mud"], answer:2},
     {q:"Find all M words: moon, sun, mango, monkey", options:["sun only","moon, mango, monkey","mango only","monkey only"], answer:1},
  ...
  {subject:"Math", title:"Counting by 2s to 20", summary:"Students skip-count by 2s (2, 4, 6, 8...) to 20, recognising the pattern of even numbers.",
   ...
   quiz:[
     ...
     {q:"Counting by 2s gives you ___ numbers.", options:["odd","even","random","prime"], answer:1},
     {q:"What comes next? 16, 18, ___", options:["17","20","19","21"], answer:1},
  ...
  {subject:"Science", title:"Seasons Review", summary:"Students review the four seasons in Ontario, reinforcing what changes during each — temperatures, clothing, plants, animals, and activities.",
   ...
   quiz:[
     ...
     {q:"What type of clothing do you wear in summer?", options:["Heavy coat and boots","Light clothes and shorts","Thick sweaters","Ski gear"], answer:1},
     {q:"In fall, many farmers ___.", options:["plant crops","harvest their crops","begin planting seeds","do nothing"], answer:1},
  ...
  {subject:"SocialStudies", title:"Community Helpers: Doctors and Teachers", summary:"Students explore how doctors keep us healthy and how teachers help us learn. They appreciate that community helpers work to improve the lives of everyone.",
   ...
   quiz:[
     ...
     {q:"Where do you go to see a doctor?", options:["A library","A fire station","A clinic or hospital","A school"], answer:2},
     {q:"Community helpers work to make our community ___.", options:["worse","better and safer for everyone","confusing","smaller"], answer:1},
     {q:"Who would you visit for a check-up to make sure you are healthy?", options:["Teacher","Doctor","Firefighter","Librarian"], answer:1}
   ]},
]},
{day:16, label:"Day 16 — Mon", subjects:[
  {subject:"Language", title:"Letter P", summary:"Explore uppercase and lowercase P. Students identify the letter, practise its sound, and name words beginning with P such as penguin, pizza, and purple.",
   ...
   quiz:[
     ...
     {q:"How do you write a lowercase p?", options:["Like a b facing right","A stick with a circle at the bottom left","A tall stick","Two circles"], answer:1},
     {q:"Which of these starts with P?", options:["Apple","Banana","Pear","Mango"], answer:2},
  ...
  {subject:"Math", title:"Numbers 1-20: Recognition", summary:"Students read and write numerals 1 to 20, connecting each numeral to its quantity.",
   ...
   quiz:[
     ...
     {q:"Which group has 20 items?", options:["A group of ten","A group of fifteen","A group of twenty","A group of five"], answer:2},
  ...
  {subject:"Science", title:"Push and Pull: Forces", summary:"Students explore how pushing and pulling are forces that move objects. They observe that heavier objects need more force.",
   ...
   quiz:[
     ...
     {q:"Which is an example of a push?", options:["Pulling a wagon","Opening a drawer toward you","Kicking a ball","Picking up a book"], answer:2},
     {q:"Which is an example of a pull?", options:["Pushing a door open","Throwing a ball","Opening a drawer toward you","Kicking a soccer ball"], answer:2},
  ...
  {subject:"SocialStudies", title:"Our School Community", summary:"Students explore the school as a community. They identify helpers such as the principal, caretaker, librarian, and office staff.",
   ...
   quiz:[
     ...
     {q:"A caretaker helps keep the school ___.", options:["noisy","clean and safe","messy","closed"], answer:1},
     {q:"Why is the school a community?", options:["People fight there","People live there","People work and learn together","No one helps each other"], answer:2},
     {q:"Who answers the phone and helps visitors in a school?", options:["The teacher","The caretaker","The office staff","The librarian"], answer:2}
   ]},
]},
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"Language", title:"Letter Q", summary:"Explore uppercase and lowercase Q. Students identify the letter, practise its sound, and recognise that Q is almost always followed by U in English words.",
   ...
   quiz:[
     ...
     {q:"Which word starts with Q?", options:["King","Queen","Quick","Both B and C"], answer:3},
     {q:"A word that means silent and peaceful starts with Q. It is ___.", options:["Quick","Quiet","Quite","Quiz"], answer:1},
  ...
  {subject:"Math", title:"Sorting by Size and Colour", summary:"Students sort collections by size (big/small) and colour. They explain their sorting rule.",
   ...
   quiz:[
     ...
     {q:"You can sort the same set of objects in ___ ways.", options:["only one","only two","many different","no"], answer:2},
     {q:"What is the sorting rule if you put triangles together?", options:["Colour","Size","Shape","Number"], answer:2},
  ...
  {subject:"Science", title:"Sinking and Floating", summary:"Students predict and test whether objects sink or float in water, discovering that shape and material affect floating.",
   ...
   quiz:[
     ...
     {q:"A wooden stick will most likely ___.", options:["sink","float","dissolve","explode"], answer:1},
     {q:"A heavy metal coin will most likely ___.", options:["float","dissolve","fly","sink"], answer:3},
  ...
  {subject:"SocialStudies", title:"Needs and Wants", summary:"Students learn to distinguish between needs (things necessary to survive) and wants (things we desire but do not need).",
   ...
   quiz:[
     ...
     {q:"Which is a NEED?", options:["A toy car","A video game","Clean water","A bicycle"], answer:2},
     {q:"Which is a WANT?", options:["Food","Shelter","A new book bag","Clothing"], answer:2},
     {q:"Why is it important to know the difference between needs and wants?", options:["It is not important","It helps you make good choices with money and resources","Only adults need to know","Wants are always wrong"], answer:1}
   ]},
]},
{day:18, label:"Day 18 — Wed", subjects:[
  {subject:"Language", title:"Letter R", summary:"Explore uppercase and lowercase R. Students identify the letter, practise its /r/ sound, and name words beginning with R such as rabbit, rain, and rainbow.",
   ...
   quiz:[
     ...
     {q:"Which animal starts with R?", options:["Cat","Bear","Dog","Rabbit"], answer:3},
     {q:"Find the R word: The ___ is falling from the sky.", options:["Sun","Moon","Rain","Wind"], answer:2},
  ...
  {subject:"Math", title:"Patterns: ABAB and AABB", summary:"Students identify, copy, extend, and create repeating patterns using objects, sounds, and actions.",
   ...
   quiz:[
     ...
     {q:"What is the pattern rule for: circle, circle, square, circle, circle, square?", options:["ABAB","AABB","ABBA","AAAB"], answer:1},
     {q:"What comes next? 1, 2, 1, 2, ___", options:["3","1","2","4"], answer:1},
  ...
  {subject:"Science", title:"Living Things: Animals", summary:"Students explore characteristics of animals. All animals move, eat, grow, and produce offspring. They are sorted by habitat and diet.",
   ...
   quiz:[
     ...
     {q:"An animal that eats only meat is a ___.", options:["herbivore","omnivore","carnivore","producer"], answer:2},
     {q:"A bear that eats both plants and fish is an ___.", options:["herbivore","carnivore","omnivore","insectivore"], answer:2},
  ...
  {subject:"SocialStudies", title:"Our Neighbourhood", summary:"Students explore their neighbourhood as a community with homes, parks, stores, schools, and community services close together.",
   ...
   quiz:[
     ...
     {q:"What makes a neighbourhood a community?", options:["The buildings","People sharing the same area and looking out for each other","Only the stores","Only the houses"], answer:1},
     {q:"A map of a neighbourhood shows ___.", options:["only countries","where places like homes, schools, and parks are located","only oceans","only mountains"], answer:1},
     {q:"Why are parks important in a neighbourhood?", options:["They are not","They give people a place to play, relax, and connect with nature","Only children use them","Only for sports"], answer:1}
   ]},
]},
{day:19, label:"Day 19 — Thu", subjects:[
  {subject:"Language", title:"Letter S", summary:"Explore uppercase and lowercase S. Students identify the letter, practise its /s/ sound, and name S words such as sun, snake, and star.",
   ...
   quiz:[
     ...
     {q:"Find the S word: The ___ shines in the sky.", options:["Moon","Cloud","Rain","Sun"], answer:3},
     {q:"Which animal starts with S?", options:["Dog","Cat","Bird","Snake"], answer:3},
  ...
  {subject:"Math", title:"Addition to 10", summary:"Students add two groups of objects to find the total. They use pictures, counters, and number lines to explore addition.",
   ...
   quiz:[
     ...
     {q:"What does the + sign mean?", options:["Take away","Put together / add","Compare","Divide"], answer:1},
  ...
  {subject:"Science", title:"The Sun and Sky", summary:"Students explore the Sun as Earth's main source of light and heat. They observe that the sky changes from day to night.",
   ...
   quiz:[
     ...
     {q:"During the day, the Sun is ___ in the sky.", options:["invisible","visible (we can see it when skies are clear)","underground","on the horizon only"], answer:1},
     {q:"At night, the Sun ___.", options:["is still in the sky in the same place","has moved to the other side of Earth (appears to set)","disappears forever","gets smaller"], answer:1},
  ...
  {subject:"SocialStudies", title:"Canadian Symbols", summary:"Students learn about symbols that represent Canada: the maple leaf, beaver, Canadian flag, Parliament Buildings, and the national anthem.",
   ...
   quiz:[
     ...
     {q:"Canada's national anthem is called ___.", options:["God Save the King","O Canada","Amazing Grace","The Star-Spangled Banner"], answer:1},
     {q:"Where does Canada's federal government meet?", options:["The CN Tower","Parliament Hill","Niagara Falls","The Rockies"], answer:1},
     {q:"The colours of the Canadian flag are ___.", options:["Blue and white","Red, white, and blue","Red and white","Green and gold"], answer:2}
   ]},
]},
{day:20, label:"Day 20 — Fri", subjects:[
  {subject:"Language", title:"Letter T", summary:"Explore uppercase and lowercase T. Students identify the letter, practise its /t/ sound, and name T words such as tiger, table, and turtle.",
   ...
   quiz:[
     ...
     {q:"Find the T word: I sit at a ___ to eat.", options:["Chair","Desk","Table","Bench"], answer:2},
     {q:"Which colour starts with T?", options:["Blue","Teal","Red","Green"], answer:1},
  ...
  {subject:"Math", title:"Subtraction from 10", summary:"Students subtract within 10 using objects, pictures, and number lines. They understand subtraction as taking away.",
   ...
   quiz:[
     ...
     {q:"What does the - sign mean?", options:["Add","Take away","Put together","Share"], answer:1},
     {q:"7 - 7 = ?", options:["7","1","0","14"], answer:2},
  ...
  {subject:"Science", title:"Air and Wind", summary:"Students explore air as a real substance that takes up space, and that moving air is called wind. Wind can be gentle or strong.",
   ...
   quiz:[
     ...
     {q:"A gentle breeze and a storm are both caused by ___.", options:["rain","moving air (wind)","the sun heating the ground evenly","no movement"], answer:1},
     {q:"Which tool measures wind speed?", options:["Thermometer","Ruler","Anemometer","Scale"], answer:2},
  ...
  {subject:"SocialStudies", title:"Feelings and Emotions", summary:"Students explore a range of emotions and learn healthy ways to express feelings and manage emotions in social situations.",
   ...
   quiz:[
     ...
     {q:"Why is it important to talk about your feelings?", options:["It is not","It helps others understand you and helps you feel better","Only adults talk about feelings","Feelings should always be hidden"], answer:1},
     {q:"If a friend is sad, you could ___.", options:["ignore them","laugh at them","ask if they are okay and listen","run away"], answer:2},
     {q:"Being kind to someone who is upset is called ___.", options:["arguing","empathy","ignoring","competing"], answer:1}
   ]},
]},
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"Language", title:"Letter U", summary:"Explore uppercase and lowercase U. Students identify the letter, practise its short /u/ sound (umbrella) and long /u/ sound (uniform), and find U words.",
   ...
   quiz:[
     ...
     {q:"Which U word means something you wear?", options:["Undo","Under","Uniform","Upper"], answer:2},
     {q:"U is a ___.", options:["consonant","vowel","number","colour"], answer:1},
  ...
  {subject:"Math", title:"Graphs: Bar Graphs", summary:"Students create and read simple picture and bar graphs. They answer questions about the data shown.",
   ...
   quiz:[
     ...
     {q:"What question does a graph help answer?", options:["How does something smell?","How many of each thing are there?","What colour is something?","How heavy is something?"], answer:1},
     {q:"If 5 kids chose pizza and 3 chose pasta, which bar is taller?", options:["Pasta","They are equal","Pizza","Cannot tell"], answer:2},
  ...
  {subject:"Science", title:"Day and Night", summary:"Students explore why we have day and night — Earth rotates on its axis, causing each side to face toward or away from the Sun.",
   ...
   quiz:[
     ...
     {q:"One full rotation of Earth takes about ___.", options:["1 hour","24 hours (1 day)","1 month","1 year"], answer:1},
     {q:"At night, the Sun ___.", options:["is visible in the sky","is shining on the other side of Earth","disappears","gets cold"], answer:1},
  ...
  {subject:"SocialStudies", title:"Friends and Kindness", summary:"Students explore what makes a good friend and practise acts of kindness. They discuss how kind actions make communities happier.",
   ...
   quiz:[
     ...
     {q:"If a classmate has no one to play with, you could ___.", options:["ignore them","laugh at them","invite them to join your game","tell them to find others"], answer:2},
     {q:"Why is kindness important in a community?", options:["It is not","It makes everyone feel welcome and valued","Only kind people deserve it","Only some people need kindness"], answer:1},
     {q:"Which is an act of kindness?", options:["Taking someone's pencil","Pushing in line","Holding the door open for someone","Laughing at a mistake"], answer:2}
   ]},
]},
{day:22, label:"Day 22 — Tue", subjects:[
  ...
  {subject:"Math", title:"2D Shapes Review", summary:"Students review circles, squares, triangles, and rectangles. They identify, describe, and sort shapes by their properties.",
   ...
   quiz:[
     ...
     {q:"Which shape has 4 sides but they are not all equal?", options:["Square","Circle","Triangle","Rectangle"], answer:3},
  ...
  {subject:"Science", title:"Plants Need Water and Light", summary:"Students investigate what happens to plants without water or light, reinforcing that plants need both to grow.",
   ...
   quiz:[
     ...
     {q:"Leaves face toward light because ___.", options:["they are afraid of the dark","plants use sunlight to make food (photosynthesis)","leaves like warmth only","roots need light"], answer:1},
     {q:"Which part of a plant absorbs water from the soil?", options:["Leaves","Flowers","Stem","Roots"], answer:3},
  ...
  {subject:"SocialStudies", title:"Helping at Home", summary:"Students explore how family members share responsibilities at home: cooking, cleaning, caring for younger siblings, and yard work.",
   ...
   quiz:[
     ...
     {q:"Why is it important to share home responsibilities?", options:["It is not","It teaches children to be responsible and helps the family work as a team","Only adults should work","Only if parents ask"], answer:1},
     {q:"A chore is ___.", options:["a type of game","a job you do at home to help the family","a school subject","a type of food"], answer:1},
     {q:"Which chore could a kindergartener do?", options:["Pay the bills","Drive to the store","Fix the roof","Put toys away and help set the table"], answer:3}
   ]},
]},
{day:23, label:"Day 23 — Wed", subjects:[
  {subject:"Language", title:"Letter W", summary:"Explore uppercase and lowercase W. Students identify the letter, practise its /w/ sound, and name W words such as water, whale, and winter.",
   ...
   quiz:[
     ...
     {q:"Which W word is a large ocean animal?", options:["Wolf","Worm","Whale","Wasp"], answer:2},
  ...
  {subject:"Math", title:"Measurement: Length", summary:"Students use non-standard units (paper clips, blocks) to measure and compare the length of objects. They use terms: longer, shorter, same.",
   ...
   quiz:[
     ...
     {q:"Which statement about length is correct?", options:["Longer means shorter","Longer means it takes up more space from end to end","All things are the same length","Shorter means bigger"], answer:1},
     {q:"To compare two lengths, you should ___.", options:["guess","line them up at the same starting point","use a scale","smell them"], answer:1},
  ...
  {subject:"Science", title:"Animals in Winter", summary:"Students learn how animals survive winter: some hibernate, some migrate south, and some stay active by adapting their behaviour.",
   ...
   quiz:[
     ...
     {q:"Migration means ___.", options:["sleeping through winter","growing thicker fur","travelling to a warmer place for winter","staying and being active"], answer:2},
     {q:"Which bird migrates south in autumn?", options:["Owl","Chickadee","Canada Goose","Crow"], answer:2},
  ...
  {subject:"SocialStudies", title:"Weather and Our Lives", summary:"Students explore how weather affects daily decisions: what to wear, what activities to do, and how communities prepare for extreme weather.",
   ...
   quiz:[
     ...
     {q:"Extreme weather like a blizzard can ___.", options:["have no impact","cause school closures and road dangers","only affect farms","only affect the sky"], answer:1},
     {q:"A weather forecast helps people ___.", options:["predict the future","plan and prepare for upcoming weather","control the weather","make it rain"], answer:1},
     {q:"Which job involves predicting the weather?", options:["Baker","Meteorologist","Plumber","Librarian"], answer:1}
   ]},
]},
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Letter X", summary:"Explore uppercase and lowercase X. Students identify the letter, practise its /ks/ sound, and note that X rarely starts words in English.",
   ...
   quiz:[
     ...
     {q:"Which word has an X?", options:["Dog","Cat","Fox","Bird"], answer:2},
     {q:"An X on a map often marks ___.", options:["water","mountains","a special or buried location","a road"], answer:2},
  ...
  {subject:"Math", title:"Measurement: Capacity", summary:"Students compare the capacity (how much a container holds) using non-standard units. They use terms: more, less, same.",
   ...
   quiz:[
     ...
     {q:"If you fill a small jar and a big jar with water, the big jar holds ___.", options:["less","the same","more","nothing"], answer:2},
     {q:"To compare capacity you could ___.", options:["weigh the containers","count the containers","fill each with water and compare","smell them"], answer:2},
  ...
  {subject:"Science", title:"Properties of Water", summary:"Students explore water as a liquid that takes the shape of its container, that it freezes into solid ice and evaporates into invisible vapour.",
   ...
   quiz:[
     ...
     {q:"When water evaporates it becomes ___.", options:["solid","heavier","invisible water vapour (gas)","coloured"], answer:2},
     {q:"Water takes the shape of ___.", options:["its original form only","its container","a ball always","a flat sheet always"], answer:1},
  ...
  {subject:"SocialStudies", title:"My Country: Canada", summary:"Students explore Canada as their country: its size, capital city, official languages, and symbols that make it unique.",
   ...
   quiz:[
     ...
     {q:"What are Canada's official languages?", options:["Spanish and English","French and English","Italian and French","English and Chinese"], answer:1},
     {q:"Canada is the ___ largest country in the world by area.", options:["1st","2nd","3rd","5th"], answer:1}
   ]},
]},
{day:25, label:"Day 25 — Fri", subjects:[
  {subject:"Language", title:"Letter Y", summary:"Explore uppercase and lowercase Y. Students identify the letter, practise its /y/ sound, and name Y words such as yak, yarn, and yes.",
   ...
   quiz:[
     ...
     {q:"Find the Y: The answer is ___, not no.", options:["Maybe","Yes","No","Perhaps"], answer:1},
     {q:"Which Y word is something you knit with?", options:["Yam","Year","Yarn","Yard"], answer:2},
  ...
  {subject:"Math", title:"Numbers to 20: Addition and Subtraction", summary:"Students add and subtract within 20 using number lines, counters, and mental strategies.",
   ...
   quiz:[
     ...
     {q:"What is 10 + 7?", options:["16","17","18","15"], answer:1},
     {q:"20 - 9 = ?", options:["10","11","12","13"], answer:1},
  ...
  {subject:"Science", title:"Insects", summary:"Students explore characteristics of insects: 6 legs, 3 body parts (head, thorax, abdomen), and often wings. Common Ontario insects are identified.",
   ...
   quiz:[
     ...
     {q:"Which is an insect?", options:["Spider","Worm","Butterfly","Centipede"], answer:2},
     {q:"A spider is NOT an insect because it has ___ legs.", options:["6","8","4","10"], answer:1},
  ...
  {subject:"SocialStudies", title:"Exploring Our Differences and Similarities", summary:"Students celebrate diversity by exploring how people are alike and different in appearance, language, food, and traditions.",
   ...
   quiz:[
     ...
     {q:"Which is a way people are similar across all cultures?", options:["They all eat the same food","They all look the same","They all have families, feelings, and a need to belong","They all speak English"], answer:2},
     {q:"Diversity in a classroom means ___.", options:["everyone is the same","everyone has the exact same background","students come from different backgrounds and experiences","only one culture is represented"], answer:2},
     {q:"Why is it important to learn about other cultures?", options:["It is not","It builds empathy and understanding","Only for geography class","Only for adults"], answer:1}
   ]},
]},
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Letter Z", summary:"Explore uppercase and lowercase Z. Students identify the letter, practise its /z/ sound, and name Z words such as zebra, zero, and zip.",
   ...
   quiz:[
     ...
     {q:"Find the Z: The number that means nothing is ___.", options:["One","Ten","Zero","Two"], answer:2},
     {q:"Which Z word is a striped animal?", options:["Zap","Zip","Zebra","Zone"], answer:2},
  ...
  {subject:"Math", title:"Sorting 3D Shapes", summary:"Students identify and sort 3D shapes: sphere, cube, cylinder, and cone. They describe them using faces, edges, and vertices.",
   ...
   quiz:[
     ...
     {q:"A cube has ___ flat faces.", options:["4","5","6","8"], answer:2},
     {q:"A cylinder has ___ flat circular faces.", options:["0","1","2","3"], answer:2},
     {q:"Which 3D shape comes to a point at the top?", options:["Sphere","Cube","Cylinder","Cone"], answer:3},
  ...
  {subject:"Science", title:"Taking Care of Our Environment", summary:"Students learn about littering and waste, and simple actions to protect the environment: picking up litter, reducing waste, and recycling.",
   ...
   quiz:[
     ...
     {q:"Which action helps the environment?", options:["Leaving garbage in a park","Picking up litter","Wasting water","Leaving lights on all night"], answer:1},
     {q:"The three Rs are Reduce, Reuse, and ___.", options:["Recycle","Refuse","Rotate","Reach"], answer:0},
  ...
  {subject:"SocialStudies", title:"All About Me: Reflection", summary:"Students reflect on their learning through the year, identifying what they have learned, how they have grown, and what they are proud of.",
   ...
   quiz:[
     ...
     {q:"Something new I learned this year is ___.", options:["Nothing","How to read new words, count higher, and learn about the world","Only my name","Only colours"], answer:1},
     {q:"A goal for next year could be ___.", options:["To do nothing new","To try something harder and keep learning","To never make mistakes","To stop reading"], answer:1},
     {q:"Learning is ___.", options:["only at school","only from books","something that happens everywhere and every day","only from teachers"], answer:2}
   ]},
]},
{day:27, label:"Day 27 — Tue", subjects:[
  ...
  {subject:"Math", title:"Counting Back: Subtraction", summary:"Students use counting back as a strategy for subtraction within 20.",
   ...
   quiz:[
     ...
     {q:"15 - 3 = ?", options:["10","11","12","13"], answer:2},
     {q:"Counting back means you count in which direction?", options:["Forward (up)","Backward (down)","Sideways","Randomly"], answer:1},
  ...
  {subject:"Science", title:"Materials Around Us", summary:"Students explore everyday materials (wood, plastic, metal, fabric, glass) and their properties such as hard, soft, bendy, and transparent.",
   ...
   quiz:[
     ...
     {q:"Fabric is usually ___.", options:["hard and rigid","soft and flexible","transparent","liquid"], answer:1},
     {q:"Which material is a good conductor of electricity?", options:["Wood","Glass","Metal","Rubber"], answer:2},
  ...
  {subject:"SocialStudies", title:"Special Days and Celebrations", summary:"Students explore special days celebrated in their community and around the world, recognising that different cultures celebrate in unique ways.",
   ...
   quiz:[
     ...
     {q:"Why do different cultures celebrate differently?", options:["They do not","Each culture has unique traditions, histories, and values that shape its celebrations","Only one way is correct","All celebrations are the same"], answer:1},
     {q:"Learning about others' celebrations helps us ___.", options:["feel confused","respect and appreciate different cultures","ignore diversity","stay only with our own culture"], answer:1},
     {q:"What is Diwali known as?", options:["Festival of Colour","Festival of Lights","Festival of Music","Festival of Food"], answer:1}
   ]},
]},
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Writing: My Favourite Thing", summary:"Students practise simple sentence writing about a personal favourite topic, using a capital letter, words, and a period.",
   ...
   quiz:[
     ...
     {q:"Which is written correctly?", options:["my dog is fluffy.","My dog is fluffy.","my Dog is fluffy.","My dog is Fluffy"], answer:1},
     {q:"When writing about your favourite thing, a good first sentence ___.", options:["says nothing","tells what your favourite thing is and why you like it","lists random words","asks a question with no answer"], answer:1},
  ...
  {subject:"Math", title:"Number Stories", summary:"Students create and solve simple addition and subtraction number stories using pictures and equations.",
   ...
   quiz:[
     ...
     {q:"I had 7 cookies. I ate 3. How many are left?", options:["3","4","5","6"], answer:1},
     {q:"Which equation matches: 4 ducks plus 2 ducks?", options:["4 - 2 = 2","4 + 2 = 6","4 x 2 = 8","6 - 2 = 4"], answer:1},
  ...
  {subject:"Science", title:"Living and Non-Living Review", summary:"Students review the differences between living things (grow, breathe, reproduce, respond) and non-living things (do not do these things).",
   ...
   quiz:[
     ...
     {q:"Which is a living thing?", options:["A chair","A cloud","A tree","A book"], answer:2},
     {q:"A non-living thing ___.", options:["grows on its own","needs food and water to survive","does not grow, breathe, or reproduce on its own","has feelings"], answer:2},
  ...
  {subject:"SocialStudies", title:"Caring for the Earth", summary:"Students review environmental responsibility: conserving water, reducing waste, protecting animals and plants, and making choices that help the planet.",
   ...
   quiz:[
     ...
     {q:"Protecting habitats helps ___.", options:["only humans","the animals and plants that live there","nobody","only farmers"], answer:1},
     {q:"Why should we reduce waste?", options:["Waste is good","Less waste means less pollution and a healthier planet","Only adults need to reduce waste","Waste helps plants grow"], answer:1},
     {q:"One thing a child can do to help the Earth is ___.", options:["Drive a car","Use less plastic and recycle where possible","Move to another planet","Wait for adults to fix everything"], answer:1}
   ]},
]},
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Rhyming Words", summary:"Students identify and generate rhyming words. Rhyming words have the same ending sound (e.g., cat/hat, dog/log, play/day).",
   ...
   quiz:[
     ...
     {q:"Which word rhymes with SUN?", options:["Moon","Star","Fun","Sky"], answer:2},
     {q:"Which pair of words rhymes?", options:["Dog/Cat","Ball/Bat","Play/Day","Sun/Moon"], answer:2},
  ...
  {subject:"Math", title:"Counting to 100 by 2s and 5s", summary:"Students count forward by 2s and 5s to 100, building number sense and a foundation for multiplication.",
   ...
   quiz:[
     ...
     {q:"Count by 2s: 14, 16, ___", options:["17","18","19","20"], answer:1},
     {q:"Count by 5s: 25, 30, ___", options:["33","35","40","45"], answer:1},
  ...
  {subject:"Science", title:"Science Review: All Strands", summary:"Students review life science (plants, animals), earth science (seasons, weather), and physical science (forces, materials).",
   ...
   quiz:[
     ...
     {q:"The four seasons in Ontario are ___.", options:["Hot, cold, wet, dry","Spring, summer, fall, winter","North, south, east, west","Day, night, dawn, dusk"], answer:1},
     {q:"A push and a pull are both types of ___.", options:["weather","patterns","forces","materials"], answer:2},
  ...
  {subject:"SocialStudies", title:"Social Studies Review", summary:"Students review communities, Canadian geography, symbols, seasons, and citizenship topics covered through the year.",
   ...
   quiz:[
     ...
     {q:"Which is a Canadian symbol?", options:["Eiffel Tower","Bald Eagle","Maple leaf","Statue of Liberty"], answer:2},
     {q:"Being a good citizen means ___.", options:["only following rules you like","following laws, helping others, and respecting the community","never helping anyone","only thinking about yourself"], answer:1},
     {q:"Canada has ___ official languages.", options:["1","2","3","4"], answer:1}
   ]},
]},
{day:30, label:"Day 30 — Fri", subjects:[
  {subject:"Language", title:"Alphabet Review and Simple Reading", summary:"Students review all 26 letters, their sounds, and demonstrate early reading of simple CVC (consonant-vowel-consonant) words.",
   ...
   quiz:[
     ...
     {q:"A CVC word has ___ letters.", options:["2","3","4","5"], answer:1},
     {q:"Which is a CVC word?", options:["Street","Cat","Play","Bring"], answer:1},
  ...
  {subject:"Math", title:"Year Review: Math", summary:"Students review all Kindergarten math concepts: counting, shapes, patterns, measurement, and addition/subtraction.",
   ...
   quiz:[
     ...
     {q:"What comes next? 2, 4, 6, ___", options:["7","8","9","10"], answer:1},
     {q:"8 - 3 = ?", options:["4","5","6","7"], answer:1},
  ...
  {subject:"Science", title:"Year Review: Science", summary:"Students review all Kindergarten science: living and non-living, plants, animals, seasons, weather, forces, and materials.",
   ...
   quiz:[
     ...
     {q:"Which season is it when leaves fall off trees?", options:["Spring","Summer","Fall/Autumn","Winter"], answer:2},
     {q:"A push and pull are types of ___.", options:["weather","forces","patterns","materials"], answer:1},
  ...
  {subject:"SocialStudies", title:"Year Review: Social Studies and Citizenship", summary:"Students review community helpers, Canadian symbols, rights and responsibilities, celebrations, and caring for the Earth.",
   ...
   quiz:[
     ...
     {q:"A right is something you ___.", options:["must give to others","are allowed to do or have","can take from others","never earn"], answer:1},
     {q:"Why is recycling important?", options:["It is not","It reduces waste and protects the environment","Only for adults","Only for scientists"], answer:1},
     {q:"A good citizen ___.", options:["ignores community rules","respects others, follows rules, and helps the community","only cares about themselves","never votes"], answer:1}
   ]},
]},
];
