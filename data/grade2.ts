...
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Finding the Main Idea", summary:"The main idea is what a story or text is mostly about.",
   ...
   quiz:[
     ...
     {q:"To find the main idea, you should...", options:["Think about what most of the text is about","Skip reading","Guess randomly","Read only the last sentence"], answer:0},
   ]},
...
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"Language", title:"Sequencing Events", summary:"Sequencing means putting events in the order they happened — first, next, then, last.",
   ...
   quiz:[
     ...
     {q:"Why is sequencing important when reading a story?", options:["It replaces the main idea","It changes the ending","It is not important","It helps you understand the order of events"], answer:3},
  ...
  {subject:"SocialStudies", title:"Finding Directions on a Map", summary:"Maps use symbols, a compass rose, and directions (N, S, E, W) to help people find their way.",
   ...
   quiz:[
     ...
     {q:"Why are symbols used on maps?", options:["To represent real things in a small, simple way","To take up space","To confuse readers","No reason"], answer:0},
   ]},
]},
{day:9, label:"Day 9 — Thu", subjects:[
  ...
  {subject:"SocialStudies", title:"Comparing Communities", summary:"Communities can be urban (city), suburban, or rural (countryside), each with different features and ways of life.",
   ...
   quiz:[
     ...
     {q:"A rural community is usually...", options:["Very crowded with tall buildings","On the moon","In the countryside, with farms and open land","Underwater"], answer:2},
...
{day:12, label:"Day 12 — Tue", subjects:[
  ...
  {subject:"SocialStudies", title:"Indigenous Peoples and First Nations of Canada", summary:"Canada is home to many Indigenous peoples — the First Nations, Métis, and Inuit — who have lived on this land for thousands of years and have rich cultures and traditions.",
   ...
   quiz:[
     {q:"Who were the first people to live in Canada?", options:["British settlers","French settlers","American explorers","Indigenous peoples (First Nations, Métis, Inuit)"], answer:3},
     ...
     {q:"Why is it important to learn about Indigenous cultures?", options:["To copy them exactly","It is not important","Because they are all the same","To respect and understand Canada's history and traditions"], answer:3},
     ...
     {q:"Traditional Indigenous knowledge often includes...", options:["Caring for the land, storytelling, and cultural practices","Modern factory work","Nothing about nature","How to use computers"], answer:0},
   ]},
]},
{day:13, label:"Day 13 — Wed", subjects:[
  ...
  {subject:"SocialStudies", title:"How Communities Change Over Time", summary:"Communities change over time — buildings get built or torn down, technology changes, and people's ways of life are different from long ago.",
   ...
   quiz:[
     ...
     {q:"How have communities changed over time?", options:["Buildings, technology, and ways of life have changed","They haven't changed at all","Only the weather changed","Communities disappear and reappear"], answer:0},
     ...
     {q:"Why is it helpful to learn about how communities changed?", options:["It helps us understand where we came from and how things improved","It is not helpful","To copy the past exactly","No reason"], answer:0},
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  ...
  {subject:"Math", title:"Measuring Length with Non-Standard Units", summary:"We can measure how long things are using non-standard units like paper clips, cubes, or hand spans — then count how many units fit.",
   ...
   quiz:[
     ...
     {q:"Why do we need to use the SAME unit when comparing lengths?", options:["To make it harder","Because units are the same always","So our measurements are fair and accurate","No reason"], answer:2},
  ...
  {subject:"SocialStudies", title:"Needs vs. Wants", summary:"Needs are things we must have to survive, like food, water, clothing, and shelter. Wants are things we would like to have but do not need to survive, like toys or candy.",
   ...
   quiz:[
     ...
     {q:"Which is the best description of a 'want'?", options:["Something you must have to live","Something free","Something every person owns","Something nice to have but not essential to survive"], answer:3},
...
{day:16, label:"Day 16 — Mon", subjects:[
  ...
  {subject:"Science", title:"Properties of Materials", summary:"Materials have properties that describe what they are like — hard or soft, rough or smooth, flexible or stiff, shiny or dull. These properties help us decide how to use them.",
   ...
   quiz:[
     ...
     {q:"A property of a material is something you can...", options:["Only guess","Smell only","Observe or measure, like hardness or colour","Never describe"], answer:2},
  ...
  {subject:"SocialStudies", title:"How Money and Trading Work", summary:"Long ago, people traded goods they had for goods they needed (called bartering). Today, we use money — coins and bills — to buy and sell things in a fair way.",
   ...
   quiz:[
     {q:"What is 'bartering'?", options:["Trading one item for another without money","Saving money in a bank","Spending all your money","Buying things with coins"], answer:0},
     ...
     {q:"If you earn money, you have...", options:["Lost it","Borrowed it","Received money for doing work or selling something","Spent it already"], answer:2},
...
{day:17, label:"Day 17 — Tue", subjects:[
  ...
  {subject:"Math", title:"Fractions: Halves and Quarters", summary:"A fraction shows equal parts of a whole. When something is cut into 2 equal parts, each part is one half (1/2). When cut into 4 equal parts, each part is one quarter (1/4).",
   ...
   quiz:[
     ...
     {q:"What does the bottom number in a fraction tell you?", options:["The size of the shape","Nothing","How many parts are shaded","How many equal parts the whole is divided into"], answer:3},
...
{day:18, label:"Day 18 — Wed", subjects:[
  ...
  {subject:"Science", title:"Light and Sound as Forms of Energy", summary:"Light and sound are both forms of energy. Light travels in straight lines and helps us see. Sound is made by vibrations and travels through air to reach our ears.",
   ...
   quiz:[
     {q:"What makes a sound?", options:["Light bouncing","Vibrations (things shaking back and forth)","Hot air only","Only electricity"], answer:1},
     ...
     {q:"Why can we hear sound?", options:["Vibrations travel through the air to our ears","Sound is visible","Our eyes pick it up","We create sound in our brains"], answer:0},
  ...
  {subject:"SocialStudies", title:"Caring for the Environment", summary:"We can help protect our environment by reducing waste, reusing things, recycling, and not polluting our air, water, or land. Everyone can help keep our planet healthy.",
   ...
   quiz:[
     ...
     {q:"Why is it important to care for the environment?", options:["No real reason","It is not important","All living things depend on a healthy environment","Only scientists care about it"], answer:2},
...
{day:19, label:"Day 19 — Thu", subjects:[
  ...
  {subject:"SocialStudies", title:"Good Citizenship", summary:"A good citizen is someone who helps their community, follows rules, respects others, and takes care of shared spaces. Being a helpful community member makes life better for everyone.",
   ...
   quiz:[
     ...
     {q:"Why is voting (when you are old enough) important?", options:["Voting changes nothing","It lets people have a say in decisions that affect the community","It is not important","Only leaders should vote"], answer:1},
...
{day:21, label:"Day 21 — Mon", subjects:[
  ...
  {subject:"Science", title:"Living vs. Non-Living Things (Deeper Look)", summary:"Living things need food, water, air, and space to grow. They also respond to their environment and reproduce (have offspring). Non-living things do not do these things.",
   ...
   quiz:[
     {q:"Which is a characteristic of ALL living things?", options:["They always live in water","They can fly","They need food, water, and air to survive","They are always green"], answer:2},
     {q:"Which of these is a non-living thing?", options:["A mushroom","A cloud","A flower","A worm"], answer:1},
     {q:"'Reproduce' means...", options:["To breathe air","To move quickly","To eat food","To make copies of yourself (have offspring)"], answer:3},
  ...
  {subject:"SocialStudies", title:"Transportation Long Ago vs. Today", summary:"Transportation has changed a lot over time. Long ago, people walked, rode horses, or travelled by boat. Today, we have cars, trains, airplanes, and buses.",
   ...
   quiz:[
     ...
     {q:"How has transportation changed our world?", options:["It has not changed anything","It changed nothing about trade","It lets people and goods travel faster and farther than before","It made travel slower"], answer:2},
...
{day:22, label:"Day 22 — Tue", subjects:[
  ...
  {subject:"Math", title:"Estimation Then Counting to Check", summary:"Estimation means making a good guess about a number without counting exactly. After estimating, you count to check how close your guess was.",
   ...
   quiz:[
     ...
     {q:"Which is the best strategy for estimating?", options:["Always guess 1","Always guess 100","Never guess","Think about what you already know to make a reasonable guess"], answer:3},
   ]},
  {subject:"Science", title:"Using Tools: Thermometers and Magnifying Glasses", summary:"Scientists use special tools to observe and measure. A thermometer measures temperature (how hot or cold something is). A magnifying glass makes small things look bigger so we can study them.",
   ...
   quiz:[
     ...
     {q:"Why do scientists use tools?", options:["Tools are never useful","To make observations and measurements more accurate","To draw pictures only","Just for decoration"], answer:1},
  ...
  {subject:"SocialStudies", title:"Celebrations and Traditions Around the World", summary:"Families and communities around the world celebrate many different holidays and traditions, like Diwali, Hanukkah, Eid, Christmas, Lunar New Year, and Kwanzaa. Each celebration has its own meaning and customs.",
   ...
   quiz:[
     ...
     {q:"Lunar New Year is celebrated by many people from...", options:["No specific culture","African cultures","Asian cultures (e.g., Chinese, Vietnamese)","European cultures only"], answer:2},
     {q:"Why do communities around the world have different celebrations?", options:["Different cultures have different histories, beliefs, and traditions","No real reason","Only one culture celebrates anything","All celebrations are the same"], answer:0},
     {q:"Learning about other cultures' celebrations helps us...", options:["Respect and understand people who are different from us","Copy them exactly","Stop celebrating everything","Ignore our own traditions"], answer:0},
...
{day:23, label:"Day 23 — Wed", subjects:[
  ...
  {subject:"Science", title:"Animal Habitats (Deeper Look)", summary:"Animals are specially suited for their habitats — their body features help them survive. A polar bear has thick fur for the cold arctic. A fish has gills for breathing underwater.",
   ...
   quiz:[
     {q:"Why does a polar bear have thick white fur?", options:["To swim faster","To keep warm in the cold arctic and blend in with snow","Just for looks","Because all bears have white fur"], answer:1},
     ...
     {q:"What does 'adapted' mean when we talk about animals?", options:["The animal moves to a new country","The animal changes its diet only","Nothing special","The animal has body features that help it survive in its habitat"], answer:3},
  ...
  {subject:"SocialStudies", title:"Alphabetical Review: Canadian Communities", summary:"Canada has many communities from coast to coast — from big cities like Toronto, Vancouver, and Montreal to smaller towns and rural areas. Each place has unique features that make it special.",
   ...
   quiz:[
     ...
     {q:"What makes communities across Canada unique?", options:["Different geography, cultures, and people make each place special","They all have the same weather","Nothing makes them different","They are all exactly alike"], answer:0},
...
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Predicting What Happens Next", summary:"Good readers make predictions — they use clues in the story and what they already know to guess what might happen next.",
   ...
   quiz:[
     {q:"What is a prediction when reading?", options:["A guess about what might happen next, based on clues","Reading backwards","Copying the story","Remembering what happened"], answer:0},
     {q:"What do good readers use to make a prediction?", options:["Nothing","The last word in the book","Clues from the story and their own knowledge","Random guesses only"], answer:2},
     ...
     {q:"If a prediction turns out to be wrong, you should...", options:["Change your prediction based on new information","Skip ahead","Decide the book is wrong","Stop reading"], answer:0},
     {q:"Why is making predictions helpful when reading?", options:["It replaces reading","It is only for teachers","It keeps readers thinking and engaged with the story","It is not helpful"], answer:2},
   ]},
  ...
  {subject:"Science", title:"The Five Senses in Science Observations", summary:"Scientists use all five senses to make observations — they look, listen, smell, feel, and sometimes taste (safely!) to learn about the world around them.",
   ...
   quiz:[
     {q:"What is a scientific observation?", options:["Drawing a picture only","Guessing randomly","Reading a textbook only","Using your senses to notice details about something"], answer:3},
     ...
     {q:"Why do scientists use more than one sense when observing?", options:["Senses are not used in science","Using more senses gives more detailed and accurate information","One sense is always enough","No reason"], answer:1},
  ...
  {subject:"SocialStudies", title:"Transportation and Its Impact on Communities", summary:"Transportation connects communities — roads, trains, and airports allow people and goods to move between towns, cities, and countries. This helps communities grow and trade.",
   ...
   quiz:[
     {q:"How does transportation help communities?", options:["It does not help","It only helps cities","It only brings problems","It connects people and allows goods to move between places"], answer:3},
     ...
     {q:"Roads and highways are important for communities because they...", options:["Allow cars and trucks to move people and goods efficiently","Only carry water","Look pretty","Have no useful purpose"], answer:0},
     {q:"Before highways and cars, how did settlers in Canada move heavy goods?", options:["By airplane","By rivers, canoes, and horse-drawn wagons","By bicycle","By train only"], answer:1},
...
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Retelling a Story in Your Own Words", summary:"Retelling a story means explaining what happened in your own words — including the main characters, the setting, the problem, and the solution.",
   ...
   quiz:[
     {q:"When retelling a story, you should include...", options:["Only the title","Random details","The characters, setting, and what happened","Only the last event"], answer:2},
     {q:"What does 'in your own words' mean?", options:["Rewrite every single word differently","Not speak at all","Say the story using your own language, not copying word for word","Copy the book exactly"], answer:2},
     {q:"What is the 'problem' in a story?", options:["The title","The challenge or trouble that happens in the story","The setting","The character's name"], answer:1},
  ...
  {subject:"Science", title:"What Plants Need: Deeper Exploration", summary:"Plants make their own food using sunlight, water, and air (carbon dioxide) — this process is called photosynthesis. Roots absorb water and nutrients; leaves capture sunlight.",
   ...
   quiz:[
     {q:"What is photosynthesis?", options:["How plants eat insects","How plants use sunlight, water, and air to make their own food","How plants move around","How plants sleep at night"], answer:1},
  ...
  {subject:"SocialStudies", title:"People and the Environment: Making a Difference", summary:"People can both harm and help the environment. Pollution harms nature, but acts like planting trees, picking up litter, and saving energy help protect it for future generations.",
   ...
   quiz:[
     ...
     {q:"What does 'pollution' mean?", options:["Making the environment dirty or harmful with waste","Planting more trees","Conserving water","Cleaning up the environment"], answer:0},
     ...
     {q:"Why is it important to protect the environment for future generations?", options:["So that children growing up in the future will have clean air, water, and nature","The environment never changes","It is not important","Only adults need to worry about it"], answer:0},
   ]},
]},
{day:27, label:"Day 27 — Tue", subjects:[
  {subject:"Language", title:"Using Describing Words in Writing", summary:"Describing words (adjectives and adverbs) make writing more interesting and detailed. Instead of 'The cat ran,' you could write 'The small, fluffy cat ran quickly.'",
   ...
   quiz:[
     {q:"Which sentence uses the BEST describing words?", options:["The cat ran.","Something happened.","A thing moved.","The small fluffy cat ran quickly across the yard."], answer:3},
  ...
  {subject:"Science", title:"Weather and How We Measure It", summary:"Scientists called meteorologists study weather. They use thermometers to measure temperature, rain gauges to measure rainfall, and wind vanes to find wind direction.",
   ...
   quiz:[
     ...
     {q:"Why is it useful to measure and record weather?", options:["Weather never changes","It is not useful","It helps predict future weather and keep people safe","Only scientists need to know"], answer:2},
   ]},
  {subject:"SocialStudies", title:"Canada's Regions and Geography", summary:"Canada is a huge country with many different regions — the mountains of British Columbia, the prairies of Alberta and Saskatchewan, the Great Lakes area, and the Atlantic coast all have different landscapes and ways of life.",
   ...
   quiz:[
     ...
     {q:"Why do different regions of Canada have different ways of life?", options:["Only the weather is different","All regions are the same","The geography and climate of each region affect what people do there","No reason"], answer:2},
...
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Reading for Details", summary:"When we read for details, we look for specific information — who, what, where, when, and how. Details support the main idea and help us understand the story better.",
   ...
   quiz:[
     {q:"What are 'details' in a text?", options:["The title only","The main idea only","Specific pieces of information that support the main idea","Random words"], answer:2},
     ...
     {q:"Reading for details helps you...", options:["Only read faster","Find specific facts and understand the text better","Skip important information","Ignore the main idea"], answer:1},
     {q:"Which question word helps you find WHERE details in a story?", options:["Why","What","Where","Who"], answer:2},
     {q:"Details in a story can tell you...", options:["Who, what, where, when, and how things happened","Only the ending","Nothing important","Only the lesson"], answer:0},
   ]},
  ...
  {subject:"Science", title:"Simple Machines Around Us", summary:"Simple machines make work easier. We have learned about levers, ramps (inclined planes), and wheels. Other simple machines include pulleys and wedges. They help us lift, move, or cut things.",
   ...
   quiz:[
     ...
     {q:"Simple machines help us by...", options:["Adding more steps to tasks","Making work easier by reducing the force needed","Making work harder","Making things slower always"], answer:1},
   ]},
  {subject:"SocialStudies", title:"Why Rules and Laws are Important", summary:"Communities use rules and laws to make sure everyone is treated fairly and can stay safe. Laws are made by governments, and everyone in a community must follow them.",
   ...
   quiz:[
     ...
     {q:"Why are traffic laws like traffic lights important?", options:["They are optional","They just look nice","They help keep drivers and pedestrians safe","They are only for trucks"], answer:2},
     {q:"What happens when people do not follow the laws?", options:["Nothing at all","The community gets better","Everyone gets a prize","Others may get hurt and there can be consequences"], answer:3},
     {q:"Rules in a school help to...", options:["Make school boring","Help only some students","Stop learning","Keep students safe and create a fair learning environment"], answer:3},
...
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Simple Poetry and Rhythm", summary:"Poems often use rhythm (a beat) and rhyming words to make them fun to read aloud. Each line in a poem has a pattern of sounds. Poetry helps us play with language!",
   ...
   quiz:[
     {q:"What is rhythm in a poem?", options:["Rhyming words at the end","The number of words","The title of the poem","The beat or pattern of sounds when you read it aloud"], answer:3},
     ...
     {q:"What makes a poem different from a regular sentence?", options:["Poems have no words","Poems are always very long","Poems often use rhythm, rhyme, and creative language","Poems never have punctuation"], answer:2},
   ]},
  ...
  {subject:"Science", title:"Earth and Space: The Sun, Moon, and Stars", summary:"The sun is a star that gives Earth light and warmth. The moon orbits Earth and reflects sunlight. Stars are very far away and look small in the night sky because of the distance.",
   ...
   quiz:[
     ...
     {q:"What would happen to life on Earth without the sun?", options:["We would see better","Plants could not grow and it would be very cold and dark","Animals would be happier","Nothing would change"], answer:1},
   ]},
  {subject:"SocialStudies", title:"Our Rights and the Rights of Children", summary:"Every child has rights — things they are entitled to, like the right to safety, education, a family, and to be treated with respect. The United Nations Convention on the Rights of the Child protects these rights.",
   ...
   quiz:[
     {q:"What is a 'right'?", options:["A school subject","Something every person is entitled to have","Something you must give away","A type of direction"], answer:1},
...
{day:30, label:"Day 30 — Fri (Final Review)", reviewNote:"Day 30 Final Review — mixed questions from Days 26–29", subjects:[
  {subject:"Language", title:"Final Review: Retelling, Describing Words, Details & Poetry", summary:"Mixed review of retelling stories, using describing words, reading for details, and simple poetry.",
   ...
   quiz:[
     {q:"When retelling a story, what should you include?", options:["Characters, setting, problem, and solution","Only the title","Random details","Only the last event"], answer:0},
     {q:"Which word is a describing word (adjective)?", options:["Jump","Fluffy","Run","Quickly"], answer:1},
     {q:"Reading for details means looking for...", options:["Only the main idea","The title only","Specific information like who, what, where, when","Nothing specific"], answer:2},
  ...
  {subject:"SocialStudies", title:"Final Review: Environment, Geography, Laws & Children's Rights", summary:"Mixed review of protecting the environment, Canada's regions, rules and laws, and children's rights.",
   ...
   quiz:[
     ...
     {q:"Why are laws important in a community?", options:["They stop fun","They are not important","They keep people safe and ensure fairness","Only adults benefit from laws"], answer:2},
