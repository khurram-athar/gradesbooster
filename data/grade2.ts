...
{day:111, label:"Day 111 — Mon", subjects:[
  {subject:"Language", title:"Apostrophes: Contractions vs Possessives", summary:"Grade 2 Language strand: an apostrophe can either join two words into a contraction, like do not becoming dont, or show ownership in a possessive noun, like the dogs bone.",
   resourceLabel:"YouTube: Apostrophes: Contractions vs Possessives", resourceUrl:"https://www.youtube.com/results?search_query=Apostrophes%3A%20Contractions%20vs%20Possessives%20grade%202%20educational",
   quiz:[
     {q:"In dont, why is an apostrophe used?", options:["To join two words into one","To end a sentence","It has no purpose","It shows a contraction is being made"], answer:3},
     {q:"In the dogs bone, why is an apostrophe used?", options:["To join two words","To end the sentence","To make a plural","To show the bone belongs to the dog"], answer:3},
     {q:"Which of these is a contraction?", options:["Cats","Cat","Cannot","Cant"], answer:3},
     {q:"Which of these shows possession?", options:["The girls shoes are new.","Girls play.","Two girls.","Girls run."], answer:0},
     {q:"An apostrophe used in a possessive noun shows ___.", options:["A plural only","The end of a sentence","A question","Ownership"], answer:3}
   ]},
  {subject:"Math", title:"Multiplication Facts: 11s and 12s", summary:"Grade 2 Math strand: students extend their multiplication fact fluency to include the 11 times table and the 12 times table.",
   resourceLabel:"YouTube: Multiplication Facts: 11s and 12s", resourceUrl:"https://www.youtube.com/results?search_query=Multiplication%20Facts%3A%2011s%20and%2012s%20grade%202%20educational",
   quiz:[
     {q:"What is 11 x 3?", options:["31","33","30","32"], answer:1},
     {q:"What is 12 x 2?", options:["22","20","24","26"], answer:2},
     {q:"What is 11 x 5?", options:["55","45","60","50"], answer:0},
     {q:"What is 12 x 4?", options:["42","48","44","46"], answer:1},
     {q:"What is 11 x 11?", options:["112","121","111","110"], answer:1}
   ]},
  {subject:"Science", title:"Water Conservation: Using Water Wisely", summary:"Grade 2 Science strand: water conservation means using water carefully and avoiding waste, such as turning off taps and fixing leaks, so there is enough clean water for everyone.",
   resourceLabel:"YouTube: Water Conservation: Using Water Wisely", resourceUrl:"https://www.youtube.com/results?search_query=Water%20Conservation%3A%20Using%20Water%20Wisely%20grade%202%20educational",
   quiz:[
     {q:"What does water conservation mean?", options:["Using as much water as possible","Wasting water on purpose","Using water carefully and not wasting it","Never using water"], answer:2},
     {q:"Which action helps conserve water?", options:["Taking very long baths daily","Ignoring leaks","Turning off the tap while brushing teeth","Leaving the tap running"], answer:2},
     {q:"Why is it important to fix a leaky tap?", options:["It does not matter","Leaks help save water","Leaks are good for pipes","To stop wasting water"], answer:3},
     {q:"Why do we need to be careful with our water use?", options:["So there is enough clean water for everyone","Only oceans matter","Water is not important","There is unlimited water everywhere"], answer:0},
     {q:"Which of these is a water-saving habit?", options:["Letting the hose run all day","Leaving taps dripping","Filling a pool every day","Taking shorter showers"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The War of 1812: A Conflict That Shaped Canada", summary:"Grade 2 Social Studies strand: the War of 1812 was a conflict between the United States and British North America, and it helped shape the identity of what would later become Canada.",
   resourceLabel:"YouTube: The War of 1812: A Conflict That Shaped Canada", resourceUrl:"https://www.youtube.com/results?search_query=The%20War%20of%201812%3A%20A%20Conflict%20That%20Shaped%20Canada%20grade%202%20educational",
   quiz:[
     {q:"Who fought in the War of 1812?", options:["France and Spain","Canada and Mexico","The United States and British North America","No one, it never happened"], answer:2},
     {q:"When did the War of 1812 take place?", options:["In the 1900s","It has not happened yet","Last year","In the early 1800s"], answer:3},
     {q:"Why do people still learn about the War of 1812 today?", options:["It has no importance","It was not a real event","It happened in another country only","It helped shape early Canadian identity"], answer:3},
     {q:"What area was involved in the War of 1812 that later became part of Canada?", options:["Africa","British North America","South America","Australia"], answer:1},
     {q:"Learning about historical conflicts like the War of 1812 helps us understand ___.", options:["How our country developed over time","Only foreign history","Modern technology","Nothing about Canada"], answer:0}
   ]},
]},
{day:112, label:"Day 112 — Tue", subjects:[
  {subject:"Language", title:"Syllable Division: Breaking Words into Parts", summary:"Grade 2 Language strand: dividing a word into syllables, or beats, helps readers sound out and spell longer words, such as splitting rabbit into rab-bit.",
   resourceLabel:"YouTube: Syllable Division: Breaking Words into Parts", resourceUrl:"https://www.youtube.com/results?search_query=Syllable%20Division%3A%20Breaking%20Words%20into%20Parts%20grade%202%20educational",
   quiz:[
     {q:"How many syllables are in the word rabbit?", options:["One","Three","Four","Two"], answer:3},
     {q:"How many syllables are in the word butterfly?", options:["Four","Two","Three","One"], answer:2},
     {q:"Why is dividing a word into syllables helpful?", options:["It makes words shorter","It helps us sound out and spell longer words","It has no purpose","It removes vowels"], answer:1},
     {q:"How many syllables are in the word cat?", options:["One","Four","Two","Three"], answer:0},
     {q:"Where is rabbit divided into syllables?", options:["rabb-it","r-abbit","ra-bbit","rab-bit"], answer:3}
   ]},
  {subject:"Math", title:"Multiplying Two-Digit Numbers by a One-Digit Number", summary:"Grade 2 Math strand: students learn to multiply a two-digit number by a one-digit number, such as 23 x 3, by breaking the two-digit number into tens and ones.",
   resourceLabel:"YouTube: Multiplying Two-Digit Numbers by a One-Digit Number", resourceUrl:"https://www.youtube.com/results?search_query=Multiplying%20Two-Digit%20Numbers%20by%20a%20One-Digit%20Number%20grade%202%20educational",
   quiz:[
     {q:"What is 12 x 4?", options:["44","46","48","50"], answer:2},
     {q:"What is 21 x 3?", options:["61","63","60","65"], answer:1},
     {q:"What is 14 x 2?", options:["28","24","30","26"], answer:0},
     {q:"What is 32 x 3?", options:["90","92","94","96"], answer:3},
     {q:"To multiply 23 x 3, you can break 23 into ___.", options:["20 and 30","20 and 3","23 and 0","2 and 3"], answer:1}
   ]},
  {subject:"Science", title:"Composting: Recycling Food Scraps Into Soil", summary:"Grade 2 Science strand: composting is a natural process where food scraps and plant materials break down over time into rich soil that helps new plants grow.",
   resourceLabel:"YouTube: Composting: Recycling Food Scraps Into Soil", resourceUrl:"https://www.youtube.com/results?search_query=Composting%3A%20Recycling%20Food%20Scraps%20Into%20Soil%20grade%202%20educational",
   quiz:[
     {q:"What is composting?", options:["Freezing food scraps","Burning garbage","A natural process turning food scraps into soil","Throwing food away"], answer:2},
     {q:"What can be added to a compost pile?", options:["Metal cans","Food scraps and plant materials","Glass bottles","Plastic bags"], answer:1},
     {q:"What does compost eventually become?", options:["Rich soil","Sand","Plastic","Clean water"], answer:0},
     {q:"Why is composting good for the environment?", options:["It has no benefit","It creates more garbage","It reduces waste and helps plants grow","It pollutes the water"], answer:2},
     {q:"What breaks down food scraps in a compost pile over time?", options:["Sunlight alone","Tiny organisms and time","Ice","Fire"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Canadas Justice System: Judges and Courts", summary:"Grade 2 Social Studies strand: the justice system uses courts and judges to make fair decisions when people disagree or when someone breaks a law.",
   resourceLabel:"YouTube: Canadas Justice System: Judges and Courts", resourceUrl:"https://www.youtube.com/results?search_query=Canadas%20Justice%20System%3A%20Judges%20and%20Courts%20grade%202%20educational",
   quiz:[
     {q:"Who makes decisions in a courtroom?", options:["A teacher","A doctor","A judge","A mayor"], answer:2},
     {q:"What is the justice system used for?", options:["To teach math","To sell products","To make fair decisions when laws are broken or people disagree","To build houses"], answer:2},
     {q:"Where do judges usually work?", options:["In a court","In a farm","In a hospital","In a school"], answer:0},
     {q:"Why is it important for a justice system to be fair?", options:["Judges should be unfair","Fairness does not matter","Only some people deserve fairness","So everyone is treated equally under the law"], answer:3},
     {q:"What might happen in a courtroom?", options:["A sports game","A judge helps resolve a disagreement or legal case","A birthday party","A cooking class"], answer:1}
   ]},
]},
{day:113, label:"Day 113 — Wed", subjects:[
  {subject:"Language", title:"Making Connections: Text to Text and Text to World", summary:"Grade 2 Language strand: readers make connections not only to their own lives but also between two texts (text to text) and between a text and events in the real world (text to world).",
   resourceLabel:"YouTube: Making Connections: Text to Text and Text to World", resourceUrl:"https://www.youtube.com/results?search_query=Making%20Connections%3A%20Text%20to%20Text%20and%20Text%20to%20World%20grade%202%20educational",
   quiz:[
     {q:"What does text-to-text mean?", options:["Reading only one book","Connecting a text to your own life","Ignoring the text","Connecting one text to another text"], answer:3},
     {q:"What does text-to-world mean?", options:["Connecting a text to real events in the world","Memorizing the text","Connecting a text to another text","Skipping the text"], answer:0},
     {q:"Why do readers make connections while reading?", options:["It has no benefit","It helps deepen understanding of the text","It replaces reading","It makes reading harder"], answer:1},
     {q:"If a story about weather reminds you of a real storm in the news, this is an example of ___.", options:["No connection","Text to self","Text to world","Text to text"], answer:2},
     {q:"If a story reminds you of another book you read, this is an example of ___.", options:["No connection","Text to world","Text to text","Text to self"], answer:2}
   ]},
  {subject:"Math", title:"Telling Time: Reading to the Exact Minute", summary:"Grade 2 Math strand: students read an analog clock to tell the exact minute, not just the nearest five minutes, such as 3:47 or 8:12.",
   resourceLabel:"YouTube: Telling Time: Reading to the Exact Minute", resourceUrl:"https://www.youtube.com/results?search_query=Telling%20Time%3A%20Reading%20to%20the%20Exact%20Minute%20grade%202%20educational",
   quiz:[
     {q:"If the minute hand points between the 9 and the 10, closer to 9, what might the time show?", options:["Exactly :30","Something like :46 or :47","Exactly :00","Exactly :50"], answer:1},
     {q:"How many minutes are in one hour?", options:["55","60","50","65"], answer:1},
     {q:"If a clock shows 4:23, what hour is it?", options:["23","3","5","4"], answer:3},
     {q:"If a clock shows 7:58, how many minutes until 8:00?", options:["1","2","3","4"], answer:1},
     {q:"Reading a clock to the exact minute means checking ___.", options:["Only the date","Every individual minute mark","Only the hour hand","Only whether it is day or night"], answer:1}
   ]},
  {subject:"Science", title:"Air Quality: Keeping Our Air Clean", summary:"Grade 2 Science strand: air quality describes how clean or polluted the air is, and clean air is important for the health of people, animals, and plants.",
   resourceLabel:"YouTube: Air Quality: Keeping Our Air Clean", resourceUrl:"https://www.youtube.com/results?search_query=Air%20Quality%3A%20Keeping%20Our%20Air%20Clean%20grade%202%20educational",
   quiz:[
     {q:"What does air quality describe?", options:["How clean or polluted the air is","How loud the air is","How colourful the air is","How hot the air is"], answer:0},
     {q:"Why is clean air important?", options:["It keeps people, animals, and plants healthy","Clean air is not real","Only plants need clean air","It has no importance"], answer:0},
     {q:"Which of these can lower air quality?", options:["Trees","Rain","Fresh wind","Smoke and pollution"], answer:3},
     {q:"What can help improve air quality in a community?", options:["Ignoring pollution","Adding more smoke","Planting trees and reducing pollution","Burning more fuel"], answer:2},
     {q:"Which living things benefit from clean air?", options:["Only machines","Nothing benefits","People, animals, and plants","Only rocks"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Canadian Media: Newspapers, TV, and Online News", summary:"Grade 2 Social Studies strand: Canadians learn about their communities and the world through media such as newspapers, television, and online news sources.",
   resourceLabel:"YouTube: Canadian Media: Newspapers, TV, and Online News", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Media%3A%20Newspapers%2C%20TV%2C%20and%20Online%20News%20grade%202%20educational",
   quiz:[
     {q:"Name one form of media people use to learn the news.", options:["A recipe book","A road sign","A dictionary","Newspapers"], answer:3},
     {q:"What is the purpose of news media?", options:["To sell only toys","To inform people about events","To have no purpose","To confuse people"], answer:1},
     {q:"Has the way Canadians get news changed over time?", options:["No, it has never changed","News did not exist before","Yes, it has changed with new technology","Only newspapers have ever existed"], answer:2},
     {q:"Which is an example of online news?", options:["A cookbook","A news website or app","A comic book","A paper map"], answer:1},
     {q:"Why is it helpful to know about current events through the media?", options:["News has no value","Only adults should know about events","It is not helpful at all","It helps us understand our community and the world"], answer:3}
   ]},
]},
{day:114, label:"Day 114 — Thu", subjects:[
  {subject:"Language", title:"Reading Graphic Novels and Comics: Visual Storytelling", summary:"Grade 2 Language strand: graphic novels and comics tell stories using both pictures and words together, with speech bubbles showing what characters say.",
   resourceLabel:"YouTube: Reading Graphic Novels and Comics: Visual Storytelling", resourceUrl:"https://www.youtube.com/results?search_query=Reading%20Graphic%20Novels%20and%20Comics%3A%20Visual%20Storytelling%20grade%202%20educational",
   quiz:[
     {q:"What two things do graphic novels use together to tell a story?", options:["Only colours","Only numbers","Only sound","Pictures and words"], answer:3},
     {q:"What do speech bubbles show in a comic?", options:["What a character is saying","The setting of the story","The title of the book","The page number"], answer:0},
     {q:"How is a graphic novel different from a chapter book?", options:["It has no story","It has no pictures at all","It relies heavily on pictures to tell the story","It is always shorter"], answer:2},
     {q:"Why might pictures help tell a story in a comic?", options:["Pictures have no effect on stories","They make reading impossible","Pictures replace all words always","They show action and emotion visually"], answer:3},
     {q:"Which of these is a feature of comics?", options:["Footnotes only","Speech bubbles","No pictures","A table of contents only"], answer:1}
   ]},
  {subject:"Math", title:"Expanded Form: Writing Numbers by Place Value", summary:"Grade 2 Math strand: expanded form shows a number broken apart by place value, such as writing 456 as 400 + 50 + 6.",
   resourceLabel:"YouTube: Expanded Form: Writing Numbers by Place Value", resourceUrl:"https://www.youtube.com/results?search_query=Expanded%20Form%3A%20Writing%20Numbers%20by%20Place%20Value%20grade%202%20educational",
   quiz:[
     {q:"What is 456 written in expanded form?", options:["400 + 50 + 6","45 + 6","4 + 5 + 6","456 + 0"], answer:0},
     {q:"What is 372 written in expanded form?", options:["300 + 70 + 2","37 + 2","372 + 0","3 + 7 + 2"], answer:0},
     {q:"What number does 200 + 30 + 5 represent?", options:["325","2035","235","253"], answer:2},
     {q:"What number does 600 + 40 + 1 represent?", options:["146","641","604","461"], answer:1},
     {q:"Expanded form helps us understand ___.", options:["Only the first digit","The value of each digit in a number","Only the last digit","Nothing about the number"], answer:1}
   ]},
  {subject:"Science", title:"Sound Waves: How Sound Travels Through Different Materials", summary:"Grade 2 Science strand: sound travels as vibrations through materials like air, water, and solids, though it travels differently depending on the material.",
   resourceLabel:"YouTube: Sound Waves: How Sound Travels Through Different Materials", resourceUrl:"https://www.youtube.com/results?search_query=Sound%20Waves%3A%20How%20Sound%20Travels%20Through%20Different%20Materials%20grade%202%20educational",
   quiz:[
     {q:"What causes sound to travel?", options:["Temperature","Colour","Light","Vibrations"], answer:3},
     {q:"Name one material sound can travel through.", options:["A total void","Air","Outer space vacuum","Nothingness"], answer:1},
     {q:"Does sound need vibrations to travel?", options:["Only in space","Only in water","Yes","No"], answer:2},
     {q:"Which of these best describes how sound moves?", options:["As a colour","As a solid object","As a smell","As vibrations through a material"], answer:3},
     {q:"Sound generally cannot travel through ___.", options:["Empty space with no matter","Water","Solid walls","Air"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Canadian Astronauts and Space Achievements", summary:"Grade 2 Social Studies strand: Canada has sent astronauts into space to conduct research and represent Canada on international space missions.",
   resourceLabel:"YouTube: Canadian Astronauts and Space Achievements", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Astronauts%20and%20Space%20Achievements%20grade%202%20educational",
   quiz:[
     {q:"What is an astronaut?", options:["A person who fixes cars","A person who travels into space","A person who bakes bread","A person who teaches school"], answer:1},
     {q:"Has Canada sent astronauts into space?", options:["No","Only in movies","Yes","Canada has no astronauts"], answer:2},
     {q:"Why might a country be proud of its astronauts?", options:["Space travel has no value","They do nothing important","Astronauts never leave the ground","They represent the country and add to scientific research"], answer:3},
     {q:"What might an astronaut do on a space mission?", options:["Conduct scientific research","Grow crops on Earth","Sell products","Teach history only"], answer:0},
     {q:"Canadian achievements in space help show ___.", options:["That Canada contributes to science and exploration","That Canada has no scientists","Nothing important","That space travel is impossible"], answer:0}
   ]},
]},
{day:115, label:"Day 115 — Fri", subjects:[
  {subject:"Language", title:"Oral Language: Sharing Ideas in a Discussion", summary:"Grade 2 Language strand: strong oral communication involves speaking clearly, listening to others, taking turns, and building on the ideas of classmates during a discussion.",
   resourceLabel:"YouTube: Oral Language: Sharing Ideas in a Discussion", resourceUrl:"https://www.youtube.com/results?search_query=Oral%20Language%3A%20Sharing%20Ideas%20in%20a%20Discussion%20grade%202%20educational",
   quiz:[
     {q:"What is one important part of a good discussion?", options:["Talking over everyone","Never sharing ideas","Listening to others","Ignoring classmates"], answer:2},
     {q:"Why should you take turns speaking in a discussion?", options:["Turns are not important","So only one person ever talks","So everyone gets a chance to share ideas","To confuse the group"], answer:2},
     {q:"What does it mean to build on someone elses idea?", options:["Arguing without listening","Adding to or expanding what they said","Repeating it exactly","Ignoring what they said"], answer:1},
     {q:"Which is a respectful way to disagree in a discussion?", options:["Walking away","Refusing to listen","Yelling at others","Explaining your thinking politely"], answer:3},
     {q:"Good oral communication includes speaking ___.", options:["Clearly and respectfully","Without listening to others","As loudly as possible","Only when forced"], answer:0}
   ]},
  {subject:"Math", title:"Multiplying by Multiples of Ten", summary:"Grade 2 Math strand: multiplying a number by a multiple of ten, like 3 x 20, can be solved by multiplying the basic fact and then adding a zero.",
   resourceLabel:"YouTube: Multiplying by Multiples of Ten", resourceUrl:"https://www.youtube.com/results?search_query=Multiplying%20by%20Multiples%20of%20Ten%20grade%202%20educational",
   quiz:[
     {q:"What is 3 x 20?", options:["60","6","600","23"], answer:0},
     {q:"What is 4 x 30?", options:["34","120","43","12"], answer:1},
     {q:"What is 5 x 40?", options:["200","20","45","54"], answer:0},
     {q:"What is 2 x 60?", options:["26","120","62","12"], answer:1},
     {q:"To find 6 x 20, you can first solve 6 x 2, then ___.", options:["Subtract a zero","Multiply by zero","Add a zero to the answer","Ignore the tens"], answer:2}
   ]},
  {subject:"Science", title:"Birds of Prey: Owls, Hawks, and Eagles", summary:"Grade 2 Science strand: birds of prey, such as owls, hawks, and eagles, are skilled hunters with sharp talons, strong beaks, and excellent eyesight.",
   resourceLabel:"YouTube: Birds of Prey: Owls, Hawks, and Eagles", resourceUrl:"https://www.youtube.com/results?search_query=Birds%20of%20Prey%3A%20Owls%2C%20Hawks%2C%20and%20Eagles%20grade%202%20educational",
   quiz:[
     {q:"Which of these is a bird of prey?", options:["Chicken","Eagle","Duck","Penguin"], answer:1},
     {q:"What body part helps a bird of prey grab its food?", options:["Soft fur","Sharp talons","A long tail","Webbed feet"], answer:1},
     {q:"Which sense is especially sharp in birds of prey?", options:["Touch","Taste","Smell","Eyesight"], answer:3},
     {q:"Why do birds of prey need a strong, hooked beak?", options:["To swim faster","To tear apart food","To sing loudly","To build large nests only"], answer:1},
     {q:"Owls are birds of prey that hunt mostly ___.", options:["Never","At night","Only in winter","Underwater"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Canadian Weather Records: Hottest, Coldest, and Snowiest Places", summary:"Grade 2 Social Studies strand: different regions of Canada hold weather records, such as the coldest recorded temperature or the snowiest city, showing how varied Canadian climate can be.",
   resourceLabel:"YouTube: Canadian Weather Records: Hottest, Coldest, and Snowiest Places", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Weather%20Records%3A%20Hottest%2C%20Coldest%2C%20and%20Snowiest%20Places%20grade%202%20educational",
   quiz:[
     {q:"Does all of Canada have the same weather?", options:["Yes","Weather does not exist in Canada","Only one city has weather","No"], answer:3},
     {q:"What might a weather record show?", options:["A type of animal","A type of food","The coldest or snowiest place recorded","A famous painting"], answer:2},
     {q:"Why does Canada have such varied weather records?", options:["Canada is very small","Canada is a very large country with many regions","Weather never changes anywhere","Canada has only one climate"], answer:1},
     {q:"Which part of Canada is often known for extremely cold winters?", options:["The far north","The equator","Only cities near the ocean","Nowhere in Canada"], answer:0},
     {q:"Learning about weather records helps us understand ___.", options:["How diverse Canadas geography and climate are","That Canada has no weather","Nothing about Canada","Only one type of weather exists"], answer:0}
   ]},
]},
{day:116, label:"Day 116 — Mon", subjects:[
  {subject:"Language", title:"Peer Editing: Giving Helpful Feedback on Writing", summary:"Grade 2 Language strand: peer editing means reading a classmates writing and giving kind, helpful suggestions to make it clearer or stronger.",
   resourceLabel:"YouTube: Peer Editing: Giving Helpful Feedback on Writing", resourceUrl:"https://www.youtube.com/results?search_query=Peer%20Editing%3A%20Giving%20Helpful%20Feedback%20on%20Writing%20grade%202%20educational",
   quiz:[
     {q:"What is peer editing?", options:["Ignoring a classmates writing","Copying a classmates writing","Giving helpful feedback on a classmates writing","Erasing a classmates writing"], answer:2},
     {q:"Why should feedback during peer editing be kind?", options:["Feedback should always be harsh","Kindness does not matter","So it helps the writer improve without feeling bad","To make the writer upset"], answer:2},
     {q:"Which is an example of helpful peer editing feedback?", options:["Your writing is bad.","I will not read this.","This makes no sense at all.","This part is confusing, can you explain more?"], answer:3},
     {q:"What is one goal of peer editing?", options:["To criticize without helping","To ignore the writer completely","To rewrite the whole piece yourself","To help make writing clearer and stronger"], answer:3},
     {q:"When receiving peer feedback, a writer should ___.", options:["Ignore all feedback","Get upset and stop writing","Listen and consider the suggestions","Argue with every comment"], answer:2}
   ]},
  {subject:"Math", title:"Finding the Range of a Data Set", summary:"Grade 2 Math strand: the range of a data set is the difference between the largest and smallest values, found by subtracting the smallest from the largest.",
   resourceLabel:"YouTube: Finding the Range of a Data Set", resourceUrl:"https://www.youtube.com/results?search_query=Finding%20the%20Range%20of%20a%20Data%20Set%20grade%202%20educational",
   quiz:[
     {q:"What is the range of the data set 3, 7, 9, 2?", options:["7","9","5","2"], answer:1},
     {q:"How do you find the range of a data set?", options:["Subtract the smallest value from the largest","Multiply the values","Add all the values","Count the values"], answer:0},
     {q:"What is the range of the data set 10, 15, 20, 5?", options:["10","20","5","15"], answer:3},
     {q:"What is the range of the data set 4, 4, 4, 4?", options:["8","16","0","4"], answer:2},
     {q:"The range tells us about the ___ of a data set.", options:["Spread between highest and lowest values","Average value","Total number of values","Most common value"], answer:0}
   ]},
  {subject:"Science", title:"Plant Defenses: Thorns, Poison, and Bad Smells", summary:"Grade 2 Science strand: many plants have special defenses, such as sharp thorns, poisonous parts, or bad smells, that help protect them from being eaten by animals.",
   resourceLabel:"YouTube: Plant Defenses: Thorns, Poison, and Bad Smells", resourceUrl:"https://www.youtube.com/results?search_query=Plant%20Defenses%3A%20Thorns%2C%20Poison%2C%20and%20Bad%20Smells%20grade%202%20educational",
   quiz:[
     {q:"Which of these is a plant defense?", options:["Sharp thorns","Tall height only","Soft leaves only","Bright petals only"], answer:0},
     {q:"Why might a plant produce a bad smell?", options:["To grow faster","To keep animals from eating it","For no reason","To attract more rain"], answer:1},
     {q:"What is one purpose of a plants defenses?", options:["To change its colour","To protect it from being eaten","To make more seeds instantly","To help it grow taller"], answer:1},
     {q:"Which plant part often has thorns for protection?", options:["The stem","The root only","The seed only","The flower petal only"], answer:0},
     {q:"Some plants are poisonous mainly to ___.", options:["Discourage animals from eating them","Make themselves weaker","Help animals grow","Attract more predators"], answer:0}
   ]},
  {subject:"SocialStudies", title:"The Role of a Census: Counting Everyone in Canada", summary:"Grade 2 Social Studies strand: a census is an official count of everyone living in a country, helping the government plan services like schools, hospitals, and roads.",
   resourceLabel:"YouTube: The Role of a Census: Counting Everyone in Canada", resourceUrl:"https://www.youtube.com/results?search_query=The%20Role%20of%20a%20Census%3A%20Counting%20Everyone%20in%20Canada%20grade%202%20educational",
   quiz:[
     {q:"What is a census?", options:["A type of holiday","A weather report","An official count of everyone in a country","A kind of map"], answer:2},
     {q:"Why does the government take a census?", options:["To sell products","To help plan services like schools and hospitals","To confuse citizens","To have no reason"], answer:1},
     {q:"How often is a census usually taken?", options:["At regular intervals, such as every few years","Every single day","Only once ever","Never"], answer:0},
     {q:"Which service might benefit from census information?", options:["Making candy","Painting a fence","Playing a game","Planning new schools"], answer:3},
     {q:"A census helps a government understand ___.", options:["Movie ratings","Sports scores","How many people live in different areas","The weather forecast"], answer:2}
   ]},
]},
{day:117, label:"Day 117 — Tue", subjects:[
  {subject:"Language", title:"Story Sequels: Imagining What Happens Next", summary:"Grade 2 Language strand: a sequel continues the story after the original ending, and writers use what they know about the characters and setting to imagine new events.",
   resourceLabel:"YouTube: Story Sequels: Imagining What Happens Next", resourceUrl:"https://www.youtube.com/results?search_query=Story%20Sequels%3A%20Imagining%20What%20Happens%20Next%20grade%202%20educational",
   quiz:[
     {q:"What is a sequel?", options:["A story that continues after the original","A dictionary","A story with no characters","The very first story"], answer:0},
     {q:"What should a writer consider when writing a sequel?", options:["The characters and setting from the original story","Nothing from the original","Only new characters","A different language"], answer:0},
     {q:"Why might a reader enjoy a sequel?", options:["To find out what happens to characters they liked","Sequels have no connection to the first story","Sequels ignore the original story","Sequels are always boring"], answer:0},
     {q:"A sequel usually takes place ___ the events of the original story.", options:["In a completely unrelated book","During the exact same moment","Before","After"], answer:3},
     {q:"Which is an example of writing a sequel?", options:["Imagining what a character does the next day","Copying the same story exactly","Ignoring the characters completely","Writing about a math problem"], answer:0}
   ]},
  {subject:"Math", title:"Estimating Quotients: Rounding Before Dividing", summary:"Grade 2 Math strand: to estimate a quotient, students round the numbers involved to make the division easier before finding an approximate answer.",
   resourceLabel:"YouTube: Estimating Quotients: Rounding Before Dividing", resourceUrl:"https://www.youtube.com/results?search_query=Estimating%20Quotients%3A%20Rounding%20Before%20Dividing%20grade%202%20educational",
   quiz:[
     {q:"To estimate 42 divided by 7, you could round 42 to ___.", options:["100","50","42","40"], answer:3},
     {q:"Estimating a quotient means finding ___.", options:["The largest possible number","The exact answer only","A completely unrelated number","An approximate answer to a division problem"], answer:3},
     {q:"About what is 29 divided by 5, rounded first?", options:["About 6","About 0.6","About 60","About 600"], answer:0},
     {q:"About what is 61 divided by 10?", options:["About 16","About 600","About 6","About 60"], answer:2},
     {q:"Why do we estimate before dividing exactly?", options:["It makes math harder","It has no purpose","Estimating replaces the need to divide at all","To quickly check if our exact answer seems reasonable"], answer:3}
   ]},
  {subject:"Science", title:"Coral Reefs: A Colourful Underwater Habitat", summary:"Grade 2 Science strand: coral reefs are colourful ocean habitats built by tiny living creatures called coral polyps, and they provide homes for many kinds of fish and sea animals.",
   resourceLabel:"YouTube: Coral Reefs: A Colourful Underwater Habitat", resourceUrl:"https://www.youtube.com/results?search_query=Coral%20Reefs%3A%20A%20Colourful%20Underwater%20Habitat%20grade%202%20educational",
   quiz:[
     {q:"What builds a coral reef?", options:["Fish","Rocks alone","Tiny living creatures called coral polyps","Seaweed alone"], answer:2},
     {q:"Where are coral reefs found?", options:["In the ocean","On mountains","In deserts","In forests"], answer:0},
     {q:"What lives among the coral in a reef?", options:["Nothing lives there","Only insects","Many fish and sea animals","Only birds"], answer:2},
     {q:"Why are coral reefs considered important habitats?", options:["They harm ocean life","They are empty and unimportant","They only exist on land","They provide homes for a huge variety of sea life"], answer:3},
     {q:"Coral reefs are known for being especially ___.", options:["Colourful and full of life","Grey and lifeless","Located only in deserts","Made of plastic"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Time Capsules: Preserving Memories for the Future", summary:"Grade 2 Social Studies strand: a time capsule is a container filled with objects and messages that is sealed and opened many years later, helping future generations learn about the past.",
   resourceLabel:"YouTube: Time Capsules: Preserving Memories for the Future", resourceUrl:"https://www.youtube.com/results?search_query=Time%20Capsules%3A%20Preserving%20Memories%20for%20the%20Future%20grade%202%20educational",
   quiz:[
     {q:"What is a time capsule?", options:["A kind of vehicle","A type of clock","A sealed container of objects opened later","A weather tool"], answer:2},
     {q:"Why do people create time capsules?", options:["To confuse people","For no reason","To throw things away","To help future generations learn about the past"], answer:3},
     {q:"What might someone put inside a time capsule?", options:["Photos, letters, or small objects","Nothing at all","Only liquids","Only garbage"], answer:0},
     {q:"When is a time capsule usually opened?", options:["Many years after it was sealed","Before it is sealed","The very next day","It is never opened"], answer:0},
     {q:"A time capsule helps connect ___.", options:["Nothing important","Only two friends","Different countries oceans apart","The past to the future"], answer:3}
   ]},
]},
{day:118, label:"Day 118 — Wed", subjects:[
  {subject:"Language", title:"Word Origins: Where Some English Words Come From", summary:"Grade 2 Language strand: many English words originally came from other languages, and learning simple word origins can help readers understand and remember new vocabulary.",
   resourceLabel:"YouTube: Word Origins: Where Some English Words Come From", resourceUrl:"https://www.youtube.com/results?search_query=Word%20Origins%3A%20Where%20Some%20English%20Words%20Come%20From%20grade%202%20educational",
   quiz:[
     {q:"Do all English words come only from English?", options:["English has no history","Yes, always","Words have no origin","No, many come from other languages"], answer:3},
     {q:"Why might learning about word origins be helpful?", options:["It has no benefit","It makes words harder to learn","It changes the spelling randomly","It can help us understand and remember new words"], answer:3},
     {q:"What do we call the study of where words come from?", options:["Grammar","Word origin study, sometimes called etymology","Punctuation","Word origin study"], answer:1},
     {q:"Learning word origins is part of building strong ___.", options:["Art skills","Athletic skills","Math skills","Vocabulary"], answer:3},
     {q:"Which is an example of curiosity about word origins?", options:["Refusing to learn vocabulary","Ignoring new words completely","Asking where the word school first came from","Avoiding reading"], answer:2}
   ]},
  {subject:"Math", title:"Multi-Step Word Problems: Multiplication and Addition Together", summary:"Grade 2 Math strand: some word problems require more than one step, such as multiplying to find a total and then adding another amount to solve the problem.",
   resourceLabel:"YouTube: Multi-Step Word Problems: Multiplication and Addition Together", resourceUrl:"https://www.youtube.com/results?search_query=Multi-Step%20Word%20Problems%3A%20Multiplication%20and%20Addition%20Together%20grade%202%20educational",
   quiz:[
     {q:"If you buy 3 bags of 4 apples, then get 2 more apples, how many apples in all?", options:["12","13","10","14"], answer:1},
     {q:"If there are 5 rows of 2 chairs, then 3 more chairs are added, how many chairs total?", options:["11","13","10","12"], answer:1},
     {q:"A multi-step problem requires you to ___.", options:["Only add numbers","Only look at the first number","Solve more than one operation to find the answer","Skip a step"], answer:2},
     {q:"If 4 boxes have 6 toys each, then 5 toys are added, how many toys in total?", options:["29","24","30","25"], answer:0},
     {q:"When solving a multi-step problem, it helps to ___.", options:["Guess randomly","Skip straight to the final answer","Ignore some of the numbers","Solve one step at a time in order"], answer:3}
   ]},
  {subject:"Science", title:"Bees and Their Hives: Working Together in a Colony", summary:"Grade 2 Science strand: bees live together in large groups called colonies inside a hive, where each bee has a job that helps the whole group survive.",
   resourceLabel:"YouTube: Bees and Their Hives: Working Together in a Colony", resourceUrl:"https://www.youtube.com/results?search_query=Bees%20and%20Their%20Hives%3A%20Working%20Together%20in%20a%20Colony%20grade%202%20educational",
   quiz:[
     {q:"What do we call a large group of bees living together?", options:["A pack","A herd","A flock","A colony"], answer:3},
     {q:"Where do bees in a colony live?", options:["In a den","In a burrow","In a hive","In a nest"], answer:2},
     {q:"Do all bees in a hive have the same job?", options:["Yes, they all do the exact same thing","Only one bee works","No, different bees have different jobs","Bees do not have jobs"], answer:2},
     {q:"Why is teamwork important in a bee colony?", options:["Teamwork does not matter to bees","Bees work completely alone","It has no purpose","It helps the whole group survive"], answer:3},
     {q:"Which of these might be a job of a worker bee?", options:["Reading a book","Collecting nectar","Driving a car","Building a house for people"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Sister Cities: Twin Communities Around the World", summary:"Grade 2 Social Studies strand: sister cities are communities in different countries that form a special partnership to share culture, ideas, and friendship.",
   resourceLabel:"YouTube: Sister Cities: Twin Communities Around the World", resourceUrl:"https://www.youtube.com/results?search_query=Sister%20Cities%3A%20Twin%20Communities%20Around%20the%20World%20grade%202%20educational",
   quiz:[
     {q:"What is a sister city?", options:["A city with no people","A kind of holiday","A partner community in another country","A type of building"], answer:2},
     ...
     {q:"What might sister cities share with each other?", options:["Only complaints","Weather patterns only","Cultural events and ideas","Nothing at all"], answer:2},
     {q:"Is a sister city partnership an example of global friendship?", options:["It has no purpose","Yes","No","Only if in the same country"], answer:1},
     {q:"Sister city partnerships can help people learn about ___.", options:["Nothing new","Weather forecasting","Only their own city","Other cultures and communities"], answer:3}
   ]},
]},
{day:119, label:"Day 119 — Thu", subjects:[
  {subject:"Language", title:"List Poems: Writing Poetry Without Rhyme", summary:"Grade 2 Language strand: a list poem is a simple form of poetry that lists ideas, things, or feelings related to a topic, without needing to rhyme.",
   resourceLabel:"YouTube: List Poems: Writing Poetry Without Rhyme", resourceUrl:"https://www.youtube.com/results?search_query=List%20Poems%3A%20Writing%20Poetry%20Without%20Rhyme%20grade%202%20educational",
   quiz:[
     {q:"Does a list poem need to rhyme?", options:["No","Rhyme is the only rule","Yes, always","Only sometimes required"], answer:0},
     {q:"What does a list poem usually do?", options:["Uses only numbers","Lists ideas or things related to a topic","Tells a long complicated story","Has no topic at all"], answer:1},
     {q:"Why might a list poem be a good choice for a beginner poet?", options:["It does not require rhyming, making it simpler to write","It requires perfect rhyme","It has strict rules about length","It is the hardest form of poetry"], answer:0},
     {q:"Which is an example of a list poem topic?", options:["A math equation","Things I love about summer","A grocery receipt","A phone number"], answer:1},
     {q:"A list poem is a type of ___.", options:["Map","Science experiment","Poetry","Math problem"], answer:2}
   ]},
  {subject:"Math", title:"3D Shapes: Nets and Unfolding", summary:"Grade 2 Math strand: a net is a flat pattern that can be folded to make a 3D shape, such as unfolding a cube into six connected squares.",
   resourceLabel:"YouTube: 3D Shapes: Nets and Unfolding", resourceUrl:"https://www.youtube.com/results?search_query=3D%20Shapes%3A%20Nets%20and%20Unfolding%20grade%202%20educational",
   quiz:[
     {q:"What is a net in geometry?", options:["A flat pattern that folds into a 3D shape","A tool for catching fish","A type of graph","A kind of clock"], answer:0},
     {q:"How many squares make up the net of a cube?", options:["Eight","Five","Six","Four"], answer:2},
     {q:"What 3D shape can a net of six squares fold into?", options:["A cylinder","A cone","A cube","A sphere"], answer:2},
     {q:"When you fold a net, what do you create?", options:["A 3D shape","A graph","A 2D shape","A number line"], answer:0},
     {q:"Understanding nets helps us see how ___ relate to 3D shapes.", options:["Smells","Sounds","2D flat shapes","Colours"], answer:2}
   ]},
  {subject:"Science", title:"Comparing Animal Senses: Who Sees, Hears, or Smells Best?", summary:"Grade 2 Science strand: different animals have different strong senses -- some see very well, some hear extremely well, and some have an excellent sense of smell.",
   resourceLabel:"YouTube: Comparing Animal Senses: Who Sees, Hears, or Smells Best?", resourceUrl:"https://www.youtube.com/results?search_query=Comparing%20Animal%20Senses%3A%20Who%20Sees%2C%20Hears%2C%20or%20Smells%20Best%3F%20grade%202%20educational",
   quiz:[
     {q:"Which animal is known for excellent eyesight?", options:["A jellyfish","An eagle","A snail","A worm"], answer:1},
     {q:"Which animal is known for having an excellent sense of smell?", options:["A butterfly","A frog","A fish","A dog"], answer:3},
     {q:"Do all animals rely most on the same sense?", options:["Only humans have senses","Yes, all animals are identical","No, different animals rely on different strong senses","Animals have no senses"], answer:2},
     {q:"Why might a bat rely heavily on hearing instead of sight?", options:["Bats cannot hear at all","Hearing is not useful to bats","It often navigates in the dark","Bats never move"], answer:2},
     {q:"Comparing animal senses helps scientists understand ___.", options:["That all animals are the same","How animals are adapted to their environment","That senses do not matter","Nothing important"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Public Signs and Symbols: Reading the World Around Us", summary:"Grade 2 Social Studies strand: public signs use symbols and simple pictures, such as a red octagon for stop or a wheelchair icon for accessibility, to communicate quickly across different languages.",
   resourceLabel:"YouTube: Public Signs and Symbols: Reading the World Around Us", resourceUrl:"https://www.youtube.com/results?search_query=Public%20Signs%20and%20Symbols%3A%20Reading%20the%20World%20Around%20Us%20grade%202%20educational",
   quiz:[
     {q:"What shape is a stop sign?", options:["A triangle","A square","A circle","An octagon"], answer:3},
     {q:"Why do public signs often use symbols instead of only words?", options:["Signs never need symbols","Words are always better","Symbols have no meaning","Symbols can be understood quickly across languages"], answer:3},
     {q:"What does a wheelchair symbol on a sign usually indicate?", options:["A type of food","A parking fee","An accessible entrance or space","A weather warning"], answer:2},
     {q:"Why is it useful to recognize common public signs?", options:["Signs are never useful","Signs have no purpose","Only adults need to know signs","It helps keep us safe and informed"], answer:3},
     {q:"Which colour is often used on signs to warn of danger?", options:["Beige","Red","Pink","Light blue"], answer:1}
   ]},
]},
{day:120, label:"Day 120 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Apostrophes, Connections, and Word Study", summary:"Grade 2 Language strand review: students revisit apostrophes in contractions and possessives, syllable division, text-to-text and text-to-world connections, peer editing, and word origins.",
   resourceLabel:"YouTube: Language Review: Apostrophes, Connections, and Word Study", resourceUrl:"https://www.youtube.com/results?search_query=Language%20Review%3A%20Apostrophes%2C%20Connections%2C%20and%20Word%20Study%20grade%202%20educational",
   quiz:[
     {q:"In dont, why is an apostrophe used?", options:["To join two words into one","It shows a contraction is being made","To end a sentence","It has no purpose"], answer:1},
     {q:"What does text-to-text mean?", options:["Ignoring the text","Connecting one text to another text","Connecting a text to your own life","Reading only one book"], answer:1},
     {q:"What is peer editing?", options:["Ignoring a classmates writing","Copying a classmates writing","Erasing a classmates writing","Giving helpful feedback on a classmates writing"], answer:3},
     {q:"How many syllables are in the word butterfly?", options:["One","Three","Two","Four"], answer:1},
     {q:"Why might learning about word origins be helpful?", options:["It can help us understand and remember new words","It changes the spelling randomly","It makes words harder to learn","It has no benefit"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Multiplication, Place Value, and Data", summary:"Grade 2 Math strand review: students revisit multiplication facts to 12, two-digit multiplication, expanded form, multiples of ten, data range, and 3D shape nets.",
   resourceLabel:"YouTube: Math Review: Multiplication, Place Value, and Data", resourceUrl:"https://www.youtube.com/results?search_query=Math%20Review%3A%20Multiplication%2C%20Place%20Value%2C%20and%20Data%20grade%202%20educational",
   quiz:[
     {q:"What is 11 x 5?", options:["60","45","55","50"], answer:2},
     {q:"What is 12 x 4?", options:["50","44","46","48"], answer:3},
     {q:"What is 456 written in expanded form?", options:["456 + 0","400 + 50 + 6","45 + 6","4 + 5 + 6"], answer:1},
     {q:"What is 3 x 20?", options:["60","23","600","6"], answer:0},
     {q:"What is the range of the data set 3, 7, 9, 2?", options:["9","2","5","7"], answer:0}
   ]},
  {subject:"Science", title:"Science Review: Environment, Sound, and Living Things", summary:"Grade 2 Science strand review: students revisit water conservation, composting, sound waves, birds of prey, plant defenses, coral reefs, bee colonies, and comparing animal senses.",
   resourceLabel:"YouTube: Science Review: Environment, Sound, and Living Things", resourceUrl:"https://www.youtube.com/results?search_query=Science%20Review%3A%20Environment%2C%20Sound%2C%20and%20Living%20Things%20grade%202%20educational",
   quiz:[
     {q:"What does water conservation mean?", options:["Using as much water as possible","Using water carefully and not wasting it","Never using water","Wasting water on purpose"], answer:1},
     {q:"What causes sound to travel?", options:["Temperature","Light","Vibrations","Colour"], answer:2},
     {q:"Which of these is a bird of prey?", options:["Eagle","Duck","Penguin","Chicken"], answer:0},
     {q:"What builds a coral reef?", options:["Tiny living creatures called coral polyps","Fish","Seaweed alone","Rocks alone"], answer:0},
     {q:"What do we call a large group of bees living together?", options:["A colony","A flock","A pack","A herd"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: History, Government, and Community", summary:"Grade 2 Social Studies strand review: students revisit the War of 1812, the justice system, Canadian astronauts, the census, time capsules, and public signs.",
   resourceLabel:"YouTube: Social Studies Review: History, Government, and Community", resourceUrl:"https://www.youtube.com/results?search_query=Social%20Studies%20Review%3A%20History%2C%20Government%2C%20and%20Community%20grade%202%20educational",
   quiz:[
     {q:"Who fought in the War of 1812?", options:["Canada and Mexico","No one, it never happened","France and Spain","The United States and British North America"], answer:3},
     {q:"Who makes decisions in a courtroom?", options:["A judge","A mayor","A doctor","A teacher"], answer:0},
     {q:"What is a census?", options:["A type of holiday","A weather report","An official count of everyone in a country","A kind of map"], answer:2},
     {q:"What is a time capsule?", options:["A kind of vehicle","A weather tool","A sealed container of objects opened later","A type of clock"], answer:2},
     {q:"What shape is a stop sign?", options:["A square","An octagon","A triangle","A circle"], answer:1}
   ]},
]},
{day:121, label:"Day 121 — Mon", subjects:[
  {subject:"Language", title:"Adjective Order: Which Word Comes First?", summary:"Grade 2 Language strand: when using more than one adjective before a noun, there is often a natural order, such as saying a big red ball rather than a red big ball.",
   resourceLabel:"YouTube: Adjective Order: Which Word Comes First?", resourceUrl:"https://www.youtube.com/results?search_query=Adjective%20Order%3A%20Which%20Word%20Comes%20First%3F%20grade%202%20educational",
   quiz:[
     {q:"Which phrase uses correct adjective order?", options:["A big red ball","A red big ball","A ball big red","Big a red ball"], answer:0},
     {q:"Which of these follows natural English adjective order?", options:["Wooden box a small","A small wooden box","A wooden small box","Box small wooden"], answer:1},
     {q:"Why does adjective order matter in English?", options:["It changes the spelling","It makes sentences sound natural","It has no effect at all","It is never important"], answer:1},
     {q:"Which sentence sounds correct?", options:["She wore blue dress a lovely.","She wore a lovely blue dress.","She wore a blue lovely dress.","She wore dress a lovely blue."], answer:1},
     {q:"Adjective order is a pattern that ___.", options:["Has no pattern at all","Never applies to size","Only applies to colours","Native speakers often follow naturally"], answer:3}
   ]},
  {subject:"Math", title:"Fractions on a Number Line", summary:"Grade 2 Math strand: fractions can be placed on a number line between 0 and 1, showing their value relative to whole numbers.",
   resourceLabel:"YouTube: Fractions on a Number Line", resourceUrl:"https://www.youtube.com/results?search_query=Fractions%20on%20a%20Number%20Line%20grade%202%20educational",
   quiz:[
     {q:"Where would the fraction 1/2 be placed on a number line from 0 to 1?", options:["At the very start","At the very end","Past the number 1","Exactly in the middle"], answer:3},
     {q:"Where would the fraction 1/4 be placed on a number line from 0 to 1?", options:["Closer to 1","Closer to 0","Exactly in the middle","Past the number 1"], answer:1},
     {q:"On a number line, which fraction is closer to 1: 3/4 or 1/4?", options:["3/4","1/4","Neither is close to 1","They are equal"], answer:0},
     {q:"A number line showing fractions between 0 and 1 helps us see ___.", options:["The size of fractions compared to whole numbers","Shapes","Only whole numbers","Colours"], answer:0},
     {q:"Where is the fraction 0/4 located on a number line from 0 to 1?", options:["Past 1","In the middle","At 0","At 1"], answer:2}
   ]},
  {subject:"Science", title:"Bats: Nocturnal Mammals That Use Echolocation", summary:"Grade 2 Science strand: bats are nocturnal mammals that use echolocation, bouncing sound off objects, to find food and navigate in the dark.",
   resourceLabel:"YouTube: Bats: Nocturnal Mammals That Use Echolocation", resourceUrl:"https://www.youtube.com/results?search_query=Bats%3A%20Nocturnal%20Mammals%20That%20Use%20Echolocation%20grade%202%20educational",
   quiz:[
     {q:"Are bats active mostly during the day or at night?", options:["Neither","Only at noon","Night","Day"], answer:2},
     {q:"What is echolocation?", options:["Using smell only","Using light to see","Using taste only","Using sound to find objects in the dark"], answer:3},
     {q:"Are bats classified as birds or mammals?", options:["Reptiles","Mammals","Birds","Fish"], answer:1},
     {q:"How does echolocation help a bat?", options:["It has no purpose","It helps the bat see colours","It helps the bat breathe underwater","It helps the bat find food and avoid obstacles in the dark"], answer:3},
     {q:"Bats are the only mammals that can ___.", options:["Run fast","Change colour","Truly fly","Swim"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Classroom Jobs: Sharing Responsibility Together", summary:"Grade 2 Social Studies strand: classroom jobs, such as line leader or paper passer, give students a chance to share responsibility and help their classroom run smoothly.",
   resourceLabel:"YouTube: Classroom Jobs: Sharing Responsibility Together", resourceUrl:"https://www.youtube.com/results?search_query=Classroom%20Jobs%3A%20Sharing%20Responsibility%20Together%20grade%202%20educational",
   quiz:[
     {q:"What is the purpose of classroom jobs?", options:["They have no purpose","To keep students from learning","Only the teacher should do all the work","To share responsibility and help the classroom run smoothly"], answer:3},
     {q:"Which of these could be a classroom job?", options:["Pilot","Judge","Mayor","Line leader"], answer:3},
     {q:"Why might students take turns with classroom jobs?", options:["Only one student should ever help","Turns are not important","So everyone gets a chance to contribute","Jobs should never rotate"], answer:2},
     {q:"Having classroom jobs helps build a sense of ___.", options:["Boredom","Unfairness","Community and responsibility","Confusion"], answer:2},
     {q:"Which is an example of a helpful classroom job?", options:["Refusing to help","Ignoring the teacher","Leaving early","Passing out papers"], answer:3}
   ]},
]},
{day:122, label:"Day 122 — Tue", subjects:[
  {subject:"Language", title:"Using a Thesaurus to Find Synonyms", summary:"Grade 2 Language strand: a thesaurus is a reference book that lists synonyms, or words with similar meanings, to help writers choose stronger words.",
   resourceLabel:"YouTube: Using a Thesaurus to Find Synonyms", resourceUrl:"https://www.youtube.com/results?search_query=Using%20a%20Thesaurus%20to%20Find%20Synonyms%20grade%202%20educational",
   quiz:[
     {q:"What is a thesaurus used for?", options:["Finding a recipe","Finding a map","Finding synonyms for a word","Finding the weather forecast"], answer:2},
     {q:"If you look up happy in a thesaurus, what might you find?", options:["A math equation","The definition only","Glad or joyful","A picture"], answer:2},
     {q:"How is a thesaurus different from a dictionary?", options:["A dictionary only has pictures","A thesaurus gives synonyms, a dictionary gives definitions","They are exactly the same","A thesaurus has no words"], answer:1},
     {q:"Why might a writer use a thesaurus?", options:["To find a phone number","To find a stronger or more interesting word","To check the weather","To draw a picture"], answer:1},
     {q:"Which of these could you find in a thesaurus entry for big?", options:["A recipe for cookies","A math problem","A weather report","Large, huge, enormous"], answer:3}
   ]},
  {subject:"Math", title:"Number Bonds to 100: Finding Missing Addends", summary:"Grade 2 Math strand: students find missing addends that combine with a given number to make 100, such as finding that 35 needs 65 more to reach 100.",
   resourceLabel:"YouTube: Number Bonds to 100: Finding Missing Addends", resourceUrl:"https://www.youtube.com/results?search_query=Number%20Bonds%20to%20100%3A%20Finding%20Missing%20Addends%20grade%202%20educational",
   quiz:[
     {q:"35 + ? = 100", options:["65","55","70","60"], answer:0},
     {q:"What number is needed to make 100 when added to 40?", options:["50","60","70","65"], answer:1},
     {q:"80 + ? = 100", options:["25","10","20","15"], answer:2},
     {q:"Finding a number bond to 100 means finding ___.", options:["Half of 100 only","The missing addend that reaches 100","A fraction of 100","A number greater than 100"], answer:1},
     {q:"25 + ? = 100", options:["70","80","65","75"], answer:3}
   ]},
  {subject:"Science", title:"Reptiles and Amphibians: Cold-Blooded Animals", summary:"Grade 2 Science strand: reptiles like snakes and turtles, and amphibians like frogs, are cold-blooded animals whose body temperature changes with their surroundings.",
   resourceLabel:"YouTube: Reptiles and Amphibians: Cold-Blooded Animals", resourceUrl:"https://www.youtube.com/results?search_query=Reptiles%20and%20Amphibians%3A%20Cold-Blooded%20Animals%20grade%202%20educational",
   quiz:[
     {q:"What does it mean for an animal to be cold-blooded?", options:["It never moves","It cannot survive at all","Its body temperature changes with its surroundings","It has cold blood at all times"], answer:2},
     {q:"Which of these is a reptile?", options:["Robin","Frog","Dog","Snake"], answer:3},
     {q:"Which of these is an amphibian?", options:["Turtle","Frog","Lizard","Snake"], answer:1},
     {q:"Why might a reptile bask in the sun?", options:["To warm up its body temperature","For no reason","To hide from all light","To cool down completely"], answer:0},
     {q:"Amphibians typically begin life in ___.", options:["Outer space","Deep snow","Water","The desert"], answer:2}
   ]},
  {subject:"SocialStudies", title:"How Goods Travel: From Producer to Consumer", summary:"Grade 2 Social Studies strand: goods travel a long path from the producer who makes them to the consumer who buys them, often through factories, trucks, and stores.",
   resourceLabel:"YouTube: How Goods Travel: From Producer to Consumer", resourceUrl:"https://www.youtube.com/results?search_query=How%20Goods%20Travel%3A%20From%20Producer%20to%20Consumer%20grade%202%20educational",
   quiz:[
     {q:"Who is a producer?", options:["A person or company that makes goods","A type of animal","A person who only buys goods","A kind of weather"], answer:0},
     {q:"Who is a consumer?", options:["A kind of building","A type of vehicle","A person who buys and uses goods","A person who only makes goods"], answer:2},
     {q:"Which of these might help transport goods from a factory to a store?", options:["A dictionary","A truck","A calendar","A thermometer"], answer:1},
     {q:"Why is it useful to understand how goods travel?", options:["Goods appear instantly with no process","Only farmers need to know this","It has no value","It helps us see how products reach us"], answer:3},
     {q:"The journey of a good from producer to consumer often passes through ___.", options:["Nothing at all","Only one single step","Only the consumers home","Factories, trucks, and stores"], answer:3}
   ]},
]},
{day:123, label:"Day 123 — Wed", subjects:[
  {subject:"Language", title:"Foreshadowing: Hints About What Will Happen", summary:"Grade 2 Language strand: foreshadowing is when an author gives readers small clues or hints early in a story about events that will happen later.",
   resourceLabel:"YouTube: Foreshadowing: Hints About What Will Happen", resourceUrl:"https://www.youtube.com/results?search_query=Foreshadowing%3A%20Hints%20About%20What%20Will%20Happen%20grade%202%20educational",
   quiz:[
     {q:"What is foreshadowing?", options:["The ending of a story","Hints about what will happen later in a story","The title of a book","A characters name"], answer:1},
     {q:"Why do authors use foreshadowing?", options:["To skip the middle of the story","To confuse readers on purpose with no meaning","To end the story early","To build suspense and hint at future events"], answer:3},
     {q:"If a story mentions dark storm clouds early on, this might foreshadow ___.", options:["A sunny happy ending only","Nothing at all","A storm or trouble coming later","The title of the book"], answer:2},
     {q:"Foreshadowing usually appears ___ in a story.", options:["Only at the very end","Early on, before the event happens","Never","Only in the title"], answer:1},
     {q:"Noticing foreshadowing can help readers ___.", options:["Skip the ending","Predict what might happen next","Forget the story completely","Ignore the plot"], answer:1}
   ]},
  {subject:"Math", title:"Data: Finding the Median of a Data Set", summary:"Grade 2 Math strand: the median of a data set is the middle number when the values are arranged in order from least to greatest.",
   resourceLabel:"YouTube: Data: Finding the Median of a Data Set", resourceUrl:"https://www.youtube.com/results?search_query=Data%3A%20Finding%20the%20Median%20of%20a%20Data%20Set%20grade%202%20educational",
   quiz:[
     {q:"What is the median of the data set 2, 4, 6?", options:["12","6","2","4"], answer:3},
     {q:"How do you find the median of a data set?", options:["Add all the numbers together","Order the numbers and find the middle value","Multiply the numbers","Find the largest number only"], answer:1},
     {q:"What is the median of the data set 1, 3, 5, 7, 9?", options:["3","9","5","1"], answer:2},
     {q:"Before finding the median, the data should be ___.", options:["Left in random order","Multiplied together","Ordered from least to greatest","Ignored"], answer:2},
     {q:"The median tells us about the ___ of a data set.", options:["Largest value only","Total sum","Number of items only","Middle value"], answer:3}
   ]},
  {subject:"Science", title:"How Plants Make Food: An Introduction to Photosynthesis", summary:"Grade 2 Science strand: plants make their own food through a process called photosynthesis, using sunlight, water, and air to grow.",
   resourceLabel:"YouTube: How Plants Make Food: An Introduction to Photosynthesis", resourceUrl:"https://www.youtube.com/results?search_query=How%20Plants%20Make%20Food%3A%20An%20Introduction%20to%20Photosynthesis%20grade%202%20educational",
   quiz:[
     {q:"What is photosynthesis?", options:["The process plants use to make their own food","A kind of rock formation","A weather pattern","A type of animal behaviour"], answer:0},
     {q:"What do plants need for photosynthesis?", options:["Only darkness","Sunlight, water, and air","Only soil","Only sound"], answer:1},
     {q:"Where in the plant does most photosynthesis happen?", options:["The roots","The leaves","The flower petals only","The seeds only"], answer:1},
     {q:"Why is photosynthesis important for plants?", options:["It stops plants from growing","It has no purpose","It lets plants make the food they need to grow","It only happens at night"], answer:2},
     {q:"Photosynthesis mainly requires energy from ___.", options:["Sunlight","The moon","Wind alone","Rocks"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Community Recycling Programs: Where Our Blue Bin Goes", summary:"Grade 2 Social Studies strand: communities run recycling programs, collecting materials in blue bins and sending them to facilities where they are sorted and turned into new products.",
   resourceLabel:"YouTube: Community Recycling Programs: Where Our Blue Bin Goes", resourceUrl:"https://www.youtube.com/results?search_query=Community%20Recycling%20Programs%3A%20Where%20Our%20Blue%20Bin%20Goes%20grade%202%20educational",
   quiz:[
     {q:"What colour bin is often used for recycling in many communities?", options:["Pink","Black","Yellow","Blue"], answer:3},
     {q:"Where do recycled materials go after being collected?", options:["Back to the same store","Straight to a landfill","Nowhere, they disappear","A recycling facility to be sorted and processed"], answer:3},
     {q:"Why do communities run recycling programs?", options:["To reduce waste and reuse materials","To waste more resources","To create more garbage","Recycling has no benefit"], answer:0},
     {q:"Which of these is commonly recycled?", options:["Sunlight","Food scraps only","Paper and cardboard","Rocks"], answer:2},
     {q:"A community recycling program helps ___.", options:["Harm the environment","Waste more resources","Protect the environment","Increase pollution"], answer:2}
   ]},
]},
{day:124, label:"Day 124 — Thu", subjects:[
  {subject:"Language", title:"Visualizing: Making Pictures in Your Mind While Reading", summary:"Grade 2 Language strand: visualizing means using descriptive details in a text to create a picture in your mind of what is happening in the story.",
   resourceLabel:"YouTube: Visualizing: Making Pictures in Your Mind While Reading", resourceUrl:"https://www.youtube.com/results?search_query=Visualizing%3A%20Making%20Pictures%20in%20Your%20Mind%20While%20Reading%20grade%202%20educational",
   quiz:[
     {q:"What does it mean to visualize while reading?", options:["Skipping descriptive parts","Only looking at illustrations","Creating a picture in your mind of the story","Ignoring the words"], answer:2},
     {q:"What kind of details help readers visualize a scene?", options:["Only the page number","Only the authors name","Descriptive details about sights, sounds, and feelings","Only the title"], answer:2},
     {q:"Why is visualizing a helpful reading strategy?", options:["It only works with pictures already in the book","It replaces reading completely","It helps readers understand and enjoy the story more","It has no benefit"], answer:2},
     {q:"If a story describes a crunchy, golden autumn leaf, what does this help readers do?", options:["Skip to the next page","Picture the leaf in their mind","Ignore the sentence","Forget the story"], answer:1},
     {q:"Visualizing is a strategy used mainly during ___.", options:["Recess","Gym class","Reading","Lunch"], answer:2}
   ]},
  {subject:"Math", title:"Time: Understanding AM and PM", summary:"Grade 2 Math strand: AM refers to the time from midnight to noon, and PM refers to the time from noon to midnight, helping us describe when events happen.",
   resourceLabel:"YouTube: Time: Understanding AM and PM", resourceUrl:"https://www.youtube.com/results?search_query=Time%3A%20Understanding%20AM%20and%20PM%20grade%202%20educational",
   quiz:[
     {q:"Does AM refer to morning or evening hours?", options:["Only noon exactly","Only midnight exactly","Morning, from midnight to noon","Evening, from noon to midnight"], answer:2},
     {q:"Does PM refer to morning or evening hours?", options:["Only sunrise","Only midnight","Morning hours","Noon to midnight hours"], answer:3},
     {q:"If you wake up at 7:00 in the morning, is that AM or PM?", options:["Neither","PM","AM","Both"], answer:2},
     {q:"If you eat dinner at 6:00 in the evening, is that AM or PM?", options:["PM","Both","Neither","AM"], answer:0},
     {q:"AM and PM help us know ___.", options:["The temperature outside","The month of the year","Whether a time is in the morning or evening/night","The day of the week"], answer:2}
   ]},
  {subject:"Science", title:"Layers of the Rainforest: Canopy to Forest Floor", summary:"Grade 2 Science strand: a rainforest has different layers, including the tall emergent layer, the leafy canopy, the understory, and the shaded forest floor.",
   resourceLabel:"YouTube: Layers of the Rainforest: Canopy to Forest Floor", resourceUrl:"https://www.youtube.com/results?search_query=Layers%20of%20the%20Rainforest%3A%20Canopy%20to%20Forest%20Floor%20grade%202%20educational",
   quiz:[
     {q:"What is the very top layer of a rainforest called?", options:["The basement","The understory","The emergent layer","The forest floor"], answer:2},
     {q:"What is the leafy, tree-top layer of a rainforest called?", options:["The canopy","The forest floor","The roots","The emergent layer only"], answer:0},
     {q:"Which rainforest layer receives the least sunlight?", options:["The canopy","The forest floor","The emergent layer","The very top"], answer:1},
     {q:"Why do rainforests have different layers?", options:["Different plants and animals live at different heights","Only the ground layer matters","All rainforest layers are identical","Layers do not exist in rainforests"], answer:0},
     {q:"The layer just below the canopy is called the ___.", options:["Basement","Overstory","Attic","Understory"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The History of the Canadian Flag: Before and After 1965", summary:"Grade 2 Social Studies strand: before 1965, Canada used a different flag, and the current red and white maple leaf flag was officially adopted that year.",
   resourceLabel:"YouTube: The History of the Canadian Flag: Before and After 1965", resourceUrl:"https://www.youtube.com/results?search_query=The%20History%20of%20the%20Canadian%20Flag%3A%20Before%20and%20After%201965%20grade%202%20educational",
   quiz:[
     {q:"In what year was the current Canadian maple leaf flag adopted?", options:["1965","1867","2000","1812"], answer:0},
     {q:"What are the main colours of the Canadian flag?", options:["Red and white","Purple and black","Blue and yellow","Green and orange"], answer:0},
     {q:"What symbol is in the centre of the Canadian flag?", options:["A maple leaf","A crown","A bird","A star"], answer:0},
     {q:"Did Canada always use the same flag as it does today?", options:["The flag changes every year","No, the flag changed in 1965","Yes, it has never changed","Canada has never had a flag"], answer:1},
     {q:"Learning about the history of the flag helps us understand ___.", options:["A fictional story","Nothing important","Only recent history","How national symbols can change over time"], answer:3}
   ]},
]},
{day:125, label:"Day 125 — Fri", subjects:[
  {subject:"Language", title:"Free Verse Poetry: Poems Without Rhyme or Rules", summary:"Grade 2 Language strand: free verse poetry does not follow a set rhyme scheme or rhythm, allowing writers to express ideas freely in whatever lines feel right.",
   resourceLabel:"YouTube: Free Verse Poetry: Poems Without Rhyme or Rules", resourceUrl:"https://www.youtube.com/results?search_query=Free%20Verse%20Poetry%3A%20Poems%20Without%20Rhyme%20or%20Rules%20grade%202%20educational",
   quiz:[
     {q:"Does free verse poetry need to rhyme?", options:["Yes, always","Only sometimes required","No","Rhyme is the only rule"], answer:2},
     {q:"What makes free verse different from rhyming poetry?", options:["It does not follow a set rhyme or rhythm pattern","It must rhyme perfectly","It cannot use descriptive words","It has strict rules about length"], answer:0},
     {q:"Why might a poet choose to write in free verse?", options:["Because it has to be exactly ten lines","To express ideas freely without following strict rules","Because rhyming is required","Because it is the only kind of poem that exists"], answer:1},
     {q:"Which is a feature of free verse poetry?", options:["It cannot use imagery","Every line must rhyme with the next","It must be written in one sentence","Flexible line lengths and no required rhyme"], answer:3},
     {q:"Free verse poetry is a type of ___.", options:["Science report","Map","Math problem","Poetry"], answer:3}
   ]},
  {subject:"Math", title:"Multiplying Three Numbers Together", summary:"Grade 2 Math strand: to multiply three numbers together, students multiply two of the numbers first, then multiply that answer by the third number.",
   resourceLabel:"YouTube: Multiplying Three Numbers Together", resourceUrl:"https://www.youtube.com/results?search_query=Multiplying%20Three%20Numbers%20Together%20grade%202%20educational",
   quiz:[
     {q:"What is 2 x 3 x 2?", options:["16","10","14","12"], answer:3},
     {q:"To solve 2 x 2 x 5, which two numbers might you multiply first?", options:["Any two of the numbers, then multiply by the third","None of them","Only the largest number","2 and 2"], answer:0},
     {q:"What is 1 x 4 x 3?", options:["10","14","12","8"], answer:2},
     {q:"What is 3 x 2 x 2?", options:["16","14","10","12"], answer:3},
     {q:"When multiplying three numbers, the order you multiply them in ___.", options:["Does not change the final answer","Always changes the final answer","Must always start with the largest","Must always start with the smallest"], answer:0}
   ]},
  {subject:"Science", title:"Polar Animals: Surviving the Arctic Cold", summary:"Grade 2 Science strand: polar animals, such as polar bears and arctic foxes, have thick fur and fat to help them survive extremely cold temperatures.",
   resourceLabel:"YouTube: Polar Animals: Surviving the Arctic Cold", resourceUrl:"https://www.youtube.com/results?search_query=Polar%20Animals%3A%20Surviving%20the%20Arctic%20Cold%20grade%202%20educational",
   quiz:[
     {q:"Name one adaptation that helps polar animals stay warm.", options:["Bright feathers only","Thin skin only","No fur at all","Thick fur or fat"], answer:3},
     {q:"Which of these is a polar animal?", options:["Camel","Polar bear","Kangaroo","Toucan"], answer:1},
     {q:"Why do polar animals often have white fur?", options:["It has no purpose","To camouflage in the snow","To attract more predators","To stay cooler in heat"], answer:1},
     {q:"What body feature helps seals and whales survive cold arctic water?", options:["A thick layer of fat called blubber","No body fat at all","Feathers","Dry scaly skin"], answer:0},
     {q:"Polar regions are known for being ___.", options:["Always rainy","Extremely cold","Always dry and sandy","Extremely hot"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Canadian Bridges and Tunnels: Engineering Our Connections", summary:"Grade 2 Social Studies strand: bridges and tunnels are built across Canada to connect communities separated by rivers, valleys, or mountains, making travel easier.",
   resourceLabel:"YouTube: Canadian Bridges and Tunnels: Engineering Our Connections", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Bridges%20and%20Tunnels%3A%20Engineering%20Our%20Connections%20grade%202%20educational",
   quiz:[
     {q:"Why are bridges built?", options:["To connect places separated by water, valleys, or gaps","They serve no purpose","To make travel harder","To block travel"], answer:0},
     {q:"Why might a tunnel be built through a mountain?", options:["Tunnels are never useful","To make travel impossible","To make travel through the mountain easier and faster","To hide the mountain"], answer:2},
     {q:"What do bridges and tunnels both help improve?", options:["Nothing important","Weather patterns","Transportation and connection between places","Only decoration"], answer:2},
     {q:"Which of these might a bridge cross over?", options:["A river","A pencil","A single house","A classroom"], answer:0},
     {q:"Engineers who design bridges and tunnels need to consider ___.", options:["Only the price of paint","Safety and strong construction","Nothing at all","Only the colour"], answer:1}
   ]},
]},
{day:126, label:"Day 126 — Mon", subjects:[
  {subject:"Language", title:"Informal Writing: Notes and Messages", summary:"Grade 2 Language strand: informal writing, like a quick note or message to a friend, uses a casual, friendly tone that is different from formal writing.",
   resourceLabel:"YouTube: Informal Writing: Notes and Messages", resourceUrl:"https://www.youtube.com/results?search_query=Informal%20Writing%3A%20Notes%20and%20Messages%20grade%202%20educational",
   quiz:[
     {q:"What is informal writing?", options:["Casual writing like a note or message","A dictionary entry","A legal document","A formal report only"], answer:0},
     {q:"Which of these is an example of informal writing?", options:["A scientific report","A quick note to a friend","A formal essay for a teacher","A legal contract"], answer:1},
     {q:"How is informal writing different from formal writing?", options:["It has no purpose","It is always longer","It must always rhyme","It uses a casual, friendly tone"], answer:3},
     {q:"Which sentence sounds informal?", options:["This document shall be reviewed.","Hey, want to play at recess?","It is hereby requested that you attend.","The following report outlines the findings."], answer:1},
     {q:"Informal writing is often used when writing to ___.", options:["A formal business only","Friends or family","A government office","A judge in court"], answer:1}
   ]},
  {subject:"Math", title:"Perimeter and Area Together: Comparing Two Measurements", summary:"Grade 2 Math strand: perimeter measures the distance around a shape, while area measures the space inside it, and students compare both for the same shape.",
   resourceLabel:"YouTube: Perimeter and Area Together: Comparing Two Measurements", resourceUrl:"https://www.youtube.com/results?search_query=Perimeter%20and%20Area%20Together%3A%20Comparing%20Two%20Measurements%20grade%202%20educational",
   quiz:[
     ...
     {q:"What does area measure?", options:["The distance around a shape","The height only","The number of corners","The space inside a shape"], answer:3},
     {q:"A rectangle has a perimeter of 14 and sides of 5 and 2. Does the math check out, since 5+5+2+2 equals 14?", options:["No, it should be 10","No, it should be 20","Yes, 14","No, it should be 7"], answer:2},
     {q:"Can two different shapes have the same perimeter but different areas?", options:["Only if they are circles","Yes","No, never","Only if they are squares"], answer:1},
     {q:"Perimeter and area are both examples of ___.", options:["Types of graphs","Colours","Measurements of a shape","Fractions"], answer:2}
   ]},
  {subject:"Science", title:"Animal Groups: Herds, Flocks, and Schools", summary:"Grade 2 Science strand: many animals live and move together in groups with special names, such as a herd of deer, a flock of birds, or a school of fish.",
   resourceLabel:"YouTube: Animal Groups: Herds, Flocks, and Schools", resourceUrl:"https://www.youtube.com/results?search_query=Animal%20Groups%3A%20Herds%2C%20Flocks%2C%20and%20Schools%20grade%202%20educational",
   quiz:[
     {q:"What do we call a group of deer?", options:["A flock","A pack","A school","A herd"], answer:3},
     {q:"What do we call a group of birds flying together?", options:["A herd","A school","A den","A flock"], answer:3},
     {q:"What do we call a group of fish swimming together?", options:["A herd","A pod","A flock","A school"], answer:3},
     {q:"Why might animals travel together in groups?", options:["It is always dangerous","To get lost more easily","Groups provide no benefit","For safety and to find food more easily"], answer:3},
     {q:"A group of wolves is called a ___.", options:["Pack","Herd","Flock","School"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Statues and Monuments: Remembering Our History", summary:"Grade 2 Social Studies strand: statues and monuments are built in public places to help communities remember important people or events from history.",
   resourceLabel:"YouTube: Statues and Monuments: Remembering Our History", resourceUrl:"https://www.youtube.com/results?search_query=Statues%20and%20Monuments%3A%20Remembering%20Our%20History%20grade%202%20educational",
   quiz:[
     {q:"What is the purpose of a statue or monument?", options:["To help communities remember important people or events","They have no purpose","To block traffic","To confuse visitors"], answer:0},
     {q:"Where are statues and monuments often found?", options:["Only inside private homes","Hidden underground with no access","Nowhere, they do not exist","In public places like parks or squares"], answer:3},
     {q:"Why might a community build a monument for a historical event?", options:["It has no meaning","To hide the event from everyone","To remember and honour what happened","To forget the event completely"], answer:2},
     {q:"Which of these could a monument represent?", options:["A historical figure or event","A random shape with no meaning","A type of food","A weather pattern"], answer:0},
     {q:"Learning about statues and monuments helps us understand ___.", options:["Parts of our shared history","Modern technology only","Only fictional stories","Nothing about the past"], answer:0}
   ]},
]},
{day:127, label:"Day 127 — Tue", subjects:[
  {subject:"Language", title:"Story Pacing: Fast and Slow Moments in a Story", summary:"Grade 2 Language strand: story pacing describes how quickly or slowly events unfold, with exciting parts often moving fast and quiet parts moving slower.",
   resourceLabel:"YouTube: Story Pacing: Fast and Slow Moments in a Story", resourceUrl:"https://www.youtube.com/results?search_query=Story%20Pacing%3A%20Fast%20and%20Slow%20Moments%20in%20a%20Story%20grade%202%20educational",
   quiz:[
     {q:"What does story pacing describe?", options:["How quickly or slowly events happen","The title of the book","The cover colour","The characters names"], answer:0},
     {q:"During an exciting chase scene, the pacing is usually ___.", options:["Nonexistent","Slow","The same as a quiet scene","Fast"], answer:3},
     {q:"During a calm, quiet moment in a story, the pacing is usually ___.", options:["Slow","Not important","Random","Fast"], answer:0},
     {q:"Why do authors vary the pacing of a story?", options:["It has no purpose","To create excitement or calm at the right moments","Pacing never changes in stories","To confuse readers on purpose"], answer:1},
     {q:"Which word suggests fast pacing in a scene?", options:["Quietly","Slowly","Eventually, over many years","Suddenly"], answer:3}
   ]},
  {subject:"Math", title:"Skip Counting Backwards by 10s and 100s", summary:"Grade 2 Math strand: students skip count backwards by 10s and 100s, such as counting 100, 90, 80 or 500, 400, 300.",
   resourceLabel:"YouTube: Skip Counting Backwards by 10s and 100s", resourceUrl:"https://www.youtube.com/results?search_query=Skip%20Counting%20Backwards%20by%2010s%20and%20100s%20grade%202%20educational",
   quiz:[
     {q:"What comes next: 100, 90, 80, ___?", options:["65","60","75","70"], answer:3},
     {q:"What comes next: 500, 400, 300, ___?", options:["250","150","200","100"], answer:2},
     {q:"Skip counting backwards by 10s from 50 gives what number next?", options:["40","30","45","35"], answer:0},
     {q:"What comes next: 900, 800, 700, ___?", options:["650","550","600","500"], answer:2},
     {q:"Skip counting backwards by 100s means we subtract ___ each time.", options:["100","10","1000","50"], answer:0}
   ]},
  {subject:"Science", title:"Bioluminescence: Animals That Glow in the Dark", summary:"Grade 2 Science strand: bioluminescence is when living things, such as fireflies and some deep-sea fish, produce their own light using a chemical reaction.",
   resourceLabel:"YouTube: Bioluminescence: Animals That Glow in the Dark", resourceUrl:"https://www.youtube.com/results?search_query=Bioluminescence%3A%20Animals%20That%20Glow%20in%20the%20Dark%20grade%202%20educational",
   quiz:[
     {q:"What is bioluminescence?", options:["When rocks glow from heat","When living things produce their own light","When animals sleep all winter","When plants change colour"], answer:1},
     {q:"Name one animal known for bioluminescence.", options:["A rabbit","A sheep","A firefly","A cow"], answer:2},
     {q:"Where do many bioluminescent sea creatures live?", options:["Deep in the dark ocean","In deserts","On mountain tops","In dry grasslands"], answer:0},
     {q:"Why might an animal use bioluminescence?", options:["To stay warm","To attract food, find mates, or scare predators","To breathe underwater","It has no purpose at all"], answer:1},
     {q:"Bioluminescent light is created through a ___.", options:["Burning fire","Reflection of moonlight only","Chemical reaction inside the animals body","Electric wire"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Emergency 911: How to Call for Help", summary:"Grade 2 Social Studies strand: in Canada, 911 is the emergency phone number people call to reach police, firefighters, or ambulance workers quickly during an emergency.",
   resourceLabel:"YouTube: Emergency 911: How to Call for Help", resourceUrl:"https://www.youtube.com/results?search_query=Emergency%20911%3A%20How%20to%20Call%20for%20Help%20grade%202%20educational",
   quiz:[
     {q:"What phone number do people call in an emergency in Canada?", options:["411","911","211","611"], answer:1},
     {q:"Who might answer a 911 call?", options:["An emergency dispatcher who sends help","A store clerk","No one answers","A random stranger"], answer:0},
     {q:"Which of these is an example of a real emergency to call 911 for?", options:["Wanting a snack","A house fire","Losing a toy","Being bored"], answer:1},
     {q:"Why is it important to know how to call 911?", options:["It is only for adults to know","It can help get fast help during a real emergency","It should never be used","It has no importance"], answer:1},
     {q:"When calling 911, it is important to ___.", options:["Hang up right away","Say nothing at all","Stay calm and give clear information","Call as a joke"], answer:2}
   ]},
]},
{day:128, label:"Day 128 — Wed", subjects:[
  {subject:"Language", title:"Reading Strategy: Asking Questions Before and During Reading", summary:"Grade 2 Language strand: strong readers ask themselves questions before and during reading, such as wondering what will happen next, to stay engaged and understand the text.",
   resourceLabel:"YouTube: Reading Strategy: Asking Questions Before and During Reading", resourceUrl:"https://www.youtube.com/results?search_query=Reading%20Strategy%3A%20Asking%20Questions%20Before%20and%20During%20Reading%20grade%202%20educational",
   quiz:[
     {q:"What is one benefit of asking questions while reading?", options:["It replaces reading completely","It has no benefit","It helps readers stay engaged and understand more","It confuses readers on purpose"], answer:2},
     {q:"Which is an example of a question a reader might ask before starting a book?", options:["What do I think this book will be about?","What is the weather like?","What time is recess?","What is for lunch today?"], answer:0},
     {q:"When might a reader ask questions during reading?", options:["Only during math class","Never","Whenever something seems confusing or interesting","Only after finishing the whole book"], answer:2},
     {q:"Asking questions while reading is an example of a ___.", options:["Recess game","Reading strategy","Math strategy","Art project"], answer:1},
     {q:"Which question shows deep thinking about a story?", options:["Why did the character make that choice?","What colour is the cover?","What font is used?","How many pages does it have?"], answer:0}
   ]},
  {subject:"Math", title:"Estimating Measurement: Choosing the Best Unit", summary:"Grade 2 Math strand: students choose the most reasonable unit to estimate a measurement, such as using metres for a hallway and centimetres for a pencil.",
   resourceLabel:"YouTube: Estimating Measurement: Choosing the Best Unit", resourceUrl:"https://www.youtube.com/results?search_query=Estimating%20Measurement%3A%20Choosing%20the%20Best%20Unit%20grade%202%20educational",
   quiz:[
     {q:"Which unit would best measure the length of a pencil?", options:["Centimetres","Kilometres","Litres","Metres"], answer:0},
     {q:"Which unit would best measure the length of a hallway?", options:["Grams","Centimetres","Millilitres","Metres"], answer:3},
     {q:"Which unit would best measure the mass of an apple?", options:["Litres","Metres","Grams","Kilograms"], answer:2},
     {q:"Which unit would best measure the capacity of a bathtub?", options:["Centimetres","Litres","Grams","Millilitres"], answer:1},
     {q:"Choosing the best unit depends on the ___ of the object being measured.", options:["Colour","Price","Size","Name"], answer:2}
   ]},
  {subject:"Science", title:"Camels and Desert Adaptations: Storing Water and Fat", summary:"Grade 2 Science strand: camels have special adaptations for desert life, such as humps that store fat and the ability to go a long time without drinking water.",
   resourceLabel:"YouTube: Camels and Desert Adaptations: Storing Water and Fat", resourceUrl:"https://www.youtube.com/results?search_query=Camels%20and%20Desert%20Adaptations%3A%20Storing%20Water%20and%20Fat%20grade%202%20educational",
   quiz:[
     {q:"What do camel humps mainly store?", options:["Sand","Air","Fat","Water only"], answer:2},
     {q:"Why can camels survive a long time without water?", options:["They live only in wet places","Their bodies are adapted to conserve water","They never need water at all","They drink constantly"], answer:1},
     {q:"Camels are well adapted to living in ___.", options:["Oceans","Deserts","The Arctic","Rainforests"], answer:1},
     {q:"Which of these is a camel adaptation for hot, sandy environments?", options:["Long eyelashes to protect from sand","Wings for flying","Gills for breathing underwater","Thick blubber like a whale"], answer:0},
     {q:"Desert adaptations help animals like camels survive with ___.", options:["No sunlight at all","Constant rain","Extreme cold only","Very little water"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Fair Trade: Buying Products That Help Others", summary:"Grade 2 Social Studies strand: fair trade means buying products, like coffee or chocolate, that are made in ways that pay workers fairly and protect the environment.",
   resourceLabel:"YouTube: Fair Trade: Buying Products That Help Others", resourceUrl:"https://www.youtube.com/results?search_query=Fair%20Trade%3A%20Buying%20Products%20That%20Help%20Others%20grade%202%20educational",
   quiz:[
     {q:"What does fair trade mean?", options:["Buying the cheapest product always","Buying products made in ways that pay workers fairly","Ignoring how products are made","Only buying products from one country"], answer:1},
     {q:"Which of these might have a fair trade label?", options:["Coffee or chocolate","A rock","A shadow","A cloud"], answer:0},
     {q:"Why might someone choose to buy fair trade products?", options:["To harm workers on purpose","It has no purpose","Fair trade does not exist","To support fair pay and good conditions for workers"], answer:3},
     {q:"Fair trade often also considers ___.", options:["Increasing pollution","Protecting the environment","Making products more wasteful","Ignoring nature completely"], answer:1},
     {q:"Choosing fair trade products is one way to be a ___.", options:["Careless shopper","Responsible consumer","Unfair trader","Wasteful buyer"], answer:1}
   ]},
]},
{day:129, label:"Day 129 — Thu", subjects:[
  {subject:"Language", title:"Authors Craft: Repetition for Emphasis", summary:"Grade 2 Language strand: authors sometimes repeat words or phrases on purpose to emphasize an idea or create a rhythm, such as repeating never give up, never give up.",
   resourceLabel:"YouTube: Authors Craft: Repetition for Emphasis", resourceUrl:"https://www.youtube.com/results?search_query=Authors%20Craft%3A%20Repetition%20for%20Emphasis%20grade%202%20educational",
   quiz:[
     {q:"Why might an author repeat a word or phrase in a story?", options:["To emphasize an important idea","By accident every time","To make the story shorter","To confuse the reader"], answer:0},
     {q:"Which of these shows repetition for emphasis?", options:["She walked to school.","Run, run, run as fast as you can!","The dog ran quickly.","It was a sunny day."], answer:1},
     {q:"What effect can repetition have on a reader?", options:["It has no effect","It removes all meaning","It can create rhythm and emphasize meaning","It always makes writing boring"], answer:2},
     {q:"Repetition is a tool used mainly in ___.", options:["Math equations only","Phone numbers","Writing and poetry","Weather reports only"], answer:2},
     {q:"Which phrase uses repetition to build excitement?", options:["Faster, faster, faster we go!","The room was empty.","It was quiet.","The car moved."], answer:0}
   ]},
  {subject:"Math", title:"Tessellations: Shapes That Tile Without Gaps", summary:"Grade 2 Math strand: a tessellation is a pattern of shapes, like squares or triangles, that fit together perfectly with no gaps or overlaps.",
   resourceLabel:"YouTube: Tessellations: Shapes That Tile Without Gaps", resourceUrl:"https://www.youtube.com/results?search_query=Tessellations%3A%20Shapes%20That%20Tile%20Without%20Gaps%20grade%202%20educational",
   quiz:[
     {q:"What is a tessellation?", options:["A single shape alone","Shapes that fit together with no gaps or overlaps","A type of graph","A kind of number"], answer:1},
     {q:"Which shape can tessellate easily to cover a floor with no gaps?", options:["None of these can tessellate","A shape with curves only","Square","A random blob"], answer:2},
     {q:"Why might tessellations be used in floor tiles?", options:["They fit together perfectly with no wasted space","They cannot be repeated","They are only used once","They always leave big gaps"], answer:0},
     {q:"Which of these shapes tessellates well?", options:["A random curved blob","A triangle","An oval","A single point"], answer:1},
     {q:"A pattern with no gaps or overlaps between repeating shapes is called a ___.", options:["Perimeter","Median","Tessellation","Fraction"], answer:2}
   ]},
  {subject:"Science", title:"Spiders: Eight-Legged Predators", summary:"Grade 2 Science strand: spiders are eight-legged animals, unlike six-legged insects, that often build webs to catch prey for food.",
   resourceLabel:"YouTube: Spiders: Eight-Legged Predators", resourceUrl:"https://www.youtube.com/results?search_query=Spiders%3A%20Eight-Legged%20Predators%20grade%202%20educational",
   quiz:[
     {q:"How many legs does a spider have?", options:["Four","Ten","Six","Eight"], answer:3},
     {q:"How is a spider different from an insect?", options:["Spiders have wings, insects do not","They are exactly the same","Insects have eight legs, spiders have six","A spider has eight legs, an insect has six"], answer:3},
     {q:"What do many spiders build to catch food?", options:["A burrow","A web","A nest","A hive"], answer:1},
     {q:"What do spiders mainly eat?", options:["Only fruit","Only rocks","Insects and other small creatures","Only leaves"], answer:2},
     {q:"Spiders are classified as ___.", options:["Predators that catch prey","Fish","Plants","Birds"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Peer Mediation: Helping Classmates Solve Disagreements", summary:"Grade 2 Social Studies strand: peer mediation is when trained students help classmates talk through a disagreement calmly and find a fair solution together.",
   resourceLabel:"YouTube: Peer Mediation: Helping Classmates Solve Disagreements", resourceUrl:"https://www.youtube.com/results?search_query=Peer%20Mediation%3A%20Helping%20Classmates%20Solve%20Disagreements%20grade%202%20educational",
   quiz:[
     {q:"What is peer mediation?", options:["Ignoring a disagreement completely","A type of game","A teacher solving every problem alone","Trained students helping classmates solve disagreements"], answer:3},
     {q:"What is the goal of peer mediation?", options:["To make the disagreement worse","To avoid talking about the problem","To pick one side and ignore the other","To help both sides find a fair solution"], answer:3},
     {q:"Which skill is important for a peer mediator?", options:["Listening carefully to both sides","Ignoring both students","Choosing a side immediately","Yelling the loudest"], answer:0},
     {q:"Why might schools use peer mediation programs?", options:["Only adults can solve problems","Conflicts should never be discussed","To help students solve conflicts peacefully","It has no benefit"], answer:2},
     {q:"A successful peer mediation usually ends with ___.", options:["More arguing","One side losing completely","No resolution at all","A fair solution both sides agree on"], answer:3}
   ]},
]},
{day:130, label:"Day 130 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Word Choice, Poetry, and Reading Strategies", summary:"Grade 2 Language strand review: students revisit adjective order, using a thesaurus, foreshadowing, visualizing, free verse poetry, and asking questions while reading.",
   resourceLabel:"YouTube: Language Review: Word Choice, Poetry, and Reading Strategies", resourceUrl:"https://www.youtube.com/results?search_query=Language%20Review%3A%20Word%20Choice%2C%20Poetry%2C%20and%20Reading%20Strategies%20grade%202%20educational",
   quiz:[
     {q:"Which phrase uses correct adjective order?", options:["A red big ball","Big a red ball","A ball big red","A big red ball"], answer:3},
     {q:"What is a thesaurus used for?", options:["Finding synonyms for a word","Finding a recipe","Finding a map","Finding the weather forecast"], answer:0},
     {q:"What is foreshadowing?", options:["Hints about what will happen later in a story","The ending of a story","A characters name","The title of a book"], answer:0},
     {q:"What does it mean to visualize while reading?", options:["Only looking at illustrations","Creating a picture in your mind of the story","Ignoring the words","Skipping descriptive parts"], answer:1},
     {q:"Does free verse poetry need to rhyme?", options:["No","Only sometimes required","Yes, always","Rhyme is the only rule"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Fractions, Time, and Measurement", summary:"Grade 2 Math strand review: students revisit fractions on a number line, number bonds to 100, finding the median, AM and PM, multiplying three numbers, and tessellations.",
   resourceLabel:"YouTube: Math Review: Fractions, Time, and Measurement", resourceUrl:"https://www.youtube.com/results?search_query=Math%20Review%3A%20Fractions%2C%20Time%2C%20and%20Measurement%20grade%202%20educational",
   quiz:[
     {q:"Where would the fraction 1/2 be placed on a number line from 0 to 1?", options:["At the very end","Past the number 1","Exactly in the middle","At the very start"], answer:2},
     {q:"35 + ? = 100", options:["55","65","70","60"], answer:1},
     {q:"What is the median of the data set 2, 4, 6?", options:["2","12","6","4"], answer:3},
     {q:"If you wake up at 7:00 in the morning, is that AM or PM?", options:["PM","Both","Neither","AM"], answer:3},
     {q:"What is 2 x 3 x 2?", options:["16","10","14","12"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Animals, Plants, and Habitats", summary:"Grade 2 Science strand review: students revisit bats, reptiles and amphibians, photosynthesis, rainforest layers, polar animals, animal groups, and bioluminescence.",
   resourceLabel:"YouTube: Science Review: Animals, Plants, and Habitats", resourceUrl:"https://www.youtube.com/results?search_query=Science%20Review%3A%20Animals%2C%20Plants%2C%20and%20Habitats%20grade%202%20educational",
   quiz:[
     {q:"Are bats active mostly during the day or at night?", options:["Only at noon","Neither","Night","Day"], answer:2},
     {q:"Which of these is a reptile?", options:["Snake","Robin","Frog","Dog"], answer:0},
     {q:"What is photosynthesis?", options:["A kind of rock formation","A type of animal behaviour","A weather pattern","The process plants use to make their own food"], answer:3},
     {q:"What is the very top layer of a rainforest called?", options:["The emergent layer","The understory","The forest floor","The basement"], answer:0},
     {q:"What do we call a group of fish swimming together?", options:["A pod","A herd","A flock","A school"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Community, Symbols, and Responsibility", summary:"Grade 2 Social Studies strand review: students revisit classroom jobs, how goods travel, recycling programs, the Canadian flags history, bridges and tunnels, and peer mediation.",
   resourceLabel:"YouTube: Social Studies Review: Community, Symbols, and Responsibility", resourceUrl:"https://www.youtube.com/results?search_query=Social%20Studies%20Review%3A%20Community%2C%20Symbols%2C%20and%20Responsibility%20grade%202%20educational",
   quiz:[
     {q:"What is the purpose of classroom jobs?", options:["To share responsibility and help the classroom run smoothly","They have no purpose","Only the teacher should do all the work","To keep students from learning"], answer:0},
     {q:"Who is a producer?", options:["A kind of weather","A person or company that makes goods","A person who only buys goods","A type of animal"], answer:1},
     {q:"In what year was the current Canadian maple leaf flag adopted?", options:["1965","1812","2000","1867"], answer:0},
     {q:"What phone number do people call in an emergency in Canada?", options:["611","911","211","411"], answer:1},
...
{day:141, label:"Day 141 — Mon", subjects:[
  {subject:"Language", title:"Blends: thr, squ, and spr", summary:"Grade 2 Language strand: three-letter consonant blends like thr, squ, and spr appear at the start of words such as three, squirrel, and spring.",
   resourceLabel:"YouTube: Blends: thr, squ, and spr", resourceUrl:"https://www.youtube.com/results?search_query=Blends%3A%20thr%2C%20squ%2C%20and%20spr%20grade%202%20educational",
   quiz:[
     {q:"Which word begins with the thr blend?", options:["Three","Sun","Spring","Squirrel"], answer:0},
     {q:"Which word begins with the squ blend?", options:["Three","Sit","Spring","Squirrel"], answer:3},
     {q:"Which word begins with the spr blend?", options:["Stop","Three","Spring","Squirrel"], answer:2},
     {q:"How many letters are in a three-letter blend like spr?", options:["Four","Five","Three","Two"], answer:2},
     {q:"Which of these words has a three-letter blend?", options:["Dog","Throw","Sun","Cat"], answer:1}
   ]},
  {subject:"Math", title:"Long Division: Dividing Two-Digit Numbers by One-Digit Numbers", summary:"Grade 2 Math strand: students practise dividing a two-digit number by a one-digit number, sharing the total into equal groups.",
   resourceLabel:"YouTube: Long Division: Dividing Two-Digit Numbers by One-Digit Numbers", resourceUrl:"https://www.youtube.com/results?search_query=Long%20Division%3A%20Dividing%20Two-Digit%20Numbers%20by%20One-Digit%20Numbers%20grade%202%20educational",
   quiz:[
     {q:"What is 24 divided by 4?", options:["6","5","4","8"], answer:0},
     {q:"What is 36 divided by 6?", options:["4","5","6","7"], answer:2},
     {q:"What is 42 divided by 7?", options:["8","7","5","6"], answer:3},
     {q:"When we divide a two-digit number, we are sharing it into ___.", options:["Equal groups","One big group","Random groups","No groups"], answer:0},
     {q:"What is 48 divided by 8?", options:["5","6","8","7"], answer:1}
   ]},
  {subject:"Science", title:"Our Sense of Balance: The Inner Ear", summary:"Grade 2 Science strand: our sense of balance is controlled by a part deep inside our ear, helping us stand, walk, and stay steady without falling.",
   resourceLabel:"YouTube: Our Sense of Balance: The Inner Ear", resourceUrl:"https://www.youtube.com/results?search_query=Our%20Sense%20of%20Balance%3A%20The%20Inner%20Ear%20grade%202%20educational",
   quiz:[
     {q:"What sense helps us stand and walk without falling?", options:["Sense of smell","Sense of taste","Sense of hearing","Sense of balance"], answer:3},
     {q:"Where in our body is our sense of balance controlled?", options:["In our elbow","In our teeth","Deep inside our ear","In our hair"], answer:2},
     {q:"Which activity relies heavily on our sense of balance?", options:["Riding a bicycle","Tasting food","Smelling a flower","Listening to music"], answer:0},
     {q:"Our sense of balance helps prevent us from ___.", options:["Falling over","Tasting food","Smelling things","Hearing sounds"], answer:0},
     {q:"Why might spinning in circles make us feel dizzy?", options:["It makes our eyes change colour","It confuses the balance system in our inner ear","It stops our heart from beating","It has no effect on our body"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Our Senate: Another Part of Canadas Government", summary:"Grade 2 Social Studies strand: the Senate is part of Canadas government, made up of appointed senators who review and can suggest changes to new laws.",
   resourceLabel:"YouTube: Our Senate: Another Part of Canadas Government", resourceUrl:"https://www.youtube.com/results?search_query=Our%20Senate%3A%20Another%20Part%20of%20Canadas%20Government%20grade%202%20educational",
   quiz:[
     {q:"What is the Senate?", options:["A part of Canadas government","A city council","A sports league","A group that reviews new laws"], answer:0},
     {q:"How do people usually become senators, unlike members of Parliament?", options:["They inherit the position","They are appointed, not elected","They are elected by the public","They are chosen by a lottery"], answer:1},
     {q:"What is one job of the Senate?", options:["Coaching sports teams","Delivering mail","Running local schools","Reviewing and suggesting changes to new laws"], answer:3},
     {q:"The Senate is part of which level of government?", options:["A single citys government","The federal government","A private business","A school government"], answer:1},
     {q:"Why might it be helpful to have more than one group review a new law?", options:["It has no benefit at all","It helps catch mistakes and improve the law","It removes the need for any laws","It slows down government for no reason"], answer:1}
   ]},
]},
{day:142, label:"Day 142 — Tue", subjects:[
  {subject:"Language", title:"Text Features: Timelines", summary:"Grade 2 Language strand: a timeline is a text feature that shows events in the order they happened, often with dates along a line.",
   resourceLabel:"YouTube: Text Features: Timelines", resourceUrl:"https://www.youtube.com/results?search_query=Text%20Features%3A%20Timelines%20grade%202%20educational",
   quiz:[
     {q:"What does a timeline show?", options:["A map of a place","A recipe","Events in the order they happened","A list of characters"], answer:2},
     {q:"What is often included along a timeline?", options:["Dates","Weather","Songs","Colours"], answer:0},
     {q:"Why might an author use a timeline in a nonfiction book?", options:["To confuse the reader","To make the book shorter with less detail","To help readers understand the order of events","To remove all the facts"], answer:2},
     {q:"A timeline usually reads from ___.", options:["Earliest to latest","Top to bottom only","Random order","Latest to earliest only"], answer:0},
     {q:"Which subject might use a timeline to show important events?", options:["Singing","Colouring","Cooking only","History"], answer:3}
   ]},
  {subject:"Math", title:"Fractions: Adding Fractions with the Same Denominator", summary:"Grade 2 Math strand: to add fractions with the same denominator, we add the numerators together and keep the denominator the same.",
   resourceLabel:"YouTube: Fractions: Adding Fractions with the Same Denominator", resourceUrl:"https://www.youtube.com/results?search_query=Fractions%3A%20Adding%20Fractions%20with%20the%20Same%20Denominator%20grade%202%20educational",
   quiz:[
     {q:"What is 1/4 + 2/4?", options:["1/2","2/4","4/4","3/4"], answer:3},
     {q:"What is 2/5 + 1/5?", options:["3/5","3/10","1/5","2/10"], answer:0},
     {q:"When adding fractions with the same denominator, what stays the same?", options:["Both numbers","The numerator","The denominator","Neither number"], answer:2},
     {q:"What is 3/8 + 2/8?", options:["5/8","1/8","5/16","6/8"], answer:0},
     {q:"What is 1/6 + 3/6?", options:["3/6","4/12","4/6","2/6"], answer:2}
   ]},
  {subject:"Science", title:"Density: Why Some Things Float Higher Than Others", summary:"Grade 2 Science strand: density describes how tightly packed the matter in an object is, and it helps explain why some objects float higher or sink faster than others.",
   resourceLabel:"YouTube: Density: Why Some Things Float Higher Than Others", resourceUrl:"https://www.youtube.com/results?search_query=Density%3A%20Why%20Some%20Things%20Float%20Higher%20Than%20Others%20grade%202%20educational",
   quiz:[
     {q:"What does density describe?", options:["The colour of an object","The sound an object makes","How tightly packed matter is in an object","The taste of an object"], answer:2},
     {q:"Which object would likely have higher density, a rock or a feather of the same size?", options:["They are always equal","Neither has density","A rock","A feather"], answer:2},
     {q:"Why might one object float higher in water than another?", options:["It is a different colour","It has a higher density","It has a lower density","It makes more noise"], answer:2},
     {q:"What happens to an object with very high density when placed in water?", options:["It disappears","It is more likely to sink","It always floats on top","It changes colour"], answer:1},
     {q:"Understanding density helps scientists explain why ships made of metal can still ___.", options:["Float","Disappear","Change shape","Sink immediately"], answer:0}
   ]},
  {subject:"SocialStudies", title:"The Order of Canada: Honouring Outstanding Canadians", summary:"Grade 2 Social Studies strand: the Order of Canada is a special honour given to Canadians who have made an outstanding contribution to their community or country.",
   resourceLabel:"YouTube: The Order of Canada: Honouring Outstanding Canadians", resourceUrl:"https://www.youtube.com/results?search_query=The%20Order%20of%20Canada%3A%20Honouring%20Outstanding%20Canadians%20grade%202%20educational",
   quiz:[
     {q:"What is the Order of Canada?", options:["A type of holiday","A kind of coin","A sports league","A special honour for outstanding Canadians"], answer:3},
     {q:"Who might receive the Order of Canada?", options:["Someone who made an outstanding contribution","Only politicians","Anyone chosen at random","Only professional athletes"], answer:0},
     {q:"Why does Canada give out this kind of honour?", options:["It has no purpose","To recognize people who have helped their community or country","To give away free prizes","To replace elections"], answer:1},
     {q:"The Order of Canada could be given to someone who worked in ___.", options:["Only professional sports","Many different fields, like science or the arts","No particular field","Only one specific job"], answer:1},
     {q:"Recognizing outstanding Canadians can help inspire others to ___.", options:["Avoid working hard","Ignore their community","Make a positive difference too","Stop trying to help others"], answer:2}
   ]},
]},
{day:143, label:"Day 143 — Wed", subjects:[
  {subject:"Language", title:"Writing an Invitation: Sharing Details Clearly", summary:"Grade 2 Language strand: an invitation shares important details about an event, like the date, time, and place, so people know how to join.",
   resourceLabel:"YouTube: Writing an Invitation: Sharing Details Clearly", resourceUrl:"https://www.youtube.com/results?search_query=Writing%20an%20Invitation%3A%20Sharing%20Details%20Clearly%20grade%202%20educational",
   quiz:[
     {q:"What is the purpose of an invitation?", options:["To tell a made-up story","To list facts about animals","To give a weather report","To share details about an event"], answer:3},
     {q:"Which detail should always be included in an invitation?", options:["A grocery list","The date and time of the event","A random riddle","A weather forecast"], answer:1},
     {q:"Why is it important for an invitation to be clear?", options:["So people know exactly how to join the event","To make the event a surprise from everyone","Clarity does not matter for invitations","To confuse the reader on purpose"], answer:0},
     {q:"Which of these might also appear on an invitation?", options:["A weather forecast for another country","A math equation","The location of the event","A recipe for soup"], answer:2},
     {q:"An invitation is an example of writing that is meant to ___.", options:["Describe a scientific process","Entertain with a made-up story","Inform people about an event","Persuade someone to buy something"], answer:2}
   ]},
  {subject:"Math", title:"Data: Stem-and-Leaf Plots", summary:"Grade 2 Math strand: a stem-and-leaf plot organizes numbers by splitting each one into a stem, the larger digits, and a leaf, the last digit.",
   resourceLabel:"YouTube: Data: Stem-and-Leaf Plots", resourceUrl:"https://www.youtube.com/results?search_query=Data%3A%20Stem-and-Leaf%20Plots%20grade%202%20educational",
   quiz:[
     {q:"What does a stem-and-leaf plot organize?", options:["Numbers, split into stems and leaves","Letters","Colours","Shapes"], answer:0},
     {q:"In the number 23, what would the stem usually be?", options:["3","2","0","23"], answer:1},
     {q:"In the number 23, what would the leaf usually be?", options:["0","3","23","2"], answer:1},
     {q:"Why might we use a stem-and-leaf plot instead of a list of numbers?", options:["It only works with letters","It helps organize data so it is easier to read","It removes the need for numbers","It hides the numbers completely"], answer:1},
     {q:"A stem-and-leaf plot is a way to organize and display ___.", options:["Weather patterns","Data","Colours","Story characters"], answer:1}
   ]},
  {subject:"Science", title:"Nuclear Energy: Power from Atoms", summary:"Grade 2 Science strand: nuclear energy is a powerful form of energy that comes from splitting tiny particles called atoms, and it can be used to make electricity.",
   resourceLabel:"YouTube: Nuclear Energy: Power from Atoms", resourceUrl:"https://www.youtube.com/results?search_query=Nuclear%20Energy%3A%20Power%20from%20Atoms%20grade%202%20educational",
   quiz:[
     {q:"What does nuclear energy come from?", options:["Burning wood","Wind blowing","Splitting tiny particles called atoms","Sunlight only"], answer:2},
     {q:"What can nuclear energy be used to make?", options:["Rain","Electricity","Rocks","Wind"], answer:1},
     {q:"What are the tiny particles split to release nuclear energy called?", options:["Rocks","Atoms","Molecules of water only","Cells"], answer:1},
     {q:"Nuclear energy is considered a powerful source of ___.", options:["Water","Food","Energy","Sound"], answer:2},
     {q:"Why do scientists and engineers need to be very careful when working with nuclear energy?", options:["Because it is a very powerful form of energy","Because it only works on cloudy days","Because it is the same as solar energy","Because it has no power at all"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Our School Board: Supporting Many Schools", summary:"Grade 2 Social Studies strand: a school board oversees many schools in an area, helping make decisions about education for a whole region.",
   resourceLabel:"YouTube: Our School Board: Supporting Many Schools", resourceUrl:"https://www.youtube.com/results?search_query=Our%20School%20Board%3A%20Supporting%20Many%20Schools%20grade%202%20educational",
   quiz:[
     {q:"What does a school board oversee?", options:["Only school buses","Only sports teams","Just one single classroom","Many schools in an area"], answer:3},
     ...
     {q:"Why is a school board an important part of education?", options:["It replaces teachers completely","It helps make decisions that support many schools","It only decides lunch menus","It has no role in education"], answer:1},
     {q:"Which of these might a school board help decide?", options:["How schools in the area are run","Personal weekend plans for families","The colour of every students shoes","What every student eats for breakfast at home"], answer:0},
     {q:"A school board works to support ___ across a region.", options:["Only sports","Only art class","Education","Nothing important"], answer:2}
   ]},
]},
{day:144, label:"Day 144 — Thu", subjects:[
  {subject:"Language", title:"Persuasive Techniques: Loaded Words and Bandwagon Appeals", summary:"Grade 2 Language strand: persuasive writers sometimes use loaded words, which carry strong feelings, or bandwagon appeals, which suggest everyone else agrees, to convince readers.",
   resourceLabel:"YouTube: Persuasive Techniques: Loaded Words and Bandwagon Appeals", resourceUrl:"https://www.youtube.com/results?search_query=Persuasive%20Techniques%3A%20Loaded%20Words%20and%20Bandwagon%20Appeals%20grade%202%20educational",
   quiz:[
     {q:"What are loaded words?", options:["Words that carry strong feelings","Words that rhyme","Words that are always true","Words with no meaning"], answer:0},
     {q:"What is a bandwagon appeal?", options:["A type of song","A math strategy","A type of vehicle","Suggesting everyone else agrees, so you should too"], answer:3},
     {q:"Why might a writer use these persuasive techniques?", options:["To confuse the reader on purpose","To avoid persuading anyone","To try to convince readers to agree with them","To share only true facts with no opinion"], answer:2},
     {q:"Which is an example of a bandwagon appeal?", options:["The sky is blue","Two plus two equals four","Water freezes at zero degrees","Everyone is choosing this, so you should too"], answer:3},
     {q:"Recognizing persuasive techniques helps readers think ___ about what they read.", options:["Only about the title","Without any thought","Carefully and critically","Only about the pictures"], answer:2}
   ]},
  {subject:"Math", title:"Geometry: Classifying Triangles by Sides and Angles", summary:"Grade 2 Math strand: triangles can be classified by their sides, like equilateral or scalene, or by their angles, like right or obtuse.",
   resourceLabel:"YouTube: Geometry: Classifying Triangles by Sides and Angles", resourceUrl:"https://www.youtube.com/results?search_query=Geometry%3A%20Classifying%20Triangles%20by%20Sides%20and%20Angles%20grade%202%20educational",
   quiz:[
     {q:"What is a triangle with three equal sides called?", options:["Isosceles","Obtuse","Equilateral","Scalene"], answer:2},
     {q:"What is a triangle with no equal sides called?", options:["Scalene","Isosceles","Equilateral","Right"], answer:0},
     {q:"What is a triangle with one 90 degree angle called?", options:["An equilateral triangle","An obtuse triangle","A scalene triangle","A right triangle"], answer:3},
     {q:"How many sides does every triangle have?", options:["4","2","3","5"], answer:2},
     {q:"Classifying shapes by their sides and angles helps us understand their ___.", options:["Weight","Colour","Smell","Properties"], answer:3}
   ]},
  {subject:"Science", title:"Animal Tracks: Reading Footprints in Snow and Mud", summary:"Grade 2 Science strand: many animals leave tracks, or footprints, in snow or mud, and scientists can study the shape and pattern of tracks to identify which animal made them.",
   resourceLabel:"YouTube: Animal Tracks: Reading Footprints in Snow and Mud", resourceUrl:"https://www.youtube.com/results?search_query=Animal%20Tracks%3A%20Reading%20Footprints%20in%20Snow%20and%20Mud%20grade%202%20educational",
   quiz:[
     {q:"What are animal tracks?", options:["Footprints animals leave behind","A sound animals make","A type of animal food","A kind of nest"], answer:0},
     {q:"Where can animal tracks often be seen most clearly?", options:["In the middle of the ocean","On a sunny sidewalk","In snow or soft mud","In the sky"], answer:2},
     {q:"How can scientists use the shape of a track?", options:["To tell the animals favourite colour","To predict the weather","To calculate the animals age exactly","To help identify which animal made it"], answer:3},
     {q:"Which of these might leave visible tracks in snow?", options:["A whale","A goldfish","A rabbit","A jellyfish"], answer:2},
     {q:"Studying animal tracks is one way scientists learn about animals without ___.", options:["Any effort at all","Using their eyes","Leaving their home","Seeing the animal directly"], answer:3}
   ]},
  {subject:"SocialStudies", title:"World Currency: Comparing Money From Different Countries", summary:"Grade 2 Social Studies strand: different countries use different kinds of money, called currency, and comparing currencies helps us understand how trade and travel work around the world.",
   resourceLabel:"YouTube: World Currency: Comparing Money From Different Countries", resourceUrl:"https://www.youtube.com/results?search_query=World%20Currency%3A%20Comparing%20Money%20From%20Different%20Countries%20grade%202%20educational",
   quiz:[
     {q:"What is the money used by a country called?", options:["Currency","Symbol","Anthem","Language"], answer:0},
     {q:"Do all countries around the world use the exact same currency?", options:["Only Canada uses money","Yes, every country uses the same money","Money is not used anywhere","No, different countries use different currency"], answer:3},
     {q:"Why might a traveller need to exchange money when visiting another country?", options:["Currency is only used in stores","Money never changes anywhere","All countries ban money","Because that country uses a different currency"], answer:3},
     {q:"Comparing currencies from different countries can help us understand ___.", options:["Only colours","Only shapes","Trade and travel around the world","Nothing important"], answer:2},
     {q:"Which of these is an example of a countrys currency?", options:["A national anthem","The Canadian dollar","A national flag","A national bird"], answer:1}
   ]},
]},
{day:145, label:"Day 145 — Fri", subjects:[
  {subject:"Language", title:"Reading Strategy: Setting a Purpose Before Reading", summary:"Grade 2 Language strand: setting a purpose before reading means thinking about why we are reading something, such as to learn facts or to enjoy a story.",
   resourceLabel:"YouTube: Reading Strategy: Setting a Purpose Before Reading", resourceUrl:"https://www.youtube.com/results?search_query=Reading%20Strategy%3A%20Setting%20a%20Purpose%20Before%20Reading%20grade%202%20educational",
   quiz:[
     {q:"What does it mean to set a purpose before reading?", options:["Thinking about why we are reading something","Ignoring the title and cover","Skipping the whole book without reading","Reading with no thought at all"], answer:0},
     {q:"Which is an example of a purpose for reading?", options:["Reading a book upside down","Reading to learn facts about animals","Reading without opening the book","Reading with your eyes closed"], answer:1},
     {q:"Why is it helpful to set a purpose before reading?", options:["It makes reading pointless","It has no benefit at all","It prevents us from understanding the text","It helps us focus on the most important parts"], answer:3},
     {q:"If your purpose is to learn facts, which kind of book would you likely choose?", options:["A fictional fairy tale","A nonfiction book","A joke book","A blank notebook"], answer:1},
     {q:"Setting a purpose before reading is a strategy that helps improve our ___.", options:["Handwriting","Ability to ignore the text","Drawing skills","Understanding of the text"], answer:3}
   ]},
  {subject:"Math", title:"Time: Solving Elapsed Time Word Problems", summary:"Grade 2 Math strand: elapsed time word problems ask us to figure out how much time has passed between a start time and an end time.",
   resourceLabel:"YouTube: Time: Solving Elapsed Time Word Problems", resourceUrl:"https://www.youtube.com/results?search_query=Time%3A%20Solving%20Elapsed%20Time%20Word%20Problems%20grade%202%20educational",
   quiz:[
     {q:"If a movie starts at 2:00 and ends at 4:00, how much time passed?", options:["3 hours","2 hours","1 hour","4 hours"], answer:1},
     {q:"If recess starts at 10:15 and ends at 10:30, how many minutes passed?", options:["20 minutes","5 minutes","15 minutes","10 minutes"], answer:2},
     {q:"What do we call the amount of time that passes between a start and end time?", options:["Elapsed time","End time","Start time","No time"], answer:0},
     {q:"If school starts at 9:00 and ends at 3:00, how many hours is that?", options:["6 hours","7 hours","5 hours","4 hours"], answer:0},
     {q:"To solve an elapsed time problem, we need to know the ___.", options:["Neither time","Only the end time","Only the start time","Start time and end time"], answer:3}
   ]},
  {subject:"Science", title:"Vaccines: Helping Our Body Fight Disease", summary:"Grade 2 Science strand: vaccines help our immune system learn to recognize and fight off certain diseases before we ever get sick from them.",
   resourceLabel:"YouTube: Vaccines: Helping Our Body Fight Disease", resourceUrl:"https://www.youtube.com/results?search_query=Vaccines%3A%20Helping%20Our%20Body%20Fight%20Disease%20grade%202%20educational",
   quiz:[
     {q:"What do vaccines help our body do?", options:["Hear better","Recognize and fight off certain diseases","Grow taller","See better"], answer:1},
     {q:"Which body system do vaccines work with?", options:["The circulatory system only","The digestive system","The skeletal system","The immune system"], answer:3},
     {q:"Why might someone get a vaccine before they are sick?", options:["So their body can learn to fight the disease ahead of time","To make someone sick on purpose","Vaccines only work after someone is already sick","Vaccines have no effect at all"], answer:0},
     {q:"Vaccines are an example of how science helps us stay ___.", options:["Confused","Unaware","Unwell","Healthy"], answer:3},
     {q:"Which of these best describes what a vaccine does over time?", options:["Removes the immune system completely","Makes the body forget how to fight disease","Has no connection to the immune system","Helps the immune system remember how to fight a disease"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Land Acknowledgements: Respecting Indigenous Territory", summary:"Grade 2 Social Studies strand: a land acknowledgement is a respectful statement recognizing that a place was, and often still is, the traditional territory of Indigenous peoples.",
   resourceLabel:"YouTube: Land Acknowledgements: Respecting Indigenous Territory", resourceUrl:"https://www.youtube.com/results?search_query=Land%20Acknowledgements%3A%20Respecting%20Indigenous%20Territory%20grade%202%20educational",
   quiz:[
     {q:"What is a land acknowledgement?", options:["A respectful statement about Indigenous territory","A type of map","A kind of song","A weather report"], answer:0},
     {q:"What does a land acknowledgement recognize?", options:["That a place was, and still is, Indigenous territory","A sports team","A random fact about weather","A type of food"], answer:0},
     {q:"Where might you hear a land acknowledgement given?", options:["At the start of a school assembly or event","Never anywhere","Only in outer space","Only in other countries"], answer:0},
     {q:"Why do communities share land acknowledgements?", options:["They have no meaning at all","To replace all history lessons","To ignore Indigenous history","To show respect for Indigenous peoples and their history"], answer:3},
     {q:"A land acknowledgement is one way people can show ___.", options:["Respect and awareness","Disrespect","Confusion","Carelessness"], answer:0}
   ]},
]},
{day:146, label:"Day 146 — Mon", subjects:[
  {subject:"Language", title:"Story Structure: Rising Action and Climax", summary:"Grade 2 Language strand: rising action is the part of a story where excitement builds, leading up to the climax, the most exciting or important moment of the story.",
   resourceLabel:"YouTube: Story Structure: Rising Action and Climax", resourceUrl:"https://www.youtube.com/results?search_query=Story%20Structure%3A%20Rising%20Action%20and%20Climax%20grade%202%20educational",
   quiz:[
     {q:"What is rising action?", options:["The very beginning of a story","The back cover of a book","The part of a story where excitement builds","The title of a story"], answer:2},
     {q:"What is the climax of a story?", options:["The list of characters","The books price","The first sentence","The most exciting or important moment"], answer:3},
     {q:"Does rising action happen before or after the climax?", options:["Before","At the very end","After","It never happens"], answer:0},
     {q:"Why is rising action important in a story?", options:["It builds excitement leading to the climax","It removes the main problem","It always comes after the ending","It has no purpose in a story"], answer:0},
     {q:"Which of these describes the climax of a story?", options:["The most tense or exciting turning point","The dedication page","The table of contents","The very first page"], answer:0}
   ]},
  {subject:"Math", title:"Money: Making Change from Five and Ten Dollar Bills", summary:"Grade 2 Math strand: students practise figuring out how much change to give back when someone pays with a five or ten dollar bill.",
   resourceLabel:"YouTube: Money: Making Change from Five and Ten Dollar Bills", resourceUrl:"https://www.youtube.com/results?search_query=Money%3A%20Making%20Change%20from%20Five%20and%20Ten%20Dollar%20Bills%20grade%202%20educational",
   quiz:[
     {q:"If something costs 3 dollars and you pay with a 5 dollar bill, how much change do you get?", options:["3 dollars","1 dollar","4 dollars","2 dollars"], answer:3},
     {q:"If something costs 7 dollars and you pay with a 10 dollar bill, how much change do you get?", options:["4 dollars","3 dollars","2 dollars","5 dollars"], answer:1},
     {q:"If something costs 4 dollars and you pay with a 5 dollar bill, how much change do you get?", options:["2 dollars","3 dollars","1 dollar","4 dollars"], answer:2},
     {q:"Making change correctly is important because it makes sure a purchase is ___.", options:["Unfair","Fair and accurate","Confusing","Impossible"], answer:1},
     {q:"If something costs 6 dollars and you pay with a 10 dollar bill, how much change do you get?", options:["2 dollars","5 dollars","4 dollars","3 dollars"], answer:2}
   ]},
  {subject:"Science", title:"Desert Plants: Cacti and Succulents", summary:"Grade 2 Science strand: desert plants like cacti and succulents store water in their thick stems and leaves so they can survive long periods without rain.",
   resourceLabel:"YouTube: Desert Plants: Cacti and Succulents", resourceUrl:"https://www.youtube.com/results?search_query=Desert%20Plants%3A%20Cacti%20and%20Succulents%20grade%202%20educational",
   quiz:[
     {q:"What do cacti and succulents store water in?", options:["The clouds","The air around them","The wind","Their thick stems and leaves"], answer:3},
     {q:"Why do desert plants need to store water?", options:["They never need water","To grow taller instantly","To survive long periods without rain","To change colour"], answer:2},
     {q:"What is a cactus an example of?", options:["An ocean animal","A desert plant","A type of rock","A rainforest tree"], answer:1},
     {q:"Which feature helps some desert plants avoid losing too much water?", options:["Constant rainfall","Thick, waxy skin","No leaves and no stem at all","Thin, papery leaves"], answer:1},
     {q:"Desert plants like cacti are well adapted to living in a place that is usually ___.", options:["Covered in snow","Underwater","Hot and dry","Cold and wet"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Our Provincial Legislature: Where Laws Are Made", summary:"Grade 2 Social Studies strand: the provincial legislature is a building where elected leaders meet to discuss and create laws for the province.",
   resourceLabel:"YouTube: Our Provincial Legislature: Where Laws Are Made", resourceUrl:"https://www.youtube.com/results?search_query=Our%20Provincial%20Legislature%3A%20Where%20Laws%20Are%20Made%20grade%202%20educational",
   quiz:[
     {q:"What happens at a provincial legislature?", options:["Movies are shown to visitors","Food is sold to the public","Elected leaders discuss and create laws","Students take a math test"], answer:2},
     {q:"Who works at a provincial legislature?", options:["Elected leaders, including the premier","Only firefighters","Only doctors","Only bus drivers"], answer:0},
     {q:"Why is a provincial legislature an important building?", options:["Important laws and decisions are made there","It has no real purpose","It is only used for sports games","It is closed at all times"], answer:0},
     ...
     {q:"A provincial legislature helps a province by creating ___.", options:["Only weather forecasts","Nothing useful","Laws and important decisions","Only sports schedules"], answer:2}
   ]},
]},
{day:147, label:"Day 147 — Tue", subjects:[
  {subject:"Language", title:"Word Choice: Vivid Verbs Instead of Said", summary:"Grade 2 Language strand: writers can replace the word said with more vivid verbs, like whispered, shouted, or exclaimed, to show more about how a character speaks.",
   resourceLabel:"YouTube: Word Choice: Vivid Verbs Instead of Said", resourceUrl:"https://www.youtube.com/results?search_query=Word%20Choice%3A%20Vivid%20Verbs%20Instead%20of%20Said%20grade%202%20educational",
   quiz:[
     {q:"What is a vivid verb?", options:["A word with no meaning","A type of punctuation","A type of noun","A specific, descriptive action word"], answer:3},
     {q:"Which of these is a vivid verb that could replace said?", options:["And","The","Very","Whispered"], answer:3},
     {q:"Why might a writer choose whispered instead of said?", options:["It confuses the reader on purpose","It has the exact same meaning with no extra detail","It removes all dialogue from the story","It shows more about how the character spoke"], answer:3},
     {q:"Which sentence uses a vivid verb?", options:["She spoke","She said something","She shouted with excitement","She talked"], answer:2},
     {q:"Using vivid verbs instead of plain words helps make writing more ___.", options:["Confusing","Interesting and descriptive","Short with no detail","Boring"], answer:1}
   ]},
  {subject:"Math", title:"Number Patterns: Patterns in the Multiplication Table", summary:"Grade 2 Math strand: students look for patterns in the multiplication table, such as how the 2s row is always even, or how rows and columns mirror each other.",
   resourceLabel:"YouTube: Number Patterns: Patterns in the Multiplication Table", resourceUrl:"https://www.youtube.com/results?search_query=Number%20Patterns%3A%20Patterns%20in%20the%20Multiplication%20Table%20grade%202%20educational",
   quiz:[
     {q:"Are the numbers in the 2 times table always even or always odd?", options:["Neither even nor odd","Sometimes even and sometimes odd","Always even","Always odd"], answer:2},
     {q:"In a multiplication table, the 3 row and the 3 column contain ___.", options:["Completely different numbers","The same set of numbers","Only the number 3","Only odd numbers"], answer:1},
     {q:"Why might noticing patterns in a multiplication table be helpful?", options:["It only works for addition","It has no use at all","It makes multiplication impossible to learn","It helps us remember multiplication facts more easily"], answer:3},
     {q:"What pattern can you find in the 10 times table?", options:["There is no pattern at all","Every answer is odd","Every answer ends in a zero","Every answer is the same number"], answer:2},
     {q:"Looking for patterns in math helps us become better at ___.", options:["Solving problems","Drawing pictures","Singing songs","Spelling words"], answer:0}
   ]},
  {subject:"Science", title:"Ice Ages: When Earth Was Covered in Ice", summary:"Grade 2 Science strand: an ice age is a long period of time when much of the Earth was covered by thick sheets of ice called glaciers.",
   resourceLabel:"YouTube: Ice Ages: When Earth Was Covered in Ice", resourceUrl:"https://www.youtube.com/results?search_query=Ice%20Ages%3A%20When%20Earth%20Was%20Covered%20in%20Ice%20grade%202%20educational",
   quiz:[
     {q:"What is an ice age?", options:["A long period when much of Earth was covered in ice","A single cold day","A type of animal","A kind of rock"], answer:0},
     {q:"What covered much of the Earth during an ice age?", options:["Sand and desert","Rainforest trees","Thick sheets of ice called glaciers","Warm ocean water"], answer:2},
     {q:"How long did ice ages usually last?", options:["A few minutes","A very long period of time","One hour","Just one single day"], answer:1},
     {q:"What can scientists study to learn about past ice ages?", options:["Nothing at all","Fossils and layers of ice or rock","Only modern buildings","Only todays weather"], answer:1},
     {q:"Ice ages remind us that Earths climate has ___ over a very long time.", options:["Disappeared completely","Never changed","Stayed exactly the same forever","Changed"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Our School Yearbook: Remembering the School Year", summary:"Grade 2 Social Studies strand: a school yearbook is a book filled with photos and memories that helps students remember their school year.",
   resourceLabel:"YouTube: Our School Yearbook: Remembering the School Year", resourceUrl:"https://www.youtube.com/results?search_query=Our%20School%20Yearbook%3A%20Remembering%20the%20School%20Year%20grade%202%20educational",
   quiz:[
     ...
     {q:"Why might a school create a yearbook?", options:["To replace all textbooks","To confuse students","It has no real purpose","To help students remember the school year"], answer:3},
     ...
     {q:"Yearbooks are usually created ___ during the school year.", options:["Once, near the end","Every single day","Only in summer","Never"], answer:0}
   ]},
]},
{day:148, label:"Day 148 — Wed", subjects:[
  {subject:"Language", title:"Compound-Complex Sentences: Combining Three Ideas", summary:"Grade 2 Language strand: a compound-complex sentence combines two complete ideas with a joining word, plus an extra dependent idea, all in one sentence.",
   resourceLabel:"YouTube: Compound-Complex Sentences: Combining Three Ideas", resourceUrl:"https://www.youtube.com/results?search_query=Compound-Complex%20Sentences%3A%20Combining%20Three%20Ideas%20grade%202%20educational",
   quiz:[
     {q:"What does a compound-complex sentence combine?", options:["Only a single word","No punctuation at all","Two complete ideas and an extra dependent idea","Only a title"], answer:2},
     {q:"Why might a writer choose to use a compound-complex sentence?", options:["To remove all meaning from the sentence","To confuse the reader on purpose","To make the sentence disappear","To smoothly combine multiple related ideas"], answer:3},
     {q:"Which of these is a feature of a compound-complex sentence?", options:["It cannot have any punctuation","It never has a verb","It joins more than one complete idea together","It is always exactly one word"], answer:2},
     {q:"A compound-complex sentence is generally ___ than a simple sentence.", options:["Exactly the same length","Impossible to write","Longer and more detailed","Always shorter"], answer:2},
     {q:"Combining ideas smoothly in a sentence can help make writing feel more ___.", options:["Confusing","Connected and clear","Choppy and broken","Meaningless"], answer:1}
   ]},
  {subject:"Math", title:"Measurement: Converting Grams to Kilograms", summary:"Grade 2 Math strand: students learn that 1000 grams equal 1 kilogram, and practise converting between the two units.",
   resourceLabel:"YouTube: Measurement: Converting Grams to Kilograms", resourceUrl:"https://www.youtube.com/results?search_query=Measurement%3A%20Converting%20Grams%20to%20Kilograms%20grade%202%20educational",
   quiz:[
     {q:"How many grams are in one kilogram?", options:["10","10000","1000","100"], answer:2},
     {q:"If something weighs 2000 grams, how many kilograms is that?", options:["1","2","20","3"], answer:1},
     {q:"Which unit would we usually use to weigh a small paperclip?", options:["Metres","Grams","Kilograms","Litres"], answer:1},
     {q:"Which unit would we usually use to weigh a large bag of rice?", options:["Grams only","Millilitres","Centimetres","Kilograms"], answer:3},
     {q:"Knowing that 1000 grams equal 1 kilogram helps us ___ between units.", options:["Erase","Convert","Ignore","Confuse"], answer:1}
   ]},
  {subject:"Science", title:"Beavers: Natures Engineers", summary:"Grade 2 Science strand: beavers are known as natures engineers because they build dams and lodges using trees, branches, and mud to change their habitat.",
   resourceLabel:"YouTube: Beavers: Natures Engineers", resourceUrl:"https://www.youtube.com/results?search_query=Beavers%3A%20Natures%20Engineers%20grade%202%20educational",
   quiz:[
     {q:"Why are beavers sometimes called natures engineers?", options:["They fly through the air","They build dams and lodges to change their habitat","They cannot swim","They live only in trees"], answer:1},
     {q:"What materials do beavers use to build a dam?", options:["Trees, branches, and mud","Ice only","Sand only","Rocks only"], answer:0},
     {q:"What does a beaver dam do to a habitat?", options:["Destroys all nearby plants instantly","Has no effect on the habitat","Changes the flow of water, often creating a pond","Turns the area into a desert"], answer:2},
     {q:"What body part helps a beaver cut down trees?", options:["Its nose","Its claws only","Its tail","Its strong front teeth"], answer:3},
     {q:"Beavers changing their habitat by building dams is an example of ___.", options:["A type of weather","A type of rock formation","An animal shaping its environment","An animal with no effect on nature"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Canadian Lighthouses: Guiding Ships Safely", summary:"Grade 2 Social Studies strand: lighthouses along Canadas coasts use bright lights to help guide ships safely and warn them away from rocky shores.",
   resourceLabel:"YouTube: Canadian Lighthouses: Guiding Ships Safely", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Lighthouses%3A%20Guiding%20Ships%20Safely%20grade%202%20educational",
   quiz:[
     {q:"What is the main purpose of a lighthouse?", options:["To grow crops","To collect rainwater","To provide housing for fish","To help guide ships safely"], answer:3},
     {q:"What do lighthouses use to help guide ships?", options:["Loud music","Colourful flags only","Smoke signals only","A bright light"], answer:3},
     {q:"Where are lighthouses usually built?", options:["On top of a mountain far from water","In the middle of a city","Inside a forest","Along coasts, near rocky shores or harbours"], answer:3},
     {q:"Why might a lighthouse warn ships away from certain areas?", options:["To help ships avoid dangerous rocky shores","To confuse sailors on purpose","Lighthouses have no real purpose","To stop all ships from ever sailing"], answer:0},
     {q:"Lighthouses are an important part of keeping people who travel by ___ safe.", options:["Water","Land only","Air","Space"], answer:0}
   ]},
]},
{day:149, label:"Day 149 — Thu", subjects:[
  {subject:"Language", title:"Graphic Organizers: Mapping Out Our Ideas", summary:"Grade 2 Language strand: a graphic organizer is a visual tool, like a web or a chart, that helps writers plan and organize their ideas before writing.",
   resourceLabel:"YouTube: Graphic Organizers: Mapping Out Our Ideas", resourceUrl:"https://www.youtube.com/results?search_query=Graphic%20Organizers%3A%20Mapping%20Out%20Our%20Ideas%20grade%202%20educational",
   quiz:[
     {q:"What is a graphic organizer?", options:["A punctuation mark","A visual tool for planning and organizing ideas","A type of made-up story","A math equation"], answer:1},
     {q:"Why might a writer use a graphic organizer before writing?", options:["To skip planning entirely","To remove all their ideas completely","To plan and organize their ideas clearly","To make writing more confusing"], answer:2},
     {q:"Which of these is an example of a graphic organizer?", options:["A grocery list with no structure","A single random word","A blank page with nothing on it","A web with connected ideas"], answer:3},
     {q:"A graphic organizer can help a writer see how their ideas ___.", options:["Have no relationship at all","Connect to each other","Disappear completely","Cannot be organized"], answer:1},
     {q:"Using a graphic organizer before writing is a helpful step in the writing ___.", options:["Font","Process","Ending","Title"], answer:1}
   ]},
  {subject:"Math", title:"Coordinate Grids: Plotting Points on a Grid", summary:"Grade 2 Math strand: students learn to plot points on a coordinate grid using two numbers, moving across and then up to find the exact spot.",
   resourceLabel:"YouTube: Coordinate Grids: Plotting Points on a Grid", resourceUrl:"https://www.youtube.com/results?search_query=Coordinate%20Grids%3A%20Plotting%20Points%20on%20a%20Grid%20grade%202%20educational",
   quiz:[
     {q:"What two numbers are used to plot a point on a coordinate grid?", options:["A horizontal number and a vertical number","No numbers at all","Three numbers","Only one number"], answer:0},
     {q:"Which direction do we usually move first when plotting a point on a grid?", options:["Across, then up","Up, then across","We never move","Diagonally only"], answer:0},
     {q:"Why are coordinate grids useful in math?", options:["They remove the need for numbers","They have no real use","They only work with letters","They help us find an exact location"], answer:3},
     {q:"A coordinate grid is made up of a horizontal line and a ___ line.", options:["Dotted","Diagonal","Curved","Vertical"], answer:3},
     {q:"Plotting points on a grid can help us create simple ___.", options:["Recipes","Songs","Stories with no numbers","Maps or pictures"], answer:3}
   ]},
  {subject:"Science", title:"Wetlands: A Habitat Between Land and Water", summary:"Grade 2 Science strand: a wetland is a special habitat where the land is covered by shallow water for at least part of the year, supporting many plants and animals.",
   resourceLabel:"YouTube: Wetlands: A Habitat Between Land and Water", resourceUrl:"https://www.youtube.com/results?search_query=Wetlands%3A%20A%20Habitat%20Between%20Land%20and%20Water%20grade%202%20educational",
   quiz:[
     {q:"What is a wetland?", options:["A habitat where land is covered by shallow water","A frozen glacier","A tall mountain","A dry desert"], answer:0},
     {q:"What kind of living things does a wetland often support?", options:["Many plants and animals","No living things at all","Only sand","Only rocks"], answer:0},
     {q:"Why are wetlands considered an important type of habitat?", options:["They cannot support any life","They have no living things in them","They support a wide variety of plants and animals","They are always completely dry"], answer:2},
     {q:"Which of these might you find living in a wetland?", options:["Polar bears","Frogs and ducks","Cactus plants","Camels"], answer:1},
     {q:"A wetland is a habitat found between ___.", options:["Land and water","Ice and fire","Sky and space","Rock and sand only"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Our Local Fire Hall: Where Firefighters Prepare", summary:"Grade 2 Social Studies strand: the local fire hall is where firefighters keep their trucks and equipment ready and train so they can respond quickly to emergencies.",
   resourceLabel:"YouTube: Our Local Fire Hall: Where Firefighters Prepare", resourceUrl:"https://www.youtube.com/results?search_query=Our%20Local%20Fire%20Hall%3A%20Where%20Firefighters%20Prepare%20grade%202%20educational",
   quiz:[
     {q:"What do firefighters keep ready at the fire hall?", options:["Only toys","Their trucks and equipment","Only food","Only books"], answer:1},
     {q:"Why do firefighters train regularly at the fire hall?", options:["To make emergencies happen more often","To avoid ever helping anyone","Training has no purpose for firefighters","So they can respond quickly to emergencies"], answer:3},
     {q:"What is the main purpose of a fire hall?", options:["To show movies to the public","To be a base where firefighters prepare and respond from","To teach math classes","To sell groceries"], answer:1},
     {q:"Which of these might be found inside a fire hall?", options:["A movie theatre","A fire truck","A shopping mall","A swimming pool"], answer:1},
     {q:"Having a well prepared fire hall helps keep a community ___.", options:["Unaware of emergencies","Less prepared","More confused","Safer"], answer:3}
   ]},
]},
{day:150, label:"Day 150 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Text Features, Persuasion, and Sentence Craft", summary:"Grade 2 Language strand review: students revisit three-letter blends, timelines, invitations, persuasive techniques, story structure, vivid verbs, compound-complex sentences, and graphic organizers.",
   resourceLabel:"YouTube: Language Review: Text Features, Persuasion, and Sentence Craft", resourceUrl:"https://www.youtube.com/results?search_query=Language%20Review%3A%20Text%20Features%2C%20Persuasion%2C%20and%20Sentence%20Craft%20grade%202%20educational",
   quiz:[
     {q:"Which word begins with the thr blend?", options:["Spring","Sun","Squirrel","Three"], answer:3},
     {q:"What does a timeline show?", options:["A recipe","A list of characters","A map of a place","Events in the order they happened"], answer:3},
     {q:"What is a bandwagon appeal?", options:["A type of vehicle","A type of song","Suggesting everyone else agrees, so you should too","A math strategy"], answer:2},
     {q:"What is the climax of a story?", options:["The books price","The most exciting or important moment","The first sentence","The list of characters"], answer:1},
     {q:"What is a graphic organizer?", options:["A punctuation mark","A math equation","A visual tool for planning and organizing ideas","A type of made-up story"], answer:2}
   ]},
  {subject:"Math", title:"Math Review: Division, Fractions, Data, and Measurement", summary:"Grade 2 Math strand review: students revisit long division, adding fractions, stem-and-leaf plots, classifying triangles, elapsed time, making change, patterns, and measurement conversions.",
   resourceLabel:"YouTube: Math Review: Division, Fractions, Data, and Measurement", resourceUrl:"https://www.youtube.com/results?search_query=Math%20Review%3A%20Division%2C%20Fractions%2C%20Data%2C%20and%20Measurement%20grade%202%20educational",
   quiz:[
     {q:"What is 24 divided by 4?", options:["4","8","5","6"], answer:3},
     {q:"What is 1/4 + 2/4?", options:["2/4","3/4","1/2","4/4"], answer:1},
     {q:"What is a triangle with three equal sides called?", options:["Isosceles","Obtuse","Scalene","Equilateral"], answer:3},
     {q:"If something costs 3 dollars and you pay with a 5 dollar bill, how much change do you get?", options:["4 dollars","2 dollars","1 dollar","3 dollars"], answer:1},
     {q:"How many grams are in one kilogram?", options:["1000","100","10","10000"], answer:0}
   ]},
  {subject:"Science", title:"Science Review: Our Bodies, Earth, and Habitats", summary:"Grade 2 Science strand review: students revisit our sense of balance, density, nuclear energy, animal tracks, vaccines, desert plants, ice ages, beavers, and wetlands.",
   resourceLabel:"YouTube: Science Review: Our Bodies, Earth, and Habitats", resourceUrl:"https://www.youtube.com/results?search_query=Science%20Review%3A%20Our%20Bodies%2C%20Earth%2C%20and%20Habitats%20grade%202%20educational",
   quiz:[
     {q:"What sense helps us stand and walk without falling?", options:["Sense of hearing","Sense of smell","Sense of balance","Sense of taste"], answer:2},
     {q:"What does density describe?", options:["The taste of an object","How tightly packed matter is in an object","The colour of an object","The sound an object makes"], answer:1},
     {q:"What do vaccines help our body do?", options:["Grow taller","See better","Recognize and fight off certain diseases","Hear better"], answer:2},
     {q:"What is an ice age?", options:["A long period when much of Earth was covered in ice","A single cold day","A type of animal","A kind of rock"], answer:0},
     {q:"What is a wetland?", options:["A frozen glacier","A tall mountain","A habitat where land is covered by shallow water","A dry desert"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Government, Money, and Our Communities", summary:"Grade 2 Social Studies strand review: students revisit our senate, the Order of Canada, our school board, world currency, land acknowledgements, our legislature, our yearbook, lighthouses, and our fire hall.",
   resourceLabel:"YouTube: Social Studies Review: Government, Money, and Our Communities", resourceUrl:"https://www.youtube.com/results?search_query=Social%20Studies%20Review%3A%20Government%2C%20Money%2C%20and%20Our%20Communities%20grade%202%20educational",
   quiz:[
     {q:"What is the Senate?", options:["A city council","A group that reviews new laws","A part of Canadas government","A sports league"], answer:2},
     {q:"What is the Order of Canada?", options:["A special honour for outstanding Canadians","A sports league","A type of holiday","A kind of coin"], answer:0},
     {q:"What is a land acknowledgement?", options:["A weather report","A respectful statement about Indigenous territory","A kind of song","A type of map"], answer:1},
     {q:"What happens at a provincial legislature?", options:["Elected leaders discuss and create laws","Movies are shown to visitors","Food is sold to the public","Students take a math test"], answer:0},
     {q:"What is the main purpose of a lighthouse?", options:["To help guide ships safely","To provide housing for fish","To collect rainwater","To grow crops"], answer:0}
   ]},
]},
{day:151, label:"Day 151 — Mon", subjects:[
  {subject:"Language", title:"Conjunctions: Joining Words Like And, But, and Or", summary:"Grade 2 Language strand: a conjunction is a joining word, such as and, but, or or, that connects two words or two parts of a sentence.",
   resourceLabel:"YouTube: Conjunctions: Joining Words Like And, But, and Or", resourceUrl:"https://www.youtube.com/results?search_query=Conjunctions%3A%20Joining%20Words%20Like%20And%2C%20But%2C%20and%20Or%20grade%202%20educational",
   quiz:[
     {q:"What is a conjunction?", options:["A joining word that connects ideas","A vowel sound","A type of noun","A punctuation mark"], answer:0},
     {q:"Which word is a conjunction?", options:["Blue","And","Jump","Quickly"], answer:1},
     {q:"Which sentence uses a conjunction correctly?", options:["I like apples run oranges","I like apples the oranges","I like apples and oranges","I like apples big oranges"], answer:2},
     {q:"The word but is often used to show ___.", options:["Addition only","A contrast or difference","A command","A question"], answer:1},
     {q:"Why do writers use conjunctions?", options:["To connect ideas smoothly in a sentence","To end a sentence","To remove all meaning","To make a word plural"], answer:0}
   ]},
  {subject:"Math", title:"Data: Line Graphs Showing Change Over Time", summary:"Grade 2 Math strand: a line graph uses points connected by lines to show how something changes over time, such as temperature over a week.",
   resourceLabel:"YouTube: Data: Line Graphs Showing Change Over Time", resourceUrl:"https://www.youtube.com/results?search_query=Data%3A%20Line%20Graphs%20Showing%20Change%20Over%20Time%20grade%202%20educational",
   quiz:[
     {q:"What does a line graph show?", options:["A single number only","How something changes over time","A list of names","A shape"], answer:1},
     {q:"What connects the points on a line graph?", options:["Squares","Circles","Lines","Bars"], answer:2},
     {q:"Which of these would a line graph be good for showing?", options:["Temperature changing each day of the week","A single students name","The title of a book","The colour of a shirt"], answer:0},
     {q:"If a line graph slopes upward, what does that usually mean?", options:["There is no data","The value is staying the same","The value is increasing","The value is unknown"], answer:2},
     {q:"A line graph is especially useful for showing data over ___.", options:["A single moment","Colours","Time","No particular order"], answer:2}
   ]},
  {subject:"Science", title:"The Digestive System: How Our Body Uses Food", summary:"Grade 2 Science strand: the digestive system breaks down the food we eat so our body can use it for energy and growth.",
   resourceLabel:"YouTube: The Digestive System: How Our Body Uses Food", resourceUrl:"https://www.youtube.com/results?search_query=The%20Digestive%20System%3A%20How%20Our%20Body%20Uses%20Food%20grade%202%20educational",
   quiz:[
     {q:"What does the digestive system do?", options:["Pumps blood through the body","Helps us see","Helps us hear","Breaks down food so the body can use it"], answer:3},
     {q:"Why does our body need to break down food?", options:["To change the food into water only","Food has no purpose in the body","To get energy and nutrients for growth","To make the food disappear completely"], answer:2},
     {q:"Where does digestion begin?", options:["In the hair","In the mouth, with chewing","In the ears","In the feet"], answer:1},
     {q:"Which of these is part of the digestive system?", options:["The ear","The stomach","The skin only","The eye"], answer:1},
     {q:"After food is digested, the body uses the nutrients to ___.", options:["Grow and have energy","Change colour","Stop growing completely","Lose all its energy"], answer:0}
   ]},
  {subject:"SocialStudies", title:"The Royal Canadian Mounted Police: A National Police Force", summary:"Grade 2 Social Studies strand: the Royal Canadian Mounted Police, or RCMP, is a police force that works to keep people safe across many parts of Canada.",
   resourceLabel:"YouTube: The Royal Canadian Mounted Police: A National Police Force", resourceUrl:"https://www.youtube.com/results?search_query=The%20Royal%20Canadian%20Mounted%20Police%3A%20A%20National%20Police%20Force%20grade%202%20educational",
   quiz:[
     {q:"What does RCMP stand for?", options:["Royal Canadian Mounted Police","Regional Canadian Map Project","Rural Canadian Mail Post","Royal Canadian Music Program"], answer:0},
     {q:"What is the main job of the RCMP?", options:["To deliver mail","To teach in schools","To build roads","To help keep people safe"], answer:3},
     {q:"The RCMP is known for its distinctive uniform, which is often ___.", options:["Blue","Green","Purple","Red"], answer:3},
     {q:"Does the RCMP work in only one small area or across much of Canada?", options:["Only in one single city","Across much of Canada","Only outside Canada","Only on farms"], answer:1},
     {q:"Why might a country have a national police force like the RCMP?", options:["To stop people from travelling","To help keep communities safe across a large area","To replace all local governments","It has no real purpose"], answer:1}
   ]},
]},
{day:152, label:"Day 152 — Tue", subjects:[
  {subject:"Language", title:"Homographs: Same Spelling, Different Meanings", summary:"Grade 2 Language strand: homographs are words spelled the same way but with different meanings, like bat, the flying animal, and bat, used to hit a ball.",
   resourceLabel:"YouTube: Homographs: Same Spelling, Different Meanings", resourceUrl:"https://www.youtube.com/results?search_query=Homographs%3A%20Same%20Spelling%2C%20Different%20Meanings%20grade%202%20educational",
   quiz:[
     {q:"What is a homograph?", options:["A punctuation mark","A type of sentence","A word spelled the same with different meanings","A word that sounds different but is spelled the same always"], answer:2},
     {q:"Which word can be a homograph?", options:["Umbrella","Elephant","Rainbow","Bat"], answer:3},
     {q:"The word bat can mean a flying animal or ___.", options:["A type of tree","A season","A colour","A tool used to hit a ball"], answer:3},
     {q:"Why can homographs sometimes be tricky for readers?", options:["They have no meaning at all","The same word can have more than one meaning","They are always spelled differently","They never appear in sentences"], answer:1},
     {q:"How can a reader figure out which meaning of a homograph is being used?", options:["By guessing randomly with no clues","By counting the letters only","By ignoring the sentence completely","By looking at the context of the sentence"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Parallel and Perpendicular Lines", summary:"Grade 2 Math strand: parallel lines run side by side and never meet, while perpendicular lines cross each other to form a right angle.",
   resourceLabel:"YouTube: Geometry: Parallel and Perpendicular Lines", resourceUrl:"https://www.youtube.com/results?search_query=Geometry%3A%20Parallel%20and%20Perpendicular%20Lines%20grade%202%20educational",
   quiz:[
     {q:"What do parallel lines never do?", options:["Touch a point","Meet or cross","Bend","Stay straight"], answer:1},
     {q:"What do perpendicular lines form where they cross?", options:["No angle at all","A circle","A right angle","A curve"], answer:2},
     {q:"Which of these is an example of parallel lines?", options:["The hands of a clock at three oclock","A single straight line","A circle","The two rails of a train track"], answer:3},
     {q:"Perpendicular lines cross at an angle of how many degrees?", options:["180 degrees","0 degrees","90 degrees","45 degrees"], answer:2},
     {q:"Why might builders use parallel and perpendicular lines when constructing a building?", options:["To make the building crooked on purpose","To make sure walls and floors line up correctly","They have no use in construction","To remove the need for measurement"], answer:1}
   ]},
  {subject:"Science", title:"Sharks: Ocean Predators", summary:"Grade 2 Science strand: sharks are fish with skeletons made of cartilage instead of bone, and many species are skilled ocean predators.",
   resourceLabel:"YouTube: Sharks: Ocean Predators", resourceUrl:"https://www.youtube.com/results?search_query=Sharks%3A%20Ocean%20Predators%20grade%202%20educational",
   quiz:[
     {q:"What are shark skeletons mostly made of?", options:["Wood","Bone","Cartilage","Metal"], answer:2},
     {q:"What is a shark classified as?", options:["A bird","A mammal","A reptile","A fish"], answer:3},
     {q:"What helps many sharks detect prey in the water?", options:["Fur on their skin","Bright colours","A strong sense of smell","Loud sounds they make"], answer:2},
     {q:"Which of these describes most sharks?", options:["Birds that fly","Skilled ocean predators","Land animals","Insects"], answer:1},
     {q:"Why are sharks an important part of ocean ecosystems?", options:["They have no role in the ocean","They eat only plants","They only live on land","They help keep other populations balanced"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Multiculturalism: Many Cultures Living Together", summary:"Grade 2 Social Studies strand: multiculturalism means people from many different cultures, languages, and traditions live together and share their communities.",
   resourceLabel:"YouTube: Multiculturalism: Many Cultures Living Together", resourceUrl:"https://www.youtube.com/results?search_query=Multiculturalism%3A%20Many%20Cultures%20Living%20Together%20grade%202%20educational",
   quiz:[
     {q:"What does multiculturalism mean?", options:["Only one culture is allowed","People from many cultures living together","Everyone must look the same","No cultures exist"], answer:1},
     {q:"Which of these might be shared in a multicultural community?", options:["Only one language","Different foods, languages, and traditions","No traditions at all","Only one single food"], answer:1},
     {q:"Why is multiculturalism considered a strength in Canada?", options:["It forces everyone to be the same","It removes all traditions","It brings many ideas, traditions, and perspectives together","It has no benefit at all"], answer:2},
     {q:"How can students show respect in a multicultural classroom?", options:["By learning about and respecting differences","By refusing to share","By making fun of other cultures","By ignoring classmates who are different"], answer:0},
     {q:"A community that welcomes many cultures is often described as ___.", options:["Multicultural","Silent","Unchanging","Empty"], answer:0}
   ]},
]},
{day:153, label:"Day 153 — Wed", subjects:[
  {subject:"Language", title:"Character Traits: Describing Who Someone Is", summary:"Grade 2 Language strand: a character trait describes what a character is like on the inside, such as brave, honest, or kind, shown through their words and actions.",
   resourceLabel:"YouTube: Character Traits: Describing Who Someone Is", resourceUrl:"https://www.youtube.com/results?search_query=Character%20Traits%3A%20Describing%20Who%20Someone%20Is%20grade%202%20educational",
   quiz:[
     {q:"What is a character trait?", options:["The name of a character","A description of what a character is like inside","The setting of a story","The title of a book"], answer:1},
     {q:"Which word describes a character trait?", options:["Brave","Jump","Blue","Table"], answer:0},
     {q:"How can a reader figure out a character trait?", options:["By looking at the characters words and actions","By reading only the title","By ignoring the character completely","By counting the pages in the book"], answer:0},
     {q:"If a character always helps others, which trait might describe them?", options:["Selfish","Rude","Kind","Lazy"], answer:2},
     {q:"Character traits help readers understand a character ___.", options:["Only by their name","More deeply","Not at all","Less clearly"], answer:1}
   ]},
  {subject:"Math", title:"Telling Time: Digital and Analog Clocks", summary:"Grade 2 Math strand: an analog clock shows time with moving hands on a round face, while a digital clock shows time using numbers only.",
   resourceLabel:"YouTube: Telling Time: Digital and Analog Clocks", resourceUrl:"https://www.youtube.com/results?search_query=Telling%20Time%3A%20Digital%20and%20Analog%20Clocks%20grade%202%20educational",
   quiz:[
     {q:"Which clock shows time using hands on a round face?", options:["An analog clock","A digital clock","A calendar","A ruler"], answer:0},
     {q:"Which clock shows time using numbers only?", options:["A digital clock","A scale","An analog clock","A thermometer"], answer:0},
     {q:"On an analog clock, which hand moves faster, the hour hand or the minute hand?", options:["The hour hand","They move at the same speed","The minute hand","Neither hand moves"], answer:2},
     {q:"If a digital clock reads 3:30, what would an analog clock show at the same time?", options:["The hour hand between 3 and 4, minute hand at 6","The minute hand at 3 only","Both hands at 12","The hour hand at 12"], answer:0},
     {q:"Why is it useful to be able to read both kinds of clocks?", options:["Both types of clocks are used in everyday life","Digital clocks are never accurate","Clocks are never used","Only one type of clock exists"], answer:0}
   ]},
  {subject:"Science", title:"Penguins: Birds That Cannot Fly", summary:"Grade 2 Science strand: penguins are birds with wings shaped like flippers that help them swim instead of fly, and many species live in cold climates.",
   resourceLabel:"YouTube: Penguins: Birds That Cannot Fly", resourceUrl:"https://www.youtube.com/results?search_query=Penguins%3A%20Birds%20That%20Cannot%20Fly%20grade%202%20educational",
   quiz:[
     {q:"Can most penguins fly?", options:["Yes, they fly very high","Only baby penguins can fly","No, they cannot fly","Yes, but only short distances"], answer:2},
     {q:"What are penguin wings shaped like?", options:["Umbrellas","Long straws","Flippers, for swimming","Large sails"], answer:2},
     {q:"What helps penguins move quickly through water?", options:["Their flipper-shaped wings","Their eyes","Their tails alone","Their beaks alone"], answer:0},
     {q:"Where do many penguin species live?", options:["Cold climates","Underground caves only","Hot deserts","Rainforests"], answer:0},
     {q:"Penguins are classified as ___.", options:["Reptiles","Mammals","Fish","Birds"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Hockey: Canadas Popular Winter Sport", summary:"Grade 2 Social Studies strand: hockey is a fast winter sport played on ice that is closely connected to Canadian culture and community life.",
   resourceLabel:"YouTube: Hockey: Canadas Popular Winter Sport", resourceUrl:"https://www.youtube.com/results?search_query=Hockey%3A%20Canadas%20Popular%20Winter%20Sport%20grade%202%20educational",
   quiz:[
     {q:"What kind of sport is hockey?", options:["A sport played only indoors on grass","A summer sport played in water","A fast winter sport played on ice","A sport with no equipment"], answer:2},
     {q:"What surface is hockey typically played on?", options:["Sand","Water","Ice","Grass"], answer:2},
     {q:"Why is hockey often connected to Canadian culture?", options:["No one in Canada plays hockey","It has no connection to community life","It is only played in one small town","It is a widely popular and celebrated sport across the country"], answer:3},
     {q:"Which of these is equipment commonly used in hockey?", options:["A bat and glove","A stick and skates","A bow and arrow","A racket and net only"], answer:1},
     {q:"Community hockey rinks can help bring people together by ___.", options:["Giving neighbours a place to play and watch together","Keeping everyone apart","Removing community events","Closing all winter activities"], answer:0}
   ]},
]},
{day:154, label:"Day 154 — Thu", subjects:[
  {subject:"Language", title:"Journal Writing: Recording Your Day", summary:"Grade 2 Language strand: journal writing means recording thoughts, feelings, and events from your day, often written regularly like a personal diary.",
   resourceLabel:"YouTube: Journal Writing: Recording Your Day", resourceUrl:"https://www.youtube.com/results?search_query=Journal%20Writing%3A%20Recording%20Your%20Day%20grade%202%20educational",
   quiz:[
     {q:"What is journal writing?", options:["Writing a made-up fairy tale only","Writing a science report only","Copying words from a dictionary","Recording thoughts and events from your day"], answer:3},
     {q:"How often might someone write in a journal?", options:["Only once in a lifetime","Never","Regularly, such as every day","Only during a test"], answer:2},
     {q:"What might a journal entry include?", options:["Only a list of colours","Only numbers","Only other peoples names","Thoughts, feelings, and events from the day"], answer:3},
     {q:"Why might writing in a journal be helpful?", options:["It helps you reflect on and remember your day","It replaces reading completely","It has no purpose at all","It removes your memories"], answer:0},
     {q:"Journal writing is usually written from whose point of view?", options:["A strangers point of view only","A made-up characters point of view only","The writers own point of view","No point of view at all"], answer:2}
   ]},
  {subject:"Math", title:"Fractions: Finding a Fraction of a Group", summary:"Grade 2 Math strand: finding a fraction of a group means splitting a set of objects into equal parts and counting how many are in one or more of those parts.",
   resourceLabel:"YouTube: Fractions: Finding a Fraction of a Group", resourceUrl:"https://www.youtube.com/results?search_query=Fractions%3A%20Finding%20a%20Fraction%20of%20a%20Group%20grade%202%20educational",
   quiz:[
     {q:"What does it mean to find a fraction of a group?", options:["Adding two whole numbers","Telling time","Measuring length","Splitting a set into equal parts"], answer:3},
     {q:"What is 1/2 of a group of 8 objects?", options:["2","4","8","6"], answer:1},
     {q:"What is 1/4 of a group of 12 objects?", options:["3","4","2","6"], answer:0},
     {q:"To find a fraction of a group, we first split the group into ___.", options:["Random piles","Two unequal piles","One large pile","Equal parts"], answer:3},
     {q:"What is 1/3 of a group of 9 objects?", options:["4","3","5","2"], answer:1}
   ]},
  {subject:"Science", title:"Invasive Species: When Plants or Animals Do Not Belong", summary:"Grade 2 Science strand: an invasive species is a plant or animal that moves into a new area where it does not naturally belong and can crowd out native species.",
   resourceLabel:"YouTube: Invasive Species: When Plants or Animals Do Not Belong", resourceUrl:"https://www.youtube.com/results?search_query=Invasive%20Species%3A%20When%20Plants%20or%20Animals%20Do%20Not%20Belong%20grade%202%20educational",
   quiz:[
     {q:"What is an invasive species?", options:["A plant grown in a garden on purpose","A plant or animal that does not naturally belong in an area","A type of pet only","Any animal that lives in a zoo"], answer:1},
     {q:"What can invasive species do to native plants and animals?", options:["Crowd them out and compete for resources","Protect them from every danger","Have no effect on them at all","Always help them grow faster"], answer:0},
     {q:"How might an invasive species arrive in a new area?", options:["It can only appear by magic","It has always lived there","It always evolves there naturally","It can be carried there accidentally by people or transport"], answer:3},
     {q:"Why do scientists study invasive species carefully?", options:["To remove all native species instead","To help them spread faster","To understand and reduce the harm they might cause","Invasive species cause no harm at all"], answer:2},
     {q:"A species that belongs naturally in an area is called a ___ species.", options:["Native","Invasive","Imaginary","Extinct"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Municipal Taxes: How Cities Pay for Services", summary:"Grade 2 Social Studies strand: municipal taxes are money collected by a city or town from residents to help pay for services like roads, parks, and libraries.",
   resourceLabel:"YouTube: Municipal Taxes: How Cities Pay for Services", resourceUrl:"https://www.youtube.com/results?search_query=Municipal%20Taxes%3A%20How%20Cities%20Pay%20for%20Services%20grade%202%20educational",
   quiz:[
     {q:"What are municipal taxes?", options:["Money collected by a city to pay for services","A type of sport","A type of holiday","A kind of weather"], answer:0},
     {q:"Which of these might municipal taxes help pay for?", options:["Roads, parks, and libraries","Only one persons house","Nothing at all","Only private businesses"], answer:0},
     {q:"Who usually pays municipal taxes?", options:["Residents of a city or town","Only visitors passing through","Only children","No one"], answer:0},
     {q:"Why does a city need money from taxes?", options:["To provide services that benefit the whole community","To pay for things in other countries only","To keep the money hidden away","Cities need no money at all"], answer:0},
     {q:"Municipal taxes are an example of how a community works together to ___.", options:["Avoid helping each other","Remove all public services","Ignore community needs","Fund shared services"], answer:3}
   ]},
]},
{day:155, label:"Day 155 — Fri", subjects:[
  {subject:"Language", title:"Text Features: Bold Print and Italics", summary:"Grade 2 Language strand: bold print makes words stand out as darker and thicker, while italics slant words sideways, and both features signal important words to readers.",
   resourceLabel:"YouTube: Text Features: Bold Print and Italics", resourceUrl:"https://www.youtube.com/results?search_query=Text%20Features%3A%20Bold%20Print%20and%20Italics%20grade%202%20educational",
   quiz:[
     {q:"What does bold print look like?", options:["Invisible","Darker and thicker than regular text","Slanted sideways","Underlined only"], answer:1},
     {q:"What does italic text look like?", options:["Invisible","Underlined only","Slanted sideways","Darker and thicker"], answer:2},
     {q:"Why might an author use bold print for a word?", options:["To make the word disappear","To show that the word is especially important","To hide the word from readers","To remove the word from the sentence"], answer:1},
     {q:"Which of these is a common use for italics?", options:["Removing punctuation","Showing the title of a book","Making a word invisible","Ending a sentence"], answer:1},
     {q:"Bold print and italics are both examples of ___.", options:["Punctuation marks","Vowel sounds","Consonant blends","Text features"], answer:3}
   ]},
  {subject:"Math", title:"Money: Finding the Total Cost of Multiple Items", summary:"Grade 2 Math strand: students add the prices of several items together to find the total cost of a purchase.",
   resourceLabel:"YouTube: Money: Finding the Total Cost of Multiple Items", resourceUrl:"https://www.youtube.com/results?search_query=Money%3A%20Finding%20the%20Total%20Cost%20of%20Multiple%20Items%20grade%202%20educational",
   quiz:[
     {q:"If a pencil costs 1 dollar and an eraser costs 2 dollars, what is the total cost?", options:["4 dollars","5 dollars","2 dollars","3 dollars"], answer:3},
     {q:"If three toys each cost 2 dollars, what is the total cost?", options:["8 dollars","6 dollars","5 dollars","4 dollars"], answer:1},
     {q:"To find the total cost of several items, we ___ their prices.", options:["Subtract","Divide only","Add","Ignore"], answer:2},
     {q:"If a book costs 5 dollars and a bookmark costs 1 dollar, what is the total cost?", options:["5 dollars","4 dollars","7 dollars","6 dollars"], answer:3},
     {q:"Why is it useful to know how to find a total cost before shopping?", options:["It only matters for adults","It removes the need for money","It has no real use","It helps make sure you have enough money"], answer:3}
   ]},
  {subject:"Science", title:"Biodiversity: Many Kinds of Living Things in One Place", summary:"Grade 2 Science strand: biodiversity means having many different kinds of living things, like plants, animals, and insects, living together in one area.",
   resourceLabel:"YouTube: Biodiversity: Many Kinds of Living Things in One Place", resourceUrl:"https://www.youtube.com/results?search_query=Biodiversity%3A%20Many%20Kinds%20of%20Living%20Things%20in%20One%20Place%20grade%202%20educational",
   quiz:[
     {q:"What does biodiversity mean?", options:["Having no living things at all","Having only one kind of animal","Having many different kinds of living things in one area","Having only rocks and sand"], answer:2},
     {q:"Which of these describes a place with high biodiversity?", options:["A room with no plants or animals","A single house with one pet","A rainforest with many different species","An empty parking lot"], answer:2},
     {q:"Why is biodiversity important for an ecosystem?", options:["It removes the need for any species","It helps the ecosystem stay healthy and balanced","It always causes harm","It has no importance at all"], answer:1},
     {q:"Which of these could reduce biodiversity in an area?", options:["Protecting many species","Creating nature reserves","Destroying habitats","Planting more variety of plants"], answer:2},
     {q:"A healthy ecosystem usually has ___ different kinds of living things.", options:["No particular number of","Zero","Many","Exactly one"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The Trans-Canada Highway: Connecting the Country", summary:"Grade 2 Social Studies strand: the Trans-Canada Highway is a very long road that connects communities across the country, from coast to coast.",
   resourceLabel:"YouTube: The Trans-Canada Highway: Connecting the Country", resourceUrl:"https://www.youtube.com/results?search_query=The%20Trans-Canada%20Highway%3A%20Connecting%20the%20Country%20grade%202%20educational",
   quiz:[
     {q:"What does the Trans-Canada Highway connect?", options:["Communities across the country, coast to coast","Only two small towns","Nothing at all","Only cities outside Canada"], answer:0},
     {q:"What kind of route is the Trans-Canada Highway?", options:["A short walking path","A very long road","A river route","A railway only"], answer:1},
     {q:"Why might a road like this be important for a large country?", options:["It has no real purpose","It only connects two houses","It prevents any travel at all","It helps people and goods travel long distances"], answer:3},
     {q:"Which of these might travel along the Trans-Canada Highway?", options:["Only boats","Only bicycles","Cars, trucks, and travellers","Only airplanes"], answer:2},
     {q:"A highway that spans an entire country helps support ___.", options:["Isolation between communities","The end of all transportation","Trade and travel between communities","Nothing important"], answer:2}
   ]},
]},
{day:156, label:"Day 156 — Mon", subjects:[
  {subject:"Language", title:"Assonance and Consonance: Sound Patterns in Poetry", summary:"Grade 2 Language strand: assonance repeats vowel sounds within nearby words, while consonance repeats consonant sounds, and both create musical patterns in poetry.",
   resourceLabel:"YouTube: Assonance and Consonance: Sound Patterns in Poetry", resourceUrl:"https://www.youtube.com/results?search_query=Assonance%20and%20Consonance%3A%20Sound%20Patterns%20in%20Poetry%20grade%202%20educational",
   quiz:[
     {q:"What does assonance repeat?", options:["Only the first letter of a word","Vowel sounds within nearby words","Punctuation marks","Whole sentences"], answer:1},
     {q:"What does consonance repeat?", options:["Whole paragraphs","Only vowel letters","Consonant sounds within nearby words","Titles of poems"], answer:2},
     {q:"Which is an example of assonance?", options:["The rain in Spain falls mainly","A quiet cat sat","The sky is blue","A loud dog ran"], answer:0},
     {q:"Why might a poet use assonance or consonance?", options:["To create a musical, pleasing sound pattern","To confuse the reader on purpose","To remove all sound from the poem","To make the poem impossible to read"], answer:0},
     {q:"Assonance and consonance are both examples of ___ in poetry.", options:["Sound patterns","Punctuation marks","Story elements","Grammar rules"], answer:0}
   ]},
  {subject:"Math", title:"Geometry: Naming Polygons by Number of Sides", summary:"Grade 2 Math strand: polygons are named by how many sides and angles they have, such as a triangle with three sides or a pentagon with five sides.",
   resourceLabel:"YouTube: Geometry: Naming Polygons by Number of Sides", resourceUrl:"https://www.youtube.com/results?search_query=Geometry%3A%20Naming%20Polygons%20by%20Number%20of%20Sides%20grade%202%20educational",
   quiz:[
     {q:"How many sides does a triangle have?", options:["6","4","5","3"], answer:3},
     {q:"How many sides does a pentagon have?", options:["7","5","4","6"], answer:1},
     {q:"How many sides does a hexagon have?", options:["8","6","5","7"], answer:1},
     {q:"How many sides does an octagon have?", options:["8","7","6","9"], answer:0},
     {q:"A polygon is named based on its number of ___.", options:["Sides","Colours","Textures","Corners only, never sides"], answer:0}
   ]},
  {subject:"Science", title:"Grasslands and Prairies: Open Habitats", summary:"Grade 2 Science strand: grasslands and prairies are wide open habitats covered mostly in grasses, with few trees, and are home to animals adapted to open spaces.",
   resourceLabel:"YouTube: Grasslands and Prairies: Open Habitats", resourceUrl:"https://www.youtube.com/results?search_query=Grasslands%20and%20Prairies%3A%20Open%20Habitats%20grade%202%20educational",
   quiz:[
     {q:"What covers most of a grassland or prairie?", options:["Ocean water","Tall trees","Grasses","Ice"], answer:2},
     {q:"Do grasslands usually have many trees or few trees?", options:["Few trees","Trees only, no grass","Many tall trees","No plants at all"], answer:0},
     {q:"Which animal might be adapted to living on an open prairie?", options:["An animal that only lives in caves","An animal built for running long distances","A creature that only lives underwater","A fish that only lives in the deep ocean"], answer:1},
     {q:"Why might grassland animals need to be fast runners?", options:["There are too many trees to climb","There are few places to hide from predators","They never need to move at all","There is too much water to swim in"], answer:1},
     {q:"A prairie is an example of a ___.", options:["Habitat","Weather pattern","Kind of ocean","Type of rock"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Public Libraries: Free Access to Books for Everyone", summary:"Grade 2 Social Studies strand: a public library is a community place where anyone can borrow books and other resources for free.",
   resourceLabel:"YouTube: Public Libraries: Free Access to Books for Everyone", resourceUrl:"https://www.youtube.com/results?search_query=Public%20Libraries%3A%20Free%20Access%20to%20Books%20for%20Everyone%20grade%202%20educational",
   quiz:[
     {q:"What can people usually do at a public library?", options:["Get a haircut","Watch a sports game","Borrow books for free","Buy expensive furniture"], answer:2},
     {q:"Who is usually allowed to use a public library?", options:["Only certain wealthy people","Only one single family","Anyone in the community","Only teachers"], answer:2},
     {q:"Why are public libraries an important community resource?", options:["They are only open one day per year","They give everyone free access to books and information","They have no useful resources","They charge very high prices for everything"], answer:1},
     {q:"Besides books, what else might a public library offer?", options:["Computers or community programs","Only empty rooms","Only outdoor sports equipment","Nothing besides books"], answer:0},
     {q:"A public library helps support learning by making resources ___.", options:["Available to no one","Accessible to everyone","Hidden away","Extremely expensive"], answer:1}
   ]},
]},
{day:157, label:"Day 157 — Tue", subjects:[
  {subject:"Language", title:"Hyperbole: Exaggerating for Effect", summary:"Grade 2 Language strand: hyperbole is an extreme exaggeration used to make a strong point or add humour, like saying I am so hungry I could eat a horse.",
   resourceLabel:"YouTube: Hyperbole: Exaggerating for Effect", resourceUrl:"https://www.youtube.com/results?search_query=Hyperbole%3A%20Exaggerating%20for%20Effect%20grade%202%20educational",
   quiz:[
     {q:"What is hyperbole?", options:["A silent letter","A true, exact statement","A type of punctuation","An extreme exaggeration"], answer:3},
     {q:"Which sentence is an example of hyperbole?", options:["I woke up at seven","I slept for eight hours","I feel a little tired","I am so tired I could sleep for a year"], answer:3},
     {q:"Why might a writer use hyperbole?", options:["To state only exact facts","To confuse the reader with true numbers","To remove all feeling from writing","To make a strong point or add humour"], answer:3},
     {q:"Is hyperbole meant to be taken literally?", options:["Yes, it is always exactly true","It is a math equation","No, it is an exaggeration, not literal","It has no meaning at all"], answer:2},
     {q:"Which of these is the best example of hyperbole?", options:["This bag has a zipper","This bag weighs a million pounds","This bag is blue","This bag weighs five pounds"], answer:1}
   ]},
  {subject:"Math", title:"Number Sense: Comparing Numbers Using Greater Than, Less Than, and Equal Signs", summary:"Grade 2 Math strand: students compare two numbers using the greater than sign, the less than sign, or the equal sign to show their relationship.",
   resourceLabel:"YouTube: Number Sense: Comparing Numbers Using Greater Than, Less Than, and Equal Signs", resourceUrl:"https://www.youtube.com/results?search_query=Number%20Sense%3A%20Comparing%20Numbers%20Using%20Greater%20Than%2C%20Less%20Than%2C%20and%20Equal%20Signs%20grade%202%20educational",
   quiz:[
     {q:"Which symbol means greater than?", options:[">","=","+","<"], answer:0},
     {q:"Which symbol means less than?", options:["-","=","<",">"], answer:2},
     {q:"Which symbol means equal to?", options:[">","/","<","="], answer:3},
     {q:"Which comparison is correct for 8 and 5?", options:["8 is less than 5","8 cannot be compared to 5","8 is equal to 5","8 is greater than 5"], answer:3},
     {q:"Which comparison is correct for 6 and 6?", options:["6 cannot be compared to itself","6 is less than 6","6 is greater than 6","6 is equal to 6"], answer:3}
   ]},
  {subject:"Science", title:"Keystone Species: Animals That Hold Ecosystems Together", summary:"Grade 2 Science strand: a keystone species is an animal that has a very large effect on its ecosystem, helping keep many other plants and animals in balance.",
   resourceLabel:"YouTube: Keystone Species: Animals That Hold Ecosystems Together", resourceUrl:"https://www.youtube.com/results?search_query=Keystone%20Species%3A%20Animals%20That%20Hold%20Ecosystems%20Together%20grade%202%20educational",
   quiz:[
     {q:"What is a keystone species?", options:["A kind of plant that never grows","Any animal with no effect on nature","A type of rock","An animal with a very large effect on its ecosystem"], answer:3},
     {q:"What might happen if a keystone species disappeared from its ecosystem?", options:["Every other species would disappear too, with no cause","The ecosystem could become unbalanced","The ecosystem would instantly improve","Nothing would change at all"], answer:1},
     {q:"Why do scientists pay close attention to keystone species?", options:["They have no importance in an ecosystem","They cause every ecosystem to fail","Because they help keep an ecosystem healthy and balanced","They only exist in stories"], answer:2},
     {q:"A keystone species can be thought of as important because it ___.", options:["Has no connection to its habitat","Supports many other living things around it","Lives completely alone with no effect","Only eats rocks"], answer:1},
     {q:"Keystone species help scientists understand how living things are ___.", options:["Impossible to study","Completely separate from each other","Unimportant to nature","Connected to each other"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Lieutenant Governor: A Provincial Representative of the Crown", summary:"Grade 2 Social Studies strand: the lieutenant governor is a ceremonial representative of the Crown in each province, similar to the Governor General at the national level.",
   resourceLabel:"YouTube: The Lieutenant Governor: A Provincial Representative of the Crown", resourceUrl:"https://www.youtube.com/results?search_query=The%20Lieutenant%20Governor%3A%20A%20Provincial%20Representative%20of%20the%20Crown%20grade%202%20educational",
   quiz:[
     {q:"What role does a lieutenant governor represent?", options:["The mayor of a city","A local shop owner","A school principal","A ceremonial representative of the Crown in a province"], answer:3},
     {q:"Is the lieutenant governor role found at the provincial or federal level?", options:["It does not exist in Canada","The provincial level","The federal level only","The municipal level only"], answer:1},
     {q:"Which national role is similar to a provincial lieutenant governor?", options:["The Prime Minister","A mayor","The Governor General","A school teacher"], answer:2},
     {q:"What kind of duties does a lieutenant governor often perform?", options:["Ceremonial duties, such as opening a legislature session","Driving school buses","Coaching sports teams","Cooking meals for the province"], answer:0},
     {q:"Each Canadian province has its own ___.", options:["Lieutenant governor","Ocean","Country","National anthem"], answer:0}
   ]},
]},
{day:158, label:"Day 158 — Wed", subjects:[
  {subject:"Language", title:"Acrostic Poems: Writing With Hidden Words", summary:"Grade 2 Language strand: an acrostic poem uses the first letter of each line to spell out a word, often the topic of the poem, reading down the page.",
   resourceLabel:"YouTube: Acrostic Poems: Writing With Hidden Words", resourceUrl:"https://www.youtube.com/results?search_query=Acrostic%20Poems%3A%20Writing%20With%20Hidden%20Words%20grade%202%20educational",
   quiz:[
     {q:"What does an acrostic poem spell using the first letter of each line?", options:["A punctuation mark","A silent letter","A random number","A hidden word, often the topic"], answer:3},
     {q:"In an acrostic poem, how do the first letters usually read?", options:["Sideways only","Backwards only","Down the page","In a circle"], answer:2},
     {q:"Why might a writer choose to write an acrostic poem?", options:["To creatively connect a word to descriptive lines","To remove all words from the poem","To make the poem impossible to read","To avoid choosing a topic"], answer:0},
     {q:"If the word SUN is used in an acrostic poem, how many lines would it likely have?", options:["3","5","10","1"], answer:0},
     {q:"An acrostic poem is a fun way to explore a topic through ___.", options:["Creative, connected lines","Silence","Numbers only","Random unrelated facts"], answer:0}
   ]},
  {subject:"Math", title:"Fractions: Comparing Fractions with Different Denominators Using Models", summary:"Grade 2 Math strand: students use visual models, like fraction bars or circles, to compare fractions that have different denominators.",
   resourceLabel:"YouTube: Fractions: Comparing Fractions with Different Denominators Using Models", resourceUrl:"https://www.youtube.com/results?search_query=Fractions%3A%20Comparing%20Fractions%20with%20Different%20Denominators%20Using%20Models%20grade%202%20educational",
   quiz:[
     {q:"Why are visual models helpful when comparing fractions with different denominators?", options:["They only work with whole numbers","They help us see which fraction is larger","They remove the need for numbers","They make fractions disappear"], answer:1},
     {q:"Using a model, which is larger, 1/2 or 1/4?", options:["Cannot be compared","They are equal","1/2","1/4"], answer:2},
     {q:"Using a model, which is larger, 1/3 or 1/6?", options:["Cannot be compared","They are equal","1/3","1/6"], answer:2},
     {q:"When the numerator is the same, a fraction with a smaller denominator is usually ___.", options:["Larger","Smaller","Equal to zero","Impossible to compare"], answer:0},
     {q:"A fraction bar model divided into more equal parts shows ___ pieces.", options:["No","Larger","The same size","Smaller"], answer:3}
   ]},
  {subject:"Science", title:"Scavengers: Natures Cleanup Crew", summary:"Grade 2 Science strand: scavengers are animals that eat dead plants and animals they find, helping clean up the environment and recycle nutrients.",
   resourceLabel:"YouTube: Scavengers: Natures Cleanup Crew", resourceUrl:"https://www.youtube.com/results?search_query=Scavengers%3A%20Natures%20Cleanup%20Crew%20grade%202%20educational",
   quiz:[
     {q:"What do scavengers typically eat?", options:["Dead plants and animals they find","Only rocks","Nothing at all","Only live prey they hunt"], answer:0},
     {q:"How do scavengers help the environment?", options:["They help clean up dead material and recycle nutrients","They have no effect on the environment","They make the environment messier","They destroy every habitat"], answer:0},
     {q:"Which of these best describes a scavenger?", options:["An animal that never eats anything","An animal that lives only underwater","An animal that only eats plants it grows itself","An animal that eats what it finds rather than hunts"], answer:3},
     {q:"Why are scavengers considered an important part of an ecosystem?", options:["They remove all other animals","They have no important role","They help recycle nutrients back into the environment","They stop plants from growing"], answer:2},
     {q:"Scavengers are different from predators because scavengers usually ___.", options:["Hunt only live prey","Only eat plants","Never eat anything","Eat animals that are already dead"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Canadian Citizenship: Becoming a Canadian", summary:"Grade 2 Social Studies strand: Canadian citizenship is the process by which a person officially becomes a member of Canada, often including learning about the countrys history and values.",
   resourceLabel:"YouTube: Canadian Citizenship: Becoming a Canadian", resourceUrl:"https://www.youtube.com/results?search_query=Canadian%20Citizenship%3A%20Becoming%20a%20Canadian%20grade%202%20educational",
   quiz:[
     {q:"What is Canadian citizenship?", options:["A kind of weather","A type of food","A type of holiday","Officially becoming a member of Canada"], answer:3},
     {q:"What might someone learn about before becoming a Canadian citizen?", options:["Only weather patterns","Canadas history and values","Only sports scores","Only recipes"], answer:1},
     {q:"Why might a person choose to become a Canadian citizen?", options:["To fully participate in Canadian society, including voting","To avoid all responsibilities","It has no benefit at all","To stop living in Canada"], answer:0},
     {q:"Which of these could be part of becoming a citizen?", options:["Taking a citizenship test and ceremony","Ignoring all Canadian laws","Ending all connections to Canada","Never learning about Canada"], answer:0},
     {q:"New citizens joining Canada can add to the countrys ___.", options:["Silence","Diversity and community","Isolation","Emptiness"], answer:1}
   ]},
]},
{day:159, label:"Day 159 — Thu", subjects:[
  {subject:"Language", title:"Writing a Fictional Story: Beginning, Middle, and End", summary:"Grade 2 Language strand: a fictional story is a made-up tale with a clear beginning that introduces characters, a middle with a problem, and an end with a solution.",
   resourceLabel:"YouTube: Writing a Fictional Story: Beginning, Middle, and End", resourceUrl:"https://www.youtube.com/results?search_query=Writing%20a%20Fictional%20Story%3A%20Beginning%2C%20Middle%2C%20and%20End%20grade%202%20educational",
   quiz:[
     {q:"What is a fictional story?", options:["A made-up tale","A list of facts","A dictionary entry","A true report of real events"], answer:0},
     {q:"What usually happens in the beginning of a fictional story?", options:["The story ends","Nothing happens at all","Characters and setting are introduced","The problem is solved"], answer:2},
     {q:"What usually happens in the middle of a fictional story?", options:["The characters are introduced for the first time","The book cover is shown","The story has not started yet","A problem or challenge appears"], answer:3},
     {q:"What usually happens at the end of a fictional story?", options:["The characters are introduced","The title is chosen","Nothing happens at all","The problem is solved"], answer:3},
     {q:"Why is planning a beginning, middle, and end helpful before writing a story?", options:["It makes the story impossible to write","It helps organize the story clearly","It has no benefit at all","It removes the need for characters"], answer:1}
   ]},
  {subject:"Math", title:"Data: Choosing the Best Type of Graph", summary:"Grade 2 Math strand: different graphs, like bar graphs, line graphs, and pictographs, are useful for showing different kinds of data.",
   resourceLabel:"YouTube: Data: Choosing the Best Type of Graph", resourceUrl:"https://www.youtube.com/results?search_query=Data%3A%20Choosing%20the%20Best%20Type%20of%20Graph%20grade%202%20educational",
   quiz:[
     {q:"Which type of graph is best for showing change over time?", options:["A line graph","A pictograph only","No graph is useful for this","A bar graph only"], answer:0},
     {q:"Which type of graph uses pictures to represent data?", options:["A line graph","A pictograph","A number line","A ruler"], answer:1},
     {q:"Which type of graph uses bars to compare amounts?", options:["A line graph","A clock","A bar graph","A pictograph"], answer:2},
     {q:"Why is it important to choose the right type of graph?", options:["It always makes data more confusing","It makes the data easier to understand","Graphs are never useful","It has no effect on understanding"], answer:1},
     {q:"If you wanted to compare the heights of five plants, which graph might work best?", options:["No graph at all","A line graph only","A bar graph","A pictograph is never useful"], answer:2}
   ]},
  {subject:"Science", title:"Deciduous vs Coniferous Trees: Two Kinds of Forests", summary:"Grade 2 Science strand: deciduous trees lose their leaves each fall, while coniferous trees have needles and cones and usually stay green all year.",
   resourceLabel:"YouTube: Deciduous vs Coniferous Trees: Two Kinds of Forests", resourceUrl:"https://www.youtube.com/results?search_query=Deciduous%20vs%20Coniferous%20Trees%3A%20Two%20Kinds%20of%20Forests%20grade%202%20educational",
   quiz:[
     {q:"What do deciduous trees do each fall?", options:["Turn into a different plant","Disappear completely","Grow needles instead of leaves","Lose their leaves"], answer:3},
     {q:"What do coniferous trees usually have instead of broad leaves?", options:["Needles and cones","Flowers only","No leaves of any kind","Fruit only"], answer:0},
     {q:"Do coniferous trees usually stay green all year or lose their needles each fall?", options:["Lose all their needles every fall","Turn a different colour each season","Stay green all year","Disappear in winter"], answer:2},
     {q:"Which of these is an example of a deciduous tree?", options:["A spruce tree","A maple tree","A fir tree","A pine tree"], answer:1},
     {q:"A forest made mostly of coniferous trees is sometimes called a ___ forest.", options:["Underwater","Desert","Leafless","Evergreen"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Canadian Armed Forces: Protecting Our Country", summary:"Grade 2 Social Studies strand: the Canadian Armed Forces are the men and women who serve to protect Canada and help during emergencies at home and abroad.",
   resourceLabel:"YouTube: The Canadian Armed Forces: Protecting Our Country", resourceUrl:"https://www.youtube.com/results?search_query=The%20Canadian%20Armed%20Forces%3A%20Protecting%20Our%20Country%20grade%202%20educational",
   quiz:[
     {q:"What is the main role of the Canadian Armed Forces?", options:["To teach in schools","To protect Canada and help during emergencies","To deliver mail","To run grocery stores"], answer:1},
     {q:"Where might members of the Canadian Armed Forces help during an emergency?", options:["Only in one single building","Only in outer space","Nowhere at all","At home in Canada or in other countries"], answer:3},
     {q:"Which of these might the Canadian Armed Forces help with?", options:["Coaching a soccer team","Grocery shopping for a family","Painting houses","Natural disasters, like floods"], answer:3},
     {q:"The people who serve in the Canadian Armed Forces are often called ___.", options:["Bus drivers","Librarians","Farmers","Members of the military"], answer:3},
     {q:"Why might communities honour the service of the Canadian Armed Forces?", options:["It has no meaning at all","The Armed Forces have never helped anyone","To show respect for their sacrifice and service","They have no reason to be honoured"], answer:2}
   ]},
]},
{day:160, label:"Day 160 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Word Relationships, Poetry Devices, and Story Writing", summary:"Grade 2 Language strand review: students revisit conjunctions, homographs, character traits, journal writing, bold and italic text features, assonance and consonance, hyperbole, acrostic poems, and writing a fictional story.",
   resourceLabel:"YouTube: Language Review: Word Relationships, Poetry Devices, and Story Writing", resourceUrl:"https://www.youtube.com/results?search_query=Language%20Review%3A%20Word%20Relationships%2C%20Poetry%20Devices%2C%20and%20Story%20Writing%20grade%202%20educational",
   quiz:[
     {q:"What is a conjunction?", options:["A joining word that connects ideas","A punctuation mark","A type of noun","A vowel sound"], answer:0},
     {q:"What is a homograph?", options:["A word that sounds different but is spelled the same always","A type of sentence","A word spelled the same with different meanings","A punctuation mark"], answer:2},
     {q:"What is a character trait?", options:["The name of a character","A description of what a character is like inside","The setting of a story","The title of a book"], answer:1},
     {q:"What is hyperbole?", options:["An extreme exaggeration","A true, exact statement","A type of punctuation","A silent letter"], answer:0},
     {q:"What does an acrostic poem spell using the first letter of each line?", options:["A random number","A silent letter","A punctuation mark","A hidden word, often the topic"], answer:3}
   ]},
  {subject:"Math", title:"Math Review: Graphs, Geometry, Time, Fractions, and Comparing Numbers", summary:"Grade 2 Math strand review: students revisit line graphs, parallel and perpendicular lines, digital and analog clocks, fraction of a group, total cost, polygons, comparing numbers, comparing fractions, and choosing the best graph.",
   resourceLabel:"YouTube: Math Review: Graphs, Geometry, Time, Fractions, and Comparing Numbers", resourceUrl:"https://www.youtube.com/results?search_query=Math%20Review%3A%20Graphs%2C%20Geometry%2C%20Time%2C%20Fractions%2C%20and%20Comparing%20Numbers%20grade%202%20educational",
   quiz:[
     {q:"What does a line graph show?", options:["A single number only","A list of names","How something changes over time","A shape"], answer:2},
     {q:"What do perpendicular lines form where they cross?", options:["A circle","No angle at all","A right angle","A curve"], answer:2},
     {q:"What is 1/2 of a group of 8 objects?", options:["2","8","6","4"], answer:3},
     {q:"How many sides does a pentagon have?", options:["7","5","4","6"], answer:1},
     {q:"Which symbol means greater than?", options:["=","<","+",">"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Our Bodies, Animals, and Ecosystems", summary:"Grade 2 Science strand review: students revisit the digestive system, sharks, penguins, invasive species, biodiversity, grasslands and prairies, keystone species, scavengers, and deciduous versus coniferous trees.",
   resourceLabel:"YouTube: Science Review: Our Bodies, Animals, and Ecosystems", resourceUrl:"https://www.youtube.com/results?search_query=Science%20Review%3A%20Our%20Bodies%2C%20Animals%2C%20and%20Ecosystems%20grade%202%20educational",
   quiz:[
     {q:"What does the digestive system do?", options:["Pumps blood through the body","Breaks down food so the body can use it","Helps us hear","Helps us see"], answer:1},
     {q:"What are shark skeletons mostly made of?", options:["Cartilage","Bone","Metal","Wood"], answer:0},
     {q:"What is an invasive species?", options:["Any animal that lives in a zoo","A type of pet only","A plant or animal that does not naturally belong in an area","A plant grown in a garden on purpose"], answer:2},
     {q:"What is a keystone species?", options:["A kind of plant that never grows","An animal with a very large effect on its ecosystem","A type of rock","Any animal with no effect on nature"], answer:1},
     {q:"What do deciduous trees do each fall?", options:["Turn into a different plant","Disappear completely","Grow needles instead of leaves","Lose their leaves"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Services, Culture, and Our Country", summary:"Grade 2 Social Studies strand review: students revisit the RCMP, multiculturalism, hockey, municipal taxes, the Trans-Canada Highway, public libraries, the lieutenant governor, Canadian citizenship, and the Canadian Armed Forces.",
   resourceLabel:"YouTube: Social Studies Review: Services, Culture, and Our Country", resourceUrl:"https://www.youtube.com/results?search_query=Social%20Studies%20Review%3A%20Services%2C%20Culture%2C%20and%20Our%20Country%20grade%202%20educational",
   quiz:[
     {q:"What does RCMP stand for?", options:["Regional Canadian Map Project","Royal Canadian Music Program","Royal Canadian Mounted Police","Rural Canadian Mail Post"], answer:2},
     {q:"What does multiculturalism mean?", options:["No cultures exist","People from many cultures living together","Everyone must look the same","Only one culture is allowed"], answer:1},
     {q:"What are municipal taxes?", options:["A type of sport","A type of holiday","A kind of weather","Money collected by a city to pay for services"], answer:3},
     {q:"What role does a lieutenant governor represent?", options:["A school principal","A ceremonial representative of the Crown in a province","A local shop owner","The mayor of a city"], answer:1},
     {q:"What is the main role of the Canadian Armed Forces?", options:["To deliver mail","To run grocery stores","To teach in schools","To protect Canada and help during emergencies"], answer:3}
   ]},
]},
];
