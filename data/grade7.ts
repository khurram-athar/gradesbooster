...
{day:2, label:"Day 2 — Tue", subjects:[
  ...
  {subject:"SocialStudies", title:"Conflict and Challenges, 1800–1850", summary:"This period in Canadian history includes the War of 1812, immigration waves, and political rebellions like the Rebellions of 1837–38.",
   ...
   quiz:[
     ...
     {q:"During this period, Upper Canada and Lower Canada experienced...", options:["No change at all","Only peace and stability","No immigration at all","Waves of immigration and political tension"], answer:3},
     ...
     {q:"One long-term effect of this era of conflict was movement toward...", options:["Less self-government","More responsible government in the colonies","No political change","Independence immediately"], answer:1},
   ]},
]},
{day:3, label:"Day 3 — Wed", subjects:[
  {subject:"Language", title:"Theme and Tone", summary:"Theme is the central message or idea of a text; tone is the author's attitude conveyed through word choice.",
   ...
   quiz:[
     ...
     {q:"Tone refers to...", options:["The setting only","The font used","The author's attitude shown through word choice","The number of chapters"], answer:2},
     ...
     {q:"To identify tone, readers should pay attention to...", options:["Only the title","Only the page count","Word choice and details the author includes","Only punctuation"], answer:2},
   ]},
  ...
  {subject:"Science", title:"Structures and Mechanisms: Form and Function", summary:"Ontario Grade 7 Science strand: the form (shape/design) of a structure or mechanism affects its function (how well it works).",
   ...
   quiz:[
     {q:"A lever is a simple mechanism that...", options:["Multiplies force around a fixed point (fulcrum)","Has no function","Only spins in circles","Only works underwater"], answer:0},
     ...
     {q:"An aerodynamic shape is useful for vehicles because it...", options:["Only matters for boats","Increases air resistance","Has no effect on motion","Reduces air resistance, improving efficiency"], answer:3},
   ]},
  {subject:"SocialStudies", title:"Physical Patterns in a Changing World", summary:"Ontario Grade 7 Geography strand: physical patterns like landforms, climate zones, and natural vegetation shape where and how people live.",
   ...
   quiz:[
     {q:"A landform is a...", options:["A type of weather","Natural feature of the Earth's surface, like a mountain","Type of government","A political boundary"], answer:1},
     ...
     {q:"Studying physical patterns helps geographers understand...", options:["How natural features affect human settlement","Nothing useful","Only maps","Only weather forecasts"], answer:0},
   ]},
]},
...
{day:5, label:"Day 5 — Fri (Review)", reviewNote:"Review day: mixed questions from Days 1–4.", subjects:[
  ...
  {subject:"Science", title:"Review: Ecosystems, Matter, and Heat", summary:"Mixed review of food webs, pure substances/mixtures, structures, and heat transfer.",
   ...
   quiz:[
     ...
     {q:"A mixture contains...", options:["Nothing","Two or more substances that keep their properties","Only one type of particle","Only gases"], answer:1},
...
{day:7, label:"Day 7 — Tue", subjects:[
  {subject:"Language", title:"Narrative Structure", summary:"Stories typically follow a structure: exposition, rising action, climax, falling action, and resolution.",
   ...
   quiz:[
     ...
     {q:"Rising action refers to...", options:["The title page","A summary only","The very end of the story","Events building tension toward the climax"], answer:3},
     {q:"The resolution is...", options:["The climax","A character's name","The opening scene","How the story's conflict is resolved at the end"], answer:3},
  ...
  {subject:"SocialStudies", title:"Canada's Connection to the World", summary:"Canada's geography, trade, and history connect it to global patterns of migration, resources, and international relationships.",
   ...
   quiz:[
     ...
     {q:"Trade agreements help Canada by...", options:["Enabling exchange of goods and services with other countries","Having no economic effect","Stopping all imports","Limiting all exports"], answer:0},
     ...
     {q:"Studying global connections helps us understand...", options:["Only weather","Only sports","Nothing about Canada","How geography and history shape relationships between places"], answer:3},
   ]},
]},
{day:8, label:"Day 8 — Wed", subjects:[
  {subject:"Language", title:"Citing Evidence from Text", summary:"When answering questions about a text, support your answer by citing specific evidence from what you read.",
   ...
   quiz:[
     {q:"Citing evidence means...", options:["Making up facts","Ignoring the text completely","Only using your own opinion","Referring to specific details from the text"], answer:3},
     ...
     {q:"Which is the best evidence to support a claim about a character's bravery?", options:["Nothing at all","A specific action showing courage in the text","A random unrelated detail","Your own unrelated experience"], answer:1},
     {q:"Paraphrasing means...", options:["Ignoring the source","Restating the text's idea in your own words","Making up new information","Copying the text exactly"], answer:1},
   ]},
  ...
  {subject:"Science", title:"Designing and Testing Structures", summary:"Engineers use the design process — plan, build, test, evaluate, improve — to create effective structures and mechanisms.",
   ...
   quiz:[
     ...
     {q:"Iteration in design means...", options:["Building only once with no changes","Ignoring all feedback","Avoiding any testing","Repeating and refining a design based on testing"], answer:3},
...
{day:9, label:"Day 9 — Thu", subjects:[
  {subject:"Language", title:"Persuasive Writing Techniques", summary:"Persuasive writers use techniques like emotional appeals, rhetorical questions, and strong word choice to convince readers.",
   ...
   quiz:[
     {q:"A rhetorical question is asked to...", options:["End an essay","Make the reader think, not to get an answer","Confuse the reader","Get a literal answer"], answer:1},
...
{day:11, label:"Day 11 — Mon", subjects:[
  {subject:"Language", title:"Formal vs. Informal Letters and Emails", summary:"Formal letters and emails use polite, professional language and a clear structure; informal writing is more casual and personal.",
   ...
   quiz:[
     {q:"A formal email to a teacher should begin with...", options:["A polite greeting like 'Dear Mr./Ms. ___'","'Hey!'","Slang","No greeting at all"], answer:0},
     ...
     {q:"A formal letter's purpose line is usually found...", options:["In the signature","Only at the very end","Near the beginning, stating why you're writing","Nowhere"], answer:2},
   ]},
  ...
  {subject:"SocialStudies", title:"The Canadian Pacific Railway and Westward Expansion", summary:"The CPR linked Canada from coast to coast, encouraging settlement and helping fulfill the promise made to British Columbia at Confederation.",
   ...
   quiz:[
     ...
     {q:"One major reason for building the CPR was to...", options:["Stop all immigration","Create a new capital city","End the fur trade","Connect British Columbia to the rest of Canada"], answer:3},
     ...
     {q:"The railway helped Canada by...", options:["Encouraging settlement and trade across the country","Stopping economic growth","Having no real effect","Isolating the provinces"], answer:0},
...
{day:12, label:"Day 12 — Tue", subjects:[
  {subject:"Language", title:"Analyzing Poetry: Stanza, Rhyme Scheme, Meter", summary:"Poems are organized into stanzas and often use rhyme schemes and rhythm (meter) to create musicality and meaning.",
   ...
   quiz:[
     ...
     {q:"Meter in poetry refers to...", options:["The title's font","The poet's age","The rhythmic pattern of stressed/unstressed syllables","The poem's length in pages"], answer:2},
  ...
  {subject:"Science", title:"Classification of Organisms (Kingdoms)", summary:"Scientists classify living things into kingdoms (such as animals, plants, fungi, and bacteria) based on shared characteristics.",
   ...
   quiz:[
     {q:"Classification helps scientists...", options:["Confuse species names","Avoid studying nature","Eliminate species","Organize living things based on shared traits"], answer:3},
  ...
  {subject:"SocialStudies", title:"Immigration and Settlement of the Prairies", summary:"In the late 1800s and early 1900s, the Canadian government encouraged immigration to settle the Prairie provinces.",
   ...
   quiz:[
     ...
     {q:"Prairie settlement had significant effects on...", options:["Indigenous peoples and their traditional lands","Only the weather","No one","Only Eastern Canada"], answer:0},
...
{day:13, label:"Day 13 — Wed", subjects:[
  {subject:"Language", title:"Debate Skills and Structuring an Argument", summary:"Effective debaters organize claims, evidence, and rebuttals clearly, and listen carefully to counterarguments.",
   ...
   quiz:[
     {q:"A rebuttal in a debate is...", options:["A summary of the topic","Irrelevant information","The opening statement only","A response that challenges the other side's argument"], answer:3},
     {q:"In a structured debate, each side usually presents...", options:["Only opinions with no support","Random facts","Claims supported by evidence and reasoning","No evidence at all"], answer:2},
  ...
  {subject:"SocialStudies", title:"Residential Schools and Truth and Reconciliation", summary:"Residential schools were part of a difficult chapter in Canadian history; Truth and Reconciliation Day helps Canadians learn about this history and honour Indigenous survivors and communities.",
   ...
   quiz:[
     ...
     {q:"Residential schools were a part of Canadian history in which Indigenous children were...", options:["Sent away from their families to schools that often harmed their culture and well-being","Taught only at home","Given no education at all","Given extra holidays"], answer:0},
     {q:"Learning about residential schools helps Canadians today...", options:["Avoid difficult topics forever","Ignore Indigenous voices","Forget the past entirely","Understand history and work toward reconciliation"], answer:3},
     {q:"Reconciliation means working toward...", options:["Healing and improved relationships between Indigenous and non-Indigenous peoples","Erasing history","More conflict","Nothing in particular"], answer:0},
     {q:"Orange Shirt Day is connected to Truth and Reconciliation Day because it...", options:["Is unrelated to Indigenous history","Celebrates a sports event","Has no connection","Honours residential school survivors and raises awareness"], answer:3},
   ]},
]},
{day:14, label:"Day 14 — Thu", subjects:[
  {subject:"Language", title:"Note-Taking and Summarizing Strategies", summary:"Effective note-takers identify main ideas and key details, and summarize text concisely in their own words.",
   ...
   quiz:[
     ...
     {q:"Identifying the main idea of a paragraph means finding...", options:["The least important detail","The longest sentence","The central point the paragraph is making","The first word only"], answer:2},
  ...
  {subject:"SocialStudies", title:"Canada's Role in World War I", summary:"Canada, as part of the British Empire, played a significant role in World War I, with major battles like Vimy Ridge shaping national identity.",
   ...
   quiz:[
     ...
     {q:"The Battle of Vimy Ridge is significant in Canadian history because...", options:["It had no impact on Canada","It is often seen as a moment that helped shape Canadian national identity","It took place in Canada","It ended the war immediately"], answer:1},
     ...
     {q:"Many Canadian women contributed to the war effort by...", options:["Avoiding all involvement","Leaving the country","Doing nothing at home","Working in factories and supporting roles"], answer:3},
...
{day:16, label:"Day 16 — Mon", subjects:[
  {subject:"Language", title:"Analyzing Graphic and Visual Texts", summary:"Infographics, charts, and diagrams present information visually; readers must interpret data, labels, and layout to understand the message.",
   ...
   quiz:[
     ...
     {q:"When reading a chart in an article, you should first check...", options:["The font size","The author's name only","The title and labels to understand what's shown","The page number"], answer:2},
     ...
     {q:"When analyzing a visual text, it's important to consider...", options:["The purpose, audience, and accuracy of the information","Only the colours used","The artist's signature only","Nothing beyond the picture"], answer:0},
   ]},
  ...
  {subject:"Science", title:"Simple Machines and Mechanical Efficiency", summary:"Simple machines like levers, pulleys, and inclined planes make work easier, though some energy is always lost to friction.",
   ...
   quiz:[
     {q:"An inclined plane makes work easier by...", options:["Reducing the force needed over a longer distance","Increasing weight","Doing nothing useful","Eliminating all friction"], answer:0},
     {q:"Mechanical efficiency compares...", options:["Mass to friction only","Colour to weight","Useful output energy to total input energy","Speed to volume"], answer:2},
     {q:"Friction in machines generally...", options:["Has no effect","Eliminates the need for force","Reduces efficiency by converting some energy to heat","Increases efficiency"], answer:2},
  ...
  {subject:"SocialStudies", title:"Women's Suffrage in Canada", summary:"Women in Canada campaigned for and gradually won the right to vote, beginning with Manitoba in 1916 and federally in 1918.",
   ...
   quiz:[
     ...
     {q:"Women's suffrage activists worked to...", options:["Avoid public campaigning","Gain political rights and equality for women","Stop all social change","Maintain the status quo"], answer:1},
...
{day:17, label:"Day 17 — Tue", subjects:[
  {subject:"Language", title:"Irony and Satire", summary:"Irony occurs when there's a contrast between expectation and reality; satire uses humour or exaggeration to criticize something.",
   ...
   quiz:[
     {q:"Irony involves...", options:["A contrast between expectation and reality","A type of rhyme scheme","Always being funny","A formal greeting"], answer:0},
     ...
     {q:"Dramatic irony occurs when...", options:["No one knows anything","A character speaks formally","The ending is happy","The audience knows something a character doesn't"], answer:3},
     ...
     {q:"Verbal irony occurs when...", options:["No one speaks","Someone uses a rhyme","Someone tells the literal truth always","Someone says the opposite of what they mean"], answer:3},
   ]},
  ...
  {subject:"Science", title:"The Rock Cycle and Types of Rocks", summary:"Rocks are classified as igneous, sedimentary, or metamorphic, and constantly change form through the rock cycle.",
   ...
   quiz:[
     ...
     {q:"Sedimentary rock forms through...", options:["Freezing only","Volcanic eruption only","Melting only","Compaction and cementation of sediment layers"], answer:3},
     ...
     {q:"The rock cycle shows that rocks...", options:["Disappear permanently","Never change","Can transform between types over long periods of time","Only form once"], answer:2},
  ...
  {subject:"SocialStudies", title:"Urbanization and Its Effects on Canadian Cities", summary:"As Canada industrialized, more people moved to cities, leading to growth in housing, jobs, and infrastructure challenges.",
   ...
   quiz:[
     ...
     {q:"Industrialization in Canadian history contributed to urbanization by...", options:["Creating factory jobs that drew people to cities","Removing all jobs","Having no economic effect","Discouraging migration"], answer:0},
     {q:"Rapid urban growth historically created challenges such as...", options:["Housing shortages and crowded living conditions","Excess farmland","No challenges at all","Less need for infrastructure"], answer:0},
     ...
     {q:"Urbanization changed Canadian society by...", options:["Returning everyone to farms","Stopping immigration","Shifting many people's lifestyles from rural to city-based living","Having no social effect"], answer:2},
   ]},
]},
{day:18, label:"Day 18 — Wed", subjects:[
  {subject:"Language", title:"Bias Detection in News Articles", summary:"Critical readers identify bias by examining word choice, missing perspectives, and the source's purpose or ownership.",
   ...
   quiz:[
     ...
     {q:"An author's purpose (to inform, persuade, or entertain) can affect...", options:["How the information is presented, including potential bias","Only the font used","Nothing about the article","Only the article's length"], answer:0},
   ]},
  {subject:"Math", title:"Linear Relations and Graphing (Intro)", summary:"A linear relation shows a constant rate of change between two variables and can be represented with a table, equation, or straight-line graph.",
   ...
   quiz:[
     ...
     {q:"In a table of values for a linear relation, the y-values change by a...", options:["Nothing, they stay the same","Constant amount for each constant change in x","Decreasing rate only","Random amount each time"], answer:1},
   ]},
  {subject:"Science", title:"Weather Systems and Air Masses", summary:"Weather is influenced by moving air masses with different temperature and humidity, and by fronts where air masses meet.",
   ...
   quiz:[
     ...
     {q:"A cold front occurs when...", options:["Air pressure has no role","No air masses move","A cold air mass pushes into a warmer area","Two warm air masses combine"], answer:2},
...
{day:19, label:"Day 19 — Thu", subjects:[
  ...
  {subject:"Science", title:"Biodiversity and Species at Risk", summary:"Biodiversity is the variety of living things in an ecosystem; human activity can threaten species, leading some to become at risk or endangered.",
   ...
   quiz:[
     ...
     {q:"A species at risk is one that...", options:["Faces a declining population and risk of extinction","Is thriving with a growing population","Lives only in zoos","Has no predators"], answer:0},
  ...
  {subject:"SocialStudies", title:"Population Distribution and Density Globally", summary:"Population distribution describes where people live; population density measures how many people live in a given area, both shaped by geography and resources.",
   ...
   quiz:[
     ...
     {q:"Population distribution refers to...", options:["How people are spread out across a region","The government type","The climate only","Only the total number of people"], answer:0},
...
{day:20, label:"Day 20 — Fri (Review)", reviewNote:"Review day: mixed questions from Days 16–19.", subjects:[
  {subject:"Language", title:"Review: Visual Texts, Irony, Bias, and Research Reports", summary:"Mixed review of analyzing visual texts, irony/satire, bias detection, and research report structure.",
   ...
   quiz:[
     ...
     {q:"Situational irony is when...", options:["Everything goes as planned","No one notices anything","A character speaks formally","The outcome is the opposite of what's expected"], answer:3},
   ]},
  ...
  {subject:"Science", title:"Review: Simple Machines, Rocks, Weather, Biodiversity", summary:"Mixed review of mechanical efficiency, the rock cycle, weather systems, and biodiversity.",
   ...
   quiz:[
     ...
     {q:"A cold front occurs when...", options:["No air masses move","Two warm air masses combine","Pressure has no role","A cold air mass pushes into a warmer area"], answer:3},
   ]},
...
{day:21, label:"Day 21 — Mon", subjects:[
  {subject:"Language", title:"Analyzing Character Motivation", summary:"Character motivation is the reason behind a character's actions, often revealed through their words, choices, and reactions to events.",
   ...
   quiz:[
     {q:"Character motivation refers to...", options:["The setting of the story","The author's name","The book's cover design","The reason a character acts the way they do"], answer:3},
     {q:"Readers can infer motivation by examining...", options:["Only the chapter titles","A character's words, choices, and reactions","The page count","The font used in the book"], answer:1},
     ...
     {q:"Understanding motivation helps readers...", options:["Skip important scenes","Better understand a character's choices and growth","Ignore the plot","Avoid analyzing the text"], answer:1},
     {q:"Internal conflict often relates to a character's...", options:["Height","Favourite colour","Motivation clashing with another need or value","Handwriting"], answer:2},
   ]},
  ...
  {subject:"Science", title:"Renewable Energy Technologies", summary:"Renewable energy sources like solar, wind, and hydro generate power without depleting finite resources, using technologies engineered to capture natural energy.",
   ...
   quiz:[
     ...
     {q:"Wind turbines generate electricity using...", options:["Sunlight only","Ocean tides only","Underground heat","Moving air to spin blades connected to a generator"], answer:3},
  ...
  {subject:"SocialStudies", title:"Trade and Globalization (Intro)", summary:"Globalization connects countries through trade, technology, and culture, allowing goods, services, and ideas to move around the world.",
   ...
   quiz:[
     {q:"Globalization refers to...", options:["Countries becoming more isolated","A single world government","The end of all trade","Increasing connections between countries through trade, technology, and culture"], answer:3},
     ...
     {q:"One effect of globalization is that products in stores often...", options:["Come from many different countries around the world","Are no longer available","Come from only one country","Cannot be transported"], answer:0},
...
{day:22, label:"Day 22 — Tue", subjects:[
  {subject:"Language", title:"Comparing Perspectives in Two Texts", summary:"Comparing how two texts present the same topic or event helps readers identify different viewpoints, tone, and emphasis.",
   ...
   quiz:[
     {q:"When comparing two texts on the same topic, readers should look for...", options:["The page count of each text","The font size used","Differences in viewpoint, tone, and emphasis","Only spelling differences"], answer:2},
  ...
  {subject:"Math", title:"Data: Measures of Central Tendency with Real Data Sets", summary:"Mean, median, and mode summarize data sets, and the choice of measure can affect how data is interpreted, especially with outliers.",
   ...
   quiz:[
     {q:"An outlier in a data set is a value that is...", options:["Typical of the rest of the data","Always the mode","Much higher or lower than most other values","Always the median"], answer:2},
...
{day:23, label:"Day 23 — Wed", subjects:[
  {subject:"Language", title:"Analyzing Advertisements and Persuasive Media", summary:"Advertisements use persuasive techniques such as emotional appeals, testimonials, and bandwagon appeal to influence consumer choices.",
   ...
   quiz:[
     ...
     {q:"A testimonial in an ad typically features...", options:["No people at all","Only statistics","A celebrity or customer praising the product","A list of ingredients only"], answer:2},
     {q:"Advertisers often use emotional appeals to...", options:["List only technical specifications","Persuade consumers using feelings rather than just facts","Avoid persuading at all","Bore the viewer"], answer:1},
     {q:"Critically analyzing an ad involves asking...", options:["What font is used?","Nothing important","What techniques are being used to persuade me?","What is the song in the background?"], answer:2},
     {q:"Product placement in media refers to...", options:["A type of poem","Featuring a brand's product within a show or movie","A type of news article","Removing all brands from media"], answer:1},
   ]},
  ...
  {subject:"SocialStudies", title:"Map Projections and Their Distortions", summary:"Map projections translate the curved surface of the Earth onto a flat map, which always introduces some distortion in shape, size, or distance.",
   ...
   quiz:[
     ...
     {q:"The Mercator projection is known for distorting...", options:["Country names","The size of landmasses, especially near the poles","Only ocean colours","Nothing at all"], answer:1},
     {q:"No flat map projection can be completely accurate in...", options:["Naming countries","Shape, area, distance, and direction all at once","Showing some information","Showing colour"], answer:1},
     {q:"A globe is more accurate than a flat map because it...", options:["Is smaller","Is easier to fold","Has more colours","Represents the Earth's actual curved shape"], answer:3},
     {q:"Choosing a map projection depends on...", options:["The mapmaker's favourite colour","Nothing important","Random chance only","The purpose of the map, like navigation or showing accurate area"], answer:3},
   ]},
]},
{day:24, label:"Day 24 — Thu", subjects:[
  {subject:"Language", title:"Using Active vs. Passive Voice", summary:"In active voice, the subject performs the action; in passive voice, the subject receives the action, which can make writing less direct.",
   ...
   quiz:[
     ...
     {q:"Passive voice can be useful when...", options:["You always want to confuse the reader","The performer of the action is unknown or unimportant","Grammar doesn't matter","Writing is never edited"], answer:1},
   ]},
  ...
  {subject:"SocialStudies", title:"Economic Systems: Needs, Wants, Resources, and Trade", summary:"Economic systems organize how societies use limited resources to meet needs and wants, often relying on trade to access goods they cannot produce themselves.",
   ...
   quiz:[
     {q:"A need is something...", options:["Required for survival, like food and shelter","Never important","The same as a want","Always a luxury item"], answer:0},
     {q:"A want is something that...", options:["Is required for survival","Is desired but not essential for survival","Cannot be purchased","Is illegal to have"], answer:1},
     ...
     {q:"Scarcity in economics refers to...", options:["Unlimited resources for everyone","Limited resources relative to unlimited wants","A government policy only","A type of currency"], answer:1},
   ]},
]},
{day:25, label:"Day 25 — Fri (Review)", reviewNote:"Review day: mixed questions from Days 21–24.", subjects:[
  {subject:"Language", title:"Review: Motivation, Perspectives, Ads, and Voice", summary:"Mixed review of character motivation, comparing perspectives, analyzing ads, and active/passive voice.",
   ...
   quiz:[
     {q:"Character motivation refers to...", options:["The reason a character acts a certain way","The book's cover","The author's name","The story's setting"], answer:0},
...
{day:26, label:"Day 26 — Mon", subjects:[
  {subject:"Language", title:"Analyzing a Short Story's Setting and Mood", summary:"Setting (time and place) often shapes a story's mood, the emotional atmosphere a reader experiences.",
   ...
   quiz:[
     ...
     {q:"Mood refers to...", options:["The emotional atmosphere a reader experiences","The book's price","The author's biography","The font used"], answer:0},
     {q:"A dark, stormy setting often creates a mood of...", options:["Cheerfulness","Celebration","Tension or unease","Boredom only"], answer:2},
     {q:"Authors create mood through...", options:["Page numbers","Only the title","Only character names","Word choice, setting details, and imagery"], answer:3},
  ...
  {subject:"Science", title:"pH and Acids/Bases (Intro)", summary:"The pH scale measures how acidic or basic a substance is, ranging from 0 (strongly acidic) to 14 (strongly basic), with 7 being neutral.",
   ...
   quiz:[
     ...
     {q:"Litmus paper is used to...", options:["Test whether a substance is acidic or basic","Measure volume","Measure mass","Measure temperature"], answer:0},
  ...
  {subject:"SocialStudies", title:"The Structure of Canadian Government", summary:"Canada has three levels of government — federal, provincial, and municipal — each responsible for different areas like national defence, education, and local services.",
   ...
   quiz:[
     ...
     {q:"Municipal governments usually manage...", options:["The national military","International trade agreements","Local services like roads and waste collection","Printing currency"], answer:2},
...
{day:27, label:"Day 27 — Tue", subjects:[
  ...
  {subject:"SocialStudies", title:"Canada's Relationship with the United States", summary:"Canada and the United States share the world's longest border and a close relationship built on trade, culture, and cooperation.",
   ...
   quiz:[
     ...
     {q:"Trade between Canada and the U.S. involves...", options:["A large volume of goods and services crossing the border daily","No exchange of goods","Illegal activity only","Only Canadian exports with no U.S. exports"], answer:0},
     ...
     {q:"Many Canadians live near the U.S. border because of...", options:["Climate reasons only","A government requirement to do so","Historical settlement patterns and economic opportunities","Random chance only"], answer:2},
   ]},
]},
{day:28, label:"Day 28 — Wed", subjects:[
  {subject:"Language", title:"Peer Editing and Feedback Strategies", summary:"Effective peer editors give specific, constructive feedback focused on both strengths and areas for improvement in a piece of writing.",
   ...
   quiz:[
     ...
     {q:"A good peer editing strategy is to...", options:["Only point out everything wrong","Rewrite the whole piece yourself","Ignore the writer's intent","Identify strengths and offer specific suggestions for improvement"], answer:3},
     ...
     {q:"A useful feedback technique is the 'two stars and a wish,' which means...", options:["Giving two compliments and one suggestion for improvement","Giving no feedback","Giving three criticisms","Rating the piece out of five stars only"], answer:0},
   ]},
  {subject:"Math", title:"Probability: Independent Events and Tree Diagrams", summary:"Independent events don't affect each other's outcomes; tree diagrams help visualize and calculate probabilities of combined events.",
   ...
   quiz:[
     {q:"Two events are independent if...", options:["One event's outcome affects the other","They always happen together","They can never both happen","One event's outcome does not affect the other"], answer:3},
  ...
  {subject:"Science", title:"Technological Design Process Applied to a Real Problem", summary:"Engineers and designers apply a structured process — identifying a problem, brainstorming, prototyping, testing, and improving — to solve real-world challenges.",
   ...
   quiz:[
     {q:"The first step in solving a design problem is usually to...", options:["Skip planning","Clearly identify the problem and criteria for success","Build the final product","Sell the idea"], answer:1},
  ...
  {subject:"SocialStudies", title:"Sustainable Development Goals (Intro)", summary:"The United Nations' Sustainable Development Goals are a shared global framework aiming to address issues like poverty, inequality, and environmental protection by 2030.",
   ...
   quiz:[
     {q:"The Sustainable Development Goals were created by...", options:["A private company","A single country acting alone","The United Nations, with global member countries","No organization at all"], answer:2},
     {q:"The SDGs aim to address global issues such as...", options:["Poverty, inequality, and environmental protection","Only space exploration","Only sports development","Nothing related to people's lives"], answer:0},
     {q:"Sustainable development means meeting current needs while...", options:["Avoiding all economic growth","Using up all resources immediately","Not compromising the ability of future generations to meet their needs","Ignoring future generations completely"], answer:2},
...
{day:29, label:"Day 29 — Thu", subjects:[
  {subject:"Language", title:"Oral Presentation Delivery Skills", summary:"Effective oral presentations rely on clear speech, eye contact, appropriate pacing, and engaging body language, in addition to strong content.",
   ...
   quiz:[
     ...
     {q:"Visual aids like slides should...", options:["Always be in tiny font","Be ignored during delivery","Support your spoken points without overwhelming detail","Contain your entire script"], answer:2},
   ]},
  ...
  {subject:"Science", title:"Environmental Impact Assessment Basics", summary:"Before major projects are built, environmental impact assessments evaluate how the project might affect ecosystems, water, air, and communities.",
   ...
   quiz:[
     {q:"An environmental impact assessment is conducted to...", options:["Evaluate how a project might affect the environment before it's built","Guarantee no environmental effects exist","Ignore potential environmental effects","Replace the need for construction"], answer:0},
     ...
     {q:"Public input is often included in impact assessments to...", options:["Incorporate community concerns and local knowledge","Avoid transparency","Slow down all projects with no purpose","Exclude community concerns"], answer:0},
  ...
  {subject:"SocialStudies", title:"Current Geographic Issues: Inquiry Skills", summary:"Geographic inquiry involves asking questions, gathering evidence from multiple sources, and analyzing patterns to understand real-world issues.",
   ...
   quiz:[
     ...
     {q:"Maps, statistics, and satellite images are examples of...", options:["Only used in math class","Tools and evidence used in geographic inquiry","Useless information","Items unrelated to geography"], answer:1},
     ...
     {q:"Geographic inquiry skills help students...", options:["Ignore evidence-based reasoning","Avoid asking questions","Understand and evaluate real-world issues critically","Memorize maps with no analysis"], answer:2},
   ]},
]},
{day:30, label:"Day 30 — Fri (Final Review)", reviewNote:"Final review day: mixed questions from Days 26–29, getting ready for Grade 7 in September.", subjects:[
  {subject:"Language", title:"Final Review: Setting/Mood, Sentence Variety, Feedback, Presentation", summary:"Mixed review of setting and mood, varying sentence length, peer editing, and oral presentation skills.",
   ...
   quiz:[
     ...
     {q:"Mood refers to...", options:["The author's biography","The emotional atmosphere a reader experiences","The font used","The book's price"], answer:1},
   ]},
  {subject:"Math", title:"Final Review: Coordinate Geometry, Negative Numbers, Probability, Unit Conversions", summary:"Mixed review of distance between points, negative number applications, independent events, and metric conversions.",
   ...
   quiz:[
     ...
     {q:"Two events are independent if...", options:["One always affects the other","One event's outcome does not affect the other","They never happen","They always happen together"], answer:1},
  ...
  {subject:"Science", title:"Final Review: pH, Energy Flow, Design Process, Environmental Assessment", summary:"Mixed review of acids/bases, food pyramids and energy flow, the technological design process, and environmental impact assessments.",
   ...
   quiz:[
     ...
     {q:"The first step in solving a design problem is usually to...", options:["Sell the idea","Identify the problem and criteria for success","Skip planning","Build the final product"], answer:1},
     {q:"An environmental impact assessment is conducted to...", options:["Guarantee no effects exist","Replace construction","Evaluate how a project might affect the environment","Ignore environmental effects"], answer:2},
