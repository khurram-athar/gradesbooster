...
{day:31, label:"Day 31 — Mon", subjects:[
  {subject:"Language", title:"Reading: Analyzing Symbolism and Allegory", summary:"Ontario Grade 7 Reading strand: symbolism uses an object or image to represent a deeper idea, while an allegory is an entire story in which characters and events represent broader meanings, often moral or political.",
   ...
   quiz:[
     ...
     {q:"Which is an example of a common literary symbol?", options:["A dove representing peace","The book’s publisher","A character’s exact height","The page number"], answer:0},
     {q:"Why might an author write an entire story as an allegory?", options:["To convey a broader moral, political, or social message through the narrative","Allegories have no deeper meaning","To make a story purely literal with no symbolism","To avoid having any characters"], answer:0},
     {q:"Why is understanding symbolism and allegory considered an advanced reading skill?", options:["It requires no interpretation at all","These devices never appear in complex texts","Symbolism and allegory are the simplest literary devices to identify","It requires recognizing deeper meaning beyond the literal events of a story"], answer:3}
   ]},
  {subject:"Math", title:"Simplifying and Expanding Algebraic Expressions", summary:"Ontario Grade 7 Algebra strand: simplifying an expression means combining like terms, while expanding involves using the distributive property to remove parentheses, such as 2(x + 3) becoming 2x + 6.",
   ...
   quiz:[
     ...
     {q:"Simplify: 4x + 2y minus x + 3y.", options:["3x + y","5x + 5y","4x + 5y","3x + 5y"], answer:3},
     {q:"Like terms are terms that ___.", options:["Can never be combined","Have no variables at all","Always have different variables","Have the same variable raised to the same power"], answer:3},
     {q:"Expand: 5(2x + 4).", options:["10x + 9","10x + 4","7x + 20","10x + 20"], answer:3}
   ]},
  {subject:"Science", title:"Cell Division and Growth", summary:"Ontario Grade 7 Science Life Systems strand: cell division allows organisms to grow, repair tissue, and reproduce, with mitosis producing two identical cells from one original cell.",
   ...
   quiz:[
     ...
     {q:"Why is cell division important for healing an injury, such as a cut?", options:["Cell division has no role in healing","New cells are produced to repair and replace damaged tissue","Injuries heal with no biological process involved","Cell division only occurs before birth"], answer:1},
     {q:"Which process allows a single-celled organism to reproduce?", options:["Digestion","Photosynthesis only","Cell division","Respiration only"], answer:2},
     {q:"Why do organisms need a reliable process like cell division to grow?", options:["Growth never involves cells at all","Cell division only occurs in plants, not animals","Organisms do not actually grow over time","Growth requires producing new cells to increase the size and number of tissues"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Great Depression and Its Impact on Canada", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: the Great Depression of the 1930s brought severe economic hardship to Canada, including widespread unemployment, leading to major changes in government policy and social programs.",
   ...
   quiz:[
     ...
     {q:"The hardships of the Great Depression led to changes in ___.", options:["Nothing related to government","Foreign languages spoken in Canada","Only sports rules","Government policy and social programs"], answer:3},
     {q:"Why is the Great Depression considered a turning point in Canadian social policy?", options:["It had no connection to unemployment or hardship","It had no lasting effect on government policy","It occurred after all major social programs were created","It highlighted the need for government support systems during economic crises"], answer:3},
     {q:"Which is an example of hardship faced by many Canadians during the Great Depression?", options:["Widespread job loss and poverty","No significant economic challenges","Unlimited access to jobs and wealth","A rapidly growing, thriving economy"], answer:0}
   ]},
]},
{day:32, label:"Day 32 — Tue", subjects:[
  {subject:"Language", title:"Writing: Literary Analysis Essay", summary:"Ontario Grade 7 Writing strand: a literary analysis essay closely examines elements of a text, such as character, theme, or symbolism, supporting a clear interpretation with evidence from the text.",
   ...
   quiz:[
     ...
     {q:"Why is textual evidence important in a literary analysis essay?", options:["Evidence makes an analysis less convincing","It supports the writer’s interpretation with specific examples from the text","Evidence is unnecessary in literary analysis","A literary analysis should never reference the text"], answer:1},
     {q:"A strong thesis in a literary analysis essay should ___.", options:["Avoid taking any position at all","Simply restate the plot with no interpretation","Present a clear, arguable interpretation of the text","Ignore the text’s themes entirely"], answer:2},
     {q:"Why might different readers write different literary analyses of the same text?", options:["Literary analysis allows for no personal interpretation","Interpretation can vary based on the reader’s perspective and the evidence they emphasize","Texts only ever have one single possible meaning","Every reader must always reach the exact same interpretation"], answer:1}
   ]},
  {subject:"Math", title:"Solving Multi-Step Equations", summary:"Ontario Grade 7 Algebra strand: solving a multi-step equation involves combining like terms, using the distributive property if needed, and then applying inverse operations to isolate the variable.",
   ...
   quiz:[
     ...
     {q:"When solving a multi-step equation, which step is often completed first?", options:["Multiplying both sides by zero","Ignoring one side of the equation","Combining like terms or expanding parentheses","Immediately guessing the answer"], answer:2},
     {q:"Solve for n: 4n minus 2n + 6 = 16.", options:["n = 2","n = 8","n = 10","n = 5"], answer:3},
     {q:"Solve for m: 2(m + 4) minus 3 = 13.", options:["m = 6","m = 8","m = 3","m = 4"], answer:0}
   ]},
  {subject:"Science", title:"Photosynthesis and Cellular Respiration", summary:"Ontario Grade 7 Science Life Systems strand: photosynthesis converts sunlight into stored energy in plants, while cellular respiration releases that stored energy for cells to use, forming a connected cycle.",
   ...
   quiz:[
     ...
     {q:"Photosynthesis and cellular respiration are considered connected because ___.", options:["They have no relationship to each other","The products of one process are often used as inputs for the other","Neither process involves energy","Only plants perform either process"], answer:1},
     {q:"Which gas is taken in by plants during photosynthesis?", options:["Argon","Helium","Carbon dioxide","Nitrogen only"], answer:2},
     {q:"Why is cellular respiration essential for living cells?", options:["It provides the usable energy cells need to carry out their functions","Only photosynthesis provides usable energy for cells","Cells never require energy to function","Cellular respiration has no role in providing energy"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Canada in World War II", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: Canada played a significant role in World War II, contributing troops, resources, and industrial production, which also led to major social changes at home.",
   ...
   quiz:[
     ...
     {q:"Why is Canada’s role in World War II considered historically significant?", options:["Canada was not involved in World War II","It had no lasting impact on Canada","It occurred before World War I","It contributed to shaping Canada’s international reputation and domestic society"], answer:3},
     {q:"Canadian industry during World War II shifted to focus on ___.", options:["Producing military supplies and equipment","Goods entirely unrelated to the war","Only agricultural products with no industrial output","Producing nothing of use to the war effort"], answer:0},
     {q:"Why do historians study the domestic changes in Canada during World War II?", options:["Domestic changes during the war had no lasting significance","Canadian society remained completely unchanged throughout the war","These changes have no connection to Canadian history","To understand how wartime needs reshaped Canadian society and the economy"], answer:3}
   ]},
]},
{day:33, label:"Day 33 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Subjunctive Mood and Conditional Sentences", summary:"Ontario Grade 7 Writing strand: the subjunctive mood expresses wishes, hypotheticals, or conditions contrary to fact, often seen in sentences like If I were taller, I would reach the shelf.",
   ...
   quiz:[
     ...
     {q:"A conditional sentence typically includes ___.", options:["An if clause and a result clause","A command with no condition","Only a single unrelated word","No clauses at all"], answer:0},
     {q:"Which sentence expresses a wish using the subjunctive mood?", options:["I wish I was is on vacation right now.","I wish I am on vacation right now.","I wish I were on vacation right now.","I wish vacation."], answer:2},
     {q:"Why might writers use the subjunctive mood in formal or literary writing?", options:["To express hypothetical or unreal situations clearly","It replaces the need for verbs entirely","It is only used for factual statements","The subjunctive mood has no specific grammatical purpose"], answer:0}
   ]},
  {subject:"Math", title:"Direct and Partial Variation", summary:"Ontario Grade 7 Algebra strand: direct variation describes a relationship where one quantity is a constant multiple of another (y equals kx), while partial variation includes a fixed starting amount plus a variable rate (y equals kx plus b).",
   ...
   quiz:[
     ...
     {q:"Which situation is an example of direct variation?", options:["The total cost of apples, based only on price per apple times quantity, with no extra fee","A taxi fare with a flat starting fee plus a per-kilometre rate","A fixed monthly fee with no other charges","A situation with no relationship between two quantities"], answer:0},
     {q:"Which situation is an example of partial variation?", options:["Buying items where total cost is exactly price times quantity, with no starting fee","A phone plan with a flat monthly fee plus a per-text charge","A situation where cost is always exactly zero","A relationship with no constant rate at all"], answer:1},
     {q:"In the equation y equals 3x plus 5, what does the 5 represent in a partial variation context?", options:["An unrelated constant with no meaning","The rate of change","The starting or fixed amount","The value of x"], answer:2}
   ]},
  {subject:"Science", title:"Plate Tectonics and Continental Drift", summary:"Ontario Grade 7 Science Earth and Space Systems strand: plate tectonics explains how Earth’s crust is divided into large plates that move slowly over time, a process related to the theory of continental drift.",
   ...
   quiz:[
     ...
     {q:"Movement of tectonic plates can result in ___.", options:["The complete disappearance of continents","Only changes in ocean colour","Earthquakes and volcanic activity","No geological activity at all"], answer:2},
     {q:"Evidence supporting continental drift includes ___.", options:["Matching coastlines and fossil patterns across separated continents","A complete absence of fossil evidence","Continents that have never been connected in any way","No evidence exists to support this theory"], answer:0},
     {q:"Why is understanding plate tectonics important for studying natural disasters?", options:["Natural disasters occur with no geological cause","It helps explain the causes behind events like earthquakes and volcanic eruptions","Plate tectonics only affects ocean currents","Plate tectonics has no connection to natural disasters"], answer:1}
   ]},
  {subject:"SocialStudies", title:"The Cold War and Canada’s Role", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: during the Cold War, Canada aligned with Western allies, participated in organizations like NATO, and played a role in international tensions between the United States and the Soviet Union.",
   ...
   quiz:[
     ...
     {q:"The Cold War was primarily a period of tension between the United States and ___.", options:["Japan","France","Canada","The Soviet Union"], answer:3},
     {q:"Why might Canada have chosen to participate in international alliances during the Cold War?", options:["To align with allies and contribute to collective international security","Canada avoided all international involvement during this period","Alliances provided no benefit to Canada","Canada had no role in international relations at that time"], answer:0},
     {q:"Why is Canada’s role during the Cold War studied as part of Canadian history?", options:["It shows how Canada positioned itself within global political tensions","Canada was entirely disconnected from world events during the Cold War","Canada had no role in Cold War events","This period has no relevance to Canadian history"], answer:0}
   ]},
]},
{day:34, label:"Day 34 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Connotation, Denotation, and Word Choice", summary:"Ontario Grade 7 Language strand: denotation is a word’s literal meaning, connotation is the feeling or association it carries, and skilled writers choose words carefully based on both to create a desired effect.",
   ...
   quiz:[
     ...
     {q:"Why might a writer choose the word slender instead of skinny, despite similar denotations?", options:["Connotation has no effect on writing","Word choice never affects tone","Slender often carries a more positive connotation","The words have completely different denotations"], answer:2},
     {q:"Which word likely has a more negative connotation than confident, despite a similar meaning?", options:["Assured","Capable","Arrogant","Self-assured"], answer:2},
     {q:"Why is understanding connotation especially important in persuasive writing?", options:["Word choice can strongly influence how an audience feels about a topic","Persuasive writing should avoid considering word choice","Connotation has no role in persuasion","Connotation only matters in poetry"], answer:0}
   ]},
  {subject:"Math", title:"Similar Triangles and Scale Factor", summary:"Ontario Grade 7 Geometry strand: similar triangles have the same shape but not necessarily the same size, with corresponding sides in proportion according to a consistent scale factor.",
   ...
   quiz:[
     ...
     {q:"A scale factor describes ___.", options:["The exact angle measurements only","The ratio between corresponding sides of similar shapes","A shape’s colour","The area of a triangle only"], answer:1},
     {q:"In similar triangles, corresponding angles are ___.", options:["Always different","Equal","Impossible to compare","Irrelevant to similarity"], answer:1},
     {q:"If a triangle has sides of 3, 4, and 5, and is scaled by a factor of 3, what are the new side lengths?", options:["3, 4, 5","1, 4/3, 5/3","9, 12, 15","6, 8, 10"], answer:2}
   ]},
  {subject:"Science", title:"Optics: Refraction and Lenses", summary:"Ontario Grade 7 Science Matter and Energy strand: refraction is the bending of light as it passes between materials of different densities, a principle used in lenses to focus or spread out light.",
   ...
   quiz:[
     ...
     {q:"A convex lens generally causes light rays to ___.", options:["Always spread apart with no convergence","Converge (come together)","Reflect back with no refraction","Disappear entirely"], answer:1},
     {q:"Why does a straw in a glass of water sometimes appear bent?", options:["Light refracts differently as it passes from air into water","Refraction never affects visual appearance","The straw physically changes shape underwater","Water has no effect on light"], answer:0},
     {q:"Which everyday device relies on lenses and refraction to function?", options:["A cotton shirt","A rubber ball","Eyeglasses","A wooden spoon"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Quebec’s Quiet Revolution and Canadian Federalism", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: the Quiet Revolution was a period of significant social, political, and economic change in Quebec during the 1960s, which influenced discussions about Canadian federalism.",
   ...
   quiz:[
     ...
     {q:"The Quiet Revolution involved changes in areas such as ___.", options:["Social, political, and economic life in Quebec","Only sports and entertainment","No meaningful areas of life","Only weather-related policy"], answer:0},
     {q:"Why is the Quiet Revolution significant to discussions about Canadian federalism?", options:["It had no connection to Canadian federalism","It ended all discussion of provincial and federal relationships","It shaped ongoing conversations about the relationship between Quebec and the rest of Canada","It was unrelated to Quebec’s political development"], answer:2},
     {q:"Canadian federalism refers to ___.", options:["A single, unified government with no divisions of power","A system with no provincial governments at all","A concept unrelated to Canadian government structure","The division of powers and responsibilities between federal and provincial governments"], answer:3}
   ]},
]},
{day:35, label:"Day 35 — Fri", subjects:[
  {subject:"Language", title:"Reading: Comparing Themes Across Genres", summary:"Ontario Grade 7 Reading strand: comparing how a similar theme, such as courage or friendship, is explored differently across genres like poetry, fiction, and nonfiction reveals how form shapes meaning.",
   ...
   quiz:[
     ...
     {q:"Why might a theme be expressed differently in poetry compared to nonfiction?", options:["Poetry never contains any identifiable themes","All genres express themes in exactly the same way","Genre has no connection to how a theme is presented","Different genres use distinct techniques, such as imagery or structure, to convey ideas"], answer:3},
     {q:"Why is comparing themes across genres considered a valuable literacy skill?", options:["It replaces the need to understand any individual text","It deepens understanding of how form and structure shape meaning","Only one genre can ever explore meaningful themes","This comparison has no educational value"], answer:1},
     {q:"Which pairing would be useful for comparing how a theme like resilience is explored across genres?", options:["A blank page with no content","A poem about resilience and a nonfiction article about resilience","A single grocery list","Two unrelated math problems"], answer:1}
   ]},
  {subject:"Math", title:"Surface Area and Volume of Cylinders", summary:"Ontario Grade 7 Geometry strand: the surface area of a cylinder includes its two circular bases plus the curved surface, while its volume is found by multiplying the area of its circular base by its height.",
   ...
   quiz:[
     ...
     {q:"If a cylinder’s circular base area is 20 square units and its height is 6 units, what is its volume?", options:["120 cubic units","26 cubic units","3.3 cubic units","20 cubic units"], answer:0},
     {q:"Why might engineers need to calculate the volume of a cylindrical tank?", options:["To determine how much liquid or material the tank can hold","Volume calculations are unnecessary for tanks","Only surface area matters for tanks, never volume","Cylindrical tanks have no measurable volume"], answer:0},
     {q:"A cylinder’s two circular bases are ___ in size.", options:["Irrelevant to the shape","Identical","Different","Impossible to determine"], answer:1}
   ]},
  {subject:"Science", title:"Chemical Reactions: Types and Balancing", summary:"Ontario Grade 7 Science Matter and Energy strand: chemical reactions can be classified into types such as synthesis and decomposition, and balancing a chemical equation ensures the same number of atoms appears on both sides.",
   ...
   quiz:[
     ...
     {q:"Balancing a chemical equation ensures that ___.", options:["No atoms are involved in the reaction","The same number of atoms appears on both sides of the equation","The number of atoms can differ freely between sides","Chemical equations never need to be balanced"], answer:1},
     {q:"Why is it important for a chemical equation to be balanced?", options:["It simply makes the equation look neater with no real purpose","Chemical equations are never actually balanced in real reactions","Balancing has no scientific basis","It reflects the law of conservation of mass, since matter is neither created nor destroyed"], answer:3},
     {q:"Which is an example of a synthesis reaction?", options:["A compound breaking into its individual elements","No reaction occurring at all","Two elements combining to form a compound","A substance disappearing without forming anything new"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The Charter of Rights and Freedoms in Depth", summary:"Ontario Grade 7 Social Studies People and Environments strand: the Canadian Charter of Rights and Freedoms, part of the Constitution since 1982, protects fundamental rights such as freedom of expression, equality rights, and legal rights for people in Canada.",
   ...
   quiz:[
     ...
     {q:"Legal rights protected under the Charter include protections related to ___.", options:["No connection to the justice system","Only property ownership","Only voting procedures","Fair treatment within the justice system"], answer:3},
     {q:"Why is the Charter considered a significant part of Canadian law?", options:["It establishes constitutionally protected rights and freedoms for people in Canada","It applies to no one in Canada","It has no legal significance","It was created before Canada became a country"], answer:0},
     {q:"Equality rights under the Charter are intended to protect against ___.", options:["Only economic inequality","Discrimination based on factors like race or gender","Discrimination that is fully permitted by law","Nothing related to fairness or discrimination"], answer:1}
   ]},
]},
{day:36, label:"Day 36 — Mon", subjects:[
  {subject:"Language", title:"Writing: Reflective Personal Essay", summary:"Ontario Grade 7 Writing strand: a reflective personal essay explores a meaningful experience from the writer’s life and considers its lasting impact, insight, or lesson learned.",
   ...
   quiz:[
     ...
     {q:"Which is an example of reflective insight in a personal essay?", options:["That challenge taught me to be more patient with myself and others.","I woke up. I ate breakfast. I went to school.","The weather was cold that day.","This essay has no connection to real experiences."], answer:0},
     {q:"A strong reflective essay often connects a specific experience to ___.", options:["Only a list of facts with no interpretation","An unrelated topic with no connection","No broader meaning at all","A broader lesson or understanding about life"], answer:3},
     {q:"Why might writers choose to write reflective personal essays?", options:["This type of writing avoids any personal connection","Personal reflection serves no purpose in writing","Reflective essays are never assigned in school","To process and share meaningful experiences and what they learned from them"], answer:3}
   ]},
  {subject:"Math", title:"Combined Probability Events", summary:"Ontario Grade 7 Data Management strand: the probability of two independent events both occurring is found by multiplying their individual probabilities together.",
   ...
   quiz:[
     ...
     {q:"If a coin is flipped and a die is rolled, what is the probability of getting heads and rolling a 6?", options:["1/12","1/2","1/6","1/3"], answer:0},
     {q:"To find the probability of two independent events both happening, you should ___.", options:["Divide one probability by the other","Add their individual probabilities","Subtract one probability from the other","Multiply their individual probabilities"], answer:3},
     {q:"If the probability of rain tomorrow is 1/4 and the probability of a specific team winning is 1/2, what is the probability of both events happening, assuming independence?", options:["1/8","3/4","1/6","1/2"], answer:0}
   ]},
  {subject:"Science", title:"Electricity: Circuits and Ohm’s Law", summary:"Ontario Grade 7 Science Structures and Mechanisms strand: Ohm’s Law describes the relationship between voltage, current, and resistance in an electrical circuit, expressed as voltage equals current times resistance.",
   ...
   quiz:[
     ...
     {q:"If voltage increases while resistance stays the same, current will generally ___.", options:["Become zero","Decrease","Increase","Stay exactly the same"], answer:2},
     {q:"Which of these could increase the resistance in a simple circuit?", options:["Using a wider, shorter wire","Using a longer or thinner wire","Removing all resistance from the circuit","Adding no components at all"], answer:1},
     {q:"Why is Ohm’s Law useful for understanding electrical circuits?", options:["Ohm’s Law has no practical use in circuits","It helps predict how changes in voltage or resistance affect current flow","It describes relationships unrelated to electricity","It only applies to circuits with no current"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Globalization and Its Critics", summary:"Ontario Grade 7 Social Studies People and Environments strand: while globalization has increased international trade and connection, critics point to concerns such as economic inequality, loss of local industries, and environmental impact.",
   ...
   quiz:[
     ...
     {q:"Why might some communities feel negatively impacted by globalization?", options:["Globalization has no effect on local communities","Increased international competition can affect local jobs and industries","All communities benefit equally with no downsides","Globalization eliminates all economic challenges"], answer:1},
     {q:"Supporters and critics of globalization often disagree about ___.", options:["Topics unrelated to trade or economics","Whether globalization exists at all","Nothing, since everyone agrees completely","Whether its benefits outweigh its potential downsides"], answer:3},
     {q:"Why is it useful to consider multiple perspectives on globalization?", options:["Globalization affects every country in an identical way","It provides a more complete understanding of its complex effects","Considering multiple perspectives has no value","Only one perspective on globalization is ever valid"], answer:1}
   ]},
]},
{day:37, label:"Day 37 — Tue", subjects:[
  {subject:"Language", title:"Media Literacy: Analyzing Propaganda Techniques", summary:"Ontario Grade 7 Media Literacy strand: propaganda uses techniques such as name-calling, bandwagon appeal, and emotional language to influence public opinion, often simplifying complex issues.",
   ...
   quiz:[
     ...
     {q:"Name-calling as a propaganda technique involves ___.", options:["Presenting balanced, respectful language","Providing detailed, neutral facts only","Avoiding any judgment of people or ideas","Using negative labels to discredit an opposing person or idea"], answer:3},
     {q:"Why might propaganda oversimplify complex issues?", options:["Propaganda always presents highly detailed, nuanced arguments","Simplification has no persuasive effect","To make a message easier to spread and more emotionally persuasive","Propaganda avoids emotional appeals entirely"], answer:2},
     {q:"Why is it useful for citizens to recognize propaganda techniques?", options:["Recognizing these techniques serves no purpose","Citizens should accept persuasive messages without question","It helps them think critically about messages instead of being easily influenced","Propaganda has no real influence on public opinion"], answer:2}
   ]},
  {subject:"Math", title:"Compound Interest", summary:"Ontario Grade 7 Financial Literacy strand: compound interest is calculated on both the original principal and any interest already earned, causing savings or debt to grow faster than with simple interest over time.",
   ...
   quiz:[
     ...
     {q:"If $100 earns 10 percent compound interest in the first year, how much interest is earned in year one?", options:["$5","$110","$10","$100"], answer:2},
     {q:"In year two of compound interest, interest is calculated on ___.", options:["Nothing at all","The original amount plus year one’s interest","A completely new, unrelated amount","Only the original amount from year one"], answer:1},
     {q:"Why is understanding compound interest useful when considering long-term savings or loans?", options:["It only applies to very small amounts of money","It helps predict how savings or debt will grow significantly over time","Compound interest has no real-world financial impact","Compound interest calculations are never used in real finance"], answer:1}
   ]},
  {subject:"Science", title:"The Nitrogen Cycle", summary:"Ontario Grade 7 Science Life Systems strand: the nitrogen cycle describes how nitrogen moves between the atmosphere, soil, and living things, with bacteria playing a key role in converting nitrogen into forms plants can use.",
   ...
   quiz:[
     ...
     {q:"Nitrogen makes up a large portion of Earth’s ___.", options:["Rock layers only","Atmosphere","Oceans only","Ice caps only"], answer:1},
     {q:"Why is nitrogen important for plant growth?", options:["Plants never require nitrogen in any form","Nitrogen has no role in plant growth","Nitrogen prevents plant growth entirely","Plants need nitrogen in usable forms to build proteins and grow"], answer:3},
     {q:"Why is the nitrogen cycle considered an important natural process?", options:["This cycle only affects non-living matter","Nitrogen is not actually found in nature","It supports life by making nitrogen available in forms living things can use","The nitrogen cycle has no ecological importance"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Indigenous Self-Government and Modern Treaties", summary:"Ontario Grade 7 Social Studies People and Environments strand: many Indigenous communities in Canada today exercise self-government through modern treaties and agreements that recognize their authority over their own affairs.",
   ...
   quiz:[
     ...
     {q:"Why is self-government important to many Indigenous communities?", options:["It has no connection to community wellbeing","It removes all rights from Indigenous peoples","Self-government has no real impact on communities","It allows communities to make decisions that reflect their own needs, values, and traditions"], answer:3},
     {q:"Modern treaties differ from many historical treaties in that they are often ___.", options:["Impossible to negotiate today","Identical to treaties signed centuries ago","Void of any legal significance","Negotiated to address more contemporary rights and governance issues"], answer:3},
     {q:"Learning about Indigenous self-government helps students understand ___.", options:["That Indigenous governance ended in the past","That Indigenous communities have no role in modern Canada","How Indigenous nations exercise rights and responsibilities today","That treaties are no longer relevant"], answer:2}
   ]},
]},
{day:38, label:"Day 38 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Using Passive Voice Effectively", summary:"Ontario Grade 7 Writing strand: while active voice is often clearer, passive voice can be used effectively when the focus should be on the action or receiver rather than who performed it, such as in scientific writing.",
   ...
   quiz:[
     ...
     {q:"Why might scientific writing often use passive voice?", options:["Passive voice makes scientific writing less accurate","To focus on the process or results rather than who performed the action","Passive voice is never used in scientific writing","Scientific writing should always use active voice exclusively"], answer:1},
     {q:"Which is a potential drawback of overusing passive voice?", options:["It always shortens sentences significantly","There are no drawbacks to passive voice","Passive voice always makes writing clearer","Sentences can become less direct or clear"], answer:3},
     {q:"Which sentence is written in active voice?", options:["The ball had been thrown.","The ball was thrown by Sam.","The ball is thrown.","Sam threw the ball."], answer:3}
   ]},
  {subject:"Math", title:"Sampling and Bias in Data Collection", summary:"Ontario Grade 7 Data Management strand: a sample should represent the larger population fairly, and bias in sampling occurs when certain groups are overrepresented or underrepresented, leading to inaccurate conclusions.",
   ...
   quiz:[
     ...
     {q:"Why might surveying only students in one specific class about a school-wide issue introduce bias?", options:["A single class always represents the whole school perfectly","Every class always has identical opinions","Bias never occurs in surveys","That group might not accurately represent the opinions of the entire school"], answer:3},
     {q:"A random sample is generally considered more reliable because ___.", options:["It always excludes certain groups intentionally","Randomness always leads to biased results","It never accurately represents a population","It gives every member of the population a fair chance of being included"], answer:3},
     {q:"Why is recognizing bias in data collection important?", options:["Sampling bias is impossible to identify","Biased data can lead to inaccurate or misleading conclusions","Bias only affects opinions, never factual data","Bias has no effect on the accuracy of conclusions"], answer:1}
   ]},
  {subject:"Science", title:"Astronomy: Galaxies and the Universe", summary:"Ontario Grade 7 Science Earth and Space Systems strand: a galaxy is a massive collection of stars, gas, and dust held together by gravity, and our solar system exists within the Milky Way galaxy, one of billions of galaxies in the universe.",
   ...
   quiz:[
     ...
     {q:"Scientists estimate that the universe contains ___.", options:["Only one galaxy","Billions of galaxies","Exactly ten galaxies","No galaxies at all"], answer:1},
     {q:"What force holds a galaxy’s stars and matter together?", options:["Air pressure","Magnetism","Gravity","Friction"], answer:2},
     {q:"Why do astronomers study galaxies beyond our own?", options:["Studying other galaxies serves no scientific purpose","Galaxies beyond our own have no connection to astronomy","To better understand the structure, formation, and scale of the universe","Only our own galaxy is worth studying"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Urban Planning and Sustainable Cities", summary:"Ontario Grade 7 Social Studies People and Environments strand: urban planning involves designing cities to balance housing, transportation, and green space, with sustainable cities aiming to reduce environmental impact while supporting growing populations.",
   ...
   quiz:[
     ...
     {q:"Which is an example of sustainable urban planning?", options:["Increasing pollution with no mitigation efforts","Expanding public transportation to reduce car dependency","Ignoring transportation needs entirely","Removing all parks and green spaces"], answer:1},
     {q:"Why might urban planners prioritize green space in city design?", options:["Urban planners never consider environmental factors","Green space always harms a city’s development","Green space has no benefits for a city","Green space can improve air quality and quality of life for residents"], answer:3},
     {q:"Why is sustainable urban planning becoming increasingly important?", options:["Growing populations and environmental concerns require thoughtful, balanced city design","Population growth has no effect on city planning needs","Urban planning has no connection to environmental issues","Cities never need to consider sustainability"], answer:0}
   ]},
]},
{day:39, label:"Day 39 — Thu", subjects:[
  ...
  {subject:"Math", title:"Slope and Rate of Change", summary:"Ontario Grade 7 Algebra strand: slope represents the rate of change between two variables on a graph, calculated as the vertical change (rise) divided by the horizontal change (run) between two points.",
   ...
   quiz:[
     ...
     {q:"A steeper line on a graph generally indicates ___.", options:["No rate of change at all","A smaller rate of change","A completely flat line","A greater rate of change"], answer:3},
     {q:"A horizontal line has a slope of ___.", options:["0","1","10","Undefined"], answer:0},
     {q:"Why is slope a useful concept when analyzing graphs of real-world situations, such as speed over time?", options:["It represents how quickly one quantity changes in relation to another","Rate of change cannot be represented graphically","Slope has no real-world application","Slope only applies to graphs with no practical meaning"], answer:0}
   ]},
  {subject:"Science", title:"Environmental Toxicology and Pollution", summary:"Ontario Grade 7 Science Earth and Space Systems strand: environmental toxicology studies how pollutants, such as chemicals released into air, water, or soil, affect living organisms and ecosystems.",
   ...
   quiz:[
     ...
     {q:"Pollution entering a water source can affect ___.", options:["Only organisms living on land","Only the colour of the water, with no other effects","Both aquatic organisms and the people who rely on that water","Nothing at all, since water is unaffected by pollutants"], answer:2},
     {q:"Why might scientists monitor pollution levels in ecosystems?", options:["Monitoring pollution serves no scientific purpose","Pollution levels never change over time","Ecosystems are never affected by pollution","To assess risks to wildlife and human health and guide environmental protection"], answer:3},
     {q:"Which action could help reduce pollution’s impact on an ecosystem?", options:["Releasing untreated chemicals directly into rivers","Ignoring pollution sources entirely","Properly treating wastewater before it enters natural water sources","Increasing the use of harmful chemicals with no regulation"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Human Migration Patterns and Push-Pull Factors", summary:"Ontario Grade 7 Social Studies People and Environments strand: human migration is often influenced by push factors, which encourage people to leave a place, and pull factors, which attract people to a new location.",
   ...
   quiz:[
     ...
     {q:"Which is an example of a push factor?", options:["Conflict or economic hardship in a region","A strong existing economy at home","Job opportunities in a new country","Political stability in the current location"], answer:0},
     {q:"Which is an example of a pull factor?", options:["War in a region","A natural disaster at home","Better job opportunities in a new location","Severe economic hardship at home"], answer:2},
     {q:"Why is it useful to study push and pull factors when learning about migration?", options:["They help explain the reasons behind people’s decisions to move","Migration always occurs with no identifiable reasons","These factors have no connection to migration patterns","Push and pull factors only apply to a single historical era"], answer:0}
   ]},
]},
{day:40, label:"Day 40 — Fri", subjects:[
  {subject:"Language", title:"Reading: Evaluating Rhetorical Appeals", summary:"Ontario Grade 7 Reading strand: rhetorical appeals include ethos (credibility), pathos (emotion), and logos (logic), and identifying which appeals a text relies on helps readers evaluate how persuasion is being used.",
   ...
   quiz:[
     ...
     {q:"Logos as a rhetorical appeal relies on ___.", options:["Random, unsupported claims","Only the speaker’s reputation","Logical reasoning and evidence","Only emotional language"], answer:2},
     {q:"Which is an example of an appeal to ethos?", options:["A doctor citing their medical expertise to support a health claim","A statistic with no context","A story designed only to make the audience feel sad","A random, unrelated fact"], answer:0},
     {q:"Why is it useful for readers to identify which rhetorical appeals a text uses?", options:["All persuasive texts use identical rhetorical strategies","Rhetorical appeals have no effect on persuasion","Identifying appeals is not a useful reading skill","It helps them critically evaluate how the text is attempting to persuade them"], answer:3}
   ]},
  {subject:"Math", title:"Number Theory: GCF and LCM", summary:"Ontario Grade 7 Number strand: the greatest common factor (GCF) is the largest number that divides evenly into two or more numbers, while the least common multiple (LCM) is the smallest number that is a multiple of two or more numbers.",
   ...
   quiz:[
     ...
     {q:"The GCF of two numbers is ___.", options:["The largest number that divides evenly into both","Impossible to calculate","Always equal to one of the two numbers","The smallest number that is a multiple of both"], answer:0},
     {q:"The LCM of two numbers is ___.", options:["The same as the GCF","The largest number that divides evenly into both","The smallest number that is a multiple of both","Always smaller than both numbers"], answer:2},
     {q:"What is the GCF of 20 and 30?", options:["60","10","5","15"], answer:1}
   ]},
  {subject:"Science", title:"Scientific Literacy: Evaluating Scientific Claims", summary:"Ontario Grade 7 Science Inquiry strand: evaluating a scientific claim involves checking whether it is supported by reliable evidence, tested through valid methods, and reviewed by other experts.",
   ...
   quiz:[
     ...
     {q:"Which is a warning sign that a scientific claim might be unreliable?", options:["It is supported by multiple independent studies","It is based on carefully controlled experiments","It lacks supporting evidence or has never been tested","It has been reviewed by other scientists"], answer:2},
     {q:"Why might scientists want to repeat an experiment before fully accepting a claim?", options:["Repeating results helps confirm that findings are consistent and reliable","Repeating experiments has no scientific value","A single experiment is always considered sufficient proof","Reliable claims never need to be tested more than once"], answer:0},
     {q:"Why is scientific literacy an important skill for evaluating information in daily life?", options:["Scientific literacy has no real-world application","All claims presented as scientific are automatically true","It helps people critically assess whether claims are based on sound evidence","Evaluating claims is unnecessary in everyday life"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Comparative Government Systems", summary:"Ontario Grade 7 Social Studies People and Environments strand: comparing different government systems around the world, such as parliamentary democracies, republics, and monarchies, highlights different approaches to governance and representation.",
   ...
   quiz:[
     ...
     {q:"Comparing government systems across countries helps students understand ___.", options:["That all countries are governed identically","That government systems have no real differences","Different ways nations organize decision-making and representation","That comparison of government types is unnecessary"], answer:2},
     {q:"Why might different countries choose different systems of government?", options:["All countries are required to use the same system","Government systems often reflect a country’s unique history, values, and needs","Government systems have no connection to history or culture","Choice of government system is always random"], answer:1},
     {q:"Studying comparative government systems can help citizens ___.", options:["Conclude that comparison is unnecessary","Assume only one system has ever existed","Better understand how their own government compares to others","Avoid learning about their own government"], answer:2}
   ]},
]},
{day:41, label:"Day 41 — Mon", subjects:[
  {subject:"Language", title:"Reading: Analyzing Unreliable Narrators", summary:"Ontario Grade 7 Reading strand: an unreliable narrator is a storyteller whose account may be biased, mistaken, or dishonest, requiring readers to critically evaluate what is really happening in the story.",
   ...
   quiz:[
     ...
     {q:"Which is a clue that a narrator might be unreliable?", options:["A story with no narrator present","A narrator who never says anything at all","A narrator who is always proven completely correct","Inconsistencies between their account and other details in the story"], answer:3},
     {q:"Reading critically when a narrator seems unreliable involves ___.", options:["Assuming the story has no deeper meaning","Questioning the narrator’s claims and looking for supporting or contradicting evidence","Ignoring the narrator completely","Accepting every statement without question"], answer:1},
     {q:"Why is recognizing an unreliable narrator considered an advanced reading skill?", options:["It requires careful analysis of tone, consistency, and perspective","This skill has no connection to comprehension","It requires no critical thinking at all","Unreliable narrators are always obvious immediately"], answer:0}
   ]},
  {subject:"Math", title:"Systems of Two Linear Relations: A Graphical Introduction", summary:"Ontario Grade 7 Algebra strand: a system of two linear relations can be solved graphically by finding the point where their two lines intersect, representing the values that satisfy both relations.",
   ...
   quiz:[
     ...
     {q:"If two lines on a graph are identical, the system has ___.", options:["Infinitely many solutions","A solution only at the origin","No solution","Exactly one solution"], answer:0},
     {q:"Why is finding the point of intersection useful when solving a system of linear relations?", options:["It has no meaning in the context of the two relations","It represents the values of the variables that satisfy both relations at once","It only matters for one of the two lines","Intersection points are unrelated to solving systems"], answer:1},
     {q:"Graphing two linear relations on the same grid allows you to ___.", options:["Prevent any comparison between the relations","Visually identify where their solutions overlap","Automatically solve unrelated equations","Remove the need for any calculations"], answer:1}
   ]},
  {subject:"Science", title:"The Endocrine System: Hormones and Regulation", summary:"Ontario Grade 7 Science Human Body Systems strand: the endocrine system uses glands to release hormones into the bloodstream, regulating processes like growth, metabolism, and stress response.",
   ...
   quiz:[
     ...
     {q:"Which of these processes might the endocrine system help regulate?", options:["Nothing related to body function","Only hair colour","Growth and metabolism","Only eye colour"], answer:2},
     {q:"How does the endocrine system typically differ from the nervous system in how it sends signals?", options:["It has no way of sending any signals","It always works faster than the nervous system","It relies on hormones travelling through the bloodstream rather than fast electrical signals","It has no connection to body regulation"], answer:2},
     {q:"Why is the endocrine system important for maintaining balance in the body?", options:["It affects only external appearance, not internal processes","The body functions with no hormonal regulation at all","It helps regulate many internal processes needed for healthy functioning","The endocrine system has no role in maintaining balance"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The Vietnam War and Its Global Impact", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: the Vietnam War, fought primarily during the 1960s and 1970s, was a significant Cold War-era conflict that had lasting political and social effects around the world, including in Canada.",
   ...
   quiz:[
     ...
     {q:"The Vietnam War had lasting effects on ___.", options:["No countries outside of Vietnam","Only ancient history","Political and social attitudes in many countries, including Canada","Nations with no involvement or connection to the war"], answer:2},
     {q:"Why is the Vietnam War often studied in the context of Cold War history?", options:["It was completely unrelated to global politics","It reflected broader tensions between opposing political systems during that era","It had no connection to Cold War tensions","It occurred before the Cold War began"], answer:1},
     {q:"Why might a war fought primarily in one country still have a significant global impact?", options:["Global impact is impossible from a single regional conflict","International alliances and public opinion can be affected far beyond the location of the conflict","Wars never have any impact beyond their immediate location","Only wars fought on multiple continents matter internationally"], answer:1}
   ]},
]},
{day:42, label:"Day 42 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing a Satirical Piece", summary:"Ontario Grade 7 Writing strand: satire uses humour, irony, or exaggeration to criticize or draw attention to flaws in society, people, or ideas.",
   ...
   quiz:[
     ...
     {q:"Which is an example of a technique commonly used in satire?", options:["Presenting only neutral, factual statements","Avoiding any criticism of the subject","Removing all humour from the piece","Exaggerating a flaw to make it seem absurd"], answer:3},
     {q:"Satire is often used to draw attention to ___.", options:["Only positive qualities with no criticism","Flaws in society, people, or ideas","Nothing of significance","Random, unrelated topics with no purpose"], answer:1},
     {q:"Why might readers need to think carefully when reading satire?", options:["Satire requires no interpretation at all","Readers never need to consider tone in satire","Satire is always completely literal with no hidden meaning","The exaggerated or ironic tone might not be immediately obvious"], answer:3}
   ]},
  {subject:"Math", title:"Exponent Laws: Multiplying and Dividing Powers", summary:"Ontario Grade 7 Number strand: when multiplying powers with the same base, add the exponents; when dividing powers with the same base, subtract the exponents.",
   ...
   quiz:[
     ...
     {q:"When multiplying powers with the same base, you should ___.", options:["Divide the exponents","Multiply the exponents","Subtract the exponents","Add the exponents"], answer:3},
     {q:"When dividing powers with the same base, you should ___.", options:["Add the exponents","Divide the bases","Subtract the exponents","Multiply the exponents"], answer:2},
     {q:"Simplify: 2 to the fourth power times 2 to the third power.", options:["2 to the seventh power","2 to the twelfth power","4 to the seventh power","2 to the first power"], answer:0}
   ]},
  {subject:"Science", title:"Biomes of the World", summary:"Ontario Grade 7 Science Earth and Space Systems strand: biomes are large regions characterized by distinct climate and communities of plants and animals adapted to those conditions, such as deserts, rainforests, and tundra.",
   ...
   quiz:[
     ...
     {q:"The tropical rainforest biome is known for its ___.", options:["High biodiversity and warm, wet climate","Permanent ice cover","Cold, treeless landscape","Extremely dry, sandy conditions"], answer:0},
     {q:"The tundra biome is characterized mainly by ___.", options:["Cold temperatures and a lack of trees","Coral reef ecosystems","Warm, tropical conditions","Dense rainforest vegetation"], answer:0},
     {q:"Why do organisms in different biomes have different adaptations?", options:["They must adjust to the specific climate and conditions of their biome","All biomes have identical conditions requiring no adaptation","Organisms never adapt to their environment","Adaptations have no connection to climate"], answer:0}
   ]},
  {subject:"SocialStudies", title:"The Fall of the Berlin Wall and the End of the Cold War", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: the fall of the Berlin Wall in 1989 symbolized the end of the Cold War era, leading to significant political changes in Europe, including German reunification.",
   ...
   quiz:[
     ...
     {q:"Following the fall of the Berlin Wall, Germany experienced ___.", options:["Permanent division into more countries","Reunification","A return to conflict with no resolution","No political change of any kind"], answer:1},
     {q:"Why is the fall of the Berlin Wall considered a major turning point in world history?", options:["It caused the Cold War to begin","It marked significant political change and reduced Cold War tensions in Europe","It had no lasting political significance","It was unrelated to Cold War tensions"], answer:1},
     {q:"The Berlin Wall had originally divided the city of Berlin into ___.", options:["Four unrelated countries","North and South sections only","No divisions at all","Eastern and Western sections"], answer:3}
   ]},
]},
{day:43, label:"Day 43 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Gerunds and Infinitives", summary:"Ontario Grade 7 Writing strand: a gerund is a verb form ending in -ing used as a noun (Swimming is fun), while an infinitive is the base form of a verb preceded by to (I want to swim).",
   ...
   quiz:[
     ...
     {q:"Which sentence contains a gerund?", options:["She swims every morning.","Swimming is my favourite activity.","They will swim later.","I want to swim today."], answer:1},
     {q:"Which sentence contains an infinitive?", options:["Swimming is relaxing.","She enjoys swimming.","I want to swim today.","Swimming builds strength."], answer:2},
     {q:"Why might a writer choose to use a gerund instead of a regular noun?", options:["Gerunds always replace the need for a subject","Gerunds are never grammatically correct","A gerund can add a sense of ongoing action to a sentence","There is no functional difference between a gerund and any noun"], answer:2}
   ]},
  {subject:"Math", title:"Volume and Surface Area of Composite 3D Shapes", summary:"Ontario Grade 7 Geometry strand: a composite 3D shape is made up of two or more basic solids combined, and its volume or surface area can be found by breaking it into simpler shapes and adding or subtracting their measurements.",
   ...
   quiz:[
     ...
     {q:"If a composite shape is made of a rectangular prism with volume 40 cubic units and a triangular prism with volume 15 cubic units attached, what is the total volume?", options:["55 cubic units","600 cubic units","40 cubic units","25 cubic units"], answer:0},
     {q:"Why might a real-world object, like a house-shaped storage shed, be considered a composite shape?", options:["A shed has no identifiable geometric shape","It combines multiple basic shapes, such as a rectangular prism and a triangular prism roof","It is made of only one simple shape","Composite shapes never appear in real life"], answer:1},
     {q:"When calculating the surface area of a composite shape, it is important to ___.", options:["Ignore all internal considerations completely","Only measure the shape’s volume, not surface area","Account for any internal faces that are not part of the outer surface","Assume all composite shapes have identical surface areas"], answer:2}
   ]},
  {subject:"Science", title:"Chemical Safety and WHMIS Symbols", summary:"Ontario Grade 7 Science Matter and Energy strand: WHMIS (Workplace Hazardous Materials Information System) symbols communicate important safety information about hazardous materials, helping people handle chemicals safely.",
   ...
   quiz:[
     ...
     {q:"Why is it important to recognize WHMIS symbols in a lab or workplace setting?", options:["They help people understand risks and handle materials safely","These symbols have no practical safety purpose","WHMIS symbols are purely decorative","Safety symbols are never used in real workplaces"], answer:0},
     {q:"A WHMIS symbol indicating a flammable material would likely warn about ___.", options:["No risk at all","A material unrelated to fire hazards","The risk of the material catching fire","A material that is completely safe to burn"], answer:2},
     {q:"Why might students learn about WHMIS symbols as part of science class?", options:["Chemical safety has no connection to science education","Safety information is unnecessary in a classroom setting","To build safe habits when working with materials in labs and other settings","WHMIS symbols are only relevant to a single profession"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Apartheid and the Struggle for Equality in South Africa", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: apartheid was a system of racial segregation and discrimination in South Africa, and its end in the early 1990s followed decades of resistance and advocacy for equality.",
   ...
   quiz:[
     ...
     {q:"Apartheid came to an end in the early ___.", options:["1950s","2010s","1900s","1990s"], answer:3},
     {q:"The end of apartheid followed decades of ___.", options:["Immediate, effortless political change","Complete indifference from the global community","No opposition of any kind","Resistance and advocacy for equality"], answer:3},
     {q:"Why is the history of apartheid studied as part of world history?", options:["It illustrates the impact of systemic discrimination and the importance of the struggle for equality","Apartheid never actually occurred","It has no historical significance","It has no connection to global discussions on equality"], answer:0}
   ]},
]},
{day:44, label:"Day 44 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Words with Multiple Meanings", summary:"Ontario Grade 7 Language strand: many English words have more than one meaning depending on context, and recognizing these multiple-meaning words (homographs) helps readers accurately interpret unfamiliar or ambiguous sentences.",
   resourceLabel:"YouTube: Vocabulary: Words with Multiple Meanings", resourceUrl:"https://www.youtube.com/results?search_query=Multiple%20Meaning%20Words%20grade%207%20educational",
   videoUrl:"https://www.youtube.com/watch?v=5CPReuxGK0A",
   quiz:[
     {q:"A word with multiple meanings is best described as a word that ___.", options:["Has more than one possible meaning depending on context","Can only ever be used one way","Has no connection to context at all","Is never found in everyday reading"], answer:0},
     {q:"Which sentence uses the word 'bat' with a different meaning than 'The bat flew out of the cave at night'?", options:["He swung the bat and hit a home run","The bat flew out of the cave at night","A bat is a nocturnal flying mammal","Bats use echolocation to find food"], answer:0},
     {q:"Why is context especially important when reading a word with multiple meanings?", options:["Context is never useful for understanding meaning","Every meaning of a word is always identical","Context has no connection to word meaning","Context helps the reader determine which meaning the writer intends"], answer:3},
     {q:"The word 'right' can mean 'correct' or ___ depending on context.", options:["A direction opposite of left","A type of vocabulary word","Something with no other meaning","A word that is never ambiguous"], answer:0},
     {q:"Why might a dictionary list several definitions under a single word entry?", options:["Dictionaries only ever list one definition per word","That word has multiple meanings used in different contexts","Definitions are listed randomly with no purpose","Multiple definitions indicate a printing error"], answer:1}
   ]},
  {subject:"Math", title:"Data: Outliers and Their Effect on Statistics", summary:"Ontario Grade 7 Data Management strand: an outlier is a data value that is significantly higher or lower than the rest of a data set, and it can strongly affect statistics like the mean.",
   ...
   quiz:[
     ...
     {q:"In the data set 2, 3, 4, 5, 50, which value is the outlier?", options:["3","50","2","4"], answer:1},
     {q:"Why might statisticians examine a data set for outliers before calculating the mean?", options:["An outlier can skew the mean and make it less representative of the typical values","The mean should always be calculated without checking for outliers","Outliers should never be considered in statistics","Outliers have no effect on any calculation"], answer:0},
     {q:"Compared to the mean, the median is generally ___ affected by outliers.", options:["More","Equally","Never","Less"], answer:3}
   ]},
  {subject:"Science", title:"Robotics and Automation in Technology", summary:"Ontario Grade 7 Science and Technology strand: robotics involves designing machines that can perform tasks automatically, often using sensors and programming to interact with their environment.",
   ...
   quiz:[
     ...
     {q:"Automation refers to ___.", options:["A process with no connection to technology","Tasks that always require constant human control","Machines that can never repeat a task","Technology performing tasks with little or no human intervention"], answer:3},
     {q:"Which is an example of a real-world application of robotics?", options:["A basic hand tool with no automation","A drawing made without any technology","A robotic arm assembling products in a factory","A book with no technological components"], answer:2},
     {q:"Why is understanding robotics increasingly relevant in today’s world?", options:["Robotics has no real-world applications","Robotics has no connection to modern technology","Robots are used exclusively in fictional stories","Automation and robotics are used across many industries and everyday technologies"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The United Nations and Peacekeeping", summary:"Ontario Grade 7 Social Studies People and Environments strand: United Nations peacekeeping missions involve international forces working to maintain or restore peace in regions affected by conflict, with Canada historically playing a notable role.",
   ...
   quiz:[
     ...
     {q:"Canada has historically been recognized for its role in ___.", options:["Avoiding all international involvement","Opposing the United Nations entirely","United Nations peacekeeping efforts","A role unrelated to international peace efforts"], answer:2},
     {q:"Why might the United Nations organize peacekeeping missions instead of relying on a single country to act alone?", options:["International cooperation can bring broader legitimacy and shared resources to peace efforts","Peacekeeping missions never require cooperation between countries","International cooperation has no benefit in peacekeeping efforts","A single country always resolves conflicts more effectively alone"], answer:0},
     {q:"Why is learning about peacekeeping relevant to understanding international relations?", options:["Peacekeeping missions have never actually taken place","Conflicts are never addressed through international cooperation","It shows how countries can work together to address global conflicts","Peacekeeping has no connection to international relations"], answer:2}
   ]},
]},
{day:45, label:"Day 45 — Fri", subjects:[
  {subject:"Language", title:"Reading: Evaluating Counterarguments in Persuasive Texts", summary:"Ontario Grade 7 Reading strand: a counterargument acknowledges an opposing viewpoint, and evaluating how effectively a writer addresses it helps readers judge the overall strength of a persuasive text.",
   ...
   quiz:[
     ...
     {q:"An effective response to a counterargument typically ___.", options:["Explains why the writer’s position still holds despite the opposing view","Ignores the counterargument completely after mentioning it","Simply restates the counterargument with no response","Contradicts the writer’s own argument"], answer:0},
     {q:"Why is evaluating how a writer handles counterarguments useful for readers?", options:["This evaluation has no value for readers","It helps readers judge how well-reasoned and balanced the argument truly is","Readers should never question a persuasive text’s reasoning","Counterarguments are never relevant to understanding an argument"], answer:1},
     {q:"Which is an example of effectively addressing a counterargument?", options:["Changing the topic entirely to avoid the opposing view","Agreeing completely with the opposing view with no further explanation","Refusing to mention any opposing views","Acknowledging the opposing view, then explaining why the evidence still supports the writer’s position"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Angle Relationships in Polygons", summary:"Ontario Grade 7 Geometry strand: the sum of interior angles in a polygon can be calculated using the formula (n minus 2) times 180 degrees, where n represents the number of sides.",
   ...
   quiz:[
     ...
     {q:"The formula for the sum of interior angles in a polygon is ___.", options:["(n minus 2) times 180 degrees","n times 180 degrees","n times 360 degrees","(n plus 2) times 90 degrees"], answer:0},
     {q:"What is the sum of interior angles in a pentagon (5 sides)?", options:["360 degrees","720 degrees","540 degrees","450 degrees"], answer:2},
     {q:"Why is the interior angle sum formula useful when working with polygons?", options:["Angle sums are always identical for every polygon regardless of sides","It has no practical use in geometry","It only applies to triangles","It allows you to calculate missing angles without measuring each one directly"], answer:3}
   ]},
  {subject:"Science", title:"The Respiratory and Circulatory Systems", summary:"Ontario Grade 7 Science Human Body Systems strand: the respiratory system brings oxygen into the body and removes carbon dioxide, while the circulatory system transports that oxygen and other nutrients throughout the body.",
   ...
   quiz:[
     ...
     {q:"The heart is the main organ of the ___ system.", options:["Digestive","Excretory","Respiratory","Circulatory"], answer:3},
     {q:"The lungs are the main organs of the ___ system.", options:["Digestive","Respiratory","Excretory","Circulatory"], answer:1},
     {q:"How do the respiratory and circulatory systems work together?", options:["The circulatory system brings in air directly","The respiratory system pumps blood throughout the body","They function with no connection to each other","Oxygen brought in by the respiratory system is transported through the body by the circulatory system"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Canada’s Multiculturalism Policy in Depth", summary:"Ontario Grade 7 Social Studies Heritage and Identity strand: Canada became the first country to adopt an official multiculturalism policy in 1971, aiming to recognize and support the cultural diversity of its population.",
   ...
   quiz:[
     ...
     {q:"The goal of Canada’s multiculturalism policy is to ___.", options:["Eliminate all cultural diversity","Require all citizens to share an identical culture","Recognize and support the cultural diversity of its population","Ignore the cultural backgrounds of Canadians"], answer:2},
     {q:"Why might Canada’s multiculturalism policy be seen as connected to its identity as a nation?", options:["The policy was created with no consideration of Canadian history","It reflects Canada’s history of immigration and diverse population","It has no connection to Canada’s history or identity","Canada has never had a diverse population"], answer:1},
     {q:"Why is studying multiculturalism policy relevant to understanding modern Canada?", options:["Multiculturalism has no connection to Canadian identity","The policy has never influenced Canadian society","This policy has no relevance to modern Canadian society","It helps explain how Canada approaches diversity and inclusion as a country"], answer:3}
   ]},
]},
{day:46, label:"Day 46 — Mon", subjects:[
  {subject:"Language", title:"Writing: Writing a Speech for a Specific Audience", summary:"Ontario Grade 7 Writing strand: writing an effective speech requires considering the specific audience’s interests, knowledge, and expectations to choose appropriate language, tone, and content.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Writing a speech for a specific audience requires considering ___.", options:["A random, unrelated topic","The audience’s interests, knowledge, and expectations","Nothing about who will be listening","Only the speaker’s personal preferences"], answer:1},
     {q:"Why might a speech for young children use different language than a speech for adults?", options:["Language should be appropriate to the audience’s age and understanding","All speeches should use identical vocabulary regardless of audience","Audience consideration has no effect on speech writing","Language never needs to change based on audience"], answer:0},
     {q:"Which is an example of adapting a speech for a specific audience?", options:["Avoiding any connection to the audience’s interests","Using relevant examples the audience is likely to understand and connect with","Using only complex vocabulary regardless of the audience","Ignoring who will be listening to the speech"], answer:1},
     {q:"Why is tone an important consideration when writing a speech for a particular audience?", options:["Speeches should always sound exactly the same regardless of audience","Tone only matters in written essays, not speeches","The right tone helps the message resonate and be well received","Tone has no effect on how a speech is received"], answer:2},
     {q:"Considering audience expectations can help a speech writer decide ___.", options:["That audience has no connection to speech writing","Nothing useful about how to write the speech","What content and structure will be most effective and appropriate","To ignore the purpose of the speech entirely"], answer:2}
   ]},
  {subject:"Math", title:"Financial Literacy: Currency Exchange and Conversion", summary:"Ontario Grade 7 Financial Literacy strand: currency exchange involves converting money from one currency to another using an exchange rate, which represents how much one currency is worth compared to another.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"An exchange rate represents ___.", options:["How much one currency is worth compared to another","The total amount of money in a country","Only how much tax is charged","A fixed amount that never changes"], answer:0},
     {q:"If the exchange rate is 1 Canadian dollar equals 0.75 US dollars, how many US dollars would you get for 100 Canadian dollars?", options:["$100 US","$75 US","$133 US","$25 US"], answer:1},
     {q:"Why might exchange rates change over time?", options:["They are influenced by economic factors that can shift regularly","Exchange rates always stay exactly the same forever","Currency values never change under any circumstances","Exchange rates have no connection to economics"], answer:0},
     {q:"Why is understanding currency exchange useful when travelling to another country?", options:["It helps travellers understand the real value and cost of items in a foreign currency","Currency exchange has no relevance when travelling","Understanding exchange rates serves no practical purpose","All countries use the exact same currency value"], answer:0},
     {q:"If 1 Canadian dollar equals 1.5 units of another currency, how many units would 20 Canadian dollars convert to?", options:["20 units","30 units","35 units","15 units"], answer:1}
   ]},
  {subject:"Science", title:"Renewable vs. Non-Renewable Resources: Global Perspectives", summary:"Ontario Grade 7 Science Matter and Energy strand: countries around the world rely differently on renewable resources, like solar and wind, and non-renewable resources, like coal and oil, based on geography, technology, and economic factors.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"A country’s reliance on renewable versus non-renewable resources can depend on ___.", options:["A completely random, unrelated factor","Nothing related to its location or economy","Only the size of the country, with no other influence","Its geography, technology, and economic factors"], answer:3},
     {q:"Which is an example of a renewable resource used differently around the world?", options:["A resource that never varies by region","Solar energy, which is more effective in sunnier regions","Oil, which is considered renewable","Coal, which is considered renewable"], answer:1},
     {q:"Non-renewable resources, such as oil and coal, are considered limited because they ___.", options:["Can be replenished within days","Are available in unlimited supply everywhere","Take an extremely long time to form and can eventually run out","Have no connection to geography"], answer:2},
     {q:"Why might some countries invest more heavily in renewable energy than others?", options:["Every country has identical access to every energy source","Renewable energy investment is unrelated to geography or economics","Available natural resources, technology, and economic priorities can vary by country","All countries rely on the exact same energy sources"], answer:2},
     {q:"Why is understanding global resource use important when studying environmental science?", options:["Global resource use has no connection to environmental science","All countries use resources in an identical way","This topic has no real-world relevance","It helps explain differences in energy policy and environmental impact around the world"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Trade Agreements and Their Effects on Canada", summary:"Ontario Grade 7 Social Studies People and Environments strand: trade agreements between countries establish rules for buying and selling goods and services, affecting Canada’s economy, industries, and international relationships.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"A trade agreement is best described as ___.", options:["A rule that prevents all trade between countries","An agreement establishing rules for trade between countries","An agreement unrelated to buying or selling goods","A policy that only applies within a single country"], answer:1},
     {q:"Trade agreements can affect Canada’s ___.", options:["Only its population size","Nothing related to its economy","Only its weather patterns","Economy and industries"], answer:3},
     {q:"Why might Canada choose to enter into a trade agreement with another country?", options:["They have no connection to international relationships","Trade agreements are illegal for Canada to enter","To create more favourable conditions for trade, such as reduced tariffs","Trade agreements provide no economic benefit"], answer:2},
     {q:"Which is a potential effect of a trade agreement on a specific Canadian industry?", options:["Increased access to new markets or increased competition","The complete elimination of that industry with no other outcome","A guaranteed benefit with no possible drawbacks","No effect on any industry whatsoever"], answer:0},
     {q:"Why is it useful for citizens to understand how trade agreements affect their economy?", options:["Citizens do not need to understand economic policy","It helps them understand economic changes that may affect jobs and prices","Trade agreements have no connection to daily economic life","Trade agreements never have any real-world effects"], answer:1}
   ]},
]},
{day:47, label:"Day 47 — Tue", subjects:[
  ...
  {subject:"Math", title:"Rational and Irrational Numbers: An Introduction", summary:"Ontario Grade 7 Number strand: a rational number can be written as a fraction of two integers, while an irrational number, such as pi, cannot be expressed exactly as a simple fraction.",
   ...
   quiz:[
     ...
     {q:"An irrational number, when written as a decimal, is ___.", options:["Non-terminating and non-repeating","Always able to be written as a simple fraction","Always a whole number","Always equal to zero"], answer:0},
     {q:"Which of these is an example of a rational number?", options:["Pi","A non-repeating, non-terminating decimal","3/4","The square root of 2"], answer:2},
     {q:"Why might the square root of a non-perfect-square number, like the square root of 7, be considered irrational?", options:["All square roots are automatically rational","It can always be written as a simple fraction","It is always a whole number","It cannot be expressed exactly as a simple fraction and its decimal never terminates or repeats"], answer:3}
   ]},
  {subject:"Science", title:"The Immune System and Disease Prevention", summary:"Ontario Grade 7 Science Human Body Systems strand: the immune system defends the body against pathogens, and practices like vaccination, handwashing, and proper nutrition can help support the immune system and prevent disease.",
   ...
   quiz:[
     ...
     {q:"Vaccines work by helping the immune system ___.", options:["Stop functioning altogether","Ignore all future infections","Weaken permanently","Recognize and respond more quickly to specific pathogens in the future"], answer:3},
     {q:"Proper nutrition can support the immune system by ___.", options:["Providing the body with resources needed for healthy immune function","Having no connection to immune health","Replacing the need for any immune response","Weakening the immune system intentionally"], answer:0},
     {q:"Why is understanding disease prevention considered important for public health?", options:["Preventing illness has no connection to community wellbeing","Public health has no relationship to individual health practices","Disease prevention has no effect on public health","Preventive practices can help reduce the spread of illness within communities"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Refugee Crises and International Response", summary:"Ontario Grade 7 Social Studies People and Environments strand: a refugee crisis occurs when large numbers of people are forced to flee their home country due to conflict or persecution, often requiring coordinated international humanitarian response.",
   ...
   quiz:[
     ...
     {q:"Which organization might be involved in responding to a refugee crisis?", options:["The United Nations","A local, unrelated sports club","An organization with no connection to humanitarian issues","A group uninvolved in international affairs"], answer:0},
     {q:"Why might countries choose to accept refugees during a crisis?", options:["Refugee crises have no connection to international cooperation","To provide safety and support for people fleeing dangerous conditions","Accepting refugees provides no humanitarian benefit","Countries are never involved in refugee resettlement"], answer:1},
     {q:"Why is understanding refugee crises important in studying global issues?", options:["It highlights the human impact of conflict and the importance of international cooperation","Refugee crises never require any international attention","This topic has no relevance to social studies","Refugee crises have no connection to global issues"], answer:0}
   ]},
]},
{day:48, label:"Day 48 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Correcting Dangling and Misplaced Modifiers", summary:"Ontario Grade 7 Writing strand: a dangling modifier lacks a clear word to describe, while a misplaced modifier is positioned too far from the word it describes, both of which can create confusing or unintended meanings.",
   ...
   quiz:[
     ...
     {q:"Which sentence contains a dangling modifier? Running quickly, the finish line came into view.", options:["The finish line was near the runner.","This sentence","She ran quickly toward the finish line.","The runner crossed the finish line quickly."], answer:1},
     {q:"Why is it important to fix dangling and misplaced modifiers in writing?", options:["These issues never affect a sentence’s meaning","To avoid confusing or unintended meanings in a sentence","Clarity has no connection to modifier placement","Modifiers should always be placed randomly"], answer:1},
     {q:"Which is a corrected version of a sentence with a misplaced modifier? Wearing a red jacket, I saw my friend.", options:["Wearing a red jacket, my friend I saw.","Neither sentence contains a modifier.","I saw my friend wearing a red jacket.","Both versions mean the exact same thing with no ambiguity."], answer:2}
   ]},
  {subject:"Math", title:"Solving Equations with Variables on Both Sides", summary:"Ontario Grade 7 Algebra strand: solving an equation with variables on both sides involves first combining variable terms onto one side, then using inverse operations to isolate the variable.",
   ...
   quiz:[
     ...
     {q:"When solving an equation with variables on both sides, the first step is often to ___.", options:["Ignore one side of the equation entirely","Immediately guess the answer","Multiply both sides by zero","Combine the variable terms onto one side"], answer:3},
     {q:"Solve for n: 4n + 6 = 2n + 16.", options:["n = 3","n = 10","n = 5","n = 22"], answer:2},
     {q:"Solve for m: 6m minus 3 = 3m + 12.", options:["m = 9","m = 3","m = 5","m = 15"], answer:2}
   ]},
  {subject:"Science", title:"Space Exploration: Missions and Technology", summary:"Ontario Grade 7 Science Earth and Space Systems strand: space exploration relies on missions and technologies such as rockets, satellites, and space stations to study space and expand human understanding of the universe.",
   ...
   quiz:[
     ...
     {q:"Satellites launched into space are often used for ___.", options:["Preventing all forms of communication","Communication and scientific observation","Only entertainment, with no other function","No practical purpose"], answer:1},
...
{day:49, label:"Day 49 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing an Op-Ed (Opinion Editorial)", summary:"Ontario Grade 7 Writing strand: an op-ed presents a writer’s opinion on a current issue, supported by reasoning and evidence, often published to persuade or inform public opinion.",
   ...
   quiz:[
     ...
     {q:"Why might a writer choose to write an op-ed about a current issue?", options:["To persuade or inform public opinion on a topic they care about","Op-eds never discuss real or current issues","Op-eds are always purely factual with no opinion involved","Writing an op-ed serves no persuasive purpose"], answer:0},
     {q:"Which is an example of a strong op-ed opening?", options:["This piece has no clear topic.","Some things happen sometimes.","This is an article.","Our city urgently needs improved public transportation, and here is why."], answer:3},
     {q:"Why is it useful for an op-ed to consider opposing viewpoints?", options:["Considering other viewpoints always weakens an op-ed","This consideration has no effect on persuasive writing","Op-eds should never mention any opposing views","Addressing other perspectives can strengthen the credibility of the writer’s argument"], answer:3}
   ]},
  {subject:"Math", title:"Probability: Expected Value", summary:"Ontario Grade 7 Data Management strand: expected value is the average outcome you would predict over many trials, calculated by multiplying each possible outcome by its probability and adding the results together.",
   ...
   quiz:[
     ...
     {q:"If a game has a 50 percent chance of winning $10 and a 50 percent chance of winning $0, what is the expected value?", options:["$10","$5","$0","$20"], answer:1},
     {q:"Why might a business use expected value when evaluating a decision involving risk?", options:["Expected value guarantees an exact outcome every single time","Businesses never consider probability in decision-making","Expected value has no practical business application","It helps estimate the average outcome over many repeated situations"], answer:3},
     {q:"If a raffle ticket has a 1 in 100 chance of winning $200 and otherwise wins $0, what is its expected value?", options:["$2","$200","$100","$0"], answer:0}
   ]},
  {subject:"Science", title:"Erosion, Deposition, and Landform Change", summary:"Ontario Grade 7 Science Earth and Space Systems strand: erosion moves weathered rock and soil, while deposition occurs when that material settles in a new location, together gradually reshaping landforms over time.",
   ...
   quiz:[
     ...
     {q:"Which of these can cause both erosion and deposition?", options:["Rivers and wind","Nothing natural causes these processes","Only complete stillness","Only artificial materials"], answer:0},
     {q:"A river delta is often formed through the process of ___.", options:["Deposition","A process unrelated to rivers","Only erosion, with no deposition involved","Neither erosion nor deposition"], answer:0},
     {q:"Why might erosion and deposition together take thousands of years to significantly reshape a landform?", options:["Landforms cannot change through natural processes","These processes have no connection to landform formation","Landform changes always occur within a single day","These processes typically occur gradually rather than instantly"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Climate Change Policy and International Agreements", summary:"Ontario Grade 7 Social Studies People and Environments strand: countries often work together through international agreements to address climate change, setting shared goals for reducing greenhouse gas emissions and supporting sustainable development.",
   ...
   quiz:[
     ...
     {q:"Which is an example of a goal commonly included in climate policy agreements?", options:["Increasing pollution with no limits","Ignoring environmental impact entirely","Reducing greenhouse gas emissions over time","Eliminating all forms of international cooperation"], answer:2},
     {q:"Sustainable development, often connected to climate policy, focuses on ___.", options:["Ignoring the needs of future generations entirely","A concept unrelated to climate policy","Development that has no connection to environmental impact","Meeting current needs without compromising the ability of future generations to meet theirs"], answer:3},
     {q:"Why is it useful for students to study international climate policy?", options:["Climate policy has no connection to global issues","International climate agreements have never actually existed","This topic has no relevance to social studies","It helps them understand how countries collaborate to address a shared global challenge"], answer:3}
   ]},
]},
{day:50, label:"Day 50 — Fri", subjects:[
  ...
  {subject:"Math", title:"Review: Algebra, Exponents, Probability, and Geometry", summary:"Ontario Grade 7 Number and Geometry strands review: this lesson revisits systems of linear relations, exponent laws, expected value, angle relationships in polygons, and equations with variables on both sides.",
   ...
   quiz:[
     ...
     {q:"What is the sum of interior angles in a hexagon (6 sides)?", options:["900 degrees","720 degrees","360 degrees","540 degrees"], answer:1},
     {q:"If a raffle ticket has a 1 in 50 chance of winning $100, what is its expected value?", options:["$1","$2","$50","$100"], answer:1},
     {q:"Why is it useful to review algebra, exponents, probability, and geometry together?", options:["Review is never useful in math","Each topic must be learned in complete isolation","These topics have no connection to each other","These related math concepts reinforce each other for stronger overall understanding"], answer:3}
   ]},
  {subject:"Science", title:"Review: Body Systems, Technology, and Earth Processes", summary:"Ontario Grade 7 Science review: this lesson revisits the endocrine, respiratory, circulatory, and immune systems, robotics, WHMIS symbols, space exploration, and erosion and deposition covered across recent lessons.",
   ...
   quiz:[
     ...
     {q:"WHMIS symbols are used to communicate information about ___.", options:["Musical instruments","Space missions","Weather patterns","Hazardous materials"], answer:3},
     {q:"Erosion and deposition together gradually reshape ___.", options:["Landforms","The solar system","The human body","Robotic technology"], answer:0},
     {q:"Why is it valuable to review body systems, technology, and Earth processes together?", options:["These topics are entirely unrelated to each other","Each topic must always be studied in isolation","It helps connect and reinforce related science concepts learned across recent lessons","Review provides no benefit in science"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Review: 20th-Century History and Global Citizenship", summary:"Ontario Grade 7 Social Studies review: this lesson revisits the Vietnam War, the fall of the Berlin Wall, apartheid, peacekeeping, multiculturalism, trade agreements, refugee crises, technology and government, and climate policy.",
   ...
   quiz:[
     ...
     {q:"United Nations peacekeeping missions aim to ___.", options:["Maintain or restore peace in regions affected by conflict","Replace national governments","Avoid any international involvement","Increase global conflict"], answer:0},
     {q:"A refugee is generally someone forced to flee their home country due to ___.", options:["A vacation choice","A routine work assignment","A school field trip","Conflict or persecution"], answer:3},
     {q:"Why is it useful to review 20th-century history and global citizenship topics together?", options:["Each topic must be studied with no connection to the others","These topics have no meaningful connections","Review is never useful in social studies","It helps reinforce how historical events connect to ongoing global cooperation and citizenship today"], answer:3}
   ]},
]},
{day:51, label:"Day 51 — Mon", subjects:[
  ...
  {subject:"Math", title:"Solving and Graphing Inequalities on a Number Line", summary:"Grade 7 Math strand: solving an inequality finds the range of values that make it true, and graphing it on a number line uses an open or closed circle and an arrow to show that range.",
   ...
   quiz:[
     ...
     {q:"On a number line, a closed (filled-in) circle at a point means ___.", options:["A concept unrelated to graphing inequalities","That value is included in the solution","That value is not included in the solution","The inequality has no solution"], answer:1},
     {q:"If x ≥ 4, which type of circle would be used at 4 on the number line?", options:["An open circle","A circle unrelated to this inequality","A closed (filled-in) circle","No circle would be used at all"], answer:2},
     {q:"Solve for x: 2x < 10.", options:["x < 12","x < 5","A solution unrelated to the inequality","x < 20"], answer:1}
   ]},
  {subject:"Science", title:"Newton’s Laws of Motion (Intro)", summary:"Grade 7 Science strand: Newton’s three laws of motion describe how objects behave when forces act on them, including inertia, the relationship between force and acceleration, and action-reaction pairs.",
   ...
   quiz:[
     ...
     {q:"Newton’s third law of motion states that ___.", options:["For every action, there is an equal and opposite reaction","Objects in motion always eventually speed up on their own","Forces never have any reaction at all","A concept unrelated to Newton’s laws"], answer:0},
     {q:"Which is an example of Newton’s third law in action?", options:["A ball sitting still on a table with no forces acting on it","A swimmer pushing water backward to move forward","A concept unrelated to Newton’s laws","An object that never interacts with any other object"], answer:1},
     {q:"Why are Newton’s laws considered fundamental to understanding motion?", options:["Newton’s laws only apply to objects in outer space","These laws have no connection to how objects move","They explain how and why objects move or stay still under different forces","A reason unrelated to physics"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The League of Nations and Its Legacy", summary:"Grade 7 Social Studies strand: the League of Nations was an international organization formed after World War I to promote peace and cooperation between countries, though it ultimately struggled to prevent future conflict.",
   ...
   quiz:[
     ...
     {q:"Which of these contributed to the League of Nations’ struggles?", options:["It lacked the power to enforce its decisions on member countries","A reason unrelated to the League of Nations","It had no connection to preventing conflict","Every country in the world immediately joined and fully supported it"], answer:0},
     {q:"Why is the League of Nations often discussed alongside the later United Nations?", options:["The United Nations was formed long before the League of Nations","A reason unrelated to international organizations","The League’s shortcomings influenced the design of the UN as its successor organization","The League of Nations and the United Nations have no historical connection"], answer:2},
     {q:"Why do historians study the League of Nations today?", options:["The League of Nations has no relevance to understanding global history","It successfully prevented all future global conflicts","A reason unrelated to social studies learning","It offers important lessons about the challenges of international cooperation"], answer:3}
   ]},
]},
{day:52, label:"Day 52 — Tue", subjects:[
  {subject:"Language", title:"Grammar: Parallel Structure in Complex Sentences", summary:"Grade 7 Language strand: parallel structure in complex sentences means keeping grammatically similar elements consistent, even across clauses joined by conjunctions like “although” or “because.”",
   ...
   quiz:[
     ...
     {q:"Which sentence uses correct parallel structure in a complex sentence?", options:["Although he was tired, he finished his homework and cleaned his room.","Although he was tired, he finished his homework and was cleaning his room.","A sentence unrelated to parallel structure","Although being tired, he finished his homework and cleaned his room."], answer:0},
     {q:"Why is parallel structure especially important in complex sentences with multiple clauses?", options:["A reason unrelated to grammar","Complex sentences never need to follow consistent grammatical patterns","It keeps the sentence clear and grammatically consistent despite its added complexity","Parallel structure only matters in short, simple sentences"], answer:2},
     {q:"Which phrase breaks parallel structure?", options:["“running, jumping, and to climb”","“running, jumping, and climbing”","A phrase unrelated to parallel structure","“to run, to jump, and to climb”"], answer:0}
   ]},
  {subject:"Math", title:"Polynomials: Introduction to Terms and Like Terms", summary:"Grade 7 Math strand: a polynomial is an expression made up of terms combined with addition or subtraction, and like terms have the same variable raised to the same power and can be combined.",
   ...
   quiz:[
     ...
     {q:"Which of these are like terms?", options:["3x and 7x","3x and 7y","3x and 7x²","Terms unrelated to this concept"], answer:0},
     {q:"Simplify: 4x + 3x.", options:["7x","7x²","12x","A value unrelated to the calculation"], answer:0},
     {q:"Why can 5y and 5y² not be combined as like terms?", options:["A reason unrelated to like terms","They have the same variable but different exponents","Terms can never be combined under any circumstances","They have completely different variables"], answer:1}
   ]},
  {subject:"Science", title:"The Water Cycle and Its Connection to Climate", summary:"Grade 7 Science strand: the water cycle describes how water moves through evaporation, condensation, and precipitation, and it plays a key role in shaping regional and global climate patterns.",
   ...
   quiz:[
     ...
     {q:"Condensation occurs when ___.", options:["Water vapour changes into liquid water droplets","A process unrelated to condensation","Liquid water changes into water vapour","Water changes directly into ice"], answer:0},
     {q:"How does the water cycle influence regional climate?", options:["Climate is determined with no involvement from water at all","A reason unrelated to the water cycle","It affects patterns of rainfall, humidity, and temperature in different regions","The water cycle has no connection to climate at all"], answer:2},
     {q:"Why might scientists study changes in the water cycle when studying climate change?", options:["The water cycle has no connection to climate change","A reason unrelated to environmental science","Shifts in evaporation and precipitation patterns can signal broader climate changes","The water cycle never changes over time"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Canada’s Immigration Policy: Historical Changes", summary:"Grade 7 Social Studies strand: Canada’s immigration policy has changed significantly over time, shifting from restrictive and discriminatory practices to a points-based system aimed at welcoming diverse newcomers.",
   ...
   quiz:[
     ...
     {q:"Why might a country change its immigration policies over time?", options:["Economic needs, social values, and global events can all influence policy changes","A reason unrelated to immigration policy","Immigration policies never change once they are established","Policy changes have no connection to a country’s needs or values"], answer:0},
     {q:"Why is it important to study the history of Canada’s immigration policy?", options:["It helps explain how Canada’s population and society have developed and changed","Immigration policy has remained exactly the same throughout Canadian history","This history has no connection to understanding Canada today","A reason unrelated to social studies learning"], answer:0},
     {q:"Which of these reflects a shift toward more inclusive immigration policy?", options:["Closing Canada’s borders to all immigration entirely","Adding new restrictions based on a person’s country of origin","A concept unrelated to immigration policy","Removing restrictions based on a person’s country of origin"], answer:3}
   ]},
]},
{day:53, label:"Day 53 — Wed", subjects:[
  {subject:"Language", title:"Writing: Writing a Compare and Contrast Essay", summary:"Grade 7 Language strand: a compare and contrast essay examines the similarities and differences between two subjects, often organized point-by-point or subject-by-subject.",
   ...
   quiz:[
     ...
     {q:"In a subject-by-subject structure, a writer organizes the essay by ___.", options:["Avoiding any clear structure altogether","Discussing one point of comparison at a time for both subjects","Discussing all of one subject, then all of the other subject","A concept unrelated to essay structure"], answer:2},
     {q:"Which transition word might signal a similarity in a compare and contrast essay?", options:["However","Although","Similarly","A word unrelated to signaling similarity"], answer:2},
     {q:"Why might a writer choose to compare and contrast two subjects in an essay?", options:["A reason unrelated to writing","To avoid discussing either subject in any detail","To help readers understand each subject more clearly through comparison","Comparing subjects never adds any value to an essay"], answer:2}
   ]},
  {subject:"Math", title:"The Pythagorean Theorem: Applications", summary:"Grade 7 Math strand: the Pythagorean theorem (a² + b² = c²) can be applied to real-world problems, such as finding the shortest distance across a rectangular field or checking whether a corner is a right angle.",
   ...
   quiz:[
     ...
     {q:"If a right triangle has legs of 6 and 8, what is the length of the hypotenuse?", options:["10","14","A value unrelated to the calculation","48"], answer:0},
     {q:"Which of these is a real-world application of the Pythagorean theorem?", options:["Finding the average of a set of numbers","Finding the shortest diagonal distance across a rectangular field","Measuring the temperature of a room","A concept unrelated to the Pythagorean theorem"], answer:1},
     {q:"The Pythagorean theorem can only be applied to a triangle that is ___.", options:["An equilateral triangle","Any triangle with no specific requirements","A type of triangle unrelated to this theorem","A right triangle"], answer:3}
   ]},
  {subject:"Science", title:"Sound Waves: Pitch, Volume, and Frequency", summary:"Grade 7 Science strand: sound travels as waves, and its pitch is determined by frequency (how many vibrations per second) while its volume is determined by amplitude (the size of the vibration).",
   ...
   quiz:[
     ...
     {q:"A higher frequency sound wave produces a ___ pitch.", options:["A pitch unrelated to frequency","Lower","Silent","Higher"], answer:3},
     {q:"A larger amplitude sound wave produces a ___ volume.", options:["A volume unrelated to amplitude","Silent","Louder","Quieter"], answer:2},
     {q:"Why might a small object, like a whistle, tend to produce a higher pitch than a large object, like a tuba?", options:["Larger objects always produce higher pitches than smaller ones","A reason unrelated to sound waves","Object size has no connection to the pitch it produces","Smaller objects generally vibrate at higher frequencies than larger objects"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Marshall Plan and European Reconstruction", summary:"Grade 7 Social Studies strand: the Marshall Plan was a large-scale American aid program launched after World War II to help rebuild the economies of war-torn European countries.",
   ...
   quiz:[
     ...
     {q:"Why might economic aid have been especially important for Europe after World War II?", options:["Many countries faced widespread destruction and needed support to rebuild","European countries faced no economic challenges after the war","Economic aid had no effect on rebuilding efforts","A reason unrelated to post-war reconstruction"], answer:0},
     {q:"Which country launched the Marshall Plan?", options:["A country that no longer exists today","A country unrelated to the Marshall Plan","Canada","The United States"], answer:3},
     {q:"Why is the Marshall Plan still studied as an example of international cooperation?", options:["It shows how aid can help rebuild economies and stability after a major conflict","A reason unrelated to its historical significance","It focused only on military strategy, with no economic component","The Marshall Plan had no lasting effect on Europe’s recovery"], answer:0}
   ]},
]},
{day:54, label:"Day 54 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Analogies and Word Relationships", summary:"Grade 7 Language strand: an analogy compares two pairs of words that share a similar relationship, such as synonym, antonym, cause-and-effect, or part-to-whole relationships.",
   ...
   quiz:[
     ...
     {q:"What relationship does the analogy “spark is to fire as seed is to plant” show?", options:["Cause and effect","Antonyms","A relationship unrelated to analogies","Synonyms"], answer:0},
     {q:"Complete the analogy: Enormous is to huge as tiny is to ___.", options:["Gigantic","Small","Loud","A word unrelated to the analogy"], answer:1},
     {q:"Why are analogies a useful vocabulary tool?", options:["Analogies only apply to numbers, not words","Analogies never help with understanding vocabulary","A concept unrelated to vocabulary building","They help build understanding of relationships between words and concepts"], answer:3}
   ]},
  {subject:"Math", title:"Volume and Surface Area of Spheres (Intro)", summary:"Grade 7 Math strand: the volume of a sphere is found using the formula (4/3)πr³, and its surface area is found using the formula 4πr², where r is the radius.",
   ...
   quiz:[
     ...
     {q:"In the sphere formulas, what does “r” represent?", options:["The radius of the sphere","The circumference of the sphere","A value unrelated to spheres","The diameter of the sphere"], answer:0},
     {q:"If a sphere has a radius of 3, what is its approximate volume using π ≈ 3.14?", options:["A value unrelated to the calculation","About 113.04 cubic units","About 28.26 cubic units","About 9 cubic units"], answer:1},
     {q:"Why might understanding the volume of a sphere be useful in real life?", options:["Sphere volume calculations have no real-world use","A reason unrelated to spheres","Spheres never have a measurable volume","It helps calculate the capacity of round objects, like balls or tanks"], answer:3}
   ]},
  {subject:"Science", title:"Structures: Load, Stress, and Material Strength", summary:"Grade 7 Science strand: a structure must withstand different types of load and stress, and engineers select materials based on their strength, flexibility, and ability to resist these forces.",
   ...
   quiz:[
     ...
     {q:"Why might an engineer choose a flexible material for a structure in an earthquake-prone area?", options:["A reason unrelated to materials engineering","Flexibility has no connection to how a structure performs in an earthquake","Rigid materials are always safer in earthquake-prone areas","Flexible materials can absorb and withstand shifting forces without breaking"], answer:3},
     {q:"Which of these is an example of a structure experiencing load?", options:["A bridge supporting the weight of passing vehicles","A material with no connection to forces at all","A concept unrelated to load","A structure with nothing resting on or pushing against it"], answer:0},
     {q:"Why do engineers test the strength of materials before building a structure?", options:["Testing materials provides no useful information for construction","A reason unrelated to engineering","To ensure the materials can safely support the expected loads and stresses","Materials never need to be tested before use"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Decolonization in Africa: An Overview", summary:"Grade 7 Social Studies strand: decolonization in Africa refers to the process, largely occurring in the mid-20th century, by which African nations gained independence from European colonial powers.",
   ...
   quiz:[
     ...
     {q:"Which of these was a common challenge many newly independent African nations faced?", options:["Having no challenges at all after gaining independence","A reason unrelated to decolonization","Remaining under colonial control indefinitely","Building new governments and economies after colonial rule"], answer:3},
     {q:"Why is the history of decolonization in Africa significant to study?", options:["Decolonization in Africa never actually took place","It helps explain the political and economic landscape of many African nations today","A reason unrelated to social studies learning","This history has no connection to understanding the world today"], answer:1},
     {q:"Which of these best describes the goal of independence movements in Africa?", options:["Preventing any future political change in the region","Strengthening colonial control over African nations","Achieving self-governance and freedom from colonial rule","A concept unrelated to independence movements"], answer:2}
   ]},
]},
{day:55, label:"Day 55 — Fri", subjects:[
  {subject:"Language", title:"Reading: Analyzing Flashback and Foreshadowing Together", summary:"Grade 7 Language strand: flashback interrupts a story to show a past event, while foreshadowing hints at a future event, and authors often use both techniques together to build a richer narrative.",
   ...
   quiz:[
     ...
     {q:"Why might an author use both flashback and foreshadowing in the same story?", options:["To build a richer narrative that connects past, present, and future events","These two techniques can never be used together","A reason unrelated to narrative structure","To confuse the reader with no clear purpose"], answer:0},
     {q:"Which is an example of a flashback?", options:["A character suddenly remembering an event from years earlier","A character noticing dark clouds before a coming storm","A character describing their current surroundings","A concept unrelated to flashback"], answer:0},
     {q:"How might recognizing flashback and foreshadowing improve a reader’s understanding of a story?", options:["Recognizing these techniques makes a story harder to understand","These techniques never affect how a reader understands a story","It helps reveal how the past, present, and future connect within the narrative","A reason unrelated to reading comprehension"], answer:2}
   ]},
  {subject:"Math", title:"Ratio and Rate Problems with Multiple Steps", summary:"Grade 7 Math strand: multi-step ratio and rate problems require combining several calculations, such as finding a unit rate and then using it to solve for a larger or smaller quantity.",
   ...
   quiz:[
     ...
     {q:"If a recipe uses a ratio of 2 cups of flour for every 3 cups of sugar, how many cups of flour are needed for 9 cups of sugar?", options:["6 cups","An amount unrelated to the ratio","13.5 cups","9 cups"], answer:0},
     {q:"If 5 workers can build a fence in 10 hours, how many hours would it take 10 workers, assuming the same rate per worker?", options:["A value unrelated to the calculation","10 hours","5 hours","20 hours"], answer:2},
     {q:"Why are multi-step ratio problems useful to practice?", options:["They build skills for solving more complex, real-world proportional situations","A reason unrelated to ratio problems","They only apply to problems with a single possible step","Multi-step ratio problems have no practical use"], answer:0}
   ]},
  {subject:"Science", title:"The Digestive System in Depth", summary:"Grade 7 Science strand: the digestive system breaks down food into nutrients the body can absorb and use, involving organs such as the stomach, small intestine, and large intestine.",
   ...
   quiz:[
     ...
     {q:"The small intestine plays a key role in ___.", options:["Absorbing nutrients into the bloodstream","A role unrelated to the small intestine","Filtering air for the lungs","Pumping blood to the rest of the body"], answer:0},
     {q:"The large intestine mainly functions to ___.", options:["Break food down using stomach acid","A function unrelated to the large intestine","Pump oxygen throughout the body","Absorb water and form waste for elimination"], answer:3},
     {q:"Why is the digestive system considered essential for overall health?", options:["The digestive system has no connection to the body’s overall health","It provides the body with the nutrients and energy needed to function","The body can function normally with no digestive system at all","A reason unrelated to biology"], answer:1}
   ]},
  {subject:"SocialStudies", title:"The Non-Aligned Movement During the Cold War", summary:"Grade 7 Social Studies strand: the Non-Aligned Movement was a group of countries during the Cold War that chose not to formally align with either the United States or the Soviet Union.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Non-Aligned Movement was made up of countries that chose not to ___.", options:["Formally align with either the United States or the Soviet Union","Communicate with any other countries during the Cold War","A concept unrelated to the Non-Aligned Movement","Participate in any international organizations at all"], answer:0},
     {q:"Why might a country have chosen to join the Non-Aligned Movement?", options:["To maintain independence from the two major Cold War powers","To become fully controlled by one of the two major powers","Joining provided no benefit to member countries at all","A reason unrelated to the Non-Aligned Movement"], answer:0},
     {q:"The Cold War was primarily a period of tension between ___.", options:["Every country in the world equally","Canada and the United States","The United States and the Soviet Union","Two countries unrelated to the Cold War"], answer:2},
     {q:"Why is the Non-Aligned Movement an important part of Cold War history?", options:["It shows that many countries sought an independent path rather than choosing a side","A reason unrelated to Cold War history","It shows that every country in the world was forced to pick a side","The Non-Aligned Movement had no real impact on world history"], answer:0},
     {q:"Which of these best describes the overall goal of the Non-Aligned Movement?", options:["Ending all international cooperation between countries","Pursuing an independent path in international relations","A concept unrelated to the Non-Aligned Movement","Strengthening one side of the Cold War over the other"], answer:1}
   ]},
]},
{day:56, label:"Day 56 — Mon", subjects:[
  {subject:"Language", title:"Media Literacy: Evaluating Online Sources for Credibility", summary:"Grade 7 Language strand: evaluating an online source for credibility involves checking its author, publication date, purpose, and whether its claims are supported by reliable evidence.",
   ...
   quiz:[
     ...
     {q:"Why might checking the publication date of a source matter?", options:["A reason unrelated to evaluating sources","It helps determine whether the information is current and still accurate","Older sources are always more reliable than newer ones","The publication date never affects how reliable a source is"], answer:1},
     {q:"Which is a warning sign that an online source may not be credible?", options:["It clearly cites its sources and evidence","It makes claims with no supporting evidence or citations","It is written by an expert in the field","A concept unrelated to evaluating sources"], answer:1},
     {q:"Why is evaluating source credibility an important skill today?", options:["All online information can be trusted without question","A reason unrelated to media literacy","This skill has no use when reading information online","It helps readers avoid being misled by inaccurate or biased information online"], answer:3}
   ]},
  {subject:"Math", title:"Probability: Complementary Events", summary:"Grade 7 Math strand: complementary events are two outcomes where exactly one must occur, and their probabilities always add up to 1 (or 100%).",
   ...
   quiz:[
     ...
     {q:"If the probability of rain tomorrow is 30%, what is the probability it will not rain?", options:["30%","70%","A value unrelated to the calculation","100%"], answer:1},
     {q:"If the probability of drawing a red marble from a bag is 2/5, what is the probability of not drawing a red marble?", options:["3/5","A value unrelated to the calculation","1/5","2/5"], answer:0},
     {q:"Why are complementary events useful in probability?", options:["Complementary events have no practical use in probability","They allow one probability to be calculated easily if the other is already known","They can only be used when there are more than two possible outcomes","A reason unrelated to complementary events"], answer:1}
   ]},
  {subject:"Science", title:"Fossil Formation and the Geologic Time Scale", summary:"Grade 7 Science strand: fossils form when the remains or traces of living things are preserved in rock over long periods of time, and the geologic time scale organizes Earth’s history into different eras and periods.",
   ...
   quiz:[
     ...
     {q:"Why are fossils useful to scientists studying Earth’s history?", options:["Fossils provide no useful scientific information","They provide evidence about past life forms and environmental conditions","Fossils only reveal information about modern living things","A reason unrelated to fossils"], answer:1},
     {q:"Which of these is required for a fossil to form?", options:["The complete absence of any rock or sediment","A living thing that has never existed","Conditions that allow remains to be preserved rather than decompose completely","A concept unrelated to fossil formation"], answer:2},
     {q:"Why might scientists use the geologic time scale when studying fossils?", options:["Fossils can never be placed within a specific time period","The geologic time scale has no connection to studying fossils","A reason unrelated to Earth science","It helps place fossils within a specific era, giving context to when a species existed"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Canada’s National Parks and Environmental Policy", summary:"Grade 7 Social Studies strand: Canada’s national parks protect significant natural areas, and environmental policy shapes how the country balances conservation with development and resource use.",
   ...
   quiz:[
     ...
     {q:"Why might governments create environmental policies related to national parks?", options:["A reason unrelated to environmental policy","National parks require no policies or protections at all","Environmental policies have no connection to protecting natural areas","To help protect natural areas for future generations while managing human impact"], answer:3},
     {q:"Which of these might be a challenge in balancing conservation and development?", options:["A concept unrelated to environmental policy","Weighing the economic benefits of development against environmental protection","Conservation and development always align perfectly with no tension","There are never any challenges involved in this balance"], answer:1},
     {q:"Why is it valuable for students to learn about environmental policy?", options:["A reason unrelated to social studies learning","Environmental policy is decided with no input from society at all","It helps them understand how societies make decisions about protecting natural resources","Environmental policy has no connection to understanding society"], answer:2}
   ]},
]},
{day:57, label:"Day 57 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing a Process Analysis Essay (How Something Works)", summary:"Grade 7 Language strand: a process analysis essay explains how something works or how to complete a task, breaking the process down into clear, logically ordered steps.",
   ...
   quiz:[
     ...
     {q:"Which of these would be an appropriate topic for a process analysis essay?", options:["A persuasive argument about a controversial topic","How a bill becomes a law","A concept unrelated to process analysis essays","A personal memory from childhood"], answer:1},
     {q:"Why might a writer use transition words like “first,” “next,” and “finally” in a process analysis essay?", options:["They are only used in fictional stories","A reason unrelated to process analysis essays","They help guide the reader clearly through each step of the process","These words are never useful in this type of essay"], answer:2},
     {q:"Why is it important for a process analysis essay to be written in a logical order?", options:["Steps presented out of order can confuse the reader and make the process hard to follow","A process analysis essay does not need any clear order at all","A reason unrelated to writing","The order of steps never affects how clearly a process is understood"], answer:0}
   ]},
  {subject:"Math", title:"Standard Form vs. Expanded Form of Numbers", summary:"Grade 7 Math strand: standard form writes a number using digits, such as 4,502, while expanded form breaks it down by place value, such as 4,000 + 500 + 2.",
   ...
   quiz:[
     ...
     {q:"What is 3,406 written in expanded form?", options:["3,000 + 400 + 6","A value unrelated to the conversion","3,000 + 40 + 6","300 + 40 + 6"], answer:0},
     {q:"What is 2,000 + 300 + 70 + 5 written in standard form?", options:["23,075","A value unrelated to the conversion","2,357","2,375"], answer:3},
     {q:"Why might expanded form be useful when teaching place value?", options:["Expanded form is only used with very small numbers","Expanded form has no connection to understanding place value","A reason unrelated to expanded form","It clearly shows the value each digit represents based on its position"], answer:3}
   ]},
  {subject:"Science", title:"Symbiosis: Mutualism, Commensalism, and Parasitism", summary:"Grade 7 Science strand: symbiosis describes close relationships between different species, including mutualism (both benefit), commensalism (one benefits, the other is unaffected), and parasitism (one benefits at the other’s expense).",
   ...
   quiz:[
     ...
     {q:"In a parasitic relationship, ___.", options:["A concept unrelated to parasitism","Neither species is affected in any way","One species benefits at the expense of the other","Both species benefit equally"], answer:2},
     {q:"Which is an example of a mutualistic relationship?", options:["Two species that never interact with one another","A tick feeding on a dog’s blood, harming the dog","Bees pollinating flowers while feeding on their nectar","A concept unrelated to mutualism"], answer:2},
     {q:"Why do scientists study symbiotic relationships in ecosystems?", options:["Symbiotic relationships provide no useful information about ecosystems","They help explain how different species depend on and affect one another","A reason unrelated to biology","Species in an ecosystem never interact with each other"], answer:1}
   ]},
  {subject:"SocialStudies", title:"The Arab Spring and Its Global Impact", summary:"Grade 7 Social Studies strand: the Arab Spring was a wave of pro-democracy protests and uprisings that spread across several Middle Eastern and North African countries beginning in 2010 and 2011.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Arab Spring was a wave of ___.", options:["International trade agreements","A concept unrelated to the Arab Spring","Celebrations with no political purpose","Pro-democracy protests and uprisings"], answer:3},
     {q:"The Arab Spring began spreading across the Middle East and North Africa around ___.", options:["A time period unrelated to the Arab Spring","Ancient times, thousands of years ago","2010 and 2011","The 1800s"], answer:2},
     {q:"Which of these was a common demand of protesters during the Arab Spring?", options:["A demand unrelated to the Arab Spring","A return to stricter authoritarian governments","Greater political freedom and an end to authoritarian rule","The complete removal of all elections"], answer:2},
     {q:"Why did the Arab Spring have such a widespread impact across the region?", options:["The events in one country had no effect on any other country","The protests were limited to a single city with no broader impact","A reason unrelated to the Arab Spring","Similar political and economic frustrations existed in multiple countries at the same time"], answer:3},
     {q:"Why do historians and social studies students continue to study the Arab Spring?", options:["A reason unrelated to its historical significance","The events of the Arab Spring have been completely forgotten","It offers insight into how citizen movements can influence political change","The Arab Spring had no lasting effect on the region"], answer:2}
   ]},
]},
{day:58, label:"Day 58 — Wed", subjects:[
  ...
  {subject:"Math", title:"Box-and-Whisker Plots (Intro)", summary:"Grade 7 Math strand: a box-and-whisker plot displays a data set’s minimum, first quartile, median, third quartile, and maximum, helping to visualize its spread and central tendency.",
   ...
   quiz:[
     ...
     {q:"The “whiskers” of a box-and-whisker plot extend to show the ___.", options:["Minimum and maximum values in the data set","Only the median value","Only the values within the box itself","A concept unrelated to box-and-whisker plots"], answer:0},
     {q:"Why might a box-and-whisker plot be useful for comparing two data sets?", options:["A reason unrelated to box-and-whisker plots","It visually shows the spread and central tendency of each set side by side","Box-and-whisker plots cannot be used to compare data sets","They only display a single number with no visual comparison"], answer:1},
     {q:"What does the “box” portion of a box-and-whisker plot represent?", options:["The entire range of the data set","Only the single highest value in the data set","A concept unrelated to box-and-whisker plots","The middle 50% of the data, between the first and third quartiles"], answer:3}
   ]},
  {subject:"Science", title:"Nuclear Energy: Fission and Power Generation", summary:"Grade 7 Science strand: nuclear energy is produced through fission, a process where atomic nuclei split apart and release large amounts of energy, which can be used to generate electricity.",
   ...
   quiz:[
     ...
     {q:"Which of these is a potential benefit of nuclear energy?", options:["It requires no safety considerations of any kind","It can generate large amounts of electricity without directly burning fossil fuels","A concept unrelated to nuclear energy","It produces no usable energy at all"], answer:1},
     {q:"Which of these is a potential concern associated with nuclear energy?", options:["Safely managing radioactive waste","A concept unrelated to nuclear energy","It cannot generate any electricity at all","Nuclear energy has no potential concerns of any kind"], answer:0},
     {q:"Why might countries consider nuclear energy as part of their energy strategy?", options:["It has no connection to generating electricity","Nuclear energy provides no benefits to a country’s energy strategy","A reason unrelated to nuclear energy","It can provide a significant, relatively low-carbon source of electricity"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Urban Sprawl and City Planning Challenges", summary:"Grade 7 Social Studies strand: urban sprawl refers to the rapid, spread-out expansion of a city into surrounding areas, creating challenges for transportation, infrastructure, and city planning.",
   ...
   quiz:[
     ...
     {q:"Why might urban sprawl create challenges for city infrastructure?", options:["Infrastructure needs are never affected by how a city is developed","Spread-out development can be more costly and difficult to service with roads, water, and utilities","Spread-out cities always require less infrastructure than compact ones","A reason unrelated to urban sprawl"], answer:1},
     {q:"Which of these is a strategy city planners might use to address urban sprawl?", options:["Encouraging more compact, mixed-use development","Encouraging development to spread out as much as possible","Avoiding any planning or strategy at all","A concept unrelated to city planning"], answer:0},
     {q:"Why is urban sprawl an important topic in city planning?", options:["Urban sprawl is not a real or relevant issue for city planners","Urban sprawl has no effect on how a city functions","It affects transportation, the environment, and quality of life in a growing city","A reason unrelated to city planning"], answer:2}
   ]},
]},
{day:59, label:"Day 59 — Thu", subjects:[
  {subject:"Language", title:"Reading: Analyzing Nonfiction Text Structures", summary:"Grade 7 Language strand: nonfiction texts are often organized using structures like cause-and-effect, problem-and-solution, or sequence, and recognizing these structures helps readers follow the author’s ideas.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Nonfiction texts are often organized using structures such as ___.", options:["A concept unrelated to nonfiction text structures","Cause-and-effect, problem-and-solution, or sequence","A single unchanging structure used in every text","Only rhyme and rhythm"], answer:1},
     {q:"A cause-and-effect structure explains ___.", options:["A structure unrelated to cause-and-effect","How one event leads to another","Events with no connection to one another","The steps needed to solve a problem"], answer:1},
     {q:"A problem-and-solution structure presents ___.", options:["Only a problem, with no solution ever discussed","A problem, followed by one or more possible solutions","A solution with no explanation of the original problem","A structure unrelated to problem-and-solution"], answer:1},
     {q:"A sequence structure organizes information ___.", options:["In a completely random order every time","With no order or organization at all","In a specific order, such as chronological order","A structure unrelated to sequence"], answer:2},
     {q:"Why is it useful for readers to recognize a text’s structure?", options:["A reason unrelated to reading comprehension","It helps them anticipate how information will be organized and better follow the author’s ideas","All nonfiction texts use exactly the same structure","Recognizing text structure never helps with understanding a text"], answer:1}
   ]},
  {subject:"Math", title:"Adding and Subtracting Polynomials", summary:"Grade 7 Math strand: adding or subtracting polynomials involves combining like terms while keeping unlike terms separate.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"To add polynomials, you ___.", options:["Combine like terms","A method unrelated to adding polynomials","Multiply every term together","Combine unlike terms only"], answer:0},
     {q:"Simplify: (3x + 5) + (2x + 1).", options:["A value unrelated to the calculation","6x + 6","5x + 6","5x + 5"], answer:2},
     {q:"Simplify: (7x + 4) - (2x + 1).", options:["5x + 5","A value unrelated to the calculation","5x + 3","9x + 3"], answer:2},
     {q:"When subtracting polynomials, what must be done to the terms in the second polynomial?", options:["They must be multiplied by 2 before combining","Their signs are never changed during subtraction","A step unrelated to subtracting polynomials","Their signs must be changed before combining like terms"], answer:3},
     {q:"Why must like terms be combined carefully when adding or subtracting polynomials?", options:["Polynomials never require any careful combination of terms","Only terms with the same variable and exponent can be combined accurately","Any two terms can always be combined regardless of their variable or exponent","A reason unrelated to polynomials"], answer:1}
   ]},
  {subject:"Science", title:"The Skeletal and Muscular Systems in Depth", summary:"Grade 7 Science strand: the skeletal system provides structure, protection, and support for the body, while the muscular system works with it through contraction and relaxation to produce movement.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"The skeletal system provides the body with ___.", options:["Structure, protection, and support","The ability to digest food","The ability to pump blood","A function unrelated to the skeletal system"], answer:0},
     {q:"Muscles produce movement through the process of ___.", options:["Contraction and relaxation","A process unrelated to muscles","Digestion and absorption","Filtration and excretion"], answer:0},
     {q:"Which is an example of the skeletal and muscular systems working together?", options:["A concept unrelated to these systems","Breathing using only the lungs, with no involvement from bones or muscles","Bending your arm at the elbow using both bone and muscle","Digesting a meal using only the stomach"], answer:2},
     {q:"Why might bones be described as providing a framework for the body?", options:["The body has no structure or framework at all","Bones have no connection to the body’s overall shape","A reason unrelated to the skeletal system","They give the body its overall shape and structure, supporting other systems"], answer:3},
     {q:"Why do the skeletal and muscular systems need to work closely together?", options:["A reason unrelated to body systems","Movement occurs with no involvement from bones or muscles","Muscles need bones to pull against in order to create controlled movement","These two systems function completely independently of one another"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Global Food Security and Agriculture", summary:"Grade 7 Social Studies strand: food security means having reliable access to enough safe, nutritious food, and global agriculture faces challenges such as climate change, population growth, and unequal distribution of resources.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"Food security refers to ___.", options:["A concern that only applies to a single country","Having access to an unlimited supply of any type of food","Having reliable access to enough safe, nutritious food","A concept unrelated to food security"], answer:2},
     {q:"Which of these is a challenge facing global agriculture today?", options:["A complete absence of any global food challenges","A concept unrelated to agricultural challenges","Climate change affecting crop yields and growing conditions","An unlimited and endlessly reliable food supply everywhere"], answer:2},
     {q:"Why might population growth create challenges for food security?", options:["A growing population requires more food production and resources to meet demand","Population growth has no connection to food security","A larger population automatically guarantees enough food for everyone","A reason unrelated to food security"], answer:0},
     {q:"Which of these could help improve food security in a region?", options:["A concept unrelated to food security","Ignoring agricultural challenges entirely","Reducing food production without any other changes","Investing in sustainable farming techniques and infrastructure"], answer:3},
     {q:"Why is global food security an important topic in social studies?", options:["Food security has no connection to social studies topics","Food security is a concern only in fictional scenarios","A reason unrelated to this unit","It connects to economics, geography, and the well-being of people around the world"], answer:3}
   ]},
]},
{day:60, label:"Day 60 — Fri", subjects:[
  {subject:"Language", title:"Writing: Writing a Eulogy or Tribute Speech", summary:"Grade 7 Language strand: a eulogy or tribute speech honours a person by sharing meaningful memories, qualities, and the impact they had on others, often organized around specific stories or themes.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"A eulogy or tribute speech is written to ___.", options:["A concept unrelated to this type of writing","Criticize a person’s actions and character","Honour a person by sharing meaningful memories and qualities","Provide only a list of dates and facts with no personal reflection"], answer:2},
     {q:"Which of these might a tribute speech include?", options:["A list of unrelated statistics with no connection to the person","Criticism of the person being honoured","A concept unrelated to tribute speeches","A specific story that reflects the person’s character"], answer:3},
     {q:"Why might a speaker organize a tribute speech around specific themes, such as kindness or determination?", options:["It helps highlight meaningful qualities in a clear, memorable way","A reason unrelated to tribute speeches","Themes make a speech harder for an audience to follow","Themes are never used to organize this type of speech"], answer:0},
     {q:"Why is tone especially important in a eulogy or tribute speech?", options:["A respectful, sincere tone helps honour the person appropriately","A reason unrelated to this type of writing","A humorous, disrespectful tone is always most appropriate","Tone has no effect on how a tribute speech is received"], answer:0},
     {q:"Which of these is a purpose of a tribute speech?", options:["To provide a purely factual, emotionless account of events","A concept unrelated to tribute speeches","To focus only on negative memories of a person","To celebrate and remember the impact a person had on others"], answer:3}
   ]},
  {subject:"Math", title:"Review: Polynomials, Pythagorean Applications, and Data Displays", summary:"Grade 7 Math strand: this review lesson revisits key ideas from Days 51-60, including polynomials, the Pythagorean theorem, spheres, and box-and-whisker plots.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"A polynomial is an expression made up of ___.", options:["A concept unrelated to polynomials","Terms combined using addition or subtraction","Terms that can never be combined in any way","Only a single number with no variables"], answer:1},
     {q:"The Pythagorean theorem states that ___.", options:["a² + b² = c², where c is the hypotenuse of a right triangle","a² - b² = c² for any triangle","A formula unrelated to the Pythagorean theorem","a + b = c for any triangle"], answer:0},
     {q:"The formula for the volume of a sphere is ___.", options:["(4/3)πr³","πr²","A formula unrelated to the volume of a sphere","2πr"], answer:0},
     {q:"The line inside the box of a box-and-whisker plot typically represents the ___.", options:["Maximum","A value unrelated to box-and-whisker plots","Range","Median"], answer:3},
     {q:"Why is it useful to review polynomials, geometry, and data displays together?", options:["These topics have no connection to each other","A reason unrelated to reviewing math","It reinforces how these math concepts connect and build on one another","Review never helps strengthen understanding of a subject"], answer:2}
   ]},
  {subject:"Science", title:"Review: Motion, Sound, Structures, and Systems", summary:"Grade 7 Science strand: this review lesson revisits key ideas from Days 51-60, including Newton’s laws, sound waves, structures, symbiosis, and the skeletal and muscular systems.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Newton’s first law of motion describes ___.", options:["A concept unrelated to Newton’s laws","The relationship between force and colour","The speed of light in a vacuum","Inertia -- an object’s tendency to resist changes in motion"], answer:3},
     {q:"Pitch is determined by ___.", options:["A concept unrelated to pitch","Frequency, or how many vibrations occur per second","The colour of the sound wave","The distance the sound has travelled"], answer:1},
     {q:"In a mutualistic relationship, ___.", options:["Both species benefit","Neither species benefits at all","A concept unrelated to mutualism","Only one species benefits, while the other is harmed"], answer:0},
     {q:"Muscles produce movement through the process of ___.", options:["Filtration and excretion","A process unrelated to muscles","Digestion and absorption","Contraction and relaxation"], answer:3},
     {q:"Why is it useful to review motion, sound, structures, and body systems together?", options:["Each topic must be studied with no connection to the others","It reinforces how these interconnected science concepts relate to one another","Review is never useful in science","These topics have no connection to each other"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Review: International Relations and Canadian Policy", summary:"Grade 7 Social Studies strand: this review lesson revisits key ideas from Days 51-60, including the League of Nations, Canadian immigration policy, decolonization, the Non-Aligned Movement, and the Arab Spring.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The League of Nations was formed after ___.", options:["The Cold War","World War I","A conflict unrelated to the League of Nations","World War II"], answer:1},
     {q:"Canada’s modern immigration system often uses ___.", options:["A system that only accepts immigrants from a single country","A concept unrelated to immigration policy","A points-based system considering factors like skills and education","A system that considers no criteria at all"], answer:2},
     {q:"Decolonization in Africa refers to the process by which ___.", options:["African nations became colonies for the first time","European powers expanded their control over African nations","African nations gained independence from European colonial powers","A concept unrelated to decolonization"], answer:2},
     {q:"The Arab Spring was a wave of ___.", options:["A concept unrelated to the Arab Spring","Pro-democracy protests and uprisings","International trade agreements","Celebrations with no political purpose"], answer:1},
...
{day:71, label:"Day 71 — Mon", subjects:[
  {subject:"Language", title:"Point of View: First-Person, Third-Person Limited, and Omniscient Narration", summary:"Grade 7 Language strand: point of view describes who is telling a story — first-person narrators use I, third-person limited narrators reveal one character’s thoughts, and third-person omniscient narrators know the thoughts of every character.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"A first-person narrator tells a story using ___.", options:["No pronouns of any kind","A concept unrelated to point of view","Only third-person pronouns like he and she","Pronouns such as I and we"], answer:3},
     {q:"A third-person limited narrator reveals the thoughts of ___.", options:["A concept unrelated to third-person limited narration","No character at all","Every character in the story","Only one character"], answer:3},
     {q:"A third-person omniscient narrator ___.", options:["Can only describe what one character sees","Knows the thoughts and feelings of every character","Has no knowledge of any character’s thoughts","A concept unrelated to omniscient narration"], answer:1},
     {q:"Which sentence is told from a first-person point of view?", options:["He and she walked toward the house together.","I walked slowly toward the old house.","A sentence unrelated to point of view","She walked slowly toward the old house."], answer:1},
     {q:"Why might an author choose a limited point of view instead of an omniscient one?", options:["It can build suspense by keeping some information hidden from the reader","Omniscient narration always reveals less information than limited narration","A reason unrelated to point of view","Point of view never affects how a reader experiences a story"], answer:0}
   ]},
  {subject:"Math", title:"Circle Graphs (Pie Charts): Constructing and Interpreting", summary:"Grade 7 Math strand: a circle graph (pie chart) represents data as proportional slices of a circle, where each slice’s size corresponds to its percentage of the whole data set.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"A circle graph represents data using ___.", options:["A single straight line","Proportional slices of a circle","A concept unrelated to circle graphs","A grid of individual dots"], answer:1},
     {q:"In a circle graph, a larger slice represents ___.", options:["A smaller percentage of the total data","A greater percentage of the total data","No connection to the data at all","A concept unrelated to circle graphs"], answer:1},
     {q:"If a circle graph shows that 50% of students chose pizza as their favourite food, that slice would take up ___ of the circle.", options:["A value unrelated to the calculation","The entire circle","A quarter","Half"], answer:3},
     {q:"A full circle graph always represents ___.", options:["A value unrelated to circle graphs","100% of the data","0% of the data","50% of the data"], answer:1},
     {q:"Why might a circle graph be a good choice for displaying survey results?", options:["Circle graphs can only display exactly two categories","Circle graphs never show proportions clearly","It clearly shows how each category compares as a proportion of the whole","A reason unrelated to displaying data"], answer:2}
   ]},
  {subject:"Science", title:"Introduction to Atoms, Elements, and the Periodic Table", summary:"Grade 7 Science strand: atoms are the basic building blocks of matter, elements are pure substances made of only one type of atom, and the periodic table organizes all known elements by their properties.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"An atom is ___.", options:["The basic building block of matter","A concept unrelated to atoms","A mixture of two or more substances","A type of chemical reaction"], answer:0},
     {q:"An element is a pure substance made of ___.", options:["No atoms at all","Two or more different types of atoms combined","Only one type of atom","A concept unrelated to elements"], answer:2},
     {q:"The periodic table organizes elements by their ___.", options:["Colour only","Properties, such as atomic structure and behaviour","A concept unrelated to the periodic table","Alphabetical order only"], answer:1},
     {q:"Which of these is an example of an element?", options:["A substance unrelated to elements","Oxygen","Water","Salt water"], answer:1},
     {q:"Why is the periodic table a useful tool for scientists?", options:["The periodic table provides no useful scientific information","A reason unrelated to the periodic table","It organizes elements in a way that reveals patterns in their properties","Elements on the periodic table share no patterns at all"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The Acadian Expulsion (Le Grand Dérangement)", summary:"Grade 7 Social Studies strand: the Acadian Expulsion, known as Le Grand Dérangement, was the forced removal of thousands of Acadian settlers from their homes by the British in the 1750s.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Acadian Expulsion involved the forced removal of ___.", options:["A small group of British soldiers","Thousands of Acadian settlers from their homes","No people at all","A concept unrelated to the Acadian Expulsion"], answer:1},
     {q:"The Acadian Expulsion was carried out by ___.", options:["A group unrelated to the Acadian Expulsion","The British","The French government alone","Indigenous nations acting alone"], answer:1},
     {q:"Le Grand Dérangement took place primarily during the ___.", options:["1850s","A time period unrelated to the Acadian Expulsion","1750s","1950s"], answer:2},
     {q:"Many Acadians who were expelled were forced to ___.", options:["Remain safely in their original homes","Immediately return home within days","Resettle in distant and unfamiliar regions","A consequence unrelated to the Acadian Expulsion"], answer:2},
     {q:"Why is the Acadian Expulsion an important event to study in Canadian history?", options:["The Acadian Expulsion had no lasting impact on Canadian history","A reason unrelated to its historical significance","This event never actually took place","It highlights the impact of colonial conflict on the lives of settler communities"], answer:3}
   ]},
]},
{day:72, label:"Day 72 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing a Short Story with a Clear Plot Arc", summary:"Grade 7 Language strand: a short story with a clear plot arc follows a structure of exposition, rising action, climax, falling action, and resolution to build tension and satisfy the reader.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"The exposition of a story introduces ___.", options:["Only the story’s title","The final resolution of the conflict","The characters, setting, and initial situation","A concept unrelated to exposition"], answer:2},
     {q:"The climax of a story is ___.", options:["A concept unrelated to a story’s climax","The very first event in the story","A part of the story with no importance","The turning point or moment of highest tension"], answer:3},
     {q:"Rising action refers to the events that ___.", options:["Occur only in the story’s final sentence","Build tension and lead toward the climax","Happen after the story’s conflict is resolved","A concept unrelated to rising action"], answer:1},
     {q:"The resolution of a story typically ___.", options:["Introduces the main characters for the first time","Builds tension toward the climax","A concept unrelated to a story’s resolution","Shows how the conflict is finally settled"], answer:3},
     {q:"Why is a clear plot arc useful when writing a short story?", options:["It helps organize events so the story builds tension and feels satisfying to readers","A reason unrelated to writing a short story","Stories are always more effective with no structure at all","A plot arc never affects how a story is experienced"], answer:0}
   ]},
  {subject:"Math", title:"Repeating and Terminating Decimals", summary:"Grade 7 Math strand: a terminating decimal ends after a finite number of digits, while a repeating decimal has one or more digits that repeat infinitely, and both can result from converting fractions to decimal form.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"A terminating decimal is a decimal that ___.", options:["Ends after a finite number of digits","Has no digits after the decimal point","Repeats the same digits forever","A concept unrelated to terminating decimals"], answer:0},
     {q:"A repeating decimal is a decimal in which ___.", options:["The digits always end after two places","No digits ever appear after the decimal point","A concept unrelated to repeating decimals","One or more digits repeat infinitely"], answer:3},
     {q:"Which fraction converts to a terminating decimal?", options:["1/3","1/4","2/3","A fraction unrelated to the calculation"], answer:1},
     {q:"Which fraction converts to a repeating decimal?", options:["A fraction unrelated to the calculation","3/4","1/3","1/2"], answer:2},
     {q:"Why is it useful to recognize whether a decimal terminates or repeats?", options:["This distinction never matters when working with decimals","All decimals terminate after exactly one digit","A reason unrelated to decimals","It helps identify patterns when converting between fractions and decimals"], answer:3}
   ]},
  {subject:"Science", title:"Static Electricity and Electric Charge", summary:"Grade 7 Science strand: static electricity builds up when electric charges accumulate on the surface of an object, often due to friction, and can cause objects to attract or repel one another.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Static electricity builds up when ___.", options:["A concept unrelated to static electricity","A magnet is placed near metal","Electric charges accumulate on the surface of an object","An object loses all of its mass"], answer:2},
     {q:"Static electricity is often caused by ___.", options:["A decrease in temperature alone","Objects being placed in water","A concept unrelated to static electricity","Friction between two objects"], answer:3},
     {q:"Objects with the same electric charge will ___ each other.", options:["Repel","Attract","Have no effect on","A concept unrelated to electric charge"], answer:0},
     {q:"Objects with opposite electric charges will ___ each other.", options:["Repel","Attract","A concept unrelated to electric charge","Have no effect on"], answer:1},
     {q:"Why does rubbing a balloon on hair sometimes cause it to stick to a wall?", options:["A reason unrelated to static electricity","Balloons always stick to walls regardless of electric charge","The friction transfers electric charge, creating an attraction between the balloon and the wall","Friction removes all electric charge from the balloon"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The Underground Railroad and Its Connection to Canada", summary:"Grade 7 Social Studies strand: the Underground Railroad was a secret network of routes and safe houses that helped freedom seekers escape enslavement in the United States, with many settling in British North America, including present-day Ontario.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Underground Railroad was a secret network that helped ___.", options:["Settlers travel to Europe for trade","A concept unrelated to the Underground Railroad","Freedom seekers escape enslavement in the United States","Soldiers move between military bases"], answer:2},
     {q:"Many freedom seekers who used the Underground Railroad settled in ___.", options:["British North America, including present-day Ontario","A region unrelated to the Underground Railroad","Regions with no connection to freedom seekers","The southern United States"], answer:0},
     {q:"The Underground Railroad relied on ___.", options:["A concept unrelated to the Underground Railroad","Secret routes and safe houses run by helpers along the way","A single, well-known public road","Official government railways with public schedules"], answer:1},
     {q:"Why did British North America become a destination for freedom seekers?", options:["British North America required freedom seekers to remain enslaved","A reason unrelated to the Underground Railroad","Slavery had been abolished there, offering greater safety and freedom","British North America had no laws regarding slavery at all"], answer:2},
     {q:"Why is the Underground Railroad an important part of Canadian history?", options:["It highlights Canada’s role as a destination for people escaping enslavement","This network only ever operated within Canada’s borders","The Underground Railroad has no connection to Canadian history","A reason unrelated to its historical significance"], answer:0}
   ]},
]},
{day:73, label:"Day 73 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Correcting Pronoun-Antecedent Agreement Errors", summary:"Grade 7 Language strand: a pronoun must agree in number with its antecedent, the noun it replaces, to avoid confusing or grammatically incorrect sentences.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"An antecedent is ___.", options:["The noun that a pronoun refers back to","A verb tense used in formal writing","A type of punctuation mark","A concept unrelated to antecedents"], answer:0},
     {q:"Which sentence shows correct pronoun-antecedent agreement?", options:["The girls packed their bags for the trip.","The girls packed her bags for the trip.","The girl packed their bags for the trip.","A sentence unrelated to pronoun-antecedent agreement"], answer:0},
     {q:"If the antecedent is singular, the pronoun that replaces it must also be ___.", options:["Singular","Plural","Written in all capital letters","A concept unrelated to pronoun-antecedent agreement"], answer:0},
     {q:"Which sentence contains a pronoun-antecedent agreement error?", options:["A sentence unrelated to pronoun-antecedent agreement","The book fell off its shelf and landed on the floor.","The books fell off their shelf and landed on the floor.","The book fell off their shelf and landed on the floor."], answer:3},
     {q:"Why is it important to match a pronoun with its correct antecedent?", options:["It helps readers clearly understand which noun the pronoun is referring to","Antecedents have no connection to the pronouns used in a sentence","A reason unrelated to grammar","Pronoun-antecedent agreement never affects how clear a sentence is"], answer:0}
   ]},
  {subject:"Math", title:"The Cartesian Plane and Plotting in All Four Quadrants", summary:"Grade 7 Math strand: the Cartesian plane is divided into four quadrants by a horizontal x-axis and vertical y-axis, and each point is located using an ordered pair (x, y).",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"The Cartesian plane is divided into ___ quadrants.", options:["Eight","A number unrelated to the Cartesian plane","Four","Two"], answer:2},
     {q:"An ordered pair (x, y) identifies a point’s location using ___.", options:["A concept unrelated to ordered pairs","Its distance along the x-axis and y-axis","Only its distance from the origin","The colour of the point"], answer:1},
     {q:"In which quadrant would the point (-3, 4) be located?", options:["A quadrant unrelated to this point","The fourth quadrant","The second quadrant","The first quadrant"], answer:2},
     {q:"The point where the x-axis and y-axis intersect is called the ___.", options:["Vertex","A term unrelated to the Cartesian plane","Median","Origin"], answer:3},
     {q:"Why is the Cartesian plane useful in mathematics?", options:["It allows points, shapes, and relationships to be represented and analyzed visually","A reason unrelated to the Cartesian plane","Points can only be described using words, never a plane","The Cartesian plane has no practical mathematical use"], answer:0}
   ]},
  {subject:"Science", title:"Light: Reflection and the Law of Reflection", summary:"Grade 7 Science strand: reflection occurs when light bounces off a surface, and the law of reflection states that the angle at which light hits a surface equals the angle at which it bounces off.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Reflection occurs when ___.", options:["A concept unrelated to reflection","Light bounces off a surface","Light is completely absorbed by a surface","Light bends as it passes through a new material"], answer:1},
     {q:"The law of reflection states that the angle of incidence ___.", options:["A concept unrelated to the law of reflection","Has no relationship to the angle of reflection","Equals the angle of reflection","Is always greater than the angle of reflection"], answer:2},
     {q:"A smooth, shiny surface like a mirror produces a ___ reflection.", options:["Completely invisible","Clear","A concept unrelated to reflection","Scattered"], answer:1},
     {q:"A rough surface, such as paper, produces a reflection that is ___.", options:["A concept unrelated to reflection off rough surfaces","Perfectly clear and focused","Completely absorbed with no light bouncing at all","Scattered in many directions"], answer:3},
     {q:"Why can you see your reflection clearly in a mirror but not in a piece of paper?", options:["Mirrors do not actually reflect any light","A mirror’s smooth surface reflects light in an organized way, while paper scatters light in many directions","A reason unrelated to reflection","Paper reflects light exactly the same way a mirror does"], answer:1}
   ]},
  {subject:"SocialStudies", title:"The Persons Case and Women’s Legal Rights in Canada", summary:"Grade 7 Social Studies strand: the Persons Case was a 1929 legal ruling that recognized women as “persons” eligible to serve in the Canadian Senate, marking a major milestone in the fight for women’s legal rights.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Persons Case was a legal ruling that recognized women as ___.", options:["“Persons” eligible to serve in the Canadian Senate","Persons only for the purpose of paying taxes","Ineligible for any political involvement","A concept unrelated to the Persons Case"], answer:0},
     {q:"The Persons Case was decided in ___.", options:["1929","A year unrelated to the Persons Case","1982","1867"], answer:0},
     {q:"Before the Persons Case, women were often excluded from ___.", options:["All forms of paid employment","A concept unrelated to the Persons Case","Serving in the Canadian Senate","Attending public schools"], answer:2},
     {q:"The group of women who led the legal challenge in the Persons Case became known as ___.", options:["The Confederation Five","A group unrelated to the Persons Case","The Famous Five","The Senate Six"], answer:2},
     {q:"Why is the Persons Case considered a significant milestone in Canadian history?", options:["The Persons Case had no effect on women’s rights","It expanded legal recognition and rights for women in Canadian public life","A reason unrelated to its historical significance","The Persons Case reduced legal rights for women"], answer:1}
   ]},
]},
{day:74, label:"Day 74 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Etymology and Word Origins", summary:"Grade 7 Language strand: etymology is the study of where words come from and how their meanings have changed over time, often tracing roots back to languages such as Latin or Greek.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Etymology is the study of ___.", options:["How to spell words correctly","Where words come from and how their meanings have changed over time","A concept unrelated to etymology","The grammar rules of a language"], answer:1},
     {q:"Many English words trace their origins back to ___.", options:["Languages such as Latin or Greek","Only modern English slang","A concept unrelated to word origins","Numbers and mathematical symbols"], answer:0},
     {q:"Knowing a word’s Greek or Latin root can help a reader ___.", options:["Determine the punctuation of a sentence","Figure out the meaning of unfamiliar related words","Guess the exact spelling of any word","A concept unrelated to word origins"], answer:1},
     {q:"The word biology comes from Greek roots meaning ___.", options:["The study of numbers","The study of ancient buildings","The study of life","A meaning unrelated to the word biology"], answer:2},
     {q:"Why is studying etymology useful for building vocabulary?", options:["Word origins never help with understanding vocabulary","Every word in English has a completely unrelated, unique origin","A reason unrelated to etymology","Recognizing common roots helps readers decode the meaning of many unfamiliar words"], answer:3}
   ]},
  {subject:"Math", title:"Congruence and Symmetry in 2D Shapes", summary:"Grade 7 Math strand: congruent shapes are identical in size and shape, and a shape has line symmetry if it can be folded along a line so both halves match exactly.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Two shapes are congruent if they are ___.", options:["Different in both size and shape","Identical in size and shape","Similar in shape but different in size","A concept unrelated to congruence"], answer:1},
     {q:"A shape has line symmetry if ___.", options:["It can be folded along a line so both halves match exactly","It has more than four sides","It can never be folded to match on both sides","A concept unrelated to line symmetry"], answer:0},
     {q:"How many lines of symmetry does a square have?", options:["A number unrelated to the calculation","Two","Four","Zero"], answer:2},
     {q:"Which shape is an example of two congruent triangles placed together?", options:["A rectangle divided in half diagonally","A single triangle with no division","A circle with no straight edges","A shape unrelated to congruent triangles"], answer:0},
     {q:"Why is understanding congruence and symmetry useful in geometry?", options:["A reason unrelated to this topic","Congruence and symmetry have no practical use in geometry","All shapes are automatically congruent to one another","It helps identify relationships and patterns between shapes"], answer:3}
   ]},
  {subject:"Science", title:"Adaptations and Natural Selection: An Introduction", summary:"Grade 7 Science strand: an adaptation is a trait that helps an organism survive in its environment, and natural selection is the process by which organisms with helpful adaptations are more likely to survive and reproduce.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"An adaptation is a trait that ___.", options:["Helps an organism survive in its environment","Always harms an organism’s chances of survival","A concept unrelated to adaptations","Has no effect on an organism’s survival"], answer:0},
     {q:"Natural selection is the process by which ___.", options:["Organisms with helpful adaptations are more likely to survive and reproduce","A concept unrelated to natural selection","All organisms survive and reproduce equally, regardless of traits","Organisms lose all of their adaptations over time"], answer:0},
     {q:"Which is an example of a physical adaptation?", options:["An object with no living characteristics","A polar bear’s thick fur for insulation in cold climates","A concept unrelated to physical adaptations","A rock sitting in a cold climate"], answer:1},
     {q:"A behavioural adaptation is best described as ___.", options:["An action an organism takes to help it survive","A concept unrelated to behavioural adaptations","A trait with no connection to survival","A physical body part used for survival"], answer:0},
     {q:"Why do organisms with helpful adaptations tend to survive and reproduce more successfully over time?", options:["All organisms in an environment face identical challenges regardless of traits","Adaptations never affect an organism’s chances of survival","Their traits make them better suited to overcome challenges in their environment","A reason unrelated to natural selection"], answer:2}
   ]},
  {subject:"SocialStudies", title:"The October Crisis and the War Measures Act", summary:"Grade 7 Social Studies strand: the October Crisis of 1970 was a major political crisis centred in Quebec that led the federal government to invoke the War Measures Act, temporarily suspending certain civil liberties to respond to the emergency.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The October Crisis took place in ___.", options:["1970","A year unrelated to the October Crisis","1929","1867"], answer:0},
     {q:"The War Measures Act, when invoked, allowed the federal government to ___.", options:["A concept unrelated to the War Measures Act","Permanently remove a province from Confederation","Immediately dissolve all provincial governments","Temporarily suspend certain civil liberties during an emergency"], answer:3},
     {q:"The October Crisis was centred in the province of ___.", options:["British Columbia","Ontario","A province unrelated to the October Crisis","Quebec"], answer:3},
     {q:"Invoking the War Measures Act during the October Crisis was controversial because it ___.", options:["Limited civil liberties that Canadians normally have","Only applied to citizens outside of Canada","Had no effect on the rights of Canadian citizens","A reason unrelated to the controversy"], answer:0},
     {q:"Why do historians and students study the October Crisis today?", options:["The October Crisis has no connection to understanding Canadian history","This event never actually took place","A reason unrelated to its historical significance","It raises important questions about balancing public safety with civil liberties during a crisis"], answer:3}
   ]},
]},
{day:75, label:"Day 75 — Fri", subjects:[
  {subject:"Language", title:"Reading: Identifying Cause and Effect Relationships in Text", summary:"Grade 7 Language strand: identifying cause and effect in a text involves recognizing how one event or action (the cause) leads directly to a result (the effect).",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"A cause-and-effect relationship shows how ___.", options:["One event leads directly to a result","A concept unrelated to cause and effect","A story’s setting connects to its characters","Two unrelated events happen at the same time"], answer:0},
     {q:"In the sentence “Because it rained, the game was cancelled,” the cause is ___.", options:["It rained","A concept unrelated to this sentence","Neither part of the sentence","The game was cancelled"], answer:0},
     {q:"Which signal word often introduces an effect in a sentence?", options:["A word unrelated to cause and effect","Similarly","Therefore","Meanwhile"], answer:2},
     {q:"Which sentence shows a clear cause-and-effect relationship?", options:["She forgot her umbrella, so she got soaked in the rain.","The umbrella and the raincoat were both new.","A sentence unrelated to cause and effect","She has a red umbrella and a blue raincoat."], answer:0},
     {q:"Why is it useful for readers to identify cause-and-effect relationships in a text?", options:["It helps readers understand why events happen and how ideas are connected","A reason unrelated to reading comprehension","Every event in a text happens for no reason at all","Cause-and-effect relationships never help readers understand a text"], answer:0}
   ]},
  {subject:"Math", title:"Data: Constructing and Interpreting Stem-and-Leaf Plots", summary:"Grade 7 Math strand: a stem-and-leaf plot organizes numerical data by splitting each value into a “stem” (leading digits) and a “leaf” (last digit), making it easy to see the shape and spread of a data set.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"In a stem-and-leaf plot, the “stem” usually represents ___.", options:["The leading digit or digits of a value","The final digit of a value","The total number of data points","A concept unrelated to stem-and-leaf plots"], answer:0},
     {q:"In a stem-and-leaf plot, the “leaf” usually represents ___.", options:["The average of all values","The last digit of a value","A concept unrelated to stem-and-leaf plots","The leading digit of a value"], answer:1},
     {q:"For the value 47, which digit would typically be the stem?", options:["A digit unrelated to the calculation","7","4","47"], answer:2},
     {q:"One advantage of a stem-and-leaf plot is that it ___.", options:["Only works with exactly two data points","Displays every individual data value while showing overall patterns","A concept unrelated to stem-and-leaf plots","Hides all of the individual data values"], answer:1},
     {q:"Why might a stem-and-leaf plot be useful for analyzing a set of test scores?", options:["This type of plot only works with negative numbers","It shows both the exact scores and the overall distribution at a glance","Stem-and-leaf plots cannot display exact data values","A reason unrelated to analyzing data"], answer:1}
   ]},
  {subject:"Science", title:"Ocean Currents and Their Influence on Climate", summary:"Grade 7 Science strand: ocean currents are large-scale movements of seawater driven by wind, temperature, and salinity differences, and they play a major role in distributing heat and shaping climate around the world.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Ocean currents are large-scale movements of ___.", options:["Only surface ice","Seawater","A concept unrelated to ocean currents","Underground freshwater"], answer:1},
     {q:"Which of these can drive ocean currents?", options:["The colour of the water","Differences in wind, temperature, and salinity","The number of fish in the ocean","A concept unrelated to ocean currents"], answer:1},
     {q:"Ocean currents play a major role in ___.", options:["Keeping all regions of the world at the exact same temperature","Preventing any heat from moving through the ocean","A concept unrelated to ocean currents","Distributing heat and shaping climate around the world"], answer:3},
     {q:"A warm ocean current flowing toward a coastal region can cause that region’s climate to be ___.", options:["Colder than it would otherwise be","Completely unaffected by the current","Milder than it would otherwise be","A concept unrelated to ocean currents"], answer:2},
     {q:"Why do scientists study ocean currents when trying to understand global climate patterns?", options:["Ocean currents move large amounts of heat around the planet, directly influencing regional climates","A reason unrelated to ocean currents","Ocean currents have no connection to climate patterns","Ocean currents only affect a single, isolated location"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Population Pyramids and Demographic Transition", summary:"Grade 7 Social Studies strand: a population pyramid is a graph showing the age and sex distribution of a population, and demographic transition describes how birth and death rates change as a country develops economically.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"A population pyramid displays a population’s distribution by ___.", options:["A concept unrelated to population pyramids","Age and sex","Income level only","Favourite occupations"], answer:1},
     {q:"A population pyramid with a wide base typically indicates ___.", options:["A concept unrelated to population pyramids","No connection to birth rates at all","A high birth rate and a young population","A low birth rate and an aging population"], answer:2},
     {q:"Demographic transition describes how ___.", options:["A population’s culture disappears completely","Birth and death rates change as a country develops economically","A concept unrelated to demographic transition","A country’s borders change over time"], answer:1},
     {q:"A country with a narrowing pyramid base over time often reflects ___.", options:["Rapidly increasing birth rates","A concept unrelated to population pyramids","Declining birth rates","No change in birth rates at all"], answer:2},
     {q:"Why are population pyramids useful tools for geographers and planners?", options:["They help predict future needs for schools, healthcare, and other services","A reason unrelated to population pyramids","Population pyramids provide no useful information for planning","Population data never changes over time"], answer:0}
   ]},
]},
{day:76, label:"Day 76 — Mon", subjects:[
  {subject:"Language", title:"Media Literacy: Analyzing Podcasts and Audio Storytelling", summary:"Grade 7 Language strand: analyzing podcasts and audio storytelling involves considering how sound effects, music, tone of voice, and pacing are used to inform or engage a listening audience.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Audio storytelling relies on elements such as ___.", options:["Only written text with no sound at all","A concept unrelated to audio storytelling","Photographs and illustrations only","Sound effects, music, tone of voice, and pacing"], answer:3},
     {q:"A podcast host’s tone of voice can help convey ___.", options:["Nothing useful to the listener","Emotion and emphasis about the topic being discussed","Only the exact spelling of words being said","A concept unrelated to tone of voice"], answer:1},
     {q:"Why might a podcast use background music during a serious moment?", options:["A reason unrelated to audio storytelling","To help set an emotional mood for the listener","Background music always distracts from the story with no purpose","Music never affects how a listener feels"], answer:1},
     {q:"Pacing in a podcast refers to ___.", options:["A concept unrelated to pacing","The length of the podcast’s title","The speed and rhythm at which information is delivered","The number of speakers involved"], answer:2},
     {q:"Why is it important to critically analyze podcasts and other audio media?", options:["Critical analysis is only useful for written texts, not audio","A reason unrelated to media literacy","Audio media never influences how listeners understand a topic","It helps listeners understand how audio techniques shape their understanding of a topic"], answer:3}
   ]},
  {subject:"Math", title:"Estimation Strategies and Rounding for Real-World Problems", summary:"Grade 7 Math strand: estimation strategies, such as rounding numbers to the nearest ten or hundred, help quickly approximate answers and check whether an exact calculation is reasonable.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Estimation is useful because it helps ___.", options:["Always produce the exact correct answer","A concept unrelated to estimation","Quickly approximate an answer and check if an exact calculation is reasonable","Replace the need for exact calculations entirely"], answer:2},
     {q:"Rounded to the nearest ten, 47 becomes ___.", options:["A value unrelated to the calculation","45","40","50"], answer:3},
     {q:"Rounded to the nearest hundred, 342 becomes ___.", options:["350","300","400","A value unrelated to the calculation"], answer:1},
     {q:"Which situation would benefit most from an estimate rather than an exact answer?", options:["A situation unrelated to estimation","Quickly checking if you have enough money for groceries","Recording an exact measurement for a science experiment","Calculating exact change owed at a cash register"], answer:1},
     {q:"Why is it useful to estimate before solving a problem exactly?", options:["Estimating always gives a more accurate result than exact calculation","Estimating never helps confirm whether an answer makes sense","It helps identify whether the final exact answer is reasonable","A reason unrelated to estimation"], answer:2}
   ]},
  {subject:"Science", title:"The Scientific Method: Variables and Designing a Fair Test", summary:"Grade 7 Science strand: a fair test changes only one variable at a time while keeping all other conditions constant, allowing scientists to determine the true cause of a result.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"A fair test changes ___.", options:["No variables at all","A concept unrelated to a fair test","Every variable at the same time","Only one variable at a time"], answer:3},
     {q:"The variable that a scientist deliberately changes in an experiment is called the ___.", options:["Dependent variable","Constant variable","Independent variable","A concept unrelated to experimental variables"], answer:2},
     {q:"The variable that is measured or observed as a result of an experiment is called the ___.", options:["Independent variable","Dependent variable","Controlled variable","A concept unrelated to experimental variables"], answer:1},
     {q:"Keeping all other conditions the same during an experiment, except for the one variable being tested, helps ensure ___.", options:["A concept unrelated to fair testing","The experiment will always fail","The results will always be inaccurate","The results can be reliably attributed to the variable being tested"], answer:3},
     {q:"Why is designing a fair test important in scientific investigations?", options:["A reason unrelated to the scientific method","Fair tests never affect the reliability of an experiment’s results","Changing multiple variables at once always produces clearer results","It allows scientists to determine the true cause of a result with confidence"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Fair Trade and Ethical Consumerism", summary:"Grade 7 Social Studies strand: fair trade is a movement that aims to ensure producers in developing countries receive fair prices and working conditions, and ethical consumerism involves making purchasing choices based on their social and environmental impact.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"Fair trade aims to ensure that producers in developing countries receive ___.", options:["Fair prices and working conditions","The lowest possible price for their goods","No compensation for their work","A concept unrelated to fair trade"], answer:0},
     {q:"Ethical consumerism involves making purchasing choices based on ___.", options:["Random selection with no consideration at all","A concept unrelated to ethical consumerism","A product’s social and environmental impact","Only the lowest possible price"], answer:2},
     {q:"Which of these might be a benefit of buying fair trade products?", options:["Supporting better wages and working conditions for producers","Reducing the quality of products being sold","A concept unrelated to fair trade products","Guaranteeing the lowest price for consumers"], answer:0},
     {q:"A fair trade certification label on a product is meant to show that ___.", options:["The product was made using child labour","The product has no connection to its country of origin","The product meets certain standards for fair pricing and labour practices","A concept unrelated to fair trade certification"], answer:2},
     {q:"Why might consumers choose to support fair trade and ethical consumerism?", options:["Fair trade products always cost less than other products","A reason unrelated to fair trade","To help promote fairer treatment of workers and more sustainable practices globally","Ethical consumerism has no effect on global trade practices"], answer:2}
   ]},
]},
{day:77, label:"Day 77 — Tue", subjects:[
  {subject:"Language", title:"Writing: Writing an Interview Script or Q&A Feature", summary:"Grade 7 Language strand: an interview script or Q&A feature uses purposeful, open-ended questions to draw out detailed and informative responses from a subject.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"An effective interview question is usually ___.", options:["Closed, allowing only a yes or no answer","A concept unrelated to interview questions","Completely unrelated to the interview’s topic","Open-ended, encouraging a detailed response"], answer:3},
     {q:"Which is an example of an open-ended interview question?", options:["A question unrelated to open-ended interviewing","Are you busy today?","What inspired you to pursue this career?","Do you like your job?"], answer:2},
     {q:"Before conducting an interview, it is helpful to ___.", options:["Research the subject and prepare thoughtful questions","A concept unrelated to interview preparation","Avoid any preparation at all","Only ask questions the subject suggests"], answer:0},
     {q:"A Q&A feature typically presents information in the format of ___.", options:["A concept unrelated to Q&A features","A list of unrelated facts with no questions","A single continuous paragraph with no structure","Questions followed by the subject’s direct responses"], answer:3},
     {q:"Why are follow-up questions useful during an interview?", options:["A reason unrelated to interviewing","They allow the interviewer to explore interesting details further","Interviews are always more effective with no follow-up questions","Follow-up questions never add useful information"], answer:1}
   ]},
  {subject:"Math", title:"Probability: Theoretical vs. Experimental Probability", summary:"Grade 7 Math strand: theoretical probability predicts outcomes based on mathematical reasoning, while experimental probability is based on the actual results of repeated trials, and the two may differ.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Theoretical probability is based on ___.", options:["Mathematical reasoning about possible outcomes","Guessing with no reasoning at all","A concept unrelated to theoretical probability","The actual results of trials that have occurred"], answer:0},
     {q:"Experimental probability is based on ___.", options:["A concept unrelated to experimental probability","A single guess with no data","Mathematical reasoning alone, with no trials","The actual results of repeated trials"], answer:3},
     {q:"What is the theoretical probability of rolling a 4 on a fair six-sided die?", options:["A value unrelated to the calculation","4/6","1/4","1/6"], answer:3},
     {q:"If a coin is flipped 20 times and lands on heads 13 times, the experimental probability of heads is ___.", options:["A value unrelated to the calculation","7/20","1/2","13/20"], answer:3},
     {q:"Why might experimental probability differ from theoretical probability?", options:["Experimental and theoretical probability are always exactly the same","Theoretical probability is always incorrect","Random chance can cause actual results to vary from what is mathematically expected","A reason unrelated to probability"], answer:2}
   ]},
  {subject:"Science", title:"Renewable Resource Management: Forestry and Fisheries", summary:"Grade 7 Science strand: renewable resource management involves practices such as sustainable forestry and fisheries quotas that allow resources like trees and fish populations to replenish over time.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Renewable resource management aims to ___.", options:["Prevent any use of natural resources at all","Allow resources to replenish over time while still being used","A concept unrelated to renewable resource management","Use up resources as quickly as possible"], answer:1},
     {q:"Sustainable forestry practices might include ___.", options:["Replanting trees after harvesting","Removing all trees from a forest with no replanting","Avoiding any use of forest resources","A concept unrelated to sustainable forestry"], answer:0},
     {q:"A fisheries quota is used to ___.", options:["Limit the number of fish that can be caught to protect the population","A concept unrelated to fisheries quotas","Remove all fish from a body of water at once","Encourage catching as many fish as possible"], answer:0},
     {q:"Why might overfishing be a concern for ocean ecosystems?", options:["Overfishing has no effect on fish populations","It can reduce fish populations faster than they can naturally replenish","Fish populations always grow regardless of how many are caught","A reason unrelated to overfishing"], answer:1},
     {q:"Why is renewable resource management important for both the environment and the economy?", options:["Renewable resources never need to be managed carefully","A reason unrelated to renewable resource management","Resource management has no connection to the environment or economy","It helps ensure resources like forests and fisheries remain available for future use"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Role of Non-Governmental Organizations (NGOs) in Global Issues", summary:"Grade 7 Social Studies strand: non-governmental organizations (NGOs) are independent groups that work to address global issues such as poverty, health, and human rights, often operating without direct government control.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"A non-governmental organization (NGO) is best described as ___.", options:["A for-profit business with no social mission","A branch of a country’s official government","An independent group working to address global issues","A concept unrelated to NGOs"], answer:2},
     {q:"NGOs often work to address global issues such as ___.", options:["A concept unrelated to the work of NGOs","Poverty, health, and human rights","Issues unrelated to communities or people","Only issues within a single company"], answer:1},
     {q:"Which of these is an example of what an NGO might do?", options:["Pass new laws for a country","Control a country’s military","A concept unrelated to NGO activities","Provide emergency relief supplies after a natural disaster"], answer:3},
     {q:"NGOs typically operate ___.", options:["Independently, without direct government control","As an official part of every national government","Only within a single city","A concept unrelated to NGOs"], answer:0},
     {q:"Why are NGOs important players in addressing global issues?", options:["A reason unrelated to their role","NGOs only operate within one specific country and never globally","NGOs have no meaningful impact on global issues","They can mobilize resources and expertise to help communities facing challenges worldwide"], answer:3}
   ]},
]},
{day:78, label:"Day 78 — Wed", subjects:[
  {subject:"Language", title:"Grammar: Using Correct Verb Tense Consistency", summary:"Grade 7 Language strand: verb tense consistency means keeping the same tense throughout a passage unless a shift in time genuinely requires a change, helping avoid confusing readers.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Verb tense consistency means ___.", options:["Keeping the same tense throughout a passage unless a time shift requires a change","Avoiding verbs altogether in writing","Using a different tense in every sentence","A concept unrelated to verb tense consistency"], answer:0},
     {q:"Which sentence has a verb tense inconsistency?", options:["She walks to the store and buys some milk.","She walked to the store and buys some milk.","She walked to the store and bought some milk.","A sentence unrelated to verb tense"], answer:1},
     {q:"If a paragraph is written in the past tense, most verbs should ___.", options:["Also be in the past tense","Switch randomly to the future tense","A concept unrelated to verb tense consistency","Be written with no verbs at all"], answer:0},
     {q:"Which sentence correctly maintains consistent verb tense?", options:["He finishes his homework and then watched a movie.","He finished his homework and then watched a movie.","He finished his homework and then watches a movie.","A sentence unrelated to verb tense consistency"], answer:1},
     {q:"Why can inconsistent verb tense confuse a reader?", options:["Readers always understand a passage the same way regardless of tense","Verb tense never affects how a reader understands a timeline","A reason unrelated to grammar","It makes it unclear when the events in a passage are taking place"], answer:3}
   ]},
  {subject:"Math", title:"Financial Literacy: Comparing Loan and Savings Options", summary:"Grade 7 Math strand: comparing loan and savings options involves evaluating interest rates and terms to determine which option costs less when borrowing or earns more when saving.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"When comparing loans, a lower interest rate generally means ___.", options:["A concept unrelated to comparing loans","No difference in the total amount paid","Less money paid in interest over time","More money paid in interest over time"], answer:2},
     {q:"When comparing savings accounts, a higher interest rate generally means ___.", options:["A concept unrelated to comparing savings accounts","No difference in the total amount earned","Less money earned over time","More money earned over time"], answer:3},
     {q:"If Loan A has a 4% interest rate and Loan B has a 7% interest rate on the same amount borrowed, which loan generally costs less overall?", options:["Both loans cost exactly the same","A choice unrelated to the calculation","Loan A","Loan B"], answer:2},
     {q:"The term of a loan refers to ___.", options:["The exact amount of money borrowed","The name of the bank offering the loan","A concept unrelated to loan terms","The length of time given to repay it"], answer:3},
     {q:"Why is it important to compare loan and savings options carefully before choosing one?", options:["Comparing these options never affects a person’s finances","A reason unrelated to financial literacy","It helps ensure a person pays less in interest or earns more on their savings over time","All loans and savings accounts offer identical terms"], answer:2}
   ]},
  {subject:"Science", title:"Weather Instruments and How Meteorologists Forecast", summary:"Grade 7 Science strand: meteorologists use instruments such as thermometers, barometers, and anemometers to measure conditions like temperature, air pressure, and wind speed in order to forecast weather.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"A thermometer is used to measure ___.", options:["Wind speed","Air pressure","Temperature","An instrument unrelated to thermometers"], answer:2},
     {q:"A barometer is used to measure ___.", options:["An instrument unrelated to barometers","Air pressure","Temperature","Humidity only"], answer:1},
     {q:"An anemometer is used to measure ___.", options:["An instrument unrelated to anemometers","Rainfall amounts","Air pressure","Wind speed"], answer:3},
     {q:"A sudden drop in air pressure often signals that ___.", options:["Clear, sunny weather is guaranteed","A concept unrelated to air pressure","Temperature will remain exactly the same","Stormy weather may be approaching"], answer:3},
     {q:"Why do meteorologists rely on multiple instruments to forecast weather?", options:["A single instrument always provides a complete and accurate forecast","A reason unrelated to weather forecasting","Weather instruments provide no useful information for forecasting","Combining data on temperature, pressure, and wind gives a more accurate picture of upcoming conditions"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Canada’s Official Languages: French and English Bilingualism", summary:"Grade 7 Social Studies strand: Canada’s Official Languages Act, passed in 1969, established French and English as the country’s two official languages, reflecting its history and diverse linguistic heritage.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"Canada’s Official Languages Act established ___ as the country’s official languages.", options:["Only English","A concept unrelated to Canada’s official languages","English and Spanish","French and English"], answer:3},
     {q:"Canada’s Official Languages Act was passed in ___.", options:["1969","1867","A year unrelated to the Official Languages Act","1929"], answer:0},
     {q:"The Official Languages Act reflects Canada’s ___.", options:["A concept unrelated to the Official Languages Act","Complete rejection of its French heritage","History and diverse linguistic heritage","Adoption of a single national language only"], answer:2},
     {q:"Under the Official Languages Act, federal government services must generally be available in ___.", options:["Only French","Only Indigenous languages","A concept unrelated to federal government services","Both French and English"], answer:3},
     {q:"Why is Canada’s bilingual policy significant to its national identity?", options:["Bilingualism has no connection to Canadian identity","The policy eliminated French as an official language","A reason unrelated to its significance","It reflects and protects the country’s dual linguistic heritage"], answer:3}
   ]},
]},
{day:79, label:"Day 79 — Thu", subjects:[
  {subject:"Language", title:"Reading: Analyzing Dialogue for Characterization", summary:"Grade 7 Language strand: analyzing dialogue for characterization means examining what characters say and how they say it to understand their personality, motivations, and relationships with others.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Analyzing dialogue for characterization involves examining ___.", options:["What characters say and how they say it","Only the setting described in a story","A concept unrelated to analyzing dialogue","The number of paragraphs in a story"], answer:0},
     {q:"A character’s word choice in dialogue can reveal ___.", options:["Nothing about who the character is","A concept unrelated to word choice in dialogue","Only the story’s setting","Their personality, background, or emotional state"], answer:3},
     {q:"Which is an example of using dialogue to show a character’s personality?", options:["A list of a character’s physical features","A narrator describing the weather in detail","A character speaking sharply and interrupting others often","A concept unrelated to characterization through dialogue"], answer:2},
     {q:"Dialogue tags, such as she whispered or he shouted, can help readers understand ___.", options:["The tone or emotion behind a character’s words","The setting of the story","A concept unrelated to dialogue tags","The story’s overall theme"], answer:0},
     {q:"Why might an author give two characters noticeably different speech patterns?", options:["To help distinguish their personalities and make them feel distinct","A reason unrelated to characterization","Speech patterns never affect how readers view a character","All characters in a story should sound exactly alike"], answer:0}
   ]},
  {subject:"Math", title:"Complementary, Supplementary, and Vertical Angle Pairs", summary:"Grade 7 Math strand: complementary angles add up to 90 degrees, supplementary angles add up to 180 degrees, and vertical angles, formed by intersecting lines, are always equal to each other.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Complementary angles add up to ___.", options:["360 degrees","90 degrees","A value unrelated to complementary angles","180 degrees"], answer:1},
     {q:"Supplementary angles add up to ___.", options:["180 degrees","90 degrees","45 degrees","A value unrelated to supplementary angles"], answer:0},
     {q:"Vertical angles, formed when two lines intersect, are always ___.", options:["Supplementary to each other","A concept unrelated to vertical angles","Equal to each other","Complementary to each other"], answer:2},
     {q:"If one angle measures 35 degrees, its complementary angle measures ___.", options:["A value unrelated to the calculation","145 degrees","65 degrees","55 degrees"], answer:3},
     {q:"Why are vertical angles always equal when two lines intersect?", options:["A reason unrelated to vertical angles","They are formed by the same pair of intersecting lines and share the same angle measure by geometric definition","Vertical angles are always supplementary instead of equal","Vertical angles are only sometimes equal, depending on the shape"], answer:1}
   ]},
  {subject:"Science", title:"Friction and Its Effects on Motion", summary:"Grade 7 Science strand: friction is a force that opposes motion between two surfaces in contact, slowing down or preventing movement depending on how rough or smooth the surfaces are.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Friction is a force that ___.", options:["Opposes motion between two surfaces in contact","Always speeds up motion between two surfaces","Has no effect on moving objects","A concept unrelated to friction"], answer:0},
     {q:"Rougher surfaces generally produce ___ friction than smoother surfaces.", options:["More","The exact same amount of","Less","A concept unrelated to friction"], answer:0},
     {q:"Which of these would likely produce the least friction?", options:["Sandpaper","A rough gravel surface","A smooth ice surface","A surface unrelated to this comparison"], answer:2},
     {q:"Why do cars use brakes that rely on friction?", options:["A reason unrelated to friction","Friction has no effect on a car’s ability to slow down","Friction between the brake pads and wheels helps slow the car down","Brakes work by eliminating all friction on the road"], answer:2},
     {q:"Why might engineers try to reduce friction in machines with moving parts?", options:["A reason unrelated to friction","Friction has no effect on how machines wear over time","Reducing friction always makes a machine less efficient","Reducing friction can decrease wear and improve the machine’s efficiency"], answer:3}
   ]},
  {subject:"SocialStudies", title:"The Manhattan Project and the Dawn of the Nuclear Age", summary:"Grade 7 Social Studies strand: the Manhattan Project was a major scientific and military effort during World War II that developed the first nuclear weapons, marking the beginning of the nuclear age and changing global politics.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Manhattan Project was a major effort during World War II to develop ___.", options:["A new global trade agreement","A concept unrelated to the Manhattan Project","The first commercial airplanes","The first nuclear weapons"], answer:3},
     {q:"The Manhattan Project involved cooperation between ___.", options:["Groups with no scientific expertise at all","A concept unrelated to the Manhattan Project","Only a single individual working alone","Scientists, engineers, and government officials"], answer:3},
     {q:"The completion of the Manhattan Project marked the beginning of ___.", options:["The end of all international conflict","A concept unrelated to the Manhattan Project","A period with no further scientific development","The nuclear age"], answer:3},
     {q:"The development of nuclear weapons significantly changed ___.", options:["Only local weather patterns","Global politics and international relations","Nothing about international relations","A concept unrelated to the Manhattan Project’s impact"], answer:1},
     {q:"Why do historians consider the Manhattan Project a turning point in world history?", options:["The Manhattan Project had no lasting effect on world history","A reason unrelated to its historical significance","It introduced a powerful new technology that reshaped global politics and security for decades","The technology developed was never used or referenced again"], answer:2}
   ]},
]},
{day:80, label:"Day 80 — Fri", subjects:[
  {subject:"Language", title:"Review: Language Skills (Days 71-79)", summary:"Grade 7 Language strand: this review lesson revisits key ideas from Days 71-79, including point of view, plot arcs, pronoun-antecedent agreement, cause and effect, and interview writing.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"A first-person narrator tells a story using ___.", options:["A concept unrelated to point of view","Pronouns such as I and we","Only third-person pronouns like he and she","No pronouns of any kind"], answer:1},
     {q:"An antecedent is ___.", options:["A concept unrelated to antecedents","The noun that a pronoun refers back to","A type of punctuation mark","A verb tense used in formal writing"], answer:1},
     {q:"A cause-and-effect relationship shows how ___.", options:["One event leads directly to a result","A story’s setting connects to its characters","Two unrelated events happen at the same time","A concept unrelated to cause and effect"], answer:0},
     {q:"An effective interview question is usually ___.", options:["Completely unrelated to the interview’s topic","A concept unrelated to interview questions","Open-ended, encouraging a detailed response","Closed, allowing only a yes or no answer"], answer:2},
     {q:"Why is it useful to review point of view, grammar, cause and effect, and interview writing together?", options:["It reinforces how these language skills support clear reading and writing across different formats","These skills have no connection to each other","Review never helps strengthen understanding of language","A reason unrelated to reviewing language skills"], answer:0}
   ]},
  {subject:"Math", title:"Review: Math Skills (Days 71-79)", summary:"Grade 7 Math strand: this review lesson revisits key ideas from Days 71-79, including circle graphs, the Cartesian plane, stem-and-leaf plots, and theoretical probability.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"A circle graph represents data using ___.", options:["A concept unrelated to circle graphs","Proportional slices of a circle","A grid of individual dots","A single straight line"], answer:1},
     {q:"The Cartesian plane is divided into ___ quadrants.", options:["Four","Two","A number unrelated to the Cartesian plane","Eight"], answer:0},
     {q:"In a stem-and-leaf plot, the “stem” usually represents ___.", options:["A concept unrelated to stem-and-leaf plots","The total number of data points","The leading digit or digits of a value","The final digit of a value"], answer:2},
     {q:"Theoretical probability is based on ___.", options:["The actual results of trials that have occurred","Guessing with no reasoning at all","Mathematical reasoning about possible outcomes","A concept unrelated to theoretical probability"], answer:2},
     {q:"Why is it useful to review data displays, coordinate geometry, probability, and financial literacy together?", options:["A reason unrelated to reviewing math","Review never helps strengthen understanding of math","It reinforces how these math concepts connect and apply to real-world situations","These topics have no connection to each other"], answer:2}
   ]},
  {subject:"Science", title:"Review: Science Skills (Days 71-79)", summary:"Grade 7 Science strand: this review lesson revisits key ideas from Days 71-79, including atoms and elements, light reflection, ocean currents, and renewable resource management.",
   resourceLabel:"TVO Learn: Grade 7 Science & Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"An atom is ___.", options:["A concept unrelated to atoms","A mixture of two or more substances","A type of chemical reaction","The basic building block of matter"], answer:3},
     {q:"Reflection occurs when ___.", options:["Light is completely absorbed by a surface","Light bends as it passes through a new material","Light bounces off a surface","A concept unrelated to reflection"], answer:2},
     {q:"Ocean currents are large-scale movements of ___.", options:["Only surface ice","Seawater","A concept unrelated to ocean currents","Underground freshwater"], answer:1},
     {q:"Renewable resource management aims to ___.", options:["Allow resources to replenish over time while still being used","Prevent any use of natural resources at all","A concept unrelated to renewable resource management","Use up resources as quickly as possible"], answer:0},
     {q:"Why is it useful to review matter, light, Earth systems, and resource management together?", options:["A reason unrelated to reviewing science","These topics have no connection to each other","Review is never useful in science","It reinforces how these interconnected science concepts help explain the natural world"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Review: Social Studies Skills (Days 71-79)", summary:"Grade 7 Social Studies strand: this review lesson revisits key ideas from Days 71-79, including the Acadian Expulsion, the Persons Case, population pyramids, and non-governmental organizations.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"The Acadian Expulsion involved the forced removal of ___.", options:["Thousands of Acadian settlers from their homes","No people at all","A concept unrelated to the Acadian Expulsion","A small group of British soldiers"], answer:0},
     {q:"The Persons Case was a legal ruling that recognized women as ___.", options:["Ineligible for any political involvement","A concept unrelated to the Persons Case","Persons only for the purpose of paying taxes","“Persons” eligible to serve in the Canadian Senate"], answer:3},
     {q:"A population pyramid displays a population’s distribution by ___.", options:["Favourite occupations","Age and sex","Income level only","A concept unrelated to population pyramids"], answer:1},
     {q:"A non-governmental organization (NGO) is best described as ___.", options:["A branch of a country’s official government","An independent group working to address global issues","A concept unrelated to NGOs","A for-profit business with no social mission"], answer:1},
...
{day:121, label:"Day 121 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Subject-Verb Agreement with Collective Nouns", summary:"Grade 7 Language strand: a collective noun names a group treated as a single unit, such as team, class, or family, and it typically takes a singular verb unless the individual members are clearly acting separately.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a collective noun?", options:["A noun that names a group treated as a single unit","A noun that always describes a single person","A verb describing group action","A punctuation mark used to join clauses"], answer:0},
     {q:"Which of these words is a collective noun?", options:["Running","Committee","Quickly","Blue"], answer:1},
     {q:"Does a collective noun usually take a singular verb when the group acts as one unit?", options:["Collective nouns never take any verb at all","Yes, because the group is treated as a single entity","No, collective nouns always take a plural verb","This concept has no connection to grammar"], answer:1},
     {q:"In the sentence The committee is reviewing the proposal, why is the singular verb is used?", options:["This concept has no connection to subject-verb agreement","Because the committee is acting together as one unit","Because committee is always a plural word","Because is is the only verb allowed in English"], answer:1},
     {q:"Which sentence correctly matches a collective noun with its verb?", options:["The class is going on a field trips.","A class field trip is on the going.","The class going trip a field is.","The class is going on a field trip."], answer:3}
   ]},
  {subject:"Math", title:"Probability: Conditional Probability (Intro)", summary:"Grade 7 Math strand: conditional probability is the probability that an event happens given that another event has already occurred, and it often differs from the probability of that event occurring on its own.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does conditional probability measure?", options:["The probability of an event that can never happen","A concept unrelated to probability","The probability of two events that are always identical","The probability of an event given that another event has already occurred"], answer:3},
     {q:"If a bag has 3 red and 2 blue marbles and one red marble is removed without replacement, how does the probability of drawing another red marble change?", options:["It increases to 100 percent automatically","It decreases, since one red marble and one total marble were removed","It stays exactly the same as before","A concept unrelated to probability"], answer:1},
     {q:"Conditional probability is often described using what phrase?", options:["The probability of A given B","The probability of A multiplied by B with no condition","The probability of A occurring before B is defined","A concept unrelated to conditional probability"], answer:0},
     {q:"Why might knowing that a card drawn is a face card change the probability that it is also a king?", options:["Knowing one condition narrows down the possible outcomes being considered","A face card can never also be a king","Conditions never affect a probability calculation","This concept has no connection to math"], answer:0},
     {q:"In a class of 20 students where 12 play soccer and 5 of those also play basketball, what is the probability a student plays basketball given that they play soccer?", options:["12 out of 5","12 out of 20","5 out of 12","5 out of 20"], answer:2}
   ]},
  {subject:"Science", title:"Solutions, Solubility, and Concentration", summary:"Grade 7 Science strand: a solution forms when one substance dissolves evenly into another, solubility describes how much of a substance can dissolve in a given amount of solvent, and concentration describes how much solute is present in a solution.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a solution?", options:["A concept unrelated to science","A solid that cannot be broken down further","A mixture formed when one substance dissolves evenly into another","A substance that never mixes with any other substance"], answer:2},
     {q:"What does solubility describe?", options:["A concept unrelated to solubility","The colour of a substance only","The temperature at which a substance freezes","How much of a substance can dissolve in a given amount of solvent"], answer:3},
     {q:"What does concentration describe in a solution?", options:["A concept unrelated to solutions","How much solute is present in a solution","The exact colour of the solvent","The container size holding the solution"], answer:1},
     {q:"Why might sugar dissolve faster in hot water than in cold water?", options:["Cold water always dissolves sugar faster than hot water","Temperature never affects how quickly a solute dissolves","This concept has no connection to science","Higher temperatures generally increase how quickly a solute dissolves"], answer:3},
     {q:"What happens when a solution reaches its maximum solubility and can dissolve no more solute?", options:["A concept unrelated to solubility","It stops being considered a solution at all","It becomes saturated","It becomes completely solid"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: United Empire Loyalists and Their Impact on Canada", summary:"Grade 7 Social Studies strand: United Empire Loyalists were colonists who remained loyal to Britain during the American Revolution and resettled in what is now Canada, shaping the early population and development of regions like Ontario and the Maritimes.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"Who were the United Empire Loyalists?", options:["A concept unrelated to Canadian history","Colonists who fought for American independence","A group of French explorers who settled Quebec","Colonists who remained loyal to Britain during the American Revolution"], answer:3},
     {q:"Where did many United Empire Loyalists resettle after the American Revolution?", options:["Regions that are now part of South America","A concept unrelated to Loyalist settlement","Regions that are now part of Mexico","Regions that are now Ontario and the Maritimes"], answer:3},
     {q:"Why did United Empire Loyalists leave the newly independent United States?", options:["They were forced out by British soldiers with no connection to loyalty","A concept unrelated to Canadian history","They wished to remain under British rule rather than live in the new republic","They were seeking a warmer climate for farming"], answer:2},
     {q:"How did the arrival of United Empire Loyalists affect the population of British North America?", options:["It caused the population of British North America to shrink dramatically","This concept has no connection to Canadian history","It significantly increased the population and led to new colonial boundaries","It had no effect on the population at all"], answer:2},
     {q:"Why do historians consider the Loyalist migration an important event in Canadian history?", options:["This concept has no relevance to social studies","It has no lasting significance for Canadian history","It only affected a single small village with no wider impact","It helped shape the early English-speaking population and political development of Canada"], answer:3}
   ]},
]},
{day:122, label:"Day 122 — Tue", subjects:[
  {subject:"Language", title:"Vocabulary: Eponyms — Words Named After People", summary:"Grade 7 Language strand: an eponym is a word created from the name of a real or fictional person, such as sandwich from the Earl of Sandwich or volt from the scientist Alessandro Volta.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is an eponym?", options:["A concept unrelated to vocabulary","A word borrowed directly from a sound","A word created from the name of a real or fictional person","A word that has no origin at all"], answer:2},
     {q:"Which of these words is an eponym?", options:["Blue","Table","Sandwich","Quickly"], answer:2},
     {q:"The unit volt is named after which scientist?", options:["Albert Einstein","Alessandro Volta","Isaac Newton","Marie Curie"], answer:1},
     {q:"Why might a product or invention eventually become an eponym in everyday language?", options:["Eponyms are never connected to real people or brands","A brand or inventor becomes so closely tied to an item that its name becomes the common word for it","This concept has no connection to vocabulary","Every word in English started as an eponym"], answer:1},
     {q:"Which is an example of an eponym drawn from mythology or literature?", options:["A quick walk in the park","A simple math equation","A plain white wall","A herculean effort, named after the mythological hero Hercules"], answer:3}
   ]},
  {subject:"Math", title:"Probability: With Replacement vs Without Replacement", summary:"Grade 7 Math strand: in a with replacement scenario an item is returned before the next draw so probabilities stay the same, while in a without replacement scenario the item stays out, changing the probabilities for later draws.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What happens in a with replacement scenario after an item is drawn?", options:["The item is returned before the next draw","The item is destroyed and cannot be replaced","The item is doubled before the next draw","A concept unrelated to probability"], answer:0},
     {q:"How do probabilities change across draws in a without replacement scenario?", options:["They always stay exactly the same","They change because the total number of items decreases","They become impossible to calculate at all","A concept unrelated to probability"], answer:1},
     {q:"If a bag has 4 marbles and one is drawn without replacement, how many marbles remain for the next draw?", options:["0","4","3","5"], answer:2},
     {q:"Why might a without replacement scenario give a different probability for a second event than a with replacement scenario?", options:["With replacement and without replacement always give identical results","Removing an item changes both the total count and possibly the count of a specific outcome","This concept has no connection to math","Removing an item never changes any probability"], answer:1},
     {q:"Drawing a card, recording it, and then putting it back in the deck before drawing again is an example of which scenario?", options:["A concept unrelated to probability","Neither type of draw applies here","Without replacement","With replacement"], answer:3}
   ]},
  {subject:"Science", title:"Glaciers and Their Role in Shaping Landscapes", summary:"Grade 7 Science strand: glaciers are massive, slow-moving bodies of ice that shape the land beneath and around them by eroding rock, carving valleys, and depositing sediment as they advance and retreat over long periods of time.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a glacier?", options:["A concept unrelated to earth science","A type of underground cave system","A massive, slow-moving body of ice","A fast-flowing river of warm water"], answer:2},
     {q:"How can glaciers shape the landscape beneath them?", options:["By instantly melting without leaving any trace","By having no effect on the land at all","A concept unrelated to glaciers","By eroding rock and carving valleys as they move"], answer:3},
     {q:"What happens to sediment carried by a glacier when the glacier retreats?", options:["A concept unrelated to glaciers","It is often deposited, forming new landforms","It turns instantly into solid rock","It disappears completely with no trace left behind"], answer:1},
     {q:"Why do many valleys shaped by glaciers have a distinctive U shape rather than a V shape?", options:["Glacial ice erodes broadly along the sides and bottom of a valley as it moves","Only rivers, never glaciers, can shape a valley","This concept has no connection to earth science","Glaciers never change the shape of a valley"], answer:0},
     {q:"Why are scientists interested in studying how glaciers are changing today?", options:["This concept has no relevance to science","Glaciers have no connection to climate at all","Changes in glacier size can indicate broader shifts in global climate","Glaciers never change in size over time"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Rebellions of 1837 in Upper and Lower Canada", summary:"Grade 7 Social Studies strand: in 1837, reformers in Upper and Lower Canada rebelled against colonial governments they saw as unfair and unrepresentative, and although the rebellions were defeated, they contributed to later reforms in Canadian self-government.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What happened during the Rebellions of 1837?", options:["Reformers in Upper and Lower Canada rebelled against colonial governments","A concept unrelated to Canadian history","A trade agreement was signed between Canada and Britain","A new national holiday was created"], answer:0},
     {q:"Why did reformers rebel in 1837?", options:["They were protesting a change to the school calendar","A concept unrelated to the rebellions","They viewed the colonial governments as unfair and unrepresentative","They wanted to strengthen ties with Britain even further"], answer:2},
     {q:"Were the Rebellions of 1837 ultimately defeated?", options:["No, the rebels immediately won full independence","Yes","A concept unrelated to the rebellions","The rebellions never actually took place"], answer:1},
     {q:"How did the Rebellions of 1837 influence later Canadian history?", options:["This concept has no relevance to social studies","They caused Britain to abandon all of its North American colonies immediately","They had no lasting effect on Canadian government at all","They contributed to reforms that eventually expanded self-government in the colonies"], answer:3},
     {q:"Which report, commissioned after the rebellions, recommended greater self-government for the colonies?", options:["The Balfour Declaration","The Persons Case ruling","The Quebec Act","The Durham Report"], answer:3}
   ]},
]},
{day:123, label:"Day 123 — Wed", subjects:[
  {subject:"Language", title:"Reading: Analyzing Dramatic Irony in Plays", summary:"Grade 7 Language strand: dramatic irony occurs when the audience knows something important that a character on stage does not, creating tension or humour as the audience watches the character act without that knowledge.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is dramatic irony?", options:["When a character explains every detail directly to the audience","When the audience knows something a character does not","When two characters share identical knowledge at all times","A concept unrelated to reading"], answer:1},
     {q:"What effect can dramatic irony create for an audience?", options:["Boredom, since the audience already knows everything","Complete confusion with no emotional effect","A concept unrelated to dramatic irony","Tension or humour as the audience watches events unfold"], answer:3},
     {q:"In which situation is dramatic irony present?", options:["A character explains the plot directly to another character who already knows it","Two characters discover the same secret at the exact same moment","The audience knows a character is walking into a trap, but the character does not","The audience and every character know exactly the same information"], answer:2},
     {q:"Why might a playwright use dramatic irony to build suspense?", options:["Dramatic irony always removes suspense from a scene","Watching a character act without key knowledge can make the audience anxious about what will happen","This concept has no connection to literature","Dramatic irony requires the audience to know nothing about the plot"], answer:1},
     {q:"How does dramatic irony differ from a simple plot twist?", options:["This concept has no relevance to reading comprehension","Dramatic irony relies on the audience knowing more than a character, not on a sudden surprise reveal","Dramatic irony and a plot twist always mean exactly the same thing","A plot twist requires the audience to know less than every character"], answer:1}
   ]},
  {subject:"Math", title:"Measurement: Converting Between Imperial and Metric Units", summary:"Grade 7 Math strand: the imperial system uses units like inches, feet, and pounds while the metric system uses units like centimetres, metres, and kilograms, and converting between the two systems requires using an approximate conversion factor.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Which system uses units like inches, feet, and pounds?", options:["Neither system uses these units","A concept unrelated to measurement","The metric system","The imperial system"], answer:3},
     {q:"Approximately how many centimetres are in one inch?", options:["10 centimetres","2.54 centimetres","1 centimetre","100 centimetres"], answer:1},
     {q:"Why is a conversion factor needed when converting between imperial and metric units?", options:["A concept unrelated to measurement","Conversion factors are never used in measurement","The two systems are based on different units, so a fixed ratio connects them","Imperial and metric units are always exactly the same size"], answer:2},
     {q:"If a board is 5 feet long, roughly how many metres is that, given about 3.28 feet in a metre?", options:["About 15 metres","About 0.5 metres","About 1.5 metres","About 50 metres"], answer:2},
     {q:"Why might understanding both imperial and metric units be useful in everyday life?", options:["This concept has no connection to math","Only one measurement system exists worldwide","Imperial and metric units can never be compared to each other","Different countries and industries commonly use different systems of measurement"], answer:3}
   ]},
  {subject:"Science", title:"Blood Composition and Blood Types", summary:"Grade 7 Science strand: blood is made up of plasma, red blood cells, white blood cells, and platelets, and a persons blood type is determined by specific markers on the surface of their red blood cells.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What are the main components of blood?", options:["Plasma, red blood cells, white blood cells, and platelets","A concept unrelated to biology","Only bone and muscle tissue","Only water and salt"], answer:0},
     {q:"What is the main role of red blood cells?", options:["Fighting off infection only","Carrying oxygen throughout the body","A concept unrelated to blood","Producing sound waves"], answer:1},
     {q:"What determines a persons blood type?", options:["The colour of a persons skin","Specific markers on the surface of red blood cells","A concept unrelated to blood type","The persons height and weight"], answer:1},
     {q:"Why is it important for doctors to know a patients blood type before a transfusion?", options:["This concept has no connection to biology","Blood type never matters during a transfusion","Mismatched blood types can cause a dangerous immune reaction","Every blood type is always compatible with every other type"], answer:2},
     {q:"What is the role of platelets in the blood?", options:["Helping blood clot to stop bleeding","Carrying oxygen to the lungs","A concept unrelated to blood composition","Producing new bone cells"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Meech Lake and Charlottetown Accords", summary:"Grade 7 Social Studies strand: the Meech Lake and Charlottetown Accords were attempts in the late 1980s and early 1990s to amend the Canadian constitution and address Quebecs demands for recognition, but both ultimately failed to gain the required approval.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What were the Meech Lake and Charlottetown Accords attempting to do?", options:["Create a new national anthem for Canada","Establish a new trade agreement with the United States","A concept unrelated to Canadian history","Amend the Canadian constitution and address Quebecs demands for recognition"], answer:3},
     {q:"Did both accords ultimately gain the approval needed to take effect?", options:["Only the Charlottetown Accord failed, while Meech Lake succeeded","Yes, both accords were fully approved and enacted","A concept unrelated to the accords","No, both accords ultimately failed"], answer:3},
     {q:"Roughly when did these constitutional negotiations take place?", options:["The late 1980s and early 1990s","The 2010s","The early 1800s","The 1950s"], answer:0},
     {q:"Why were these accords significant even though they failed?", options:["They were approved without any public debate or discussion","They had no impact on Canadian political discussions at all","They revealed deep divisions over how to accommodate Quebec within Confederation","This concept has no relevance to social studies"], answer:2},
     {q:"What method was used to attempt to ratify the Charlottetown Accord?", options:["A unanimous vote in the Senate only","A decision made solely by the Prime Minister","A national referendum","An international treaty signing"], answer:2}
   ]},
]},
{day:124, label:"Day 124 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Book Review", summary:"Grade 7 Language strand: a book review summarizes a text without giving away every detail, evaluates its strengths and weaknesses, and offers the writers opinion supported by specific examples from the book.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What should a book review generally include, along with a summary?", options:["A complete retelling of every plot detail","A concept unrelated to writing","An evaluation of strengths and weaknesses supported by examples","Only the books total page count"], answer:2},
     {q:"Why might a book review avoid giving away every plot detail?", options:["Spoilers are always required in a book review","A book review should never mention the plot at all","To avoid spoiling the story for readers who have not read it yet","This concept has no connection to writing"], answer:2},
     {q:"What should support the opinions expressed in a book review?", options:["Random guesses with no connection to the text","A concept unrelated to book reviews","Specific examples from the book","Only the reviewers personal mood that day"], answer:2},
     {q:"Why might a reviewer discuss a books pacing or character development?", options:["This concept has no connection to writing","These elements affect how effectively the story is told","Pacing and character development are never relevant to a review","A book review can only discuss the cover design"], answer:1},
     {q:"Which sentence sounds most like part of a book review?", options:["Once upon a time, in a faraway kingdom.","The chemical symbol for gold is Au.","The novels vivid descriptions pulled me into the setting, though the ending felt rushed.","Add 15 and 20 to get 35."], answer:2}
   ]},
  {subject:"Math", title:"Data Management: Range and Interquartile Range (IQR)", summary:"Grade 7 Math strand: the range of a data set is the difference between its highest and lowest values, while the interquartile range measures the spread of the middle half of the data and is less affected by extreme values.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"How is the range of a data set calculated?", options:["Multiplying the highest and lowest values","A concept unrelated to data management","Subtracting the lowest value from the highest value","Adding every value together"], answer:2},
     {q:"What does the interquartile range measure?", options:["The total number of values in a data set","A concept unrelated to interquartile range","The single most common value in the data","The spread of the middle half of the data"], answer:3},
     {q:"Why is the interquartile range often more useful than the range when a data set has extreme outliers?", options:["A concept unrelated to data management","The interquartile range is always identical to the range","The interquartile range is less affected by unusually high or low values","Outliers always make the interquartile range meaningless"], answer:2},
     {q:"If a data set has a lowest value of 5 and a highest value of 45, what is the range?", options:["40","45","5","50"], answer:0},
     {q:"The interquartile range is generally found using which two values?", options:["Only the very first and very last data points listed","A concept unrelated to quartiles","The first quartile and the third quartile","Only the mean and the mode"], answer:2}
   ]},
  {subject:"Science", title:"How Vaccines Train the Immune System", summary:"Grade 7 Science strand: a vaccine introduces a weakened, inactivated, or partial form of a pathogen so the immune system can learn to recognize it and build a faster, stronger defense if the real pathogen is encountered later.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What does a vaccine typically introduce into the body?", options:["A random substance with no connection to disease","A concept unrelated to science","A weakened, inactivated, or partial form of a pathogen","A fully active, dangerous version of a disease with no changes"], answer:2},
     {q:"Why does a vaccine help the immune system respond faster to a real infection later?", options:["The immune system has already learned to recognize the pathogen from the vaccine","Vaccines have no effect on how the immune system responds","The immune system forgets the vaccine immediately","A concept unrelated to vaccines"], answer:0},
     {q:"What cells does the immune system use to remember a pathogen after vaccination?", options:["A concept unrelated to the immune system","Memory cells","Only red blood cells","Only skin cells"], answer:1},
     {q:"Why might a vaccinated persons body respond more quickly to a pathogen than an unvaccinated persons body?", options:["The vaccinated persons immune system has already been trained to recognize that specific pathogen","Only unvaccinated people have functioning immune systems","Vaccination always makes the immune system weaker overall","This concept has no connection to biology"], answer:0},
     {q:"Why are vaccines considered an important public health tool?", options:["This concept has no relevance to science","Vaccines have no effect on how diseases spread through a population","Vaccines only work for a single person and never affect anyone else","They can reduce the spread and severity of infectious diseases within a population"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Group of Seven and Canadian National Identity", summary:"Grade 7 Social Studies strand: the Group of Seven was a collective of Canadian landscape painters active in the early 20th century whose bold depictions of the Canadian wilderness helped shape a distinct sense of national identity and pride.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the Group of Seven?", options:["A collective of Canadian landscape painters active in the early 20th century","A group of Canadian prime ministers","A sports team representing Canada internationally","A concept unrelated to Canadian history"], answer:0},
     {q:"What did the Group of Seven primarily paint?", options:["The Canadian wilderness and landscape","Scenes exclusively from cities outside Canada","Portraits of European royalty","A concept unrelated to the Group of Seven"], answer:0},
     {q:"How did the Group of Seven influence Canadian culture?", options:["Their art helped shape a distinct sense of Canadian national identity","A concept unrelated to Canadian identity","They discouraged any interest in Canadian landscapes","Their work had no influence on Canadian culture at all"], answer:0},
     {q:"Why might depicting the rugged Canadian wilderness have resonated with audiences in the early 20th century?", options:["The Group of Seven copied European landscapes exactly","It offered a distinctly Canadian artistic style separate from European traditions","Canadian audiences had no interest in art depicting their own country","This concept has no relevance to social studies"], answer:1},
     {q:"Why do museums and schools still study the Group of Seven today?", options:["The Group of Seven has been entirely forgotten by historians","Their paintings were destroyed and no longer exist","This concept has no relevance to Canadian history","Their work remains an important part of Canadian art history and cultural identity"], answer:3}
   ]},
]},
{day:125, label:"Day 125 — Fri", subjects:[
  {subject:"Language", title:"Media Literacy: Evaluating Deepfakes and Digital Manipulation", summary:"Grade 7 Language strand: a deepfake uses artificial intelligence to create convincing but fake images, audio, or video of real people, making it essential for viewers to critically evaluate digital media before trusting or sharing it.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a deepfake?", options:["A completely unedited video with no digital changes","A concept unrelated to media literacy","AI-generated media that convincingly but falsely depicts a real person","A type of printed newspaper article"], answer:2},
     {q:"What technology is typically used to create a deepfake?", options:["Artificial intelligence","A simple pencil and paper sketch","An unedited photograph with no software involved","A concept unrelated to deepfakes"], answer:0},
     {q:"Why is it important to critically evaluate digital media before sharing it?", options:["Sharing unverified content never causes any harm","Manipulated content can spread false information convincingly","A concept unrelated to media literacy","All digital media is always completely accurate"], answer:1},
     {q:"Which of these might be a warning sign that a video could be a deepfake?", options:["A video with a clearly labeled and credited source","Perfectly natural, verified footage from a trusted news source","A concept unrelated to digital manipulation","Unnatural facial movements or mismatched audio and lip movement"], answer:3},
     {q:"Why might deepfakes pose a challenge for journalism and public trust?", options:["This concept has no relevance to media literacy","Deepfakes have no impact on how people perceive news","Deepfakes always clearly announce themselves as fake","They can make it harder to distinguish real events from fabricated ones"], answer:3}
   ]},
  {subject:"Math", title:"Data Management: Constructing Frequency Polygons", summary:"Grade 7 Math strand: a frequency polygon displays grouped data as a series of connected line segments plotted at the midpoint of each interval, offering an alternative to a histogram for showing the shape of a distribution.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does a frequency polygon use to display data?", options:["Randomly placed dots with no clear pattern","Solid bars with no connecting lines","A concept unrelated to data management","A series of connected line segments plotted at interval midpoints"], answer:3},
     {q:"What point of each interval is typically used to plot a frequency polygon?", options:["The midpoint","The highest value only","A concept unrelated to frequency polygons","The lowest value only"], answer:0},
     {q:"How does a frequency polygon differ from a histogram?", options:["A concept unrelated to data displays","A frequency polygon can only display a single data value","It uses connected points instead of bars to show the same kind of grouped data","A frequency polygon and a histogram are always exactly identical"], answer:2},
     {q:"Why might a frequency polygon be useful for comparing two data sets on the same graph?", options:["Only one frequency polygon can ever exist on a single graph","This concept has no connection to math","Frequency polygons can never be used to compare two data sets","Overlapping line shapes can be easier to compare than overlapping bars"], answer:3},
     {q:"What does the overall shape of a frequency polygon help reveal about a data set?", options:["The general distribution and trend of the data","The exact colour used in the original data collection","A concept unrelated to frequency polygons","The names of the people who collected the data"], answer:0}
   ]},
  {subject:"Science", title:"Moon Phases and Tidal Cycles", summary:"Grade 7 Science strand: the moon appears to change shape in the sky as it orbits Earth in a predictable cycle of phases, and its gravitational pull, along with the suns, causes the rise and fall of ocean tides.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Why does the moon appear to change shape in the sky over about a month?", options:["The moon disappears completely every single day","The moon physically changes shape every night","A concept unrelated to astronomy","It moves through a predictable cycle of phases as it orbits Earth"], answer:3},
     {q:"What mainly causes ocean tides on Earth?", options:["Wind blowing across the ocean surface only","The gravitational pull of the moon and the sun","Ocean currents with no connection to gravity","A concept unrelated to tides"], answer:1},
     {q:"What is a full moon?", options:["A concept unrelated to moon phases","The phase when the entire visible side of the moon appears illuminated","The phase when the moon is completely invisible","A phase that never actually occurs"], answer:1},
     {q:"Why do the highest tides, called spring tides, occur during a full or new moon?", options:["The gravitational pull of the sun and moon align, increasing their combined effect","Spring tides only occur during the spring season","The sun and moon have no combined effect on tides","This concept has no connection to science"], answer:0},
     {q:"Why is understanding the predictable cycle of moon phases and tides useful for coastal communities?", options:["This concept has no relevance to science","It helps with activities like fishing, navigation, and planning around changing water levels","Tides never actually change throughout a lunar cycle","Moon phases and tides have no practical use for coastal communities"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Bank of Canada and Monetary Policy", summary:"Grade 7 Social Studies strand: the Bank of Canada is the countrys central bank, responsible for setting monetary policy, controlling the money supply, and working to keep inflation low and stable to support the overall economy.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What is the Bank of Canada?", options:["The countrys central bank","A concept unrelated to Canadian government","A department that manages national parks","A private bank that competes with other Canadian banks for customers"], answer:0},
     {q:"What is one main responsibility of the Bank of Canada?", options:["A concept unrelated to the Bank of Canada","Building highways across the country","Setting monetary policy and controlling the money supply","Managing Canadas foreign embassies"], answer:2},
     {q:"What economic goal does the Bank of Canada aim to support by keeping inflation low and stable?", options:["Rapid, unlimited price increases every year","The complete elimination of all Canadian currency","A healthy, stable overall economy","A concept unrelated to monetary policy"], answer:2},
     {q:"Why might the Bank of Canada adjust interest rates as a tool of monetary policy?", options:["Changing interest rates can influence borrowing, spending, and overall economic activity","The Bank of Canada has no ability to influence interest rates","This concept has no relevance to social studies","Interest rates have no connection to the economy at all"], answer:0},
     {q:"Why is it important for a country to have a central bank like the Bank of Canada?", options:["Central banks only exist to print currency with no other function","It helps manage the money supply and maintain economic stability","A central bank has no meaningful role in a countrys economy","This concept has no relevance to Canadian history"], answer:1}
   ]},
]},
{day:126, label:"Day 126 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Coordinating and Subordinating Conjunctions", summary:"Grade 7 Language strand: a coordinating conjunction, such as and or but, joins two equal ideas, while a subordinating conjunction, such as although or because, joins a dependent clause to an independent clause.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What does a coordinating conjunction do?", options:["Joins two equal ideas","Ends a sentence with no connection to grammar","A concept unrelated to grammar","Joins a dependent clause only"], answer:0},
     {q:"Which of these is a coordinating conjunction?", options:["Since","And","Although","Because"], answer:1},
     {q:"What does a subordinating conjunction do?", options:["Replaces a noun in a sentence","Joins two completely unrelated sentences with no connection","A concept unrelated to subordinating conjunctions","Joins a dependent clause to an independent clause"], answer:3},
     {q:"In the sentence Although it was raining, we went outside, what type of conjunction is although?", options:["A type of pronoun","A subordinating conjunction","A coordinating conjunction","A concept unrelated to conjunctions"], answer:1},
     {q:"Why is it useful to know the difference between coordinating and subordinating conjunctions?", options:["Only subordinating conjunctions exist in English","It helps writers correctly join clauses and vary sentence structure","This concept has no connection to grammar","The difference between these conjunctions never matters in writing"], answer:1}
   ]},
  {subject:"Math", title:"Geometry: Volume of Irregular Solids by Water Displacement", summary:"Grade 7 Math strand: the volume of an irregular solid that cannot be measured with a simple formula can be found using water displacement, where the amount of water an object pushes aside equals its volume.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What method can be used to find the volume of an irregular solid?", options:["Water displacement","Multiplying its length, width, and height only","Weighing the object on a scale only","A concept unrelated to geometry"], answer:0},
     {q:"In water displacement, what does the amount of water pushed aside represent?", options:["The mass of the object","A concept unrelated to water displacement","The temperature of the object","The volume of the object"], answer:3},
     {q:"If an object raises the water level in a container from 200 mL to 250 mL, what is the volume of the object?", options:["200 mL","250 mL","50 mL","450 mL"], answer:2},
     {q:"Why is water displacement useful for measuring the volume of an oddly shaped rock?", options:["Water displacement can only be used on perfectly cube-shaped objects","A simple geometric formula cannot easily be applied to its irregular shape","Every irregular object already has an obvious volume formula","This concept has no connection to math"], answer:1},
     {q:"What must be true about the irregular solid for the water displacement method to work correctly?", options:["A concept unrelated to measuring volume","It must always float on top of the water","It must not dissolve or absorb the water it is placed in","It must be exactly the same size as the container"], answer:2}
   ]},
  {subject:"Science", title:"Renewable Energy: Solar Panels and Photovoltaic Technology", summary:"Grade 7 Science strand: solar panels use photovoltaic cells to convert sunlight directly into electricity, offering a renewable energy source that produces no direct emissions while generating power.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What do photovoltaic cells in a solar panel convert into electricity?", options:["Wind","Heat from underground","A concept unrelated to renewable energy","Sunlight"], answer:3},
     {q:"Why is solar power considered a renewable energy source?", options:["Sunlight is a limited resource that will soon disappear","A concept unrelated to solar power","Solar panels require burning fossil fuels to operate","Sunlight is naturally replenished and does not run out"], answer:3},
     {q:"What is one advantage of solar power over fossil fuels?", options:["It never depends on weather or sunlight conditions","It requires no technology to harness at all","A concept unrelated to solar energy","It produces no direct emissions while generating electricity"], answer:3},
     {q:"What might reduce how much electricity a solar panel produces on a given day?", options:["The time of year, with no other factor involved","A concept unrelated to solar panels","The colour of nearby buildings only","Cloud cover or reduced sunlight reaching the panel"], answer:3},
     {q:"Solar panels are often grouped together on rooftops or in large fields called what?", options:["Solar farms","Power plants only","Wind farms","A concept unrelated to solar energy"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The 1972 Summit Series and Cold War Sports Diplomacy", summary:"Grade 7 Social Studies strand: the 1972 Summit Series was a hockey competition between Canada and the Soviet Union that became a symbol of Cold War rivalry, with Canadas dramatic victory sparking a surge of national pride.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the 1972 Summit Series?", options:["A hockey competition between Canada and the Soviet Union","A concept unrelated to Canadian history","A trade agreement between Canada and the United States","A summit meeting between world political leaders"], answer:0},
     {q:"Why did the 1972 Summit Series become a symbol of Cold War rivalry?", options:["A concept unrelated to the Summit Series","It had no connection to international politics at all","It was played entirely within a single country with no international element","It pitted two nations from opposing sides of the Cold War against each other in sport"], answer:3},
     {q:"How did Canadians generally react to their teams victory in the series?", options:["A concept unrelated to the Summit Series","With disappointment, since Canada actually lost","With a surge of national pride","With complete indifference to the result"], answer:2},
     {q:"Why might a sports competition like the Summit Series carry political significance beyond the game itself?", options:["It can symbolize broader ideological and national rivalries between competing systems","Sports competitions never carry any meaning beyond the game itself","This concept has no relevance to social studies","The Cold War had no connection to any cultural or sporting events"], answer:0},
     {q:"Why is the 1972 Summit Series still remembered as a significant moment in Canadian history?", options:["It is seen as a defining moment of national identity and Cold War tension","It had no lasting cultural impact on Canada","This concept has no relevance to Canadian history","It has been completely forgotten by most Canadians today"], answer:0}
   ]},
]},
{day:127, label:"Day 127 — Tue", subjects:[
  {subject:"Language", title:"Vocabulary: Oxymorons and Contradictory Phrases", summary:"Grade 7 Language strand: an oxymoron combines two contradictory terms for effect, such as deafening silence or bittersweet, often highlighting a complex or ironic idea in just a few words.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is an oxymoron?", options:["A phrase that combines two contradictory terms","A concept unrelated to vocabulary","A phrase with only one possible meaning","A word that means the exact same thing twice"], answer:0},
     {q:"Which of these phrases is an example of an oxymoron?", options:["Cold winter","Bright sunshine","Fast runner","Deafening silence"], answer:3},
     {q:"Why might a writer use an oxymoron in a piece of writing?", options:["To highlight a complex or ironic idea in just a few words","Oxymorons are always grammatically incorrect and should be avoided","A concept unrelated to oxymorons","Oxymorons never add any meaning to writing"], answer:0},
     {q:"What makes bittersweet an oxymoron?", options:["A concept unrelated to oxymorons","It combines the contradictory ideas of bitterness and sweetness","It describes only one simple, uncomplicated feeling","It has no connection to taste or emotion at all"], answer:1},
     {q:"Why might the phrase original copy be considered an oxymoron?", options:["This concept has no relevance to vocabulary","The two words always mean exactly the same thing","A copy is always considered more original than the source","Original suggests something new, while copy suggests something duplicated"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Surface-Area-to-Volume Ratio and Its Real-World Effects", summary:"Grade 7 Math strand: the surface-area-to-volume ratio compares an objects outer surface area to its interior volume, and this ratio decreases as an object gets larger, which affects things like heat loss and cooling rates.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does the surface-area-to-volume ratio compare?", options:["A concept unrelated to geometry","An objects mass to its colour","An objects height to its width only","An objects outer surface area to its interior volume"], answer:3},
     {q:"What generally happens to the surface-area-to-volume ratio as an object gets larger?", options:["It always stays exactly the same","A concept unrelated to this ratio","It decreases","It increases without any limit"], answer:2},
     {q:"Why might a smaller object cool down faster than a larger object of the same shape?", options:["A smaller object has a relatively larger surface area compared to its volume, allowing faster heat loss","Object size has no effect on how quickly heat is lost","Smaller objects always have a lower surface-area-to-volume ratio than larger ones","A concept unrelated to geometry"], answer:0},
     {q:"A cube with side length 2 has a smaller surface-area-to-volume ratio than a cube with side length ___.", options:["3","4","1","5"], answer:2},
     {q:"Why might engineers consider surface-area-to-volume ratio when designing cooling systems for machinery?", options:["A higher ratio can help a design lose heat more efficiently","Surface-area-to-volume ratio has no connection to how objects lose heat","Cooling systems never depend on the shape or size of an object","This concept has no relevance to math"], answer:0}
   ]},
  {subject:"Science", title:"Decomposers and Nutrient Recycling in Ecosystems", summary:"Grade 7 Science strand: decomposers, such as fungi and bacteria, break down dead organisms and waste material, releasing nutrients back into the soil and allowing them to be reused by other living things in an ecosystem.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is the main role of decomposers in an ecosystem?", options:["Hunting and consuming only living prey","Breaking down dead organisms and waste to release nutrients","Producing their own food using sunlight only","A concept unrelated to ecosystems"], answer:1},
     {q:"Which of these organisms are common decomposers?", options:["A concept unrelated to decomposers","Only plants that photosynthesize","Fungi and bacteria","Only large predators"], answer:2},
     {q:"What happens to nutrients released by decomposers?", options:["They return to the soil and can be reused by other living things","A concept unrelated to nutrient cycling","They disappear from the ecosystem permanently","They only benefit the decomposers themselves"], answer:0},
     {q:"Why would an ecosystem struggle to function without decomposers?", options:["This concept has no connection to biology","Dead material and waste would build up instead of being recycled into usable nutrients","Only producers, never decomposers, matter in an ecosystem","Ecosystems function exactly the same with or without decomposers"], answer:1},
     {q:"How are decomposers connected to nutrient cycles, such as the carbon and nitrogen cycles?", options:["This concept has no relevance to science","Decomposers have no role in any nutrient cycle","They help break down organic material, returning key elements to the environment for reuse","Nutrient cycles function without any input from living organisms"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canada and the Founding of NATO", summary:"Grade 7 Social Studies strand: Canada was a founding member of the North Atlantic Treaty Organization in 1949, a military alliance created to provide collective defense among member countries during the early Cold War period.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What is NATO?", options:["A trade agreement focused only on agricultural goods","A military alliance created to provide collective defense among member countries","An organization focused solely on environmental protection","A concept unrelated to Canadian history"], answer:1},
     {q:"Was Canada a founding member of NATO?", options:["Yes","Canada has never been a member of NATO","A concept unrelated to NATO","No, Canada joined NATO decades after it was founded"], answer:0},
     {q:"In what year was NATO founded?", options:["1867","1949","1999","1918"], answer:1},
     {q:"Why was NATO created during the early Cold War period?", options:["NATO was created purely to promote international trade","Member countries wanted collective protection against potential threats from the Soviet Union","A concept unrelated to NATO","NATO was created with no connection to Cold War tensions"], answer:1},
     {q:"What does collective defense mean within an alliance like NATO?", options:["Each member must handle every conflict entirely alone","A concept unrelated to collective defense","An attack on one member is treated as an attack on all members","Only the strongest member is responsible for defending the alliance"], answer:2}
   ]},
]},
{day:128, label:"Day 128 — Wed", subjects:[
  {subject:"Language", title:"Reading: Analyzing In Medias Res and Nonlinear Timelines", summary:"Grade 7 Language strand: in medias res means beginning a story in the middle of the action rather than at the very start, and a nonlinear timeline presents events out of chronological order, requiring readers to piece the story together.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What does in medias res mean?", options:["A concept unrelated to reading","Ending a story before any action occurs","Beginning a story in the middle of the action","Telling a story in strict chronological order only"], answer:2},
     {q:"What is a nonlinear timeline in storytelling?", options:["A structure where events are presented out of chronological order","A timeline that only ever moves forward one second at a time","A concept unrelated to nonlinear timelines","A structure where every event happens in perfect time order"], answer:0},
     {q:"Why might an author choose to begin a story in medias res?", options:["Every story is required to begin in medias res","A concept unrelated to reading strategies","To immediately capture the readers interest with action or tension","Beginning in the middle of the action always confuses readers with no benefit"], answer:2},
     {q:"What skill do readers often need when following a nonlinear timeline?", options:["Reading only the first page of the story","Piecing together the order of events as the story unfolds","Ignoring the order of events completely","A concept unrelated to reading comprehension"], answer:1},
     {q:"Which is an example of a nonlinear structure?", options:["A story that begins with the ending, then flashes back to explain how it happened","A story told in exact chronological order from beginning to end with no flashbacks","A list of dictionary definitions","A recipe with numbered steps"], answer:0}
   ]},
  {subject:"Math", title:"Financial Literacy: Understanding Depreciation and Asset Value Over Time", summary:"Grade 7 Math strand: depreciation is the gradual decrease in the value of an asset, such as a car or electronic device, over time due to age, wear, and changing market conditions.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is depreciation?", options:["The gradual decrease in the value of an asset over time","A concept unrelated to financial literacy","A fixed value that never changes for any asset","The gradual increase in the value of an asset over time"], answer:0},
     {q:"Which of these items is most likely to depreciate in value over time?", options:["A concept unrelated to depreciation","A rare, well-preserved painting","Land in a rapidly growing city, which often appreciates instead","A used car"], answer:3},
     {q:"What might cause an electronic device to lose value over time?", options:["A concept unrelated to depreciation","Depreciation only applies to houses, never electronics","Age, wear, and the release of newer models","Devices always keep the exact same value forever"], answer:2},
     {q:"If a car worth 20,000 dollars depreciates by 10 percent in its first year, what is its approximate value after that year?", options:["20,000 dollars","18,000 dollars","2,000 dollars","22,000 dollars"], answer:1},
     {q:"Why might understanding depreciation be useful when deciding whether to buy a new or used vehicle?", options:["Depreciation has no connection to buying decisions","Every vehicle depreciates at exactly the same fixed rate","It helps estimate how much value the vehicle may lose over time","This concept has no relevance to financial literacy"], answer:2}
   ]},
  {subject:"Science", title:"Physical and Chemical Weathering of Rocks", summary:"Grade 7 Science strand: physical weathering breaks rock into smaller pieces without changing its chemical makeup, such as through freezing and thawing, while chemical weathering alters the minerals in rock through reactions like oxidation or dissolution.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What does physical weathering do to rock?", options:["A concept unrelated to earth science","Turns the rock into a different type of mineral entirely","Breaks it into smaller pieces without changing its chemical makeup","Completely dissolves the rock into liquid"], answer:2},
     {q:"What is one process that causes physical weathering?", options:["Sound waves traveling through the air","Freezing and thawing of water in cracks","Photosynthesis in nearby plants only","A concept unrelated to physical weathering"], answer:1},
     {q:"What happens during chemical weathering?", options:["The rock is broken apart with no chemical change at all","The minerals in rock are altered through chemical reactions","Rock instantly transforms into a living organism","A concept unrelated to chemical weathering"], answer:1},
     {q:"Why might iron-rich rocks develop a reddish, rusty appearance over time?", options:["Oxidation, a type of chemical weathering, reacts with the iron in the rock","This concept has no connection to earth science","Only physical weathering can ever change a rocks appearance","Rocks never undergo any type of chemical change"], answer:0},
     {q:"Why might freezing and thawing be especially effective at breaking apart rock in a crack?", options:["Freezing and thawing have no effect on the size of a crack","Water always shrinks as it freezes, closing cracks completely","This concept has no relevance to science","Water expands as it freezes, widening the crack over repeated cycles"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Time Zones and the International Date Line", summary:"Grade 7 Social Studies strand: time zones divide the world into regions that generally share the same standard time based on longitude, and the International Date Line marks where, by convention, the calendar date changes by a full day.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What do time zones divide the world into?", options:["Regions that always share identical weather patterns","Regions that generally share the same standard time","A concept unrelated to geography","Regions based only on population size"], answer:1},
     {q:"What is the International Date Line used for?", options:["Marking where the calendar date changes by a full day","Marking the boundary between countries only","Measuring temperature differences across the globe","A concept unrelated to time zones"], answer:0},
     {q:"What geographic measurement are time zones generally based on?", options:["A concept unrelated to time zones","Latitude only, with no connection to longitude","Altitude above sea level","Longitude"], answer:3},
     {q:"Why do countries or regions sometimes adjust their official time zone boundaries away from a strict longitude line?", options:["Longitude has no relationship to time zones at all","To keep areas with close economic or political ties on the same time for convenience","This concept has no connection to geography","Time zone boundaries can never be adjusted for any reason"], answer:1},
     {q:"Why might understanding time zones be important for international communication and travel?", options:["Time zones have no effect on communication or travel planning","It helps people coordinate schedules and avoid confusion across different regions","Every location in the world shares the exact same time","This concept has no relevance to social studies"], answer:1}
   ]},
]},
{day:129, label:"Day 129 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Diary Entry from a Historical Perspective", summary:"Grade 7 Language strand: a historical diary entry imagines the voice and perspective of a person living through a past event, using accurate details and a personal tone to help readers connect emotionally with history.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What does a historical diary entry imagine?", options:["The voice and perspective of a person living through a past event","A completely fictional world with no connection to history","A formal news report with no personal perspective","A concept unrelated to writing"], answer:0},
     {q:"Why is accurate historical detail important in this type of writing?", options:["A concept unrelated to historical diary entries","It helps the diary entry feel authentic to the time period being described","Accuracy is never important in creative writing","Historical details should always be avoided completely"], answer:1},
     {q:"What tone does a diary entry typically use?", options:["A concept unrelated to tone in writing","An entirely objective tone with no perspective at all","A personal, reflective tone","A strictly formal, businesslike tone with no emotion"], answer:2},
     {q:"Why might writing a diary entry from a historical perspective help readers understand a past event more deeply?", options:["Diary entries never help readers understand historical events","Historical events are always better understood only through statistics","It connects readers emotionally by showing history through an individual persons experience","This concept has no connection to writing"], answer:2},
     {q:"Which opening sounds most like a historical diary entry?", options:["Today, the ship finally docked after weeks at sea, and I can hardly believe what I have seen.","Please find attached the quarterly financial report.","Add 15 and 20 to get 35.","The chemical symbol for gold is Au."], answer:0}
   ]},
  {subject:"Math", title:"Geometry: The Midpoint of a Line Segment on the Cartesian Plane", summary:"Grade 7 Math strand: the midpoint of a line segment is the point exactly halfway between its two endpoints, and it can be found on the Cartesian plane by averaging the x-coordinates and averaging the y-coordinates of the endpoints.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is the midpoint of a line segment?", options:["The point at one of the two endpoints","The point exactly halfway between its two endpoints","A concept unrelated to geometry","The longest possible point along the segment"], answer:1},
     {q:"How is the midpoint of a segment found on the Cartesian plane?", options:["By multiplying the two endpoints together","A concept unrelated to midpoints","By averaging the x-coordinates and averaging the y-coordinates of the endpoints","By adding the x-coordinates together with no division"], answer:2},
     {q:"What is the midpoint of a segment with endpoints at (2, 4) and (6, 8)?", options:["(4, 6)","(2, 4)","(6, 8)","(8, 12)"], answer:0},
     {q:"Why might finding a midpoint be useful when working with maps or coordinate-based problems?", options:["Midpoints have no practical use on the Cartesian plane","It can help locate a central point between two known locations","A concept unrelated to geometry","A midpoint can only be found using a physical ruler, never coordinates"], answer:1},
     {q:"If one endpoint of a segment is (0, 0) and the midpoint is (3, 5), what is the other endpoint?", options:["(0, 0)","(1.5, 2.5)","(6, 10)","(3, 5)"], answer:2}
   ]},
  {subject:"Science", title:"3D Printing and Additive Manufacturing", summary:"Grade 7 Science strand: 3D printing, also called additive manufacturing, builds objects layer by layer from a digital design, allowing complex shapes to be created that would be difficult or impossible to make using traditional manufacturing methods.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is another name for 3D printing?", options:["Traditional casting","A concept unrelated to technology","Subtractive manufacturing","Additive manufacturing"], answer:3},
     {q:"How does a 3D printer typically build an object?", options:["A concept unrelated to 3D printing","By carving material away from a solid block","By melting an entire object into a single mold instantly","Layer by layer from a digital design"], answer:3},
     {q:"What is one advantage of 3D printing over some traditional manufacturing methods?", options:["A concept unrelated to 3D printing","It can create complex shapes that would be difficult to make otherwise","It can only ever create simple cube shapes","It always requires more raw material than traditional methods"], answer:1},
     {q:"Why might engineers use 3D printing to create a prototype before mass-producing a product?", options:["This concept has no connection to technology","Mass production always happens before any prototype is made","It allows a design to be tested and adjusted quickly and at lower cost","Prototypes can never be created using 3D printing"], answer:2},
     {q:"Which of these fields has benefited from advances in 3D printing technology?", options:["Medicine, through custom prosthetics and models","Fields that have no use for manufactured objects","Only the food service industry, with no other applications","A concept unrelated to 3D printing"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Urban Heat Islands and City Climate Patterns", summary:"Grade 7 Social Studies strand: an urban heat island forms when cities, with their concentration of pavement and buildings, absorb and retain more heat than surrounding rural areas, creating noticeably warmer local temperatures.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What is an urban heat island?", options:["A rural area that is always colder than any nearby city","An island located entirely within a citys harbour","A concept unrelated to geography","An area where a city is noticeably warmer than surrounding rural areas"], answer:3},
     {q:"Why do cities often become warmer than surrounding rural areas?", options:["A concept unrelated to urban heat islands","Cities receive less sunlight than rural areas","Cities always contain more trees and green space than rural areas","Pavement and buildings absorb and retain more heat than natural landscapes"], answer:3},
     {q:"Which surface would likely contribute most to an urban heat island effect?", options:["Dark asphalt pavement","A concept unrelated to heat retention","A forest with dense tree cover","A large grassy field"], answer:0},
     {q:"Why might city planners add green spaces or reflective roofing to reduce the urban heat island effect?", options:["Urban heat islands cannot be reduced by any planning decisions","Green spaces and reflective roofing always increase citywide temperatures","These features can help lower how much heat a city absorbs and retains","This concept has no connection to social studies"], answer:2},
     {q:"Why is understanding urban heat islands important for city planning and public health?", options:["This concept has no relevance to social studies","Urban temperature has no connection to public health or energy use","Cities are always exactly the same temperature as nearby rural areas","Higher urban temperatures can affect energy use, comfort, and heat-related health risks"], answer:3}
   ]},
]},
{day:130, label:"Day 130 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Grammar, Vocabulary, Reading, and Writing", summary:"Grade 7 Language strand review: students revisit subject-verb agreement with collective nouns, eponyms, dramatic irony, evaluating deepfakes, oxymorons, and writing a historical diary entry.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a collective noun?", options:["A noun that always describes a single person","A punctuation mark used to join clauses","A verb describing group action","A noun that names a group treated as a single unit"], answer:3},
     {q:"What is an eponym?", options:["A word created from the name of a real or fictional person","A concept unrelated to vocabulary","A word borrowed directly from a sound","A word that has no origin at all"], answer:0},
     {q:"What is dramatic irony?", options:["When the audience knows something a character does not","When a character explains every detail directly to the audience","A concept unrelated to reading","When two characters share identical knowledge at all times"], answer:0},
     {q:"What is a deepfake?", options:["A concept unrelated to media literacy","AI-generated media that convincingly but falsely depicts a real person","A completely unedited video with no digital changes","A type of printed newspaper article"], answer:1},
     {q:"What is an oxymoron?", options:["A phrase that combines two contradictory terms","A concept unrelated to vocabulary","A word that means the exact same thing twice","A phrase with only one possible meaning"], answer:0}
   ]},
  {subject:"Math", title:"Math Review: Probability, Measurement, Data, and Geometry", summary:"Grade 7 Math strand review: students revisit conditional probability, converting imperial and metric units, range and interquartile range, volume by water displacement, and the midpoint formula.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does conditional probability measure?", options:["A concept unrelated to probability","The probability of two events that are always identical","The probability of an event given that another event has already occurred","The probability of an event that can never happen"], answer:2},
     {q:"Which system uses units like inches, feet, and pounds?", options:["The metric system","The imperial system","Neither system uses these units","A concept unrelated to measurement"], answer:1},
     {q:"How is the range of a data set calculated?", options:["Adding every value together","Multiplying the highest and lowest values","A concept unrelated to data management","Subtracting the lowest value from the highest value"], answer:3},
     {q:"What method can be used to find the volume of an irregular solid?", options:["Multiplying its length, width, and height only","Weighing the object on a scale only","A concept unrelated to geometry","Water displacement"], answer:3},
     {q:"How is the midpoint of a segment found on the Cartesian plane?", options:["By multiplying the two endpoints together","By adding the x-coordinates together with no division","A concept unrelated to midpoints","By averaging the x-coordinates and averaging the y-coordinates of the endpoints"], answer:3}
   ]},
  {subject:"Science", title:"Science Review: Chemistry, Earth Science, Biology, and Technology", summary:"Grade 7 Science strand review: students revisit solutions and solubility, glaciers, blood composition, how vaccines work, and 3D printing and additive manufacturing.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a solution?", options:["A solid that cannot be broken down further","A concept unrelated to science","A mixture formed when one substance dissolves evenly into another","A substance that never mixes with any other substance"], answer:2},
     {q:"What is a glacier?", options:["A massive, slow-moving body of ice","A type of underground cave system","A fast-flowing river of warm water","A concept unrelated to earth science"], answer:0},
     {q:"What are the main components of blood?", options:["A concept unrelated to biology","Only water and salt","Only bone and muscle tissue","Plasma, red blood cells, white blood cells, and platelets"], answer:3},
     {q:"What does a vaccine typically introduce into the body?", options:["A weakened, inactivated, or partial form of a pathogen","A concept unrelated to science","A fully active, dangerous version of a disease with no changes","A random substance with no connection to disease"], answer:0},
     {q:"What is another name for 3D printing?", options:["Traditional casting","Subtractive manufacturing","A concept unrelated to technology","Additive manufacturing"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Nation-Building and Global Institutions", summary:"Grade 7 Social Studies strand review: students revisit the United Empire Loyalists, the Rebellions of 1837, the Meech Lake and Charlottetown Accords, the Group of Seven, the Bank of Canada, and the founding of NATO.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"Who were the United Empire Loyalists?", options:["Colonists who remained loyal to Britain during the American Revolution","A concept unrelated to Canadian history","A group of French explorers who settled Quebec","Colonists who fought for American independence"], answer:0},
     {q:"What happened during the Rebellions of 1837?", options:["A new national holiday was created","Reformers in Upper and Lower Canada rebelled against colonial governments","A trade agreement was signed between Canada and Britain","A concept unrelated to Canadian history"], answer:1},
     {q:"What were the Meech Lake and Charlottetown Accords attempting to do?", options:["Amend the Canadian constitution and address Quebecs demands for recognition","A concept unrelated to Canadian history","Create a new national anthem for Canada","Establish a new trade agreement with the United States"], answer:0},
     {q:"What was the Group of Seven?", options:["A concept unrelated to Canadian history","A collective of Canadian landscape painters active in the early 20th century","A sports team representing Canada internationally","A group of Canadian prime ministers"], answer:1},
     {q:"What is NATO?", options:["A trade agreement focused only on agricultural goods","A concept unrelated to Canadian history","An organization focused solely on environmental protection","A military alliance created to provide collective defense among member countries"], answer:3}
   ]},
]},
{day:131, label:"Day 131 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Relative Clauses and Relative Pronouns", summary:"Grade 7 Language strand: a relative clause adds extra information about a noun and begins with a relative pronoun such as who, whom, whose, which, or that, connecting the extra detail directly to the noun it describes.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a relative clause?", options:["A clause that never connects to any noun","A concept unrelated to grammar","A clause that always stands alone as its own sentence","A clause that adds extra information about a noun using a relative pronoun"], answer:3},
     {q:"Which word is commonly used as a relative pronoun?", options:["Quickly","Running","Blue","Which"], answer:3},
     {q:"In the sentence The book which I borrowed was excellent, what does the relative clause describe?", options:["The reader of the book","The act of borrowing only","A concept unrelated to relative clauses","The book"], answer:3},
     {q:"Why would a writer use who instead of which in a relative clause?", options:["Which can only ever refer to people","Who generally refers to people while which generally refers to things","Who and which always mean exactly the same thing","This concept has no connection to grammar"], answer:1},
     {q:"Which sentence correctly uses a relative clause?", options:["The teacher who helped me was patient very.","Patient the teacher who helped me was.","The teacher who helped me was very patient.","Helped the teacher who was me patient."], answer:2}
   ]},
  {subject:"Math", title:"Data Management: Mean Absolute Deviation (MAD)", summary:"Grade 7 Math strand: mean absolute deviation, or MAD, measures the average distance between each data value and the mean of the data set, giving a sense of how spread out the values are.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does mean absolute deviation (MAD) measure?", options:["The average distance between each data value and the mean","The total number of values in a data set","The single highest value in a data set","A concept unrelated to data management"], answer:0},
     {q:"What is the first step in finding the MAD of a data set?", options:["Removing the lowest and highest values entirely","A concept unrelated to MAD","Multiplying every value by itself","Calculating the mean of the data set"], answer:3},
     {q:"Why are absolute values used when calculating MAD?", options:["Absolute values always make every difference equal to zero","Absolute value has no purpose in this calculation","So that positive and negative differences do not cancel each other out","A concept unrelated to data management"], answer:2},
     {q:"If a data set has a mean of 10 and one value is 14, what is the absolute deviation of that value from the mean?", options:["24","14","10","4"], answer:3},
     {q:"Why might MAD be useful for comparing how consistent two data sets are?", options:["MAD can never be used to compare two different data sets","A smaller MAD suggests the data values are generally closer to the mean","A larger MAD always means the data set has fewer values","This concept has no connection to math"], answer:1}
   ]},
  {subject:"Science", title:"Comets, Asteroids, and Meteors", summary:"Grade 7 Science strand: comets are icy bodies that develop glowing tails as they near the sun, asteroids are rocky or metallic bodies found mostly in the asteroid belt between Mars and Jupiter, and meteors are streaks of light produced when space debris burns up in Earths atmosphere.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a comet mostly made of?", options:["A concept unrelated to astronomy","Pure liquid water only","Ice, dust, and rocky material","Solid metal with no ice at all"], answer:2},
     {q:"Where are most asteroids in our solar system found?", options:["The asteroid belt between Mars and Jupiter","A concept unrelated to asteroids","Orbiting far outside the solar system entirely","Deep inside the suns core"], answer:0},
     {q:"What is a meteor?", options:["A type of cloud found only on Earth","A concept unrelated to astronomy","A fully formed planet within our solar system","A streak of light produced when space debris burns up in the atmosphere"], answer:3},
     {q:"Why does a comet develop a glowing tail as it approaches the sun?", options:["This concept has no connection to science","A comets tail forms only when it is farthest from the sun","Comets always have an identical tail regardless of distance from the sun","Heat from the sun causes ice on the comet to turn into gas and dust that stream away from it"], answer:3},
     {q:"What is the difference between a meteor and a meteorite?", options:["A meteor and a meteorite are always exactly the same thing","A meteorite can only be found floating in space, never on the ground","This concept has no relevance to astronomy","A meteorite is a piece of space debris that survives and reaches the ground"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Fenian Raids and the Push Toward Confederation", summary:"Grade 7 Social Studies strand: the Fenian Raids were a series of armed incursions into British North America by an Irish-American group in the 1860s, and the resulting sense of vulnerability helped strengthen support for Confederation among the colonies.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What were the Fenian Raids?", options:["A peaceful trade negotiation between Canada and Ireland","A series of scientific expeditions across the Arctic","A series of armed incursions into British North America by an Irish-American group","A concept unrelated to Canadian history"], answer:2},
     {q:"Why did the Fenians target British North America in the 1860s?", options:["They wanted to establish a new trade route to Asia","They were hired directly by the Canadian government","A concept unrelated to the Fenian Raids","They hoped pressuring Britain in North America would help the cause of Irish independence"], answer:3},
     {q:"How did the Fenian Raids affect support for Confederation among the colonies?", options:["They had no effect whatsoever on support for Confederation","They increased a sense of vulnerability that strengthened support for a unified defense","They caused every colony to reject the idea of Confederation completely","A concept unrelated to Canadian history"], answer:1},
     {q:"In which decade did the Fenian Raids mainly take place?", options:["The 1900s","The 1700s","The 1860s","The 1950s"], answer:2},
     {q:"Why do historians consider the Fenian Raids significant to Confederation in 1867?", options:["They have no connection to the events leading up to Confederation","They highlighted the colonies need for stronger, unified defense against outside threats","This concept has no relevance to social studies","They led to the colonies being permanently annexed by another country"], answer:1}
   ]},
]},
{day:132, label:"Day 132 — Tue", subjects:[
  {subject:"Language", title:"Vocabulary: Malapropisms and Word Confusion", summary:"Grade 7 Language strand: a malapropism happens when a speaker or character mistakenly swaps a word for a similar-sounding word, often creating an unintentionally funny effect, as when a character says dance a flamingo instead of dance a flamenco.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a malapropism?", options:["A concept unrelated to vocabulary","The mistaken use of a word in place of a similar-sounding word","A word that never appears in dialogue","A word that has exactly one correct meaning"], answer:1},
     {q:"Which sentence contains an example of a malapropism?", options:["She wanted to sing a song at the party.","She wanted to dance a flamenco at the party.","She wanted to dance a flamingo at the party.","She wanted to read a book at the party."], answer:2},
     {q:"Why might an author give a character a habit of using malapropisms?", options:["Malapropisms never appear in fiction","A concept unrelated to characterization","To add humour and reveal something about the characters personality","Malapropisms are always meant to be taken completely seriously"], answer:2},
     {q:"The term malapropism comes from a character in which type of work?", options:["A stage play","A scientific textbook","A weather report","A concept unrelated to vocabulary"], answer:0},
     {q:"Why is context important for recognizing a malapropism?", options:["A malapropism can only be identified by its spelling, never its meaning","This concept has no connection to vocabulary","Context never helps identify a mistaken word choice","Context reveals that a similar-sounding but incorrect word was used by mistake"], answer:3}
   ]},
  {subject:"Math", title:"Geometry: Angle Relationships in Parallel Lines and Transversals", summary:"Grade 7 Math strand: when a transversal crosses two parallel lines, it creates pairs of angles with predictable relationships, including equal corresponding angles, equal alternate interior angles, and supplementary co-interior angles.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is a transversal?", options:["A line segment with no defined length","A concept unrelated to geometry","A line that crosses two or more other lines","A line that never intersects any other line"], answer:2},
     {q:"What is true about corresponding angles when a transversal crosses two parallel lines?", options:["A concept unrelated to parallel lines","They are always equal to zero degrees","They are equal in measure","They always add up to 90 degrees"], answer:2},
     {q:"What is true about alternate interior angles formed by a transversal crossing two parallel lines?", options:["They always add up to 360 degrees","They are never related to each other in any way","A concept unrelated to transversals","They are equal in measure"], answer:3},
     {q:"What do co-interior (same-side interior) angles add up to when formed by a transversal crossing two parallel lines?", options:["90 degrees","360 degrees","180 degrees","45 degrees"], answer:2},
     {q:"If one angle formed by a transversal crossing parallel lines measures 70 degrees, what is the measure of its corresponding angle?", options:["70 degrees","35 degrees","180 degrees","110 degrees"], answer:0}
   ]},
  {subject:"Science", title:"Permafrost and the Cryosphere", summary:"Grade 7 Science strand: the cryosphere includes all the frozen water on Earth, such as glaciers, sea ice, and snow, while permafrost is ground that has remained frozen for two or more consecutive years, mostly found in Arctic and high-altitude regions.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is permafrost?", options:["Ground that has remained frozen for two or more consecutive years","A type of rock found only underwater","Ground that has never once frozen in recorded history","A concept unrelated to earth science"], answer:0},
     {q:"What does the term cryosphere refer to?", options:["A concept unrelated to the cryosphere","All the frozen water found on Earth, including ice, snow, and permafrost","Only the liquid water found in oceans","The layer of gases surrounding Earth"], answer:1},
     {q:"Why is thawing permafrost a concern for scientists studying climate change?", options:["Thawing permafrost has no effect on the atmosphere at all","A concept unrelated to earth science","Permafrost releases oxygen only, with no other gases involved","Thawing permafrost can release trapped greenhouse gases into the atmosphere"], answer:3},
     {q:"Where is permafrost most commonly found?", options:["Tropical rainforests near the equator","Arctic and high-altitude mountain regions","Ocean floors far from any coastline","A concept unrelated to permafrost"], answer:1},
     {q:"Why might thawing permafrost cause problems for roads and buildings constructed on top of it?", options:["This concept has no relevance to earth science","Buildings are never affected by changes in the ground beneath them","Thawing permafrost always makes the ground more solid and stable","The ground becomes unstable and can shift or sink as the ice within it melts"], answer:3}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The National Policy of 1879", summary:"Grade 7 Social Studies strand: the National Policy, introduced by Prime Minister John A. Macdonald in 1879, combined protective tariffs on foreign goods, construction of a transcontinental railway, and immigration to the west into a single strategy for economic development.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the National Policy of 1879?", options:["A treaty ending a war between Canada and another country","A policy focused only on education reform","An economic strategy combining tariffs, a transcontinental railway, and western immigration","A concept unrelated to Canadian history"], answer:2},
     {q:"Why did the National Policy include protective tariffs on foreign goods?", options:["To eliminate all trade between Canada and other countries","To protect Canadian manufacturers from foreign competition","Tariffs were included with no economic purpose at all","A concept unrelated to the National Policy"], answer:1},
     {q:"What role did the railway play in the National Policy?", options:["A concept unrelated to the National Policy","It was intended to discourage any travel between regions","It aimed to connect the country and encourage settlement of the west","It had no connection to settlement or economic development"], answer:2},
     {q:"Why did the National Policy encourage immigration to western Canada?", options:["To reduce the overall population of Canada","Immigration was actively discouraged under the National Policy","A concept unrelated to Canadian history","To populate the west and support agricultural and economic growth"], answer:3},
     {q:"Who was the prime minister most closely associated with introducing the National Policy?", options:["Pierre Trudeau","Sir John A. Macdonald","Lester B. Pearson","Sir Wilfrid Laurier"], answer:1}
   ]},
]},
{day:133, label:"Day 133 — Wed", subjects:[
  {subject:"Language", title:"Reading: Analyzing Literary Archetypes", summary:"Grade 7 Language strand: a literary archetype is a recurring character type, symbol, or pattern, such as the hero or the wise mentor, that appears across many stories and cultures because it reflects a familiar human experience.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a literary archetype?", options:["A concept unrelated to reading","A character that appears in only one story ever written","A type of punctuation used in dialogue","A recurring character type or pattern found across many stories"], answer:3},
     {q:"Which of these is a well-known literary archetype?", options:["A character with no name or role in the story","The wise mentor who guides the hero","A concept unrelated to archetypes","A list of chapter titles"], answer:1},
     {q:"Why do archetypes appear across many different cultures and time periods?", options:["This concept has no connection to literature","Archetypes are always invented by a single author with no wider connection","They reflect familiar human experiences and roles that many cultures recognize","Archetypes only appear in stories written in the last ten years"], answer:2},
     {q:"How does an archetype differ from a highly unique, one-of-a-kind character?", options:["An archetype follows a recognizable pattern seen in other stories, while a unique character does not","Archetypes can only exist in nonfiction writing","An archetype and a unique character are always exactly identical","This concept has no relevance to reading"], answer:0},
     {q:"Which situation best reflects the hero archetype?", options:["A character who never leaves home or faces any challenge","A concept unrelated to literary archetypes","A character who exists only in a list of ingredients","A character who leaves home, faces challenges, and grows through the journey"], answer:3}
   ]},
  {subject:"Math", title:"Financial Literacy: Mortgages and Amortization (Intro)", summary:"Grade 7 Math strand: a mortgage is a long-term loan used to purchase property, and amortization describes the schedule of regular payments that gradually pay down both the interest owed and the original amount borrowed.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is a mortgage?", options:["A one-time payment made in full with no borrowing involved","A long-term loan used to purchase property","A concept unrelated to financial literacy","A type of savings account with no connection to borrowing"], answer:1},
     {q:"What does amortization describe in relation to a mortgage?", options:["The schedule of regular payments that gradually pay down the loan","The exact size of the home being purchased","A single payment that pays off the entire mortgage instantly","A concept unrelated to mortgages"], answer:0},
     {q:"How might a longer amortization period generally affect the total interest paid on a mortgage?", options:["A concept unrelated to amortization","A longer period generally increases the total interest paid over time","The length of the amortization period never affects total interest","A longer period always decreases the total interest paid to zero"], answer:1},
     {q:"Why does a larger down payment generally reduce the size of a mortgage needed?", options:["This concept has no connection to financial literacy","A larger down payment covers more of the purchase price upfront, leaving less to borrow","Down payments have no relationship to the size of a mortgage","A larger down payment always increases the amount that must be borrowed"], answer:1},
     {q:"How does a higher interest rate generally affect a mortgages monthly payment?", options:["It always decreases the monthly payment amount to zero","It generally increases the monthly payment amount","Interest rates never affect monthly mortgage payments","A concept unrelated to mortgages"], answer:1}
   ]},
  {subject:"Science", title:"Light and Colour: Absorption and Reflection", summary:"Grade 7 Science strand: an object appears a particular colour because it reflects that wavelength of light while absorbing most other wavelengths, and darker colours generally absorb more light energy, which is often converted into heat.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"Why does an object appear a particular colour, such as red?", options:["A concept unrelated to science","It reflects that wavelength of light while absorbing most other wavelengths","It creates that colour of light entirely on its own with no outside light needed","Colour has no connection to light at all"], answer:1},
     {q:"Why do black surfaces generally feel warmer in sunlight than white surfaces?", options:["Black surfaces reflect all light and absorb none of it","Black surfaces absorb more light energy, which converts into heat","A concept unrelated to light and colour","Colour has no effect on how much heat a surface absorbs"], answer:1},
     {q:"Why do white or light-coloured surfaces generally reflect more light?", options:["Light-coloured surfaces produce their own light source","They reflect most wavelengths of visible light rather than absorbing them","White surfaces absorb every wavelength of light completely","A concept unrelated to science"], answer:1},
     {q:"What generally happens to light energy that is absorbed by an object rather than reflected?", options:["It is converted directly into sound energy","It disappears completely with no effect on the object","A concept unrelated to light and colour","It is often converted into heat energy"], answer:3},
     {q:"Why does a red apple appear red under white light?", options:["It reflects mostly red wavelengths of light while absorbing the other colours","This concept has no connection to science","It absorbs every wavelength of light equally","It produces red light itself with no outside light source needed"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Patriation of the Canadian Constitution in 1982", summary:"Grade 7 Social Studies strand: patriation in 1982 brought full authority over the Canadian constitution under Canadian control for the first time, ending the need for British approval of constitutional changes, and was accompanied by the introduction of the Canadian Charter of Rights and Freedoms.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What does patriation of the constitution mean?", options:["Removing the constitution from use entirely","Bringing full authority over the constitution under Canadian control","A concept unrelated to Canadian history","Sending the constitution to another country for approval"], answer:1},
     {q:"Who was the prime minister during the 1982 patriation of the constitution?", options:["Lester B. Pearson","Pierre Trudeau","Sir John A. Macdonald","Stephen Harper"], answer:1},
     {q:"What important document was introduced alongside patriation in 1982?", options:["The Canadian Charter of Rights and Freedoms","A concept unrelated to patriation","The Statute of Westminster","The Treaty of Versailles"], answer:0},
     {q:"Which province did not formally sign on to the 1982 constitutional agreement?", options:["Quebec","Ontario","British Columbia","Nova Scotia"], answer:0},
     {q:"Why is the 1982 patriation considered a significant milestone in Canadian history?", options:["This concept has no relevance to social studies","It had no meaningful effect on how Canadas constitution could be changed","It marked the moment Canada lost all connection to its previous constitution","Canada gained full authority to amend its own constitution without requiring British approval"], answer:3}
   ]},
]},
{day:134, label:"Day 134 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Movie Review", summary:"Grade 7 Language strand: a movie review briefly summarizes the plot without spoiling key surprises, evaluates elements like acting, direction, and visuals, and supports the writers opinion with specific scenes or examples from the film.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What should a movie review generally include, along with a brief summary?", options:["Only the exact runtime of the movie","A complete transcript of every line of dialogue","A concept unrelated to writing","An evaluation of elements like acting, direction, and visuals"], answer:3},
     {q:"Why might a movie review avoid revealing a films biggest plot twist?", options:["Spoilers are always required in a movie review","This concept has no connection to writing","A movie review should never mention the plot at all","To avoid spoiling the experience for viewers who have not seen it yet"], answer:3},
     {q:"What should support the opinions expressed in a movie review?", options:["Only the reviewers mood on the day of writing","Specific scenes or examples from the film","Random guesses with no connection to the film","A concept unrelated to movie reviews"], answer:1},
     {q:"Why might a reviewer discuss a films direction or visual style?", options:["Direction and visuals are never relevant to a movie review","These elements affect how effectively the story is told on screen","A movie review can only discuss the poster design","This concept has no connection to writing"], answer:1},
     {q:"Which sentence sounds most like part of a movie review?", options:["The lead actors performance brought real emotion to an otherwise predictable plot.","Add 15 and 20 to get 35.","The chemical symbol for gold is Au.","Once upon a time, in a faraway kingdom."], answer:0}
   ]},
  {subject:"Math", title:"Data Management: Cumulative Frequency and Ogives", summary:"Grade 7 Math strand: a cumulative frequency table keeps a running total of frequencies as data values increase, and an ogive is a line graph of that running total, often used to estimate the median of a data set.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does a cumulative frequency table show?", options:["The exact colour used to display each data value","Only the single most frequent value in a data set","A running total of frequencies as data values increase","A concept unrelated to data management"], answer:2},
     {q:"What is an ogive?", options:["A graph that can only display a single data point","A type of bar graph with no connection to frequency","A line graph showing cumulative frequency","A concept unrelated to data displays"], answer:2},
     {q:"How is each new value added to a cumulative frequency table?", options:["By adding it to the running total of all previous frequencies","By replacing the previous total completely","A concept unrelated to cumulative frequency","By subtracting it from the running total"], answer:0},
     {q:"What can the shape of an ogive help estimate about a data set?", options:["The approximate median of the data","The name of the person who collected the data","The exact colour of the original survey used to collect data","A concept unrelated to ogives"], answer:0},
     {q:"If a cumulative frequency table shows 5, 12, 20, and 30 for four increasing intervals, how many data values fall within the third interval alone?", options:["30","20","8","12"], answer:2}
   ]},
  {subject:"Science", title:"Biodegradable Materials and Waste Management", summary:"Grade 7 Science strand: biodegradable materials, such as food scraps and paper, break down naturally through the action of living organisms, while non-biodegradable materials, such as many plastics, persist in the environment for a very long time and pose challenges for waste management.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What does biodegradable mean?", options:["Made entirely of metal or glass","A concept unrelated to science","Unable to ever break down under any circumstances","Able to be broken down naturally by living organisms"], answer:3},
     {q:"Which of these materials is generally considered non-biodegradable?", options:["A concept unrelated to biodegradability","Many types of plastic","A sheet of paper","A banana peel"], answer:1},
     {q:"Why can non-biodegradable materials be especially problematic in landfills?", options:["Landfills have no connection to biodegradability at all","A concept unrelated to waste management","They can remain in the environment for a very long time without breaking down","They always break down completely within a single day"], answer:2},
     {q:"How can recycling help reduce problems associated with non-biodegradable waste?", options:["It can reduce the amount of new non-biodegradable material sent to landfills","Recycling always increases the total amount of waste produced","Recycling has no effect on how materials are managed","This concept has no connection to science"], answer:0},
     {q:"Which of these is an example of a biodegradable material?", options:["A styrofoam container","Food scraps","A concept unrelated to biodegradability","A plastic bottle"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The Great Canadian Flag Debate of 1964", summary:"Grade 7 Social Studies strand: the flag debate of 1964, championed by Prime Minister Lester B. Pearson, led to the adoption of the red and white Maple Leaf flag in 1965, replacing the Red Ensign and sparking heated disagreement over Canadas ties to British symbols.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the Great Canadian Flag Debate of 1964 about?", options:["Choosing a new national flag design to replace the existing one","Deciding whether Canada should adopt a new national anthem","Choosing the location of a new national capital","A concept unrelated to Canadian history"], answer:0},
     {q:"Which prime minister championed the introduction of a new Canadian flag?", options:["Sir John A. Macdonald","Stephen Harper","Lester B. Pearson","Pierre Trudeau"], answer:2},
     {q:"What flag design was ultimately chosen as a result of the debate?", options:["A concept unrelated to the flag debate","A flag with no connection to Canada at all","A flag featuring only the Union Jack","The red and white Maple Leaf flag"], answer:3},
     {q:"In what year was the new Canadian flag officially adopted?", options:["1965","1939","1982","1867"], answer:0},
     {q:"Why was the flag debate considered controversial at the time?", options:["Some Canadians wanted to preserve stronger visual ties to British symbols like the Red Ensign","The debate had no connection to Canadian identity or history","This concept has no relevance to social studies","Every Canadian agreed completely on the new design from the start"], answer:0}
   ]},
]},
{day:135, label:"Day 135 — Fri", subjects:[
  {subject:"Language", title:"Media Literacy: Evaluating Influencer Marketing", summary:"Grade 7 Language strand: influencer marketing happens when a social media personality promotes a product, often for payment, and viewers benefit from recognizing sponsored content and thinking critically about whether a recommendation is genuine.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is influencer marketing?", options:["A concept unrelated to media literacy","A completely unpaid recommendation with no business relationship","A type of printed magazine advertisement only","When a social media personality promotes a product, often for payment"], answer:3},
     {q:"Why are influencers often required to disclose when content is sponsored?", options:["A concept unrelated to influencer marketing","Sponsored content is always identical to genuine, unpaid opinions","So viewers know a payment or partnership may have influenced the recommendation","Disclosure is never required for sponsored content"], answer:2},
     {q:"Why is it important to think critically about an influencers product recommendation?", options:["Critical thinking is never useful when viewing social media content","Every influencer recommendation is always completely unbiased","The recommendation may be influenced by payment rather than the influencers honest opinion","A concept unrelated to media literacy"], answer:2},
     {q:"Which of these might indicate a social media post is sponsored content?", options:["A post that never mentions a brand or product at all","A concept unrelated to influencer marketing","A post with absolutely no connection to any product","A label such as ad or sponsored included in the post"], answer:3},
     {q:"Why does influencer marketing matter to consumers making purchasing decisions?", options:["This concept has no relevance to media literacy","Sponsored content has no effect on what consumers decide to buy","Recognizing sponsored content helps consumers make more informed choices","Consumers can never be influenced by social media content"], answer:2}
   ]},
  {subject:"Math", title:"Geometry: Tessellations and Symmetry", summary:"Grade 7 Math strand: a tessellation is a repeating pattern of shapes that covers a flat surface with no gaps or overlaps, and shapes like equilateral triangles, squares, and regular hexagons can tessellate because their angles divide evenly around a point.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is a tessellation?", options:["A concept unrelated to geometry","A single shape that never repeats in any pattern","A repeating pattern of shapes that covers a surface with no gaps or overlaps","A pattern that always leaves large gaps between shapes"], answer:2},
     {q:"Which of these regular shapes can tessellate on its own?", options:["A square","A regular pentagon","A regular heptagon","A concept unrelated to tessellations"], answer:0},
     {q:"Why can a regular hexagon tessellate without leaving any gaps?", options:["A concept unrelated to tessellations","Its interior angles divide evenly into 360 degrees around each point","Its interior angles always add up to more than 360 degrees","Hexagons can never fit together without leaving gaps"], answer:1},
     {q:"What role does symmetry often play in a tessellating pattern?", options:["Tessellations can never contain any symmetry at all","A concept unrelated to geometry","Symmetry always prevents shapes from tessellating","It helps the repeating shapes align consistently across the surface"], answer:3},
     {q:"Which natural structure is often cited as an example of a tessellating pattern?", options:["A honeycomb made of hexagonal cells","A concept unrelated to tessellations","A cloud with no repeating shape","A single round pebble"], answer:0}
   ]},
  {subject:"Science", title:"Nanotechnology: Engineering at the Atomic Scale", summary:"Grade 7 Science strand: nanotechnology involves designing and manipulating materials at an extremely small scale, measured in nanometres, enabling applications such as targeted drug delivery in medicine and stronger, lighter materials in engineering.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is nanotechnology?", options:["The design and manipulation of materials at an extremely small, nanometre scale","The study of objects that are visible only from space","A concept unrelated to science","A technology that only works on objects larger than a house"], answer:0},
     {q:"Roughly how small is a nanometre?", options:["About one billionth of a metre","About one metre exactly","A concept unrelated to nanotechnology","About one thousand kilometres"], answer:0},
     {q:"Why might materials behave differently at the nanoscale compared to their normal, everyday size?", options:["Extremely small particles can have different physical and chemical properties than larger amounts of the same material","Nanoscale materials never have any special properties","A concept unrelated to nanotechnology","Materials always behave in exactly the same way no matter their size"], answer:0},
     {q:"How is nanotechnology sometimes used in medicine?", options:["To help deliver medication directly and precisely to targeted cells","Nanotechnology has no applications in medicine at all","This concept has no connection to science","To completely replace the need for any medical treatment"], answer:0},
     {q:"Why might engineers use nanotechnology to develop new materials?", options:["This concept has no relevance to science","New materials can never be developed using nanotechnology","It can help create materials that are stronger or lighter than traditional materials","Nanotechnology can only make materials heavier and weaker"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: Canadas Peacekeeping Mission in Cyprus", summary:"Grade 7 Social Studies strand: Canada contributed troops to a United Nations peacekeeping force in Cyprus beginning in 1964 to help maintain a ceasefire between Greek and Turkish Cypriot communities, becoming one of Canadas longest peacekeeping commitments.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the purpose of the United Nations peacekeeping force sent to Cyprus?", options:["A concept unrelated to Canadian history","To help maintain a ceasefire between Greek and Turkish Cypriot communities","To build new highways across the island","To conquer new territory on behalf of the United Nations"], answer:1},
     {q:"Why was a peacekeeping force needed in Cyprus in the 1960s?", options:["Cyprus had no history of any internal tension at all","A concept unrelated to peacekeeping","The mission was sent for reasons unrelated to any conflict","Tension and conflict existed between the islands two main ethnic communities"], answer:3},
     {q:"Roughly how long did Canadian troops contribute to the peacekeeping mission in Cyprus?", options:["Canada never sent any troops to Cyprus","Several decades","Only a single afternoon","A concept unrelated to Cyprus"], answer:1},
     {q:"What is the general goal of a peacekeeping mission like the one in Cyprus?", options:["A concept unrelated to peacekeeping","To maintain a ceasefire and help prevent renewed violence","To take direct military control of the region permanently","To end all communication between the two communities involved"], answer:1},
     {q:"Why did missions like the one in Cyprus contribute to Canadas international reputation?", options:["Canada has never participated in any peacekeeping mission","This concept has no relevance to social studies","Peacekeeping missions have no connection to how other countries view Canada","They reinforced Canadas identity as a committed contributor to international peacekeeping efforts"], answer:3}
   ]},
]},
{day:136, label:"Day 136 — Mon", subjects:[
  {subject:"Language", title:"Grammar: Reported (Indirect) Speech", summary:"Grade 7 Language strand: reported speech restates what someone said without using their exact words in quotation marks, often shifting the verb tense and changing pronouns to fit the perspective of the person reporting it.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is reported speech?", options:["A word-for-word quotation placed in quotation marks","A sentence with no connection to speech at all","Restating what someone said without using their exact quoted words","A concept unrelated to grammar"], answer:2},
     {q:"If someone says I am tired, how might this be rewritten in reported speech?", options:["She said tired I am.","A concept unrelated to reported speech","She said I am tired.","She said she was tired."], answer:3},
     {q:"Why does the verb tense often shift when converting direct speech into reported speech?", options:["Reported speech always uses the future tense regardless of the original statement","A concept unrelated to grammar","Reported speech usually moves the tense back to reflect that the statement happened earlier","Verb tense never changes when converting to reported speech"], answer:2},
     {q:"Why might pronouns change when converting direct speech into reported speech?", options:["The pronouns need to match the perspective of the person reporting the statement","Reported speech always removes every pronoun completely","This concept has no connection to grammar","Pronouns are never affected by converting speech into reported form"], answer:0},
     {q:"Which sentence is written correctly in reported speech?", options:["He said that will call later he.","He said, He would call later.","He said that I will call later.","He said that he would call later."], answer:3}
   ]},
  {subject:"Math", title:"Measurement: Converting Units of Area and Volume", summary:"Grade 7 Math strand: converting between units of area requires squaring the linear conversion factor, while converting between units of volume requires cubing it, since area and volume involve two and three dimensions respectively.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"Why must a linear conversion factor be squared when converting between units of area?", options:["A concept unrelated to measurement","Squaring a conversion factor only applies to units of volume","Because area involves two dimensions, so the conversion factor applies twice","Area conversions never require any adjustment to the linear factor"], answer:2},
     {q:"How many square centimetres are in 1 square metre, given 100 centimetres in 1 metre?", options:["10,000","100","1,000","1,000,000"], answer:0},
     {q:"Why must a linear conversion factor be cubed when converting between units of volume?", options:["Because volume involves three dimensions, so the conversion factor applies three times","A concept unrelated to measurement","Cubing a conversion factor only applies to units of area","Volume conversions never require any adjustment to the linear factor"], answer:0},
     {q:"How many cubic centimetres are in 1 cubic metre, given 100 centimetres in 1 metre?", options:["100","1,000,000","1,000","10,000"], answer:1},
     {q:"Why can the simple linear conversion factor not be used directly when converting square or cubic units?", options:["Linear, square, and cubic units always convert using the exact same factor","This concept has no connection to measurement","Square and cubic units never need any conversion at all","Applying it without squaring or cubing would ignore the extra dimensions involved"], answer:3}
   ]},
  {subject:"Science", title:"Circadian Rhythms and the Sleep-Wake Cycle", summary:"Grade 7 Science strand: a circadian rhythm is an internal biological clock that repeats roughly every 24 hours, regulating the sleep-wake cycle and other body functions largely in response to patterns of light and darkness.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a circadian rhythm?", options:["A pattern found only in plants, never in animals","A concept unrelated to biology","A rhythm that only occurs once per year","An internal biological clock that repeats roughly every 24 hours"], answer:3},
     {q:"What is one major factor that helps regulate the circadian rhythm?", options:["A concept unrelated to circadian rhythms","The number of books a person owns","The colour of a persons clothing","Exposure to light and darkness"], answer:3},
     {q:"Why is a consistent sleep-wake cycle generally considered important for the body?", options:["It supports healthy brain function, mood, and overall physical health","The body functions identically whether or not a person sleeps","A concept unrelated to biology","Sleep has no measurable effect on the brain or body"], answer:0},
     {q:"What might disrupt a persons circadian rhythm?", options:["Waking up at the exact same time every single day","Exposure to bright screen light late at night","A completely dark, quiet room used only for sleeping","A concept unrelated to circadian rhythms"], answer:1},
     {q:"Why might travelling across many time zones cause jet lag?", options:["Jet lag has no connection to the circadian rhythm at all","The circadian rhythm instantly resets the moment a plane lands","It temporarily disrupts the bodys internal clock, which has not yet adjusted to the new light pattern","This concept has no relevance to science"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The National Energy Program and Western Alienation", summary:"Grade 7 Social Studies strand: the National Energy Program, introduced by the federal government in 1980, aimed to increase Canadian control over the oil industry and stabilize energy prices, but it angered many in western provinces like Alberta and deepened feelings of western alienation.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What was the National Energy Program?", options:["A federal policy from 1980 aimed at increasing Canadian control over oil and stabilizing prices","An agreement to import all of Canadas oil from other countries","A program focused entirely on building new schools","A concept unrelated to Canadian history"], answer:0},
     {q:"Why did the federal government introduce the National Energy Program?", options:["To eliminate the energy industry from the Canadian economy entirely","To transfer full control of oil resources to another country","To increase Canadian ownership of the energy industry and manage energy prices","A concept unrelated to the National Energy Program"], answer:2},
     {q:"How did many people in western provinces, especially Alberta, react to the National Energy Program?", options:["They were completely unaffected by the policy","A concept unrelated to western Canada","With enthusiastic support and no objections at all","With anger, feeling the policy unfairly targeted their regions oil industry"], answer:3},
     {q:"What does the term western alienation generally describe?", options:["A feeling among people in western Canada that the federal government overlooks or mistreats their interests","A term with no connection to any Canadian region","A concept unrelated to Canadian politics","A feeling of strong satisfaction with federal government policies"], answer:0},
     {q:"Why is the National Energy Program still discussed in relation to regional tensions in Canada?", options:["This concept has no relevance to social studies","It has been completely forgotten and has no lasting significance","It only affected a single small town with no wider impact","It is often cited as a key example of conflict between federal policy and western provincial interests"], answer:3}
   ]},
]},
{day:137, label:"Day 137 — Tue", subjects:[
  {subject:"Language", title:"Vocabulary: Acronyms and Initialisms", summary:"Grade 7 Language strand: an acronym is an abbreviation formed from the first letters of a phrase and pronounced as a single word, such as NASA, while an initialism is pronounced letter by letter, such as FBI.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is an acronym?", options:["An abbreviation formed from initial letters and pronounced as a single word","A concept unrelated to vocabulary","A word with no connection to any longer phrase","A phrase that is always written out in full with no shortening"], answer:0},
     {q:"Which of these is an example of an acronym pronounced as a word?", options:["FBI","NASA","ATM","CD"], answer:1},
     {q:"How does an initialism differ from an acronym?", options:["An initialism and an acronym are always pronounced in exactly the same way","An initialism can never be formed from a phrase","An initialism is pronounced letter by letter rather than as a single word","A concept unrelated to vocabulary"], answer:2},
     {q:"Why might people use acronyms and initialisms in everyday language?", options:["Acronyms and initialisms always make communication more confusing with no benefit","They shorten long phrases into something quicker and easier to say","This concept has no connection to vocabulary","Every English word is technically an acronym"], answer:1},
     {q:"Which of these is best described as an initialism rather than an acronym?", options:["A word that has no letters at all","FBI, pronounced letter by letter","NASA, pronounced as a single word","A concept unrelated to abbreviations"], answer:1}
   ]},
  {subject:"Math", title:"Probability: Geometric Probability with Area Models", summary:"Grade 7 Math strand: geometric probability compares the area of a favourable region to the area of the entire possible region, useful for situations like a dart landing inside a target or a spinner stopping in a certain zone.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does geometric probability compare?", options:["The number of dice rolled in an experiment","The exact colour of a spinner with no connection to area","A concept unrelated to probability","The area of a favourable region to the area of the entire possible region"], answer:3},
     {q:"If a target has a total area of 100 square centimetres and a bullseye area of 20 square centimetres, what is the probability of landing in the bullseye?", options:["20 out of 100","20 out of 80","100 out of 20","80 out of 100"], answer:0},
     {q:"How does geometric probability differ from counting individual equally likely outcomes?", options:["Geometric probability can never be applied to a spinner or dartboard","Geometric probability and counting outcomes are always calculated in exactly the same way","It compares continuous regions of area instead of counting separate discrete outcomes","A concept unrelated to probability"], answer:2},
     {q:"On a spinner divided into unequal regions, why might a larger region have a higher probability of being landed on?", options:["Smaller regions always have a higher probability than larger ones","A larger area typically represents a greater share of the total possible outcomes","This concept has no connection to probability","Every region on a spinner always has an identical probability regardless of size"], answer:1},
     {q:"Why are area models especially useful for probability situations involving continuous space, like a dartboard?", options:["They allow probability to be calculated using regions rather than only countable, separate outcomes","Continuous space situations can never be modeled using area","Area models can only be used when outcomes are countable and separate","This concept has no relevance to math"], answer:0}
   ]},
  {subject:"Science", title:"The Doppler Effect and Changing Sound", summary:"Grade 7 Science strand: the Doppler effect is the change in pitch heard when a sound source moves relative to a listener, with pitch rising as the source approaches and falling as it moves away, caused by sound waves being compressed or stretched.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is the Doppler effect?", options:["A change in the colour of an object as it moves","A sound that never changes no matter how it moves","A concept unrelated to science","A change in pitch caused by relative motion between a sound source and a listener"], answer:3},
     {q:"What happens to the pitch of a siren as an ambulance approaches, then passes by?", options:["The pitch sounds higher while approaching and lower after it passes","The pitch always stays exactly the same the entire time","A concept unrelated to the Doppler effect","The pitch becomes silent the moment the ambulance passes"], answer:0},
     {q:"What causes sound waves to seem compressed as a source moves toward a listener?", options:["Compression only happens when a sound source is standing still","Sound waves always spread out further as a source approaches","A concept unrelated to sound","The source is catching up slightly to its own previously emitted sound waves"], answer:3},
     {q:"Why does pitch sound lower as a sound source moves away from a listener?", options:["This concept has no connection to science","The sound waves are compressed further as the source moves away","Pitch never changes based on the motion of a sound source","The sound waves are stretched out, lowering their frequency as heard by the listener"], answer:3},
     {q:"Which field uses the Doppler effect to help detect the speed and direction of moving objects?", options:["Handwriting analysis","Basic arithmetic","Weather radar","A concept unrelated to the Doppler effect"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The 1988 Free Trade Election", summary:"Grade 7 Social Studies strand: the 1988 federal election centered on whether Canada should sign a free trade agreement with the United States, with supporters citing economic growth and opponents warning of lost sovereignty and jobs, and the governing party that supported the deal won.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What major issue was at the center of the 1988 federal election?", options:["Whether Canada should sign a free trade agreement with the United States","Whether Canada should adopt a new national flag","A concept unrelated to Canadian history","Whether Canada should end all international trade completely"], answer:0},
     {q:"What was one argument made in favour of the proposed free trade agreement?", options:["It would guarantee the end of all international trade","It could increase trade and support economic growth","It would have no effect on the economy whatsoever","A concept unrelated to the 1988 election"], answer:1},
     {q:"What was one argument made against the proposed free trade agreement?", options:["A concept unrelated to the 1988 election","Concerns about losing economic sovereignty and jobs","Concerns that the agreement would raise no economic questions at all","Concerns that trade with the United States would completely stop"], answer:1},
     {q:"What was the outcome of the 1988 federal election regarding free trade?", options:["The governing party that supported the agreement won and the deal proceeded","No government was formed as a result of the election","A concept unrelated to the 1988 election","The election resulted in trade with the United States being banned"], answer:0},
     {q:"What larger trade agreement did the Canada-US Free Trade Agreement later help lead to?", options:["The North American Free Trade Agreement (NAFTA)","A trade agreement exclusively with countries in Asia","An agreement ending all trade with the United States","A concept unrelated to Canadian trade history"], answer:0}
   ]},
]},
{day:138, label:"Day 138 — Wed", subjects:[
  {subject:"Language", title:"Reading: Analyzing Anti-Heroes and Morally Complex Characters", summary:"Grade 7 Language strand: an anti-hero is a main character who lacks some traditional heroic qualities, such as pure honesty or selflessness, yet still drives the story forward and often reveals a more complicated view of right and wrong.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is an anti-hero?", options:["A character who is always purely good with no flaws","A minor character with no role in the plot","A concept unrelated to reading","A main character who lacks some traditional heroic qualities"], answer:3},
     {q:"Which trait might an anti-hero commonly display?", options:["Moral flaws or questionable choices despite being the main character","A total absence of personality or motivation","Complete honesty and selflessness at all times","A concept unrelated to anti-heroes"], answer:0},
     {q:"Why might an author choose to write an anti-hero instead of a traditional hero?", options:["Every story is required to feature an anti-hero","Anti-heroes always make a story less interesting to readers","To create a more realistic or complex view of right and wrong","This concept has no connection to literature"], answer:2},
     {q:"How does an anti-hero generally differ from a villain?", options:["An anti-hero and a villain are always exactly the same role in a story","An anti-hero is still the main character driving the story, despite flaws, while a villain typically opposes the protagonist","A villain always narrates the story from the anti-heros point of view","This concept has no relevance to reading"], answer:1},
     {q:"Which description best fits an anti-hero?", options:["A morally flawed character who still takes center stage in the story","A character who never appears in the story at all","A concept unrelated to literary characters","A character who is perfectly virtuous in every situation"], answer:0}
   ]},
  {subject:"Math", title:"Algebra: Solving Word Problems with Consecutive Integers", summary:"Grade 7 Math strand: consecutive integers are whole numbers that follow each other in order, such as 5, 6, and 7, and word problems about them can be solved by representing the unknown integers algebraically as n, n+1, n+2, and so on.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What are consecutive integers?", options:["Numbers that must all be equal to each other","A concept unrelated to algebra","Numbers that are always separated by a gap of at least ten","Whole numbers that follow each other in order, such as 5, 6, and 7"], answer:3},
     {q:"How might three consecutive integers be represented algebraically?", options:["n, 2n, and 3n","A concept unrelated to consecutive integers","n, n, and n","n, n+1, and n+2"], answer:3},
     {q:"If three consecutive integers add up to 60, which equation represents this situation?", options:["n + (n+1) + (n+2) = 60","n + n + n = 60 with no adjustment","3n + 2 = 60 with no other terms","A concept unrelated to algebra"], answer:0},
     {q:"Using n + (n+1) + (n+2) = 60, what is the value of n?", options:["19","18","21","20"], answer:0},
     {q:"Why is representing consecutive integers algebraically helpful when solving these word problems?", options:["It turns a wordy description into a solvable equation with a single unknown","Algebra can never be used to represent consecutive integers","This concept has no connection to math","Consecutive integer problems can only be solved by guessing randomly"], answer:0}
   ]},
  {subject:"Science", title:"Renewable Energy: Hydrogen Fuel Cells", summary:"Grade 7 Science strand: a hydrogen fuel cell generates electricity through a chemical reaction between hydrogen and oxygen, producing water as its main byproduct, making it a clean energy option though challenges remain around storing and producing hydrogen.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What does a hydrogen fuel cell use to generate electricity?", options:["Burning coal in a large furnace","Sunlight captured by a solar panel","A concept unrelated to renewable energy","A chemical reaction between hydrogen and oxygen"], answer:3},
     {q:"What is the main byproduct produced by a hydrogen fuel cell?", options:["Thick black smoke","Large amounts of solid ash","Water","A concept unrelated to hydrogen fuel cells"], answer:2},
     {q:"Why are hydrogen fuel cells often considered a clean energy option?", options:["They produce water rather than carbon emissions at the point of use","A concept unrelated to renewable energy","They release large amounts of carbon dioxide directly into the air","They require burning fossil fuels to operate at all"], answer:0},
     {q:"What is one challenge associated with using hydrogen fuel cells widely?", options:["Storing and producing hydrogen can be difficult and energy-intensive","Hydrogen is the easiest possible fuel to store and never requires any energy to produce","Hydrogen fuel cells have no challenges at all","This concept has no connection to science"], answer:0},
     {q:"Which of these is a real-world application of hydrogen fuel cell technology?", options:["A concept unrelated to hydrogen fuel cells","Replacing all forms of transportation immediately worldwide","Powering certain vehicles and buses","Powering a device with no moving parts or electrical needs"], answer:2}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The History of O Canada and National Symbols", summary:"Grade 7 Social Studies strand: O Canada was composed in 1880 and became Canadas official national anthem in 1980, joining other national symbols like the Maple Leaf flag as a shared marker of Canadian identity.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"In approximately what year was the music for O Canada composed?", options:["1982","1867","1965","1880"], answer:3},
     {q:"In what year did O Canada officially become Canadas national anthem?", options:["1867","1980","1920","1945"], answer:1},
     {q:"Who composed the original music for O Canada?", options:["Sir John A. Macdonald","Calixa Lavallee","Pierre Trudeau","Lester B. Pearson"], answer:1},
     {q:"Why are national symbols like an anthem considered important to a country?", options:["Anthems are chosen randomly with no connection to national identity","National symbols have no effect on how citizens view their country","They can help foster a shared sense of identity and belonging among citizens","A concept unrelated to social studies"], answer:2},
     {q:"Besides the national anthem, which of these is also considered a well-known Canadian national symbol?", options:["The maple leaf","A concept unrelated to national symbols","A symbol used exclusively by one province","A symbol with no connection to Canadian identity"], answer:0}
   ]},
]},
{day:139, label:"Day 139 — Thu", subjects:[
  {subject:"Language", title:"Writing: Writing a Podcast Script", summary:"Grade 7 Language strand: a podcast script plans out an audio show with a strong opening hook, clearly organized segments, natural transitions, and a conversational tone suited to being heard rather than read.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What should a podcast script generally include?", options:["A list of unrelated topics with no connections between them","Only a single unbroken paragraph with no structure","A strong opening hook, organized segments, and clear transitions","A concept unrelated to writing"], answer:2},
     {q:"Why does a podcast script often use a conversational tone?", options:["A concept unrelated to podcast scripts","A conversational tone is never appropriate for an audio format","Because listeners are hearing the words rather than reading them, so natural speech feels more engaging","Podcasts are always written in a strictly formal, academic style"], answer:2},
     {q:"Why might a podcast script include notes for sound cues or music transitions?", options:["Music transitions always confuse listeners with no benefit","Sound cues are never included in a podcast script","This concept has no connection to writing","To help guide pacing and signal shifts between segments for the listener"], answer:3},
     {q:"Why is a strong opening hook important in a podcast script?", options:["This concept has no relevance to writing","A podcast script should always begin with the credits","The opening of a podcast never affects whether listeners keep listening","It helps capture listener interest right away, before they decide whether to keep listening"], answer:3},
     {q:"Which excerpt sounds most like the opening of a podcast script?", options:["Welcome back to the show. Today we are diving into a mystery that stumped scientists for decades.","The chemical symbol for gold is Au.","Please find attached the quarterly financial report.","Add 15 and 20 to get 35."], answer:0}
   ]},
  {subject:"Math", title:"Geometry: Indirect Measurement Using Similar Triangles", summary:"Grade 7 Math strand: indirect measurement uses similar triangles, such as the triangles formed by an object and its shadow, to calculate a height or distance that would be difficult to measure directly, by setting up a proportion between corresponding sides.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What is indirect measurement?", options:["A method that always requires physically climbing to the top of an object","A method that can only be used on objects smaller than one metre","A method of finding a measurement, like height, without measuring it directly","A concept unrelated to geometry"], answer:2},
     {q:"Why are similar triangles useful for indirect measurement problems involving shadows?", options:["A concept unrelated to geometry","The triangles formed by an object and its shadow are proportional to a second object and its shadow","Shadows never form triangles of any kind","Similar triangles have no connection to shadows or height"], answer:1},
     {q:"If a 2 metre tall post casts a 3 metre shadow at the same time a tree casts a 9 metre shadow, how tall is the tree?", options:["6 metres","3 metres","13.5 metres","9 metres"], answer:0},
     {q:"What must be true about the two triangles used in an indirect measurement problem for the method to work?", options:["They must have no shared angles at all","They must be similar, with proportional corresponding sides","A concept unrelated to indirect measurement","They must be exactly the same size with no proportional relationship needed"], answer:1},
     {q:"Why might indirect measurement be useful for finding the height of a very tall building?", options:["Indirect measurement can only be used on objects at ground level","This concept has no relevance to geometry","Tall buildings can always be measured directly with a small ruler","It avoids the need to physically climb or directly measure an object that is difficult to reach"], answer:3}
   ]},
  {subject:"Science", title:"The Process of Fermentation", summary:"Grade 7 Science strand: fermentation is a process in which microorganisms like yeast and bacteria break down sugars without using oxygen, producing byproducts such as carbon dioxide or lactic acid that are used in foods like bread and yogurt.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is fermentation?", options:["A process that only occurs inside rocks","A process that always requires large amounts of oxygen","A process in which microorganisms break down sugars without using oxygen","A concept unrelated to science"], answer:2},
     {q:"Which microorganism is commonly responsible for making bread dough rise?", options:["A concept unrelated to fermentation","Yeast","A species of tree","A type of large mammal"], answer:1},
     {q:"What gas is produced by yeast during the fermentation of bread dough?", options:["A concept unrelated to fermentation","Helium","Carbon dioxide","Oxygen only"], answer:2},
     {q:"Why has fermentation historically been important for preserving food?", options:["Fermentation always causes food to spoil more quickly","It can slow the growth of harmful microorganisms and extend how long food stays edible","This concept has no connection to science","Fermentation has never been used in food preparation"], answer:1},
     {q:"What role do bacteria play in the fermentation process used to make yogurt?", options:["They produce lactic acid, which thickens and flavours the milk","They have no effect on the milk at all","A concept unrelated to fermentation","They convert the milk directly into a solid metal"], answer:0}
   ]},
  {subject:"SocialStudies", title:"Social Studies: The History of the CBC and Public Broadcasting", summary:"Grade 7 Social Studies strand: the Canadian Broadcasting Corporation, founded in 1936, is a publicly funded broadcaster created to provide Canadian news and cultural programming in both English and French, helping to counter the influence of foreign broadcast signals.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What is the CBC?", options:["A publicly funded Canadian broadcaster","A company that only produces printed newspapers","A privately owned foreign broadcasting company","A concept unrelated to Canadian history"], answer:0},
     {q:"Why was a public broadcaster created in Canada in the 1930s?", options:["A concept unrelated to the CBC","To completely eliminate radio broadcasting in Canada","To broadcast programming exclusively from other countries","To provide Canadian content and help counter the influence of foreign broadcast signals"], answer:3},
     {q:"How is the CBC primarily funded?", options:["A concept unrelated to public broadcasting","The CBC receives no funding of any kind","Through public funding from the government","Entirely through a single private investor"], answer:2},
     {q:"What is one goal of public broadcasting in Canada?", options:["Broadcasting only in a single language with no other option","Avoiding any coverage of Canadian news or culture","Providing news and cultural programming in both English and French","A concept unrelated to the CBC"], answer:2},
     {q:"In approximately what year was the CBC founded?", options:["1936","1982","1965","1867"], answer:0}
   ]},
]},
{day:140, label:"Day 140 — Fri", subjects:[
  {subject:"Language", title:"Language Review: Grammar, Vocabulary, Reading, Media Literacy, and Writing", summary:"Grade 7 Language strand review: students revisit relative clauses, malapropisms, literary archetypes, evaluating influencer marketing, and writing a podcast script.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"What is a relative clause?", options:["A concept unrelated to grammar","A clause that always stands alone as its own sentence","A clause that adds extra information about a noun using a relative pronoun","A clause that never connects to any noun"], answer:2},
     {q:"What is a malapropism?", options:["A word that never appears in dialogue","A concept unrelated to vocabulary","A word that has exactly one correct meaning","The mistaken use of a word in place of a similar-sounding word"], answer:3},
     {q:"What is a literary archetype?", options:["A concept unrelated to reading","A recurring character type or pattern found across many stories","A type of punctuation used in dialogue","A character that appears in only one story ever written"], answer:1},
     {q:"What is influencer marketing?", options:["A concept unrelated to media literacy","When a social media personality promotes a product, often for payment","A type of printed magazine advertisement only","A completely unpaid recommendation with no business relationship"], answer:1},
     {q:"What should a podcast script generally include?", options:["A list of unrelated topics with no connections between them","A concept unrelated to writing","A strong opening hook, organized segments, and clear transitions","Only a single unbroken paragraph with no structure"], answer:2}
   ]},
  {subject:"Math", title:"Math Review: Data, Geometry, Financial Literacy, Probability, and Algebra", summary:"Grade 7 Math strand review: students revisit mean absolute deviation, angle relationships in parallel lines, mortgages and amortization, geometric probability, and consecutive integer word problems.",
   resourceLabel:"TVO Learn: Grade 7 Mathematics", resourceUrl:"https://tvolearn.com/pages/grade-7-mathematics",
   quiz:[
     {q:"What does mean absolute deviation (MAD) measure?", options:["The total number of values in a data set","The single highest value in a data set","The average distance between each data value and the mean","A concept unrelated to data management"], answer:2},
     {q:"What is a transversal?", options:["A concept unrelated to geometry","A line that never intersects any other line","A line segment with no defined length","A line that crosses two or more other lines"], answer:3},
     {q:"What is a mortgage?", options:["A concept unrelated to financial literacy","A type of savings account with no connection to borrowing","A long-term loan used to purchase property","A one-time payment made in full with no borrowing involved"], answer:2},
     {q:"What does geometric probability compare?", options:["The number of dice rolled in an experiment","A concept unrelated to probability","The area of a favourable region to the area of the entire possible region","The exact colour of a spinner with no connection to area"], answer:2},
     {q:"What are consecutive integers?", options:["A concept unrelated to algebra","Whole numbers that follow each other in order, such as 5, 6, and 7","Numbers that are always separated by a gap of at least ten","Numbers that must all be equal to each other"], answer:1}
   ]},
  {subject:"Science", title:"Science Review: Astronomy, Earth Science, Physics, Technology, and Biology", summary:"Grade 7 Science strand review: students revisit comets and asteroids, permafrost and the cryosphere, light and colour, nanotechnology, and circadian rhythms.",
   resourceLabel:"TVO Learn: Grade 7 Science and Technology", resourceUrl:"https://tvolearn.com/pages/grade-7-science-and-technology",
   quiz:[
     {q:"What is a comet mostly made of?", options:["A concept unrelated to astronomy","Ice, dust, and rocky material","Solid metal with no ice at all","Pure liquid water only"], answer:1},
     {q:"What is permafrost?", options:["Ground that has never once frozen in recorded history","Ground that has remained frozen for two or more consecutive years","A concept unrelated to earth science","A type of rock found only underwater"], answer:1},
     {q:"Why does an object appear a particular colour, such as red?", options:["A concept unrelated to science","It reflects that wavelength of light while absorbing most other wavelengths","It creates that colour of light entirely on its own with no outside light needed","Colour has no connection to light at all"], answer:1},
     {q:"What is nanotechnology?", options:["A technology that only works on objects larger than a house","A concept unrelated to science","The study of objects that are visible only from space","The design and manipulation of materials at an extremely small, nanometre scale"], answer:3},
     {q:"What is a circadian rhythm?", options:["A rhythm that only occurs once per year","An internal biological clock that repeats roughly every 24 hours","A concept unrelated to biology","A pattern found only in plants, never in animals"], answer:1}
   ]},
  {subject:"SocialStudies", title:"Social Studies Review: Confederation, Constitution, and Canadian Identity", summary:"Grade 7 Social Studies strand review: students revisit the Fenian Raids, the National Policy of 1879, the patriation of the constitution, the flag debate of 1964, and the history of the CBC.",
   resourceLabel:"TVO Learn: Grade 7 Social Studies", resourceUrl:"https://tvolearn.com/pages/grade-7-social-studies",
   quiz:[
     {q:"What were the Fenian Raids?", options:["A concept unrelated to Canadian history","A series of scientific expeditions across the Arctic","A series of armed incursions into British North America by an Irish-American group","A peaceful trade negotiation between Canada and Ireland"], answer:2},
     {q:"What was the National Policy of 1879?", options:["A policy focused only on education reform","A treaty ending a war between Canada and another country","An economic strategy combining tariffs, a transcontinental railway, and western immigration","A concept unrelated to Canadian history"], answer:2},
     {q:"What does patriation of the constitution mean?", options:["A concept unrelated to Canadian history","Sending the constitution to another country for approval","Bringing full authority over the constitution under Canadian control","Removing the constitution from use entirely"], answer:2},
     {q:"What was the Great Canadian Flag Debate of 1964 about?", options:["Choosing a new national flag design to replace the existing one","A concept unrelated to Canadian history","Deciding whether Canada should adopt a new national anthem","Choosing the location of a new national capital"], answer:0},
     {q:"What is the CBC?", options:["A company that only produces printed newspapers","A publicly funded Canadian broadcaster","A concept unrelated to Canadian history","A privately owned foreign broadcasting company"], answer:1}
   ]},
]},
];
