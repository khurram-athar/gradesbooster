...
{day:44, label:"Day 44 — Thu", subjects:[
  {subject:"Language", title:"Vocabulary: Technical and Academic Vocabulary", summary:"Ontario Grade 7 Language strand: technical and academic vocabulary consists of specialized words used within specific subjects or fields, and understanding these terms is important for reading and writing in those areas.",
   resourceLabel:"TVO Learn: Grade 7 Language", resourceUrl:"https://tvolearn.com/pages/grade-7-language",
   quiz:[
     {q:"Technical vocabulary refers to ___.", options:["Specialized words used within specific subjects or fields","Words used only in casual conversation","Words with no specific meaning","Vocabulary that never appears in academic writing"], answer:0},
     {q:"Why is understanding academic vocabulary important for reading textbooks?", options:["Textbooks never use specialized vocabulary","Understanding vocabulary is unnecessary for comprehension","It helps readers understand subject-specific concepts accurately","Academic vocabulary has no connection to understanding a subject"], answer:2},
     {q:"Which is an example of technical vocabulary specific to science?", options:["Photosynthesis","Quickly","Nice","Happy"], answer:0},
     {q:"Why might a student need to learn new vocabulary when starting a new subject, like geometry?", options:["New subjects never require any new vocabulary","New subjects often introduce specialized terms essential to understanding key concepts","Vocabulary has no connection to understanding a subject","Technical vocabulary is identical across every subject"], answer:1},
     {q:"A glossary in a textbook is useful because it ___.", options:["Only lists unrelated general vocabulary","Replaces the need to read the textbook itself","Provides definitions for specialized or technical terms used in the text","Contains no useful information"], answer:2}
   ]},
